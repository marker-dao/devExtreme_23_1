...
class FileManagerDetailsItemList extends _uiFile_manager3.default {
  ...
  _onContextMenuPreparing(e) {
    ...
    const eventArgs = (0, _extend.extend)({}, {
      targetElement: e.target === 'content' && (0, _type.isDefined)(e.row) ? (_this$_filesView4 = this._filesView) === null || _this$_filesView4 === void 0 ? void 0 : _this$_filesView4.getRowElement(e.rowIndex) : undefined,
      itemData: item,
