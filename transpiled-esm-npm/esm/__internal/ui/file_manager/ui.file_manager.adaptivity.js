...
class FileManagerAdaptivityControl extends Widget {
  ...
  _createDrawerTemplate(container) {
    ...
    this._splitter = this._createComponent('<div>', SplitterControl, {
      ...
      leftElement: $((_this$_drawer = this._drawer) === null || _this$_drawer === void 0 ? void 0 : _this$_drawer.content()),
      rightElement: $((_this$_drawer2 = this._drawer) === null || _this$_drawer2 === void 0 ? void 0 : _this$_drawer2.viewContent()),
  ...
  _onApplyPanelSize(e) {
    ...
    $((_this$_drawer3 = this._drawer) === null || _this$_drawer3 === void 0 ? void 0 : _this$_drawer3.content()).removeClass(DRAWER_PANEL_CONTENT_INITIAL);
  ...
  _setDrawerWidth(width) {
    ...
    $((_this$_drawer4 = this._drawer) === null || _this$_drawer4 === void 0 ? void 0 : _this$_drawer4.content()).css('width', width);
    this._updateDrawerMaxSize();
  ...
  _checkAdaptiveState() {
    ...
    if (oldState !== this._isInAdaptiveState) {
      ...
      $((_this$_drawer7 = this._drawer) === null || _this$_drawer7 === void 0 ? void 0 : _this$_drawer7.content()).toggleClass(DRAWER_PANEL_CONTENT_ADAPTIVE, this._isInAdaptiveState);
