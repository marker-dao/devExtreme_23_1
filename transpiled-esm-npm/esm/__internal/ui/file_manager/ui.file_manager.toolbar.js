...
import { current, isCompact, isFluent, isMaterial } from '../../../ui/themes';
import Toolbar from '../../../ui/toolbar';
import Widget from '../../core/widget/widget';
import { extendAttributes } from '../../ui/file_manager/ui.file_manager.common';
...
class FileManagerToolbar extends Widget {
  ...
  _configureItemByCommandName(commandName, item) {
    ...
    if (!isDefined((_result$options2 = result.options) === null || _result$options2 === void 0 ? void 0 : _result$options2.stylingMode)) {
      if (result.widget === 'dxButton') {
        extend(true, result, {
          options: {
            stylingMode: 'text'
