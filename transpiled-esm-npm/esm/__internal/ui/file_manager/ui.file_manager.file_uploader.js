...
class FileManagerFileUploader extends Widget {
  ...
  _createDropZonePlaceholder() {
    ...
    this._$dropZonePlaceholder = $('<div>').addClass(FILE_MANAGER_FILE_UPLOADER_DROPZONE_PLACEHOLDER_CLASS).appendTo($(dropZonePlaceholderContainer));
  }
  _adjustDropZonePlaceholder() {
    ...
    if (!hasWindow() || ($dropZoneTarget === null || $dropZoneTarget === void 0 ? void 0 : $dropZoneTarget.length) === 0) {
      return;
    }
