...
import { AnimationController } from '../../../viz/core/renderers/animation';
import { getNextDefsSvgId, normalizeArcParams, normalizeBBox, normalizeEnum, rotateBBox } from '../../../viz/core/utils';
...
SvgElement.prototype = {
  ...
  toBackground() {
    ...
    parent === null || parent === void 0 || parent.insertBefore(elem, parent.firstChild);
    return this;
  },
  toForeground() {
    const elem = this.element;
    const parent = elem.parentNode;
    parent === null || parent === void 0 || parent.appendChild(elem);
    return this;
  },
  attr(attrs) {
    return baseAttr(this, attrs);
  ...
  stopAnimation(disableComplete) {
    ...
    animation === null || animation === void 0 || animation.stop(disableComplete);
    return this;
  },
  setTitle(text) {
