...
describe('getAppointmentRecurrenceOccurrences', () => {
  ...
  describe('with recurrence rule', () => {
    ...
    it('should return appointment occurrences for appointment with exceptions', () => {
      const exception1 = getAsciiStringByDate(new Date(Date.UTC(2000, 0, 11, 10)));
      const exception2 = getAsciiStringByDate(new Date(Date.UTC(2000, 0, 12, 10)));
      const exception3 = getAsciiStringByDate(new Date(Date.UTC(2000, 0, 13, 10)));
      const appointment = {
        source: {
          startDate: Date.UTC(2000, 0, 9, 10),
          endDate: Date.UTC(2000, 0, 9, 11)
