import { toFixed } from '../../../core/localization/utils';
import { fitIntoRange, multiplyInExponentialForm } from '../../../core/utils/m_math';
...
export function getFormatter(format, config) {
  ...
  return value => {
    ...
    let valueIntegerPart = normalizeValueString(reverseString(valueParts[0]), minIntegerPrecision,
    // @ts-expect-error
    maxIntegerPrecision);
