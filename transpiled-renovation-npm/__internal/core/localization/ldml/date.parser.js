...
const PATTERN_REGEXPS = {
  ':': (count, dateParts) => {
    ...
    let timeSeparator = (0, _m_common.escapeRegExp)((_dateParts$getTimeSep = dateParts.getTimeSeparator) === null || _dateParts$getTimeSep === void 0 ? void 0 : _dateParts$getTimeSep.call(dateParts));
    if (timeSeparator !== ':') {
