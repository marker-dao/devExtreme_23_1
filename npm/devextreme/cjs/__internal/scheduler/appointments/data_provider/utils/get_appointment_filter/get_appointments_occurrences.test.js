/**
* DevExtreme (cjs/__internal/scheduler/appointments/data_provider/utils/get_appointment_filter/get_appointments_occurrences.test.js)
* Version: 25.2.0
...
(0, _globals.describe)('getAppointmentsOccurrences', () => {
  ...
  (0, _globals.it)('should return appointment occurrences for appointment with exceptions', () => {
    const exception1 = (0, _m_recurrence.getRecurrenceProcessor)().getAsciiStringByDate(new Date(2000, 0, 11, 10));
    const exception2 = (0, _m_recurrence.getRecurrenceProcessor)().getAsciiStringByDate(new Date(2000, 0, 12, 10));
    const exception3 = (0, _m_recurrence.getRecurrenceProcessor)().getAsciiStringByDate(new Date(2000, 0, 13, 10));
    const appointment = {
      startDate: new Date(2000, 0, 9, 10),
      endDate: new Date(2000, 0, 9, 11),
