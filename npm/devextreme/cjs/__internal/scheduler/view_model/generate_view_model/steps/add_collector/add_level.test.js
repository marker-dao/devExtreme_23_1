...
(0, _globals.describe)('addLevel', () => {
  (0, _globals.it)('should add 0 level for non-overlapping appointments', () => {
    ...
    (0, _globals.expect)((0, _add_level.addLevel)(items, collectorOptions)).toEqual([_extends({}, items[0], {
      level: 0,
      maxLevel: 3,
  ...
  (0, _globals.it)('should add levels from min to max for overlapping appointments', () => {
    ...
    (0, _globals.expect)((0, _add_level.addLevel)(items, _extends({}, collectorOptions, {
      maxLevel: 10
