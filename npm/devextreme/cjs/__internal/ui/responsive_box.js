...
class ResponsiveBox extends _uiCollection_widget.default {
  ...
  _sizesByScreen(sizeConfigs) {
    ...
    return (0, _iterator.map)(this._filterByScreen(sizeConfigs),
    // eslint-disable-next-line @typescript-eslint/no-unsafe-return
    sizeConfig => (0, _extend.extend)(this._defaultSizeConfig(), sizeConfig));
  }
  ...
  _clearItemNodeTemplates() {
    ...
    (0, _iterator.each)(items, function clearTemplates() {
