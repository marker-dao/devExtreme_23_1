...
class ListSearch extends _m_list.default {
  ...
  _initDataSource() {
    ...
    if (searchMode !== null && searchMode !== void 0 && searchMode.length) {
      dataController.searchOperation((0, _m_search_box_mixin.getOperationBySearchMode)(searchMode));
    }
    if (searchExpr) {
    ...
    switch (args.name) {
      ...
      case 'searchValue':
        ...
        if (args.name === 'searchMode') {
          this._dataSource.searchOperation((0, _m_search_box_mixin.getOperationBySearchMode)(args.value));
        } else {
