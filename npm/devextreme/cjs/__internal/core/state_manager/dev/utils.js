/**
* DevExtreme (cjs/__internal/core/state_manager/dev/utils.js)
* Version: 25.2.0
...
exports.isValidStatePath = isValidStatePath;
exports.joinStatePath = joinStatePath;
exports.splitStatePath = splitStatePath;
function joinStatePath(stateId, propertyName) {
  let separator = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '.';
  return [stateId, propertyName].join(separator);
}
function splitStatePath(statePath) {
