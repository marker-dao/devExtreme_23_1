...
class DataController {
  constructor(columnsController, options, sortingController, filterController) {
    ...
    this.dataSource = (0, _signalsCore.computed)(() => (0, _utils.normalizeDataSource)(this.dataSourceConfiguration.value, this.keyExpr.value));
    // TODO
    ...
    this.normalizedRemoteOptions = (0, _signalsCore.computed)(() => {
      ...
      return (0, _utils.normalizeRemoteOptions)(this.remoteOperations.value, (0, _utils.isLocalStore)(store), (0, _utils.isCustomStore)(store));
    });
    this.normalizedLocalOperations = (0, _signalsCore.computed)(() => (0, _utils.normalizeLocalOptions)(this.normalizedRemoteOptions.value));
    ...
    (0, _signalsCore.effect)(() => {
      ...
      if (!(0, _m_common.equalByValue)(dataSource.filter(), displayFilter, {
  ...
  onChanged(dataSource, e) {
    ...
    if (e !== null && e !== void 0 && e.changes) {
      ...
      items = (0, _utils.updateItemsImmutable)(items, e.changes, dataSource.store());
    }
