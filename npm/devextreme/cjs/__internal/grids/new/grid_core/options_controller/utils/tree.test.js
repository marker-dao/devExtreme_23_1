/**
* DevExtreme (cjs/__internal/grids/new/grid_core/options_controller/utils/tree.test.js)
* Version: 25.1.0
...
(0, _globals.describe)('OptionsController', () => {
  (0, _globals.describe)('TreeUtils', () => {
    ...
    (0, _globals.describe)('mergeOptionTrees', () => {
      (0, _globals.it)('should only shallow copy root if path contains error at first place', () => {
        const tree = {
          a: {
            b: {
              c: {
      ...
      (0, _globals.it)('should shallow copy subtree path until faced the wrong node path', () => {
        const tree = {
          a: {
            b: {
              c: {
