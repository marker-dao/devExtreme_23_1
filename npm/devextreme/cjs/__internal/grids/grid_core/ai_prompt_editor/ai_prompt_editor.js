...
class AIPromptEditor {
  ...
  getTextAreaConfig() {
    return Object.assign({
      ...
      onValueChanged: e => {
        this.updateButtonOption(_const.APPLY_BUTTON_INDEX, 'disabled', !e.value || e.value === this.prompt); // Update the disable state of the Apply button
        this.updateButtonOption(_const.REGENERATE_DATA_BUTTON_INDEX, 'disabled', !e.value || e.value !== this.prompt); // Update the disable state of the Regenerate Data button
      },
