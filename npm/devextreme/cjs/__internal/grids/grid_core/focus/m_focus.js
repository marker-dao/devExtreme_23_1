...
const editorFactory = Base => class FocusEditorFactoryExtender extends Base {
  renderFocusOverlay($element, isHideBorder) {
    ...
    if (!focusedRowEnabled || !((_this$_keyboardNaviga = this._keyboardNavigationController) !== null && _this$_keyboardNaviga !== void 0 && _this$_keyboardNaviga.isRowFocusType()) || this._editingController.isEditing() || this._columnHeadersView.isFilterRowCell($element)) {
