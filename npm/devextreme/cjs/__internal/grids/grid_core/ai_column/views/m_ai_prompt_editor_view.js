...
class AIPromptEditorView extends _m_modules.View {
  getAIPromptEditorConfig(column) {
    ...
    return {
      ...
      editorOptions: Object.assign({}, (_column$ai3 = column.ai) === null || _column$ai3 === void 0 ? void 0 : _column$ai3.editorOptions)
    };
  }
  ...
  aiColumnOptionChanged(column, optionName, value) {
    ...
    if (isPromptOptionName && ((0, _utils.isAIColumnAutoMode)(column) || (_this$promptEditorIns6 = this.promptEditorInstance) !== null && _this$promptEditorIns6 !== void 0 && _this$promptEditorIns6.isApplying())) {
      var _this$promptEditorIns7;
      this.aiColumnController.sendRequest(column.name, false, !((_this$promptEditorIns7 = this.promptEditorInstance) !== null && _this$promptEditorIns7 !== void 0 && _this$promptEditorIns7.isVisible()));
    }
