...
import { getEscapedFileName, getFileExtension, getName, getPathParts, PATH_SEPARATOR, pathCombine } from '../file_management/utils';
class FileSystemItem {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  constructor() {
    if (isString(arguments.length <= 0 ? undefined : arguments[0])) {
      this._publicCtor(arguments.length <= 0 ? undefined : arguments[0], arguments.length <= 1 ? undefined : arguments[1], arguments.length <= 2 ? undefined : arguments[2]);
    } else {
      this._internalCtor(arguments.length <= 0 ? undefined : arguments[0], arguments.length <= 1 ? undefined : arguments[1], arguments.length <= 2 ? undefined : arguments[2], arguments.length <= 3 ? undefined : arguments[3]);
    }
  }
