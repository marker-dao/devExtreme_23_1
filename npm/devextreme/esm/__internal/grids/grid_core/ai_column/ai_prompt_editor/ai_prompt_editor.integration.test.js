/**
* DevExtreme (esm/__internal/grids/grid_core/ai_column/ai_prompt_editor/ai_prompt_editor.integration.test.js)
* Version: 25.2.0
...
const createAIPromptEditor = function () {
  ...
  const instance = new AIPromptEditor(_extends({}, options, {
    container,
