...
export class AIPromptEditorView extends View {
  ...
  aiColumnOptionChanged(column, optionName, value) {
    ...
    if (isPromptOptionName && (isAIColumnAutoMode(column) || (_this$promptEditorIns6 = this.promptEditorInstance) !== null && _this$promptEditorIns6 !== void 0 && _this$promptEditorIns6.isApplying())) {
