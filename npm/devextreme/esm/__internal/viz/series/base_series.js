...
import { isDefined as _isDefined, isEmptyObject as _isEmptyObject, isFunction } from '../../../core/utils/type';
...
_extend(
// @ts-expect-error
seriesNS.mixins.chart, lineSeries.chart, areaSeries.chart, barSeries.chart, rangeSeriesChart, bubbleSeriesChart, financialSeries, stackedSeries.chart);
// @ts-expect-error
