...
import { getCategoriesInfo, getLog as mathLog, getLogExt as getLog, raiseTo as mathRaise, raiseToExt } from '../../viz/core/utils';
const {
...
function generator(options, getBusinessDelta, calculateTickInterval, calculateMinorTickInterval, getMajorTickIntervalByCustomTicks, getMinorTickIntervalByCustomTicks, convertTickInterval, calculateTicks, calculateMinorTicks, processScaleBreaks) {
  ...
  function generateMajorTicks(ticks, data, businessDelta, screenDelta, tickInterval, forceTickInterval, customTicks, breaks) {
    ...
    tickInterval = calculateTickInterval(businessDelta, screenDelta, tickInterval, forceTickInterval, options.axisDivisionFactor, options.numberMultipliers, options.allowDecimals, breaks.length,
    // eslint-disable-next-line @typescript-eslint/prefer-optional-chain
    gaps[0] && gaps[0].gapSize.days, options.minTickInterval);
