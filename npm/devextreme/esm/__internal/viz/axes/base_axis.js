...
import { calculateCanvasMargins, measureLabels } from '../../viz/axes/axes_utils';
import createConstantLine from '../../viz/axes/constant_line';
import * as polarMethods from '../../viz/axes/polar_axes';
import { formatRange, smartFormatter as _format } from '../../viz/axes/smart_formatter';
import createStrip from '../../viz/axes/strip';
import { tick } from '../../viz/axes/tick';
import { tickGenerator } from '../../viz/axes/tick_generator';
import xyMethods from '../../viz/axes/xy_axes';
import { getParser } from '../../viz/components/parse_utils';
import { adjustVisualRange, convertVisualRangeObject, getAddFunction, getCategoriesInfo, getLogExt as getLog, getVizRangeObject, patchFontOptions, raiseToExt as raiseTo, rotateBBox, valueOf } from '../core/utils';
...
Axis.prototype = {
  ...
  dispose() {
    const that = this;
    [that._axisElementsGroup, that._axisStripGroup, that._axisGroup].forEach(g => {
      g.dispose();
    });
