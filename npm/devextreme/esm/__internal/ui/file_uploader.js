...
class FileUploader extends Editor {
  ...
  _updateFileNameMaxWidth() {
    ...
    const filesContainerWidth = getWidth((_this$_$filesContaine = this._$filesContainer) === null || _this$_$filesContaine === void 0 ? void 0 : _this$_$filesContaine.find(`.${FILEUPLOADER_FILE_CONTAINER_CLASS}`).first()) || getWidth(this._$filesContainer);
