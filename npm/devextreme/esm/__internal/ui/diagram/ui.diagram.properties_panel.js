...
class DiagramPropertiesPanel extends DiagramFloatingPanel {
  ...
  _renderTabPanel($parent) {
    ...
    this._tabPanel = this._createComponent($tabPanel, TabPanel, {
      ...
      onContentReady: e => {
        var _this$_popup;
        (_this$_popup = this._popup) === null || _this$_popup === void 0 || _this$_popup.option('height', getHeight(e.component.$element()) + this._getVerticalPaddingsAndBorders());
  ...
  _renderTabContent($parent, tab, index, isSingleTab) {
    ...
    if (isSingleTab) {
      var _this$_popup2;
      (_this$_popup2 = this._popup) === null || _this$_popup2 === void 0 || _this$_popup2.option('height', getHeight(scrollView.$element()) + this._getVerticalPaddingsAndBorders());
    } else {
