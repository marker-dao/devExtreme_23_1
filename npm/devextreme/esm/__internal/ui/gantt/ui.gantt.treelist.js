...
import { GanttTreeListNodesState } from '../../ui/gantt/ui.gantt.treelist.nodes_state';
...
export class GanttTreeList {
  ...
  getRowHeight() {
    ...
    let height = $row !== null && $row !== void 0 && $row.length ? getBoundingRect($row === null || $row === void 0 ? void 0 : $row.last().get(0)).height : GANTT_DEFAULT_ROW_HEIGHT;
    if (!height) {
  ...
  getHeaderHeight() {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unsafe-return
    return getBoundingRect((_this$_treeList8 = this._treeList) === null || _this$_treeList8 === void 0 ? void 0 : _this$_treeList8.$element().find('.dx-treelist-headers').get(0)).height;
  }
  getColumns() {
    const {
      columns
