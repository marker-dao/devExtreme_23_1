...
import { getEscapedFileName, getFileExtension, getPathParts, pathCombine } from '../../file_management/utils';
import { whenSome } from '../../ui/file_manager/ui.file_manager.common';
...
export class FileItemsController {
  ...
  abortFileUpload(fileData, chunksInfo, destinationDirectory) {
    ...
    return when((_this$_fileProvider8 = this._fileProvider) === null || _this$_fileProvider8 === void 0 ? void 0 : _this$_fileProvider8.abortFileUpload(fileData, chunksInfo, destinationDirectory));
  }
  // eslint-disable-next-line @typescript-eslint/explicit-function-return-type
  ...
  downloadItems(itemInfos) {
    ...
    () => {
      ...
      return when(this._getItemActionResult((_this$_fileProvider0 = this._fileProvider) === null || _this$_fileProvider0 === void 0 ? void 0 : _this$_fileProvider0.downloadItems(items))).then(() => {}, errorInfo => {
  ...
  getItemContent(itemInfos) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unsafe-return
    const items = itemInfos.map(i => i.fileItem);
    return when((_this$_fileProvider1 = this._fileProvider) === null || _this$_fileProvider1 === void 0 ? void 0 : _this$_fileProvider1.getItemsContent(items));
  }
  // eslint-disable-next-line @typescript-eslint/explicit-function-return-type
