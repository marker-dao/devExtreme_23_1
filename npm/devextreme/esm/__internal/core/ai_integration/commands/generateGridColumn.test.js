...
describe('GenerateGridColumnCommand', () => {
  ...
  describe('execute', () => {
    ...
    it('promptManager.buildPrompt should should return prompt with passed values', () => {
      ...
      command.execute(params, callbacks);
      const expectedUserPrompt = (_templates$generateGr = templates.generateGridColumn.user) === null || _templates$generateGr === void 0 ? void 0 : _templates$generateGr.replace('{{text}}', USER_TEXT).replace('{{data}}', PROCESSED_DATA);
