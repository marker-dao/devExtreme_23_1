...
(["artifacts/transpiled-renovation/localization/number.js"], ["../core/utils/dependency_injector","../core/utils/common","../core/utils/iterator","../core/utils/type","./ldml/number","../core/config","../core/errors","./utils","./currency","./intl/number"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/localization/number.js", ["../core/utils/dependency_injector", "../core/utils/common", "../core/utils/iterator", "../core/utils/type", "./ldml/number", "../core/config", "../core/errors", "./utils", "./currency", "./intl/number"], true, function ($__require, exports, module) {
  "use strict";
