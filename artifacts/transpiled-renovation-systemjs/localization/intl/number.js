...
(["artifacts/transpiled-renovation/localization/intl/number.js"], ["../../core/config","../core","../open_xml_currency_format","../cldr-data/accounting_formats"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/localization/intl/number.js", ["../../core/config", "../core", "../open_xml_currency_format", "../cldr-data/accounting_formats"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _accounting_formats = _interopRequireDefault($__require("../cldr-data/accounting_formats"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/config","../core","../open_xml_currency_format","../cldr-data/accounting_formats"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/config"), require("../core"), require("../open_xml_currency_format"), require("../cldr-data/accounting_formats"));
  else
