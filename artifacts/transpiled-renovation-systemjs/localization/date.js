...
(["artifacts/transpiled-renovation/localization/date.js"], ["../core/utils/dependency_injector","../core/utils/type","../core/utils/iterator","../core/errors","./ldml/date.formatter","./ldml/date.format","./ldml/date.parser","./default_date_names","./cldr-data/first_day_of_week_data","./core","./number","./intl/date"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/localization/date.js", ["../core/utils/dependency_injector", "../core/utils/type", "../core/utils/iterator", "../core/errors", "./ldml/date.formatter", "./ldml/date.format", "./ldml/date.parser", "./default_date_names", "./cldr-data/first_day_of_week_data", "./core", "./number", "./intl/date"], true, function ($__require, exports, module) {
  "use strict";
