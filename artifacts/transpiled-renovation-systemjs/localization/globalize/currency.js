...
(["artifacts/transpiled-renovation/localization/globalize/currency.js"], ["../open_xml_currency_format","./core","./number","../currency","globalize/currency","globalize","../../core/config","../number"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/localization/globalize/currency.js", ["../open_xml_currency_format", "./core", "./number", "../currency", "globalize/currency", "globalize", "../../core/config", "../number"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  var _open_xml_currency_format = _interopRequireDefault($__require("../open_xml_currency_format"));
  $__require("./core");
  $__require("./number");
  $__require("../currency");
  $__require("globalize/currency");
  var _globalize = _interopRequireDefault($__require("globalize"));
  var _config = _interopRequireDefault($__require("../../core/config"));
  var _number2 = _interopRequireDefault($__require("../number"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../open_xml_currency_format","./core","./number","../currency","globalize/currency","globalize","../../core/config","../number"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../open_xml_currency_format"), require("./core"), require("./number"), require("../currency"), require("globalize/currency"), require("globalize"), require("../../core/config"), require("../number"));
  else
