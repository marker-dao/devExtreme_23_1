...
(["artifacts/transpiled-renovation/localization/globalize/message.js"], ["./core","globalize","../message","../core","globalize/message"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/localization/globalize/message.js", ["./core", "globalize", "../message", "../core", "globalize/message"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _message = _interopRequireDefault($__require("../message"));
  var _core2 = _interopRequireDefault($__require("../core"));
  $__require("globalize/message");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./core","globalize","../message","../core","globalize/message"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./core"), require("globalize"), require("../message"), require("../core"), require("globalize/message"));
  else
