...
(["artifacts/transpiled-renovation/localization.js"], ["./localization/core","./localization/message","./localization/number","./localization/date","./localization/currency"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/localization.js", ["./localization/core", "./localization/message", "./localization/number", "./localization/date", "./localization/currency"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./localization/core","./localization/message","./localization/number","./localization/date","./localization/currency"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./localization/core"), require("./localization/message"), require("./localization/number"), require("./localization/date"), require("./localization/currency"));
  else
