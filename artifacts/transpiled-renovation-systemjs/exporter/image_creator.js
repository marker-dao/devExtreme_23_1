...
(["artifacts/transpiled-renovation/exporter/image_creator.js"], ["../core/renderer","../color","../core/utils/type","../core/utils/svg","../core/utils/iterator","../core/utils/extend","../core/dom_adapter","../core/utils/dom","../core/utils/window","../core/utils/inflector","../core/utils/deferred"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/exporter/image_creator.js", ["../core/renderer", "../color", "../core/utils/type", "../core/utils/svg", "../core/utils/iterator", "../core/utils/extend", "../core/dom_adapter", "../core/utils/dom", "../core/utils/window", "../core/utils/inflector", "../core/utils/deferred"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../core/renderer","../color","../core/utils/type","../core/utils/svg","../core/utils/iterator","../core/utils/extend","../core/dom_adapter","../core/utils/dom","../core/utils/window","../core/utils/inflector","../core/utils/deferred"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../core/renderer"), require("../color"), require("../core/utils/type"), require("../core/utils/svg"), require("../core/utils/iterator"), require("../core/utils/extend"), require("../core/dom_adapter"), require("../core/utils/dom"), require("../core/utils/window"), require("../core/utils/inflector"), require("../core/utils/deferred"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=image_creator.js.map