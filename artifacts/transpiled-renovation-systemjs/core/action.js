...
(["artifacts/transpiled-renovation/core/action.js"], ["./renderer","./utils/window","./utils/type","./utils/iterator"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/action.js", ["./renderer", "./utils/window", "./utils/type", "./utils/iterator"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./renderer","./utils/window","./utils/type","./utils/iterator"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./renderer"), require("./utils/window"), require("./utils/type"), require("./utils/iterator"));
  else
