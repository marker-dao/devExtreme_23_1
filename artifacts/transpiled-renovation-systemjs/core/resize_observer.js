...
(["artifacts/transpiled-renovation/core/resize_observer.js"], ["./utils/common","./utils/window"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/resize_observer.js", ["./utils/common", "./utils/window"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./utils/common","./utils/window"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./utils/common"), require("./utils/window"));
  else
