...
(["artifacts/transpiled-renovation/core/template_manager.js"], ["./renderer","./utils/type","./utils/common","./utils/extend","./templates/function_template","./templates/empty_template","./utils/template_manager"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/template_manager.js", ["./renderer", "./utils/type", "./utils/common", "./utils/extend", "./templates/function_template", "./templates/empty_template", "./utils/template_manager"], true, function ($__require, exports, module) {
  "use strict";
