...
(["artifacts/transpiled-renovation/core/component_registrator.js"], ["./renderer","./component_registrator_callbacks","./errors","./utils/public_component"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/component_registrator.js", ["./renderer", "./component_registrator_callbacks", "./errors", "./utils/public_component"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _component_registrator_callbacks = _interopRequireDefault($__require("./component_registrator_callbacks"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./renderer","./component_registrator_callbacks","./errors","./utils/public_component"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./renderer"), require("./component_registrator_callbacks"), require("./errors"), require("./utils/public_component"));
  else
