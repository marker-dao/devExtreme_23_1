...
(["artifacts/transpiled-renovation/core/element_data.js"], ["./dom_adapter","../events/core/events_engine","./memorized_callbacks"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/element_data.js", ["./dom_adapter", "../events/core/events_engine", "./memorized_callbacks"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _memorized_callbacks = _interopRequireDefault($__require("./memorized_callbacks"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./dom_adapter","../events/core/events_engine","./memorized_callbacks"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./dom_adapter"), require("../events/core/events_engine"), require("./memorized_callbacks"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=element_data.js.map