...
(["artifacts/transpiled-renovation/core/dom_component.js"], ["../core/renderer","./config","./errors","../core/utils/resize_callbacks","./component","./template_manager","./utils/public_component","./utils/shadow_dom","./element_data","./utils/iterator","./utils/extend","../core/element","./utils/common","./utils/type","../core/utils/window","../events/short"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/dom_component.js", ["../core/renderer", "./config", "./errors", "../core/utils/resize_callbacks", "./component", "./template_manager", "./utils/public_component", "./utils/shadow_dom", "./element_data", "./utils/iterator", "./utils/extend", "../core/element", "./utils/common", "./utils/type", "../core/utils/window", "../events/short"], true, function ($__require, exports, module) {
  "use strict";
