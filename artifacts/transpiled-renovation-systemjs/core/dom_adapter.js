...
(["artifacts/transpiled-renovation/core/dom_adapter.js"], ["./utils/dependency_injector","./utils/common","./utils/shadow_dom"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/dom_adapter.js", ["./utils/dependency_injector", "./utils/common", "./utils/shadow_dom"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./utils/dependency_injector","./utils/common","./utils/shadow_dom"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./utils/dependency_injector"), require("./utils/common"), require("./utils/shadow_dom"));
  else
