...
(["artifacts/transpiled-renovation/core/templates/template_base.js"], ["../renderer","../dom_adapter","../utils/callbacks","../utils/dom","../../events/visibility_change","../errors"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/templates/template_base.js", ["../renderer", "../dom_adapter", "../utils/callbacks", "../utils/dom", "../../events/visibility_change", "../errors"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../renderer","../dom_adapter","../utils/callbacks","../utils/dom","../../events/visibility_change","../errors"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../renderer"), require("../dom_adapter"), require("../utils/callbacks"), require("../utils/dom"), require("../../events/visibility_change"), require("../errors"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=template_base.js.map