...
(["artifacts/transpiled-renovation/core/templates/template.js"], ["../renderer","./template_base","../utils/dom","./template_engine_registry"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/templates/template.js", ["../renderer", "./template_base", "../utils/dom", "./template_engine_registry"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _template_engine_registry = $__require("./template_engine_registry");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../renderer","./template_base","../utils/dom","./template_engine_registry"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../renderer"), require("./template_base"), require("../utils/dom"), require("./template_engine_registry"));
  else
