...
(["artifacts/transpiled-renovation/core/utils/template_manager.js"], ["../config","../devices","../errors","../renderer","../templates/child_default_template","../templates/empty_template","../templates/template","../templates/template_base","./array","./common","./dom","./extend","./type"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/utils/template_manager.js", ["../config", "../devices", "../errors", "../renderer", "../templates/child_default_template", "../templates/empty_template", "../templates/template", "../templates/template_base", "./array", "./common", "./dom", "./extend", "./type"], true, function ($__require, exports, module) {
  "use strict";
