...
(["artifacts/transpiled-renovation/core/utils/array.js"], ["./type","./object","../config"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/utils/array.js", ["./type", "./object", "../config"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _config2 = _interopRequireDefault($__require("../config"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./type","./object","../config"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./type"), require("./object"), require("../config"));
  else
