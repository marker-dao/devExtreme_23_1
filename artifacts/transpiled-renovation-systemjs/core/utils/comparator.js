...
(["artifacts/transpiled-renovation/core/utils/comparator.js"], ["../dom_adapter","./data","./type"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/utils/comparator.js", ["../dom_adapter", "./data", "./type"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../dom_adapter","./data","./type"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../dom_adapter"), require("./data"), require("./type"));
  else
