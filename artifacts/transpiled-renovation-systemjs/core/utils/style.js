...
(["artifacts/transpiled-renovation/core/utils/style.js"], ["./inflector","./call_once","./type","../dom_adapter"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/utils/style.js", ["./inflector", "./call_once", "./type", "../dom_adapter"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./inflector","./call_once","./type","../dom_adapter"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./inflector"), require("./call_once"), require("./type"), require("../dom_adapter"));
  else
