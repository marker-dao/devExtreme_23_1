...
(["artifacts/transpiled-renovation/core/utils/support.js"], ["../dom_adapter","./call_once","./window","../devices","./style"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/utils/support.js", ["../dom_adapter", "./call_once", "./window", "../devices", "./style"], true, function ($__require, exports, module) {
  "use strict";
