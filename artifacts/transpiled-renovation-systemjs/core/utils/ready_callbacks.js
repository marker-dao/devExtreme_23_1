...
(["artifacts/transpiled-renovation/core/utils/ready_callbacks.js"], ["../dom_adapter","./dependency_injector","./window","./call_once"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/utils/ready_callbacks.js", ["../dom_adapter", "./dependency_injector", "./window", "./call_once"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../dom_adapter","./dependency_injector","./window","./call_once"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../dom_adapter"), require("./dependency_injector"), require("./window"), require("./call_once"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ready_callbacks.js.map