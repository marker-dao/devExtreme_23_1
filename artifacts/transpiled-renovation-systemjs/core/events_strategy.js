...
(["artifacts/transpiled-renovation/core/events_strategy.js"], ["./utils/callbacks","./utils/iterator","./utils/type"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/events_strategy.js", ["./utils/callbacks", "./utils/iterator", "./utils/type"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./utils/callbacks","./utils/iterator","./utils/type"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./utils/callbacks"), require("./utils/iterator"), require("./utils/type"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=events_strategy.js.map