...
(["artifacts/transpiled-renovation/core/inferno_renderer.js"], ["inferno","@devextreme/runtime/inferno","inferno-create-element","./dom_adapter","./element_data","./utils/dependency_injector"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/inferno_renderer.js", ["inferno", "@devextreme/runtime/inferno", "inferno-create-element", "./dom_adapter", "./element_data", "./utils/dependency_injector"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _infernoCreateElement = $__require("inferno-create-element");
  var _dom_adapter = _interopRequireDefault($__require("./dom_adapter"));
  var _element_data = $__require("./element_data");
  var _dependency_injector = _interopRequireDefault($__require("./utils/dependency_injector"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","inferno-create-element","./dom_adapter","./element_data","./utils/dependency_injector"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("inferno-create-element"), require("./dom_adapter"), require("./element_data"), require("./utils/dependency_injector"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=inferno_renderer.js.map