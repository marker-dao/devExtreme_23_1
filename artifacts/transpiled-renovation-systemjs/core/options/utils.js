...
(["artifacts/transpiled-renovation/core/options/utils.js"], ["../devices","../utils/type","../utils/common","../utils/extend","../utils/data"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/options/utils.js", ["../devices", "../utils/type", "../utils/common", "../utils/extend", "../utils/data"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../devices","../utils/type","../utils/common","../utils/extend","../utils/data"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../devices"), require("../utils/type"), require("../utils/common"), require("../utils/extend"), require("../utils/data"));
  else
