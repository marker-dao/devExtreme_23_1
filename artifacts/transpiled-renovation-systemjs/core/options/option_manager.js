...
(["artifacts/transpiled-renovation/core/options/option_manager.js"], ["../utils/data","../utils/common","../utils/comparator","../utils/extend","../utils/type","./utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/options/option_manager.js", ["../utils/data", "../utils/common", "../utils/comparator", "../utils/extend", "../utils/type", "./utils"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _comparator = $__require("../utils/comparator");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../utils/data","../utils/common","../utils/comparator","../utils/extend","../utils/type","./utils"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../utils/data"), require("../utils/common"), require("../utils/comparator"), require("../utils/extend"), require("../utils/type"), require("./utils"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=option_manager.js.map