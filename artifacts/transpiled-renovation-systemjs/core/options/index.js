...
(["artifacts/transpiled-renovation/core/options/index.js"], ["../utils/type","../utils/common","./option_manager","../utils/data","./utils","../utils/extend"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/options/index.js", ["../utils/type", "../utils/common", "./option_manager", "../utils/data", "./utils", "../utils/extend"], true, function ($__require, exports, module) {
  "use strict";
