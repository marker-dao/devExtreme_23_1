...
(["artifacts/transpiled-renovation/core/postponed_operations.js"], ["./utils/deferred","./utils/type"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/core/postponed_operations.js", ["./utils/deferred", "./utils/type"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./utils/deferred","./utils/type"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./utils/deferred"), require("./utils/type"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=postponed_operations.js.map