...
(["artifacts/transpiled-renovation/data/remote_query.js"], ["./query_adapters","./errors","../core/utils/iterator","../core/utils/type","../core/utils/deferred","./array_query"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/data/remote_query.js", ["./query_adapters", "./errors", "../core/utils/iterator", "../core/utils/type", "../core/utils/deferred", "./array_query"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./query_adapters","./errors","../core/utils/iterator","../core/utils/type","../core/utils/deferred","./array_query"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./query_adapters"), require("./errors"), require("../core/utils/iterator"), require("../core/utils/type"), require("../core/utils/deferred"), require("./array_query"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=remote_query.js.map