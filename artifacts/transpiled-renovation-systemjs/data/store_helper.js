...
(["artifacts/transpiled-renovation/data/store_helper.js"], ["../core/utils/common","../core/utils/extend","../core/utils/iterator","./array_query","./utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/data/store_helper.js", ["../core/utils/common", "../core/utils/extend", "../core/utils/iterator", "./array_query", "./utils"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../core/utils/common","../core/utils/extend","../core/utils/iterator","./array_query","./utils"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../core/utils/common"), require("../core/utils/extend"), require("../core/utils/iterator"), require("./array_query"), require("./utils"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=store_helper.js.map