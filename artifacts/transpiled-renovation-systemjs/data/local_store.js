...
(["artifacts/transpiled-renovation/data/local_store.js"], ["../events/core/events_engine","../core/dom_adapter","../core/utils/window","../core/class","./errors","./array_store"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/data/local_store.js", ["../events/core/events_engine", "../core/dom_adapter", "../core/utils/window", "../core/class", "./errors", "./array_store"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../events/core/events_engine","../core/dom_adapter","../core/utils/window","../core/class","./errors","./array_store"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../events/core/events_engine"), require("../core/dom_adapter"), require("../core/utils/window"), require("../core/class"), require("./errors"), require("./array_store"));
  else
