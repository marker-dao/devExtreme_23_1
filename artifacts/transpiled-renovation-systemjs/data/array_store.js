...
(["artifacts/transpiled-renovation/data/array_store.js"], ["./utils","./query","./errors","./abstract_store","./array_utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/data/array_store.js", ["./utils", "./query", "./errors", "./abstract_store", "./array_utils"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./utils","./query","./errors","./abstract_store","./array_utils"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./utils"), require("./query"), require("./errors"), require("./abstract_store"), require("./array_utils"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=array_store.js.map