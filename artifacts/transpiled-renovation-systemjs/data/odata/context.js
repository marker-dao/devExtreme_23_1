...
(["artifacts/transpiled-renovation/data/odata/context.js"], ["../../core/class","../../core/utils/extend","../../core/utils/type","../../core/utils/iterator","../errors","./store","./request_dispatcher","./utils","../../core/utils/deferred","./query_adapter"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/data/odata/context.js", ["../../core/class", "../../core/utils/extend", "../../core/utils/type", "../../core/utils/iterator", "../errors", "./store", "./request_dispatcher", "./utils", "../../core/utils/deferred", "./query_adapter"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _store = _interopRequireDefault($__require("./store"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/class","../../core/utils/extend","../../core/utils/type","../../core/utils/iterator","../errors","./store","./request_dispatcher","./utils","../../core/utils/deferred","./query_adapter"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/class"), require("../../core/utils/extend"), require("../../core/utils/type"), require("../../core/utils/iterator"), require("../errors"), require("./store"), require("./request_dispatcher"), require("./utils"), require("../../core/utils/deferred"), require("./query_adapter"));
  else
