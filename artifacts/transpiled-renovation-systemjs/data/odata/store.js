...
(["artifacts/transpiled-renovation/data/odata/store.js"], ["../../core/utils/type","../../core/config","./utils","../errors","../query","../abstract_store","./request_dispatcher","../../core/utils/deferred","./query_adapter"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/data/odata/store.js", ["../../core/utils/type", "../../core/config", "./utils", "../errors", "../query", "../abstract_store", "./request_dispatcher", "../../core/utils/deferred", "./query_adapter"], true, function ($__require, exports, module) {
  "use strict";
