...
(["artifacts/transpiled-renovation/integration/knockout/components.js"], ["knockout","../../core/utils/icon"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/integration/knockout/components.js", ["knockout", "../../core/utils/icon"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["knockout","../../core/utils/icon"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("knockout"), require("../../core/utils/icon"));
  else
