...
(["artifacts/transpiled-renovation/renovation/component_wrapper/editors/check_box.js"], ["./editor"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/component_wrapper/editors/check_box.js", ["./editor"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.default = void 0;
  var _editor = _interopRequireDefault($__require("./editor"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    ...
    module.exports = factory(require("./editor"));
  else
