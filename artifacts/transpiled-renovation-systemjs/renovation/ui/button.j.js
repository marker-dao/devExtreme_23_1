...
(["artifacts/transpiled-renovation/renovation/ui/button.j.js"], ["../../core/component_registrator","../component_wrapper/button","./button"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/button.j.js", ["../../core/component_registrator", "../component_wrapper/button", "./button"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _button = _interopRequireDefault($__require("../component_wrapper/button"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/component_registrator","../component_wrapper/button","./button"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/component_registrator"), require("../component_wrapper/button"), require("./button"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=button.j.js.map