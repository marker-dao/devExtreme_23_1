...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/utils/semaphore/scrollSemaphore.js"], ["./semaphore"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/utils/semaphore/scrollSemaphore.js", ["./semaphore"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.ScrollSemaphore = void 0;
  var _semaphore = $__require("./semaphore");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./semaphore"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./semaphore"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=scrollSemaphore.js.map