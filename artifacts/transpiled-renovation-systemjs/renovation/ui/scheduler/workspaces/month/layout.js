...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/month/layout.js"], ["inferno","@devextreme/runtime/inferno","../base/ordinary_layout","../base/layout_props"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/month/layout.js", ["inferno", "@devextreme/runtime/inferno", "../base/ordinary_layout", "../base/layout_props"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _ordinary_layout = $__require("../base/ordinary_layout");
  var _layout_props = $__require("../base/layout_props");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../base/ordinary_layout","../base/layout_props"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../base/ordinary_layout"), require("../base/layout_props"));
  else
