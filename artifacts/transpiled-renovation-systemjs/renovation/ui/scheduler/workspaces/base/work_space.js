...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/base/work_space.js"], ["inferno","@devextreme/runtime/inferno","../../../../utils/subscribe_to_event","../../../../utils/combine_classes","./ordinary_layout","../../../../../ui/scheduler/workspaces/ui.scheduler.virtual_scrolling","../../../../../ui/scheduler/workspaces/view_model/view_data_provider","./utils","../props","./work_space_config","../utils","./cross_scrolling_layout","../../../../../ui/scheduler/workspaces/view_model/utils","../../view_model/to_test/views/utils/base","../../../../../ui/scheduler/workspaces/view_model/date_header_data_generator","../../../../../ui/scheduler/workspaces/view_model/time_panel_data_generator","../../../../../ui/scheduler/workspaces/cells_selection_controller","../../view_model/group_panel/utils","../../../../../core/utils/window","../../../../../core/dom_adapter","../../../../common/config_context","../../../../../events/pointer","../../../../../events/core/events_engine","../../../../../events/utils/index","../const","../../../../utils/diagnostic"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/base/work_space.js", ["inferno", "@devextreme/runtime/inferno", "../../../../utils/subscribe_to_event", "../../../../utils/combine_classes", "./ordinary_layout", "../../../../../ui/scheduler/workspaces/ui.scheduler.virtual_scrolling", "../../../../../ui/scheduler/workspaces/view_model/view_data_provider", "./utils", "../props", "./work_space_config", "../utils", "./cross_scrolling_layout", "../../../../../ui/scheduler/workspaces/view_model/utils", "../../view_model/to_test/views/utils/base", "../../../../../ui/scheduler/workspaces/view_model/date_header_data_generator", "../../../../../ui/scheduler/workspaces/view_model/time_panel_data_generator", "../../../../../ui/scheduler/workspaces/cells_selection_controller", "../../view_model/group_panel/utils", "../../../../../core/utils/window", "../../../../../core/dom_adapter", "../../../../common/config_context", "../../../../../events/pointer", "../../../../../events/core/events_engine", "../../../../../events/utils/index", "../const", "../../../../utils/diagnostic"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _ordinary_layout = $__require("./ordinary_layout");
  var _uiScheduler = $__require("../../../../../ui/scheduler/workspaces/ui.scheduler.virtual_scrolling");
  var _view_data_provider = _interopRequireDefault($__require("../../../../../ui/scheduler/workspaces/view_model/view_data_provider"));
  var _utils = $__require("./utils");
  var _props = $__require("../props");
  var _work_space_config = $__require("./work_space_config");
  var _utils2 = $__require("../utils");
  var _cross_scrolling_layout = $__require("./cross_scrolling_layout");
  var _utils3 = $__require("../../../../../ui/scheduler/workspaces/view_model/utils");
  var _base = $__require("../../view_model/to_test/views/utils/base");
  var _date_header_data_generator = $__require("../../../../../ui/scheduler/workspaces/view_model/date_header_data_generator");
  var _time_panel_data_generator = $__require("../../../../../ui/scheduler/workspaces/view_model/time_panel_data_generator");
  var _cells_selection_controller = $__require("../../../../../ui/scheduler/workspaces/cells_selection_controller");
  var _utils4 = $__require("../../view_model/group_panel/utils");
  ...
  var _diagnostic = $__require("../../../../utils/diagnostic");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../../../../utils/subscribe_to_event","../../../../utils/combine_classes","./ordinary_layout","../../../../../ui/scheduler/workspaces/ui.scheduler.virtual_scrolling","../../../../../ui/scheduler/workspaces/view_model/view_data_provider","./utils","../props","./work_space_config","../utils","./cross_scrolling_layout","../../../../../ui/scheduler/workspaces/view_model/utils","../../view_model/to_test/views/utils/base","../../../../../ui/scheduler/workspaces/view_model/date_header_data_generator","../../../../../ui/scheduler/workspaces/view_model/time_panel_data_generator","../../../../../ui/scheduler/workspaces/cells_selection_controller","../../view_model/group_panel/utils","../../../../../core/utils/window","../../../../../core/dom_adapter","../../../../common/config_context","../../../../../events/pointer","../../../../../events/core/events_engine","../../../../../events/utils/index","../const","../../../../utils/diagnostic"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../../../../utils/subscribe_to_event"), require("../../../../utils/combine_classes"), require("./ordinary_layout"), require("../../../../../ui/scheduler/workspaces/ui.scheduler.virtual_scrolling"), require("../../../../../ui/scheduler/workspaces/view_model/view_data_provider"), require("./utils"), require("../props"), require("./work_space_config"), require("../utils"), require("./cross_scrolling_layout"), require("../../../../../ui/scheduler/workspaces/view_model/utils"), require("../../view_model/to_test/views/utils/base"), require("../../../../../ui/scheduler/workspaces/view_model/date_header_data_generator"), require("../../../../../ui/scheduler/workspaces/view_model/time_panel_data_generator"), require("../../../../../ui/scheduler/workspaces/cells_selection_controller"), require("../../view_model/group_panel/utils"), require("../../../../../core/utils/window"), require("../../../../../core/dom_adapter"), require("../../../../common/config_context"), require("../../../../../events/pointer"), require("../../../../../events/core/events_engine"), require("../../../../../events/utils/index"), require("../const"), require("../../../../utils/diagnostic"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=work_space.js.map