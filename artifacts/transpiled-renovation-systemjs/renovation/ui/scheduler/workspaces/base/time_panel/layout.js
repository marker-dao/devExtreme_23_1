...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/base/time_panel/layout.js"], ["inferno","@devextreme/runtime/inferno","../row","./cell","../cell","../table","../date_table/all_day_panel/title"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/base/time_panel/layout.js", ["inferno", "@devextreme/runtime/inferno", "../row", "./cell", "../cell", "../table", "../date_table/all_day_panel/title"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _cell2 = $__require("../cell");
  var _table = $__require("../table");
  var _title = $__require("../date_table/all_day_panel/title");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../row","./cell","../cell","../table","../date_table/all_day_panel/title"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../row"), require("./cell"), require("../cell"), require("../table"), require("../date_table/all_day_panel/title"));
  else
