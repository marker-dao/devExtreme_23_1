...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/base/group_panel/group_panel.js"], ["inferno","@devextreme/runtime/inferno","../../utils","./group_panel_props","./vertical/layout","./horizontal/layout","../../../consts"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/base/group_panel/group_panel.js", ["inferno", "@devextreme/runtime/inferno", "../../utils", "./group_panel_props", "./vertical/layout", "./horizontal/layout", "../../../consts"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _group_panel_props = $__require("./group_panel_props");
  var _layout = $__require("./vertical/layout");
  var _layout2 = $__require("./horizontal/layout");
  var _consts = $__require("../../../consts");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../../utils","./group_panel_props","./vertical/layout","./horizontal/layout","../../../consts"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../../utils"), require("./group_panel_props"), require("./vertical/layout"), require("./horizontal/layout"), require("../../../consts"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=group_panel.js.map