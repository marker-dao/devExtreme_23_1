...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/base/work_space_config.js"], ["../../view_model/to_test/views/utils/base","../../view_model/to_test/views/utils/timeline_week","../month/date_table/layout","../timeline/header_panel/layout","./date_table/layout","./header_panel/layout","./utils","../utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/base/work_space_config.js", ["../../view_model/to_test/views/utils/base", "../../view_model/to_test/views/utils/timeline_week", "../month/date_table/layout", "../timeline/header_panel/layout", "./date_table/layout", "./header_panel/layout", "./utils", "../utils"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _timeline_week = $__require("../../view_model/to_test/views/utils/timeline_week");
  var _layout = $__require("../month/date_table/layout");
  var _layout2 = $__require("../timeline/header_panel/layout");
  var _layout3 = $__require("./date_table/layout");
  var _layout4 = $__require("./header_panel/layout");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../view_model/to_test/views/utils/base","../../view_model/to_test/views/utils/timeline_week","../month/date_table/layout","../timeline/header_panel/layout","./date_table/layout","./header_panel/layout","./utils","../utils"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../view_model/to_test/views/utils/base"), require("../../view_model/to_test/views/utils/timeline_week"), require("../month/date_table/layout"), require("../timeline/header_panel/layout"), require("./date_table/layout"), require("./header_panel/layout"), require("./utils"), require("../utils"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=work_space_config.js.map