...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/base/date_table/layout.js"], ["inferno","@devextreme/runtime/inferno","../table","./table_body","../layout_props","./cell"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/base/date_table/layout.js", ["inferno", "@devextreme/runtime/inferno", "../table", "./table_body", "../layout_props", "./cell"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../table","./table_body","../layout_props","./cell"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../table"), require("./table_body"), require("../layout_props"), require("./cell"));
  else
