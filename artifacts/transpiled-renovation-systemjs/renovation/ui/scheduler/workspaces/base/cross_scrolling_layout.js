...
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/base/cross_scrolling_layout.js", ["inferno", "@devextreme/runtime/inferno", "../../../common/widget", "../../../scroll_view/scrollable", "./group_panel/group_panel", "./date_table/all_day_panel/layout", "./header_panel_empty_cell", "./main_layout_props", "../../utils/semaphore/scrollSemaphore", "./time_panel/layout", "../month/date_table/layout", "./date_table/layout", "../timeline/header_panel/layout", "./header_panel/layout", "../../appointment/layout"], true, function ($__require, exports, module) {
  ...
  var _scrollSemaphore = $__require("../../utils/semaphore/scrollSemaphore");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    ...
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../../../common/widget"), require("../../../scroll_view/scrollable"), require("./group_panel/group_panel"), require("./date_table/all_day_panel/layout"), require("./header_panel_empty_cell"), require("./main_layout_props"), require("../../utils/semaphore/scrollSemaphore"), require("./time_panel/layout"), require("../month/date_table/layout"), require("./date_table/layout"), require("../timeline/header_panel/layout"), require("./header_panel/layout"), require("../../appointment/layout"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=cross_scrolling_layout.js.map