...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/base/virtual_cell.js"], ["inferno","@devextreme/runtime/inferno","../utils","./header_cell","./ordinary_cell"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/workspaces/base/virtual_cell.js", ["inferno", "@devextreme/runtime/inferno", "../utils", "./header_cell", "./ordinary_cell"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _header_cell = $__require("./header_cell");
  var _ordinary_cell = $__require("./ordinary_cell");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../utils","./header_cell","./ordinary_cell"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../utils"), require("./header_cell"), require("./ordinary_cell"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=virtual_cell.js.map