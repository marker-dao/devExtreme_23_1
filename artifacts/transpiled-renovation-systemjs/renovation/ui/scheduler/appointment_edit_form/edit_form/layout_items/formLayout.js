...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/appointment_edit_form/edit_form/layout_items/formLayout.js"], ["./description","./const","./groups/dateBoxGroup","./groups/switchGroup"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/appointment_edit_form/edit_form/layout_items/formLayout.js", ["./description", "./const", "./groups/dateBoxGroup", "./groups/switchGroup"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.getFormLayoutConfig = void 0;
  var _description = $__require("./description");
  var _const = $__require("./const");
  var _dateBoxGroup = $__require("./groups/dateBoxGroup");
  var _switchGroup = $__require("./groups/switchGroup");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./description","./const","./groups/dateBoxGroup","./groups/switchGroup"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./description"), require("./const"), require("./groups/dateBoxGroup"), require("./groups/switchGroup"));
  else
