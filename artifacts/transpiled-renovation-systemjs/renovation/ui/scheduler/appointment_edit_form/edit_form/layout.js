...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/appointment_edit_form/edit_form/layout.js"], ["inferno","@devextreme/runtime/inferno","../../../form/wrapper/form","./layout_items/formLayout","../../form_context","./editors/startDateEditor","./editors/endDateEditor","./editors/timeZoneEditor","./editors/switchEditor","./editors/descriptionEditor","../../../../../core/options/utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/appointment_edit_form/edit_form/layout.js", ["inferno", "@devextreme/runtime/inferno", "../../../form/wrapper/form", "./layout_items/formLayout", "../../form_context", "./editors/startDateEditor", "./editors/endDateEditor", "./editors/timeZoneEditor", "./editors/switchEditor", "./editors/descriptionEditor", "../../../../../core/options/utils"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _form = $__require("../../../form/wrapper/form");
  var _formLayout = $__require("./layout_items/formLayout");
  var _form_context = $__require("../../form_context");
  var _startDateEditor = $__require("./editors/startDateEditor");
  var _endDateEditor = $__require("./editors/endDateEditor");
  var _timeZoneEditor = $__require("./editors/timeZoneEditor");
  var _switchEditor = $__require("./editors/switchEditor");
  var _descriptionEditor = $__require("./editors/descriptionEditor");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../../../form/wrapper/form","./layout_items/formLayout","../../form_context","./editors/startDateEditor","./editors/endDateEditor","./editors/timeZoneEditor","./editors/switchEditor","./editors/descriptionEditor","../../../../../core/options/utils"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../../../form/wrapper/form"), require("./layout_items/formLayout"), require("../../form_context"), require("./editors/startDateEditor"), require("./editors/endDateEditor"), require("./editors/timeZoneEditor"), require("./editors/switchEditor"), require("./editors/descriptionEditor"), require("../../../../../core/options/utils"));
  else
