...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/header/utils.js"], ["./view_switcher","./date_navigator","../../../../ui/scheduler/header/utils","../../../../core/devices"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/header/utils.js", ["./view_switcher", "./date_navigator", "../../../../ui/scheduler/header/utils", "../../../../core/devices"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.isMonthView = exports.isMobileLayout = exports.formatViews = exports.formToolbarItem = void 0;
  var _view_switcher = $__require("./view_switcher");
  var _date_navigator = $__require("./date_navigator");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./view_switcher","./date_navigator","../../../../ui/scheduler/header/utils","../../../../core/devices"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./view_switcher"), require("./date_navigator"), require("../../../../ui/scheduler/header/utils"), require("../../../../core/devices"));
  else
