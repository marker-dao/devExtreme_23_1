...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/appointment_tooltip/item_layout.js"], ["inferno","@devextreme/runtime/inferno","./marker","../../button","./item_content","./utils/get_current_appointment","./utils/default_functions"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/appointment_tooltip/item_layout.js", ["inferno", "@devextreme/runtime/inferno", "./marker", "../../button", "./item_content", "./utils/get_current_appointment", "./utils/default_functions"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _marker = $__require("./marker");
  var _button = $__require("../../button");
  var _item_content = $__require("./item_content");
  var _get_current_appointment = _interopRequireDefault($__require("./utils/get_current_appointment"));
  var _default_functions = $__require("./utils/default_functions");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","./marker","../../button","./item_content","./utils/get_current_appointment","./utils/default_functions"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("./marker"), require("../../button"), require("./item_content"), require("./utils/get_current_appointment"), require("./utils/default_functions"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=item_layout.js.map