...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/appointment_tooltip/appointment_list.js"], ["inferno","@devextreme/runtime/inferno","../../list","./item_layout","./utils/get_current_appointment","./utils/default_functions"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/appointment_tooltip/appointment_list.js", ["inferno", "@devextreme/runtime/inferno", "../../list", "./item_layout", "./utils/get_current_appointment", "./utils/default_functions"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _item_layout = $__require("./item_layout");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../../list","./item_layout","./utils/get_current_appointment","./utils/default_functions"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../../list"), require("./item_layout"), require("./utils/get_current_appointment"), require("./utils/default_functions"));
  else
