...
(["artifacts/transpiled-renovation/renovation/ui/scheduler/appointment/tooltip/item_layout.js"], ["inferno","@devextreme/runtime/inferno","./marker","./item_content","./delete_button"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scheduler/appointment/tooltip/item_layout.js", ["inferno", "@devextreme/runtime/inferno", "./marker", "./item_content", "./delete_button"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _delete_button = $__require("./delete_button");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","./marker","./item_content","./delete_button"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("./marker"), require("./item_content"), require("./delete_button"));
  else
