...
(["artifacts/transpiled-renovation/renovation/ui/pager/pages/small.js"], ["inferno","@devextreme/runtime/inferno","./page","../info","../../editors/number_box","../../../../localization/message","../utils/calculate_values_fitted_width","../utils/get_element_width","../common/pager_props"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/pager/pages/small.js", ["inferno", "@devextreme/runtime/inferno", "./page", "../info", "../../editors/number_box", "../../../../localization/message", "../utils/calculate_values_fitted_width", "../utils/get_element_width", "../common/pager_props"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _number_box = $__require("../../editors/number_box");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","./page","../info","../../editors/number_box","../../../../localization/message","../utils/calculate_values_fitted_width","../utils/get_element_width","../common/pager_props"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("./page"), require("../info"), require("../../editors/number_box"), require("../../../../localization/message"), require("../utils/calculate_values_fitted_width"), require("../utils/get_element_width"), require("../common/pager_props"));
  else
