...
(["artifacts/transpiled-renovation/renovation/ui/form/form.js"], ["inferno","@devextreme/runtime/inferno","./form_props","../../utils/combine_classes","../common/widget","./layout_manager","../scroll_view/scrollable"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/form/form.js", ["inferno", "@devextreme/runtime/inferno", "./form_props", "../../utils/combine_classes", "../common/widget", "./layout_manager", "../scroll_view/scrollable"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _form_props = $__require("./form_props");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","./form_props","../../utils/combine_classes","../common/widget","./layout_manager","../scroll_view/scrollable"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("./form_props"), require("../../utils/combine_classes"), require("../common/widget"), require("./layout_manager"), require("../scroll_view/scrollable"));
  else
