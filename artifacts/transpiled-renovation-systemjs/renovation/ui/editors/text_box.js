...
(["artifacts/transpiled-renovation/renovation/ui/editors/text_box.js"], ["inferno","@devextreme/runtime/inferno","../../../ui/text_box","../common/dom_component_wrapper","./common/editor","./common/editor_state_props","./common/editor_label_props","./common/text_editor_props"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/editors/text_box.js", ["inferno", "@devextreme/runtime/inferno", "../../../ui/text_box", "../common/dom_component_wrapper", "./common/editor", "./common/editor_state_props", "./common/editor_label_props", "./common/text_editor_props"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../../../ui/text_box","../common/dom_component_wrapper","./common/editor","./common/editor_state_props","./common/editor_label_props","./common/text_editor_props"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../../../ui/text_box"), require("../common/dom_component_wrapper"), require("./common/editor"), require("./common/editor_state_props"), require("./common/editor_label_props"), require("./common/text_editor_props"));
  else
