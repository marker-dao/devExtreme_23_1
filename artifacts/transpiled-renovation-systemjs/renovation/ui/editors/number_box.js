...
(["artifacts/transpiled-renovation/renovation/ui/editors/number_box.js"], ["inferno","@devextreme/runtime/inferno","../../../ui/number_box","../common/dom_component_wrapper","./common/editor","./common/editor_state_props","./common/editor_label_props"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/editors/number_box.js", ["inferno", "@devextreme/runtime/inferno", "../../../ui/number_box", "../common/dom_component_wrapper", "./common/editor", "./common/editor_state_props", "./common/editor_label_props"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _number_box = _interopRequireDefault($__require("../../../ui/number_box"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../../../ui/number_box","../common/dom_component_wrapper","./common/editor","./common/editor_state_props","./common/editor_label_props"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../../../ui/number_box"), require("../common/dom_component_wrapper"), require("./common/editor"), require("./common/editor_state_props"), require("./common/editor_label_props"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=number_box.js.map