...
(["artifacts/transpiled-renovation/renovation/ui/responsive_box/responsive_box.js"], ["inferno","@devextreme/runtime/inferno","../common/widget","./responsive_box_props","../../utils/combine_classes","../box/box","../../../core/utils/window","../../../core/dom_adapter","./screen_utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/responsive_box/responsive_box.js", ["inferno", "@devextreme/runtime/inferno", "../common/widget", "./responsive_box_props", "../../utils/combine_classes", "../box/box", "../../../core/utils/window", "../../../core/dom_adapter", "./screen_utils"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../common/widget","./responsive_box_props","../../utils/combine_classes","../box/box","../../../core/utils/window","../../../core/dom_adapter","./screen_utils"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../common/widget"), require("./responsive_box_props"), require("../../utils/combine_classes"), require("../box/box"), require("../../../core/utils/window"), require("../../../core/dom_adapter"), require("./screen_utils"));
  else
