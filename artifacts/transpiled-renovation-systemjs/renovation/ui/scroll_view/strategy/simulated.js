...
(["artifacts/transpiled-renovation/renovation/ui/scroll_view/strategy/simulated.js"], ["inferno","@devextreme/runtime/inferno","../../../../events/gesture/emitter.gesture.scroll","../../../utils/subscribe_to_event","../scrollbar/animated_scrollbar","../../common/widget","../../../utils/combine_classes","../utils/get_offset_distance","../utils/get_boundary_props","../utils/get_permissible_wheel_direction","../../../../events/utils/index","../../../../core/utils/type","../common/simulated_strategy_props","../../../../events/core/events_engine","../../../../core/utils/math","../utils/scroll_direction","../common/consts","../../../utils/get_element_offset","../utils/get_element_style","../internal/pocket/top","../internal/pocket/bottom","../utils/get_device_pixel_ratio","../utils/is_element_visible","../utils/get_allowed_direction","../utils/subscribe_to_resize","../../../../core/dom_adapter","../utils/get_scroll_left_max"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scroll_view/strategy/simulated.js", ["inferno", "@devextreme/runtime/inferno", "../../../../events/gesture/emitter.gesture.scroll", "../../../utils/subscribe_to_event", "../scrollbar/animated_scrollbar", "../../common/widget", "../../../utils/combine_classes", "../utils/get_offset_distance", "../utils/get_boundary_props", "../utils/get_permissible_wheel_direction", "../../../../events/utils/index", "../../../../core/utils/type", "../common/simulated_strategy_props", "../../../../events/core/events_engine", "../../../../core/utils/math", "../utils/scroll_direction", "../common/consts", "../../../utils/get_element_offset", "../utils/get_element_style", "../internal/pocket/top", "../internal/pocket/bottom", "../utils/get_device_pixel_ratio", "../utils/is_element_visible", "../utils/get_allowed_direction", "../utils/subscribe_to_resize", "../../../../core/dom_adapter", "../utils/get_scroll_left_max"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _animated_scrollbar = $__require("../scrollbar/animated_scrollbar");
  ...
  var _get_permissible_wheel_direction = $__require("../utils/get_permissible_wheel_direction");
  ...
  var _get_element_offset = $__require("../../../utils/get_element_offset");
  ...
  var _get_device_pixel_ratio = $__require("../utils/get_device_pixel_ratio");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../../../../events/gesture/emitter.gesture.scroll","../../../utils/subscribe_to_event","../scrollbar/animated_scrollbar","../../common/widget","../../../utils/combine_classes","../utils/get_offset_distance","../utils/get_boundary_props","../utils/get_permissible_wheel_direction","../../../../events/utils/index","../../../../core/utils/type","../common/simulated_strategy_props","../../../../events/core/events_engine","../../../../core/utils/math","../utils/scroll_direction","../common/consts","../../../utils/get_element_offset","../utils/get_element_style","../internal/pocket/top","../internal/pocket/bottom","../utils/get_device_pixel_ratio","../utils/is_element_visible","../utils/get_allowed_direction","../utils/subscribe_to_resize","../../../../core/dom_adapter","../utils/get_scroll_left_max"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../../../../events/gesture/emitter.gesture.scroll"), require("../../../utils/subscribe_to_event"), require("../scrollbar/animated_scrollbar"), require("../../common/widget"), require("../../../utils/combine_classes"), require("../utils/get_offset_distance"), require("../utils/get_boundary_props"), require("../utils/get_permissible_wheel_direction"), require("../../../../events/utils/index"), require("../../../../core/utils/type"), require("../common/simulated_strategy_props"), require("../../../../events/core/events_engine"), require("../../../../core/utils/math"), require("../utils/scroll_direction"), require("../common/consts"), require("../../../utils/get_element_offset"), require("../utils/get_element_style"), require("../internal/pocket/top"), require("../internal/pocket/bottom"), require("../utils/get_device_pixel_ratio"), require("../utils/is_element_visible"), require("../utils/get_allowed_direction"), require("../utils/subscribe_to_resize"), require("../../../../core/dom_adapter"), require("../utils/get_scroll_left_max"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=simulated.js.map