...
(["artifacts/transpiled-renovation/renovation/ui/scroll_view/utils/get_boundary_props.js"], ["./get_scroll_left_max","./get_scroll_top_max","./scroll_direction"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/scroll_view/utils/get_boundary_props.js", ["./get_scroll_left_max", "./get_scroll_top_max", "./scroll_direction"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _get_scroll_left_max = $__require("./get_scroll_left_max");
  var _get_scroll_top_max = $__require("./get_scroll_top_max");
  var _scroll_direction = $__require("./scroll_direction");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./get_scroll_left_max","./get_scroll_top_max","./scroll_direction"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./get_scroll_left_max"), require("./get_scroll_top_max"), require("./scroll_direction"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=get_boundary_props.js.map