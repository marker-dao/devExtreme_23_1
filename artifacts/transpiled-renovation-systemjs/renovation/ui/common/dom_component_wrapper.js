...
(["artifacts/transpiled-renovation/renovation/ui/common/dom_component_wrapper.js"], ["inferno","@devextreme/runtime/inferno","../../common/config_context","./utils/get_updated_options"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/common/dom_component_wrapper.js", ["inferno", "@devextreme/runtime/inferno", "../../common/config_context", "./utils/get_updated_options"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _get_updated_options = $__require("./utils/get_updated_options");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../../common/config_context","./utils/get_updated_options"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../../common/config_context"), require("./utils/get_updated_options"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=dom_component_wrapper.js.map