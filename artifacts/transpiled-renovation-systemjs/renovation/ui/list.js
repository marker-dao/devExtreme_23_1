...
(["artifacts/transpiled-renovation/renovation/ui/list.js"], ["inferno","@devextreme/runtime/inferno","../../ui/list","./common/dom_component_wrapper","./common/base_props"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/ui/list.js", ["inferno", "@devextreme/runtime/inferno", "../../ui/list", "./common/dom_component_wrapper", "./common/base_props"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _list = _interopRequireDefault($__require("../../ui/list"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../../ui/list","./common/dom_component_wrapper","./common/base_props"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../../ui/list"), require("./common/dom_component_wrapper"), require("./common/base_props"));
  else
