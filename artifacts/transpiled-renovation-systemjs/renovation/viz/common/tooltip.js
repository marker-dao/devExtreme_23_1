...
(["artifacts/transpiled-renovation/renovation/viz/common/tooltip.js"], ["inferno","@devextreme/runtime/inferno","../../utils/combine_classes","./renderers/svg_path","./renderers/svg_text","./renderers/shadow_filter","./renderers/utils","./renderers/svg_root","../../../core/utils/type","./tooltip_utils","../../../viz/core/utils","../../../core/dom_adapter","./utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/viz/common/tooltip.js", ["inferno", "@devextreme/runtime/inferno", "../../utils/combine_classes", "./renderers/svg_path", "./renderers/svg_text", "./renderers/shadow_filter", "./renderers/utils", "./renderers/svg_root", "../../../core/utils/type", "./tooltip_utils", "../../../viz/core/utils", "../../../core/dom_adapter", "./utils"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _svg_path = $__require("./renderers/svg_path");
  var _svg_text = $__require("./renderers/svg_text");
  var _shadow_filter = $__require("./renderers/shadow_filter");
  var _utils = $__require("./renderers/utils");
  var _svg_root = $__require("./renderers/svg_root");
  var _type = $__require("../../../core/utils/type");
  var _tooltip_utils = $__require("./tooltip_utils");
  var _utils2 = $__require("../../../viz/core/utils");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../../utils/combine_classes","./renderers/svg_path","./renderers/svg_text","./renderers/shadow_filter","./renderers/utils","./renderers/svg_root","../../../core/utils/type","./tooltip_utils","../../../viz/core/utils","../../../core/dom_adapter","./utils"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../../utils/combine_classes"), require("./renderers/svg_path"), require("./renderers/svg_text"), require("./renderers/shadow_filter"), require("./renderers/utils"), require("./renderers/svg_root"), require("../../../core/utils/type"), require("./tooltip_utils"), require("../../../viz/core/utils"), require("../../../core/dom_adapter"), require("./utils"));
  else
