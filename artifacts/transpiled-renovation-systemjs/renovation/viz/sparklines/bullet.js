...
(["artifacts/transpiled-renovation/renovation/viz/sparklines/bullet.js"], ["inferno","@devextreme/runtime/inferno","../../utils/combine_classes","../../utils/resolve_rtl","../../utils/get_element_offset","../common/base_props","../common/base_widget","./utils","../../common/config_context","../common/renderers/svg_path","../common/tooltip","../common/utils","../../../events/core/events_engine","../../../events/utils/index","../../../events/pointer","../../../core/dom_adapter"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/renovation/viz/sparklines/bullet.js", ["inferno", "@devextreme/runtime/inferno", "../../utils/combine_classes", "../../utils/resolve_rtl", "../../utils/get_element_offset", "../common/base_props", "../common/base_widget", "./utils", "../../common/config_context", "../common/renderers/svg_path", "../common/tooltip", "../common/utils", "../../../events/core/events_engine", "../../../events/utils/index", "../../../events/pointer", "../../../core/dom_adapter"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _base_widget = $__require("../common/base_widget");
  var _utils = $__require("./utils");
  var _config_context = $__require("../../common/config_context");
  var _svg_path = $__require("../common/renderers/svg_path");
  var _tooltip = $__require("../common/tooltip");
  var _utils2 = $__require("../common/utils");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["inferno","@devextreme/runtime/inferno","../../utils/combine_classes","../../utils/resolve_rtl","../../utils/get_element_offset","../common/base_props","../common/base_widget","./utils","../../common/config_context","../common/renderers/svg_path","../common/tooltip","../common/utils","../../../events/core/events_engine","../../../events/utils/index","../../../events/pointer","../../../core/dom_adapter"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("inferno"), require("@devextreme/runtime/inferno"), require("../../utils/combine_classes"), require("../../utils/resolve_rtl"), require("../../utils/get_element_offset"), require("../common/base_props"), require("../common/base_widget"), require("./utils"), require("../../common/config_context"), require("../common/renderers/svg_path"), require("../common/tooltip"), require("../common/utils"), require("../../../events/core/events_engine"), require("../../../events/utils/index"), require("../../../events/pointer"), require("../../../core/dom_adapter"));
  else
