...
(["artifacts/transpiled-renovation/format_helper.js"], ["./core/utils/type","./core/utils/date","./localization/number","./localization/date","./core/utils/dependency_injector","./localization/currency"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/format_helper.js", ["./core/utils/type", "./core/utils/date", "./localization/number", "./localization/date", "./core/utils/dependency_injector", "./localization/currency"], true, function ($__require, exports, module) {
  "use strict";
