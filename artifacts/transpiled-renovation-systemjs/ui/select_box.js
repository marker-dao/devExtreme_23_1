...
(["artifacts/transpiled-renovation/ui/select_box.js"], ["../core/renderer","../core/utils/common","../core/utils/type","../core/utils/extend","../core/utils/iterator","../core/utils/deferred","../core/element","../core/errors","../core/dom_adapter","../localization/message","../core/component_registrator","./drop_down_editor/ui.drop_down_list","./list/modules/selection","../events/utils/index"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/select_box.js", ["../core/renderer", "../core/utils/common", "../core/utils/type", "../core/utils/extend", "../core/utils/iterator", "../core/utils/deferred", "../core/element", "../core/errors", "../core/dom_adapter", "../localization/message", "../core/component_registrator", "./drop_down_editor/ui.drop_down_list", "./list/modules/selection", "../events/utils/index"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../core/renderer","../core/utils/common","../core/utils/type","../core/utils/extend","../core/utils/iterator","../core/utils/deferred","../core/element","../core/errors","../core/dom_adapter","../localization/message","../core/component_registrator","./drop_down_editor/ui.drop_down_list","./list/modules/selection","../events/utils/index"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../core/renderer"), require("../core/utils/common"), require("../core/utils/type"), require("../core/utils/extend"), require("../core/utils/iterator"), require("../core/utils/deferred"), require("../core/element"), require("../core/errors"), require("../core/dom_adapter"), require("../localization/message"), require("../core/component_registrator"), require("./drop_down_editor/ui.drop_down_list"), require("./list/modules/selection"), require("../events/utils/index"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=select_box.js.map