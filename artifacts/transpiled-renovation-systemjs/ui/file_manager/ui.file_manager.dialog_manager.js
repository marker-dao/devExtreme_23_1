...
(["artifacts/transpiled-renovation/ui/file_manager/ui.file_manager.dialog_manager.js"], ["../../core/renderer","../../core/utils/extend","../../localization/message","./ui.file_manager.dialog.name_editor","./ui.file_manager.dialog.folder_chooser","./ui.file_manager.dialog.delete_item"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/file_manager/ui.file_manager.dialog_manager.js", ["../../core/renderer", "../../core/utils/extend", "../../localization/message", "./ui.file_manager.dialog.name_editor", "./ui.file_manager.dialog.folder_chooser", "./ui.file_manager.dialog.delete_item"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _uiFile_managerDialog = _interopRequireDefault($__require("./ui.file_manager.dialog.name_editor"));
  var _uiFile_managerDialog2 = _interopRequireDefault($__require("./ui.file_manager.dialog.folder_chooser"));
  var _uiFile_managerDialog3 = _interopRequireDefault($__require("./ui.file_manager.dialog.delete_item"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/renderer","../../core/utils/extend","../../localization/message","./ui.file_manager.dialog.name_editor","./ui.file_manager.dialog.folder_chooser","./ui.file_manager.dialog.delete_item"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/renderer"), require("../../core/utils/extend"), require("../../localization/message"), require("./ui.file_manager.dialog.name_editor"), require("./ui.file_manager.dialog.folder_chooser"), require("./ui.file_manager.dialog.delete_item"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ui.file_manager.dialog_manager.js.map