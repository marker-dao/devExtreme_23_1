...
(["artifacts/transpiled-renovation/ui/text_box/ui.text_editor.base.js"], ["../../core/renderer","../../core/dom_adapter","../../events/core/events_engine","../widget/selectors","../../core/utils/type","../../core/utils/extend","../../core/utils/iterator","../themes","../../core/devices","../editor/editor","../../events/utils/index","../../events/pointer","./ui.text_editor.clear","./texteditor_button_collection/index","../../core/config","../widget/ui.errors","../../core/utils/deferred","../load_indicator","./ui.text_editor.label","../../core/utils/size","../../core/resize_observer"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/text_box/ui.text_editor.base.js", ["../../core/renderer", "../../core/dom_adapter", "../../events/core/events_engine", "../widget/selectors", "../../core/utils/type", "../../core/utils/extend", "../../core/utils/iterator", "../themes", "../../core/devices", "../editor/editor", "../../events/utils/index", "../../events/pointer", "./ui.text_editor.clear", "./texteditor_button_collection/index", "../../core/config", "../widget/ui.errors", "../../core/utils/deferred", "../load_indicator", "./ui.text_editor.label", "../../core/utils/size", "../../core/resize_observer"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _uiText_editor = _interopRequireDefault($__require("./ui.text_editor.clear"));
  var _index2 = _interopRequireDefault($__require("./texteditor_button_collection/index"));
  ...
  var _uiText_editor2 = $__require("./ui.text_editor.label");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/renderer","../../core/dom_adapter","../../events/core/events_engine","../widget/selectors","../../core/utils/type","../../core/utils/extend","../../core/utils/iterator","../themes","../../core/devices","../editor/editor","../../events/utils/index","../../events/pointer","./ui.text_editor.clear","./texteditor_button_collection/index","../../core/config","../widget/ui.errors","../../core/utils/deferred","../load_indicator","./ui.text_editor.label","../../core/utils/size","../../core/resize_observer"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/renderer"), require("../../core/dom_adapter"), require("../../events/core/events_engine"), require("../widget/selectors"), require("../../core/utils/type"), require("../../core/utils/extend"), require("../../core/utils/iterator"), require("../themes"), require("../../core/devices"), require("../editor/editor"), require("../../events/utils/index"), require("../../events/pointer"), require("./ui.text_editor.clear"), require("./texteditor_button_collection/index"), require("../../core/config"), require("../widget/ui.errors"), require("../../core/utils/deferred"), require("../load_indicator"), require("./ui.text_editor.label"), require("../../core/utils/size"), require("../../core/resize_observer"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ui.text_editor.base.js.map