...
(["artifacts/transpiled-renovation/ui/gantt/ui.gantt.custom_fields.js"], ["../../core/utils/data","./ui.gantt.cache","./ui.gantt.helper"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/gantt/ui.gantt.custom_fields.js", ["../../core/utils/data", "./ui.gantt.cache", "./ui.gantt.helper"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _uiGantt = $__require("./ui.gantt.cache");
  var _uiGantt2 = $__require("./ui.gantt.helper");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/utils/data","./ui.gantt.cache","./ui.gantt.helper"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/utils/data"), require("./ui.gantt.cache"), require("./ui.gantt.helper"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ui.gantt.custom_fields.js.map