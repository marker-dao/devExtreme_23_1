...
(["artifacts/transpiled-renovation/ui/validation_group.js"], ["../core/renderer","../core/component_registrator","../core/dom_component","./validation_summary","./validation_engine","./validator"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/validation_group.js", ["../core/renderer", "../core/component_registrator", "../core/dom_component", "./validation_summary", "./validation_engine", "./validator"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _validation_summary = _interopRequireDefault($__require("./validation_summary"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../core/renderer","../core/component_registrator","../core/dom_component","./validation_summary","./validation_engine","./validator"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../core/renderer"), require("../core/component_registrator"), require("../core/dom_component"), require("./validation_summary"), require("./validation_engine"), require("./validator"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=validation_group.js.map