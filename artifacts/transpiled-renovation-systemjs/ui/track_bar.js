...
(["artifacts/transpiled-renovation/ui/track_bar.js"], ["../core/renderer","./editor/editor","../core/component_registrator","../core/utils/extend","../core/utils/window","../animation/fx"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/track_bar.js", ["../core/renderer", "./editor/editor", "../core/component_registrator", "../core/utils/extend", "../core/utils/window", "../animation/fx"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../core/renderer","./editor/editor","../core/component_registrator","../core/utils/extend","../core/utils/window","../animation/fx"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../core/renderer"), require("./editor/editor"), require("../core/component_registrator"), require("../core/utils/extend"), require("../core/utils/window"), require("../animation/fx"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=track_bar.js.map