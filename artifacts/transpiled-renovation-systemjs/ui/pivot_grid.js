...
(["artifacts/transpiled-renovation/ui/pivot_grid.js"], ["./pivot_grid/ui.pivot_grid"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/pivot_grid.js", ["./pivot_grid/ui.pivot_grid"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.default = void 0;
  var _ui = _interopRequireDefault($__require("./pivot_grid/ui.pivot_grid"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./pivot_grid/ui.pivot_grid"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./pivot_grid/ui.pivot_grid"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=pivot_grid.js.map