...
(["artifacts/transpiled-renovation/ui/tree_view/ui.tree_view.search.js"], ["../../core/renderer","../../core/component_registrator","../widget/ui.search_box_mixin","../text_box","../../core/utils/extend","./ui.tree_view.base"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/tree_view/ui.tree_view.search.js", ["../../core/renderer", "../../core/component_registrator", "../widget/ui.search_box_mixin", "../text_box", "../../core/utils/extend", "./ui.tree_view.base"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _ui = _interopRequireDefault($__require("../widget/ui.search_box_mixin"));
  var _text_box = _interopRequireDefault($__require("../text_box"));
  var _extend = $__require("../../core/utils/extend");
  var _uiTree_view = _interopRequireDefault($__require("./ui.tree_view.base"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/renderer","../../core/component_registrator","../widget/ui.search_box_mixin","../text_box","../../core/utils/extend","./ui.tree_view.base"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/renderer"), require("../../core/component_registrator"), require("../widget/ui.search_box_mixin"), require("../text_box"), require("../../core/utils/extend"), require("./ui.tree_view.base"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ui.tree_view.search.js.map