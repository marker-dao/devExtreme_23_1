...
(["artifacts/transpiled-renovation/ui/drawer/ui.drawer.rendering.strategy.overlap.js"], ["../../core/utils/size","./ui.drawer.animation","./ui.drawer.rendering.strategy","../../core/renderer","../../animation/translator","../overlay/ui.overlay","../../core/utils/common","../../core/utils/inflector"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/drawer/ui.drawer.rendering.strategy.overlap.js", ["../../core/utils/size", "./ui.drawer.animation", "./ui.drawer.rendering.strategy", "../../core/renderer", "../../animation/translator", "../overlay/ui.overlay", "../../core/utils/common", "../../core/utils/inflector"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/utils/size","./ui.drawer.animation","./ui.drawer.rendering.strategy","../../core/renderer","../../animation/translator","../overlay/ui.overlay","../../core/utils/common","../../core/utils/inflector"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/utils/size"), require("./ui.drawer.animation"), require("./ui.drawer.rendering.strategy"), require("../../core/renderer"), require("../../animation/translator"), require("../overlay/ui.overlay"), require("../../core/utils/common"), require("../../core/utils/inflector"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ui.drawer.rendering.strategy.overlap.js.map