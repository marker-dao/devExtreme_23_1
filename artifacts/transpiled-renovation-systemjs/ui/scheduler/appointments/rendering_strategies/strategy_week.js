...
(["artifacts/transpiled-renovation/ui/scheduler/appointments/rendering_strategies/strategy_week.js"], ["./strategy_vertical"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/scheduler/appointments/rendering_strategies/strategy_week.js", ["./strategy_vertical"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.default = void 0;
  var _strategy_vertical = _interopRequireDefault($__require("./strategy_vertical"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./strategy_vertical"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./strategy_vertical"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=strategy_week.js.map