...
(["artifacts/transpiled-renovation/ui/scheduler/recurrence_editor.js"], ["../../core/component_registrator","../../core/guid","../../core/renderer","../../core/utils/date","../../core/utils/extend","../../core/utils/type","../../localization/date","../../localization/message","../form","../button_group","../date_box","../editor/editor","../number_box","./recurrence","../radio_group"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/scheduler/recurrence_editor.js", ["../../core/component_registrator", "../../core/guid", "../../core/renderer", "../../core/utils/date", "../../core/utils/extend", "../../core/utils/type", "../../localization/date", "../../localization/message", "../form", "../button_group", "../date_box", "../editor/editor", "../number_box", "./recurrence", "../radio_group"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _date_box = _interopRequireDefault($__require("../date_box"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/component_registrator","../../core/guid","../../core/renderer","../../core/utils/date","../../core/utils/extend","../../core/utils/type","../../localization/date","../../localization/message","../form","../button_group","../date_box","../editor/editor","../number_box","./recurrence","../radio_group"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/component_registrator"), require("../../core/guid"), require("../../core/renderer"), require("../../core/utils/date"), require("../../core/utils/extend"), require("../../core/utils/type"), require("../../localization/date"), require("../../localization/message"), require("../form"), require("../button_group"), require("../date_box"), require("../editor/editor"), require("../number_box"), require("./recurrence"), require("../radio_group"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=recurrence_editor.js.map