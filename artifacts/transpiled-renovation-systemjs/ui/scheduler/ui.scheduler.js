...
(["artifacts/transpiled-renovation/ui/scheduler/ui.scheduler.js"], ["../../core/component_registrator","../../core/config","../../core/devices","../../core/renderer","../../core/templates/bindable_template","../../core/templates/empty_template","../../core/utils/callbacks","../../core/utils/common","../../core/utils/data","../../core/utils/position","../../core/utils/date","../../core/utils/date_serialization","../../core/utils/deferred","../../core/utils/extend","../../core/utils/iterator","../../core/utils/type","../../core/utils/window","../../data_helper","../../events/visibility_change","../../localization/date","../../localization/message","../dialog","../themes","../widget/ui.errors","../widget/ui.widget","./appointmentPopup/popup","./appointmentPopup/form","./compactAppointmentsHelper","./tooltip_strategies/desktopTooltipStrategy","./tooltip_strategies/mobileTooltipStrategy","./loading","./appointments/appointmentCollection","./appointments.layout_manager","./header/header","./subscribes","./recurrence","./utils.timeZone","./workspaces/ui.scheduler.agenda","./workspaces/ui.scheduler.timeline_day","./workspaces/ui.scheduler.timeline_month","./workspaces/ui.scheduler.timeline_week","./workspaces/ui.scheduler.timeline_work_week","./workspaces/ui.scheduler.work_space_day","./workspaces/ui.scheduler.work_space_month","./workspaces/ui.scheduler.work_space_week","./workspaces/ui.scheduler.work_space_work_week","./appointmentAdapter","./dataStructures","./utils","./resources/utils","./expressionUtils","../../renovation/ui/scheduler/view_model/to_test/views/utils/base","./appointments/render","./resources/agendaResourceProcessor","./appointments/dataProvider/appointmentDataProvider","../../renovation/ui/scheduler/appointment/utils/getAppointmentTakesAllDay","../../renovation/ui/scheduler/utils/data","../../renovation/ui/scheduler/model/views","../../renovation/ui/scheduler/timeZoneCalculator/createTimeZoneCalculator","../../renovation/ui/scheduler/utils/recurrence/excludeFromRecurrence"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/scheduler/ui.scheduler.js", ["../../core/component_registrator", "../../core/config", "../../core/devices", "../../core/renderer", "../../core/templates/bindable_template", "../../core/templates/empty_template", "../../core/utils/callbacks", "../../core/utils/common", "../../core/utils/data", "../../core/utils/position", "../../core/utils/date", "../../core/utils/date_serialization", "../../core/utils/deferred", "../../core/utils/extend", "../../core/utils/iterator", "../../core/utils/type", "../../core/utils/window", "../../data_helper", "../../events/visibility_change", "../../localization/date", "../../localization/message", "../dialog", "../themes", "../widget/ui.errors", "../widget/ui.widget", "./appointmentPopup/popup", "./appointmentPopup/form", "./compactAppointmentsHelper", "./tooltip_strategies/desktopTooltipStrategy", "./tooltip_strategies/mobileTooltipStrategy", "./loading", "./appointments/appointmentCollection", "./appointments.layout_manager", "./header/header", "./subscribes", "./recurrence", "./utils.timeZone", "./workspaces/ui.scheduler.agenda", "./workspaces/ui.scheduler.timeline_day", "./workspaces/ui.scheduler.timeline_month", "./workspaces/ui.scheduler.timeline_week", "./workspaces/ui.scheduler.timeline_work_week", "./workspaces/ui.scheduler.work_space_day", "./workspaces/ui.scheduler.work_space_month", "./workspaces/ui.scheduler.work_space_week", "./workspaces/ui.scheduler.work_space_work_week", "./appointmentAdapter", "./dataStructures", "./utils", "./resources/utils", "./expressionUtils", "../../renovation/ui/scheduler/view_model/to_test/views/utils/base", "./appointments/render", "./resources/agendaResourceProcessor", "./appointments/dataProvider/appointmentDataProvider", "../../renovation/ui/scheduler/appointment/utils/getAppointmentTakesAllDay", "../../renovation/ui/scheduler/utils/data", "../../renovation/ui/scheduler/model/views", "../../renovation/ui/scheduler/timeZoneCalculator/createTimeZoneCalculator", "../../renovation/ui/scheduler/utils/recurrence/excludeFromRecurrence"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _popup = $__require("./appointmentPopup/popup");
  var _form = $__require("./appointmentPopup/form");
  var _compactAppointmentsHelper = $__require("./compactAppointmentsHelper");
  var _desktopTooltipStrategy = $__require("./tooltip_strategies/desktopTooltipStrategy");
  var _mobileTooltipStrategy = $__require("./tooltip_strategies/mobileTooltipStrategy");
  var _loading = $__require("./loading");
  var _appointmentCollection = _interopRequireDefault($__require("./appointments/appointmentCollection"));
  var _appointments = _interopRequireDefault($__require("./appointments.layout_manager"));
  var _header = $__require("./header/header");
  var _subscribes = _interopRequireDefault($__require("./subscribes"));
  var _recurrence = $__require("./recurrence");
  var _utils = _interopRequireDefault($__require("./utils.timeZone"));
  var _uiScheduler = _interopRequireDefault($__require("./workspaces/ui.scheduler.agenda"));
  var _uiScheduler2 = _interopRequireDefault($__require("./workspaces/ui.scheduler.timeline_day"));
  var _uiScheduler3 = _interopRequireDefault($__require("./workspaces/ui.scheduler.timeline_month"));
  var _uiScheduler4 = _interopRequireDefault($__require("./workspaces/ui.scheduler.timeline_week"));
  var _uiScheduler5 = _interopRequireDefault($__require("./workspaces/ui.scheduler.timeline_work_week"));
  var _uiScheduler6 = _interopRequireDefault($__require("./workspaces/ui.scheduler.work_space_day"));
  var _uiScheduler7 = _interopRequireDefault($__require("./workspaces/ui.scheduler.work_space_month"));
  var _uiScheduler8 = _interopRequireDefault($__require("./workspaces/ui.scheduler.work_space_week"));
  var _uiScheduler9 = _interopRequireDefault($__require("./workspaces/ui.scheduler.work_space_work_week"));
  ...
  var _utils3 = $__require("./resources/utils");
  ...
  var _render2 = $__require("./appointments/render");
  var _agendaResourceProcessor = $__require("./resources/agendaResourceProcessor");
  var _appointmentDataProvider = $__require("./appointments/dataProvider/appointmentDataProvider");
  var _getAppointmentTakesAllDay = $__require("../../renovation/ui/scheduler/appointment/utils/getAppointmentTakesAllDay");
  var _data2 = $__require("../../renovation/ui/scheduler/utils/data");
  var _views = $__require("../../renovation/ui/scheduler/model/views");
  var _createTimeZoneCalculator = $__require("../../renovation/ui/scheduler/timeZoneCalculator/createTimeZoneCalculator");
  var _excludeFromRecurrence = $__require("../../renovation/ui/scheduler/utils/recurrence/excludeFromRecurrence");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/component_registrator","../../core/config","../../core/devices","../../core/renderer","../../core/templates/bindable_template","../../core/templates/empty_template","../../core/utils/callbacks","../../core/utils/common","../../core/utils/data","../../core/utils/position","../../core/utils/date","../../core/utils/date_serialization","../../core/utils/deferred","../../core/utils/extend","../../core/utils/iterator","../../core/utils/type","../../core/utils/window","../../data_helper","../../events/visibility_change","../../localization/date","../../localization/message","../dialog","../themes","../widget/ui.errors","../widget/ui.widget","./appointmentPopup/popup","./appointmentPopup/form","./compactAppointmentsHelper","./tooltip_strategies/desktopTooltipStrategy","./tooltip_strategies/mobileTooltipStrategy","./loading","./appointments/appointmentCollection","./appointments.layout_manager","./header/header","./subscribes","./recurrence","./utils.timeZone","./workspaces/ui.scheduler.agenda","./workspaces/ui.scheduler.timeline_day","./workspaces/ui.scheduler.timeline_month","./workspaces/ui.scheduler.timeline_week","./workspaces/ui.scheduler.timeline_work_week","./workspaces/ui.scheduler.work_space_day","./workspaces/ui.scheduler.work_space_month","./workspaces/ui.scheduler.work_space_week","./workspaces/ui.scheduler.work_space_work_week","./appointmentAdapter","./dataStructures","./utils","./resources/utils","./expressionUtils","../../renovation/ui/scheduler/view_model/to_test/views/utils/base","./appointments/render","./resources/agendaResourceProcessor","./appointments/dataProvider/appointmentDataProvider","../../renovation/ui/scheduler/appointment/utils/getAppointmentTakesAllDay","../../renovation/ui/scheduler/utils/data","../../renovation/ui/scheduler/model/views","../../renovation/ui/scheduler/timeZoneCalculator/createTimeZoneCalculator","../../renovation/ui/scheduler/utils/recurrence/excludeFromRecurrence"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/component_registrator"), require("../../core/config"), require("../../core/devices"), require("../../core/renderer"), require("../../core/templates/bindable_template"), require("../../core/templates/empty_template"), require("../../core/utils/callbacks"), require("../../core/utils/common"), require("../../core/utils/data"), require("../../core/utils/position"), require("../../core/utils/date"), require("../../core/utils/date_serialization"), require("../../core/utils/deferred"), require("../../core/utils/extend"), require("../../core/utils/iterator"), require("../../core/utils/type"), require("../../core/utils/window"), require("../../data_helper"), require("../../events/visibility_change"), require("../../localization/date"), require("../../localization/message"), require("../dialog"), require("../themes"), require("../widget/ui.errors"), require("../widget/ui.widget"), require("./appointmentPopup/popup"), require("./appointmentPopup/form"), require("./compactAppointmentsHelper"), require("./tooltip_strategies/desktopTooltipStrategy"), require("./tooltip_strategies/mobileTooltipStrategy"), require("./loading"), require("./appointments/appointmentCollection"), require("./appointments.layout_manager"), require("./header/header"), require("./subscribes"), require("./recurrence"), require("./utils.timeZone"), require("./workspaces/ui.scheduler.agenda"), require("./workspaces/ui.scheduler.timeline_day"), require("./workspaces/ui.scheduler.timeline_month"), require("./workspaces/ui.scheduler.timeline_week"), require("./workspaces/ui.scheduler.timeline_work_week"), require("./workspaces/ui.scheduler.work_space_day"), require("./workspaces/ui.scheduler.work_space_month"), require("./workspaces/ui.scheduler.work_space_week"), require("./workspaces/ui.scheduler.work_space_work_week"), require("./appointmentAdapter"), require("./dataStructures"), require("./utils"), require("./resources/utils"), require("./expressionUtils"), require("../../renovation/ui/scheduler/view_model/to_test/views/utils/base"), require("./appointments/render"), require("./resources/agendaResourceProcessor"), require("./appointments/dataProvider/appointmentDataProvider"), require("../../renovation/ui/scheduler/appointment/utils/getAppointmentTakesAllDay"), require("../../renovation/ui/scheduler/utils/data"), require("../../renovation/ui/scheduler/model/views"), require("../../renovation/ui/scheduler/timeZoneCalculator/createTimeZoneCalculator"), require("../../renovation/ui/scheduler/utils/recurrence/excludeFromRecurrence"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ui.scheduler.js.map