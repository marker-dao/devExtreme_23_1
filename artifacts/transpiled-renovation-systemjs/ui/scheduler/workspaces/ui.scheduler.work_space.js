...
(["artifacts/transpiled-renovation/ui/scheduler/workspaces/ui.scheduler.work_space.js"], ["../../../core/utils/size","../../../core/renderer","../../../core/dom_adapter","../../../events/core/events_engine","../../../core/utils/date","../../../core/utils/window","../../../core/element","../../../core/utils/extend","../../../core/utils/position","../../../localization/message","../../../core/utils/common","../../../core/utils/type","../../../events/utils/index","../../../events/pointer","../../widget/ui.errors","../../../events/click","../../../events/contextmenu","../../../events/drag","../../scroll_view/ui.scrollable","./ui.scheduler.work_space.grouped.strategy.horizontal","./ui.scheduler.work_space.grouped.strategy.vertical","../table_creator","../shaders/ui.scheduler.current_time_shader.vertical","../appointmentDragBehavior","../constants","../classes","../base/widgetObserver","../../../animation/translator","./ui.scheduler.virtual_scrolling","./view_model/view_data_provider","../../../renovation/ui/scheduler/workspaces/base/date_table/layout.j","../../../renovation/ui/scheduler/workspaces/base/date_table/all_day_panel/table.j","../../../renovation/ui/scheduler/workspaces/base/date_table/all_day_panel/title.j","../../../renovation/ui/scheduler/workspaces/base/time_panel/layout.j","../../../renovation/ui/scheduler/workspaces/base/group_panel/group_panel.j","../../../renovation/ui/scheduler/workspaces/base/header_panel/layout.j","./cells_selection_state","./cache","./cells_selection_controller","../../../renovation/ui/scheduler/view_model/to_test/views/utils/base","../resources/utils","./helpers/positionHelper","../utils","../../../core/utils/data","../../../renovation/ui/common/utils/scroll/getMemoizeScrollTo"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/scheduler/workspaces/ui.scheduler.work_space.js", ["../../../core/utils/size", "../../../core/renderer", "../../../core/dom_adapter", "../../../events/core/events_engine", "../../../core/utils/date", "../../../core/utils/window", "../../../core/element", "../../../core/utils/extend", "../../../core/utils/position", "../../../localization/message", "../../../core/utils/common", "../../../core/utils/type", "../../../events/utils/index", "../../../events/pointer", "../../widget/ui.errors", "../../../events/click", "../../../events/contextmenu", "../../../events/drag", "../../scroll_view/ui.scrollable", "./ui.scheduler.work_space.grouped.strategy.horizontal", "./ui.scheduler.work_space.grouped.strategy.vertical", "../table_creator", "../shaders/ui.scheduler.current_time_shader.vertical", "../appointmentDragBehavior", "../constants", "../classes", "../base/widgetObserver", "../../../animation/translator", "./ui.scheduler.virtual_scrolling", "./view_model/view_data_provider", "../../../renovation/ui/scheduler/workspaces/base/date_table/layout.j", "../../../renovation/ui/scheduler/workspaces/base/date_table/all_day_panel/table.j", "../../../renovation/ui/scheduler/workspaces/base/date_table/all_day_panel/title.j", "../../../renovation/ui/scheduler/workspaces/base/time_panel/layout.j", "../../../renovation/ui/scheduler/workspaces/base/group_panel/group_panel.j", "../../../renovation/ui/scheduler/workspaces/base/header_panel/layout.j", "./cells_selection_state", "./cache", "./cells_selection_controller", "../../../renovation/ui/scheduler/view_model/to_test/views/utils/base", "../resources/utils", "./helpers/positionHelper", "../utils", "../../../core/utils/data", "../../../renovation/ui/common/utils/scroll/getMemoizeScrollTo"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _uiSchedulerWork_spaceGroupedStrategy = _interopRequireDefault($__require("./ui.scheduler.work_space.grouped.strategy.horizontal"));
  var _uiSchedulerWork_spaceGroupedStrategy2 = _interopRequireDefault($__require("./ui.scheduler.work_space.grouped.strategy.vertical"));
  var _table_creator = _interopRequireDefault($__require("../table_creator"));
  var _uiSchedulerCurrent_time_shader = _interopRequireDefault($__require("../shaders/ui.scheduler.current_time_shader.vertical"));
  var _appointmentDragBehavior = _interopRequireDefault($__require("../appointmentDragBehavior"));
  var _constants = $__require("../constants");
  var _classes = $__require("../classes");
  var _widgetObserver = _interopRequireDefault($__require("../base/widgetObserver"));
  var _translator = $__require("../../../animation/translator");
  var _uiScheduler = $__require("./ui.scheduler.virtual_scrolling");
  var _view_data_provider = _interopRequireDefault($__require("./view_model/view_data_provider"));
  var _layout = _interopRequireDefault($__require("../../../renovation/ui/scheduler/workspaces/base/date_table/layout.j"));
  var _table = _interopRequireDefault($__require("../../../renovation/ui/scheduler/workspaces/base/date_table/all_day_panel/table.j"));
  var _title = _interopRequireDefault($__require("../../../renovation/ui/scheduler/workspaces/base/date_table/all_day_panel/title.j"));
  var _layout2 = _interopRequireDefault($__require("../../../renovation/ui/scheduler/workspaces/base/time_panel/layout.j"));
  var _group_panel = _interopRequireDefault($__require("../../../renovation/ui/scheduler/workspaces/base/group_panel/group_panel.j"));
  var _layout3 = _interopRequireDefault($__require("../../../renovation/ui/scheduler/workspaces/base/header_panel/layout.j"));
  var _cells_selection_state = _interopRequireDefault($__require("./cells_selection_state"));
  var _cache = $__require("./cache");
  var _cells_selection_controller = $__require("./cells_selection_controller");
  var _base = $__require("../../../renovation/ui/scheduler/view_model/to_test/views/utils/base");
  var _utils = $__require("../resources/utils");
  var _positionHelper = $__require("./helpers/positionHelper");
  var _utils2 = $__require("../utils");
  var _data = $__require("../../../core/utils/data");
  var _getMemoizeScrollTo = $__require("../../../renovation/ui/common/utils/scroll/getMemoizeScrollTo");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../../core/utils/size","../../../core/renderer","../../../core/dom_adapter","../../../events/core/events_engine","../../../core/utils/date","../../../core/utils/window","../../../core/element","../../../core/utils/extend","../../../core/utils/position","../../../localization/message","../../../core/utils/common","../../../core/utils/type","../../../events/utils/index","../../../events/pointer","../../widget/ui.errors","../../../events/click","../../../events/contextmenu","../../../events/drag","../../scroll_view/ui.scrollable","./ui.scheduler.work_space.grouped.strategy.horizontal","./ui.scheduler.work_space.grouped.strategy.vertical","../table_creator","../shaders/ui.scheduler.current_time_shader.vertical","../appointmentDragBehavior","../constants","../classes","../base/widgetObserver","../../../animation/translator","./ui.scheduler.virtual_scrolling","./view_model/view_data_provider","../../../renovation/ui/scheduler/workspaces/base/date_table/layout.j","../../../renovation/ui/scheduler/workspaces/base/date_table/all_day_panel/table.j","../../../renovation/ui/scheduler/workspaces/base/date_table/all_day_panel/title.j","../../../renovation/ui/scheduler/workspaces/base/time_panel/layout.j","../../../renovation/ui/scheduler/workspaces/base/group_panel/group_panel.j","../../../renovation/ui/scheduler/workspaces/base/header_panel/layout.j","./cells_selection_state","./cache","./cells_selection_controller","../../../renovation/ui/scheduler/view_model/to_test/views/utils/base","../resources/utils","./helpers/positionHelper","../utils","../../../core/utils/data","../../../renovation/ui/common/utils/scroll/getMemoizeScrollTo"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../../core/utils/size"), require("../../../core/renderer"), require("../../../core/dom_adapter"), require("../../../events/core/events_engine"), require("../../../core/utils/date"), require("../../../core/utils/window"), require("../../../core/element"), require("../../../core/utils/extend"), require("../../../core/utils/position"), require("../../../localization/message"), require("../../../core/utils/common"), require("../../../core/utils/type"), require("../../../events/utils/index"), require("../../../events/pointer"), require("../../widget/ui.errors"), require("../../../events/click"), require("../../../events/contextmenu"), require("../../../events/drag"), require("../../scroll_view/ui.scrollable"), require("./ui.scheduler.work_space.grouped.strategy.horizontal"), require("./ui.scheduler.work_space.grouped.strategy.vertical"), require("../table_creator"), require("../shaders/ui.scheduler.current_time_shader.vertical"), require("../appointmentDragBehavior"), require("../constants"), require("../classes"), require("../base/widgetObserver"), require("../../../animation/translator"), require("./ui.scheduler.virtual_scrolling"), require("./view_model/view_data_provider"), require("../../../renovation/ui/scheduler/workspaces/base/date_table/layout.j"), require("../../../renovation/ui/scheduler/workspaces/base/date_table/all_day_panel/table.j"), require("../../../renovation/ui/scheduler/workspaces/base/date_table/all_day_panel/title.j"), require("../../../renovation/ui/scheduler/workspaces/base/time_panel/layout.j"), require("../../../renovation/ui/scheduler/workspaces/base/group_panel/group_panel.j"), require("../../../renovation/ui/scheduler/workspaces/base/header_panel/layout.j"), require("./cells_selection_state"), require("./cache"), require("./cells_selection_controller"), require("../../../renovation/ui/scheduler/view_model/to_test/views/utils/base"), require("../resources/utils"), require("./helpers/positionHelper"), require("../utils"), require("../../../core/utils/data"), require("../../../renovation/ui/common/utils/scroll/getMemoizeScrollTo"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ui.scheduler.work_space.js.map