...
(["artifacts/transpiled-renovation/ui/diagram/ui.diagram.js"], ["../../core/utils/size","../../core/renderer","../widget/ui.widget","../load_indicator","../../core/component_registrator","../../core/utils/extend","../../core/utils/type","../../core/utils/data","../../animation/position","./diagram.importer","../../core/utils/window","../../core/element","../../events/core/events_engine","../../events/utils/index","../../localization/message","../../localization/number","../overlay/z_index","../overlay/ui.overlay","./ui.diagram.toolbar","./ui.diagram.main_toolbar","./ui.diagram.history_toolbar","./ui.diagram.view_toolbar","./ui.diagram.properties_toolbar","./ui.diagram.context_menu","./ui.diagram.context_toolbox","./ui.diagram.dialogs","./ui.diagram.scroll_view","./diagram.toolbox_manager","./ui.diagram.toolbox","./ui.diagram.properties_panel","./diagram.options_update","./ui.diagram.dialog_manager","./diagram.commands_manager","./diagram.nodes_option","./diagram.edges_option"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/diagram/ui.diagram.js", ["../../core/utils/size", "../../core/renderer", "../widget/ui.widget", "../load_indicator", "../../core/component_registrator", "../../core/utils/extend", "../../core/utils/type", "../../core/utils/data", "../../animation/position", "./diagram.importer", "../../core/utils/window", "../../core/element", "../../events/core/events_engine", "../../events/utils/index", "../../localization/message", "../../localization/number", "../overlay/z_index", "../overlay/ui.overlay", "./ui.diagram.toolbar", "./ui.diagram.main_toolbar", "./ui.diagram.history_toolbar", "./ui.diagram.view_toolbar", "./ui.diagram.properties_toolbar", "./ui.diagram.context_menu", "./ui.diagram.context_toolbox", "./ui.diagram.dialogs", "./ui.diagram.scroll_view", "./diagram.toolbox_manager", "./ui.diagram.toolbox", "./ui.diagram.properties_panel", "./diagram.options_update", "./ui.diagram.dialog_manager", "./diagram.commands_manager", "./diagram.nodes_option", "./diagram.edges_option"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _ui2 = _interopRequireDefault($__require("../overlay/ui.overlay"));
  var _uiDiagram = _interopRequireDefault($__require("./ui.diagram.toolbar"));
  var _uiDiagram2 = _interopRequireDefault($__require("./ui.diagram.main_toolbar"));
  var _uiDiagram3 = _interopRequireDefault($__require("./ui.diagram.history_toolbar"));
  var _uiDiagram4 = _interopRequireDefault($__require("./ui.diagram.view_toolbar"));
  var _uiDiagram5 = _interopRequireDefault($__require("./ui.diagram.properties_toolbar"));
  var _uiDiagram6 = _interopRequireDefault($__require("./ui.diagram.context_menu"));
  var _uiDiagram7 = _interopRequireDefault($__require("./ui.diagram.context_toolbox"));
  var _uiDiagram8 = _interopRequireDefault($__require("./ui.diagram.dialogs"));
  var _uiDiagram9 = _interopRequireDefault($__require("./ui.diagram.scroll_view"));
  var _diagram2 = _interopRequireDefault($__require("./diagram.toolbox_manager"));
  var _uiDiagram10 = _interopRequireDefault($__require("./ui.diagram.toolbox"));
  var _uiDiagram11 = _interopRequireDefault($__require("./ui.diagram.properties_panel"));
  var _diagram3 = _interopRequireDefault($__require("./diagram.options_update"));
  var _uiDiagram12 = _interopRequireDefault($__require("./ui.diagram.dialog_manager"));
  var _diagram4 = _interopRequireDefault($__require("./diagram.commands_manager"));
  var _diagram5 = _interopRequireDefault($__require("./diagram.nodes_option"));
  var _diagram6 = _interopRequireDefault($__require("./diagram.edges_option"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/utils/size","../../core/renderer","../widget/ui.widget","../load_indicator","../../core/component_registrator","../../core/utils/extend","../../core/utils/type","../../core/utils/data","../../animation/position","./diagram.importer","../../core/utils/window","../../core/element","../../events/core/events_engine","../../events/utils/index","../../localization/message","../../localization/number","../overlay/z_index","../overlay/ui.overlay","./ui.diagram.toolbar","./ui.diagram.main_toolbar","./ui.diagram.history_toolbar","./ui.diagram.view_toolbar","./ui.diagram.properties_toolbar","./ui.diagram.context_menu","./ui.diagram.context_toolbox","./ui.diagram.dialogs","./ui.diagram.scroll_view","./diagram.toolbox_manager","./ui.diagram.toolbox","./ui.diagram.properties_panel","./diagram.options_update","./ui.diagram.dialog_manager","./diagram.commands_manager","./diagram.nodes_option","./diagram.edges_option"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/utils/size"), require("../../core/renderer"), require("../widget/ui.widget"), require("../load_indicator"), require("../../core/component_registrator"), require("../../core/utils/extend"), require("../../core/utils/type"), require("../../core/utils/data"), require("../../animation/position"), require("./diagram.importer"), require("../../core/utils/window"), require("../../core/element"), require("../../events/core/events_engine"), require("../../events/utils/index"), require("../../localization/message"), require("../../localization/number"), require("../overlay/z_index"), require("../overlay/ui.overlay"), require("./ui.diagram.toolbar"), require("./ui.diagram.main_toolbar"), require("./ui.diagram.history_toolbar"), require("./ui.diagram.view_toolbar"), require("./ui.diagram.properties_toolbar"), require("./ui.diagram.context_menu"), require("./ui.diagram.context_toolbox"), require("./ui.diagram.dialogs"), require("./ui.diagram.scroll_view"), require("./diagram.toolbox_manager"), require("./ui.diagram.toolbox"), require("./ui.diagram.properties_panel"), require("./diagram.options_update"), require("./ui.diagram.dialog_manager"), require("./diagram.commands_manager"), require("./diagram.nodes_option"), require("./diagram.edges_option"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ui.diagram.js.map