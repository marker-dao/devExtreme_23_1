...
(["artifacts/transpiled-renovation/ui/diagram/diagram.nodes_option.js"], ["./diagram.items_option"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/diagram/diagram.nodes_option.js", ["./diagram.items_option"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.default = void 0;
  var _diagram = _interopRequireDefault($__require("./diagram.items_option"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./diagram.items_option"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./diagram.items_option"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=diagram.nodes_option.js.map