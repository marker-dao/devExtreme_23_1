...
(["artifacts/transpiled-renovation/ui/date_box/ui.date_box.strategy.date_view.js"], ["../../core/renderer","../../core/utils/window","./ui.date_view","./ui.date_box.strategy","../../core/utils/support","../../core/utils/extend","./ui.date_utils","../../localization/message"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/date_box/ui.date_box.strategy.date_view.js", ["../../core/renderer", "../../core/utils/window", "./ui.date_view", "./ui.date_box.strategy", "../../core/utils/support", "../../core/utils/extend", "./ui.date_utils", "../../localization/message"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _ui = _interopRequireDefault($__require("./ui.date_view"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/renderer","../../core/utils/window","./ui.date_view","./ui.date_box.strategy","../../core/utils/support","../../core/utils/extend","./ui.date_utils","../../localization/message"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/renderer"), require("../../core/utils/window"), require("./ui.date_view"), require("./ui.date_box.strategy"), require("../../core/utils/support"), require("../../core/utils/extend"), require("./ui.date_utils"), require("../../localization/message"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ui.date_box.strategy.date_view.js.map