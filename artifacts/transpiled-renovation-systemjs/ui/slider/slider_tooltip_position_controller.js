...
(["artifacts/transpiled-renovation/ui/slider/slider_tooltip_position_controller.js"], ["../popover/popover_position_controller","../../animation/translator","../../animation/position","../../core/utils/extend","../../core/utils/type"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/slider/slider_tooltip_position_controller.js", ["../popover/popover_position_controller", "../../animation/translator", "../../animation/position", "../../core/utils/extend", "../../core/utils/type"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.SliderTooltipPositionController = void 0;
  var _popover_position_controller = $__require("../popover/popover_position_controller");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../popover/popover_position_controller","../../animation/translator","../../animation/position","../../core/utils/extend","../../core/utils/type"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../popover/popover_position_controller"), require("../../animation/translator"), require("../../animation/position"), require("../../core/utils/extend"), require("../../core/utils/type"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=slider_tooltip_position_controller.js.map