...
(["artifacts/transpiled-renovation/ui/lookup.js"], ["../core/utils/size","../core/renderer","../events/core/events_engine","../core/utils/window","../core/utils/support","../core/utils/common","../core/element","../core/utils/iterator","../core/utils/extend","../core/options/utils","../localization/message","../core/devices","../core/component_registrator","../events/utils/index","./drop_down_editor/ui.drop_down_list","./themes","../events/click","./popover/ui.popover","./text_box","../core/templates/child_default_template","../animation/translator","../core/utils/type","./drop_down_editor/utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/lookup.js", ["../core/utils/size", "../core/renderer", "../events/core/events_engine", "../core/utils/window", "../core/utils/support", "../core/utils/common", "../core/element", "../core/utils/iterator", "../core/utils/extend", "../core/options/utils", "../localization/message", "../core/devices", "../core/component_registrator", "../events/utils/index", "./drop_down_editor/ui.drop_down_list", "./themes", "../events/click", "./popover/ui.popover", "./text_box", "../core/templates/child_default_template", "../animation/translator", "../core/utils/type", "./drop_down_editor/utils"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _ui = _interopRequireDefault($__require("./drop_down_editor/ui.drop_down_list"));
  ...
  var _utils2 = $__require("./drop_down_editor/utils");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../core/utils/size","../core/renderer","../events/core/events_engine","../core/utils/window","../core/utils/support","../core/utils/common","../core/element","../core/utils/iterator","../core/utils/extend","../core/options/utils","../localization/message","../core/devices","../core/component_registrator","../events/utils/index","./drop_down_editor/ui.drop_down_list","./themes","../events/click","./popover/ui.popover","./text_box","../core/templates/child_default_template","../animation/translator","../core/utils/type","./drop_down_editor/utils"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../core/utils/size"), require("../core/renderer"), require("../events/core/events_engine"), require("../core/utils/window"), require("../core/utils/support"), require("../core/utils/common"), require("../core/element"), require("../core/utils/iterator"), require("../core/utils/extend"), require("../core/options/utils"), require("../localization/message"), require("../core/devices"), require("../core/component_registrator"), require("../events/utils/index"), require("./drop_down_editor/ui.drop_down_list"), require("./themes"), require("../events/click"), require("./popover/ui.popover"), require("./text_box"), require("../core/templates/child_default_template"), require("../animation/translator"), require("../core/utils/type"), require("./drop_down_editor/utils"));
  else
