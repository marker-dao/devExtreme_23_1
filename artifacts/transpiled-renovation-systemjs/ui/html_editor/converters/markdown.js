...
(["artifacts/transpiled-renovation/ui/html_editor/converters/markdown.js"], ["turndown","devextreme-showdown","../../../core/utils/window","../../widget/ui.errors","../converterController"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/html_editor/converters/markdown.js", ["turndown", "devextreme-showdown", "../../../core/utils/window", "../../widget/ui.errors", "../converterController"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.default = void 0;
  var _turndown = _interopRequireDefault($__require("turndown"));
  var _devextremeShowdown = _interopRequireDefault($__require("devextreme-showdown"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["turndown","devextreme-showdown","../../../core/utils/window","../../widget/ui.errors","../converterController"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("turndown"), require("devextreme-showdown"), require("../../../core/utils/window"), require("../../widget/ui.errors"), require("../converterController"));
  else
