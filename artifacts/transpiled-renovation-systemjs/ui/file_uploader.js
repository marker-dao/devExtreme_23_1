...
(["artifacts/transpiled-renovation/ui/file_uploader.js"], ["../core/utils/size","../core/renderer","../core/guid","../core/utils/window","../events/core/events_engine","../core/component_registrator","../core/utils/callbacks","../core/utils/type","../core/utils/iterator","../core/utils/extend","../core/utils/deferred","../core/utils/ajax","./editor/editor","./button","./progress_bar","../core/devices","../events/utils/index","../events/click","../localization/message","./themes","../core/dom_adapter"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/file_uploader.js", ["../core/utils/size", "../core/renderer", "../core/guid", "../core/utils/window", "../events/core/events_engine", "../core/component_registrator", "../core/utils/callbacks", "../core/utils/type", "../core/utils/iterator", "../core/utils/extend", "../core/utils/deferred", "../core/utils/ajax", "./editor/editor", "./button", "./progress_bar", "../core/devices", "../events/utils/index", "../events/click", "../localization/message", "./themes", "../core/dom_adapter"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../core/utils/size","../core/renderer","../core/guid","../core/utils/window","../events/core/events_engine","../core/component_registrator","../core/utils/callbacks","../core/utils/type","../core/utils/iterator","../core/utils/extend","../core/utils/deferred","../core/utils/ajax","./editor/editor","./button","./progress_bar","../core/devices","../events/utils/index","../events/click","../localization/message","./themes","../core/dom_adapter"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../core/utils/size"), require("../core/renderer"), require("../core/guid"), require("../core/utils/window"), require("../events/core/events_engine"), require("../core/component_registrator"), require("../core/utils/callbacks"), require("../core/utils/type"), require("../core/utils/iterator"), require("../core/utils/extend"), require("../core/utils/deferred"), require("../core/utils/ajax"), require("./editor/editor"), require("./button"), require("./progress_bar"), require("../core/devices"), require("../events/utils/index"), require("../events/click"), require("../localization/message"), require("./themes"), require("../core/dom_adapter"));
  else
