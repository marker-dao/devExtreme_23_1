...
(["artifacts/transpiled-renovation/ui/toolbar/ui.toolbar.js"], ["../../core/component_registrator","../../core/utils/extend","./ui.toolbar.base","./ui.toolbar.utils","./strategy/toolbar.multiline","./strategy/toolbar.singleline"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/toolbar/ui.toolbar.js", ["../../core/component_registrator", "../../core/utils/extend", "./ui.toolbar.base", "./ui.toolbar.utils", "./strategy/toolbar.multiline", "./strategy/toolbar.singleline"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _uiToolbar = _interopRequireDefault($__require("./ui.toolbar.base"));
  var _uiToolbar2 = $__require("./ui.toolbar.utils");
  var _toolbar = $__require("./strategy/toolbar.multiline");
  var _toolbar2 = $__require("./strategy/toolbar.singleline");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/component_registrator","../../core/utils/extend","./ui.toolbar.base","./ui.toolbar.utils","./strategy/toolbar.multiline","./strategy/toolbar.singleline"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/component_registrator"), require("../../core/utils/extend"), require("./ui.toolbar.base"), require("./ui.toolbar.utils"), require("./strategy/toolbar.multiline"), require("./strategy/toolbar.singleline"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ui.toolbar.js.map