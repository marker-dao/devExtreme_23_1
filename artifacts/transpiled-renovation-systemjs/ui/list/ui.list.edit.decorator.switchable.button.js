...
(["artifacts/transpiled-renovation/ui/list/ui.list.edit.decorator.switchable.button.js"], ["../../core/utils/size","../../core/renderer","../../animation/fx","../button","../../localization/message","./ui.list.edit.decorator_registry","./ui.list.edit.decorator.switchable"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/list/ui.list.edit.decorator.switchable.button.js", ["../../core/utils/size", "../../core/renderer", "../../animation/fx", "../button", "../../localization/message", "./ui.list.edit.decorator_registry", "./ui.list.edit.decorator.switchable"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/utils/size","../../core/renderer","../../animation/fx","../button","../../localization/message","./ui.list.edit.decorator_registry","./ui.list.edit.decorator.switchable"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/utils/size"), require("../../core/renderer"), require("../../animation/fx"), require("../button"), require("../../localization/message"), require("./ui.list.edit.decorator_registry"), require("./ui.list.edit.decorator.switchable"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ui.list.edit.decorator.switchable.button.js.map