...
(["artifacts/transpiled-renovation/ui/number_box/number_box.mask.js"], ["../../events/core/events_engine","../../core/utils/extend","../../core/utils/type","../../core/devices","../../core/utils/math","../../localization/number","./number_box.caret","../../localization/ldml/number","./number_box.base","../../events/utils/index","../../core/utils/common","./utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/number_box/number_box.mask.js", ["../../events/core/events_engine", "../../core/utils/extend", "../../core/utils/type", "../../core/devices", "../../core/utils/math", "../../localization/number", "./number_box.caret", "../../localization/ldml/number", "./number_box.base", "../../events/utils/index", "../../core/utils/common", "./utils"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _number_box = $__require("./number_box.caret");
  var _number2 = $__require("../../localization/ldml/number");
  var _number_box2 = _interopRequireDefault($__require("./number_box.base"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../events/core/events_engine","../../core/utils/extend","../../core/utils/type","../../core/devices","../../core/utils/math","../../localization/number","./number_box.caret","../../localization/ldml/number","./number_box.base","../../events/utils/index","../../core/utils/common","./utils"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../events/core/events_engine"), require("../../core/utils/extend"), require("../../core/utils/type"), require("../../core/devices"), require("../../core/utils/math"), require("../../localization/number"), require("./number_box.caret"), require("../../localization/ldml/number"), require("./number_box.base"), require("../../events/utils/index"), require("../../core/utils/common"), require("./utils"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=number_box.mask.js.map