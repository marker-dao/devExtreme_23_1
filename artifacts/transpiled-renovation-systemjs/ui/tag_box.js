...
(["artifacts/transpiled-renovation/ui/tag_box.js"], ["../core/utils/size","../core/renderer","../core/devices","../core/element_data","../events/core/events_engine","../core/component_registrator","../core/utils/common","../core/utils/selection_filter","../core/utils/deferred","../core/utils/dom","../core/element","../core/utils/type","../core/utils/window","../core/utils/extend","../core/utils/iterator","../core/utils/array","../localization/message","../events/utils/index","../events/click","./text_box/utils.caret","../data/data_source/utils","../core/guid","./select_box","../core/templates/bindable_template","./text_box/utils.scroll","./widget/ui.errors"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/tag_box.js", ["../core/utils/size", "../core/renderer", "../core/devices", "../core/element_data", "../events/core/events_engine", "../core/component_registrator", "../core/utils/common", "../core/utils/selection_filter", "../core/utils/deferred", "../core/utils/dom", "../core/element", "../core/utils/type", "../core/utils/window", "../core/utils/extend", "../core/utils/iterator", "../core/utils/array", "../localization/message", "../events/utils/index", "../events/click", "./text_box/utils.caret", "../data/data_source/utils", "../core/guid", "./select_box", "../core/templates/bindable_template", "./text_box/utils.scroll", "./widget/ui.errors"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _utils = _interopRequireDefault($__require("./text_box/utils.caret"));
  ...
  var _utils3 = $__require("./text_box/utils.scroll");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../core/utils/size","../core/renderer","../core/devices","../core/element_data","../events/core/events_engine","../core/component_registrator","../core/utils/common","../core/utils/selection_filter","../core/utils/deferred","../core/utils/dom","../core/element","../core/utils/type","../core/utils/window","../core/utils/extend","../core/utils/iterator","../core/utils/array","../localization/message","../events/utils/index","../events/click","./text_box/utils.caret","../data/data_source/utils","../core/guid","./select_box","../core/templates/bindable_template","./text_box/utils.scroll","./widget/ui.errors"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../core/utils/size"), require("../core/renderer"), require("../core/devices"), require("../core/element_data"), require("../events/core/events_engine"), require("../core/component_registrator"), require("../core/utils/common"), require("../core/utils/selection_filter"), require("../core/utils/deferred"), require("../core/utils/dom"), require("../core/element"), require("../core/utils/type"), require("../core/utils/window"), require("../core/utils/extend"), require("../core/utils/iterator"), require("../core/utils/array"), require("../localization/message"), require("../events/utils/index"), require("../events/click"), require("./text_box/utils.caret"), require("../data/data_source/utils"), require("../core/guid"), require("./select_box"), require("../core/templates/bindable_template"), require("./text_box/utils.scroll"), require("./widget/ui.errors"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=tag_box.js.map