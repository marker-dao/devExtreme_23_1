...
(["artifacts/transpiled-renovation/viz/core/export.js"], ["../../core/utils/extend","../../core/utils/window","./utils","../../core/utils/svg","../../exporter","../../localization/message","../../core/utils/type","../themes","../../events/hover","../../events/pointer","../../core/utils/console","../../core/utils/size"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/core/export.js", ["../../core/utils/extend", "../../core/utils/window", "./utils", "../../core/utils/svg", "../../exporter", "../../localization/message", "../../core/utils/type", "../themes", "../../events/hover", "../../events/pointer", "../../core/utils/console", "../../core/utils/size"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _window2 = $__require("../../core/utils/window");
  var _utils = $__require("./utils");
  var _svg = $__require("../../core/utils/svg");
  var _exporter = $__require("../../exporter");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/utils/extend","../../core/utils/window","./utils","../../core/utils/svg","../../exporter","../../localization/message","../../core/utils/type","../themes","../../events/hover","../../events/pointer","../../core/utils/console","../../core/utils/size"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/utils/extend"), require("../../core/utils/window"), require("./utils"), require("../../core/utils/svg"), require("../../exporter"), require("../../localization/message"), require("../../core/utils/type"), require("../themes"), require("../../events/hover"), require("../../events/pointer"), require("../../core/utils/console"), require("../../core/utils/size"));
  else
