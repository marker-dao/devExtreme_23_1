...
(["artifacts/transpiled-renovation/viz/chart.js"], ["../core/utils/size","../core/utils/common","../core/utils/extend","../core/utils/window","../core/utils/iterator","../core/component_registrator","./utils","./core/utils","../core/utils/type","../core/utils/math","./chart_components/base_chart","./chart_components/multi_axes_synchronizer","./chart_components/advanced_chart","./chart_components/scroll_bar","./chart_components/crosshair","./series/helpers/range_data_calculator","./chart_components/layout_manager","./translators/range","./chart_components/shutter_zoom","./chart_components/zoom_and_pan","./core/annotations"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/chart.js", ["../core/utils/size", "../core/utils/common", "../core/utils/extend", "../core/utils/window", "../core/utils/iterator", "../core/component_registrator", "./utils", "./core/utils", "../core/utils/type", "../core/utils/math", "./chart_components/base_chart", "./chart_components/multi_axes_synchronizer", "./chart_components/advanced_chart", "./chart_components/scroll_bar", "./chart_components/crosshair", "./series/helpers/range_data_calculator", "./chart_components/layout_manager", "./translators/range", "./chart_components/shutter_zoom", "./chart_components/zoom_and_pan", "./core/annotations"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _utils2 = $__require("./core/utils");
  var _type = $__require("../core/utils/type");
  var _math = $__require("../core/utils/math");
  var _base_chart = $__require("./chart_components/base_chart");
  var _multi_axes_synchronizer = _interopRequireDefault($__require("./chart_components/multi_axes_synchronizer"));
  var _advanced_chart = $__require("./chart_components/advanced_chart");
  var _scroll_bar = $__require("./chart_components/scroll_bar");
  var _crosshair = $__require("./chart_components/crosshair");
  var _range_data_calculator = _interopRequireDefault($__require("./series/helpers/range_data_calculator"));
  var _layout_manager = $__require("./chart_components/layout_manager");
  var _range = $__require("./translators/range");
  var _shutter_zoom = _interopRequireDefault($__require("./chart_components/shutter_zoom"));
  var _zoom_and_pan = _interopRequireDefault($__require("./chart_components/zoom_and_pan"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../core/utils/size","../core/utils/common","../core/utils/extend","../core/utils/window","../core/utils/iterator","../core/component_registrator","./utils","./core/utils","../core/utils/type","../core/utils/math","./chart_components/base_chart","./chart_components/multi_axes_synchronizer","./chart_components/advanced_chart","./chart_components/scroll_bar","./chart_components/crosshair","./series/helpers/range_data_calculator","./chart_components/layout_manager","./translators/range","./chart_components/shutter_zoom","./chart_components/zoom_and_pan","./core/annotations"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../core/utils/size"), require("../core/utils/common"), require("../core/utils/extend"), require("../core/utils/window"), require("../core/utils/iterator"), require("../core/component_registrator"), require("./utils"), require("./core/utils"), require("../core/utils/type"), require("../core/utils/math"), require("./chart_components/base_chart"), require("./chart_components/multi_axes_synchronizer"), require("./chart_components/advanced_chart"), require("./chart_components/scroll_bar"), require("./chart_components/crosshair"), require("./series/helpers/range_data_calculator"), require("./chart_components/layout_manager"), require("./translators/range"), require("./chart_components/shutter_zoom"), require("./chart_components/zoom_and_pan"), require("./core/annotations"));
  else
