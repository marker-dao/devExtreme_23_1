...
(["artifacts/transpiled-renovation/viz/tree_map/tree_map.base.js"], ["./common","./node","./tiling","./colorizing","../core/utils","../../core/utils/common","../core/base_widget","./tiling.squarified","./colorizing.discrete","../../core/component_registrator","../core/data_source"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/tree_map/tree_map.base.js", ["./common", "./node", "./tiling", "./colorizing", "../core/utils", "../../core/utils/common", "../core/base_widget", "./tiling.squarified", "./colorizing.discrete", "../../core/component_registrator", "../core/data_source"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _colorizing = $__require("./colorizing");
  var _utils = $__require("../core/utils");
  var _common2 = $__require("../../core/utils/common");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./common","./node","./tiling","./colorizing","../core/utils","../../core/utils/common","../core/base_widget","./tiling.squarified","./colorizing.discrete","../../core/component_registrator","../core/data_source"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./common"), require("./node"), require("./tiling"), require("./colorizing"), require("../core/utils"), require("../../core/utils/common"), require("../core/base_widget"), require("./tiling.squarified"), require("./colorizing.discrete"), require("../../core/component_registrator"), require("../core/data_source"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=tree_map.base.js.map