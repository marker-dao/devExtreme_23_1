...
(["artifacts/transpiled-renovation/viz/tree_map/drilldown.js"], ["./tree_map.base","../core/helpers","./api"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/tree_map/drilldown.js", ["./tree_map.base", "../core/helpers", "./api"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./tree_map.base","../core/helpers","./api"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./tree_map.base"), require("../core/helpers"), require("./api"));
  else
