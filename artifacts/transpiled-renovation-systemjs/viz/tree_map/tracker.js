...
(["artifacts/transpiled-renovation/viz/tree_map/tracker.js"], ["./tree_map.base","../components/tracker","../core/helpers","../core/utils","./api","./hover","./tooltip"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/tree_map/tracker.js", ["./tree_map.base", "../components/tracker", "../core/helpers", "../core/utils", "./api", "./hover", "./tooltip"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _tracker = $__require("../components/tracker");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./tree_map.base","../components/tracker","../core/helpers","../core/utils","./api","./hover","./tooltip"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./tree_map.base"), require("../components/tracker"), require("../core/helpers"), require("../core/utils"), require("./api"), require("./hover"), require("./tooltip"));
  else
