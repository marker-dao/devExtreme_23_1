...
(["artifacts/transpiled-renovation/viz/funnel/tracker.js"], ["./funnel","../components/tracker","../../core/utils/type"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/funnel/tracker.js", ["./funnel", "../components/tracker", "../../core/utils/type"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.plugin = exports._TESTS_dataKey = void 0;
  var _funnel = _interopRequireDefault($__require("./funnel"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./funnel","../components/tracker","../../core/utils/type"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./funnel"), require("../components/tracker"), require("../../core/utils/type"));
  else
