...
(["artifacts/transpiled-renovation/viz/translators/translator2d.js"], ["../../core/utils/extend","../../core/utils/iterator","./range","./category_translator","./interval_translator","./datetime_translator","./logarithmic_translator","../core/utils","../../core/utils/type","../../core/utils/math","../../core/utils/date"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/translators/translator2d.js", ["../../core/utils/extend", "../../core/utils/iterator", "./range", "./category_translator", "./interval_translator", "./datetime_translator", "./logarithmic_translator", "../core/utils", "../../core/utils/type", "../../core/utils/math", "../../core/utils/date"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _range = $__require("./range");
  var _category_translator = _interopRequireDefault($__require("./category_translator"));
  var _interval_translator = _interopRequireDefault($__require("./interval_translator"));
  var _datetime_translator = _interopRequireDefault($__require("./datetime_translator"));
  var _logarithmic_translator = _interopRequireDefault($__require("./logarithmic_translator"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/utils/extend","../../core/utils/iterator","./range","./category_translator","./interval_translator","./datetime_translator","./logarithmic_translator","../core/utils","../../core/utils/type","../../core/utils/math","../../core/utils/date"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/utils/extend"), require("../../core/utils/iterator"), require("./range"), require("./category_translator"), require("./interval_translator"), require("./datetime_translator"), require("./logarithmic_translator"), require("../core/utils"), require("../../core/utils/type"), require("../../core/utils/math"), require("../../core/utils/date"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=translator2d.js.map