...
(["artifacts/transpiled-renovation/viz/series/base_series.js"], ["../../core/utils/type","../../core/utils/extend","../../core/utils/iterator","./points/base_point","../core/utils","../../core/utils/common","../components/consts","./helpers/range_data_calculator","./scatter_series","./line_series","./area_series","./bar_series","./range_series","./bubble_series","./pie_series","./financial_series","./stacked_series"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/series/base_series.js", ["../../core/utils/type", "../../core/utils/extend", "../../core/utils/iterator", "./points/base_point", "../core/utils", "../../core/utils/common", "../components/consts", "./helpers/range_data_calculator", "./scatter_series", "./line_series", "./area_series", "./bar_series", "./range_series", "./bubble_series", "./pie_series", "./financial_series", "./stacked_series"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _base_point = $__require("./points/base_point");
  ...
  var lineSeries = _interopRequireWildcard($__require("./line_series"));
  var areaSeries = _interopRequireWildcard($__require("./area_series"));
  var barSeries = _interopRequireWildcard($__require("./bar_series"));
  var _range_series = $__require("./range_series");
  var _bubble_series = $__require("./bubble_series");
  var pieSeries = _interopRequireWildcard($__require("./pie_series"));
  var financialSeries = _interopRequireWildcard($__require("./financial_series"));
  var stackedSeries = _interopRequireWildcard($__require("./stacked_series"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/utils/type","../../core/utils/extend","../../core/utils/iterator","./points/base_point","../core/utils","../../core/utils/common","../components/consts","./helpers/range_data_calculator","./scatter_series","./line_series","./area_series","./bar_series","./range_series","./bubble_series","./pie_series","./financial_series","./stacked_series"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/utils/type"), require("../../core/utils/extend"), require("../../core/utils/iterator"), require("./points/base_point"), require("../core/utils"), require("../../core/utils/common"), require("../components/consts"), require("./helpers/range_data_calculator"), require("./scatter_series"), require("./line_series"), require("./area_series"), require("./bar_series"), require("./range_series"), require("./bubble_series"), require("./pie_series"), require("./financial_series"), require("./stacked_series"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=base_series.js.map