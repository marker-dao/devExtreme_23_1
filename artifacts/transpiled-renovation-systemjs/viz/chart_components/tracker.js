...
(["artifacts/transpiled-renovation/viz/chart_components/tracker.js"], ["../../core/dom_adapter","../../events/core/events_engine","../../events/click","../../core/utils/extend","../../core/utils/iterator","../components/consts","../core/utils","../../events/pointer","../../events/utils/index","../../core/utils/type","../../core/utils/common","../../core/errors"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/chart_components/tracker.js", ["../../core/dom_adapter", "../../events/core/events_engine", "../../events/click", "../../core/utils/extend", "../../core/utils/iterator", "../components/consts", "../core/utils", "../../events/pointer", "../../events/utils/index", "../../core/utils/type", "../../core/utils/common", "../../core/errors"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/dom_adapter","../../events/core/events_engine","../../events/click","../../core/utils/extend","../../core/utils/iterator","../components/consts","../core/utils","../../events/pointer","../../events/utils/index","../../core/utils/type","../../core/utils/common","../../core/errors"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/dom_adapter"), require("../../events/core/events_engine"), require("../../events/click"), require("../../core/utils/extend"), require("../../core/utils/iterator"), require("../components/consts"), require("../core/utils"), require("../../events/pointer"), require("../../events/utils/index"), require("../../core/utils/type"), require("../../core/utils/common"), require("../../core/errors"));
  else
