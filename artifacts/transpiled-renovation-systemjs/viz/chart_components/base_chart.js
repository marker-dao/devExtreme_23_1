...
(["artifacts/transpiled-renovation/viz/chart_components/base_chart.js"], ["../../core/utils/common","../../events/core/events_engine","../../core/utils/type","../../core/utils/iterator","../../core/utils/extend","../../events/utils/index","../core/base_widget","../components/legend","../components/data_validator","../series/base_series","../components/chart_theme_manager","./layout_manager","./tracker","../core/utils","../core/export","../core/title","../core/data_source","../core/tooltip","../core/loading_indicator"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/chart_components/base_chart.js", ["../../core/utils/common", "../../events/core/events_engine", "../../core/utils/type", "../../core/utils/iterator", "../../core/utils/extend", "../../events/utils/index", "../core/base_widget", "../components/legend", "../components/data_validator", "../series/base_series", "../components/chart_theme_manager", "./layout_manager", "./tracker", "../core/utils", "../core/export", "../core/title", "../core/data_source", "../core/tooltip", "../core/loading_indicator"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _layout_manager = $__require("./layout_manager");
  var trackerModule = _interopRequireWildcard($__require("./tracker"));
  ...
  var BaseChart = _base_widget.default.inherit({
    ...
    _doRender: function _doRender(_options) {
      ...
      ///#DEBUG
      that.DEBUG_canvas = (0, _utils.setCanvasValues)(that._canvas);
      ///#ENDDEBUG
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/utils/common","../../events/core/events_engine","../../core/utils/type","../../core/utils/iterator","../../core/utils/extend","../../events/utils/index","../core/base_widget","../components/legend","../components/data_validator","../series/base_series","../components/chart_theme_manager","./layout_manager","./tracker","../core/utils","../core/export","../core/title","../core/data_source","../core/tooltip","../core/loading_indicator"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/utils/common"), require("../../events/core/events_engine"), require("../../core/utils/type"), require("../../core/utils/iterator"), require("../../core/utils/extend"), require("../../events/utils/index"), require("../core/base_widget"), require("../components/legend"), require("../components/data_validator"), require("../series/base_series"), require("../components/chart_theme_manager"), require("./layout_manager"), require("./tracker"), require("../core/utils"), require("../core/export"), require("../core/title"), require("../core/data_source"), require("../core/tooltip"), require("../core/loading_indicator"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=base_chart.js.map