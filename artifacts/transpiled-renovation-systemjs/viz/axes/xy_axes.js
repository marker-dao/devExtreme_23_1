...
(["artifacts/transpiled-renovation/viz/axes/xy_axes.js"], ["../translators/range","../../format_helper","../../core/utils/date","../../core/utils/extend","./datetime_breaks","../../core/utils/common","../core/utils","../../core/utils/type","./axes_constants"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/axes/xy_axes.js", ["../translators/range", "../../format_helper", "../../core/utils/date", "../../core/utils/extend", "./datetime_breaks", "../../core/utils/common", "../core/utils", "../../core/utils/type", "./axes_constants"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _datetime_breaks = $__require("./datetime_breaks");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../translators/range","../../format_helper","../../core/utils/date","../../core/utils/extend","./datetime_breaks","../../core/utils/common","../core/utils","../../core/utils/type","./axes_constants"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../translators/range"), require("../../format_helper"), require("../../core/utils/date"), require("../../core/utils/extend"), require("./datetime_breaks"), require("../../core/utils/common"), require("../core/utils"), require("../../core/utils/type"), require("./axes_constants"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=xy_axes.js.map