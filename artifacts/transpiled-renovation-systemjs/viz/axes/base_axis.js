...
(["artifacts/transpiled-renovation/viz/axes/base_axis.js"], ["./smart_formatter","../core/utils","../../core/utils/type","./axes_constants","../../core/utils/extend","../../format_helper","../components/parse_utils","./tick_generator","../translators/translator2d","../translators/range","./tick","../../core/utils/math","../../core/utils/date","../../core/utils/common","./xy_axes","./polar_axes","./constant_line","./strip","../../core/utils/deferred","./axes_utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/axes/base_axis.js", ["./smart_formatter", "../core/utils", "../../core/utils/type", "./axes_constants", "../../core/utils/extend", "../../format_helper", "../components/parse_utils", "./tick_generator", "../translators/translator2d", "../translators/range", "./tick", "../../core/utils/math", "../../core/utils/date", "../../core/utils/common", "./xy_axes", "./polar_axes", "./constant_line", "./strip", "../../core/utils/deferred", "./axes_utils"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.Axis = void 0;
  var _smart_formatter = $__require("./smart_formatter");
  ...
  var _tick_generator = $__require("./tick_generator");
  ...
  var polarMethods = _interopRequireWildcard($__require("./polar_axes"));
  var _constant_line = _interopRequireDefault($__require("./constant_line"));
  var _strip = _interopRequireDefault($__require("./strip"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./smart_formatter","../core/utils","../../core/utils/type","./axes_constants","../../core/utils/extend","../../format_helper","../components/parse_utils","./tick_generator","../translators/translator2d","../translators/range","./tick","../../core/utils/math","../../core/utils/date","../../core/utils/common","./xy_axes","./polar_axes","./constant_line","./strip","../../core/utils/deferred","./axes_utils"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./smart_formatter"), require("../core/utils"), require("../../core/utils/type"), require("./axes_constants"), require("../../core/utils/extend"), require("../../format_helper"), require("../components/parse_utils"), require("./tick_generator"), require("../translators/translator2d"), require("../translators/range"), require("./tick"), require("../../core/utils/math"), require("../../core/utils/date"), require("../../core/utils/common"), require("./xy_axes"), require("./polar_axes"), require("./constant_line"), require("./strip"), require("../../core/utils/deferred"), require("./axes_utils"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=base_axis.js.map