...
(["artifacts/transpiled-renovation/viz/pie_chart.js"], ["./components/consts","./core/utils","../core/utils/extend","../core/utils/type","../core/utils/iterator","./translators/range","../core/component_registrator","./chart_components/base_chart","../core/utils/common","./translators/translator1d","./core/annotations","./core/center_template"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/pie_chart.js", ["./components/consts", "./core/utils", "../core/utils/extend", "../core/utils/type", "../core/utils/iterator", "./translators/range", "../core/component_registrator", "./chart_components/base_chart", "../core/utils/common", "./translators/translator1d", "./core/annotations", "./core/center_template"], true, function ($__require, exports, module) {
  "use strict";
