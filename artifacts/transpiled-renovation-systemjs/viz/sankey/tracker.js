...
(["artifacts/transpiled-renovation/viz/sankey/tracker.js"], ["./sankey","../components/tracker"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/sankey/tracker.js", ["./sankey", "../components/tracker"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.plugin = exports._TESTS_dataKey = void 0;
  var _sankey = _interopRequireDefault($__require("./sankey"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./sankey","../components/tracker"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./sankey"), require("../components/tracker"));
  else
