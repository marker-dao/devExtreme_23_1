...
(["artifacts/transpiled-renovation/viz/range_selector/slider.js"], ["./common","./slider_marker","../../core/utils/support"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/range_selector/slider.js", ["./common", "./slider_marker", "../../core/utils/support"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _slider_marker = _interopRequireDefault($__require("./slider_marker"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./common","./slider_marker","../../core/utils/support"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./common"), require("./slider_marker"), require("../../core/utils/support"));
  else
