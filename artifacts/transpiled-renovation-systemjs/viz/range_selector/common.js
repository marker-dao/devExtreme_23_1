...
(["artifacts/transpiled-renovation/viz/range_selector/common.js"], ["../axes/smart_formatter","../../core/utils/type"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/range_selector/common.js", ["../axes/smart_formatter", "../../core/utils/type"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.utils = exports.formatValue = exports.consts = exports.HEIGHT_COMPACT_MODE = void 0;
  var _smart_formatter = $__require("../axes/smart_formatter");
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../axes/smart_formatter","../../core/utils/type"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../axes/smart_formatter"), require("../../core/utils/type"));
  else
