...
(["artifacts/transpiled-renovation/viz/gauges/circular_range_container.js"], ["./base_range_container","../core/utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/gauges/circular_range_container.js", ["./base_range_container", "../core/utils"], true, function ($__require, exports, module) {
  "use strict";

  var global = this || self,
      GLOBAL = global;
  exports.default = void 0;
  var _base_range_container = _interopRequireDefault($__require("./base_range_container"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./base_range_container","../core/utils"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./base_range_container"), require("../core/utils"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=circular_range_container.js.map