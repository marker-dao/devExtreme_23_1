...
(["artifacts/transpiled-renovation/viz/gauges/bar_gauge.js"], ["../../core/component_registrator","../../core/utils/object","../../core/utils/common","../chart_components/base_chart","../../core/utils/extend","../core/utils","./base_gauge","./circular_gauge","../components/legend","../core/center_template","../../core/utils/math"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/viz/gauges/bar_gauge.js", ["../../core/component_registrator", "../../core/utils/object", "../../core/utils/common", "../chart_components/base_chart", "../../core/utils/extend", "../core/utils", "./base_gauge", "./circular_gauge", "../components/legend", "../core/center_template", "../../core/utils/math"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _circular_gauge = _interopRequireDefault($__require("./circular_gauge"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/component_registrator","../../core/utils/object","../../core/utils/common","../chart_components/base_chart","../../core/utils/extend","../core/utils","./base_gauge","./circular_gauge","../components/legend","../core/center_template","../../core/utils/math"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/component_registrator"), require("../../core/utils/object"), require("../../core/utils/common"), require("../chart_components/base_chart"), require("../../core/utils/extend"), require("../core/utils"), require("./base_gauge"), require("./circular_gauge"), require("../components/legend"), require("../core/center_template"), require("../../core/utils/math"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=bar_gauge.js.map