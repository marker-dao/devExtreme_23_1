...
(["artifacts/transpiled-renovation/bundles/modules/data.js"], ["./core","../../core/errors","../../data/errors","../../data/data_source","../../data/query","../../data/abstract_store","../../data/array_store","../../data/custom_store","../../data/local_store","../../data/utils","../../data/apply_changes","../../core/guid","../../core/utils/data","../../data/endpoint_selector","../../data/query_implementation","../../data/query_adapters","../../data/store_helper","../../data/data_source/utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('artifacts/transpiled-renovation/bundles/modules/data.js', ['./core', '../../core/errors', '../../data/errors', '../../data/data_source', '../../data/query', '../../data/abstract_store', '../../data/array_store', '../../data/custom_store', '../../data/local_store', '../../data/utils', '../../data/apply_changes', '../../core/guid', '../../core/utils/data', '../../data/endpoint_selector', '../../data/query_implementation', '../../data/query_adapters', '../../data/store_helper', '../../data/data_source/utils'], true, function ($__require, exports, module) {
  "use strict";
