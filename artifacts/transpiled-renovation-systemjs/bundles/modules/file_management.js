...
(["artifacts/transpiled-renovation/bundles/modules/file_management.js"], ["./core","../../file_management/error","../../file_management/file_system_item","../../file_management/object_provider","../../file_management/remote_provider","../../file_management/custom_provider"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/bundles/modules/file_management.js", ["./core", "../../file_management/error", "../../file_management/file_system_item", "../../file_management/object_provider", "../../file_management/remote_provider", "../../file_management/custom_provider"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./core","../../file_management/error","../../file_management/file_system_item","../../file_management/object_provider","../../file_management/remote_provider","../../file_management/custom_provider"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./core"), require("../../file_management/error"), require("../../file_management/file_system_item"), require("../../file_management/object_provider"), require("../../file_management/remote_provider"), require("../../file_management/custom_provider"));
  else
