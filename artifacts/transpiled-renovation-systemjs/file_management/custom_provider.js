...
(["artifacts/transpiled-renovation/file_management/custom_provider.js"], ["../core/utils/common","../core/utils/type","../core/utils/data","./provider_base"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/file_management/custom_provider.js", ["../core/utils/common", "../core/utils/type", "../core/utils/data", "./provider_base"], true, function ($__require, exports, module) {
  "use strict";
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../core/utils/common","../core/utils/type","../core/utils/data","./provider_base"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../core/utils/common"), require("../core/utils/type"), require("../core/utils/data"), require("./provider_base"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=custom_provider.js.map