...
(["artifacts/transpiled-renovation/file_management/object_provider.js"], ["../core/utils/common","../core/utils/data","../core/guid","../core/utils/type","../data/errors","../core/utils/deferred","../core/utils/window","../exporter/file_saver","../ui/widget/ui.errors","jszip","./provider_base","./error","./error_codes","./utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/file_management/object_provider.js", ["../core/utils/common", "../core/utils/data", "../core/guid", "../core/utils/type", "../data/errors", "../core/utils/deferred", "../core/utils/window", "../exporter/file_saver", "../ui/widget/ui.errors", "jszip", "./provider_base", "./error", "./error_codes", "./utils"], true, function ($__require, exports, module) {
  "use strict";
