...
(["artifacts/transpiled/data/custom_store.js"], ["../core/renderer","./utils","./array_utils","../core/utils/type","../core/config","./errors","./abstract_store","./array_query","./store_helper","../core/utils/deferred"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/data/custom_store.js", ["../core/renderer", "./utils", "./array_utils", "../core/utils/type", "../core/config", "./errors", "./abstract_store", "./array_query", "./store_helper", "../core/utils/deferred"], true, function ($__require, exports, module) {
  "use strict";
