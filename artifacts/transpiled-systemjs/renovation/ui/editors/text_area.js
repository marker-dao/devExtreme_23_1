...
(["artifacts/transpiled/renovation/ui/editors/text_area.js"], ["inferno","@devextreme/runtime/inferno","../../../ui/text_area","../common/dom_component_wrapper","./common/editor","./common/editor_state_props","./common/editor_label_props","./common/text_editor_props"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/renovation/ui/editors/text_area.js", ["inferno", "@devextreme/runtime/inferno", "../../../ui/text_area", "../common/dom_component_wrapper", "./common/editor", "./common/editor_state_props", "./common/editor_label_props", "./common/text_editor_props"], true, function ($__require, exports, module) {
  "use strict";
