...
(["artifacts/transpiled/renovation/ui/pager/content.js"], ["inferno","@devextreme/runtime/inferno","./info","./pages/page_index_selector","./page_size/selector","./common/consts","./common/pager_props","../../utils/combine_classes","../common/widget","../../../ui/shared/accessibility","./common/keyboard_action_context"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/renovation/ui/pager/content.js", ["inferno", "@devextreme/runtime/inferno", "./info", "./pages/page_index_selector", "./page_size/selector", "./common/consts", "./common/pager_props", "../../utils/combine_classes", "../common/widget", "../../../ui/shared/accessibility", "./common/keyboard_action_context"], true, function ($__require, exports, module) {
  "use strict";
