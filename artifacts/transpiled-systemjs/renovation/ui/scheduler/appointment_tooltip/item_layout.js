...
(["artifacts/transpiled/renovation/ui/scheduler/appointment_tooltip/item_layout.js"], ["inferno","@devextreme/runtime/inferno","./marker","../../button","./item_content","./utils/get_current_appointment","./utils/default_functions"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/renovation/ui/scheduler/appointment_tooltip/item_layout.js", ["inferno", "@devextreme/runtime/inferno", "./marker", "../../button", "./item_content", "./utils/get_current_appointment", "./utils/default_functions"], true, function ($__require, exports, module) {
  "use strict";
