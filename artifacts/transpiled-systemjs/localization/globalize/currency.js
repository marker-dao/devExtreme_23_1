...
(["artifacts/transpiled/localization/globalize/currency.js"], ["../open_xml_currency_format","./core","./number","../currency","globalize/currency","globalize","../../core/config","../number"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/localization/globalize/currency.js", ["../open_xml_currency_format", "./core", "./number", "../currency", "globalize/currency", "globalize", "../../core/config", "../number"], true, function ($__require, exports, module) {
  "use strict";
