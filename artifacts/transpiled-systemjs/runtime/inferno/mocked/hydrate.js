...
System.register(["inferno", "./shared"], function (_export, _context) {
  "use strict";

  var _CI, _HI, _M, _MCCC, _ME, _MFCC, _MP, _MR, EMPTY_OBJ, render, renderFunctionalComponent, isFunction, isInvalid, isNull, isNullOrUndef, throwError;
  ...
  _export("hydrate", hydrate);
  return {
    setters: [function (_inferno) {
      _CI = _inferno._CI;
      _HI = _inferno._HI;
      _M = _inferno._M;
      _MCCC = _inferno._MCCC;
      _ME = _inferno._ME;
      _MFCC = _inferno._MFCC;
      _MP = _inferno._MP;
      _MR = _inferno._MR;
      EMPTY_OBJ = _inferno.EMPTY_OBJ;
      render = _inferno.render;
      renderFunctionalComponent = _inferno._RFC;
    }, function (_shared) {
      isFunction = _shared.isFunction;
      isInvalid = _shared.isInvalid;
      isNull = _shared.isNull;
      isNullOrUndef = _shared.isNullOrUndef;
      throwError = _shared.throwError;
    }],
    execute: function () {}
  };
});