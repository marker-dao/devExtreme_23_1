...
System.register([], function (_export, _context) {
  ...
  var NUMBER_STYLES, isNumeric, getNumberStyleValue, uppercasePattern, kebabCase;
  ...
  _export("normalizeStyles", normalizeStyles);
  return {
    setters: [],
    execute: function () {
      ...
      getNumberStyleValue = function getNumberStyleValue(style, value) {
