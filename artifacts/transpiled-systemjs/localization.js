...
(["artifacts/transpiled/localization.js"], ["./localization/core","./localization/message","./localization/number","./localization/date","./localization/currency"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/localization.js", ["./localization/core", "./localization/message", "./localization/number", "./localization/date", "./localization/currency"], true, function ($__require, exports, module) {
  "use strict";
