...
(["artifacts/transpiled/ui/filter_builder/utils.js"], ["../../core/renderer","../../core/utils/deferred","../../data/errors","../../core/utils/type","../../core/utils/data","../widget/ui.errors","../shared/filtering","../../format_helper","../../core/utils/extend","../../core/utils/inflector","./between","../../localization/message","../../data/data_source/data_source","./ui.filter_operations_dictionary"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/ui/filter_builder/utils.js", ["../../core/renderer", "../../core/utils/deferred", "../../data/errors", "../../core/utils/type", "../../core/utils/data", "../widget/ui.errors", "../shared/filtering", "../../format_helper", "../../core/utils/extend", "../../core/utils/inflector", "./between", "../../localization/message", "../../data/data_source/data_source", "./ui.filter_operations_dictionary"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _between = $__require("./between");
  var _message = _interopRequireDefault($__require("../../localization/message"));
  var _data_source = $__require("../../data/data_source/data_source");
  var _ui2 = _interopRequireDefault($__require("./ui.filter_operations_dictionary"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/renderer","../../core/utils/deferred","../../data/errors","../../core/utils/type","../../core/utils/data","../widget/ui.errors","../shared/filtering","../../format_helper","../../core/utils/extend","../../core/utils/inflector","./between","../../localization/message","../../data/data_source/data_source","./ui.filter_operations_dictionary"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/renderer"), require("../../core/utils/deferred"), require("../../data/errors"), require("../../core/utils/type"), require("../../core/utils/data"), require("../widget/ui.errors"), require("../shared/filtering"), require("../../format_helper"), require("../../core/utils/extend"), require("../../core/utils/inflector"), require("./between"), require("../../localization/message"), require("../../data/data_source/data_source"), require("./ui.filter_operations_dictionary"));
  else
