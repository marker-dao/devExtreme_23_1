...
(["artifacts/transpiled/core/devices.js"], ["./utils/size","../core/renderer","./utils/window","./utils/extend","./utils/type","./utils/iterator","./errors","./utils/callbacks","./utils/ready_callbacks","./utils/resize_callbacks","./events_strategy","./utils/storage","./utils/view_port","./config"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/core/devices.js", ["./utils/size", "../core/renderer", "./utils/window", "./utils/extend", "./utils/type", "./utils/iterator", "./errors", "./utils/callbacks", "./utils/ready_callbacks", "./utils/resize_callbacks", "./events_strategy", "./utils/storage", "./utils/view_port", "./config"], true, function ($__require, exports, module) {
  "use strict";
