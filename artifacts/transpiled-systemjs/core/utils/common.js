...
(["artifacts/transpiled/core/utils/common.js"], ["../config","../guid","../utils/deferred","./data","./iterator","./type"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/core/utils/common.js", ["../config", "../guid", "../utils/deferred", "./data", "./iterator", "./type"], true, function ($__require, exports, module) {
  "use strict";
