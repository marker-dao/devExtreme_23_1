...
(["artifacts/transpiled/core/utils/error.js"], ["./extend","./console","./string","../version"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/core/utils/error.js", ["./extend", "./console", "./string", "../version"], true, function ($__require, exports, module) {
  "use strict";
