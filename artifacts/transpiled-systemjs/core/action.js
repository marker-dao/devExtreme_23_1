...
(["artifacts/transpiled/core/action.js"], ["./renderer","./utils/window","./utils/type","./utils/iterator"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/core/action.js", ["./renderer", "./utils/window", "./utils/type", "./utils/iterator"], true, function ($__require, exports, module) {
  "use strict";
