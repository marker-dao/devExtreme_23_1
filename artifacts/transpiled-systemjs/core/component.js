...
(["artifacts/transpiled/core/component.js"], ["./config","./utils/extend","./options/index","./options/utils","./class","./action","./errors","./utils/callbacks","./events_strategy","./utils/public_component","./postponed_operations","./utils/type","./utils/common","./utils/data"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/core/component.js", ["./config", "./utils/extend", "./options/index", "./options/utils", "./class", "./action", "./errors", "./utils/callbacks", "./events_strategy", "./utils/public_component", "./postponed_operations", "./utils/type", "./utils/common", "./utils/data"], true, function ($__require, exports, module) {
  "use strict";
