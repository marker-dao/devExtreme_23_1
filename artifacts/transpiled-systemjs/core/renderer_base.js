...
(["artifacts/transpiled/core/renderer_base.js"], ["./element_data","./dom_adapter","./utils/window","./utils/type","./utils/style","./utils/size","./utils/html_parser"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/core/renderer_base.js", ["./element_data", "./dom_adapter", "./utils/window", "./utils/type", "./utils/style", "./utils/size", "./utils/html_parser"], true, function ($__require, exports, module) {
  "use strict";
