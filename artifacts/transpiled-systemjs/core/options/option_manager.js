...
(["artifacts/transpiled/core/options/option_manager.js"], ["../utils/data","../utils/common","../utils/comparator","../utils/extend","../utils/type","./utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/core/options/option_manager.js", ["../utils/data", "../utils/common", "../utils/comparator", "../utils/extend", "../utils/type", "./utils"], true, function ($__require, exports, module) {
  "use strict";
