...
(["artifacts/transpiled/viz/tree_map/tree_map.base.js"], ["./common","./node","./tiling","./colorizing","../core/utils","../../core/utils/common","../core/base_widget","./tiling.squarified","./colorizing.discrete","../../core/component_registrator","../core/data_source"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/viz/tree_map/tree_map.base.js", ["./common", "./node", "./tiling", "./colorizing", "../core/utils", "../../core/utils/common", "../core/base_widget", "./tiling.squarified", "./colorizing.discrete", "../../core/component_registrator", "../core/data_source"], true, function ($__require, exports, module) {
  "use strict";
