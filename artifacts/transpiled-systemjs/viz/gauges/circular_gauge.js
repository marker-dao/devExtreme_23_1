...
(["artifacts/transpiled/viz/gauges/circular_gauge.js"], ["../../core/component_registrator","../../core/utils/object","../../core/utils/extend","../../core/utils/iterator","./base_gauge","./common","../core/utils","../core/center_template","./circular_indicators","./circular_range_container"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/viz/gauges/circular_gauge.js", ["../../core/component_registrator", "../../core/utils/object", "../../core/utils/extend", "../../core/utils/iterator", "./base_gauge", "./common", "../core/utils", "../core/center_template", "./circular_indicators", "./circular_range_container"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var circularIndicators = _interopRequireWildcard($__require("./circular_indicators"));
  var _circular_range_container = _interopRequireDefault($__require("./circular_range_container"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/component_registrator","../../core/utils/object","../../core/utils/extend","../../core/utils/iterator","./base_gauge","./common","../core/utils","../core/center_template","./circular_indicators","./circular_range_container"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/component_registrator"), require("../../core/utils/object"), require("../../core/utils/extend"), require("../../core/utils/iterator"), require("./base_gauge"), require("./common"), require("../core/utils"), require("../core/center_template"), require("./circular_indicators"), require("./circular_range_container"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=circular_gauge.js.map