...
(["artifacts/transpiled/viz/series/base_series.js"], ["../../core/utils/type","../../core/utils/extend","../../core/utils/iterator","./points/base_point","../core/utils","../../core/utils/common","../components/consts","./helpers/range_data_calculator","./scatter_series","./line_series","./area_series","./bar_series","./range_series","./bubble_series","./pie_series","./financial_series","./stacked_series"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled/viz/series/base_series.js", ["../../core/utils/type", "../../core/utils/extend", "../../core/utils/iterator", "./points/base_point", "../core/utils", "../../core/utils/common", "../components/consts", "./helpers/range_data_calculator", "./scatter_series", "./line_series", "./area_series", "./bar_series", "./range_series", "./bubble_series", "./pie_series", "./financial_series", "./stacked_series"], true, function ($__require, exports, module) {
  "use strict";
