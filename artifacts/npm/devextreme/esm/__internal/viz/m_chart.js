...
var dxChart = AdvancedChart.inherit({
  ...
  _applyAutoHidePointMarkers(filteredSeries) {
    ...
    var reducerFunc = (pointsCount, currentPoint) => pointsCount + isPointOverlapped(currentPoint, overlappingPoints, true);
  ...
  _renderAxes(drawOptions, panesBorderOptions) {
    ...
    var panesCanvases = that.panes.reduce((canvases, pane) => {
  ...
  _notifyVisualRange() {
    ...
    var argumentVisualRange = convertVisualRangeObject(argAxis.visualRange(), !isArray(that.option('argumentAxis.visualRange')));
