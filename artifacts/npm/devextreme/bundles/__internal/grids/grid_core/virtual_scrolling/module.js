  ...
  return {
    ...
    _renderCore: function _renderCore(e) {
      ...
      if (dataSource && e) {
        ...
        if (_module_utils.default.isVirtualRowRendering(this) && itemCount > 0 && this.option(LEGACY_SCROLLING_MODE) !== false) {
      ...
      data: function () {
        var members = {
          ...
          _updateItemsCore: function _updateItemsCore(change) {
            ...
            this.callBase.apply(this, arguments);
            if (this.option(LEGACY_SCROLLING_MODE) === false && _module_utils.default.isVirtualRowRendering(this)) {
