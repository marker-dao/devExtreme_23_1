...
var resizingControllerMembers = {
  ...
  _waitAsyncTemplates: function _waitAsyncTemplates() {
    var _a, _b, _c;
    return (0, _deferred.when)((_a = this._columnHeadersView) === null || _a === void 0 ? void 0 : _a.waitAsyncTemplates(), (_b = this._rowsView) === null || _b === void 0 ? void 0 : _b.waitAsyncTemplates(), (_c = this._footerView) === null || _c === void 0 ? void 0 : _c.waitAsyncTemplates());
  },
