...
var FilterPanelView = _modules.default.View.inherit({
  ...
  _getFilterElement: function _getFilterElement() {
    ...
    (0, _module_accessibility.registerKeyboardAction)('filterPanel', that, $element, undefined, function () {
      return that._showFilterBuilder();
    });
  ...
  _getTextElement: function _getTextElement() {
    ...
    (0, _module_accessibility.registerKeyboardAction)('filterPanel', that, $textElement, undefined, function () {
      return that._showFilterBuilder();
    });
  ...
  _getRemoveButtonElement: function _getRemoveButtonElement() {
    ...
    (0, _module_accessibility.registerKeyboardAction)('filterPanel', this, $element, undefined, clearFilterValue);
    that._addTabIndexToElement($element);
    return $element;
  },
