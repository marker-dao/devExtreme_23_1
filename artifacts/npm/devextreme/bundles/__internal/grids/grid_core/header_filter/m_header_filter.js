...
const HeaderFilterController = _m_modules.default.ViewController.inherit(function () {
  ...
  return {
    ...
    getDataSource(column) {
      ...
      const headerFilterDataSource = (_a = column.headerFilter) === null || _a === void 0 ? void 0 : _a.dataSource;
