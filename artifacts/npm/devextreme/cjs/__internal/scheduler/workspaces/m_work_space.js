...
let SchedulerWorkSpace = /*#__PURE__*/function (_WidgetObserver) {
  ...
  _proto.renderRWorkSpace = function renderRWorkSpace(componentsToRender) {
    ...
    const components = componentsToRender !== null && componentsToRender !== void 0 ? componentsToRender : allComponents;
  ...
  _proto.renderWorkSpace = function renderWorkSpace() {
    let isGenerateNewViewData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
    this.cache.clear();
