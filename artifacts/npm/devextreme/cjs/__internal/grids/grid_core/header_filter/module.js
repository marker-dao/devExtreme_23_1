...
var HeaderFilterController = _modules.default.ViewController.inherit(function () {
  ...
  return {
    ...
    getHeaderItemText: function getHeaderItemText(displayValue, column, currentLevel, headerFilterOptions) {
      var text = _module_utils.default.formatValue(displayValue, getFormatOptions(displayValue, column, currentLevel));
      if (!text) {
...
var ColumnHeadersViewHeaderFilterExtender = (0, _extend.extend)({}, _module_core.headerFilterMixin, {
  _renderCellContent: function _renderCellContent($cell, options) {
    ...
    var column = options.column;
    if (!column.command && (0, _module_core.allowHeaderFiltering)(column) && that.option('headerFilter.visible') && options.rowType === 'header') {
      ...
      if ((0, _module_core.allowHeaderFiltering)(column) && column.calculateFilterExpression && Array.isArray(column.filterValues) && column.filterValues.length) {
        ...
        (0, _iterator.each)(column.filterValues, function (_, filterValue) {
          if (Array.isArray(filterValue)) {
            ...
            if (column.deserializeValue && !_module_utils.default.isDateType(column.dataType) && column.dataType !== 'number') {
