System.register(["jquery", "core/utils/browser", "ui/form/ui.form", "material_blue_light.css!", "../../helpers/FormLayoutTestWrapper.js", "ui/form/components/field_item"], function (_export, _context) {
  "use strict";

  var $, browser, FormLayoutTestWrapper, FIELD_ITEM_CONTENT_WRAPPER_CLASS;
  ...
  return {
    ...
    }, function (_uiFormUiForm) {}, function (_material_blue_lightCss) {}, function (_helpersFormLayoutTestWrapperJs) {
      FormLayoutTestWrapper = _helpersFormLayoutTestWrapperJs.default;
    }, function (_uiFormComponentsField_item) {
      FIELD_ITEM_CONTENT_WRAPPER_CLASS = _uiFormComponentsField_item.FIELD_ITEM_CONTENT_WRAPPER_CLASS;
    }],
    execute: function () {
      ...
      QUnit.module('Form scenarios', () => {
        ...
        testChromeOnly('1 column -> [item1, { group [{ item2 }] ]', function (assert) {
          test_1Column_2ItemsLayout(['item1', {
            itemType: 'group',
            items: ['item2']
          }]);
        });
        ...
        testChromeOnly('1 column -> [item1, { group [{ group [{ item2 }] }], item3]', function (assert) {
          test_1Column_3ItemsLayout(['item1', {
            itemType: 'group',
            items: [{
              itemType: 'group',
              items: ['item2']
        ...
        testChromeOnly('2 columns -> [item1, { group [{ item2 }] }]', function (assert) {
          test_2Column_2ItemsLayout(['item1', {
            itemType: 'group',
            items: ['item2']
          }]);
        });
        ...
        testChromeOnly('2 columns -> [item1, { group [{ group [{ item2 }] }], item3]', function (assert) {
          test_2Columns_3ItemsLayout(['item1', {
            itemType: 'group',
            items: [{
              itemType: 'group',
              items: ['item2']
        ...
        testChromeOnly('2 column -> [item1, { group [{ tabbed [{ item2 }] }] }]', function (assert) {
          const wrapper = new FormLayoutTestWrapper(2, {}, ['item1', {
            itemType: 'group',
            caption: 'Contact Information',
            items: [{
              itemType: 'tabbed',
      ...
      QUnit.module('Left label location scenarios', () => {
        ...
        testChromeOnly('3 columns -> [item1, i2.colSpan2]', function (assert) {
          const wrapper = new FormLayoutTestWrapper(3, {
            labelLocation: 'left'
          }, ['item1', {
            dataField: 'i2',
            colSpan: 2
              ...
              templates: {
                itemTemplate: {
                  render({
                    ...
                    $editorElement = $('<div>').addClass('dx-template-wrapper').appendTo(container);
                    setTimeout(() => {
                      $editorElement.dxTextBox({}).dxValidator({
                        validationRules: [{
                          type: 'required',
