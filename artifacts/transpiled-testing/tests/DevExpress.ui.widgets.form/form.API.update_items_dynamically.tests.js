...
(["testing/tests/DevExpress.ui.widgets.form/form.API.update_items_dynamically.tests.js"], ["core/utils/size","jquery","ui/form/ui.form","ui/form/ui.form.layout_manager","ui/form/components/label.js","generic_light.css!"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.form/form.API.update_items_dynamically.tests.js", ["core/utils/size", "jquery", "ui/form/ui.form", "ui/form/ui.form.layout_manager", "ui/form/components/label.js", "generic_light.css!"], function($__export) {
  "use strict";
  var getWidth,
      $,
      renderLabel,
  ...
  return {
    ...
    execute: function() {
      ...
      TABPANEL_CONTAINER = 'dx-tabpanel-container';
      ...
      FormTestWrapper = function() {
        function FormTestWrapper(options) {
        ...
        return ($traceurRuntime.createClass)(FormTestWrapper, {
          _getTestContainer: function() {
            return $('#form');
          },
          _createLayoutManagerStubs: function($form) {
            var layoutManagers = $form.find(("." + FORM_LAYOUT_MANAGER_CLASS)).toArray().map(function(item) {
              return $(item).dxLayoutManager('instance');
            });
            return layoutManagers.map(function(layoutManager) {
              var stub = sinon.stub();
              layoutManager.on('contentReady', stub);
              return stub;
            });
          },
          _getLabelWidth: function(text) {
            var $label = renderLabel({
              text: text,
              location: 'left'
            }).appendTo(this._getTestContainer());
            var width = getWidth($label.children().first());
            $label.remove();
            return width;
          },
          _findLabelTextsInColumn: function($container, columnIndex) {
            return $container.find((".dx-col-" + columnIndex + " ." + FIELD_ITEM_LABEL_CONTENT_CLASS));
          },
          _checkLabelTextsWidthByEtalon: function($labelTexts, etalonLabelText) {
            QUnit.assert.ok($labelTexts.length > 0, 'labels texts are rendered');
            var etalonLabelWidth = this._getLabelWidth((etalonLabelText + ":"));
            $labelTexts.toArray().forEach(function(text) {
              var $text = $(text);
              var textWidth = getWidth($text);
              QUnit.assert.roughEqual(textWidth, etalonLabelWidth, 1, ("width of the " + $text.text()));
            });
          },
          setOption: function(id, optionName, value) {
            this._form.option((id + "." + optionName), value);
          },
          setItemOption: function(id, optionName, value) {
          ...
          updateLayoutManagerStubs: function() {
            this._contentReadyStubs = this._createLayoutManagerStubs(this._form.$element());
          },
          checkValidationSummaryContent: function(expectedMessages) {
            var $itemsContent = this._form.$element().find('.dx-validationsummary-item-content');
            QUnit.assert.equal($itemsContent.length, expectedMessages.length, 'validation summary items');
            $itemsContent.toArray().forEach(function(item, index) {
              QUnit.assert.strictEqual($(item).text(), expectedMessages[index], (index + " item text of the validation summary"));
            });
          },
          checkValidationResult: function($__5) {
            var $__6 = $__5,
                isValid = $__6.isValid,
                brokenRulesCount = $__6.brokenRulesCount,
                validatorsCount = $__6.validatorsCount;
            var result = this._form.validate();
          ...
          checkFormsReRender: function() {
            var message = arguments[0] !== (void 0) ? arguments[0] : '';
            var isReRender = arguments[1] !== (void 0) ? arguments[1] : false;
          ...
          checkLayoutManagerRendering: function(expectedRenderingArray) {
            var message = arguments[1] !== (void 0) ? arguments[1] : '';
            this._contentReadyStubs.forEach(function(stub, index) {
              var expected = expectedRenderingArray[index];
              if (stub.callCount > 1) {
            ...
            this._contentReadyStubs.forEach(function(stub) {
              return stub.reset();
            });
          },
          checkSimpleItem: function(id, expectedValue, expectedLabel) {
            var editor = this._form.getEditor(id);
            var attrID = editor.option('inputAttr.id');
            var labelText = $(("[for='" + attrID + "'] .dx-field-item-label-text")).text();
          ...
          checkEditorInstanceRemoved: function(id) {
            var editor = this._form.getEditor(id);
            QUnit.assert.notOk(!!editor, ("editor of " + id + " doesn't contains in the Form"));
          },
          checkLabelText: function(itemSelector, expectedText) {
            var labelText = $(itemSelector).find('.dx-field-item-label-text').text();
            QUnit.assert.strictEqual(labelText, (expectedText + ":"), 'text of label');
          },
          checkHelpText: function(itemSelector, expectedText) {
            var helpText = $(itemSelector).find('.dx-field-item-help-text').text();
            QUnit.assert.strictEqual(helpText, ("" + expectedText), 'text of helpText');
          },
          checkItemElement: function(selector, expected, message) {
            QUnit.assert.equal(this._form.$element().find(selector).length > 0, expected, message || 'item element');
          },
          checkGroupCaption: function(groupSelector, expectedCaption) {
          ...
          checkTabTitle: function(tabSelector, expectedTitle) {
            QUnit.assert.strictEqual(this._form.$element().find((tabSelector + " .dx-tab-text")).text(), expectedTitle, 'caption of tab');
          },
          checkLabelsWidthInGroup: function($__5) {
            var $__7;
            var $__6 = $__5,
                columnIndex = $__6.columnIndex,
                groupColumnIndex = ($__7 = $__6.groupColumnIndex) === void 0 ? 0 : $__7,
                etalonLabelText = $__6.etalonLabelText;
            var $groups = this._form._getGroupElementsInColumn(this._getTestContainer(), columnIndex);
            var $texts = this._findLabelTextsInColumn($groups, groupColumnIndex);
            this._checkLabelTextsWidthByEtalon($texts, etalonLabelText);
          },
          checkLabelsWidthInTab: function($__5) {
            var $__6 = $__5,
                tabColumnIndex = $__6.tabColumnIndex,
                etalonLabelText = $__6.etalonLabelText;
            var $tabContainers = this._form.$element().find(("." + TABPANEL_CONTAINER));
            var $texts = this._findLabelTextsInColumn($tabContainers, tabColumnIndex);
            this._checkLabelTextsWidthByEtalon($texts, etalonLabelText);
          },
          checkLabelsBySelector: function($__5) {
            var $__7;
            var $__6 = $__5,
                itemSelector = $__6.itemSelector,
                columnIndex = ($__7 = $__6.columnIndex) === void 0 ? 0 : $__7,
                etalonLabelText = $__6.etalonLabelText;
            var $texts = this._form.$element().find((itemSelector + ".dx-col-" + columnIndex + " ." + FIELD_ITEM_LABEL_CONTENT_CLASS));
            this._checkLabelTextsWidthByEtalon($texts, etalonLabelText);
          },
          checkRequired: function(selector, expected, message) {
      ...
      module('Group item. Use the option method', function() {
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'group\', items:[\'dataField2\']}] }, change visible of dataField2)', function() {
          var testWrapper = new FormTestWrapper({
            formData: {
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'group\', items:[\'dataField2\']}] }, change items of group)', function() {
          ...
          testWrapper.setOption('items[1]', 'items', ['dataField11', 'dataField12'].map(function(dataField) {
            return ({
              dataField: dataField,
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'group\', items:[{itemType: \'group\', items: [\'dataField2\']}]}] }, change items of first group)', function() {
          ...
          var items = ['dataField11', 'dataField12'].map(function(dataField, index) {
            return ({
              itemType: 'group',
          ...
          var message = 'items: [{itemType: "group", items: ["dataField11"]}, {itemType: "group", items: ["dataField12"]}]';
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'group\', items:[{itemType: \'group\', items: [\'dataField2\']}]}] }, change items of last group)', function() {
          ...
          var items = ['dataField11', 'dataField12'].map(function(dataField) {
            return ({
              dataField: dataField,
              editorType: 'dxTextBox'
            });
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'group\', items:[\'dataField2\']}, {itemType: \'group\', items:[\'dataField3\']}] }, change items in the both groups)', function() {
          ...
          testWrapper.checkSimpleItem('dataField12', '', 'Data Field 12');
          testWrapper.checkEditorInstanceRemoved('dataField2');
          testWrapper.setOption('items[2]', 'items', ['dataField21', 'dataField22'].map(function(dataField) {
            return ({
              dataField: dataField,
              editorType: 'dxTextBox'
            });
        ...
        test('Set { items: [{itemType: \'group\', items:[{itemType: \'group\', items:[\'dataField2\']}, \'dataField1\']}] }, change required of dataField1 and change visible of dataField2)', function() {
          var testWrapper = new FormTestWrapper({items: [{
              itemType: 'group',
              items: [{
                itemType: 'group',
                items: [{
      ...
      module('Tabbed item. Use the option method', function() {
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'tabbed\', tabs:[{items: \'dataField2\'}]}] }, change items of tab)', function() {
          var testWrapper = new FormTestWrapper({
            ...
            items: ['dataField1', {
              itemType: 'tabbed',
              tabs: [{items: ['dataField2']}]
            }]
          });
          testWrapper.setOption('items[1].tabs[0]', 'items', ['dataField11', 'dataField12'].map(function(dataField) {
            return ({
              dataField: dataField,
              editorType: 'dxTextBox'
            });
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'tabbed\', tabs:[{items: \'dataField2\'}]}] }, change editorOptions of dataField2)', function() {
          var testWrapper = new FormTestWrapper({
            ...
            items: ['dataField1', {
              itemType: 'tabbed',
              tabs: [{items: [{dataField: 'dataField2'}]}]
            }]
          });
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'tabbed\', tabs:[{items: [{itemType: \'group\', items:[\'dataField2\']}]}]}] }, change visible of dataField2)', function() {
          ...
          var id = 'items[1].tabs[0].items[0].items[0]';
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'tabbed\', tabs:[{items: [{itemType: \'group\', items:[\'dataField2\']}]}]}] }, change items of group)', function() {
          ...
          var id = 'items[1].tabs[0].items[0]';
          testWrapper.setOption(id, 'items', ['dataField11', 'dataField12'].map(function(dataField) {
            return ({
              dataField: dataField,
              editorType: 'dxTextBox'
            });
      ...
      module('Group item. Use the itemOption method', function() {
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'group\', items:[\'dataField2\']}] }, change items of group)', function() {
          ...
          testWrapper.setItemOption('group1', 'items', ['dataField11', 'dataField12'].map(function(dataField) {
            return ({
              dataField: dataField,
              editorType: 'dxTextBox'
            });
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'group\', items:[\'dataField2\']}] }, change items of group, change visible of dataField12)', function() {
          ...
          testWrapper.setItemOption('group1', 'items', ['dataField11', 'dataField12'].map(function(dataField, index) {
            return ({
              dataField: dataField,
              editorType: 'dxTextBox',
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'group\', items:[{itemType: \'group\', items: [\'dataField2\']}]}] }, change items of second group, change visible of dataField2)', function() {
          ...
          testWrapper.setItemOption('group2', 'items', ['dataField11', 'dataField12'].map(function(dataField, index) {
            return ({
              dataField: dataField,
              editorType: 'dxTextBox',
              cssClass: (".test-item1" + (index + 1))
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'group\', items:[\'dataField2\']}, {itemType: \'group\', items:[\'dataField3\']}] }, change items in the both groups)', function() {
          ...
          testWrapper.checkSimpleItem('dataField12', '', 'Data Field 12');
          testWrapper.checkEditorInstanceRemoved('dataField2');
          testWrapper.setItemOption('group2', 'items', ['dataField21', 'dataField22'].map(function(dataField) {
            return ({
              dataField: dataField,
              editorType: 'dxTextBox'
            });
        ...
        test('Set { items: [{itemType: \'group\', items:[{itemType: \'group\', items:[\'dataField2\']}, \'dataField1\']}] }, change required of dataField1 and change visible of dataField2)', function() {
          ...
          testWrapper.setItemOption('dataField1', {isRequired: true});
          testWrapper.checkFormsReRender('change isRequired of dataField1');
          testWrapper.checkLayoutManagerRendering([false, true, false], 'change isRequired of dataField1');
          testWrapper.checkRequired('.test-item1', true, 'required of dataField 1');
          testWrapper.updateLayoutManagerStubs();
        ...
        test('{ items: [{ caption:group1, [{ caption:group1_1 }] } -> itemOption(group1.group1_1, template)', function() {
          ...
          QUnit.assert.strictEqual(JSON.stringify(form.option('items')), JSON.stringify([{
            itemType: 'group',
            name: 'group1',
            caption: 'group 1',
            items: [{
          ...
          QUnit.assert.strictEqual(JSON.stringify($('.dx-form-group-caption').toArray().map(function(item) {
            return $(item).text();
          })), JSON.stringify(['group 1', 'group 1_1']));
      ...
      module('Tabbed item. Use the itemOption method', function() {
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {temType: \'tabbed\', tabs:[{items: \'dataField2\'}]}] }, change items of tab)', function() {
          ...
          testWrapper.setItemOption('tab1', 'items', ['dataField11', 'dataField12'].map(function(dataField) {
            return ({
              dataField: dataField,
              editorType: 'dxTextBox'
            });
        ...
        test('Set { formData: {\'DataField1\', \'DataField2\'}, items: [\'dataField1\', {itemType: \'tabbed\', tabs:[{items: [{itemType: \'group\', items:[\'dataField2\']}]}]}] }, change items of group)', function() {
          ...
          testWrapper.setItemOption('tab1.group1', 'items', ['dataField11', 'dataField12'].map(function(dataField) {
            return ({
              dataField: dataField,
              editorType: 'dxTextBox'
            });
        ...
        test('Set { items: [{itemType: \'tabbed\', tabs:[{items:[{itemType: \'group\', items:[\'dataField2\']}, \'dataField1\']}]}] }, change required of dataField1 and change visible of dataField2)', function() {
          ...
          testWrapper.setItemOption('tab1.dataField1', {isRequired: true});
          testWrapper.checkFormsReRender('change isRequired of dataField1');
          testWrapper.checkLayoutManagerRendering([false, true, false], 'change isRequired of dataField1');
          testWrapper.checkRequired('.test-item1', true, 'required of dataField 1');
          testWrapper.updateLayoutManagerStubs();
      ...
      module('Align labels', function() {
        test('Change visible of the simple item in the group when col count is 1', function() {
          ...
          testWrapper.checkLabelsWidthInGroup({
            columnIndex: 0,
            etalonLabelText: 'Last Name'
          });
        ...
        test('Change items of the groups when groups has col count is 2', function() {
          ...
          testWrapper.setItemOption('group2', 'items', ['address', 'mail', {
            dataField: 'city',
            label: {text: 'Test City'}
          }]);
          testWrapper.checkLabelsWidthInGroup({
        ...
        test('Change visible of the simple item in the tab when col count is 2', function() {
          ...
          testWrapper.checkLabelsWidthInTab({
            tabColumnIndex: 0,
            etalonLabelText: 'Home Address'
          });
          testWrapper.checkLabelsWidthInTab({
            tabColumnIndex: 1,
            etalonLabelText: 'Last Name'
        ...
        test('Labels of common layout align independently from labels of the tabbed item when parent col count is 1', function() {
          ...
          testWrapper.checkLabelsBySelector({
            itemSelector: '.parent',
            etalonLabelText: 'Birth Date'
          });
          testWrapper.checkLabelsWidthInGroup({
            columnIndex: 0,
            groupColumnIndex: 0,
      ...
      module('Validation', function() {
        test('Rendering new item with validation rules', function() {
          var testWrapper = new FormTestWrapper({
            formData: {dataField1: 'DataField1'},
            items: ['dataField1', {
              itemType: 'group',
              items: [{dataField: 'dataField2'}]
            }]
          ...
          testWrapper.checkValidationResult({
            isValid: false,
            brokenRulesCount: 1,
            validatorsCount: 1
          });
        ...
        test('Rendering new items with validation rules', function() {
          var testWrapper = new FormTestWrapper({
            ...
            items: ['dataField1', {
              itemType: 'group',
              items: [{dataField: 'dataField2'}, {dataField: 'dataField3'}]
            }]
          });
          testWrapper.setItemOption('dataField2', 'validationRules', [{type: 'required'}]);
        ...
        test('Rendering new items with validation rules instead of items without validation rules in the group and check the validation summary', function() {
          ...
          testWrapper.setItemOption('dataField2', 'validationRules', [{
            type: 'required',
            message: 'dataField2 is required'
          }]);
          testWrapper.setItemOption('dataField3', 'validationRules', [{
            type: 'required',
            message: 'dataField3 is required'
          }]);
          testWrapper.checkValidationResult({
            isValid: false,
            brokenRulesCount: 2,
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/size","jquery","ui/form/ui.form","ui/form/ui.form.layout_manager","ui/form/components/label.js","generic_light.css!"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/size"), require("jquery"), require("ui/form/ui.form"), require("ui/form/ui.form.layout_manager"), require("ui/form/components/label.js"), require("generic_light.css!"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=form.API.update_items_dynamically.tests.js.map