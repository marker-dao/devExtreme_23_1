...
(["testing/tests/DevExpress.viz.rangeSelector/common.part2.tests.js"], ["jquery","./rangeSelectorParts/commons.js","viz/range_selector/series_data_source","data/data_source/data_source","core/utils/date","../../helpers/vizMocks.js","viz/axes/base_axis","viz/core/title"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.rangeSelector/common.part2.tests.js', ['jquery', './rangeSelectorParts/commons.js', 'viz/range_selector/series_data_source', 'data/data_source/data_source', 'core/utils/date', '../../helpers/vizMocks.js', 'viz/axes/base_axis', 'viz/core/title'], true, function ($__require, exports, module) {
    ...
    const dataSourceModule = $__require('data/data_source/data_source');
    ...
    QUnit.test('range min/max from dataSource. ticks inside data source range - take range by data source', function (assert) {
        this.createWidget({
            dataSource: [{ t: 10, y1: 0 }, { t: 190, y1: 8 }],
            dataSourceField: 't',
            scale: {
                tickInterval: 20
            }
    ...
    QUnit.test('range min/max from series', function (assert) {
        this.createWidget({
            dataSource: [{ x: 10, y1: 0 }, { x: 15, y1: 6 }, { x: 20, y1: 8 }, { x: 30, y1: 10 }, { x: 50, y1: 16 }, { x: 150, y1: 12 }, { x: 180, y1: 8 }],
            chart: {
                series: {
                    argumentField: 'x',
                    valueField: 'y1'
    ...
    QUnit.test('range min from series', function (assert) {
        this.createWidget({
            dataSource: [{ x: -20, y1: 0 }, { x: -15, y1: 6 }, { x: -10, y1: 8 }],
            scale: {
                endValue: 0
            },
            chart: {
    ...
    QUnit.test('range min/max from several series', function (assert) {
        this.createWidget({
            dataSource: [{ arg: 20, val: 0, arg1: 50, val1: 6 }, { arg: 30, val: 4, arg1: 250, val1: 16 }, { arg: 180, val: 8 }],
            chart: {
                series: [{}, {
                    argumentField: 'arg1',
                    valueField: 'val1'
    ...
    QUnit.test('translator interval for datetime', function (assert) {
        this.createWidget({
            dataSource: [{ x: new Date(2011, 1, 1), y1: 0 }, { x: new Date(2011, 1, 10), y1: 6 }],
            scale: {
                valueType: 'datetime',
    ...
    QUnit.test('range, logarithmic scale', function (assert) {
        this.createWidget({
            dataSource: [{ x: 0.01, y1: 0 }, { x: 0.1, y1: 6 }, { x: 1, y1: 8 }, { x: 10, y1: 10 }, { x: 100, y1: 16 }, { x: 1000, y1: 12 }, { x: 10000, y1: 8 }],
            chart: {
                series: {
                    argumentField: 'x',
                    valueField: 'y1'
    ...
    QUnit.test('range, discrete scale', function (assert) {
        this.createWidget({
            dataSource: [{ x: 'a1', y: 1 }, { x: 'a2', y: 2 }, { x: 'a3', y: 3 }, { x: 'a4', y: 4 }],
            chart: {
                series: {
                    argumentField: 'x',
                    valueField: 'y'
    ...
    QUnit.test('range, discrete scale with start/end values', function (assert) {
        this.createWidget({
            dataSource: [{ x: 'a1', y: 1 }, { x: 'a2', y: 2 }, { x: 'a3', y: 3 }, { x: 'a4', y: 4 }, { x: 'a5', y: 5 }],
            scale: {
                startValue: 'a2',
                endValue: 'a4'
            },
    ...
    QUnit.test('range, discrete scale with categories in scale options with dataSource and start/end values', function (assert) {
        this.createWidget({
            dataSource: [{ x: 'a1', y: 1 }, { x: 'a2', y: 2 }, { x: 'a3', y: 3 }, { x: 'a4', y: 4 }, { x: 'a5', y: 5 }, { x: 'a6', y: 6 }, { x: 'a7', y: 7 }],
            scale: {
                startValue: 'a3',
                endValue: 'a5',
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","./rangeSelectorParts/commons.js","viz/range_selector/series_data_source","data/data_source/data_source","core/utils/date","../../helpers/vizMocks.js","viz/axes/base_axis","viz/core/title"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("./rangeSelectorParts/commons.js"), require("viz/range_selector/series_data_source"), require("data/data_source/data_source"), require("core/utils/date"), require("../../helpers/vizMocks.js"), require("viz/axes/base_axis"), require("viz/core/title"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=common.part2.tests.js.map