...
(["testing/tests/DevExpress.ui.widgets.treeList/treeList.markup.tests.js"], ["jquery","ui/tree_list"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.treeList/treeList.markup.tests.js", ["jquery", "ui/tree_list"], function($__export) {
  "use strict";
  var $;
  return {
    ...
    execute: function() {
      QUnit.testStart(function() {
        var markup = '<div id="treeList"></div>';
      ...
      QUnit.module('TreeList markup', {
        ...
        QUnit.test('markup init', function(assert) {
          ...
          var $headersView = $container.children('.dx-treelist-headers');
          var $rowsView = $container.children('.dx-treelist-rowsview');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/tree_list"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/tree_list"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=treeList.markup.tests.js.map