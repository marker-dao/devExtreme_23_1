...
(["testing/tests/DevExpress.viz.core.series/polarPoint.tests.js"], ["jquery","../../helpers/vizMocks.js","viz/series/points/base_point","viz/series/points/label","viz/series/base_series"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.viz.core.series/polarPoint.tests.js", ["jquery", "../../helpers/vizMocks.js", "viz/series/points/base_point", "viz/series/points/label", "viz/series/base_series"], function($__export) {
  "use strict";
  var $,
      vizMocks,
      pointModule,
  ...
  return {
    ...
    execute: function() {
      ...
      environment = {
        beforeEach: function() {
          ...
          this.valTranslator = {
            ...
            getBusinessRange: sinon.stub(),
            isInverted: sinon.stub()
          };
          this.argTranslator = {translate: sinon.stub()};
          this.valTranslator.translate.returns(10).withArgs(0).returns(6).withArgs(1).returns(8).withArgs(2).returns(10).withArgs(3).returns(12).withArgs(4).returns(14).withArgs('canvas_position_default').returns(2).withArgs('canvas_position_top').returns(0).withArgs('canvas_position_end').returns(150);
          this.argTranslator.translate.returns(90).withArgs(1).returns(5).withArgs(10).returns(-60).withArgs('canvas_position_start').returns(0);
          this.valTranslator.getBusinessRange.returns({minVisible: 0});
          series.getLabelVisibility.returns(true);
          series.getOptions = function() {
            return {containerBackgroundColor: 'ffffff'};
          };
          series._visibleArea = {
            minX: 50,
            minY: 102,
          ...
          series.getVisibleArea = function() {
            return series._visibleArea;
          };
          ...
          series.getArgumentAxis.returns({getTranslator: function() {
      ...
      QUnit.test('Draw point with errorBar', function(assert) {
        ...
        createAndDrawPoint.call(this, {errorBars: {
            color: 'red',
            lineWidth: 3,
            edgeLength: 8,
            opacity: 1
      ...
      QUnit.test('getDefaultCoords', function(assert) {
        this.valTranslator.translate.withArgs('canvas_position_default').returns(0);
        var point = createTranslatedPoint.call(this);
        assert.deepEqual(point.getDefaultCoords(), {
          x: 100,
          y: 200
        });
      });
      ...
      QUnit.test('getCoords', function(assert) {
        this.valTranslator.translate.withArgs('canvas_position_default').returns(0);
        var point = createTranslatedPoint.call(this);
        assert.deepEqual(point.getCoords(), {
          x: 106,
          y: 192
        });
        assert.deepEqual(point.getCoords(true), {
          x: 100,
          y: 200
        });
      });
      QUnit.test('draw label, position inside', function(assert) {
        var l = createLabel.call(this, null, {
          alignment: 'center',
          radialOffset: 0,
          position: 'inside'
        });
      ...
      QUnit.test('translate point for line series', function(assert) {
        var point = createTranslatedPoint.call(this, {type: 'line'});
      ...
      QUnit.test('draw label, position inside', function(assert) {
        ...
        var l = createLabel.call(this, {type: 'bar'}, {
          alignment: 'center',
          radialOffset: 0,
          position: 'inside'
        });
      ...
      QUnit.test('line, point in visible area', function(assert) {
        var point = createTranslatedPoint.call(this);
        var coord = point._checkLabelPosition({getBoundingRect: function() {
            return {
              width: 20,
              height: 10
            };
      ...
      QUnit.test('line, point is not in visible area', function(assert) {
        ...
        var point = createTranslatedPoint.call(this);
        var coord = point._checkLabelPosition({}, {
          x: -1,
          y: 2
        });
        assert.deepEqual(coord, {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/vizMocks.js","viz/series/points/base_point","viz/series/points/label","viz/series/base_series"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/vizMocks.js"), require("viz/series/points/base_point"), require("viz/series/points/label"), require("viz/series/base_series"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=polarPoint.tests.js.map