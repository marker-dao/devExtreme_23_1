...
(["testing/tests/DevExpress.viz.core.series/rangePoint.tests.js"], ["jquery","../../helpers/vizMocks.js","viz/series/points/base_point","viz/series/points/label","../../helpers/chartMocks.js","viz/core/tooltip"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.viz.core.series/rangePoint.tests.js", ["jquery", "../../helpers/vizMocks.js", "viz/series/points/base_point", "viz/series/points/label", "../../helpers/chartMocks.js", "viz/core/tooltip"], function($__export) {
  "use strict";
  var $,
      vizMocks,
      pointModule,
      ...
      createPoint,
      environment,
      createCorrectionLabels,
      createCorrectionBarLabels;
  ...
  function createLabels(x, y, minY, topLabelBBox, bottomLabelBBox) {
    ...
    var topLabel = point._topLabel;
    var bottomLabel = point._bottomLabel;
    point.x = x;
    point.y = y;
    point.minY = minY;
  ...
  return {
    ...
    execute: function() {
      ...
      createPoint = function(series, data, options) {
        ...
        point._getLabelCoordOfPosition = sinon.spy(point._getLabelCoordOfPosition);
        return point;
      };
      environment = {
        beforeEach: function() {
      ...
      QUnit.module('Translation. Rangearea', {beforeEach: function() {
          var that = this;
          this.opt = {
            widgetType: 'chart',
            styles: {},
          ...
          this.series = {
            ...
            getValueAxis: getMockAxisFunction(this.renderer, function() {
              return that.continuousTranslators.val;
            }),
            getArgumentAxis: getMockAxisFunction(this.renderer, function() {
              return that.continuousTranslators.arg;
            }),
            getVisibleArea: function() {
              return {
                minX: 0,
      ...
      QUnit.test('Width and height, not rotated', function(assert) {
        var pt = createPoint(this.series, {
          argument: 1,
          value: 5,
          minValue: 'default'
        }, this.opt);
      ...
      QUnit.test('getCoords returns false if minValue coord is null', function(assert) {
        this.continuousTranslators.val = new MockTranslator({translate: {
            1: null,
            5: 10
          }});
        var pt = createPoint(this.series, {
      ...
      QUnit.test('RangeBar. getCoords returns false if argument coord is null', function(assert) {
        this.opt.type = 'rangebar';
        this.continuousTranslators.arg = new MockTranslator({translate: {1: null}});
        var pt = createPoint(this.series, {
          argument: 1,
          value: 5,
          minValue: 1
      ...
      QUnit.test('Marker with image, not rotated. Top marker', function(assert) {
        this.options.symbol = 'circle';
        this.options.image = {url: {rangeMaxPoint: 'test-url'}};
        var point = createPoint(this.series, {
          argument: 1,
          value: 1,
          minValue: 2
        ...
        assert.deepEqual(point.graphic.topMarker.stub('attr').firstCall.args[0], {
          translateX: 11,
          translateY: 22,
          visibility: undefined
        });
        assert.deepEqual(point.graphic.bottomMarker.stub('attr').firstCall.args[0], {
          r: 6,
          translateX: 11,
          translateY: 44
        });
      ...
      QUnit.test('Marker with image, not rotated. Bottom marker', function(assert) {
        this.options.symbol = 'circle';
        this.options.image = {url: {rangeMinPoint: 'test-url'}};
        var point = createPoint(this.series, {
          argument: 1,
          value: 1,
          minValue: 2
      ...
      QUnit.test('Circle to non-circle', function(assert) {
        ...
        assert.deepEqual(this.renderer.stub('circle').getCall(0).returnValue.stub('attr').firstCall.args[0], {
          r: 6,
          translateX: 11,
          translateY: 22
        });
        assert.deepEqual(this.renderer.stub('circle').getCall(1).returnValue.stub('attr').firstCall.args[0], {
          r: 6,
          translateX: 11,
          translateY: 44
        });
      ...
      QUnit.test('Non-circle to circle', function(assert) {
        ...
        assert.deepEqual(this.renderer.stub('path').getCall(0).returnValue.stub('attr').firstCall.args[0], {
          r: 6,
          translateX: 11,
          translateY: 22,
          points: [-6, -6, 6, -6, 6, 6, -6, 6, -6, -6]
      ...
      QUnit.test('Non-image to image. Both markers (image is object)', function(assert) {
        ...
        point.translate();
        point.draw(this.renderer, this.groups);
        var newOptions = $.extend(true, {}, this.options, {image: {url: {
              rangeMinPoint: 'test',
              rangeMaxPoint: 'test'
            }}});
        point.updateOptions(newOptions);
      ...
      QUnit.test('Update markers style', function(assert) {
        ...
        assert.deepEqual(point.graphic.topMarker.stub('attr').lastCall.args[0], $.extend(style, {
          translateX: 11,
          translateY: 22
        }));
        assert.deepEqual(point.graphic.bottomMarker.stub('attr').lastCall.args[0], $.extend(style, {
          translateX: 11,
          translateY: 22
        }));
      });
      ...
      QUnit.module('Check points in visible area', {beforeEach: function() {
          var $__2 = this;
          this.options = {
            widgetType: 'chart',
            label: {visible: false},
      ...
      QUnit.module('Point translators. Rangebar', {
        ...
        setContinuousTranslators: function() {
          var xTranslator = new MockTranslator({translate: {
              1: 110,
              2: 220,
              3: 330,
              4: 440,
          ...
          var yTranslator = new MockTranslator({translate: {
              1: 111,
              2: 222,
              3: 333,
              4: 444,
      ...
      QUnit.test('Value & minValue translation. Translate method args', function(assert) {
        var getMockTranslator = function() {
          return ({translate: sinon.spy()});
        };
        this.translators = {
          arg: getMockTranslator(),
          val: getMockTranslator()
        };
        var point = createPoint(this.series, {
          argument: 1,
          value: 5,
      ...
      QUnit.module('HasValue method. RangeBar', {beforeEach: function() {
          this.opt = {
            widgetType: 'chart',
            type: 'rangebar',
            label: {},
      ...
      QUnit.test('Get label format object', function(assert) {
        var point = createPoint(this.series, this.data, this.options);
        var formatObject = point._getLabelFormatObject();
        var minFormatObject = point._getLabelMinFormatObject();
      ...
      createCorrectionLabels = function(pos1, pos2, x, y, minY, minX) {
        var point = createPoint(this.series, this.data, this.options);
        var topLabel = point._topLabel;
        var bottomLabel = point._bottomLabel;
        point.x = x;
      ...
      QUnit.test('Get graphic bbox. Not rotated. Not image', function(assert) {
        ...
        point.y = 54;
        point.minY = 100;
        var topLabelGraphicBBox = point._getGraphicBBox('top');
        var bottomLabelGraphicBBox = point._getGraphicBBox('bottom');
      ...
      QUnit.test('Point with radius', function(assert) {
        ...
        assert.deepEqual(l.topLabel.setFigureToDrawConnector.firstCall.args[0], {
          x: 33,
          y: 54,
          r: 8
        });
        ...
        assert.deepEqual(l.bottomLabel.setFigureToDrawConnector.firstCall.args[0], {
          x: 33,
          y: 100,
          r: 8
        });
      ...
      QUnit.test('Default, inside, not rotated. Overlay corrections', function(assert) {
        ...
        var topLabel = point._topLabel;
        var bottomLabel = point._bottomLabel;
        topLabel.getBoundingRect.returns({
          width: 20,
          height: 10,
          x: 23,
          y: 64
        });
        bottomLabel.getBoundingRect.returns({
          width: 20,
          height: 10,
          x: 23,
          y: 34
      ...
      QUnit.test('Draw labels, labels are crossed and crossing visible area - minY', function(assert) {
        var $__2 = this;
        this.series.getValueAxis = getMockAxisFunction(this.renderer, function() {
          return $__2.translators.val;
        }, [10, 100]);
        var $__3 = createLabels.call(this, 53, 12, 55, {
          width: 20,
          height: 10,
          x: 63,
          y: 10
      ...
      createCorrectionBarLabels = function(bBox, x, y, width, height, pos1, pos2) {
      ...
      QUnit.test('Default, not rotated', function(assert) {
        var l = createCorrectionBarLabels.call(this, {
          x: 33,
          y: 54,
          height: 10,
          width: 20
        }, 33, 54, 20, 10, 'top', 'bottom');
        assert.equal(l.topLabel.shift.firstCall.args[0], 33);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/vizMocks.js","viz/series/points/base_point","viz/series/points/label","../../helpers/chartMocks.js","viz/core/tooltip"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/vizMocks.js"), require("viz/series/points/base_point"), require("viz/series/points/label"), require("../../helpers/chartMocks.js"), require("viz/core/tooltip"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=rangePoint.tests.js.map