...
(["testing/tests/DevExpress.viz.core.series/piePoint.tests.js"], ["../../helpers/vizMocks.js","core/utils/common","viz/series/points/base_point","viz/series/points/label","../../helpers/chartMocks.js","viz/components/consts","viz/core/tooltip"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.viz.core.series/piePoint.tests.js", ["../../helpers/vizMocks.js", "core/utils/common", "viz/series/points/base_point", "viz/series/points/label", "../../helpers/chartMocks.js", "viz/components/consts", "viz/core/tooltip"], function($__export) {
  "use strict";
  var vizMocks,
      noop,
      pointModule,
  ...
  function environmentWithStubLabels() {
    ...
    this.angleTranslator = new MockAngularTranslator({translate: this.translateData});
    this.data = {
      value: 20,
      minValue: 0
    }, this.options = {
      widgetType: 'pie',
      styles: {normal: {'stroke-width': 0}},
      label: {
        position: 'columns',
        visible: true,
        radialOffset: 0,
        background: {},
        connector: {'stroke-width': 1},
        connectorOffset: 0
      }
    };
    this.series = {
      ...
      _options: {containerBackgroundColor: '#ffffff'},
      getLabelVisibility: function() {
        return true;
      },
      getValueAxis: function() {
        return {getTranslator: function() {
            return that.angleTranslator;
          }};
      },
    ...
    this.stubLabel = function(point, labelBBox) {
      ...
      point._label.getBoundingRect.returns(labelBBox || {
        height: 10,
        width: 20,
        x: 10,
        y: 15
  ...
  function environment() {
    ...
    this.opt = {
      ...
      styles: {
        normal: {fill: 'normalColor'},
        hover: {},
        selection: {},
        legendStyles: {isLegendStyles: true}
      }
    };
    this.translateData = {
      0: 100,
  ...
  return {
    setters: [function($__m) {
      ...
      MockAngularTranslator = $__m.MockAngularTranslator;
    }, function($__m) {
    ...
    execute: function() {
      ...
      QUnit.module('Creation. Pie', {beforeEach: environment});
      ...
      QUnit.module('Point coordinates translation. Pie', {beforeEach: environment});
      ...
      QUnit.module('Values correction', {beforeEach: function() {
      ...
      QUnit.module('Point radiuses correction', {beforeEach: function() {
          this.point = createPoint({
            name: 'series1',
            _options: {},
            getLabelVisibility: function() {
      ...
      QUnit.module('coordsIn API', {beforeEach: function() {
          var that = this;
          this.series = {
            name: 'series1',
            _options: {},
      ...
      QUnit.test('fromAngle > to Angle', function(assert) {
        this.angleTranslator = new MockAngularTranslator({translate: {
            0: 200,
            5: 150,
            10: 100
          }});
        ...
        var sinTo = Math.sin(point.toAngle * Math.PI / 180);
        var cosFrom = Math.cos(point.fromAngle * Math.PI / 180);
        var cosTo = Math.cos(point.toAngle * Math.PI / 180);
        var x1 = 15 * cosTo + 30;
        var x2 = 15 * cosFrom + 30;
        var yMin = -15 * sinFrom + 40;
        var yMax = -15 * sinTo + 40;
      ...
      QUnit.test('hide label on draw if it invisible', function(assert) {
        var point = createPointWithStubLabelForDraw.call(this, {
          0: 300,
          10: 270,
          20: 240
        });
      ...
      QUnit.module('get columns coord', {beforeEach: environmentWithStubLabels});
      QUnit.test('columns if label in the left side', function(assert) {
        var point = createPointWithStubLabel.call(this, {
          0: 170,
          10: 210,
          20: 250
        });
        var coord = point._correctLabelCoord({
          x: 20,
          y: 10
        });
      ...
      QUnit.module('update Coord', {beforeEach: environmentWithStubLabels});
      ...
      QUnit.test('T586419. Outside, move from center', function(assert) {
        this.options.label.position = 'outside';
        var point1 = createPointWithStubLabel.call(this, {
          0: 55,
          10: 45,
          20: 35
        }, {
        ...
        var point2 = createPointWithStubLabel.call(this, {
          0: 145,
          10: 135,
          20: 125
        }, {
        ...
        var point3 = createPointWithStubLabel.call(this, {
          0: 55,
          10: 45,
          20: 35
        }, {
        ...
        var point4 = createPointWithStubLabel.call(this, {
          0: 145,
          10: 135,
          20: 125
        }, {
      ...
      QUnit.module('Check label position', {beforeEach: environmentWithStubLabels});
      ...
      QUnit.test('Draw label (area of label > maxX area of canvas)', function(assert) {
        ...
        var coord = point._checkHorizontalLabelPosition({
          x: 595,
          y: 295,
          width: 20,
          height: 10
        }, point._label.getBoundingRect(), point._getVisibleArea());
      ...
      QUnit.module('set label ellipsis', {beforeEach: environmentWithStubLabels});
      ...
      QUnit.module('show/hide API', {beforeEach: function() {
          var that = this;
      ...
      QUnit.test('hide point', function(assert) {
        ...
        var hideTooltipSpy = sinon.spy(point, 'hideTooltip');
        point.hide();
        assert.ok(!point.isVisible());
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../helpers/vizMocks.js","core/utils/common","viz/series/points/base_point","viz/series/points/label","../../helpers/chartMocks.js","viz/components/consts","viz/core/tooltip"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../helpers/vizMocks.js"), require("core/utils/common"), require("viz/series/points/base_point"), require("viz/series/points/label"), require("../../helpers/chartMocks.js"), require("viz/components/consts"), require("viz/core/tooltip"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=piePoint.tests.js.map