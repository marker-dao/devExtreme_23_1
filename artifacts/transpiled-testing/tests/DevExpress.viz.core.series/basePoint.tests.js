...
(["testing/tests/DevExpress.viz.core.series/basePoint.tests.js"], ["jquery","../../helpers/vizMocks.js","viz/series/points/base_point","viz/series/points/label","viz/series/base_series","../../helpers/chartMocks.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.viz.core.series/basePoint.tests.js", ["jquery", "../../helpers/vizMocks.js", "viz/series/points/base_point", "viz/series/points/label", "viz/series/base_series", "../../helpers/chartMocks.js"], function($__export) {
  "use strict";
  var $,
      vizMocks,
      pointModule,
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module('Creation', {beforeEach: function() {
          this.options = {
            widgetType: 'chart',
            reduction: {},
            styles: {},
      ...
      QUnit.module('Updating', {beforeEach: function() {
          this.options = {
            reduction: {},
            widgetType: 'chart',
            label: {visible: false},
      ...
      QUnit.module('Update type of point', {beforeEach: function() {
      ...
      QUnit.test('Update simple to simple without data', function(assert) {
        ...
        var point = createPoint(this.series, data, this.options);
        var drawMarkerCalled = 0;
        point.translate();
      ...
      QUnit.test('Update simple to range', function(assert) {
        ...
        var deleteLabelSpy = sinon.spy(point, 'deleteLabel');
          ...
          this.series = {
            ...
            getValueAxis: function() {
              return {getTranslator: function() {
                  return new MockTranslator({translate: {5: 100}});
                }};
            },
            getArgumentAxis: function() {
              return {getTranslator: function() {
                  return new MockTranslator({translate: {5: 50}});
                }};
            }
          };
          this.groups = {
      ...
      QUnit.module('Deleting', {beforeEach: function() {
          this.renderer = new vizMocks.Renderer();
          this.group = this.renderer.g();
          this.options = {
            styles: {
      ...
      QUnit.module('Point views', {beforeEach: function() {
          this.renderer = new vizMocks.Renderer();
          this.group = this.renderer.g();
          ...
          }, this.series.getValueAxis.returns({getTranslator: function() {
              return new MockTranslator({translate: {
                  'null': 0,
                  1: 22,
                  2: 23,
          ...
          this.series.getArgumentAxis.returns({getTranslator: function() {
              return new MockTranslator({translate: {
                  'null': 0,
                  1: 11,
                  2: 12,
      ...
      QUnit.module('states and styles', {beforeEach: function() {
          this.renderer = new vizMocks.Renderer();
          this.group = this.renderer.g();
          this.series = sinon.createStubInstance(Series);
          this.series.isVisible.returns(true);
      ...
      QUnit.module('Event binding', {beforeEach: function() {
          this.renderer = new vizMocks.Renderer();
          this.group = this.renderer.g();
          this.series = sinon.createStubInstance(Series);
          this.options = {
      ...
      QUnit.test('Dispose', function(assert) {
        ...
        var errorBarSpy = sinon.spy(point._errorBar, 'remove');
        point.dispose();
      ...
      QUnit.test('setHole left hole', function(assert) {
        ...
        assert.strictEqual(point.leftHole, 4.7), assert.strictEqual(point.minLeftHole, -0.3);
      });
      QUnit.test('setHole right hole', function(assert) {
        var point = createPoint(this.series, this.data, this.options);
        point.setHole(0.3, 'right');
        assert.strictEqual(point.rightHole, 4.7), assert.strictEqual(point.minRightHole, -0.3);
      });
      QUnit.test('set not defined hole - null', function(assert) {
        var point = createPoint(this.series, this.data, this.options);
        point.setHole(null, 'right');
        assert.strictEqual(point.rightHole, undefined), assert.strictEqual(point.minRightHole, undefined);
      });
      QUnit.test('reset holes', function(assert) {
        ...
        point.resetHoles();
        assert.strictEqual(point.leftHole, null), assert.strictEqual(point.minLeftHole, null);
        assert.strictEqual(point.rightHole, null), assert.strictEqual(point.minRightHole, null);
      });
      ...
      QUnit.test('set defined hole - 0', function(assert) {
        ...
        assert.strictEqual(point.rightHole, 5), assert.strictEqual(point.minRightHole, 0);
      });
      ...
      QUnit.test('getBoundingRect', function(assert) {
        assert.deepEqual(createSimplePoint({
          x: 8,
          y: 8
        }).getBoundingRect(), {
          height: 12,
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/vizMocks.js","viz/series/points/base_point","viz/series/points/label","viz/series/base_series","../../helpers/chartMocks.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/vizMocks.js"), require("viz/series/points/base_point"), require("viz/series/points/label"), require("viz/series/base_series"), require("../../helpers/chartMocks.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=basePoint.tests.js.map