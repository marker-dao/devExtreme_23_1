...
(["testing/tests/DevExpress.viz.core.series/scatterSeries.tests.js"], ["jquery","../../helpers/vizMocks.js","core/utils/common","viz/series/points/base_point","viz/series/points/label","viz/series/base_series","../../helpers/chartMocks.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.viz.core.series/scatterSeries.tests.js", ["jquery", "../../helpers/vizMocks.js", "core/utils/common", "viz/series/points/base_point", "viz/series/points/label", "viz/series/base_series", "../../helpers/chartMocks.js"], function($__export) {
  "use strict";
  var $,
      vizMocks,
      noop,
    ...
    execute: function() {
      ...
      (function ScatterSeries() {
        ...
        QUnit.test('Creation simple point with valueErrorBar', function(assert) {
          ...
          var data = [{
            ...
            lowErrorValue: 0,
            highErrorValue: 4,
            'originallowErrorValue': 0,
            'originalhighErrorValue': 4
          }];
          series.updateData(data);
          series.createPoints();
          var points = series.getPoints();
        ...
        QUnit.test('Creation simple point with valueErrorBar. datetime data', function(assert) {
          ...
          var data = [{
            arg: 1,
            val: new Date(2011, 1, 1),
            lowErrorValue: new Date(2011, 0, 31),
            highErrorValue: new Date(2011, 1, 10)
          }];
        ...
        QUnit.test('Creation simple point with valueErrorBar and custom lowValueField & highValueField', function(assert) {
          var series = createSeries({
            type: 'line',
            valueErrorBar: {
              lowValueField: 'customLow',
              highValueField: 'customHigh'
            }
          });
          var data = [{
            arg: 1,
        ...
        QUnit.test('Draw series when errorBars enabled. forceClipping is false.', function(assert) {
          ...
          var errorBarGroup = this.renderer.stub('g').getCall(3).returnValue;
        ...
        QUnit.test('Create error bar group when series is animated', function(assert) {
          ...
          var completeAnimation = points[points.length - 1].animate.lastCall.args[0];
          completeAnimation();
          assert.deepEqual(errorBarGroup.animate.lastCall.args, [{opacity: 0.7}, {duration: 400}]);
        });
        QUnit.test('Create error bar group when series is animated. ErrorBars opacity is undefined', function(assert) {
          ...
          var completeAnimation = points[points.length - 1].animate.lastCall.args[0];
          completeAnimation();
          assert.deepEqual(errorBarGroup.animate.lastCall.args, [{opacity: 1}, {duration: 400}]);
        });
        ...
        QUnit.test('Label options in point', function(assert) {
          ...
          assert.deepEqual(labels.format, {
            type: 'currency',
            precision: 3
          });
          assert.deepEqual(labels.argumentFormat, {
            type: 'percent',
            precision: 1
          });
        ...
        QUnit.test('with result', function(assert) {
          ...
          assert.ok(labels);
          assert.deepEqual(labels.attributes, {'font': {
              'color': '#345678',
              'family': 'Verdana',
              'opacity': 0.9,
              'size': 18,
        ...
        QUnit.test('areErrorBarsVisible', function(assert) {
          ...
          checkVisibility({
            type: 'fixed',
            displayMode: 'all'
          }, undefined, undefined, true, 'fixed, displayMode all');
          checkVisibility({
            type: 'percent',
            displayMode: 'all'
          }, undefined, undefined, true, 'percent, displayMode all');
          checkVisibility({
            type: 'stdError',
            displayMode: 'all'
          }, undefined, undefined, true, 'stdError, displayMode all');
          checkVisibility({
            type: 'stdDeviation',
            displayMode: 'all'
          }, undefined, undefined, true, 'stdDeviation, displayMode all');
          checkVisibility({
            type: 'Variance',
            displayMode: 'all'
          }, undefined, undefined, true, 'Variance, displayMode all');
          checkVisibility({
            type: 'unknown',
            displayMode: 'all'
          }, undefined, undefined, false, 'unknown, displayMode all');
          checkVisibility({
            type: 'unknown',
            lowValueField: 'field',
            displayMode: 'all'
          }, undefined, undefined, true, 'unknown, displayMode all, lowValueField defined');
          checkVisibility({
            type: 'unknown',
            highValueField: 'field',
            displayMode: 'all'
          }, undefined, undefined, true, 'unknown, displayMode all, highValueField defined');
          checkVisibility({
            type: 'fixed',
            displayMode: 'none'
          }, undefined, undefined, false, 'fixed, displayMode none');
          checkVisibility({
            type: 'fixed',
            displayMode: 'all'
          }, undefined, 'discrete', false, 'fixed, displayMode all');
          checkVisibility({
            type: 'fixed',
            displayMode: 'all'
          }, undefined, 'logarithmic', false, 'fixed, displayMode all');
          checkVisibility({
            type: 'fixed',
            displayMode: 'all'
          }, 'datetime', undefined, false, 'fixed, displayMode all');
        });
        ...
        QUnit.test('Visible area, not rotated', function(assert) {
          assert.deepEqual(this.series.getVisibleArea(), {
            maxX: 530,
            minX: 10,
            maxY: 500,
            minY: 0
      ...
      (function getPointByCoord() {
        ...
        QUnit.test('getVisibleArea', function(assert) {
          ...
          series.getValueAxis().getCanvas = sinon.stub().returns({
            left: 1,
            right: 10,
            top: 15,
            bottom: 20,
          ...
          series.draw();
          assert.deepEqual(series.getVisibleArea(), {
            minX: 1,
            maxX: 290,
            minY: 15,
            maxY: 180
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/vizMocks.js","core/utils/common","viz/series/points/base_point","viz/series/points/label","viz/series/base_series","../../helpers/chartMocks.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/vizMocks.js"), require("core/utils/common"), require("viz/series/points/base_point"), require("viz/series/points/label"), require("viz/series/base_series"), require("../../helpers/chartMocks.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=scatterSeries.tests.js.map