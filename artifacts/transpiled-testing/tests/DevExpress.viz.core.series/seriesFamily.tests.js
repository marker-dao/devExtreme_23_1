...
(["testing/tests/DevExpress.viz.core.series/seriesFamily.tests.js"], ["jquery","../../helpers/vizMocks.js","viz/series/points/base_point","../../helpers/chartMocks.js","viz/core/series_family"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.viz.core.series/seriesFamily.tests.js", ["jquery", "../../helpers/vizMocks.js", "viz/series/points/base_point", "../../helpers/chartMocks.js", "viz/core/series_family"], function($__export) {
  "use strict";
  var $,
      vizMocks,
      pointModule,
  ...
  function checkStackedPoints(assert, points1, points2, points3) {
    ...
    $.each(points1, function(i, point) {
      ...
      var valueType = (value >= 0) ? 'positive' : 'negative';
      var currentBound = bound[valueType][i];
  ...
  function getValAxes(name, visibleArea) {
    ...
    var val2Trans = new MockTranslator({
      interval: 200,
      translate: {
        20: 311,
        21: 312,
    ...
    val1Trans.getMinBarSize && (val1Trans.getMinBarSize = function() {
      return arguments[0];
    });
    val2Trans.getMinBarSize && (val2Trans.getMinBarSize = function() {
  ...
  function createSeriesFamily(type, series, options) {
    var family = new SeriesFamily($.extend({
      type: type,
      barGroupPadding: 0.3
    }, options));
  ...
  return {
    setters: [function($__m) {
      ...
      MockPoint = $__m.MockPoint;
    }, function($__m) {
      SeriesFamily = $__m.SeriesFamily;
    }],
    execute: function() {
      ZERO = 0;
      document.title = 'Series Family ' + document.title;
      createPoint = function(value) {
      ...
      setCommonSeriesType = function(series, type) {
        var s;
      ...
      checkSeries = function(assert, series, expectedWidth, expectedOffset) {
        var points = series.getPoints();
      ...
      QUnit.test('update API method', function(assert) {
        var type = 'bar';
        var family = new SeriesFamily({type: type});
      ...
      QUnit.test('Add array of correct series', function(assert) {
        ...
        var series2 = new MockSeries();
        var series3 = new MockSeries();
      ...
      QUnit.test('Set single series, bar width is specify', function(assert) {
        ...
        createSeriesFamily('bar', [series], {});
        series.getPointsByArg.getCalls().forEach(function(call) {
      ...
      QUnit.test('Set two series', function(assert) {
        ...
        var series2 = createSeries({points: pointsForStacking.points2()});
        var series = [series1, series2];
        var expectedSpacing = 7;
      ...
      QUnit.test('Set five series', function(assert) {
        var series1 = createSeries({points: pointsForStacking.points1()});
        var series2 = createSeries({points: pointsForStacking.points2()});
        var series3 = createSeries({points: pointsForStacking.points3()});
        var series4 = createSeries({points: pointsForStacking.points4()});
        var series5 = createSeries({points: pointsForStacking.points5()});
        var series = [series1, series2, series3, series4, series5];
        var expectedSpacing = 3;
        var expectedWidth = 12;
        createSeriesFamily('bar', series, {});
      ...
      QUnit.test('Set three series, barPadding is specified', function(assert) {
        var series1 = createSeries({
          points: pointsForStacking.points1(),
          barPadding: 0.2
        });
        ...
        var series3 = createSeries({
          points: pointsForStacking.points3(),
          barPadding: 0
        });
        var series = [series1, series2, series3];
        createSeriesFamily('bar', series);
      ...
      QUnit.test('Set three series, all of them in one group', function(assert) {
        ...
        var mixedPoints2 = pointsForStacking.mixedPoints3();
        var mixedPoints3 = pointsForStacking.mixedPoints3();
        var series1 = createSeries({
          points: mixedPoints1,
      ...
      QUnit.test('Check bars order when barOverlapGroup is set', function(assert) {
        var mixedPoints1 = pointsForStacking.mixedPoints1();
        var mixedPoints2 = pointsForStacking.mixedPoints2();
        var mixedPoints3 = pointsForStacking.mixedPoints3();
        var series1 = createSeries({
          points: mixedPoints1,
          barOverlapGroup: 'g1'
        });
        var series2 = createSeries({points: mixedPoints2});
        var series3 = createSeries({points: mixedPoints3});
        var series = [series1, series2, series3];
        createSeriesFamily('bar', series);
      ...
      QUnit.test('Set four series, two of them in one group, and last in another group, and one series have custom barWidth', function(assert) {
        ...
        var mixedPoints2 = pointsForStacking.mixedPoints2();
        var mixedPoints3 = pointsForStacking.mixedPoints3();
        var mixedPoints4 = pointsForStacking.mixedPoints4();
        var series1 = createSeries({points: mixedPoints1});
        var series2 = createSeries({
          points: mixedPoints2,
          barOverlapGroup: 'g1',
          barWidth: 10
      ...
      QUnit.test('Set four series, two groups and with barPadding option (T1005617)', function(assert) {
        ...
        var mixedPoints2 = pointsForStacking.mixedPoints3();
        var mixedPoints3 = pointsForStacking.mixedPoints3();
        var mixedPoints4 = pointsForStacking.mixedPoints3();
        var series1 = createSeries({
          points: mixedPoints1,
          barOverlapGroup: 'first'
        });
      ...
      QUnit.test('Stackedbar with negative values', function(assert) {
        ...
        var mixedPoints = pointsForStacking.mixedPoints2();
        var series1 = createSeries({points: negativePoints1});
        var series2 = createSeries({points: mixedPoints});
        var series = [series1, series2];
      ...
      QUnit.test('Set two series', function(assert) {
        var series1 = createSeries({
          points: pointsForStacking.points1FirstOnly(),
          ignoreEmptyPoints: false
        });
        var series2 = createSeries({
          points: pointsForStacking.points2FirstAndSecondOnly(),
          ignoreEmptyPoints: false
        });
        var series = [series1, series2];
        var expectedSpacing = 7;
        var expectedWidthTwoBars = 32;
        createSeriesFamily('bar', series, {});
        ...
        assert.strictEqual(series1.getPointsByArg('First')[0].coordinatesCorrection.offset, 0 - expectedWidthTwoBars / 2 - expectedSpacing / 2, 'Series 1, point 1 - both bars exist');
        assert.strictEqual(series2.getPointsByArg('First')[0].coordinatesCorrection.offset, ZERO + expectedWidthTwoBars / 2 + expectedSpacing / 2, 'Series 2, point 1 - both bars exist');
        ...
        assert.strictEqual(series2.getPointsByArg('Second')[0].coordinatesCorrection.offset, ZERO + expectedWidthTwoBars / 2 + expectedSpacing / 2, 'Series 2, point 2 - offset - single bar exists');
      });
      ...
      QUnit.test('Set two series', function(assert) {
        ...
        assert.strictEqual(series2.getPointsByArg('Second')[0].coordinatesCorrection.offset, 0, 'Series 2, point 2 - single bar exists');
      });
      QUnit.test('Set two series with points with the same arguments', function(assert) {
        ...
        var series2 = createSeries({points: pointsForStacking.points2WithSameArguments()});
        var series = [series1, series2];
        var expectedWidthTwoBars = 32;
        var expectedSpacing = 7;
        createSeriesFamily('bar', series, {});
      ...
      QUnit.test('Set two series with points with the same arguments. With null points', function(assert) {
        ...
        var series2 = createSeries({points: pointsForStacking.points4WithSameArguments()});
        var series = [series1, series2];
        var expectedWidthTwoBars = 32;
        var expectedSpacing = 7;
        createSeriesFamily('bar', series, {});
      ...
      QUnit.test('Set two series, first series is invisible', function(assert) {
        ...
        var points2 = [createPoint(2)];
        var series1 = createSeries({points: points1});
        var series2 = createSeries({points: points2});
        var series = [series1, series2];
      ...
      QUnit.test('Set two series with datetime argument', function(assert) {
        var series1 = createSeries({points: pointsForStacking.points1DateArgument()});
        var series2 = createSeries({points: pointsForStacking.points1DateArgument()});
        var series = [series1, series2];
        var expectedWidthTwoBars = 32;
        createSeriesFamily('bar', series, {});
      ...
      QUnit.test('Set two series with zero values', function(assert) {
        ...
        var series2 = createSeries({points: pointsForStacking.points2FirstAndSecondOnly()});
        var series = [series1, series2];
        var expectedWidthTwoBars = 32;
        var expectedSpacing = 7;
        createSeriesFamily('bar', series, {});
      ...
      QUnit.test('null values. ignoreEmptyPoints for all series is true - bars have different width', function(assert) {
        var series1 = createSeries({
          points: pointsForStacking.barWidthPoints1(),
          ignoreEmptyPoints: true
        });
        var series2 = createSeries({
          points: pointsForStacking.barWidthPoints2(),
          ignoreEmptyPoints: true
        });
        var series3 = createSeries({
          points: pointsForStacking.barWidthPoints3(),
          ignoreEmptyPoints: true
        });
        var series = [series1, series2, series3];
        createSeriesFamily('bar', series, {});
        var series1Points = series1.getPoints();
        var series2Points = series2.getPoints();
        var series3Points = series3.getPoints();
        assert.deepEqual(series1Points[0].coordinatesCorrection, {
          width: 20,
          offset: -25
        }, 'Width and offset, Series 1, point 1');
        assert.ok(!series1Points[1].coordinatesCorrection, 'Width and offset, Series 1, point 2');
        assert.deepEqual(series1Points[2].coordinatesCorrection, {
          width: 32,
          offset: -19.5
        }, 'Width and offset, Series 1, point 3');
        assert.deepEqual(series2Points[0].coordinatesCorrection, {
          width: 20,
          offset: 0
        }, 'Width and offset, Series 2, point 1');
        ...
        assert.deepEqual(series3Points[0].coordinatesCorrection, {
          width: 20,
          offset: 25
        }, 'Width and offset, Series 3, point 1');
        assert.deepEqual(series3Points[1].coordinatesCorrection, {
          width: 70,
          offset: 0
        }, 'Width and offset, Series 3, point 2');
        assert.deepEqual(series3Points[2].coordinatesCorrection, {
          width: 32,
          offset: 19.5
        }, 'Width and offset, Series 3, point 3');
      });
      QUnit.test('null values. ignoreEmptyPoints is set for the second series - null value from the first series is displayed and have width', function(assert) {
        ...
        var series3 = createSeries({points: pointsForStacking.barWidthPoints3()});
        var series = [series1, series2, series3];
        createSeriesFamily('bar', series, {});
        var series1Points = series1.getPoints();
        var series2Points = series2.getPoints();
        ...
        assert.deepEqual(series1Points[1].coordinatesCorrection, {
          width: 32,
          offset: -19.5
        }, 'Width and offset, Series 1, point 2');
        assert.deepEqual(series1Points[2].coordinatesCorrection, {
          width: 32,
          offset: -19.5
        }, 'Width and offset, Series 1, point 3');
      ...
      QUnit.test('Translator interval is greater then aggregation interval', function(assert) {
        ...
        series.getArgumentAxis().getTranslator().getInterval = function(interval) {
          return interval;
        };
        var expectedWidth = 35;
        createSeriesFamily('bar', [series]);
      ...
      QUnit.test('Set three series', function(assert) {
        ...
        var points2 = pointsForStacking.minHeightPoints6();
        var points3 = pointsForStacking.minHeightPoints7();
        var series1 = createSeries({
          points: points1,
          minBarSize: 10
        });
      ...
      QUnit.test('Set three series, zero values', function(assert) {
        var points1 = pointsForStacking.minHeightPoints5();
        var points2 = pointsForStacking.minHeightPoints4();
        var points3 = pointsForStacking.minHeightPoints7();
        var series1 = createSeries({
          points: points1,
          minBarSize: 10
      ...
      QUnit.test('Set three series, null values', function(assert) {
        ...
        var points2 = pointsForStacking.minHeightPoints9();
        var points3 = pointsForStacking.minHeightPoints10();
        var series1 = createSeries({
          points: points1,
          minBarSize: 10
        });
      ...
      QUnit.test('Set three series - custom min size is not specify ', function(assert) {
        var points1 = pointsForStacking.minHeightPoints1();
        var points2 = pointsForStacking.minHeightPoints2();
        var points3 = pointsForStacking.minHeightPoints3();
        var series1 = createSeries({points: points1});
        var series2 = createSeries({points: points2});
        var series3 = createSeries({points: points3});
        var series = [series1, series2, series3];
        [points1, points2, points3].forEach(function(points) {
          return points.forEach(function(point) {
            return point.series = {type: 'bar'};
          });
        });
        var family = createSeriesFamily('bar', series);
      ...
      QUnit.test('Set one series. minBarSize', function(assert) {
        var series1 = createSeries({
          points: pointsForRange.point1(),
          minBarSize: 10
        });
        var series = [series1];
        var family = createSeriesFamily('rangebar', series);
      ...
      QUnit.test('Set one series with minBarSize. First point has not value', function(assert) {
        var points1 = pointsForRange.point2();
      ...
      QUnit.test('Set five series. inverted', function(assert) {
        ...
        var expectedSpacing = 3;
        var expectedWidth = 12;
        series1.getArgumentAxis().getTranslator().isInverted = function() {
          return true;
        };
        createSeriesFamily('rangebar', series, {});
        checkSeries(assert, series5, expectedWidth, 0 - expectedWidth / 2 - expectedSpacing - expectedWidth - expectedSpacing - expectedWidth / 2);
      ...
      QUnit.test('Set two series - matching points', function(assert) {
        var points1 = pointsForStacking.points1();
        var points2 = pointsForStacking.points2();
        var series1 = createSeries({
          points: points1,
          stack: '0'
        });
      ...
      QUnit.test('Set two series - matching points. Points with null values', function(assert) {
        ...
        var series = [series1, series2];
        var family = createSeriesFamily('stackedbar', series, {});
        var expectedWidth = 70;
        family.updateSeriesValues();
        checkSeries(assert, series1, expectedWidth, 0);
        checkSeries(assert, series2, expectedWidth, 0);
      ...
      QUnit.test('Set three series - matching points', function(assert) {
        var points1 = pointsForStacking.points1();
        var points2 = pointsForStacking.points2();
        var points3 = pointsForStacking.points3();
        var series1 = createSeries({
          points: points1,
          stack: '0'
        });
      ...
      QUnit.test('Set four series in two groups - matching points', function(assert) {
        ...
        var points2 = pointsForStacking.points2();
        var points3 = pointsForStacking.points3();
        var points4 = pointsForStacking.points4();
        var series1 = createSeries({
          points: points1,
          stack: 'first'
        });
      ...
      QUnit.test('Set three series - datetime value', function(assert) {
        ...
        var points2 = pointsForStacking.points2DateValue();
        var points3 = pointsForStacking.points3DateValue();
        var series1 = createSeries({
          points: points1,
          stack: '0'
        });
      ...
      QUnit.test('Set two series - matching points', function(assert) {
        var negativePoints1 = pointsForStacking.negativePoints1();
        var negativePoints2 = pointsForStacking.negativePoints2();
        var series1 = createSeries({
      ...
      QUnit.test('Set three series - matching points', function(assert) {
        var negativePoints1 = pointsForStacking.negativePoints1();
        var negativePoints2 = pointsForStacking.negativePoints2();
        var negativePoints3 = pointsForStacking.negativePoints3();
        var series1 = createSeries({
          points: negativePoints1,
          stack: '0'
        });
      ...
      QUnit.test('Set four series in two groups - matching points', function(assert) {
        ...
        var negativePoints2 = pointsForStacking.negativePoints2();
        var negativePoints3 = pointsForStacking.negativePoints3();
        var negativePoints4 = pointsForStacking.negativePoints4();
        var series1 = createSeries({
          points: negativePoints1,
          stack: 'first'
        });
      ...
      QUnit.test('Set three series - custom min size', function(assert) {
        ...
        var series = [series1, series2, series3];
        var family = createSeriesFamily('fullstackedbar', series);
        var expectedValue1 = 10 / 30;
        var expectedValue2 = 20 / 30;
      ...
      QUnit.test('Set three series - custom min size, zero values', function(assert) {
        ...
        var points2 = pointsForStacking.minHeightPoints11();
        var points3 = pointsForStacking.minHeightPoints12();
        var series1 = createSeries({
          points: points1,
          minBarSize: 10
        });
      ...
      QUnit.test('Three series with zero values in stack, T925244', function(assert) {
        ...
        var points2 = pointsForStacking.points2();
        var points3 = pointsForStacking.points3();
        points1[1] = points2[1] = points3[1] = new MockPoint({
          argument: 'Second',
          value: 0
        });
        var series1 = createSeries({points: points1});
      ...
      QUnit.test('Set three series - matching points', function(assert) {
        ...
        var mixedPoints2 = pointsForStacking.mixedPoints2();
        var mixedPoints3 = pointsForStacking.mixedPoints3();
        var arg1Stack = 10 + 20 + 30;
        var arg2Stack = 20 + 40 + 60;
        var arg3Stack = 30 + 60 + 90;
        var series1 = createSeries({
          points: mixedPoints1,
          stack: '0'
        });
      ...
      QUnit.test('Set two series - matching points', function(assert) {
        ...
        var negativePoints2 = pointsForStacking.negativePoints2();
        var series1 = createSeries({points: negativePoints1});
        var series2 = createSeries({points: negativePoints2});
        var series = [series1, series2];
        createSeriesFamily('stackedarea', series);
        checkStackedPoints(assert, negativePoints1, negativePoints2);
        assert.strictEqual(series1._prevSeries, undefined);
      ...
      QUnit.test('Set three series - matching points', function(assert) {
        ...
        var series1 = createSeries({points: negativePoints1});
        var series2 = createSeries({points: negativePoints2});
        var series3 = createSeries({points: negativePoints3});
        var series = [series1, series2, series3];
        createSeriesFamily('stackedarea', series);
        checkStackedPoints(assert, negativePoints1, negativePoints2, negativePoints3);
      });
      ...
      QUnit.test('Mixed series with negative and positive values', function(assert) {
        var points1 = pointsForStacking.points1();
        var points2 = pointsForStacking.negativePoints1();
        var points3 = pointsForStacking.points2();
        var points4 = pointsForStacking.negativePoints2();
        ...
        var series2 = createSeries({points: points2});
        var series3 = createSeries({points: points3});
        var series4 = createSeries({points: points4});
        var series = [series1, series2, series3, series4];
      ...
      QUnit.test('When negativesAsZeroes true - all negative values treated as zeroes', function(assert) {
        ...
        var points2 = [createPoint(1, 20), createPoint(2, 40), createPoint(3, -60)];
        var points3 = [createPoint(1, -30), createPoint(2, -60), createPoint(3, -90)];
        var series = [createSeries({points: points1}), createSeries({points: points2}), createSeries({points: points3})];
      ...
      QUnit.test('Set series', function(assert) {
        var series1 = createSeries({points: pointsForBubble.points1()}, undefined, {
          arg: {
            min: 0,
            max: 100
          },
        ...
        var series2 = createSeries({points: pointsForBubble.points2()}, undefined, {
          arg: {
            min: 0,
            max: 100
          },
        ...
        var series3 = createSeries({points: pointsForBubble.points3()}, undefined, {
          arg: {
            min: 0,
            max: 100
          },
        ...
        var series = [series1, series2, series3];
        createSeriesFamily('bubble', series, {
          minBubbleSize: 2,
          maxBubbleSize: 0.1
        });
      ...
      QUnit.test('Set series, points size are not much different', function(assert) {
        var series1 = createSeries({points: pointsForBubble.points4()}, undefined, {
          arg: {
            min: 0,
            max: 100
          },
        ...
        var series2 = createSeries({points: pointsForBubble.points5()}, undefined, {
          arg: {
            min: 0,
            max: 100
          },
      ...
      QUnit.test('Set series, one point', function(assert) {
        var series1 = createSeries({points: pointsForBubble.points6()}, undefined, {
          arg: {
            min: 0,
            max: 100
          },
        ...
        createSeriesFamily('bubble', [series1], {
          minBubbleSize: 2,
          maxBubbleSize: 0.1
        });
      ...
      QUnit.test('set minBubbleSize option', function(assert) {
        var series = [createSeries({points: pointsForBubble.points3()}, undefined, {
          arg: {
            min: 0,
            max: 100
          },
      ...
      QUnit.test('maxBubbleSize === minBubbleSize', function(assert) {
        var series = [createSeries({points: [new MockPoint({
            argument: 'First',
            value: 30,
            size: 10
          }), new MockPoint({
      ...
      QUnit.test('All series are invisible. Bubble', function(assert) {
        var series = createSeries({points: pointsForBubble.points1()}, undefined, {
          arg: {
            min: 0,
            max: 100
          },
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/vizMocks.js","viz/series/points/base_point","../../helpers/chartMocks.js","viz/core/series_family"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/vizMocks.js"), require("viz/series/points/base_point"), require("../../helpers/chartMocks.js"), require("viz/core/series_family"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=seriesFamily.tests.js.map