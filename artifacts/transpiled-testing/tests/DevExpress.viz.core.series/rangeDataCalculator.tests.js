...
(["testing/tests/DevExpress.viz.core.series/rangeDataCalculator.tests.js"], ["jquery","../../helpers/vizMocks.js","viz/series/base_series"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.viz.core.series/rangeDataCalculator.tests.js", ["jquery", "../../helpers/vizMocks.js", "viz/series/base_series"], function($__export) {
  "use strict";
  var $,
      vizMocks,
      SeriesModule,
  ...
  function getDefaultAxis() {
    return {
      ...
      getVisualRangeCenter: function($__1) {
        var $__2 = $__1,
            minVisible = $__2.minVisible,
            maxVisible = $__2.maxVisible;
  ...
  return {
    ...
    execute: function() {
      ...
      createSeries = function(options, renderSettings, widgetType) {
      ...
      QUnit.test('Datetime.', function(assert) {
        ...
        var date6 = new Date(2000);
        var date7 = new Date(3000);
        var date8 = new Date(4000);
        var data = getOriginalData([{
          arg: date4,
          val: date5
        }, {
      ...
      QUnit.test('Datetime. Categories', function(assert) {
        ...
        var date6 = new Date(6000);
        var date7 = new Date(7000);
        var date8 = new Date(8000);
        var data = getOriginalData([{
          arg: date4,
          val: date8
        }, {
      ...
      QUnit.test('Numeric. Logarithmic axis. Do not include negative numbers to range data if allowNegatives is false', function(assert) {
        ...
        series.getArgumentAxis().getOptions = series.getValueAxis().getOptions = function() {
          return axisOptions;
        };
        series.updateDataType(series.getOptions());
        series.updateData(data);
      ...
      QUnit.test('Datetime.', function(assert) {
        ...
        var date3 = new Date(3000);
        var date4 = new Date(4000);
        var date11 = new Date(11000);
        var date13 = new Date(13000);
        var date14 = new Date(14000);
        var data = getOriginalData([{
          arg: date4,
          val: date11
        }, {
      ...
      QUnit.module('Get range data. Simple', {beforeEach: function() {
          this.defaultOptions = {
            type: 'line',
            visible: true,
            label: {
      ...
      QUnit.test('Get range data for one point', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {
          argumentAxisType: 'argumentAxisType',
      ...
      QUnit.test('Numeric', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {argumentAxisType: 'continuous'}));
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.module('Get range data. Simple. For each types', {beforeEach: function() {
      ...
      QUnit.module('Get range data. Bar/area', {beforeEach: function() {
          this.defaultOptions = {
            type: 'bar',
            argumentAxisType: 'discrete',
            label: {
      ...
      QUnit.test('Positive points', function(assert) {
        ...
        var series = createSeries(this.defaultOptions);
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.test('Positive points. Polar bar point', function(assert) {
        ...
        var series = createSeries(this.defaultOptions, undefined, 'polar');
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.module('Get range data. Bar/area. For each types', {beforeEach: function() {
          this.defaultOptions = {
            type: 'bar',
            argumentAxisType: 'discrete',
            label: {
      ...
      QUnit.test('Stackedbar', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {type: 'stackedbar'}));
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.test('Fullstackedbar', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {type: 'fullstackedbar'}));
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.test('Area', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {type: 'area'}));
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.test('Stackedarea', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {type: 'stackedarea'}));
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.test('Stackedsplinearea', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {type: 'stackedsplinearea'}));
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.test('Steparea', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {type: 'steparea'}));
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.test('Splinearea', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {type: 'splinearea'}));
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.test('Fullstacked Line', function(assert) {
        this.testGetRange(assert, 'fullstackedline', [{
          arg: '1',
          val: 4
        }, {
          arg: '2',
          ...
          arg: '4',
          val: 3
        }], false, 0, 10, undefined, undefined);
      });
      QUnit.test('Fullstacked Line. Negative points', function(assert) {
        this.testGetRange(assert, 'fullstackedline', [{
          ...
          arg: '4',
          val: -3
        }], false, -10, 0, undefined, undefined);
      });
      QUnit.test('Fullstacked Line. Update Data', function(assert) {
        this.testGetRangeWithDataUpdate(assert, 'fullstackedline', [{
          arg: '1',
          val: 4
        }, {
          arg: '2',
      ...
      QUnit.test('Fullstacked Spline', function(assert) {
        this.testGetRange(assert, 'fullstackedspline', [{
          arg: '1',
          val: 4
        }, {
          arg: '2',
      ...
      QUnit.test('Fullstacked Spline. Discrete data', function(assert) {
        this.testGetRangeWithDataUpdate(assert, 'fullstackedspline', [{
          arg: '1',
          val: 4
        }, {
          arg: '2',
      ...
      QUnit.test('Fullstacked Area', function(assert) {
        this.testGetRange(assert, 'fullstackedarea', [{
          arg: '1',
          val: 4
        }, {
          arg: '2',
      ...
      QUnit.test('Fullstacked Area. Discrete data', function(assert) {
        this.testGetRangeWithDataUpdate(assert, 'fullstackedarea', [{
          arg: '1',
          val: 4
        }, {
          arg: '2',
      ...
      QUnit.test('Fullstacked SplineArea', function(assert) {
        this.testGetRange(assert, 'fullstackedsplinearea', [{
          arg: '1',
          val: 4
        }, {
          arg: '2',
      ...
      QUnit.test('Fullstacked SplineArea. Discrete data', function(assert) {
        this.testGetRangeWithDataUpdate(assert, 'fullstackedsplinearea', [{
          arg: '1',
          val: 4
        }, {
          arg: '2',
      ...
      QUnit.test('Fullstacked Bar', function(assert) {
        this.testGetRange(assert, 'fullstackedbar', [{
          arg: '1',
          val: 4
        }, {
          arg: '2',
      ...
      QUnit.test('Fullstacked Bar. Discrete data', function(assert) {
        this.testGetRangeWithDataUpdate(assert, 'fullstackedbar', [{
          arg: '1',
          val: 4
        }, {
          arg: '2',
      ...
      QUnit.module('Get range data. Range series', {beforeEach: function() {
          this.defaultOptions = {
            type: 'rangearea',
            argumentAxisType: 'discrete',
            label: {
      ...
      QUnit.module('Get range data. Range series. For each types', {beforeEach: function() {
          this.defaultOptions = {
            argumentAxisType: 'continuous',
            label: {
              visible: false,
      ...
      QUnit.test('Rangebar', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {type: 'rangebar'}));
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.test('Rangearea', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {type: 'rangearea'}));
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.module('Get range data. Financial series', {beforeEach: function() {
          this.defaultOptions = {
            type: 'stock',
            highValueField: 'h',
            lowValueField: 'l',
      ...
      QUnit.module('Get range data. Financial series. For each types', {beforeEach: function() {
          this.defaultOptions = {
            argumentAxisType: 'continuous',
            reduction: {level: 'open'},
            highValueField: 'h',
      ...
      QUnit.test('Stock', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {type: 'stock'}));
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.test('Candlestick', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {type: 'candlestick'}));
        series.updateData(data);
        series.createPoints();
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
      ...
      QUnit.module('Get range data. Pie series', {beforeEach: function() {
          this.defaultOptions = {
            type: 'pie',
            argumentAxisType: 'discrete',
            label: {
      ...
      QUnit.test('Positive points', function(assert) {
        ...
        var rangeData = series.getRangeData();
        assert.ok(rangeData, 'Range data should be created');
        assert.deepEqual(rangeData, {val: {
            min: 0,
            max: 50 / 20
          }});
      });
      ...
      QUnit.module('Get range data. Pie series. For each types', {beforeEach: function() {
          this.defaultOptions = {
            argumentAxisType: 'discrete',
            label: {
              visible: false,
      ...
      QUnit.test('Pie', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {type: 'pie'}), null, 'pie');
        series.updateData(data);
        series.createPoints();
        series.arrangePoints();
        var rangeData = series.getRangeData();
      ...
      QUnit.test('Doughnut', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {type: 'doughnut'}), null, 'pie');
        series.updateData(data);
        series.createPoints();
        series.arrangePoints();
        var rangeData = series.getRangeData();
      ...
      QUnit.module('Zooming range data', {beforeEach: function() {
          var viewPort = [];
      ...
      QUnit.test('Set incorrect min zoom (null)', function(assert) {
        ...
        var series = createSeries(this.defaultOptions, {argumentAxis: this.argumentAxis});
        series.updateData(data);
        series.createPoints();
        this.zoom(null, 4);
        var rangeData = series.getViewport();
      ...
      QUnit.module('Zooming range data. Simple', {beforeEach: function() {
          var viewPort = [];
          this.zoom = function(min, max) {
            viewPort = [min, max];
          };
      ...
      QUnit.test('Datetime values.', function(assert) {
        var data = [{
          arg: 1,
          val: new Date(2016, 6, 1)
        }, {
          arg: 2,
          val: new Date(2016, 6, 2)
        }, {
          arg: 3,
          val: new Date(2016, 6, 3)
        }, {
          arg: 4,
          val: new Date(2016, 6, 4)
        }, {
          arg: 5,
          val: new Date(2016, 6, 5)
        }, {
          arg: 6,
          val: 60
        }];
      ...
      QUnit.test('Datetime argument. String value.', function(assert) {
        ...
        var argDate2 = new Date(2000);
        var argDate3 = new Date(3000);
        var argDate4 = new Date(4000);
        var argDate5 = new Date(5000);
        var argDate6 = new Date(6000);
        var testDate = new Date(4500);
        var data = [{
          arg: argDate1,
          val: '10'
        }, {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {valueAxisType: 'discrete'}), {argumentAxis: this.argumentAxis});
        series.updateData(data);
        series.createPoints();
      ...
      QUnit.test('Discrete argument axis.', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {argumentAxisType: 'discrete'}), {argumentAxis: this.argumentAxis});
        series.updateData(data);
        series.createPoints();
        this.zoom('c', 'd');
        var visualRange = this.argumentAxis.visualRange();
      ...
      QUnit.module('Zooming range data. Bar/area', {beforeEach: function() {
          var viewPort = [];
          this.zoom = function(min, max) {
            viewPort = [min, max];
          };
      ...
      QUnit.test('Bar. In the range shouldn\'t be the points that out of the zoom area', function(assert) {
        ...
        var series = createSeries($.extend({}, this.defaultOptions, {type: 'bar'}), {argumentAxis: this.argumentAxis});
        series.updateData(data);
        series.createPoints();
        this.zoom(2, 4.5);
        var rangeData = series.getViewport();
      ...
      QUnit.test('ShowZero === false', function(assert) {
        ...
        var series = createSeries($.extend(true, {}, this.defaultOptions, {showZero: false}), {argumentAxis: this.argumentAxis});
        series.updateData(data);
        series.createPoints();
        this.zoom(3, 4.5);
        var rangeData = series.getViewport();
      ...
      QUnit.test('Add interval if checkInterval in marginOptions', function(assert) {
        ...
        this.argumentAxis.getMarginOptions = function() {
      ...
      QUnit.module('Get points in viewport', {beforeEach: function() {
          ...
          this.argumentAxis = {
            visualRange: function() {
              return {
                startValue: argumentViewPort[0],
                endValue: argumentViewPort[1]
              };
            },
            aggregatedPointBetweenTicks: sinon.spy()
          };
          this.valueAxis = {visualRange: function() {
              return {
                startValue: valueViewPort[0],
                endValue: valueViewPort[1]
              };
            }};
        }});
      ...
      QUnit.test('Calculate interval in range data when aggregation is enabled. aggregatedPointsPosition = crossTicks', function(assert) {
        ...
        var series = createSeries({
          ...
          argumentAxisType: 'continuous',
          aggregation: {enabled: true}
        }, {argumentAxis: $.extend({}, getDefaultAxis(), {aggregatedPointBetweenTicks: function() {
              return true;
            }})});
        series.updateData(data);
        series.createPoints();
...
//# sourceMappingURL=rangeDataCalculator.tests.js.map