...
(["testing/tests/DevExpress/misc.tests.js"], [], true, function($__System) {
...
$__System.registerDynamic('testing/tests/DevExpress/misc.tests.js', [], false, function ($__require, $__exports, $__module) {
    ...
    (function ($__global) {
        QUnit.module('uncleared timers detection', {
            ...
            QUnit.test('cleared setTimeout', function (assert) {
                this.window.clearTimeout(this.window.setTimeout(function () {}, 123));
            ...
            QUnit.test('cleared setInterval', function (assert) {
                this.window.clearInterval(this.window.setInterval(function () {}, 123));
            ...
            QUnit.test('cleared animation frame', function (assert) {
                this.window.cancelAnimationFrame(this.window.requestAnimationFrame(function () {}));
...
//# sourceMappingURL=misc.tests.js.map