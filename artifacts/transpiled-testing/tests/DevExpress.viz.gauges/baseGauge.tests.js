...
(["testing/tests/DevExpress.viz.gauges/baseGauge.tests.js"], ["jquery","../../helpers/vizMocks.js","core/component_registrator","core/utils/resize_callbacks","viz/gauges/base_gauge","viz/core/title","viz/core/loading_indicator","viz/core/renderers/renderer","viz/core/tooltip","viz/translators/translator1d","viz/gauges/theme_manager","viz/gauges/tracker","common/charts"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.viz.gauges/baseGauge.tests.js", ["jquery", "../../helpers/vizMocks.js", "core/component_registrator", "core/utils/resize_callbacks", "viz/gauges/base_gauge", "viz/core/title", "viz/core/loading_indicator", "viz/core/renderers/renderer", "viz/core/tooltip", "viz/translators/translator1d", "viz/gauges/theme_manager", "viz/gauges/tracker", "common/charts"], function($__export) {
  "use strict";
  var $,
      vizMocks,
      registerComponent,
  ...
  return {
    setters: [function($__m) {
      ...
      BaseGauge = $__m.BaseGauge;
      formatValue = $__m.formatValue;
      getSampleText = $__m.getSampleText;
    }, function($__m) {
      ...
      themeManagerModule = $__m.default;
    }, function($__m) {
      Tracker = $__m.default;
    }, function($__m) {
    ...
    execute: function() {
      ...
      factory = BaseGauge.prototype._factory;
      BASE_METHODS = ['_invalidate', '_refresh'];
      ABSTRACT_METHODS = ['_setupDomainCore', '_setupCodomain', '_getDefaultSize', '_cleanContent', '_renderContent', '_getApproximateScreenRange'];
      CONTAINER_WIDTH = 200;
      CONTAINER_HEIGHT = 100;
      StubTranslator = vizMocks.stubClass(translator1DModule.Translator1D);
      StubThemeManager = vizMocks.stubClass(themeManagerModule.ThemeManager);
      StubTracker = vizMocks.stubClass(Tracker);
      StubTooltip = vizMocks.stubClass(tooltipModule.Tooltip, {isEnabled: function() {
      ...
      QUnit.test('Components creation', function(assert) {
        ...
        assert.deepEqual(factory.createTracker.lastCall.args, [{
          renderer: this.renderer,
          container: this.renderer.root
        }], 'tracker');
        var arg = this.tracker.setCallbacks.lastCall.args[0];
        assert.strictEqual($traceurRuntime.typeof(arg['tooltip-show']), 'function', 'show callback');
        assert.strictEqual($traceurRuntime.typeof(arg['tooltip-hide']), 'function', 'hide callback');
      });
      QUnit.test('Components disposing', function(assert) {
        this.createGauge();
        this.$container.remove();
        assert.ok(this.renderer.dispose.called, 'renderer');
      ...
      QUnit.test('Animation / disabled', function(assert) {
        var gauge = this.createGauge({animation: {
            enabled: false,
            duration: 500
          }});
      ...
      QUnit.test('Animation / duration is zero', function(assert) {
        var gauge = this.createGauge({animation: {duration: 0}});
        assert.strictEqual(gauge._animationSettings, null);
      });
      QUnit.test('Animation / duration is negative', function(assert) {
        var gauge = this.createGauge({animation: {duration: -10}});
        assert.strictEqual(gauge._animationSettings, null);
      });
      ...
      QUnit.test('Container background color', function(assert) {
        var gauge = this.createGauge({containerBackgroundColor: 'red'});
      ...
      QUnit.test('Default format options / very big numbers', function(assert) {
        ...
        var gauge = this.createGauge();
        assert.deepEqual(gauge._defaultFormatOptions, {
          type: 'exponential',
          precision: 2
        });
      });
      ...
      QUnit.test('T305684. Subtitle is single text', function(assert) {
        this.createGauge({title: {
            text: 'Test',
            subtitle: 'Test2'
          }});
        vizMocks.forceThemeOptions(this.themeManager);
        assert.deepEqual(this.title.update.getCall(0).args[1], {
          text: 'Test',
          subtitle: 'Test2'
        });
        assert.strictEqual(this.title.update.getCall(0).args[0], this.themeManager.theme('title'));
      ...
      QUnit.test('Not rendered when value range is empty', function(assert) {
        ...
        this.createGauge({onIncidentOccurred: onIncidentOccurred});
        this.clock.tick(0);
      ...
      QUnit.test('Drawn callback', function(assert) {
        ...
        var gauge = this.createGauge({onDrawn: onDrawn});
      ...
      QUnit.test('Show tooltip', function(assert) {
        this.createGauge();
        var target = {getTooltipParameters: sinon.stub().returns({
            value: 'value',
            color: 'color',
            x: 100,
            y: 200,
        ...
        var info = {tag: 'info'};
        this.renderer.getRootOffset = sinon.stub().returns({
          left: 10,
          top: 20
        });
        ...
        assert.deepEqual(this.tooltip.show.lastCall.args, [{
          ...
          y: 220,
          offset: 50
        }, {target: info}, undefined, undefined], 'tooltip is shown');
      });
      ...
      QUnit.test('format and precision', function(assert) {
        assert.strictEqual(formatValue(0.135467, {format: {
            type: 'fixedPoint',
            precision: 2
          }}), '0.14');
      });
      QUnit.test('customizeText', function(assert) {
        assert.deepEqual(formatValue(0.135467, {customizeText: function(arg) {
            return arg.value.toString() + '###' + arg.valueText;
          }}), '0.135467###0.135467');
      });
      ...
      QUnit.test('format, precision and customizeText', function(assert) {
        assert.deepEqual(formatValue(0.135467, {
          ...
          customizeText: function() {
            return this.value.toString() + '###' + this.valueText;
          }
        }), '0.135467###0.14');
      });
      QUnit.test('customizeText returns not a string (B233462)', function(assert) {
        assert.strictEqual(formatValue(100, {customizeText: function() {
            return this.value;
          }}), '100', '100');
        assert.strictEqual(formatValue(undefined, {customizeText: function() {
            return this.value;
          }}), 'undefined', 'undefined');
        assert.strictEqual(formatValue(null, {customizeText: function() {
            return this.value;
          }}), 'null', 'null');
      });
      QUnit.test('extra parameters for customizeText context', function(assert) {
        assert.strictEqual(formatValue(100, {customizeText: function(arg) {
            return arg.a1 + arg.a2 + arg.value;
          }}, {
          a1: 'A1',
          a2: 'A2'
        }), 'A1A2100');
        assert.strictEqual(formatValue(200, {customizeText: function(arg) {
            return arg.value;
          }}, null), '200');
      });
      QUnit.test('format negative zero', function(assert) {
        assert.strictEqual(formatValue(-0, {format: {
            precision: 2,
            type: 'fixedPoint'
          }}), '0.00');
      });
      QUnit.module('util - getSampleText', {test_getSampleText: function(start, end) {
          return getSampleText(new translator1DModule.Translator1D(start, end, 0, 1), {customizeText: function(arg) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/vizMocks.js","core/component_registrator","core/utils/resize_callbacks","viz/gauges/base_gauge","viz/core/title","viz/core/loading_indicator","viz/core/renderers/renderer","viz/core/tooltip","viz/translators/translator1d","viz/gauges/theme_manager","viz/gauges/tracker","common/charts"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/vizMocks.js"), require("core/component_registrator"), require("core/utils/resize_callbacks"), require("viz/gauges/base_gauge"), require("viz/core/title"), require("viz/core/loading_indicator"), require("viz/core/renderers/renderer"), require("viz/core/tooltip"), require("viz/translators/translator1d"), require("viz/gauges/theme_manager"), require("viz/gauges/tracker"), require("common/charts"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=baseGauge.tests.js.map