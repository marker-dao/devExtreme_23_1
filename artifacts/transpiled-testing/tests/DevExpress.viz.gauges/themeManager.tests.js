...
(["testing/tests/DevExpress.viz.gauges/themeManager.tests.js"], ["core/utils/common","viz/themes","viz/gauges/theme_manager"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.gauges/themeManager.tests.js', ['core/utils/common', 'viz/themes', 'viz/gauges/theme_manager'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const noop = $__require('core/utils/common').noop;
    const themeModule = $__require('viz/themes');
    const ThemeManager = $__require('viz/gauges/theme_manager').ThemeManager;
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/common","viz/themes","viz/gauges/theme_manager"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/common"), require("viz/themes"), require("viz/gauges/theme_manager"));
  else
