...
(["testing/tests/DevExpress.viz.gauges/rangeContainer.tests.js"], ["jquery","core/utils/common","../../helpers/vizMocks.js","viz/gauges/base_range_container","viz/gauges/circular_range_container","viz/gauges/linear_range_container","viz/translators/translator1d","viz/gauges/theme_manager"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.gauges/rangeContainer.tests.js', ['jquery', 'core/utils/common', '../../helpers/vizMocks.js', 'viz/gauges/base_range_container', 'viz/gauges/circular_range_container', 'viz/gauges/linear_range_container', 'viz/translators/translator1d', 'viz/gauges/theme_manager'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const noop = $__require('core/utils/common').noop;
    const vizMocks = $__require('../../helpers/vizMocks.js');
    const BaseRangeContainer = $__require('viz/gauges/base_range_container');
    const CircularRangeContainer = $__require('viz/gauges/circular_range_container');
    const LinearRangeContainer = $__require('viz/gauges/linear_range_container');
    ...
    QUnit.test('Init with less ranges', function (assert) {
        ...
        rangeContainer.render({
            width: 10,
            ranges: [{ startValue: 0, endValue: 20, color: 'red' }, { startValue: 20, endValue: 40, color: 'green' }]
        });
        rangeContainer.render({
            width: 11,
            ranges: [{ startValue: 0, endValue: 10, color: 'yellow' }]
        });
    ...
    QUnit.test('Init with more ranges', function (assert) {
        ...
        rangeContainer.render({
            width: 9,
            ranges: [{ startValue: 0, endValue: 10, color: 'yellow' }, { startValue: 10, endValue: 20, color: 'blue' }, { startValue: 20, endValue: 30, color: 'orange' }]
        });
        assert.deepEqual(rangeContainer._options, {
            width: 9,
            ranges: [{ startValue: 0, endValue: 10, color: 'yellow' }, { startValue: 10, endValue: 20, color: 'blue' }, { startValue: 20, endValue: 30, color: 'orange' }]
    ...
    QUnit.test('Color for value', function (assert) {
        ...
        this.rangeContainer.render({
            ...
            ranges: [{ startValue: 10, endValue: 20, color: 'color-1' }, { startValue: 30, endValue: 50, color: 'color-2' }, { startValue: 50, endValue: 80, color: 'color-3' }]
        });
    ...
    QUnit.test('Custom colors', function (assert) {
        ...
        this.rangeContainer.render({
            ...
            ranges: [{ startValue: 10, endValue: 20, color: { fillId: 'id_color_1' } }, { startValue: 30, endValue: 50, color: { fillId: 'id_color_2' } }, { startValue: 50, endValue: 80, color: { fillId: 'id_color_3' } }]
        });
    ...
    QUnit.test('ranges', function (assert) {
        this.checkRanges(assert, [{ startValue: -20, endValue: -10, color: 'c1' }, { startValue: 0, endValue: 20, color: 'c2' }, { startValue: 50, endValue: 100, color: 'c3' }], [{ start: -20, end: -10, color: 'c1', className: 0 }, { start: 0, end: 20, color: 'c2', className: 1 }, { start: 50, end: 100, color: 'c3', className: 2 }, { start: -50, end: -20, color: 'bcolor' }, { start: -10, end: 0, color: 'bcolor' }, { start: 20, end: 50, color: 'bcolor' }, { start: 100, end: 150, color: 'bcolor' }]);
    });

    QUnit.test('ranges intersections', function (assert) {
        this.checkRanges(assert, [{ startValue: -60, endValue: -10, color: 'c1' }, { startValue: -40, endValue: 20, color: 'c2' }, { startValue: 10, endValue: 70, color: 'c3' }, { startValue: 50, endValue: 130, color: 'c4' }, { startValue: 120, endValue: 170, color: 'c5' }], [{ start: -50, end: -40, color: 'c1', className: 0 }, { start: -40, end: 10, color: 'c2', className: 1 }, { start: 10, end: 50, color: 'c3', className: 2 }, { start: 50, end: 120, color: 'c4', className: 3 }, { start: 120, end: 150, color: 'c5', className: 4 }]);
    });

    QUnit.test('ranges overlapping', function (assert) {
        this.checkRanges(assert, [{ startValue: -40, endValue: 30, color: 'c1' }, { startValue: -30, endValue: -10, color: 'c2' }, { startValue: 80, endValue: 110, color: 'c3' }, { startValue: 50, endValue: 130, color: 'c4' }], [{ start: -40, end: -30, color: 'c1', className: 0 }, { start: -10, end: 30, color: 'c1', className: 0 }, { start: -30, end: -10, color: 'c2', className: 1 }, { start: 50, end: 130, color: 'c4', className: 3 }, { start: -50, end: -40, color: 'bcolor' }, { start: 30, end: 50, color: 'bcolor' }, { start: 130, end: 150, color: 'bcolor' }]);
    });

    QUnit.test('ranges out of bounds', function (assert) {
        this.checkRanges(assert, [{ startValue: -100, endValue: -60, color: 'c1' }, { startValue: 200, endValue: 210, color: 'c2' }, { startValue: 0, endValue: 10, color: 'c3' }], [{ start: 0, end: 10, color: 'c3', className: 2 }, { start: -50, end: 0, color: 'bcolor' }, { start: 10, end: 150, color: 'bcolor' }]);
    });

    QUnit.test('ranges are empty', function (assert) {
        this.checkRanges(assert, [{ startValue: 10, endValue: 10, color: 'c1' }, { startValue: 50, endValue: 50, color: 'c2' }, { startValue: -10, endValue: 140, color: 'c3' }], [{ start: -10, end: 140, color: 'c3', className: 2 }, { start: -50, end: -10, color: 'bcolor' }, { start: 140, end: 150, color: 'bcolor' }]);
    });

    QUnit.test('ranges are not valid - wrong order', function (assert) {
        this.checkRanges(assert, [{ startValue: 10, endValue: 20, color: 'c1' }, { startValue: 30, endValue: 0, color: 'c2' }, { startValue: -10, endValue: -40, color: 'c3' }], [{ start: 10, end: 20, color: 'c1', className: 0 }, { start: -50, end: 10, color: 'bcolor' }, { start: 20, end: 150, color: 'bcolor' }]);
    });

    QUnit.test('ranges are empty, without custom color (T961251)', function (assert) {
        this.checkRanges(assert, [{ startValue: 10, endValue: 10 }, { startValue: 50, endValue: 50 }, { startValue: 10, endValue: 50 }], [{ start: 10, end: 10, color: '#97c95c', className: 0 }, { start: 50, end: 50, color: '#ffc720', className: 1 }, { start: 10, end: 50, color: '#f5564a', className: 2 }, { start: -50, end: 10, color: 'bcolor' }, { start: 50, end: 150, color: 'bcolor' }]);
    });

    QUnit.test('ranges are not valid - not numbers', function (assert) {
        this.checkRanges(assert, [{ startValue: 'test', endValue: 10, color: 'c1' }, { startValue: 20, endValue: null, color: 'c2' }, { startValue: -40, endValue: 40, color: 'c3' }, { startValue: undefined, endValue: 100, color: 'c4' }, { startValue: 10, endValue: [], color: 'c5' }, { startValue: -30, endValue: {}, color: 'c6' }, { startValue: NaN, endValue: NaN, color: 'c7' }], [{ start: -40, end: 40, color: 'c3', className: 2 }, { start: -50, end: -40, color: 'bcolor' }, { start: 40, end: 150, color: 'bcolor' }]);
    });
    ...
    QUnit.test('ascending width', function (assert) {
        ...
        this.rangeContainer.render({
            backgroundColor: 'bcolor',
            ranges: [{ startValue: 10, endValue: 25, color: 'c1' }, { startValue: 25, endValue: 50, color: 'c2' }, { startValue: 50, endValue: 90, color: 'c3' }],
        ...
        this.rangeContainer.render({
            backgroundColor: 'bcolor',
            ranges: [{ startValue: 90, endValue: 75, color: 'c1' }, { startValue: 75, endValue: 50, color: 'c2' }, { startValue: 50, endValue: 10, color: 'c3' }],
            width: { start: 10, end: 20 }
        }).resize();
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","../../helpers/vizMocks.js","viz/gauges/base_range_container","viz/gauges/circular_range_container","viz/gauges/linear_range_container","viz/translators/translator1d","viz/gauges/theme_manager"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("../../helpers/vizMocks.js"), require("viz/gauges/base_range_container"), require("viz/gauges/circular_range_container"), require("viz/gauges/linear_range_container"), require("viz/translators/translator1d"), require("viz/gauges/theme_manager"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=rangeContainer.tests.js.map