...
(["testing/tests/DevExpress.viz.gauges/barGauge.tests.js"], ["jquery","core/utils/common","../../helpers/vizMocks.js","viz/bar_gauge","viz/core/renderers/renderer","viz/core/loading_indicator","viz/core/title","viz/core/tooltip","viz/gauges/bar_gauge","viz/core/export","viz/themes"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.gauges/barGauge.tests.js', ['jquery', 'core/utils/common', '../../helpers/vizMocks.js', 'viz/bar_gauge', 'viz/core/renderers/renderer', 'viz/core/loading_indicator', 'viz/core/title', 'viz/core/tooltip', 'viz/gauges/bar_gauge', 'viz/core/export', 'viz/themes'], true, function ($__require, exports, module) {
    ...
    const dxBarGauge = $__require('viz/bar_gauge');
    ...
    const barGaugeModule = $__require('viz/gauges/bar_gauge');
    ...
    QUnit.begin(function () {
        ...
        const StubTooltip = vizMocks.stubClass(tooltipModule.Tooltip, { isEnabled: function () {
    ...
    checkPositioning('default', {
        ...
        this.checkTexts(assert, { x: 200, y: 174, textRadius: 164, lineWidth: 2 }, [[113, -108], [78, -27], [43, 81]], [[34, 223], [116, 16], [372, 136]], ['10.0', '40.0', '80.0']);
    });
    ...
    checkPositioning('labels indent', {
        ...
        this.checkTexts(assert, { x: 200, y: 174, textRadius: 164, lineWidth: 2 }, [[82.5, -49], [37, 105]], [[67, 54], [368, 215]], ['32.0', '89.0']);
    });
    ...
    checkPositioning('labels indent - out of range', {
        ...
        this.checkTexts(assert, { x: 200, y: 174, textRadius: 164, lineWidth: 2 }, [[55, -49], [24, 105]], [[67, 54], [368, 210]], ['32.0', '89.0']);
    });
    ...
    checkPositioning('value is equal to base value / with labels', {
        ...
        this.checkTexts(assert, { x: 200, y: 174, textRadius: 164, lineWidth: 2 }, [[82.5, -54], [37, -27]], [[57, 66], [116, 16]], ['30.0', '40.0']);
    });
    ...
    checkPositioning('connector width', {
        ...
        this.checkTexts(assert, { x: 200, y: 174, textRadius: 164, lineWidth: 3 }, [[95.5, -94], [43, -57]], [[27, 180], [53, 72]], ['15.0', '29.0']);
    });
    ...
    QUnit.test('labels on almost straight lines (delta less than indent)', function (assert) {
        ...
        this.checkTexts(assert, { x: 200, y: 174, textRadius: 164, lineWidth: 2 }, [[113, -92], [78, 3], [43, 89]], [[26, 172], [208, -2], [374, 164]], ['16.0', '51.0', '83.0']);
    });
    ...
    QUnit.test('labels straight lines (indent = 0)', function (assert) {
        ...
        this.checkTexts(assert, { x: 200, y: 174, textRadius: 164, lineWidth: 2 }, [[138.25, 0], [108.5, 0], [78.75, 90], [49, 90]], [[190, -2], [200, -2], [374, 174 - 12], [374, 174 - 7]], ['60.0', '60.0', '100.0', '100.0']);
    });
    ...
    QUnit.test('Half circle up - leave margin on bottom', function (assert) {
        ...
        this.checkTexts(assert, { x: 400, y: 195, textRadius: 185, lineWidth: 2 }, [[49, 90]], [[595, 188]], ['100.0']);
    });
    ...
    QUnit.module('Label overlapping behavior', function (hooks) {
        ...
        QUnit.test('Hide', function (assert) {
            ...
            { x: 27, y: 29, width: 10, height: 10 }, { x: 20, y: 20, width: 10, height: 10 },

            // compare third label with second label
            { x: 20, y: 20, width: 10, height: 10 }, { x: 3, y: 5, width: 10, height: 10 },

            // compare second label with first label
            { x: 3, y: 5, width: 10, height: 10 }, { x: 0, y: 0, width: 10, height: 10 }];
            let i = 0;
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","../../helpers/vizMocks.js","viz/bar_gauge","viz/core/renderers/renderer","viz/core/loading_indicator","viz/core/title","viz/core/tooltip","viz/gauges/bar_gauge","viz/core/export","viz/themes"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("../../helpers/vizMocks.js"), require("viz/bar_gauge"), require("viz/core/renderers/renderer"), require("viz/core/loading_indicator"), require("viz/core/title"), require("viz/core/tooltip"), require("viz/gauges/bar_gauge"), require("viz/core/export"), require("viz/themes"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=barGauge.tests.js.map