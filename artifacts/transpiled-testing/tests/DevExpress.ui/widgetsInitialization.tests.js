...
(["testing/tests/DevExpress.ui/widgetsInitialization.tests.js"], ["../../helpers/widgetsList.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui/widgetsInitialization.tests.js", ["../../helpers/widgetsList.js"], function($__export) {
  "use strict";
  var widgetsList;
  return {
    setters: [function($__m) {
      widgetsList = $__m.widgetsList;
    }],
    execute: function() {
      QUnit.module('Widget initialization', {beforeEach: function() {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../helpers/widgetsList.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../helpers/widgetsList.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=widgetsInitialization.tests.js.map