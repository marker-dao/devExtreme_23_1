...
(["testing/tests/DevExpress.ui/hierarchicalCollectionWidgetParts/hierarchicalCollectionTestHelper.js"], ["jquery","ui/hierarchical_collection/ui.data_adapter"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui/hierarchicalCollectionWidgetParts/hierarchicalCollectionTestHelper.js", ["jquery", "ui/hierarchical_collection/ui.data_adapter"], function($__export) {
  "use strict";
  var $,
  ...
  return {
    ...
    execute: function() {
      HierarchicalCollectionTestHelper = function() {
        function HierarchicalCollectionTestHelper() {
        ...
        return ($traceurRuntime.createClass)(HierarchicalCollectionTestHelper, {
          ...
          getTreeDataWithObjects: function() {
            var User = function(text, items) {
              this.text = text;
              this.items = items;
            };
            return [new User('Item 1', [new User('Item 11'), new User('Item 12')]), new User('Item 2')];
          },
          getTreeDataWithKeys: function() {
            return [{
              text: 'Item 1',
              id: 1,
              items: [{
          ...
          getTreeDataWithoutKeys: function() {
            return [{
              text: 'Item 1',
              items: [{
                text: 'Item 11',
                items: [{text: 'Item 111'}, {text: 'Item 112'}]
              }, {text: 'Item 12'}]
            }, {
              text: 'Item 2',
              items: [{text: 'Item 21'}]
          ...
          getTreeNodesWithoutKeys: function() {
            return [{
              id: 1,
              parentId: 0,
              parent: null,
      ...
      $__export('default', HierarchicalCollectionTestHelper);
    }
  };
});
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/hierarchical_collection/ui.data_adapter"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/hierarchical_collection/ui.data_adapter"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=hierarchicalCollectionTestHelper.js.map