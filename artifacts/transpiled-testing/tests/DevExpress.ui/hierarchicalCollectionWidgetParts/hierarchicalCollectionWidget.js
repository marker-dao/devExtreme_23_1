...
(["testing/tests/DevExpress.ui/hierarchicalCollectionWidgetParts/hierarchicalCollectionWidget.js"], ["jquery","ui/hierarchical_collection/ui.hierarchical_collection_widget","data/data_source/data_source"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui/hierarchicalCollectionWidgetParts/hierarchicalCollectionWidget.js", ["jquery", "ui/hierarchical_collection/ui.hierarchical_collection_widget", "data/data_source/data_source"], function($__export) {
  "use strict";
  var $,
  ...
  return {
    setters: [function($__m) {
      ...
      HierarchicalCollectionWidget = $__m.default;
    }, function($__m) {
    ...
    execute: function() {
      ...
      TestComponent = function($__super) {
        ...
        return ($traceurRuntime.createClass)(TestComponent, {
          ...
          _createActionByOption: function(optionName, config) {
            ...
            return ($__4 = $traceurRuntime.superGet(this, TestComponent.prototype, "_createActionByOption")).call.apply($__4, $traceurRuntime.spread([this], arguments));
          }
        }, {}, $__super);
      }(HierarchicalCollectionWidget);
      createHierarchicalCollectionWidget = function(options) {
      ...
      module('render', {
        ...
        [null, undefined, '', {}].forEach(function(dataExprValue) {
          test(("DisplayExpr: " + dataExprValue + ", items without 'text' property"), function(assert) {
            try {
              ...
              var $item = $('#hcw').find('.dx-item').eq(0);
        ...
        test('Expressions should be reinitialized if *expr option was changed', function(assert) {
          ...
          var item = widget.option('items')[0];
        ...
        test('Ignore dataSource paging', function(assert) {
          createHierarchicalCollectionWidget({dataSource: new DataSource({
        ...
        test('Datasource should load once on hcw init', function(assert) {
          var dataSourceLoaded = sinon.spy();
          createHierarchicalCollectionWidget({dataSource: new DataSource({
              store: [{text: 'item 1'}, {text: 'item 2'}, {text: 'item 3'}],
              paginate: true,
              pageSize: 2,
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/hierarchical_collection/ui.hierarchical_collection_widget","data/data_source/data_source"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/hierarchical_collection/ui.hierarchical_collection_widget"), require("data/data_source/data_source"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=hierarchicalCollectionWidget.js.map