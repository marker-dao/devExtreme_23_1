...
(["testing/tests/DevExpress.ui/eventsStrategy.tests.js"], ["jquery","ui/widget/ui.widget","core/component_registrator","core/events_strategy"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.ui/eventsStrategy.tests.js', ['jquery', 'ui/widget/ui.widget', 'core/component_registrator', 'core/events_strategy'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const Widget = $__require('ui/widget/ui.widget');
    const registerComponent = $__require('core/component_registrator');
    const EventsStrategy = $__require('core/events_strategy').EventsStrategy;
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/widget/ui.widget","core/component_registrator","core/events_strategy"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/widget/ui.widget"), require("core/component_registrator"), require("core/events_strategy"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=eventsStrategy.tests.js.map