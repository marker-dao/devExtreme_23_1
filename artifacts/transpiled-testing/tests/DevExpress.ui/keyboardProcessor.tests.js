...
(["testing/tests/DevExpress.ui/keyboardProcessor.tests.js"], ["jquery","events/core/keyboard_processor"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui/keyboardProcessor.tests.js", ["jquery", "events/core/keyboard_processor"], function($__export) {
  "use strict";
  var $,
      KeyboardProcessor,
      test;
    ...
    execute: function() {
      ...
      QUnit.module('keyboardProcessor', {
        beforeEach: function() {
          ...
          this.createAssertionHandler = function(assert) {
            ...
            return function(options) {
              assert.strictEqual(options.originalEvent, $__2.keyDownEvent, 'the original event is passed to a handler');
              assert.strictEqual(options.keyName, $__2.normalizedKeyName, 'string key name is passed to the handler');
              assert.strictEqual(options.ctrl, $__2.ctrlKey, 'ctrl status is passed to the handler');
            };
          };
        ...
        test('keyboardProcessor should invoke process', function(assert) {
          ...
          this.processor.process = function(e) {
            assert.strictEqual(e, $__2.keyDownEvent);
          };
        ...
        test('keyboardProcessor should process keys it does not know about', function(assert) {
          ...
          this.processor = new KeyboardProcessor({handler: function(e) {
              assert.equal(e.key, key, 'key code set as key name, if it is unknown');
            }});
          this.processor.process(this.keyDownEvent);
        });
        ...
        test('keyboardProcessor should not process event after compositionend with a \'229\' keycode [MacOS Safari specific behavior]', function(assert) {
          ...
          assert.ok(stubHandler.notCalled, 'event was not processed');
          this.element.trigger($.Event('compositionend'));
          var enterComposition = $.Event('keydown');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","events/core/keyboard_processor"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("events/core/keyboard_processor"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=keyboardProcessor.tests.js.map