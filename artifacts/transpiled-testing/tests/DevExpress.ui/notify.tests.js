System.register(["jquery", "ui/notify", "animation/fx", "core/utils/view_port", "core/utils/type", "generic_light.css!"], function (_export, _context) {
  "use strict";

  var $, notify, fx, viewPort, isPlainObject, TOAST_CLASS, TOAST_WRAPPER_CLASS, TOAST_MESSAGE_CLASS, TOAST_STACK;
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_uiNotify) {
      notify = _uiNotify.default;
    }, function (_animationFx) {
      fx = _animationFx.default;
    }, function (_coreUtilsView_port) {
      viewPort = _coreUtilsView_port.value;
    }, function (_coreUtilsType) {
      isPlainObject = _coreUtilsType.isPlainObject;
    }, function (_generic_lightCss) {}],
    execute: function () {
      TOAST_CLASS = 'dx-toast';
      TOAST_WRAPPER_CLASS = 'dx-toast-wrapper';
      TOAST_MESSAGE_CLASS = 'dx-toast-message';
      TOAST_STACK = 'dx-toast-stack';
      QUnit.module('notify', {
        beforeEach: function () {
        ...
        ['onShowing', 'onShown', 'onHiding', 'onHidden'].forEach(eventName => {
