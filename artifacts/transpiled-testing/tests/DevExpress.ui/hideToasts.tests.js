...
(["testing/tests/DevExpress.ui/hideToasts.tests.js"], ["jquery","ui/notify","animation/fx","ui/toast/hide_toasts"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui/hideToasts.tests.js", ["jquery", "ui/notify", "animation/fx", "ui/toast/hide_toasts"], function($__export) {
  "use strict";
  var $,
      notify,
      fx,
    ...
    execute: function() {
      ...
      QUnit.module('hideToasts', {
        beforeEach: function() {
          ...
          this.getToastCount = function() {
            return $('.dx-toast').length;
          };
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/notify","animation/fx","ui/toast/hide_toasts"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/notify"), require("animation/fx"), require("ui/toast/hide_toasts"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=hideToasts.tests.js.map