...
(["testing/tests/DevExpress.ui/collectionWidgetParts/liveUpdateTests.js"], ["jquery","ui/collection/ui.collection_widget.live_update","data/data_source/data_source","data/custom_store"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui/collectionWidgetParts/liveUpdateTests.js", ["jquery", "ui/collection/ui.collection_widget.live_update", "data/data_source/data_source", "data/custom_store"], function($__export) {
  "use strict";
  var $,
      CollectionWidget,
      DataSource,
  ...
  return {
    ...
    execute: function() {
      var $__5;
      (($__5 = QUnit, module = $__5.module, test = $__5.test, $__5));
      ...
      TestComponent = function($__super) {
        ...
        return ($traceurRuntime.createClass)(TestComponent, {
          ...
          reload: function() {
            $traceurRuntime.superGet(this, TestComponent.prototype, "reload").call(this);
            this.option('items', []);
      ...
      LiveUpdateTestHelper = function() {
        function LiveUpdateTestHelper() {
          this.$element = $('#cmp');
          this.data = generateData(10);
          this.instance = this.getInstance();
          this.store = this.instance.getDataSource().store();
        }
        return ($traceurRuntime.createClass)(LiveUpdateTestHelper, {
          getItems: function() {
          ...
          getInstance: function(options) {
            ...
            return new TestComponent(this.$element, options || {
              dataSource: new DataSource({
                load: function(e) {
                  return $__4.data.sort(function(a, b) {
          ...
          reinitializeWithOptions: function(options) {
            this.instance.dispose();
            this.instance = this.getInstance(options);
          }
        }, {});
      }();
      module('live update', {beforeEach: function() {
        ...
        test('correct index after push \'remove\' and dataSource reload', function(assert) {
          helper.instance._shouldAppendItems = function() {
            return false;
          };
          ...
          var $__6 = loadingSpy.getCall(0).args[0],
              skip = $__6.skip,
              take = $__6.take;
          assert.equal(skip, 0);
        ...
        test('next page items should be correctly updated with "repaintChangesOnly" mode when dataSource reloaded(T950597)', function(assert) {
          ...
          helper.instance.reload();
          helper.instance.loadNextPage();
          var $items = helper.getItemElements();
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/collection/ui.collection_widget.live_update","data/data_source/data_source","data/custom_store"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/collection/ui.collection_widget.live_update"), require("data/data_source/data_source"), require("data/custom_store"));
  else
