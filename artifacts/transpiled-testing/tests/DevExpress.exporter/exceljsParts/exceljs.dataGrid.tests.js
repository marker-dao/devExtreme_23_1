...
(["testing/tests/DevExpress.exporter/exceljsParts/exceljs.dataGrid.tests.js"], ["jquery","core/errors","exceljs","./ExcelJSTestHelper.js","excel_exporter","exporter/exceljs/export","./exceljs.format.tests.js","./exceljs.options.tests.js","../commonParts/loadPanel.tests.js","core/utils/type","ui/data_grid","generic_light.css!"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.exporter/exceljsParts/exceljs.dataGrid.tests.js", ["jquery", "core/errors", "exceljs", "./ExcelJSTestHelper.js", "excel_exporter", "exporter/exceljs/export", "./exceljs.format.tests.js", "./exceljs.options.tests.js", "../commonParts/loadPanel.tests.js", "core/utils/type", "ui/data_grid", "generic_light.css!"], function($__export) {
  "use strict";
  var $,
      errors,
      ExcelJS,
      ...
      isDefined,
      helper,
      excelColumnWidthFromGrid500Pixels,
      excelColumnWidthFromColumn100Pixels,
      excelColumnWidthFromColumn150Pixels,
      excelColumnWidthFromColumn200Pixels,
      excelColumnWidthFromColumn250Pixels,
      excelColumnWidthFromColumn300Pixels,
      alignLeftTopWrap,
      alignLeftTopNoWrap,
      alignRightTopWrap,
      alignRightTopNoWrap,
      alignCenterTopWrap,
      alignCenterTopNoWrap,
      moduleConfig;
  return {
    setters: [function($__m) {
      ...
      ExcelJSOptionTests = $__m.ExcelJSOptionTests;
    }, function($__m) {
    ...
    execute: function() {
      excelColumnWidthFromGrid500Pixels = 71.42;
      excelColumnWidthFromColumn100Pixels = 14.28;
      excelColumnWidthFromColumn150Pixels = 21.42;
      excelColumnWidthFromColumn200Pixels = 28.57;
      excelColumnWidthFromColumn250Pixels = 35.71;
      excelColumnWidthFromColumn300Pixels = 42.85;
      alignLeftTopWrap = {
        horizontal: 'left',
        vertical: 'top',
        wrapText: true
      ...
      moduleConfig = {
        beforeEach: function() {
          ...
          this.stub = sinon.stub(errors, 'log', function() {
      ...
      [true, false].forEach(function(autoFilterEnabled) {
        QUnit.module(("Scenarios, autoFilterEnabled: " + autoFilterEnabled), moduleConfig, function() {
          var topLeft = {
            row: 2,
            column: 3
          };
          var getOptions = function(context, dataGrid, expectedCustomizeCellArgs, options) {
            var $__4,
                $__5,
                $__6,
                $__7;
            var $__3 = options || {},
                ...
                topLeftCell = ($__6 = $__3.topLeftCell) === void 0 ? topLeft : $__6,
                loadPanel = ($__7 = $__3.loadPanel) === void 0 ? {enabled: false} : $__7;
            var result = {
              component: dataGrid,
              worksheet: context.worksheet,
              topLeftCell: topLeftCell,
              loadPanel: loadPanel,
              customizeCell: function(eventArgs) {
          ...
          QUnit.test('Empty grid', function(assert) {
            ...
            var expectedCells = [];
            exportDataGrid(getOptions(this, dataGrid, expectedCells)).then(function(cellRange) {
              helper.checkRowAndColumnCount({
                row: 0,
                column: 0
              }, {
                row: 0,
          ...
          QUnit.test('Header - 1 column', function(assert) {
            ...
            var expectedCells = [[{
              excelCell: {
                value: 'f1',
                alignment: alignCenterTopNoWrap,
                font: {bold: true}
              },
              gridCell: {
                rowType: 'header',
            ...
            exportDataGrid(getOptions(this, dataGrid, expectedCells)).then(function(cellRange) {
              ...
              helper.checkAutoFilter(autoFilterEnabled, {
                from: topLeft,
                to: topLeft
              }, {
                state: 'frozen',
          ...
          QUnit.test('Header - 2 dataGrid X 1 column, autoFilter', function(assert) {
            var $__2 = this;
            var done = assert.async();
            var dataGrid = $('#dataGrid').dxDataGrid({columns: [{caption: 'f1'}]}).dxDataGrid('instance');
            var expectedCells = [[{
              excelCell: {value: 'f1'},
              gridCell: {
                rowType: 'header',
            ...
            exportDataGrid(getOptions(this, dataGrid, expectedCells)).then(function(cellRange) {
              ...
              $__2.customizeCellCallCount = 0;
              var newTopLeft = {
                row: topLeft.row + 3,
                column: topLeft.column + 3
              };
              helper._extendExpectedCells(expectedCells, newTopLeft);
              exportDataGrid(getOptions($__2, dataGrid, expectedCells, {topLeftCell: newTopLeft})).then(function(cellRange) {
                helper.checkRowAndColumnCount({
                  row: 2,
                  column: 2
                }, {
          ...
          QUnit.test('Header - 1 column, column.visible: false', function(assert) {
            var done = assert.async();
            var dataGrid = $('#dataGrid').dxDataGrid({columns: [{
                caption: 'f1',
                visible: false
              }]}).dxDataGrid('instance');
            var expectedCells = [];
          ...
          QUnit.test('Header - 1 column, default alignment', function(assert) {
            ...
            helper._extendExpectedCells(expectedCells, topLeft);
            exportDataGrid(getOptions(this, dataGrid, expectedCells)).then(function() {
              helper.checkCellStyle(expectedCells);
              done();
            });
          });
          ...
          QUnit.test('Header - 2 column', function(assert) {
            ...
            helper._extendExpectedCells(expectedCells, topLeft);
            exportDataGrid(getOptions(this, dataGrid, expectedCells, {keepColumnWidths: true})).then(function(cellRange) {
              helper.checkRowAndColumnCount({
                row: 1,
                column: 2
              }, {
          ...
          QUnit.test('Header - 2 column, column.width: XXXpx', function(assert) {
            ...
            exportDataGrid(getOptions(this, dataGrid, null, true)).then(function() {
              helper.checkColumnWidths([excelColumnWidthFromColumn200Pixels, excelColumnWidthFromColumn300Pixels, undefined], topLeft.column);
              done();
            });
          });
          ...
          QUnit.test('Header - 2 column, keepColumnWidths: false', function(assert) {
            ...
            exportDataGrid(getOptions(this, dataGrid, null, {keepColumnWidths: false})).then(function() {
          ...
          QUnit.test('Data - 2 dataGrid X 2 column & 2 rows', function(assert) {
            ...
            exportDataGrid(getOptions(this, dataGrid, expectedCells)).then(function(cellRange) {
              ...
              exportDataGrid(getOptions($__2, dataGrid, expectedCells, {topLeftCell: newTopLeft})).then(function(cellRange) {
                ...
                helper.checkValues(expectedCells);
                helper.checkMergeCells(expectedCells, newTopLeft);
                assert.strictEqual($__2.worksheet.getRow(newTopLeft).outlineLevel, 0, ("worksheet.getRow(" + newTopLeft + ").outlineLevel"));
                assert.strictEqual($__2.worksheet.getRow(newTopLeft + 1).outlineLevel, 0, ("worksheet.getRow(" + (newTopLeft + 1) + ").outlineLevel"));
                helper.checkCellRange(cellRange, {
                  row: 2,
                  column: 2
                }, newTopLeft);
          ...
          QUnit.test('Data - 2 column & 2 rows, grid.dataRowTemplate: () => {}', function(assert) {
            ...
            var dataGrid = $('#dataGrid').dxDataGrid({
              dataSource: ds,
              dataRowTemplate: function(container) {
                $(container).append('<tr><td>row</td><td>template</td></tr>');
              },
              loadingTimeout: null
            }).dxDataGrid('instance');
            var expectedCells = [[{
          ...
          QUnit.test('Data - 2 column & 2 rows, clearing predefined font settings', function(assert) {
            ...
            exportDataGrid({
              ...
              assert.deepEqual($__2.worksheet.getCell(topLeft.row, topLeft.column).font, undefined, ("this.worksheet.getCell(" + topLeft.row + ", " + topLeft.column + ").font"));
              assert.deepEqual($__2.worksheet.getCell(topLeft.row, topLeft.column + 1).font, undefined, ("this.worksheet.getCell(" + topLeft.row + ", " + (topLeft.column + 1) + ").font"));
              assert.deepEqual($__2.worksheet.getCell(topLeft.row + 1, topLeft.column).font, {bold: true}, ("this.worksheet.getCell(" + (topLeft.row + 1) + ", " + topLeft.column + ").font"));
              assert.deepEqual($__2.worksheet.getCell(topLeft.row + 1, topLeft.column + 1).font, {bold: true}, ("this.worksheet.getCell(" + (topLeft.row + 1) + ", " + (topLeft.column + 1) + ").font"));
              done();
            });
          });
          QUnit.test('Data - 2 column & 2 rows, wordWrapEnabled = true, col_2.alignment: \'right\'', function(assert) {
            ...
            exportDataGrid({
              ...
              assert.deepEqual($__2.worksheet.getCell(topLeft.row, topLeft.column).alignment, alignCenterTopWrap, ("this.worksheet.getCell(" + topLeft.row + ", " + topLeft.column + ").alignment"));
              assert.deepEqual($__2.worksheet.getCell(topLeft.row, topLeft.column + 1).alignment, alignCenterTopWrap, ("this.worksheet.getCell(" + topLeft.row + ", " + (topLeft.column + 1) + ").alignment"));
              assert.deepEqual($__2.worksheet.getCell(topLeft.row + 1, topLeft.column).alignment, alignLeftTopWrap, ("this.worksheet.getCell(" + (topLeft.row + 1) + ", " + topLeft.column + ").alignment"));
              assert.deepEqual($__2.worksheet.getCell(topLeft.row + 1, topLeft.column + 1).alignment, alignRightTopWrap, ("this.worksheet.getCell(" + (topLeft.row + 1) + ", " + (topLeft.column + 1) + ").alignment"));
              done();
            });
          });
          QUnit.test('Data - 2 column & 2 rows, grid.wordWrapEnabled = true, clearing predefined alignment settings', function(assert) {
            ...
            exportDataGrid({
              ...
              assert.deepEqual($__2.worksheet.getCell(topLeft.row, topLeft.column).alignment, undefined, ("this.worksheet.getCell(" + topLeft.row + ", " + topLeft.column + ").alignment"));
              assert.deepEqual($__2.worksheet.getCell(topLeft.row, topLeft.column + 1).alignment, undefined, ("this.worksheet.getCell(" + topLeft.row + ", " + (topLeft.column + 1) + ").alignment"));
              assert.deepEqual($__2.worksheet.getCell(topLeft.row + 1, topLeft.column).alignment, alignment, ("this.worksheet.getCell(" + (topLeft.row + 1) + ", " + topLeft.column + ").alignment"));
              assert.deepEqual($__2.worksheet.getCell(topLeft.row + 1, topLeft.column + 1).alignment, alignment, ("this.worksheet.getCell(" + (topLeft.row + 1) + ", " + (topLeft.column + 1) + ").alignment"));
              done();
            });
          });
          ...
          QUnit.test('Data - columns.dataType: string, col_1.customizeText: (cell) => \'custom\'', function(assert) {
            ...
            exportDataGrid(getOptions(this, dataGrid, expectedCells)).then(function() {
              helper.checkValues(expectedCells);
              helper.checkMergeCells(expectedCells, topLeft);
              assert.equal($traceurRuntime.typeof($__2.worksheet.getCell(topLeft.row, topLeft.column).value), 'string', ("this.worksheet.getCell(" + (topLeft.row + 1) + ", " + topLeft.column + ").value"));
              done();
            });
          });
          QUnit.test('Data - columns.dataType: string, grid.wordWrapEnabled: true', function(assert) {
            ...
            helper._extendExpectedCells(expectedCells, topLeft);
            exportDataGrid(getOptions(this, dataGrid, expectedCells, {keepColumnWidths: false})).then(function(cellRange) {
              helper.checkCellStyle(expectedCells);
              helper.checkValues(expectedCells);
              helper.checkMergeCells(expectedCells, topLeft);
              done();
          ...
          QUnit.test('Data - columns.dataType: string, selectedRowKeys: [ds[1]]', function(assert) {
            ...
            helper._extendExpectedCells(expectedCells, topLeft);
            exportDataGrid(getOptions(this, dataGrid, expectedCells, {
          ...
          QUnit.test('Data - columns.dataType: string, unbound, selectedRowKeys: [ds[0]]', function(assert) {
            ...
            helper._extendExpectedCells(expectedCells, topLeft);
            exportDataGrid(getOptions(this, dataGrid, expectedCells, {selectedRowsOnly: true})).then(function(cellRange) {
              helper.checkRowAndColumnCount({
                row: 1,
                column: 2
              }, {
          ...
          QUnit.test('Data - columns.dataType: string, unbound, selectedRowKeys: [ds[0]], dataField property does not exist in dataSource', function(assert) {
            ...
            var dataGrid = $('#dataGrid').dxDataGrid({
              columns: [{
                ...
                dataField: 'fieldNotExist',
                calculateCellValue: function(rowData) {
                  return rowData.field1 + '_notExists';
                }
              }],
              dataSource: ds,
              loadingTimeout: null,
          ...
          QUnit.test('Data - columns.dataType: number, grid.wordWrapEnabled: false', function(assert) {
            ...
            exportDataGrid(getOptions(this, dataGrid, expectedCells, {keepColumnWidths: false})).then(function(cellRange) {
              ...
              helper.checkValues(expectedCells);
              helper.checkMergeCells(expectedCells, topLeft);
              assert.equal($traceurRuntime.typeof($__2.worksheet.getCell(topLeft.row + 1, topLeft.column).value), 'number', ("this.worksheet.getCell(" + (topLeft.row + 1) + ", " + topLeft.column + ").value"));
              helper.checkOutlineLevel([0, 0], topLeft.row);
              helper.checkCellRange(cellRange, {
                row: 2,
                column: 1
          ...
          QUnit.test('Data - columns.dataType: number, col_1.customizeText: (cell) => \'custom\'', function(assert) {
            ...
            helper._extendExpectedCells(expectedCells, topLeft);
            exportDataGrid(getOptions(this, dataGrid, expectedCells, {keepColumnWidths: false})).then(function() {
              helper.checkValues(expectedCells);
              helper.checkMergeCells(expectedCells, topLeft);
              assert.equal($traceurRuntime.typeof($__2.worksheet.getCell(topLeft.row, topLeft.column).value), 'string', ("this.worksheet.getCell(" + (topLeft.row + 1) + ", " + topLeft.column + ").value"));
              done();
          ...
          QUnit.test('Data - columns.dataType: number, unbound', function(assert) {
            ...
            exportDataGrid(getOptions(this, dataGrid, expectedCells)).then(function(cellRange) {
              ...
              var expectedCellTypes = ['string', 'object', 'number', 'number', 'number', 'string', 'string', 'object'];
              expectedCells.forEach(function(_, index) {
                assert.equal($traceurRuntime.typeof($__2.worksheet.getCell(topLeft.row, topLeft.column + index).value), expectedCellTypes[index], ("type of this.worksheet.getCell(" + topLeft.row + ", " + (topLeft.column + index) + ").value"));
              });
              done();
            });
          });
          ...
          QUnit.test('Data - columns.dataType: boolean, col_1.customizeText: (cell) => \'custom\'', function(assert) {
            ...
            exportDataGrid(getOptions(this, dataGrid, expectedCells)).then(function() {
              helper.checkValues(expectedCells);
              helper.checkMergeCells(expectedCells, topLeft);
              assert.equal($traceurRuntime.typeof($__2.worksheet.getCell(topLeft.row, topLeft.column).value), 'string', ("typeof this.worksheet.getCell(" + (topLeft.row + 1) + ", " + topLeft.column + ").value"));
              done();
            });
          });
          QUnit.test('Data - columns.dataType: date', function(assert) {
            var done = assert.async();
            var date = new Date(2019, 3, 12);
            var expectedExcelDateValue = new Date(Date.UTC(date.getFullYear(), date.getMonth(), date.getDate()));
            var ds = [{
              f1: undefined,
              f2: null,
              f3: date,
          ...
          [{
            ...
            format: 'month',
            expectedFormat: '[$-9]MMMM'
          }, {
            format: 'year',
            expectedFormat: '[$-9]yyyy'
          }, {
            format: 'quarter',
            expectedFormat: '[$-9]\\QM'
          }, {
            format: 'monthAndDay',
            expectedFormat: '[$-9]MMMM d'
          }, {
            format: 'monthAndYear',
            expectedFormat: '[$-9]MMMM yyyy'
          }, {
            format: 'quarterAndYear',
            expectedFormat: '[$-9]\\QM yyyy'
          }, {
            format: 'shortDate',
            expectedFormat: '[$-9]M\\/d\\/yyyy'
          }, {
            format: 'shortTime',
            expectedFormat: '[$-9]H:mm AM/PM'
          }, {
            format: 'longDateLongTime',
            expectedFormat: '[$-9]dddd, MMMM d, yyyy, H:mm:ss AM/PM'
          }, {
            format: 'shortDateShortTime',
            expectedFormat: '[$-9]M\\/d\\/yyyy, H:mm AM/PM'
          }, {
            format: 'longDate',
            expectedFormat: '[$-9]dddd, MMMM d, yyyy'
          }, {
            format: 'longTime',
            expectedFormat: '[$-9]H:mm:ss AM/PM'
          }, {
            format: 'dayOfWeek',
            expectedFormat: '[$-9]dddd'
          }, {
            format: 'yyyy-MM-dd',
            expectedFormat: '[$-9]yyyy-MM-dd'
          }].forEach(function(format) {
            var dateValue = new Date(2019, 9, 9, 9, 9, 9, 9);
            [{
              value: dateValue,
              expectedGridCellValue: dateValue,
              expectedExcelCellValue: new Date(Date.UTC(2019, 9, 9, 9, 9, 9, 9))
            }, {
              value: '2002-04-01T00:00:00',
              expectedGridCellValue: new Date(2002, 3, 1),
              expectedExcelCellValue: new Date(Date.UTC(2002, 3, 1))
            }, {
              value: '2019/10/9',
              expectedGridCellValue: new Date(2019, 9, 9),
              expectedExcelCellValue: new Date(Date.UTC(2019, 9, 9))
            }, {
              ...
              QUnit.test(("Data - columns.dataType: date, columns.format: " + format.format + ", cell.value: " + JSON.stringify(date.value)), function(assert) {
                ...
                var expectedCells = [[{
                  excelCell: {
                    value: date.expectedExcelCellValue,
                    type: ExcelJS.ValueType.Date,
                    dataType: 'object',
                    numFmt: format.expectedFormat,
                    alignment: alignLeftTopNoWrap
                  },
                  gridCell: {
                    value: date.expectedGridCellValue,
                    rowType: 'data',
                    data: ds[0],
                    column: dataGrid.columnOption(0)
                  }
          ...
          QUnit.test('Data - columns.dataType: datetime', function(assert) {
            var done = assert.async();
            var dateTime = new Date(2019, 3, 12, 12, 15);
            var expectedExcelDateValue = new Date(Date.UTC(2019, 3, 12, 12, 15));
            var ds = [{
              f1: undefined,
              f2: null,
              f3: dateTime,
          ...
          QUnit.test('Data - columns.dataType: date & dateTime, col_1.customizeText: (cell) => \'custom date\': (cell) => \'custom datetime\'', function(assert) {
            ...
            var expectedCells = [[{
              ...
              excelCell: {value: 'custom datetime'},
              gridCell: {
                value: ds[0].f2,
                rowType: 'data',
                data: ds[0],
            ...
            exportDataGrid(getOptions(this, dataGrid, expectedCells)).then(function() {
              ...
              helper.checkMergeCells(expectedCells, topLeft);
              assert.equal($traceurRuntime.typeof($__2.worksheet.getCell(topLeft.row, topLeft.column).value), 'string', ("typeof this.worksheet.getCell(" + (topLeft.row + 1) + ", " + topLeft.column + ").value"));
              assert.equal($traceurRuntime.typeof($__2.worksheet.getCell(topLeft.row, topLeft.column + 1).value), 'string', ("typeof this.worksheet.getCell(" + (topLeft.row + 1) + ", " + topLeft.column + ").value"));
              done();
            });
          });
          QUnit.test('Data - columns.dataType: object', function(assert) {
            var done = assert.async();
            var ds = [{f1: {value: 'f1_1'}}];
            var dataGrid = $('#dataGrid').dxDataGrid({
              columns: [{
                dataField: 'f1',
                dataType: 'object'
          ...
          QUnit.test('Data - columns.dataType: [string, number, date, boolean, lookup, datetime]', function(assert) {
            var done = assert.async();
            var date = new Date(2019, 3, 12);
            var dateTime = new Date(2019, 3, 12, 16, 10);
            var expectedExcelDateValue = new Date(Date.UTC(2019, 3, 12));
            var expectedExcelDateTimeValue = new Date(Date.UTC(2019, 3, 12, 16, 10));
            var ds = [{
              f1: 'str1',
              f2: 1,
              f3: date,
            ...
            var expectedCells = [[{
              ...
              excelCell: {
                value: expectedExcelDateTimeValue,
                type: ExcelJS.ValueType.Date,
                dataType: 'object',
                numFmt: '[$-9]M\\/d\\/yyyy, H:mm AM/PM',
                alignment: alignLeftTopNoWrap
          ...
          [true, false].forEach(function(masterDetailEnabled) {
            ...
            QUnit.test(("Grouping - 1 level - 1 summary group node, group.customizeText: (cell) => 'custom', masterDetail.enabled: " + masterDetailEnabled), function(assert) {
              ...
              var expectedCells = [[{
                excelCell: {value: 'f1: f1_1 (custom)'},
                gridCell: {
                  rowType: 'group',
                  groupIndex: 0,
                  column: dataGrid.columnOption(0),
                ...
                excelCell: {value: 'f1: f1_2 (custom)'},
                gridCell: {
                  rowType: 'group',
                  groupIndex: 0,
                  column: dataGrid.columnOption(0),
            ...
            QUnit.test(("Grouping - 1 level & 2 column, 1 summary showInGroupFooter, 1 summary alignByColumn, selectedRowKeys: [ds[1]], masterDetail.enabled: " + masterDetailEnabled), function(assert) {
              ...
              var expectedCells = [[{
                ...
                gridCell: {
                  ...
                  column: dataGrid.columnOption(2),
                  value: 1,
                  totalSummaryItemName: 'GroupItems 1'
                }
              }]];
              helper._extendExpectedCells(expectedCells, topLeft);
              exportDataGrid(getOptions(this, dataGrid, expectedCells, {selectedRowsOnly: true})).then(function(cellRange) {
            ...
            QUnit.test(("Grouping - 2 level - 2 summary group node, masterDetail.enabled: " + masterDetailEnabled), function(assert) {
              ...
              var expectedCells = [[{
                excelCell: {
                  value: 'f1: f1_1 (Max of f3 is f3_2, Count: 2)',
                  alignment: alignLeftTopNoWrap,
                  font: {bold: true}
                },
                gridCell: {
                ...
                excelCell: {
                  value: 'f2: f1_2 (Max of f3 is f3_1, Count: 1)',
                  alignment: alignLeftTopNoWrap,
                  font: {bold: true}
                },
                gridCell: {
                ...
                excelCell: {
                  value: 'f2: f2_2 (Max of f3 is f3_2, Count: 1)',
                  alignment: alignLeftTopNoWrap,
                  font: {bold: true}
                },
                gridCell: {
            ...
            QUnit.test(("Grouping - 2 level & 2 column - 2 summary alignByColumn: false, masterDetail.enabled: " + masterDetailEnabled), function(assert) {
              ...
              var expectedCells = [[{
                excelCell: {
                  value: 'f1: f1_1 (Max of f4 is f4_2, Count: 2, Max of f5 is f5_2, Count: 2)',
                  alignment: alignLeftTopNoWrap,
                  font: {bold: true}
                },
                gridCell: {
                ...
                excelCell: {
                  value: 'f2: f1_2 (Max of f4 is f4_1, Count: 1, Max of f5 is f5_1, Count: 1)',
                  alignment: alignLeftTopNoWrap,
                  font: {bold: true}
                },
                gridCell: {
                ...
                excelCell: {
                  value: 'f2: f2_2 (Max of f4 is f4_2, Count: 1, Max of f5 is f5_2, Count: 1)',
                  alignment: alignLeftTopNoWrap,
                  font: {bold: true}
                },
                gridCell: {
          ...
          ['standart', 'virtual'].forEach(function(columnRenderingMode) {
            QUnit.test(("Total summary - 50 columns & scrolling: { columnRenderingMode: " + columnRenderingMode + " }"), function(assert) {
              ...
              var dataGrid = $('#dataGrid').dxDataGrid({
                ...
                scrolling: {columnRenderingMode: columnRenderingMode},
                loadingTimeout: null,
                showColumnHeaders: false
              }).dxDataGrid('instance');
              for (var i$__8 = 1; i$__8 < 50; i$__8++) {
                expectedDataCells.push({
                  ...
                  gridCell: {
                    rowType: 'data',
                    data: ds[0],
                    column: dataGrid.columnOption(i$__8 - 1)
                  }
                });
              ...
              var expectedCells = [expectedDataCells, expectedTotalCells];
              helper._extendExpectedCells(expectedCells, topLeft);
              exportDataGrid(getOptions(this, dataGrid, expectedCells)).then(function(cellRange) {
                helper.checkRowAndColumnCount({
                  row: 2,
      ...
      QUnit.module('OutlineLevel', moduleConfig, function() {
          ...
          exportDataGrid({
            ...
            customizeCell: function($__3) {
              var $__4 = $__3,
                  excelCell = $__4.excelCell,
                  gridCell = $__4.gridCell;
              assert.strictEqual($__2.worksheet.getRow(excelCell.fullAddress.row).outlineLevel, gridCell.rowType === 'group' ? 0 : 1, 'row.outlinelevel');
            }
          }).then(function() {
          ...
          exportDataGrid({
            ...
            customizeCell: function($__3) {
              var $__4 = $__3,
                  excelCell = $__4.excelCell,
                  gridCell = $__4.gridCell;
              $__2.worksheet.getRow(excelCell.fullAddress.row).outlineLevel = gridCell.rowType === 'group' ? 1 : 2;
            }
          }).then(function() {
      ...
      ExcelJSOptionTests.runTests(moduleConfig, exportDataGrid.__internals._getFullOptions, function() {
      ...
      [{enabled: true}, {enabled: false}, {enabled: 'auto'}, {}, null, undefined, false, true].forEach(function(loadPanel) {
        LoadPanelTests.runTests(moduleConfig, exportDataGrid, function(options) {
      ...
      QUnit.module('encodeExecutableContent option', moduleConfig, function() {
        QUnit.test('All executable cell content should be encoded if encodeExecutableContent = true', function(assert) {
          ...
          var dataSource = [{
            ...
            value: '\ttab',
            expected: {excelCell: {value: '"\'	tab"'}}
          }, {
            value: '\rCarriage return',
            expected: {excelCell: {value: '"\'\rCarriage return"'}}
          }, {
            value: '\r=2+3',
            expected: {excelCell: {value: '"\'\r=2+3"'}}
          }, {
          ...
          var expectedCells = dataSource.map(function(cell) {
            return [cell.expected];
          });
          helper._extendExpectedCells(expectedCells, {
            row: 1,
            column: 1
          });
          exportDataGrid({
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/errors","exceljs","./ExcelJSTestHelper.js","excel_exporter","exporter/exceljs/export","./exceljs.format.tests.js","./exceljs.options.tests.js","../commonParts/loadPanel.tests.js","core/utils/type","ui/data_grid","generic_light.css!"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/errors"), require("exceljs"), require("./ExcelJSTestHelper.js"), require("excel_exporter"), require("exporter/exceljs/export"), require("./exceljs.format.tests.js"), require("./exceljs.options.tests.js"), require("../commonParts/loadPanel.tests.js"), require("core/utils/type"), require("ui/data_grid"), require("generic_light.css!"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=exceljs.dataGrid.tests.js.map