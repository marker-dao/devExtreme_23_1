...
(["testing/tests/DevExpress.viz.renderers/Animation.tests.js"], ["jquery","animation/frame","core/utils/common","core/utils/type","viz/core/renderers/animation","viz/core/renderers/renderer","../../helpers/vizMocks.js"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.renderers/Animation.tests.js', ['jquery', 'animation/frame', 'core/utils/common', 'core/utils/type', 'viz/core/renderers/animation', 'viz/core/renderers/renderer', '../../helpers/vizMocks.js'], true, function ($__require, exports, module) {
    ...
    const animationModule = $__require('viz/core/renderers/animation');
    ...
    (function () {
        ...
        QUnit.test('Synchronize animation', function (assert) {
            ...
            animation._calcProgress = function (now) {
                synchronizeTimeValue = now;return 1;
            };
            animation.tick();
            // Act
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","animation/frame","core/utils/common","core/utils/type","viz/core/renderers/animation","viz/core/renderers/renderer","../../helpers/vizMocks.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("animation/frame"), require("core/utils/common"), require("core/utils/type"), require("viz/core/renderers/animation"), require("viz/core/renderers/renderer"), require("../../helpers/vizMocks.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=Animation.tests.js.map