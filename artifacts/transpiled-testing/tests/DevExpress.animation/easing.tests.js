...
(["testing/tests/DevExpress.animation/easing.tests.js"], ["animation/easing"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.animation/easing.tests.js', ['animation/easing'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const easing = $__require('animation/easing');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["animation/easing"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("animation/easing"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=easing.tests.js.map