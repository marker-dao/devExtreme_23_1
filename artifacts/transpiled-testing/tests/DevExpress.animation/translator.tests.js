...
(["testing/tests/DevExpress.animation/translator.tests.js"], ["jquery","animation/translator","core/utils/style"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.animation/translator.tests.js', ['jquery', 'animation/translator', 'core/utils/style'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const translator = $__require('animation/translator');
    const styleUtils = $__require('core/utils/style');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","animation/translator","core/utils/style"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("animation/translator"), require("core/utils/style"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=translator.tests.js.map