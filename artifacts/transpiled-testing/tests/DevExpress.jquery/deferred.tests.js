...
(["testing/tests/DevExpress.jquery/deferred.tests.js"], ["jquery","core/utils/deferred","core/config","integration/jquery"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.jquery/deferred.tests.js', ['jquery', 'core/utils/deferred', 'core/config', 'integration/jquery'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const deferredUtils = $__require('core/utils/deferred');
    const useJQuery = $__require('core/config')().useJQuery;
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/deferred","core/config","integration/jquery"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/deferred"), require("core/config"), require("integration/jquery"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=deferred.tests.js.map