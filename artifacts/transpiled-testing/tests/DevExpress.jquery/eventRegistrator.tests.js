...
(["testing/tests/DevExpress.jquery/eventRegistrator.tests.js"], ["jquery","events/core/event_registrator","core/class","integration/jquery"], true, function($__System) {
...
define("testing/tests/DevExpress.jquery/eventRegistrator.tests.js", ["require", "jquery", "events/core/event_registrator", "core/class", "integration/jquery"], function(require) {
  ...
  QUnit.test('\'teardown\' method', function(assert) {
    const data = {};
    const handler = function() {};
    this.element.on('dxtestevent.test1.test2', data, handler).off('dxtestevent.test1.test2');
  ...
  QUnit.test('\'add\' method', function(assert) {
    const data = {};
    const handler = function() {};
    this.element.on('dxtestevent.test1.test2', '.some', data, handler);
  ...
  QUnit.test('\'remove\' method', function(assert) {
    const data = {};
    const handler = function() {};
    this.element.on('dxtestevent.test1.test2', '.some', data, handler).off('dxtestevent.test1.test2', handler);
    const LOG = this.testEventImplementer.LOG.add;
    assert.strictEqual(LOG.context, this.testEventImplementer, 'context');
    assert.equal(LOG.arguments.length, 2, 'arguments count');
    assert.strictEqual(LOG.arguments[0], this.element[0], 'element');
  ...
  QUnit.test('\'trigger\' method', function(assert) {
    ...
    this.element.on('dxtestevent.test1.test2', handler).trigger(event, data);
  ...
  QUnit.test('\'_default\' method', function(assert) {
    ...
    const handler = function() {};
    const event = $.Event('dxtestevent');
    this.element.on('dxtestevent.test1.test2', data, handler).trigger(event, data);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","events/core/event_registrator","core/class","integration/jquery"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("events/core/event_registrator"), require("core/class"), require("integration/jquery"));
  else
