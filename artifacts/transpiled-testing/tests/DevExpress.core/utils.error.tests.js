...
(["testing/tests/DevExpress.core/utils.error.tests.js"], ["core/utils/error","core/utils/console"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.core/utils.error.tests.js', ['core/utils/error', 'core/utils/console'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const errorUtils = $__require('core/utils/error');
    const consoleUtils = $__require('core/utils/console');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/error","core/utils/console"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/error"), require("core/utils/console"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=utils.error.tests.js.map