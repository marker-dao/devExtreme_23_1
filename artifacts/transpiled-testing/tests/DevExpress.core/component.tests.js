...
(["testing/tests/DevExpress.core/component.tests.js"], ["jquery","core/utils/common","core/component","core/postponed_operations","core/errors","core/devices","core/config"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.core/component.tests.js", ["jquery", "core/utils/common", "core/component", "core/postponed_operations", "core/errors", "core/devices", "core/config"], function($__export) {
  "use strict";
  var $,
      noop,
      Component,
  ...
  return {
    setters: [function($__m) {
      ...
      PostponedOperations = $__m.PostponedOperations;
    }, function($__m) {
      errors = $__m.default;
    }, function($__m) {
      devices = $__m.default;
    ...
    execute: function() {
      TestComponent = Component.inherit({
        ...
        _setOptionsByReference: function() {
          this.callBase();
          $.extend(this._optionsByReference, {byReference: true});
        },
        _setDeprecatedOptions: function() {
          ...
          $.extend(this._deprecatedOptions, {
            ...
            deprecatedOption: {
              since: '14.1',
              message: 'Use some other option instead'
            },
            ...
            'thirdLevel.option.deprecated': {
              since: '15.2',
              alias: 'thirdLevel.option.deprecatedAlias'
            },
            'onDeprecatedEvent': {
              since: '20.1',
              message: 'Use another events instead'
            }
          });
        },
        _setOptionAliases: function() {
          this.callBase();
          $.extend(this._getOptionAliases(), {checked: 'value'});
        },
        _getDefaultOptions: function() {
          return $.extend(this.callBase(), {
            ...
            secondLevel: {deprecatedOption: 1},
            thirdLevel: {option: {deprecatedAlias: 'deprecatedValue'}},
            funcOption: function() {
              return this;
            }
          });
        ...
        _optionChanged: function(name, value, prevValue) {
          ...
          ($__8 = this).callBase.apply($__8, $traceurRuntime.spread(arguments));
        },
        _init: function() {
          for (var args = [],
        ...
        _getTraceLogByMethod: function(methodName) {
          return $.grep(this._traceLog, function(i) {
      ...
      TestDeprecatedComponent = function($__super) {
        function TestDeprecatedComponent(options) {
          $traceurRuntime.superConstructor(TestDeprecatedComponent).call(this, options);
          this.NAME = 'TestDeprecatedComponent';
          this._logDeprecatedComponentWarning('20.1', 'TestComponent');
        }
        return ($traceurRuntime.createClass)(TestDeprecatedComponent, {}, {}, $__super);
      }(Component);
      QUnit.module('default', {}, function() {
        ...
        QUnit.test('setOptionSilently method', function(assert) {
          ...
          var log = instance._getTraceLogByMethod('_optionChanged');
        ...
        QUnit.test('setOptionSilently method (nested option)', function(assert) {
          var instance = new TestComponent({opt1: {nested: 1}});
        ...
        QUnit.test('options api - changing inner options', function(assert) {
          var callCount = 0;
          var instance = new TestComponent({onOptionChanged: function() {
              return callCount++;
            }});
          instance._resetTraceLog();
          instance.option({'publicOption': 'a'});
          assert.equal(callCount, 1, 'Public option calls "onOptionChanged"');
          instance.option({'_privateOption': 'a'});
          assert.equal(callCount, 1, 'Inner option doesn\'t calls "onOptionChanged"');
          var methodCallStack = $.map(instance._traceLog, function(i) {
            return i.method;
          });
          assert.deepEqual(methodCallStack, ['beginUpdate', '_optionChanged', 'endUpdate', 'beginUpdate', '_optionChanged', 'endUpdate']);
        });
        ...
        QUnit.test('postponed operations should be called on endUpdate', function(assert) {
          var instance = new TestComponent({a: 1});
          var callPostponed = sinon.stub(instance.postponedOperations, 'callPostponedOperations');
          instance.endUpdate();
        ...
        QUnit.test('component lifecycle, changing a couple of options', function(assert) {
          ...
          var optionChangedArgs = instance._getTraceLogByMethod('_optionChanged');
          assert.deepEqual(methodCallStack, ['beginUpdate', 'beginUpdate', 'endUpdate', 'endUpdate', '_init', 'beginUpdate', '_optionChanging', '_optionChanged', '_optionChanging', '_optionChanged', 'endUpdate', 'beginUpdate', 'endUpdate']);
        ...
        QUnit.test('complex options', function(assert) {
          var component1 = Component.inherit({
            NAME: 'component1',
            _getDefaultOptions: function() {
              return $.extend(this.callBase(), {plain: {a: {b: 'b'}}});
            }
          });
          component1 = new component1({plain: {
              a: {b1: 'b1'},
              a1: 'a1'
            }});
          assert.deepEqual(component1.option('plain'), {
            a: {
              b: 'b',
              b1: 'b1'
            },
        ...
        QUnit.test('option value equality comparison', function(assert) {
          var triggered;
          var instance = new (Component.inherit({NAME: 'temp'}))({onOptionChanged: function() {
              triggered = true;
            }});
        ...
        QUnit.test('option getter by path gets value', function(assert) {
          var instance = new TestComponent({prop: {
              name: 'John',
              items: [1, 2, 3]
            }});
        ...
        QUnit.test('option setter by path triggers option changed callback', function(assert) {
          var instance = new TestComponent({opt3: {subOpt: 'value'}});
        ...
        QUnit.test('option by value', function(assert) {
          ...
          var instance = new TestComponent({byValue: value});
        ...
        QUnit.test('option by reference', function(assert) {
          ...
          var instance = new TestComponent({byReference: value});
        ...
        QUnit.test('set and get option silently', function(assert) {
          var instance = new TestComponent();
          var warningCount = 0;
          var _logDeprecatedWarningMock = function() {
            ++warningCount;
          };
          instance._logDeprecatedOptionWarning = _logDeprecatedWarningMock;
          instance._options.silent({deprecatedOption: true});
        ...
        QUnit.test('reading & writing a deprecated option must invoke the _logDeprecatedOptionWarning method and pass the option name as a parameter', function(assert) {
          var instance = new TestComponent();
          var deprecatedOption = 'deprecatedOption';
          var _logDeprecatedWarningMock = function(option) {
        ...
        QUnit.test('deprecated options api syntactic sugar for options having aliases', function(assert) {
          ...
          try {
            var instance = new TestComponent();
            var option = 'deprecatedOptionWithSugarSyntax';
            var alias = 'deprecatedOptionAliasWithSugarSyntax';
            ...
            assert.deepEqual(log[0], ['W0001', instance.NAME, 'deprecatedOptionWithSugarSyntax', '14.2', 'Use the \'deprecatedOptionAliasWithSugarSyntax\' option instead']);
          } finally {
        ...
        QUnit.test('deprecated options api syntactic sugar for second level options having aliases', function(assert) {
          ...
          try {
            var instance = new TestComponent();
            var option = 'secondLevel.deprecatedOption';
            var alias = 'secondLevel.deprecatedOptionAlias';
            instance.option({secondLevel: {deprecatedOption: 'test'}});
            ...
            assert.deepEqual(log[0], ['W0001', instance.NAME, 'secondLevel.deprecatedOption', '14.2', 'Use the \'secondLevel.deprecatedOptionAlias\' option instead']);
          } finally {
            errors.log = originalLog;
          }
        });
        QUnit.test('changing a nested options triggers only top level name option change handler', function(assert) {
          var instance = new TestComponent({firstLevel: {secondLevel: [0, 1, 2]}});
          instance.option('firstLevel.secondLevel[0]', 10);
          assert.deepEqual(instance._getTraceLogByMethod('_optionChanged')[0].arguments, [{
            name: 'firstLevel',
          ...
          assert.deepEqual(instance._getTraceLogByMethod('_optionChanged')[1].arguments, [{
            name: 'firstLevel',
            fullName: 'firstLevel.secondLevel',
            value: [123, 321],
            previousValue: [10, 1, 2]
          }]);
          instance.option('firstLevel', {secondLevel: 1});
          assert.deepEqual(instance._getTraceLogByMethod('_optionChanged')[2].arguments, [{
            name: 'firstLevel',
            fullName: 'firstLevel',
            value: {'secondLevel': 1},
            previousValue: {'secondLevel': 1}
          }]);
        });
        var createDeprecatedMessageArray = function(version, instanceName, deprecatedOption, aliasName) {
          return ['W0001', instanceName, deprecatedOption, version, ("Use the '" + aliasName + "' option instead")];
        };
        QUnit.test('T320061 - the third level of nesting option deprecated message on initialize', function(assert) {
          ...
          try {
            ...
            var aliasName = 'thirdLevel.option.deprecatedAlias';
            var optionValue = 'thirdLevelValue';
            var instance = new TestComponent({thirdLevel: {option: {deprecated: optionValue}}});
            ...
            var expectedThirdLevelOptionObject = {option: {deprecatedAlias: optionValue}};
        ...
        QUnit.test('T320061 - third level of nesting option deprecated message on option change using object', function(assert) {
          ...
          try {
            ...
            var optionValue = 'thirdLevelValue';
            var instance = new TestComponent();
            instance.option({thirdLevel: {option: {deprecated: optionValue}}});
            ...
            assert.deepEqual(instance.option().thirdLevel, {option: {deprecatedAlias: optionValue}});
            assert.equal(log.length, 2);
            assert.deepEqual(log[0], createDeprecatedMessageArray('15.2', instance.NAME, optionName, aliasName));
          } finally {
            errors.log = originalLog;
        ...
        QUnit.test('dispose options', function(assert) {
          ...
          var callbacks = ['_deprecatedCallback'];
          var optionManagerCallbacks = ['_changedCallback', '_changingCallback'];
          callbacks.forEach(function(callback) {
            assert.notEqual(component._options[callback], noop);
          });
          optionManagerCallbacks.forEach(function(callback) {
        ...
        QUnit.test('\'onDisposing\' action and event should be fired on component disposing', function(assert) {
          var actionArgs = null;
          var eventArgs = null;
          var component = new TestComponent({onDisposing: function(args) {
              actionArgs = args;
            }});
          ...
          assert.deepEqual(actionArgs, {component: component});
          assert.ok(eventArgs);
          assert.deepEqual(eventArgs, {component: component});
        });
        QUnit.test('\'onDisposing\' changing', function(assert) {
          var called = null;
          var component = new TestComponent({onDisposing: function() {
              called = 'old handler';
            }});
        ...
        QUnit.test('\'onInitialized\' action should be fired on component initialized', function(assert) {
          var actionArgs = null;
          var component = new TestComponent({onInitialized: function(args) {
              actionArgs = args;
            }});
          assert.ok(actionArgs);
          assert.deepEqual(actionArgs, {component: component});
        ...
        QUnit.test('\'hasActionSubscription\' should be true if component has subscribe via option', function(assert) {
          var component = new TestComponent({onInitialized: function() {}});
        ...
        QUnit.test('\'hasActionSubscription\' should not raise deprecation warning for event option', function(assert) {
          var instance = new TestComponent();
          var logDeprecatedWarningSpy = sinon.spy(instance, '_logDeprecatedOptionWarning');
          try {
        ...
        QUnit.test('_optionChanging is called before inner _options object is changed', function(assert) {
          var instance = new TestComponent({option1: 1});
        ...
        QUnit.test('log the deprecate warning for a component', function(assert) {
          ...
          try {
            ...
            assert.deepEqual(logStub.getCall(0).args, ['W0000', 'TestDeprecatedComponent', '20.1', 'Use the \'TestComponent\' widget instead'], 'arguments of log method');
          } finally {
            errors.log = originalLog;
          }
        });
      ...
      QUnit.module('defaultOptions', {
        beforeEach: function() {
          ...
          this.createClass = function(defaultOptionsRules) {
            return Component.inherit({_defaultOptionsRules: function() {
        ...
        QUnit.test('set default option for specific component', function(assert) {
          var TestComponent = this.createClass([{options: {test: 'value'}}]);
        ...
        QUnit.test('set default options for several devices at once', function(assert) {
          var TestComponent = this.createClass([{
            device: [{platform: 'android'}, {platform: 'ios'}],
            options: {test: 'value'}
          }]);
          devices._currentDevice = {platform: 'android'};
        ...
        QUnit.test('default options of child overrides default options of parent', function(assert) {
          var TestComponent = this.createClass([{options: {test: 'parent'}}]);
          var ChildComponent = TestComponent.inherit({_defaultOptionsRules: function() {
              return this.callBase().slice(0).concat([{options: {test: 'child'}}]);
            }});
        ...
        QUnit.test('rules priority', function(assert) {
          ...
          var ChildComponent = TestComponent.inherit({
            _defaultOptions: function() {
              return $.extend(this.callBase(), {test: 'default'});
            },
            _defaultOptionsRules: function() {
              return this.callBase().slice(0).concat([{options: {test: 'byRule'}}]);
            }
          });
        ...
        QUnit.test('initial option test', function(assert) {
          var TestComponent = Component.inherit({_getDefaultOptions: function() {
              return {test: 'parent'};
            }});
          var ChildComponent = TestComponent.inherit({
            _getDefaultOptions: function() {
            ...
            _defaultOptionsRules: function() {
              return this.callBase().slice(0).concat([{options: {anotherTest: 'byRule'}}]);
            }
          });
        ...
        QUnit.test('Checking current option value with initial option value (option value as function)', function(assert) {
          ...
          assert.notOk(new TestComponent({test: function() {
              return 'test2';
        ...
        QUnit.test('Checking current option value with initial option value (option value as object)', function(assert) {
          var TestComponent = Component.inherit({_getDefaultOptions: function() {
              return {test: {prop1: 'test1'}};
            }});
          assert.ok(new TestComponent()._isInitialOptionValue('test'), 'current value equal initial value');
          assert.notOk(new TestComponent({test: {
              prop1: 'test2',
              prop2: 'test3'
            }})._isInitialOptionValue('test'), 'current value not equal initial value');
        });
        QUnit.test('\'defaultOptionRules\' option', function(assert) {
          var TestComponent = Component.inherit({_defaultOptionsRules: function() {
              return this.callBase().slice(0).concat([{options: {
                  a: 1,
                  b: 2
                }}]);
            }});
          var options = new TestComponent({defaultOptionsRules: [{options: {
                a: 2,
                c: 3
              }}]}).option();
        ...
        QUnit.test('reset option', function(assert) {
          ...
          assert.deepEqual(instance.option('opt5.subOpt2'), {value: ''});
      ...
      QUnit.module('event API', {beforeEach: function() {
      ...
      QUnit.module('action API', {}, function() {
        ...
        QUnit.test('action executing should fire event handlers with same arguments and context', function(assert) {
          ...
          var instance = new TestComponent({onTestEvent: function(args) {
        ...
        QUnit.test('action executing should fire event handlers when not exists option and exists subscriptions', function(assert) {
          var eventArguments = null;
          var eventContext = null;
          var instance = new TestComponent({onTestEvent: null});
          var executeAction = instance._createActionByOption('onTestEvent', {testProp1: 'testProp1'});
          instance.on('testEvent', function(args) {
            eventArguments = args;
            eventContext = this;
        ...
        QUnit.test('_createActionByOption should run \'beforeExecute\' before the action handler when event was subscribed with \'on\' method', function(assert) {
          ...
          var executeAction = instance._createActionByOption('onTestEvent', {beforeExecute: function() {
        ...
        QUnit.test('_createActionByOption should not override user \'afterExecute\' option', function(assert) {
          assert.expect(1);
          var instance = new TestComponent({onTestEvent: noop});
          var executeAction = instance._createActionByOption('onTestEvent', {afterExecute: function() {
              assert.ok(true);
            }});
          executeAction({});
        });
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","core/component","core/postponed_operations","core/errors","core/devices","core/config"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("core/component"), require("core/postponed_operations"), require("core/errors"), require("core/devices"), require("core/config"));
  else
