...
(["testing/tests/DevExpress.core/template.tests.js"], ["jquery","core/templates/template_base"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.core/template.tests.js", ["jquery", "core/templates/template_base"], function($__export) {
  "use strict";
  var $,
      TemplateBase,
      templateRendered,
      VISIBILITY_CHANGE_HANDLER_CLASS,
      SHOWN_EVENT_NAME;
  return {
    setters: [function($__m) {
      ...
      templateRendered = $__m.renderedCallbacks;
    }],
    execute: function() {
      ...
      QUnit.test('template should receive dxshown event when attached to container', function(assert) {
        ...
        var templateClass = function($__super) {
          function $__1() {
            $traceurRuntime.superConstructor($__1).apply(this, arguments);
          }
          return ($traceurRuntime.createClass)($__1, {_renderCore: function() {
              return $template;
            }}, {}, $__super);
        }(TemplateBase);
      ...
      QUnit.test('templateRendered callbacks should be fired before template.onRendered', function(assert) {
        ...
        var template = new templateClass();
        var isChildCallbackCalled = false;
      ...
      VISIBILITY_CHANGE_HANDLER_CLASS = 'dx-visibility-change-handler';
      SHOWN_EVENT_NAME = 'dxshown';
      QUnit.test('template should receive dxshown event when attached to container', function(assert) {
        assert.expect(1);
        var $template = $('<div>').addClass(VISIBILITY_CHANGE_HANDLER_CLASS).on(SHOWN_EVENT_NAME, function() {
      ...
      QUnit.test('template should not receive dxshown event if already attached to container', function(assert) {
        ...
        var templateClass = function($__super) {
          ...
          return ($traceurRuntime.createClass)($__1, {_renderCore: function(_, __, $container) {
      ...
      QUnit.test('template should call onRendered method', function(assert) {
        ...
        var TestTemplate = function($__super) {
          function $__1() {
            $traceurRuntime.superConstructor($__1).apply(this, arguments);
          }
          return ($traceurRuntime.createClass)($__1, {_renderCore: function() {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/templates/template_base"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/templates/template_base"));
  else
