...
(["testing/tests/DevExpress.core/utils.common.tests.js"], ["jquery","core/utils/common","core/guid","core/config"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.core/utils.common.tests.js", ["jquery", "core/utils/common", "core/guid", "core/config"], function($__export) {
  "use strict";
  var $,
      executeAsync,
      findBestMatches,
  ...
  return {
    setters: [function($__m) {
      ...
      executeAsync = $__m.executeAsync;
      findBestMatches = $__m.findBestMatches;
      deferRender = $__m.deferRender;
      deferUpdate = $__m.deferUpdate;
      deferUpdater = $__m.deferUpdater;
      deferRenderer = $__m.deferRenderer;
      applyServerDecimalSeparator = $__m.applyServerDecimalSeparator;
      grep = $__m.grep;
      getKeyHash = $__m.getKeyHash;
      equalByValue = $__m.equalByValue;
      splitPair = $__m.splitPair;
      pairToObject = $__m.pairToObject;
    }, function($__m) {
      Guid = $__m.default;
    }, function($__m) {
      config = $__m.default;
    ...
    execute: function() {
      ...
      module('findBestMatches', function() {
        test('basic', function(assert) {
          ...
          var filteredItems = findBestMatches(filter, items);
        ...
        test('filtering items by array fields', function(assert) {
          var items = [{a: 1}, {a: [1]}, {a: [1, 2]}, {a: [1, 0, 2]}, {
            a: [1, 2, 3],
            b: 1
          }];
          var filter;
      ...
      module('defer render/update', {
        ...
        test('Return deferred in deferRender and using deferUpdater', function(assert) {
          ...
          deferRender(function() {
            var d = $.Deferred();
            logs.push('render');
            setTimeout(deferUpdater(function() {
              logs.push('update');
              d.resolve();
            }), 1000);
            return d;
        ...
        test('Return deferred in deferUpdate and using deferRenderer', function(assert) {
          ...
          deferUpdate(function() {
            var d = $.Deferred();
            logs.push('update');
            setTimeout(deferRenderer(function() {
              logs.push('render');
              d.resolve();
            }), 1000);
            return d;
      ...
      module('applyServerDecimalSeparator', function() {
      ...
      module('grep', function() {
        test('basic', function(assert) {
          var array = [6, 3, 8, 2, 5];
          var object = {};
          var filterNumbers = function(number) {
            return number > 5;
          };
          for (var i = 0; i < array.length; i++) {
            object[i] = array[i];
      ...
      module('getKeyHash', function() {
        ...
        TEST_VALUES.forEach(function($__3) {
          var $__4 = $__3,
              value = $__4.value,
              result = $__4.result;
          test(("getKeyHash from the " + (typeof value === 'undefined' ? 'undefined' : $traceurRuntime.typeof(value)) + " value"), function(assert) {
            assert.strictEqual(getKeyHash(value), result, 'Correct hash');
          });
        });
      });
      module('splitPair', function() {
        var TEST_DATA = [{
          value: '',
          result: ['']
        }, {
        ...
        TEST_DATA.forEach(function($__3) {
          var $__4 = $__3,
              value = $__4.value,
              result = $__4.result;
      ...
      module('pairToObject', function() {
        ...
        [false, true].forEach(function(preventRound) {
          TEST_DATA.forEach(function($__3) {
            var $__4 = $__3,
                value = $__4.value,
                result = $__4.result,
                integerResult = $__4.integerResult;
            test(("call \"pairToObject\" function with " + JSON.stringify(value) + " value and preventRound=\"" + preventRound + "\""), function(assert) {
              var expectedResult = !preventRound && integerResult ? integerResult : result;
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","core/guid","core/config"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("core/guid"), require("core/config"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=utils.common.tests.js.map