...
(["testing/tests/DevExpress.core/utils.queue.tests.js"], ["jquery","core/utils/queue"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.core/utils.queue.tests.js', ['jquery', 'core/utils/queue'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const queueUtils = $__require('core/utils/queue');
    ...
    QUnit.test('discardPendingTasks = true', function (assert) {
        ...
        const removeTaskCallback = function (task) {
            log.push(task);
        };
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/queue"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/queue"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=utils.queue.tests.js.map