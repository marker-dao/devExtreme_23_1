...
(["testing/tests/DevExpress.core/utils.dependencyInjector.tests.js"], ["core/utils/dependency_injector"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.core/utils.dependencyInjector.tests.js', ['core/utils/dependency_injector'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const dependencyInjector = $__require('core/utils/dependency_injector');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/dependency_injector"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/dependency_injector"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=utils.dependencyInjector.tests.js.map