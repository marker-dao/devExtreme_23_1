...
(["testing/tests/DevExpress.core/utils.animationFrame.tests.js"], ["jquery","animation/frame"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.core/utils.animationFrame.tests.js', ['jquery', 'animation/frame'], true, function ($__require, exports, module) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","animation/frame"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("animation/frame"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=utils.animationFrame.tests.js.map