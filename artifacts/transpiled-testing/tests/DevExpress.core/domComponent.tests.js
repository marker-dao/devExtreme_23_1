...
(["testing/tests/DevExpress.core/domComponent.tests.js"], ["core/component_registrator","core/config","core/devices","core/dom_component","core/element_data","core/template_manager","core/utils/common","core/utils/public_component","core/utils/resize_callbacks","events/core/events_engine","events/visibility_change","jquery"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.core/domComponent.tests.js", ["core/component_registrator", "core/config", "core/devices", "core/dom_component", "core/element_data", "core/template_manager", "core/utils/common", "core/utils/public_component", "core/utils/resize_callbacks", "events/core/events_engine", "events/visibility_change", "jquery"], function($__export) {
  "use strict";
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module('default', {
        beforeEach: function() {
          this.TestComponentWithTemplate = DOMComponent.inherit({_initTemplates: function() {
              this.callBase();
              this._templateManager.addDefaultTemplates({content: {render: function() {
          ...
          this.TestComponent = DOMComponent.inherit({
            ...
            _optionChanged: function(name, value, prevValue) {
              ...
              ($__13 = this).callBase.apply($__13, $traceurRuntime.spread(arguments));
            },
            _refresh: function() {
              var $__13;
              for (var args = [],
              ...
              ($__13 = this).callBase.apply($__13, $traceurRuntime.spread(args));
            },
            _init: function() {
              for (var args = [],
        ...
        QUnit.test('component lifecycle, changing a couple of options', function(assert) {
          var TestComponent = this.TestComponent.inherit({_optionChanged: function(args) {
              this.callBase(args);
          ...
          assert.deepEqual(methodCallStack, ['beginUpdate', 'beginUpdate', 'endUpdate', 'endUpdate', '_init', '_render', 'beginUpdate', '_optionChanged', '_invalidate', '_optionChanged', '_invalidate', 'endUpdate', '_refresh', '_clean', '_render', 'beginUpdate', 'endUpdate']);
        ...
        QUnit.test('\'option\' method invoking directly and by jQuery plugin syntax should works consistently with undefined value', function(assert) {
          ...
          var instance = new this.TestComponent($element, {optionWithUndefinedValue: undefined});
        ...
        QUnit.test('mass method invoking should call method for each component (setter case)', function(assert) {
          ...
          var $secondElement = $('#anotherComponent');
          var $elements = $($firstElement).add($secondElement);
          registerComponent('TestComponent', this.TestComponent.inherit({setterReturningThis: function() {
              this._setterReturningThisCalled = true;
              return this;
            }}));
          var firstInstance = $firstElement.TestComponent().TestComponent('instance');
          var secondInstance = $secondElement.TestComponent().TestComponent('instance');
        ...
        QUnit.test('mass method invoking should return first instance method result', function(assert) {
          ...
          var result = $elements.TestComponent('setterReturningThis');
        ...
        QUnit.test('jQuery instances should be compared by DOM elements set (not by reference)', function(assert) {
          var $element = $('<div>');
          var instance = $('#component').TestComponent({opt1: $element}).TestComponent('instance');
        ...
        QUnit.test('\'disabled\' option is passed to createComponent', function(assert) {
          var $firstElement = $('#component');
          var $secondElement = $('#anotherComponent');
          registerComponent('TestComponent', this.TestComponent.inherit({createComponent: function(element, name, config) {
          ...
          var secondInstance = firstInstance.createComponent($secondElement, 'TestComponent', {});
        ...
        QUnit.test('custom template should not be taken from integrationOptions when it is skipped', function(assert) {
          var instance = new DOMComponent('#component', {
            ...
            integrationOptions: {
              ...
              templates: {customTemplate: {render: function() {
        ...
        QUnit.test('default template should not be taken from integrationOptions when it is skipped', function(assert) {
          var instance = new this.TestComponentWithTemplate('#component', {integrationOptions: {
              skipTemplates: ['content'],
              templates: {content: {render: function() {
                    return 'Integration content';
                  }}}
            }});
          var template = instance._getTemplate('content');
        ...
        QUnit.test('component does not use deferUpdate strategy for template rendering', function(assert) {
          var $element = $('#component').TestComponent();
          var instance = $element.TestComponent('instance');
          var useDeferUpdate = instance.option('integrationOptions.useDeferUpdateForTemplates');
        ...
        QUnit.test('use the TemplateManager module for templates', function(assert) {
          ...
          var ComponentWithoutTemplates = DOMComponent.inherit({_useTemplates: function() {
              return false;
            }});
          registerComponent('ComponentWithoutTemplates', nameSpace, ComponentWithoutTemplates);
          var $element2 = $('#component').ComponentWithoutTemplates();
          var instance2 = $element2.ComponentWithoutTemplates('instance');
          assert.ok($traceurRuntime.typeof(instance2._templateManager), 'should not create TemplateManager module instance if template functionality is not set');
        });
        ...
        QUnit.test('customizing default option rules', function(assert) {
          var TestComponent = DOMComponent.inherit({_defaultOptionsRules: function() {
        ...
        QUnit.test('customizing default option rules applies only on the target component class', function(assert) {
          var TestComponent1 = DOMComponent.inherit({_getDefaultOptions: function() {
              return $.extend(this.callBase(), {test: 'Initial value 1'});
            }});
          var TestComponent2 = TestComponent1.inherit({_getDefaultOptions: function() {
              return $.extend(this.callBase(), {test: 'Initial value 2'});
            }});
          ...
          TestComponent1.defaultOptions({
            device: {platform: 'ios'},
            options: {anotherOption: 'Another option value'}
          });
          TestComponent1.defaultOptions({
            device: {platform: 'ios'},
            options: {test: 'Custom value 1'}
          });
          TestComponent2.defaultOptions({
            device: {platform: 'ios'},
            options: {test: 'Custom value 2'}
          });
          devices._currentDevice = {platform: 'ios'};
        ...
        QUnit.test('visibility change handling works with hidden parent', function(assert) {
          ...
          var $component = $('<div>').hide().appendTo($parent);
        ...
        QUnit.test('\'option\' method should work correctly with $.Event instance (T105184)', function(assert) {
          var component = $('#component').TestComponent({position: {
              of: window,
              at: ''
        ...
        QUnit.test('\'elementAttr.class\' option should overwrite previous value', function(assert) {
          ...
          var changeClass = function(newClass) {
            $el.TestComponent({elementAttr: {class: 'init'}}).TestComponent('instance').option('elementAttr', {class: newClass});
        ...
        QUnit.test('changing elementAttr option should not rerender the component', function(assert) {
          var $element = $('#component').TestComponent({elementAttr: {attr1: 'widget 01'}});
          var instance = $element.TestComponent('instance');
          var render = sinon.spy(instance, '_render');
        ...
        QUnit.test('changing class via \'elementAttr\' option should preserve component specific classes', function(assert) {
          var SomeComponent = DOMComponent.inherit({_render: function() {
          ...
          var componentClassNames = $element.attr('class').split(' ');
          var specialClass = 'special-class';
          instance.option('elementAttr', {class: specialClass});
          for (var i = 0,
              n = componentClassNames.length; i < n; i++) {
        ...
        QUnit.test('Dispose: attributes deleted', function(assert) {
          var element = $('#component').TestComponent();
          var instance = element.TestComponent('instance');
          var attributes = ['role', 'aria-multiselectable', 'aria-hidden', 'aria-autocomplete', 'aria-label', 'aria-selected', 'aria-activedescendant', 'aria-checked', 'aria-owns', 'aria-haspopup', 'aria-expanded', 'aria-invalid', 'aria-readonly', 'aria-describedby', 'aria-required', 'aria-sort', 'aria-valuenow', 'aria-valuemin', 'aria-valuemax', 'aria-pressed', 'aria-controls', 'aria-multiline', 'aria-level', 'aria-disabled', 'data-dx-content-placeholder-name', 'style'];
        ...
        QUnit.test('get element', function(assert) {
          var element = $('#component').TestComponent();
          var instance = dataUtils.data(element[0], 'TestComponent');
          if (config().useJQuery) {
        ...
        QUnit.test('reset dimensions with custom default value', function(assert) {
          var TestComponentCustomDefault = DOMComponent.inherit({_getDefaultOptions: function() {
              return $.extend(this.callBase(), {
                width: 20,
                height: 10
              });
          ...
          var $element = $('#component').TestComponentCustomDefault({
            width: 200,
            height: 100
          });
          var element = $element.get(0);
          var instance = $element.TestComponentCustomDefault('instance');
          instance.resetOption('height');
          instance.resetOption('width');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/component_registrator","core/config","core/devices","core/dom_component","core/element_data","core/template_manager","core/utils/common","core/utils/public_component","core/utils/resize_callbacks","events/core/events_engine","events/visibility_change","jquery"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/component_registrator"), require("core/config"), require("core/devices"), require("core/dom_component"), require("core/element_data"), require("core/template_manager"), require("core/utils/common"), require("core/utils/public_component"), require("core/utils/resize_callbacks"), require("events/core/events_engine"), require("events/visibility_change"), require("jquery"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=domComponent.tests.js.map