...
(["testing/tests/DevExpress.core/utils.variableWrapper.tests.js"], ["core/utils/variable_wrapper","core/utils/console"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.core/utils.variableWrapper.tests.js', ['core/utils/variable_wrapper', 'core/utils/console'], true, function ($__require, exports, module) {
    ...
    QUnit.test('Custom wrapper methods', function (assert) {
        ...
        const mockVariableWrapper = {
            isWrapped: function (value) {
                log.method = 'isWrapped', log.args = arguments;
            },
            isWritableWrapped: function (value) {
                log.method = 'isWritableWrapped', log.args = arguments;
            },
            wrap: function (value) {
                log.method = 'wrap', log.args = arguments;
            },
            unwrap: function (value) {
                log.method = 'unwrap', log.args = arguments;
            },
            assign: function (variable, value) {
                log.method = 'assign', log.args = arguments;
            }
        };
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/variable_wrapper","core/utils/console"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/variable_wrapper"), require("core/utils/console"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=utils.variableWrapper.tests.js.map