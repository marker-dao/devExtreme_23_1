...
(["testing/tests/DevExpress.core/class.tests.js"], ["core/class"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.core/class.tests.js", ["core/class"], function($__export) {
  "use strict";
  var Class,
      A,
      B,
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.test('method name collision', function(assert) {
        var myClass = Class.inherit({m: function() {}});
        assert.throws(function() {
          myClass.include({m: function() {}});
        });
        assert.throws(function() {
          myClass.include({x: function() {}});
          myClass.include({x: function() {}});
        });
      });
      QUnit.test('mixins are reusable (regression)', function(assert) {
        var mixin = {ctor: function() {
            this.mixed = true;
          }};
        var class1 = Class.inherit({}).include(mixin);
        var class2 = Class.inherit({}).include(mixin);
        var obj1 = new class1();
        var obj2 = new class2();
      ...
      QUnit.test('static methods should be inherited', function(assert) {
        var A = Class.inherit({callFoo: function() {
      ...
      QUnit.test('subclassOf method for es6 inheritors', function(assert) {
        ...
        var ES6Inheritor = function($__super) {
          function ES6Inheritor() {
            $traceurRuntime.superConstructor(ES6Inheritor).apply(this, arguments);
          }
          return ($traceurRuntime.createClass)(ES6Inheritor, {}, {}, $__super);
        }(Base);
        var ES6InheritorInheritor = function($__super) {
          function ES6InheritorInheritor() {
            $traceurRuntime.superConstructor(ES6InheritorInheritor).apply(this, arguments);
          }
          return ($traceurRuntime.createClass)(ES6InheritorInheritor, {}, {}, $__super);
        }(ES6Inheritor);
      ...
      QUnit.test('callBase regression', function(assert) {
        ...
        new Child();
        assert.deepEqual(log, ['Parent.ctor', 'Child.method', 'Child.subMethod', 'Parent.subMethod', 'Parent.method', 'Child.subMethod', 'Parent.subMethod']);
      });
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/class"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/class"));
  else
