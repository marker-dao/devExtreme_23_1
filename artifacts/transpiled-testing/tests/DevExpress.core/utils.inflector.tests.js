...
(["testing/tests/DevExpress.core/utils.inflector.tests.js"], ["core/utils/inflector"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.core/utils.inflector.tests.js', ['core/utils/inflector'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const inflector = $__require('core/utils/inflector');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/inflector"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/inflector"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=utils.inflector.tests.js.map