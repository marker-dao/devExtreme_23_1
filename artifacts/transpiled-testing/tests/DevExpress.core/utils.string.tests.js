...
(["testing/tests/DevExpress.core/utils.string.tests.js"], ["core/utils/string"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.core/utils.string.tests.js', ['core/utils/string'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const stringUtils = $__require('core/utils/string');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/string"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/string"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=utils.string.tests.js.map