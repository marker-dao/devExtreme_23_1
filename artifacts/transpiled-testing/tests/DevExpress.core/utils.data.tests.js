...
(["testing/tests/DevExpress.core/utils.data.tests.js"], ["core/utils/data","core/utils/variable_wrapper"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.core/utils.data.tests.js", ["core/utils/data", "core/utils/variable_wrapper"], function($__export) {
  "use strict";
  var GETTER,
      SETTER,
      variableWrapper,
  ...
  return {
    setters: [function($__m) {
      GETTER = $__m.compileGetter;
      SETTER = $__m.compileSetter;
    }, function($__m) {
      variableWrapper = $__m.default;
    }],
    execute: function() {
      var $__4;
      mockVariableWrapper = {
      ...
      QUnit.module('getter', function() {
        ...
        test('defaultValue', function(assert) {
          ...
          var Parent = function() {
            function Parent() {}
            return ($traceurRuntime.createClass)(Parent, {}, {});
          }();
          var Child = function($__super) {
            function Child() {
              $traceurRuntime.superConstructor(Child).apply(this, arguments);
            }
            return ($traceurRuntime.createClass)(Child, {}, {}, $__super);
          }(Parent);
        ...
        test('functionsAsIs option', function(assert) {
          ...
          assert.deepEqual(GETTER('b', 'b2')(obj, {functionsAsIs: true}), {
            b: obj.b,
            b2: obj.b2
          });
        });
        test('square brackets in expr', function(assert) {
          var obj = {prop: {items: ['first', 'second', 'third']}};
      ...
      QUnit.module('getter with wrapped variables', {
        ...
        test('wrap support', function(assert) {
          ...
          var obj = mockWrapper({prop: mockWrapper({subProp: mockWrapper(3)})});
        ...
        test('not unwrapped when unwrapObservables = false', function(assert) {
          var mockWrapper = variableWrapper.wrap;
          var obj = {prop: {subProp: mockWrapper(3)}};
          var getter = GETTER('prop.subProp');
          assert.ok(variableWrapper.isWrapped(getter(obj, {
            functionsAsIs: true,
            unwrapObservables: false
          })));
        });
      });
      QUnit.module('setter', function() {
        ...
        test('complex values are replaced (default mode)', function(assert) {
          var obj = {person: {firstName: 'John'}};
          SETTER('person')(obj, {lastName: 'Doe'});
          assert.deepEqual(obj, {person: {lastName: 'Doe'}});
        });
        test('complex values are merged (merge option)', function(assert) {
          var obj = {person: {name: {first: 'John'}}};
          SETTER('person')(obj, {
            name: {last: 'Doe'},
            year: 1970
          }, {merge: true});
          assert.deepEqual(obj, {person: {
              name: {
                first: 'John',
                last: 'Doe'
              },
        ...
        test('complex values are merged only when it is plain object', function(assert) {
          ...
          var obj1 = {sub: {person: new SomeClass('John', 'Smith')}};
          var obj2 = {person: {firstName: 'Doe'}};
          SETTER('sub')(obj1, obj2, {merge: true});
        ...
        test('plain objects are cloned if previous value is null (T521407)', function(assert) {
          var obj = {dataSource: null};
          var dataSource1 = {store: 'Store 1'};
          var dataSource2 = {store: 'Store 2'};
          SETTER('dataSource')(obj, dataSource1, {merge: true});
          SETTER('dataSource')(obj, dataSource2, {merge: true});
        ...
        test('not existing multi-level prop assignment', function(assert) {
          assert.expect(1);
          var obj = {prop: {}};
          Object.defineProperty(obj.prop, 'subProp', {set: function(value) {
              assert.equal((typeof value === 'undefined' ? 'undefined' : $traceurRuntime.typeof(value)), 'string', 'the last-level prop should not become an empty object');
            }});
      ...
      QUnit.module('setter with wrapped variables', {
        ...
        test('wrap with merge and functions unwrapping', function(assert) {
          var mockWrapper = variableWrapper.wrap;
          var obj = {prop: mockWrapper({a: 1})};
          var setter = SETTER('prop');
          setter(obj, {b: 2}, {
            functionsAsIs: false,
            merge: true
          });
          assert.deepEqual(obj.prop(), {
            a: 1,
            b: 2
          });
        });
        test('multi-level prop into the wrapped value', function(assert) {
          var mockWrapper = variableWrapper.wrap;
          var obj = mockWrapper({prop: mockWrapper(undefined)});
          var setter = SETTER('prop.subProp');
        ...
        test('multi-level prop instead of wrapped value without unwrapping', function(assert) {
          assert.expect(0);
          variableWrapper.inject({unwrap: function() {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/data","core/utils/variable_wrapper"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/data"), require("core/utils/variable_wrapper"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=utils.data.tests.js.map