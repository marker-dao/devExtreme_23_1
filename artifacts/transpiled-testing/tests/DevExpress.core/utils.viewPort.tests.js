...
(["testing/tests/DevExpress.core/utils.viewPort.tests.js"], ["jquery","core/utils/view_port"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.core/utils.viewPort.tests.js', ['jquery', 'core/utils/view_port'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const viewPortUtils = $__require('core/utils/view_port');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/view_port"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/view_port"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=utils.viewPort.tests.js.map