...
(["testing/tests/DevExpress.core/utils.window.tests.js"], ["core/utils/window"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.core/utils.window.tests.js", ["core/utils/window"], function($__export) {
  "use strict";
  var hasWindow,
      getWindow,
      getNavigator,
  ...
  return {
    setters: [function($__m) {
      ...
      getNavigator = $__m.getNavigator;
      setWindow = $__m.setWindow;
      hasProperty = $__m.hasProperty;
    }],
    execute: function() {
      QUnit.module('Window utils', {afterEach: function() {
          setWindow(window);
        }});
      QUnit.test('utils should use real DOM API by default', function(assert) {
        ...
        assert.strictEqual($traceurRuntime.typeof(getWindow().getComputedStyle), 'function', 'window is real');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/window"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/window"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=utils.window.tests.js.map