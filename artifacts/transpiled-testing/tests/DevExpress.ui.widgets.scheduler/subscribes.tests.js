System.register(["generic_light.css!", "ui/scheduler/subscribes", "ui/scheduler/ui.scheduler", "ui/scheduler/appointments/settingsGenerator", "jquery", "animation/fx", "core/utils/date", "core/config", "ui/scheduler/expressionUtils", "../../helpers/scheduler/helpers.js", "ui/scheduler/resources/utils", "ui/scheduler/appointments/dataProvider/utils"], function (_export, _context) {
  "use strict";

  var DateGeneratorBaseStrategy, DateGeneratorVirtualStrategy, $, fx, dateUtils, config, ExpressionUtils, createWrapper, getAppointmentColor, createExpressions, getAppointmentTakesSeveralDays, module, testStart, test;
  return {
    setters: [function (_generic_lightCss) {}, function (_uiSchedulerSubscribes) {}, function (_uiSchedulerUiScheduler) {}, function (_uiSchedulerAppointmentsSettingsGenerator) {
      DateGeneratorBaseStrategy = _uiSchedulerAppointmentsSettingsGenerator.DateGeneratorBaseStrategy;
      DateGeneratorVirtualStrategy = _uiSchedulerAppointmentsSettingsGenerator.DateGeneratorVirtualStrategy;
    }, function (_jquery) {
      $ = _jquery.default;
      ...
      getAppointmentColor = _uiSchedulerResourcesUtils.getAppointmentColor;
      createExpressions = _uiSchedulerResourcesUtils.createExpressions;
    }, function (_uiSchedulerAppointmentsDataProviderUtils) {
      getAppointmentTakesSeveralDays = _uiSchedulerAppointmentsDataProviderUtils.getAppointmentTakesSeveralDays;
    }],
    execute: function () {
      ({
        module,
      ...
      module('Subscribes', {
        ...
        [{
          ...
          test(`Appointment dates generator strategy should has correct type if scrolling.mode: ${option.scrollingMode}`, function (assert) {
            ...
            const {
              dateSettingsStrategy
            } = appointmentRenderingStrategy.getAppointmentSettingsGenerator();
        ...
        test('check the "getField" method with date field', function (assert) {
          ...
          try {
            this.createInstance();
            const startDate = ExpressionUtils.getField(this.instance._dataAccessors, 'startDate', {
              startDate: '2017-02-08'
            });
            assert.deepEqual(startDate, new Date(2017, 1, 8), 'the "getField" method works fine');
            const endDate = ExpressionUtils.getField(this.instance._dataAccessors, 'endDate', {
              endDate: '2017-02-09'
            });
        ...
        test('check the "getField" method', function (assert) {
          this.createInstance();
          const text = ExpressionUtils.getField(this.instance._dataAccessors, 'text', {
            text: 1
          });
        ...
        test('check the \'getField - recurrenceRule\' method, if recurrenceRuleExpr = null', function (assert) {
          ...
          const recurrenceRule = ExpressionUtils.getField(this.instance._dataAccessors, 'recurrenceRule', {
            recurrenceRule: 'FREQ=daily'
          });
        ...
        test('check the \'setField\' method with multi-dotted string', function (assert) {
          ...
          const obj1 = ExpressionUtils.setField(this.instance._dataAccessors, 'text', {
            c: 'just field'
          }, 2);
          ...
          }, 'the \'setField\' method works fine');
        ...
        test('appointmentTakesSeveralDays should return true, if startDate and endDate is different days', function (assert) {
          ...
          assert.ok(getAppointmentTakesSeveralDays(appointments[0], this.instance._dataAccessors, this.instance.timeZoneCalculator), 'appointmentTakesSeveralDays works correctly');
          assert.notOk(getAppointmentTakesSeveralDays(appointments[1], this.instance._dataAccessors, this.instance.timeZoneCalculator), 'appointmentTakesSeveralDays works correctly');
        });
        ...
        test('"getAppointmentDurationInMs" should return visible appointment duration', function (assert) {
          ...
          const result = renderingStrategy.getAppointmentDurationInMs(new Date(2015, 2, 2, 8), new Date(2015, 2, 2, 20));
        ...
        test('"getAppointmentDurationInMs" should return visible appointment duration considering startDayHour and endDayHour', function (assert) {
          ...
          const renderingStrategy = this.instance.getRenderingStrategyInstance();
          const result = renderingStrategy.getAppointmentDurationInMs(new Date(2015, 2, 2, 8), new Date(2015, 2, 4, 20));
        ...
        test('"getAppointmentDurationInMs" should return visible appointment duration considering startDayHour and endDayHour for stricly allDay appointment without allDay field', function (assert) {
          ...
          const renderingStrategy = this.instance.getRenderingStrategyInstance();
          const result = renderingStrategy.getAppointmentDurationInMs(new Date(2015, 2, 2, 8), new Date(2015, 2, 3, 0));
          assert.equal(result / dateUtils.dateToMilliseconds('hour'), 12, '"getAppointmentDurationInMs" works fine');
        });
        test('"getAppointmentDurationInMs" should return visible appointment duration considering hours of startDate and endDate', function (assert) {
          ...
          const renderingStrategy = this.instance.getRenderingStrategyInstance();
          const result = renderingStrategy.getAppointmentDurationInMs(new Date(2015, 4, 25, 21), new Date(2015, 4, 26, 3));
        ...
        test('"getAppointmentDurationInMs" should return visible long appointment duration considering hours of startDate and endDate', function (assert) {
          ...
          const renderingStrategy = this.instance.getRenderingStrategyInstance();
          const result = renderingStrategy.getAppointmentDurationInMs(new Date(2015, 2, 2, 10), new Date(2015, 2, 4, 17));
        ...
        test('"getAppointmentDurationInMs" should return visible appointment duration considering hours of ultraboundary startDate and endDate', function (assert) {
          ...
          const renderingStrategy = this.instance.getRenderingStrategyInstance();
          const result = renderingStrategy.getAppointmentDurationInMs(new Date(2015, 2, 2, 7), new Date(2015, 2, 4, 21));
          assert.equal(result / dateUtils.dateToMilliseconds('hour'), 12 * 3, '"getAppointmentDurationInMs" works fine');
        });
        test('"getAppointmentDurationInMs" should return visible allDay appointment duration', function (assert) {
          ...
          const renderingStrategy = this.instance.getRenderingStrategyInstance();
          const result = renderingStrategy.getAppointmentDurationInMs(new Date(2015, 2, 2, 7), new Date(2015, 2, 4, 21), true);
          assert.equal(result / dateUtils.dateToMilliseconds('hour'), 12 * 3, '"getAppointmentDurationInMs" works fine');
        });
