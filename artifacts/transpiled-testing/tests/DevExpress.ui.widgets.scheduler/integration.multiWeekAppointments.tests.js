System.register(["core/utils/size", "jquery", "../../helpers/scheduler/helpers.js", "animation/translator", "color", "animation/fx", "data/data_source/data_source", "ui/scheduler/ui.scheduler", "generic_light.css!"], function (_export, _context) {
  "use strict";

  var getOuterWidth, getOuterHeight, $, initTestMarkup, createWrapper, translator, Color, fx, DataSource, testStart, mockWorkSpaceRendering;
  return {
    ...
    execute: function () {
      ...
      mockWorkSpaceRendering = function (schedulerInst, cellSize, bounds) {
      ...
      QUnit.test('Multi-week appointments should be split by several parts', function (assert) {
        ...
        const rowHeight = getOuterHeight(this.instance.getWorkSpace().getWorkArea().find('.dx-scheduler-date-table tr').eq(0));
