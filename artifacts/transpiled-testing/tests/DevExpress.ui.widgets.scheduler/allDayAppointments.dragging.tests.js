System.register(["core/utils/size", "jquery", "animation/fx", "../../helpers/pointerMock.js", "events/drag", "data/data_source/data_source", "core/element_data", "../../helpers/scheduler/helpers.js", "generic_light.css!", "ui/scheduler/ui.scheduler"], function (_export, _context) {
  "use strict";

  var getOuterHeight, $, fx, pointerMock, dragEvents, DataSource, dataUtils, createWrapper, initTestMarkup, module, test, testStart, createInstanceBase, triggerDragEnter, config;
  return {
    ...
    execute: function () {
      ...
      triggerDragEnter = ($element, $appointment) => {
