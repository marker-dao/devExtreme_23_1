System.register(["core/utils/size", "generic_light.css!", "../../helpers/pointerMock.js", "../../helpers/keyboardMock.js", "jquery", "ui/scheduler/workspaces/ui.scheduler.work_space_week", "ui/scheduler/appointments/rendering_strategies/strategy_vertical", "ui/scheduler/appointments/rendering_strategies/strategy_horizontal_month", "ui/scheduler/appointments/appointmentCollection", "events/core/events_engine", "events/dblclick", "animation/translator", "core/utils/data", "core/utils/common", "core/utils/type", "core/config", "ui/resizable", "animation/fx", "data/data_source/data_source", "ui/scheduler/expressionUtils", "core/utils/deferred", "ui/scheduler/resources/utils", "ui/scheduler/appointments/dataProvider/appointmentDataProvider.js", "renovation/ui/scheduler/timeZoneCalculator/createTimeZoneCalculator.js"], function (_export, _context) {
  "use strict";

  var getOuterHeight, getWidth, getHeight, pointerMock, keyboardMock, $, VerticalAppointmentsStrategy, HorizontalMonthAppointmentsStrategy, SchedulerAppointments, eventsEngine, dblclickEvent, translator, dataCoreUtils, commonUtils, typeUtils, isRenderer, config, Resizable, fx, DataSource, ExpressionUtils, Deferred, createExpressions, AppointmentDataProvider, createTimeZoneCalculator, testConfig, keyboardNavigationConfig, compileGetter, compileSetter, dataAccessors, createSubscribes, createInstance, moduleOptions;
  return {
    ...
    }, function (_generic_lightCss) {}, function (_helpersPointerMockJs) {
      pointerMock = _helpersPointerMockJs.default;
    }, function (_helpersKeyboardMockJs) {
      keyboardMock = _helpersKeyboardMockJs.default;
    }, function (_jquery) {
      $ = _jquery.default;
    }, function (_uiSchedulerWorkspacesUiSchedulerWork_space_week) {}, function (_uiSchedulerAppointmentsRendering_strategiesStrategy_vertical) {
      VerticalAppointmentsStrategy = _uiSchedulerAppointmentsRendering_strategiesStrategy_vertical.default;
    }, function (_uiSchedulerAppointmentsRendering_strategiesStrategy_horizontal_month) {
      HorizontalMonthAppointmentsStrategy = _uiSchedulerAppointmentsRendering_strategiesStrategy_horizontal_month.default;
    }, function (_uiSchedulerAppointmentsAppointmentCollection) {
      SchedulerAppointments = _uiSchedulerAppointmentsAppointmentCollection.default;
    }, function (_eventsCoreEvents_engine) {
      eventsEngine = _eventsCoreEvents_engine.default;
    }, function (_eventsDblclick) {
      dblclickEvent = _eventsDblclick.default;
    ...
    }, function (_uiResizable) {
      Resizable = _uiResizable.default;
    ...
    }, function (_uiSchedulerExpressionUtils) {
    ...
    }, function (_uiSchedulerAppointmentsDataProviderAppointmentDataProviderJs) {
      AppointmentDataProvider = _uiSchedulerAppointmentsDataProviderAppointmentDataProviderJs.AppointmentDataProvider;
    }, function (_renovationUiSchedulerTimeZoneCalculatorCreateTimeZoneCalculatorJs) {
      createTimeZoneCalculator = _renovationUiSchedulerTimeZoneCalculatorCreateTimeZoneCalculatorJs.createTimeZoneCalculator;
    }],
    execute: function () {
    ...
    `);
      ...
      createSubscribes = (coordinates, cellWidth, cellHeight) => ({
      ...
      createInstance = (options, subscribesConfig) => {
        const subscribes = createSubscribes(subscribesConfig.coordinates, subscribesConfig.cellWidth, subscribesConfig.cellHeight);
        const observer = {
      ...
      QUnit.module('Appointments', moduleOptions, () => {
        ...
        QUnit.test('Appointment should be rendered a many times if coordinates array contains a few items', function (assert) {
          ...
          assert.deepEqual(translator.locate($appointment.eq(1)), {
            top: 10,
            left: 10
          }, 'appointment is rendered in right place');
          assert.deepEqual(translator.locate($appointment.eq(2)), {
            top: 20,
            left: 20
          }, 'appointment is rendered in right place');
        ...
        QUnit.test('Delta time for resizable appointment should be 0 if appointment isn\'t resized', function (assert) {
          ...
          const deltaTime = strategy.getDeltaTime({
            width: 100
          }, {
            width: 100
          });
        ...
        QUnit.test('Split appointment by day', function (assert) {
          const instance = createInstance({}, testConfig);
          const appt1 = {
            startDate: new Date(2016, 1, 25, 9).toString(),
            endDate: new Date(2016, 1, 25, 10).toString()
          };
          const appt2 = {
            startDate: new Date(2016, 1, 28, 9).toString(),
            endDate: new Date(2016, 2, 3, 16).toString()
          };
          const appt3 = {
            startDate: new Date(2016, 1, 28, 9).toString(),
            endDate: new Date(2016, 1, 29, 10).toString()
          };
          ...
          assert.deepEqual(parts2, [{
            settings: {
              startDate: new Date(2016, 1, 28, 9),
              endDate: new Date(2016, 1, 28, 20)
            },
            startDate: appt2.startDate,
            endDate: appt2.endDate
          }, {
            settings: {
              startDate: new Date(2016, 1, 29, 8),
              endDate: new Date(2016, 1, 29, 20)
            },
            startDate: appt2.startDate,
            endDate: appt2.endDate
          }, {
            settings: {
              startDate: new Date(2016, 2, 1, 8),
              endDate: new Date(2016, 2, 1, 20)
            },
            startDate: appt2.startDate,
            endDate: appt2.endDate
          }, {
            settings: {
              startDate: new Date(2016, 2, 2, 8),
              endDate: new Date(2016, 2, 2, 20)
            },
            startDate: appt2.startDate,
            endDate: appt2.endDate
          }, {
            settings: {
              startDate: new Date(2016, 2, 3, 8),
              endDate: new Date(2016, 2, 3, 16)
            },
            startDate: appt2.startDate,
            endDate: appt2.endDate
          }], 'Parts are OK');
          assert.deepEqual(parts3, [{
            ...
            startDate: appt3.startDate,
            endDate: appt3.endDate
          }, {
            settings: {
              startDate: new Date(2016, 1, 29, 8),
              endDate: new Date(2016, 1, 29, 10)
            },
            startDate: appt3.startDate,
            endDate: appt3.endDate
          }], 'Parts are OK');
        ...
        QUnit.test('Split appointment by day should consider startDayHour & endDayHour', function (assert) {
          const instance = createInstance({}, testConfig);
          const appt1 = {
            startDate: new Date(2016, 1, 25, 1).toString(),
            endDate: new Date(2016, 1, 25, 2).toString()
          };
          const appt2 = {
            startDate: new Date(2016, 1, 28, 1).toString(),
            endDate: new Date(2016, 2, 3, 2).toString()
          };
          const appt3 = {
            startDate: new Date(2016, 1, 28, 16).toString(),
            endDate: new Date(2016, 1, 29, 20).toString()
          };
          const parts1 = instance.splitAppointmentByDay(appt1);
          const parts2 = instance.splitAppointmentByDay(appt2);
          const parts3 = instance.splitAppointmentByDay(appt3);
          ...
          assert.deepEqual(parts2, [{
            settings: {
              startDate: new Date(2016, 1, 28, 8),
              endDate: new Date(2016, 1, 28, 20)
            },
            startDate: appt2.startDate,
            endDate: appt2.endDate
          ...
          assert.deepEqual(parts3, [{
            settings: {
              startDate: new Date(2016, 1, 28, 16),
              endDate: new Date(2016, 1, 28, 20)
            },
            startDate: appt3.startDate,
            endDate: appt3.endDate
        ...
        QUnit.test('Split appointment by day should trim minutes, seconds and milliseconds if needed', function (assert) {
          const instance = createInstance({}, testConfig);
          const appt1 = {
            startDate: new Date(2017, 7, 21, 9, 0, 10).toString(),
            endDate: new Date(2017, 7, 22, 18, 0).toString()
          };
          const parts1 = instance.splitAppointmentByDay(appt1);
          assert.deepEqual(parts1, [{
            settings: {
              startDate: new Date(2017, 7, 21, 9, 0, 10),
              endDate: new Date(2017, 7, 21, 20)
            },
            startDate: appt1.startDate,
            endDate: appt1.endDate
          }, {
            settings: {
              startDate: new Date(2017, 7, 22, 8, 0, 0),
              endDate: new Date(2017, 7, 22, 18)
            },
            startDate: appt1.startDate,
            endDate: appt1.endDate
          }], 'Parts are OK');
