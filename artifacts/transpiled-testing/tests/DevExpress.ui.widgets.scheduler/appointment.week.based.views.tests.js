System.register(["core/utils/size", "jquery", "ui/widget/ui.errors", "animation/translator", "localization/date", "animation/fx", "../../helpers/pointerMock.js", "color", "ui/tooltip/ui.tooltip", "data/data_source/data_source", "data/custom_store", "core/element_data", "core/utils/date_serialization", "../../helpers/scheduler/helpers.js", "ui/scheduler/ui.scheduler", "ui/switch", "generic_light.css!"], function (_export, _context) {
  "use strict";

  var getHeight, getOuterHeight, getOuterWidth, $, errors, translator, dateLocalization, fx, pointerMock, Color, tooltip, DataSource, CustomStore, dataUtils, dateSerialization, initTestMarkup, asyncAssert, createWrapper, supportedScrollingModes, module, test, skip, DATE_TABLE_CELL_CLASS, APPOINTMENT_CLASS, APPOINTMENT_DEFAULT_LEFT_OFFSET, createInstanceBase, getAppointmentColor;
  return {
    setters: [function (_coreUtilsSize) {
      ...
      asyncAssert = _helpersSchedulerHelpersJs.asyncAssert;
    ...
    }, function (_uiSchedulerUiScheduler) {}, function (_uiSwitch) {}, function (_generic_lightCss) {}],
    execute: function () {
      ({
        module,
        test,
      ...
      createInstanceBase = (options, clock) => {
      ...
      getAppointmentColor = ($task, checkedProperty) => {
        ...
        module('Scrolling mode standard', () => {
          ...
          test('DblClick on appointment should not affect the related cell start date (T395620)', function (assert) {
            ...
            try {
              ...
              const relatedCellData = !scheduler.instance.option('renovateRender') ? dataUtils.data(cell, 'dxCellData').startDate : scheduler.instance.getWorkSpace().getCellData($(cell)).startDate;
        ...
        supportedScrollingModes.forEach(scrollingMode => {
          ...
          module(`Scrolling mode ${scrollingMode}`, () => {
            test('Scheduler tasks should have a right parent', function (assert) {
              ...
              assert.equal(scheduler.instance.$element().find('.dx-scheduler-work-space .dx-scrollable-content .dx-scheduler-date-table-container>.dx-scheduler-scrollable-appointments').length || scheduler.instance.$element().find('.dx-scheduler-work-space .dx-scrollable-content>.dx-scheduler-scrollable-appointments').length, 1, 'scrollable is parent of dxSchedulerAppointments');
            });
            ...
            test('Non-grid-aligned appointments should be resized correctly, when endDayHour is set', function (assert) {
              ...
              scheduler.instance.getWorkSpace().getScrollable().scrollTo({
                y: 1000
              });
                    ...
                    load: function (options) {
                      ...
                      setTimeout(function () {
                        d.resolve([{
                          ...
                          endDate: new Date(2015, 3, 16, 0, 30)
                        }, {
                          text: 'a',
                          startDate: new Date(2015, 3, 16),
                          endDate: new Date(2015, 3, 16, 0, 30)
                  ...
                  store: new CustomStore({
                    load: function (options) {
                      ...
                      setTimeout(function () {
                        d.resolve([{
                          text: 'a',
                          startDate: new Date(2015, 3, 16, 0),
                          endDate: new Date(2015, 3, 16, 0, 30)
                        }, {
                          text: 'b',
                          startDate: new Date(2015, 3, 16, 3),
                          endDate: new Date(2015, 3, 16, 3, 30)
                        }]);
                      }, 300);
                      return d.promise();
                    }
                  ...
                  form.option('items', [{
                    ...
                    editorOptions: {
                      ...
                      onValueChanged: function (args) {
                        ...
                        form.getEditor('EndDate').option('value', new Date(1464160900000));
                      }
                    }
                  }, {
                    name: 'EndDate',
            ...
            test('A long appointment should not change start date if resized from the bottom', function (assert) {
              ...
              const $element = $(scheduler.instance.element());
              const workspace = scheduler.instance.getWorkSpace();
              workspace.getScrollable().scrollTo({
                y: 3000
              });
              ...
              const {
                startDate
              } = scheduler.instance.option('dataSource')[0];
            ...
            test('Tail of long appointment should have a right position, groupByDate = true', function (assert) {
              const scheduler = createInstance({
                dataSource: [{
                  text: 'Task 1',
                  startDate: new Date(2015, 8, 22, 22, 0),
                  endDate: new Date(2015, 8, 23, 21, 0),
                  ownerId: 2
                }],
                groupByDate: true,
                groups: ['ownerId'],
            ...
            ['month', 'timelineMonth'].forEach(viewName => {
