System.register(["ui/scheduler/workspaces/cells_selection_state"], function (_export, _context) {
  "use strict";

  var CellsSelectionState, test, module, testViewDataMap, horizontalGroupingViewDataProviderMock;
  return {
    setters: [function (_uiSchedulerWorkspacesCells_selection_state) {
      CellsSelectionState = _uiSchedulerWorkspacesCells_selection_state.default;
    }],
    execute: function () {
      ({
        test,
      ...
      horizontalGroupingViewDataProviderMock = {
        getCellData: (rowIndex, columnIndex) => testViewDataMap.horizontalGrouping[rowIndex][columnIndex].cellData,
      ...
      module('Cells Selection State', () => {
        test('Focused cell should be set correctly', function (assert) {
          ...
          assert.deepEqual(focusedCellData, testViewDataMap.horizontalGrouping[1][1].cellData, 'Correct focused cell data');
        });
        test('"getFocusedCell" should work correctly', function (assert) {
          const cellsSelectionState = new CellsSelectionState(horizontalGroupingViewDataProviderMock);
          cellsSelectionState.setFocusedCell(1, 1, false);
          const focusedCell = cellsSelectionState.focusedCell;
          assert.deepEqual(focusedCell, {
        ...
        test('"setSelectedCells" should work correctly', function (assert) {
          const cellsSelectionState = new CellsSelectionState({
            ...horizontalGroupingViewDataProviderMock,
            getCellsByGroupIndexAndAllDay: () => [[testViewDataMap.horizontalGrouping[1][0].cellData, testViewDataMap.horizontalGrouping[1][1].cellData]]
          });
          ...
          assert.deepEqual(selectedCells, [testViewDataMap.horizontalGrouping[1][0].cellData, testViewDataMap.horizontalGrouping[1][1].cellData], 'Correct focused cell');
        });
        ...
        test('"releaseSelectedAndFocusedCells" should save current values as previous', function (assert) {
          ...
          assert.deepEqual(cellsSelectionState._prevFocusedCell, testViewDataMap.horizontalGrouping[1][1].cellData, 'Correct cached focused cell data');
          assert.deepEqual(cellsSelectionState._prevSelectedCells, [testViewDataMap.horizontalGrouping[1][0].cellData, testViewDataMap.horizontalGrouping[1][1].cellData], 'Correct cachedfocused cell');
          const prevFocusedCellData = cellsSelectionState._focusedCell;
          const prevSelectedCells = cellsSelectionState._selectedCells;
          assert.deepEqual(prevFocusedCellData, null, 'Correct focused cell data');
          assert.deepEqual(prevSelectedCells, null, 'Correct selected cells');
        });
        test('"clearSelectedAndFocusedCells" should not save current values as previous', function (assert) {
          ...
          assert.deepEqual(cellsSelectionState._prevFocusedCell, null, 'Correct cached focused cell data');
          assert.deepEqual(cellsSelectionState._prevSelectedCells, null, 'Correct cachedfocused cell');
          const prevFocusedCellData = cellsSelectionState._focusedCell;
          const prevSelectedCells = cellsSelectionState._selectedCells;
          assert.deepEqual(prevFocusedCellData, null, 'Correct focused cell data');
          assert.deepEqual(prevSelectedCells, null, 'Correct selected cells');
        ...
        test('"restoreSelectedAndFocusedCells" should restore cells correctly when previous state was saved', function (assert) {
          ...
          assert.deepEqual(cellsSelectionState.focusedCell.cellData, testViewDataMap.horizontalGrouping[1][1].cellData, 'Correct focused cell data');
          assert.deepEqual(cellsSelectionState.getSelectedCells(), [testViewDataMap.horizontalGrouping[1][0].cellData, testViewDataMap.horizontalGrouping[1][1].cellData], 'Correct selected cells');
        });
