System.register(["ui/scheduler/resources/agendaResourceProcessor", "data/data_source/data_source", "data/custom_store"], function (_export, _context) {
  "use strict";

  var AgendaResourceProcessor, DataSource, CustomStore, module, test, rooms, roomResource, owners, ownerResource, appointment;
  return {
    setters: [function (_uiSchedulerResourcesAgendaResourceProcessor) {
      AgendaResourceProcessor = _uiSchedulerResourcesAgendaResourceProcessor.AgendaResourceProcessor;
