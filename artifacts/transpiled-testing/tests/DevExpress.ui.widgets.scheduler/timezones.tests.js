System.register(["core/utils/size", "jquery", "animation/fx", "../../helpers/scheduler/helpers.js", "../../helpers/pointerMock.js", "core/utils/date", "localization/date", "animation/translator", "ui/tooltip/ui.tooltip", "data/data_source/data_source", "data/array_store", "events/drag", "ui/scheduler/utils.timeZone"], function (_export, _context) {
  "use strict";

  var getOuterHeight, getOuterWidth, $, fx, CLASSES, createWrapper, initTestMarkup, isDesktopEnvironment, pointerMock, dateUtils, dateLocalization, translator, tooltip, DataSource, ArrayStore, dragEvents, timeZoneUtils, testStart, test, module, timeZones, moduleConfig, data, createScheduler;
  return {
    ...
    }, function (_uiTooltipUiTooltip) {
      tooltip = _uiTooltipUiTooltip.default;
    ...
    }, function (_uiSchedulerUtilsTimeZone) {
      timeZoneUtils = _uiSchedulerUtilsTimeZone.default;
    }],
    execute: function () {
      ({
        testStart,
      ...
      data = [{
        ...
        startDateTimeZone: timeZones.LosAngeles,
        // -7
      ...
      module('Common', moduleConfig, () => {
        if (isDesktopEnvironment()) {
          ...
          [undefined, timeZones.LosAngeles].forEach(timeZone => {
            test(`After drag element to scheduler, dates from elements should be valid,
              ...
              const dragAppointment = $('<div>').text(data.text).css({
                display: 'block',
                width: '100px',
                height: '50px',
                background: 'red'
              }).prependTo('#qunit-fixture').dxDraggable({
              ...
              pointer.down(0, 0).move(dataCellOffset.left, dataCellOffset.top);
              pointer.up();
            });
          });
        }
      ...
      module('Not native date DST', moduleConfig, () => {
        module('summer time', () => {
          ...
          [from1amTo2amRecurrenceExceptionCase, from1amTo3amRecurrenceExceptionCase, from2amTo3amRecurrenceExceptionCase, from6amTo7amRecurrenceExceptionCase].forEach(testCase => {
          ...
          const from1amTo2amCase = {
            ...
            startDate: new Date('2020-03-01T09:00:00.000Z'),
            endDate: new Date('2020-03-01T10:00:00.000Z'),
            expectedTexts: ['1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 3:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM']
          };
          const from1amTo3amCase = {
            text: 'Recurrence start from 1 a.m. to 3 a.m.',
            startDate: new Date('2020-03-01T09:00:00.000Z'),
            endDate: new Date('2020-03-01T11:00:00.000Z'),
            expectedTexts: ['1:00 AM - 3:00 AM', '1:00 AM - 3:00 AM', '1:00 AM - 3:00 AM', '1:00 AM - 3:00 AM', '1:00 AM - 3:00 AM', '1:00 AM - 3:00 AM', '1:00 AM - 3:00 AM']
          };
          const from2amTo3amCase = {
            text: 'Recurrence start from 2 a.m. to 3 a.m.',
            startDate: new Date('2020-03-01T10:00:00.000Z'),
            endDate: new Date('2020-03-01T11:00:00.000Z'),
            expectedTexts: ['2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM', '3:00 AM - 4:00 AM', '2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM']
          };
          const from6amTo7amCase = {
            text: 'Recurrence start from 8 a.m. to 9 a.m.',
            startDate: new Date('2020-03-01T16:00:00.000Z'),
            endDate: new Date('2020-03-01T17:00:00.000Z'),
            expectedTexts: ['8:00 AM - 9:00 AM', '8:00 AM - 9:00 AM', '8:00 AM - 9:00 AM', '8:00 AM - 9:00 AM', '8:00 AM - 9:00 AM', '8:00 AM - 9:00 AM', '8:00 AM - 9:00 AM']
          };
          ...
          const from1amTo2amMonthCase = {
            ...
            expectedTexts: ['March 6 1:00 AM - 2:00 AM', 'March 7 1:00 AM - 2:00 AM', 'March 8 1:00 AM - 3:00 AM', 'March 9 1:00 AM - 2:00 AM', 'March 10 1:00 AM - 2:00 AM', 'March 11 1:00 AM - 2:00 AM', 'March 12 1:00 AM - 2:00 AM']
          };
          const from1amTo3amMonthCase = {
            text: 'Recurrence start from 1 a.m. to 3 a.m.',
            startDate: new Date('2020-03-06T09:00:00.000Z'),
            endDate: new Date('2020-03-06T11:00:00.000Z'),
            expectedTexts: ['March 6 1:00 AM - 3:00 AM', 'March 7 1:00 AM - 3:00 AM', 'March 8 1:00 AM - 3:00 AM', 'March 9 1:00 AM - 3:00 AM', 'March 10 1:00 AM - 3:00 AM', 'March 11 1:00 AM - 3:00 AM', 'March 12 1:00 AM - 3:00 AM']
          };
          const from2amTo3amMonthCase = {
            text: 'Recurrence start from 2 a.m. to 3 a.m.',
            startDate: new Date('2020-03-06T10:00:00.000Z'),
            endDate: new Date('2020-03-06T11:00:00.000Z'),
            expectedTexts: ['March 6 2:00 AM - 3:00 AM', 'March 7 2:00 AM - 3:00 AM', 'March 8 3:00 AM - 4:00 AM', 'March 9 2:00 AM - 3:00 AM', 'March 10 2:00 AM - 3:00 AM', 'March 11 2:00 AM - 3:00 AM', 'March 12 2:00 AM - 3:00 AM']
          };
          const from6amTo7amMonthCase = {
            ...
            expectedTexts: ['March 6 8:00 AM - 9:00 AM', 'March 7 8:00 AM - 9:00 AM', 'March 8 8:00 AM - 9:00 AM', 'March 9 8:00 AM - 9:00 AM', 'March 10 8:00 AM - 9:00 AM', 'March 11 8:00 AM - 9:00 AM', 'March 12 8:00 AM - 9:00 AM']
          };
        ...
        module('winter time', () => {
          ...
          const from1amTo2amCase = {
            ...
            startDate: '2020-10-25T08:00:00.000Z',
            endDate: '2020-10-25T09:00:00.000Z',
            expectedTexts: ['1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM']
          };
          const from2amTo3amCase = {
            text: 'Recurrence start from 2 a.m. to 3 a.m.',
            startDate: '2020-10-25T09:00:00.000Z',
            endDate: '2020-10-25T10:00:00.000Z',
            expectedTexts: ['2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM']
          };
          const from1amTo3amCase = {
            text: 'Recurrence start from 1 a.m. to 3 a.m.',
            startDate: '2020-10-25T08:00:00.000Z',
          ...
          const from6amTo7amCase = {
            ...
            startDate: '2020-10-25T13:00:00.000Z',
            endDate: '2020-10-25T14:00:00.000Z',
            expectedTexts: ['6:00 AM - 7:00 AM', '6:00 AM - 7:00 AM', '6:00 AM - 7:00 AM', '6:00 AM - 7:00 AM', '6:00 AM - 7:00 AM', '6:00 AM - 7:00 AM', '6:00 AM - 7:00 AM']
          };
          ...
          const from1amTo2amWinterCase = {
            ...
            startDate: '2020-10-25T08:00:00.000Z',
            endDate: '2020-10-25T09:00:00.000Z',
            expectedTexts: ['October 29 1:00 AM - 2:00 AM', 'October 30 1:00 AM - 2:00 AM', 'October 31 1:00 AM - 2:00 AM', 'November 1 1:00 AM - 2:00 AM', 'November 2 1:00 AM - 2:00 AM', 'November 3 1:00 AM - 2:00 AM', 'November 4 1:00 AM - 2:00 AM']
          };
          const from2amTo3amWinterCase = {
            text: 'Recurrence start from 2 a.m. to 3 a.m.',
            startDate: '2020-10-25T09:00:00.000Z',
            endDate: '2020-10-25T10:00:00.000Z',
            expectedTexts: ['October 29 2:00 AM - 3:00 AM', 'October 30 2:00 AM - 3:00 AM', 'October 31 2:00 AM - 3:00 AM', 'November 1 2:00 AM - 3:00 AM', 'November 2 2:00 AM - 3:00 AM', 'November 3 2:00 AM - 3:00 AM', 'November 4 2:00 AM - 3:00 AM']
          };
          const from1amTo3amWinterCase = {
            text: 'Recurrence start from 1 a.m. to 3 a.m.',
            startDate: '2020-10-25T08:00:00.000Z',
            endDate: '2020-10-25T10:00:00.000Z',
            expectedTexts: ['October 29 1:00 AM - 3:00 AM', 'October 30 1:00 AM - 3:00 AM', 'October 31 1:00 AM - 3:00 AM', 'November 1 1:00 AM - 3:00 AM', 'November 2 1:00 AM - 3:00 AM', 'November 3 1:00 AM - 3:00 AM', 'November 4 1:00 AM - 3:00 AM']
          };
          const from6amTo7amWinterCase = {
            text: 'Recurrence start from 6 a.m. to 7 a.m.',
            startDate: '2020-10-25T13:00:00.000Z',
            endDate: '2020-10-25T14:00:00.000Z',
            expectedTexts: ['October 29 6:00 AM - 7:00 AM', 'October 30 6:00 AM - 7:00 AM', 'October 31 6:00 AM - 7:00 AM', 'November 1 6:00 AM - 7:00 AM', 'November 2 6:00 AM - 7:00 AM', 'November 3 6:00 AM - 7:00 AM', 'November 4 6:00 AM - 7:00 AM']
          };
      ...
      module('Scheduler grid', moduleConfig, () => {
          ...
          [{
            ...
            test(`Drag n drop should work right in week view if timezone='${timeZone}'`, function (assert) {
              const scheduler = createWrapper({
                ...
                // fix for 'Not cleared timer detected.'
                dataSource: [{
                  text: 'a',
                  startDate,
                  endDate
        ...
        test('Appointment with custom tz should be resized correctly if the scheduler tz is empty(T392414)', function (assert) {
          const scheduler = createWrapper({
            ...
            dataSource: [{
              ...
              startDateTimeZone: timeZones.Lima,
              // -5
        ...
        test('Appts should be filtered correctly if there is a custom tz and start day hour is not 0', function (assert) {
          ...
          const cellsCount = (new Date(new Date('2015-05-27T23:00:00+01:00').setHours(new Date('2015-05-27T23:00:00+01:00').getHours() + clientTzOffset - 8)).getHours() - 7) * 2;
      ...
      module('Appointment popup', moduleConfig, () => {
        ...
        [5, 'Asia/Ashkhabad'].forEach(timeZone => {
          test(`Appointment startDate and endDate should be correct in the details view, if custom timeZone='${timeZone}' is setting`, function (assert) {
        ...
        test('Appointment startDate and endDate should be correct in the details view for new appointment, if custom timeZone was set', function (assert) {
          const scheduler = createWrapper({
            dataSource: new DataSource({
              store: []
            }),
      ...
      module('Fixed client time zone offset', {
        ...
        test('Appointment should be rendered correctly when appointment timeZone was set', function (assert) {
          const appointments = [{
            startDate: new Date(2015, 1, 4, 5).toString(),
            startDateTimeZone: 'Asia/Calcutta',
            // +05:30
        ...
        [{
          ...
          appointment: {
            ...
            startDateTimeZone: timeZones.Phoenix,
            // -7
        ...
        test('Appts should be filtered correctly if there is a custom tz and start day hour is not 0(T396719)', function (assert) {
          const scheduler = createWrapper({
            ...
            startDayHour: 10,
            currentDate: new Date(2015, 4, 25),
            timeZone: timeZones.Dawson_Creek,
            // -7
            height: 500,
            currentView: 'week',
            firstDayOfWeek: 1
