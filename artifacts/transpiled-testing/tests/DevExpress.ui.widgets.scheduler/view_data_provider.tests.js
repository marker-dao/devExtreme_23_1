System.register(["ui/scheduler/workspaces/view_model/view_data_provider", "../../helpers/scheduler/helpers.js"], function (_export, _context) {
  "use strict";

  var ViewDataProvider, supportedViews, test, module, testViewDataMap, testHeaderDataMap, verticalGroupingRenderOptions, horizontalGroupingRenderOptions, createViewDataProvider;
  return {
    setters: [function (_uiSchedulerWorkspacesView_modelView_data_provider) {
      ViewDataProvider = _uiSchedulerWorkspacesView_modelView_data_provider.default;
    }, function (_helpersSchedulerHelpersJs) {
      supportedViews = _helpersSchedulerHelpersJs.supportedViews;
    }],
    execute: function () {
      ({
        test,
        ...
        module('API', () => {
          module('Vertical grouping', {
            ...
            test('getLastGroupCellPosition', function (assert) {
              assert.deepEqual(this.viewDataProvider.getLastGroupCellPosition(2), {
                rowIndex: 1,
                columnIndex: 1
              }, 'Last position for the group 2 is correct');
              assert.deepEqual(this.viewDataProvider.getLastGroupCellPosition(3), {
                rowIndex: 3,
                columnIndex: 1
              }, 'Last position for the group 3 is correct');
            });
            test('getRowCountInGroup', function (assert) {
              assert.deepEqual(this.viewDataProvider.getRowCountInGroup(2), 1, 'Row count in group 2 is correct');
              assert.deepEqual(this.viewDataProvider.getRowCountInGroup(3), 1, 'Row count in group 3 is correct');
            });
          ...
          module('findGroupCellStartDate', {
            ...
            module('Date and time views', () => {
              test('it should return correct cell start date', function (assert) {
                assert.deepEqual(this.viewDataProvider.findGroupCellStartDate(2, new Date(2020, 7, 24, 0, 10), new Date(2020, 7, 24, 1, 10)), new Date(2020, 7, 24), 'Group 2 cell 0 start date is correct');
                assert.deepEqual(this.viewDataProvider.findGroupCellStartDate(2, new Date(2020, 7, 25, 0, 11), new Date(2020, 7, 25, 1, 20)), new Date(2020, 7, 25), 'Group 2 cell 1 start date is correct');
                assert.deepEqual(this.viewDataProvider.findGroupCellStartDate(3, new Date(2020, 7, 24, 0, 11), new Date(2020, 7, 24, 1, 22)), new Date(2020, 7, 24, 1), 'Group 3 cell 0 start date is correct');
                assert.deepEqual(this.viewDataProvider.findGroupCellStartDate(3, new Date(2020, 7, 25, 0, 11), new Date(2020, 7, 25, 1, 30)), new Date(2020, 7, 25, 1), 'Group 3 cell 1 start date is correct');
              });
              test('it should return correct cell start date if find by date', function (assert) {
                assert.deepEqual(this.viewDataProvider.findGroupCellStartDate(2, new Date(2020, 7, 24, 0, 10), new Date(2020, 7, 24, 1, 10), true), new Date(2020, 7, 24), 'Group 2 cell 0 start date is correct');
                assert.deepEqual(this.viewDataProvider.findGroupCellStartDate(2, new Date(2020, 7, 25, 0, 11), new Date(2020, 7, 25, 1, 20), true), new Date(2020, 7, 25), 'Group 2 cell 1 start date is correct');
                assert.deepEqual(this.viewDataProvider.findGroupCellStartDate(3, new Date(2020, 7, 24, 0, 11), new Date(2020, 7, 24, 1, 22), true), new Date(2020, 7, 24), 'Group 3 cell 0 start date is correct');
                assert.deepEqual(this.viewDataProvider.findGroupCellStartDate(3, new Date(2020, 7, 25, 0, 11), new Date(2020, 7, 25, 1, 30), true), new Date(2020, 7, 25), 'Group 3 cell 1 start date is correct');
              });
            });
            module('Date views', () => {
              const renderOptions = {
              ...
              test('it should return correct cell start date', function (assert) {
                ...
                assert.deepEqual(viewDataProvider.findGroupCellStartDate(2, new Date(2020, 7, 24, 0, 10), new Date(2020, 7, 24, 1, 10)), new Date(2020, 7, 24, 0), 'Group 2 cell 0 start date is correct');
                assert.deepEqual(viewDataProvider.findGroupCellStartDate(2, new Date(2020, 7, 25, 0, 11), new Date(2020, 7, 25, 1, 20)), new Date(2020, 7, 25, 0), 'Group 2 cell 1 start date is correct');
                assert.deepEqual(viewDataProvider.findGroupCellStartDate(3, new Date(2020, 7, 24, 0, 11), new Date(2020, 7, 24, 1, 22)), new Date(2020, 7, 24, 1), 'Group 3 cell 0 start date is correct');
                assert.deepEqual(viewDataProvider.findGroupCellStartDate(3, new Date(2020, 7, 25, 0, 11), new Date(2020, 7, 25, 1, 30)), new Date(2020, 7, 25, 1), 'Group 3 cell 1 start date is correct');
              });
            });
          });
          module('findAllDayGroupCellStartDate', {
            ...
            module('Date and time views', () => {
              test('it should return correct all day cell start date', function (assert) {
                this.init('vertical');
                assert.deepEqual(this.viewDataProvider.findAllDayGroupCellStartDate(2, new Date(2020, 7, 25, 0, 11)), new Date(2020, 7, 25, 0, 11), 'Group 2 cell 1 allDay start date is correct');
                assert.deepEqual(this.viewDataProvider.findAllDayGroupCellStartDate(3, new Date(2020, 7, 25, 0, 11)), new Date(2020, 7, 25, 0, 11), 'Group 2 cell 1 allDay start date is correct');
                assert.deepEqual(this.viewDataProvider.findAllDayGroupCellStartDate(2, new Date(2020, 7, 23, 0, 11)), new Date(2020, 7, 24), 'Group 2 cell 1 allDay start date is correct when startDate is out of view');
              });
            });
            module('Date views', () => {
              const renderOptions = {
              ...
              test('it should return correct cell start date', function (assert) {
                ...
                assert.deepEqual(viewDataProvider.findAllDayGroupCellStartDate(2, new Date(2020, 7, 25, 0, 11)), new Date(2020, 7, 25, 0, 11), 'Group 2 cell 1 allDay start date is correct');
                assert.deepEqual(viewDataProvider.findAllDayGroupCellStartDate(3, new Date(2020, 7, 25, 0, 11)), new Date(2020, 7, 25, 0, 11), 'Group 2 cell 1 allDay start date is correct');
                assert.deepEqual(viewDataProvider.findAllDayGroupCellStartDate(2, new Date(2020, 7, 23, 0, 11)), new Date(2020, 7, 24), 'Group 2 cell 1 allDay start date is correct when startDate is out of view');
              });
            });
          });
          module('getCellData', {
            ...
            test('Cell data of the allDayPanel', function (assert) {
              assert.deepEqual(this.viewDataProvider.getCellData(0, 0), testViewDataMap.verticalGrouping[0][0], 'Cell data [0, 0] is correct');
              assert.deepEqual(this.viewDataProvider.getCellData(0, 1), testViewDataMap.verticalGrouping[0][1], 'Cell data [0, 1] is correct');
              assert.deepEqual(this.viewDataProvider.getCellData(2, 0), testViewDataMap.verticalGrouping[2][0], 'Cell data [2, 0] is correct');
              assert.deepEqual(this.viewDataProvider.getCellData(2, 1), testViewDataMap.verticalGrouping[2][1], 'Cell data [2, 1] is correct');
            });
            test('Cell data of the dateTable', function (assert) {
              assert.deepEqual(this.viewDataProvider.getCellData(1, 0), testViewDataMap.verticalGrouping[1][0], 'Cell data [1, 0] is correct');
              assert.deepEqual(this.viewDataProvider.getCellData(1, 1), testViewDataMap.verticalGrouping[1][1], 'Cell data [1, 1] is correct');
              assert.deepEqual(this.viewDataProvider.getCellData(3, 0), testViewDataMap.verticalGrouping[3][0], 'Cell data [3, 0] is correct');
              assert.deepEqual(this.viewDataProvider.getCellData(3, 1), testViewDataMap.verticalGrouping[3][1], 'Cell data [3, 1] is correct');
            });
            test('isGroupIntersectDateInterval', function (assert) {
              assert.ok(this.viewDataProvider.isGroupIntersectDateInterval(2, new Date(2020, 7, 24), new Date(2020, 7, 24, 15)), 'View date interval intersected');
              assert.notOk(this.viewDataProvider.isGroupIntersectDateInterval(2, new Date(2020, 7, 23), new Date(2020, 7, 23, 15)), 'View date interval is not Intersected');
              assert.notOk(this.viewDataProvider.isGroupIntersectDateInterval(2, new Date(2020, 7, 26), new Date(2020, 7, 26, 15)), 'View date interval is not Intersected');
            });
          });
              ...
              module('Vertical Grouping', function () {
                test('Should return correct cell position for the allDay cell date', function (assert) {
                  ...
                  assert.deepEqual(position, {
                    rowIndex: 2,
                    columnIndex: 0
                  }, '2nd allDayPanel cell position is correct');
                });
                test('Should return correct cell position for the not allDay cell date', function (assert) {
                  ...
                  assert.deepEqual(viewDataProvider.findCellPositionInMap(cellInfo), {
                    rowIndex: 1,
                    columnIndex: 0
          ...
          module('createGroupedDataMapProvider', () => {
            test('it should create groupedDataMapProvider', function (assert) {
              ...
              viewDataProvider.viewDataMap = viewDataProvider.viewDataGenerator.generateViewDataMap(testViewDataMap.verticalGrouping, verticalGroupingRenderOptions);
          ...
          module('getViewPortGroupCount', () => {
            ...
            test('it should return correct value if horizontal grouping', function (assert) {
              ...
              viewDataProvider.viewDataMap = viewDataProvider.viewDataGenerator.generateViewDataMap(testViewDataMap.horizontalGrouping, horizontalGroupingRenderOptions);
          ...
          module('Standard scrolling', () => {
            ...
            module('groupedDataMap', () => {
              test('it should be generated correctly in vertical group orientation', function (assert) {
                ...
                const expectedGroupedDataMap = {
                  ...
                  dateTableGroupedMap: [undefined, undefined, [[{
                ...
                assert.deepEqual(viewDataProvider.groupedDataMap, expectedGroupedDataMap, 'Grouped data is correct');
              });
              test('it should be generated correctly in horizontal group orientation', function (assert) {
                ...
                const expectedGroupedDataMap = {
                  allDayPanelGroupedMap: [undefined, undefined, [{
                    cellData: viewDataMap[0][0],
                    position: {
                      rowIndex: 0,
                      columnIndex: 0
                ...
                assert.deepEqual(this.viewDataProvider.groupedDataMap, expectedGroupedDataMap, 'Grouped data is correct');
              });
            });
            ...
            test('timePanelData should be generated correctly', function (assert) {
              ...
              const expectedTimePanelMap = {
                groupedData: [{
                  dateTable: [completeTimePanelMap[0], completeTimePanelMap[1]],
                  groupIndex: 0,
                  isGroupedAllDayPanel: false,
                  key: '0'
                }, {
                  dateTable: [completeTimePanelMap[2], completeTimePanelMap[3]],
                  groupIndex: 1,
                  isGroupedAllDayPanel: false,
                  key: '1'
                }],
            ...
            test('timePanelData should be generated correctly when all-day panel is present', function (assert) {
              ...
              const expectedTimePanelMap = {
                groupedData: [{
                  ...
                  dateTable: [completeTimePanelMap[1]],
                  groupIndex: 0,
                  isGroupedAllDayPanel: true,
                  key: '0'
                }],
          ...
          module('Vertical virtual scrolling', () => {
            ...
            module('viewDataMap', () => {
              test('viewDataMap should be generated correctly if vertical grouping', function (assert) {
                ...
                assert.deepEqual(viewDataMap, expectedViewDataMap, 'View data map is correct');
              });
            ...
            module('groupedDataMap', () => {
              test('groupedDataMap should be generated correctly if vertical grouping', function (assert) {
                ...
                assert.deepEqual(groupedDataMap, expectedGroupedDataMap, 'View data map is correct');
              });
            ...
            test('timePanelData should be generated correctly when virtual scrolling is used', function (assert) {
              ...
              const expectedTimePanelMap = {
                groupedData: [{
                  ...
                  dateTable: [completeTimePanelMap[2]],
                  groupIndex: 1,
                  key: '1',
                  isGroupedAllDayPanel: false
                }],
          ...
          module('Horizontal virtual scrolling', () => {
            ...
            module('viewDataMap', () => {
              ...
              test('viewDataMap should be generated correctly if horizontal grouping', function (assert) {
                ...
                assert.deepEqual(viewDataProvider.viewDataMap, expectedViewDataMap, 'View data map is correct');
              });
            });
            module('groupedDataMap', () => {
              test('groupedDataMap should be generated correctly if vertical grouping', function (assert) {
              ...
              test('groupedDataMap should be generated correctly if horizontal grouping', function (assert) {
                ...
                const groupedDataMap = viewDataProvider.groupedDataMap;
                assert.deepEqual(expectedGroupedDataMap, groupedDataMap, 'View data map is correct');
              });
            });
            test('dateHeaderMap should be generated correctly', function (assert) {
              const viewDataProvider = createViewDataProvider({
            ...
            test('dateHeaderMap should be generated correctly in timelines when one week-day cell is visible', function (assert) {
              ...
              const dateHeaderMap = [[timelineCompleteDateHeaderMap[0][0]], [timelineCompleteDateHeaderMap[1][2], timelineCompleteDateHeaderMap[1][3]]];
              const dateHeaderData = {
                dataMap: dateHeaderMap,
            ...
            test('dateHeaderMap should be generated correctly in timelines when several week-day cells are visible', function (assert) {
              ...
              const dateHeaderMap = [[timelineCompleteDateHeaderMap[0][0], timelineCompleteDateHeaderMap[0][1]], [timelineCompleteDateHeaderMap[1][2], timelineCompleteDateHeaderMap[1][3], timelineCompleteDateHeaderMap[1][4], timelineCompleteDateHeaderMap[1][5]]];
              const dateHeaderData = {
                dataMap: dateHeaderMap,
                leftVirtualCellCount: 2,
                leftVirtualCellWidth: 200,
            ...
            test('dateHeaderMap should be generated correctly in timelines when grouping by date is used', function (assert) {
              const validTimelineCompleteDateHeaderMap = [[...timelineCompleteDateHeaderMap[0], {
              ...
              const completeViewDataMap = [validTimelineCompleteDateHeaderMap[1], validTimelineCompleteDateHeaderMap[1]];
              const viewDataProvider = createViewDataProvider({
                renderOptions: {
                  ...virtualHorizontalGroupingRenderOptions,
                  isGenerateWeekDaysHeaderData: true,
              ...
              const dateHeaderMap = [[validTimelineCompleteDateHeaderMap[0][0], validTimelineCompleteDateHeaderMap[0][1]], [validTimelineCompleteDateHeaderMap[1][2], validTimelineCompleteDateHeaderMap[1][3], validTimelineCompleteDateHeaderMap[1][4], validTimelineCompleteDateHeaderMap[1][5], validTimelineCompleteDateHeaderMap[1][6], validTimelineCompleteDateHeaderMap[1][7]]];
              const dateHeaderData = {
                dataMap: dateHeaderMap,
