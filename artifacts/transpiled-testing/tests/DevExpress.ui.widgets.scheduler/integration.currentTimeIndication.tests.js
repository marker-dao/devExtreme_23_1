System.register(["../../helpers/scheduler/helpers.js", "core/utils/date", "generic_light.css!", "ui/scheduler/ui.scheduler"], function (_export, _context) {
  "use strict";

  var createWrapper, initTestMarkup, CLASSES, toMs, testStart, module, test, NOW, HOUR, CURRENT_TIME_CELL_CLASS, HEADER_PANEL_CURRENT_TIME_CELL_CLASS;
  return {
    setters: [function (_helpersSchedulerHelpersJs) {
      ...
      toMs = _coreUtilsDate.dateToMilliseconds;
    ...
    execute: function () {
      ...
      NOW = new Date(2020, 11, 9, 12, 15);
      HOUR = 3600000;
      CURRENT_TIME_CELL_CLASS = CLASSES.currentTimeCell.slice(1);
      HEADER_PANEL_CURRENT_TIME_CELL_CLASS = CLASSES.headerPanelCurrentTimeCell.slice(1);
      ...
      module('Current Time Cell Indication Updating', {
        ...
        const testTimelineView = (assert, scheduler, clock, timeDifference, currentTimeCellsNumber, cellIndices) => {
      ...
      module('Common cases', () => {
        test('Current time indicator calculates position correctly with workWeek view (T750252)', function (assert) {
          ...
          const position = {
            top: $dateTimeIndicator.style.top,
            left: $dateTimeIndicator.style.left
          };
          assert.notDeepEqual(position, {
            left: 0,
            top: 0
