System.register(["jquery", "core/devices", "generic_light.css!", "animation/fx", "data/data_source/data_source", "core/utils/size", "data/custom_store", "color", "animation/translator", "ui/scheduler/ui.scheduler", "../../helpers/scheduler/helpers.js", "ui/scheduler/resources/utils"], function (_export, _context) {
  "use strict";

  var $, devices, fx, DataSource, getOuterHeight, CustomStore, Color, translator, createWrapper, initTestMarkup, getOrLoadResourceItem, moduleConfig;
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_coreDevices) {
      devices = _coreDevices.default;
    }, function (_generic_lightCss) {}, function (_animationFx) {
    ...
    }, function (_uiSchedulerUiScheduler) {}, function (_helpersSchedulerHelpersJs) {
      ...
      getOrLoadResourceItem = _uiSchedulerResourcesUtils.getOrLoadResourceItem;
    }],
    execute: function () {
      ...
      QUnit.module('Integration: Resources', moduleConfig, () => {
        ...
        QUnit.test('Alias for getOrLoadResourceItem method', function (assert) {
          ...
          getOrLoadResourceItem(instance.option('resources'), instance.option('resourceLoaderMap'), 'ownerId', 1).done(function (resource) {
      ...
      if (devices.real().deviceType === 'desktop') {
        const desktopModuleConfig = {
          beforeEach: function () {
            ...
            $('#qunit-fixture').html(`<div style="width: 400px; height: 500px;">
        ...
        QUnit.module('Integration: Multiple resources', desktopModuleConfig, () => {
          ...
          QUnit.test('Scheduler with multiple resources and fixed height container has visible horizontal scrollbar (T716993)', function (assert) {
            ...
            assert.roughEqual(scrollbar.offset().top + scrollbar.outerHeight(), getOuterHeight(scheduler.instance.$element()) - 1, 1, 'Horizontal scrollbar has visible top coordinate');
          });
        });
      }
    }
