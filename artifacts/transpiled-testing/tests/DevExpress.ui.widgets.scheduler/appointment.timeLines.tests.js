System.register(["jquery", "animation/fx", "../../helpers/pointerMock.js", "../../helpers/scheduler/helpers.js", "ui/scheduler/ui.scheduler", "ui/switch", "generic_light.css!"], function (_export, _context) {
  "use strict";

  var $, fx, pointerMock, initTestMarkup, CLASSES, createWrapper, module, test, skip, DATE_TABLE_CELL_CLASS, APPOINTMENT_CLASS, APPOINTMENT_DEFAULT_TOP_OFFSET, createInstanceBase;
  return {
