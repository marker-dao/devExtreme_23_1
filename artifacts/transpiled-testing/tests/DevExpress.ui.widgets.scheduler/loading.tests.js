...
(["testing/tests/DevExpress.ui.widgets.scheduler/loading.tests.js"], ["jquery","ui/scheduler/loading","core/utils/view_port","animation/fx","ui/load_panel"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.ui.widgets.scheduler/loading.tests.js', ['jquery', 'ui/scheduler/loading', 'core/utils/view_port', 'animation/fx', 'ui/load_panel'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const loading = $__require('ui/scheduler/loading');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/scheduler/loading","core/utils/view_port","animation/fx","ui/load_panel"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/scheduler/loading"), require("core/utils/view_port"), require("animation/fx"), require("ui/load_panel"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=loading.tests.js.map