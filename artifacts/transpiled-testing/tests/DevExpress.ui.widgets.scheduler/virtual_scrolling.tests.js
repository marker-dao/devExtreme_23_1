System.register(["jquery", "ui/scheduler/workspaces/ui.scheduler.virtual_scrolling", "core/dom_adapter", "events/core/events_engine", "events/utils/index"], function (_export, _context) {
  "use strict";

  var $, VirtualScrollingDispatcher, domAdapter, eventsEngine, addNamespace, module, test;
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_uiSchedulerWorkspacesUiSchedulerVirtual_scrolling) {
      VirtualScrollingDispatcher = _uiSchedulerWorkspacesUiSchedulerVirtual_scrolling.VirtualScrollingDispatcher;
    }, function (_coreDom_adapter) {
      domAdapter = _coreDom_adapter.default;
    }, function (_eventsCoreEvents_engine) {
      eventsEngine = _eventsCoreEvents_engine.default;
    }, function (_eventsUtilsIndex) {
      addNamespace = _eventsUtilsIndex.addNamespace;
    }],
    execute: function () {
      ({
        module,
      ...
      module('Virtual Scrolling', {
        ...
        module('Dispatcher', () => {
          ...
          ['both', 'vertical', 'horizontal'].forEach(orientation => {
            [0, -1, undefined, NaN, null].forEach(testValue => {
        ...
        module('API', () => {
          test('reinitState', function (assert) {
            ...
            assert.deepEqual(this.verticalVirtualScrolling.state, {
              prevPosition: 0,
              startIndex: 0,
              itemCount: 1,
            ...
            assert.deepEqual(this.horizontalVirtualScrolling.state, {
              itemCount: 4,
              outlineCountAfter: 1,
          ...
          module('Vertical', () => {
            test('State should be correct on scrolling Down', function (assert) {
              ...
              [{
                ...
                bottomVirtualRowCount: 87,
                rowCount: 12
              }, {
                top: 3980,
                stateTop: 3950,
                topVirtualRowCount: 76,
                bottomVirtualRowCount: 12,
                rowCount: 12
              }, {
                top: 4950,
                stateTop: 4700,
                topVirtualRowCount: 91,
            ...
            test('Check virtual rows height', function (assert) {
              ...
              [{
                ...
                top: 150,
                bottomVirtualRowHeight: 4400,
                topVirtualRowHeight: 0
              }, {
                top: 3980,
                bottomVirtualRowHeight: 600,
                topVirtualRowHeight: 3800
              }, {
                top: 4950,
                bottomVirtualRowHeight: 0,
                topVirtualRowHeight: 4550
              }].forEach(step => {
                assert.ok(true, `Scroll top ${step.top}`);
                this.virtualScrollingDispatcher.handleOnScrollEvent({
                  top: step.top
            ...
            test('Scroll event position should be checked correctly before update state', function (assert) {
              ...
              [{
                ...
                assert.equal(spy.getCall(index).returnValue, option.expectedNeedUpdate, `State updated ${option.expectedNeedUpdate} if scrollY: ${option.y}`);
              });
            });
          });
          module('Horizontal', () => {
            test('Check state while scrolling to the Right', function (assert) {
              ...
              [{
                ...
                stateLeft: 12300,
                leftOutlineCount: 2,
                leftVirtualCellCount: 80,
                rightVirtualCellCount: 112,
                rightOutlineCount: 2,
                cellCount: 8
              }, {
                left: 29000,
            ...
            test('Check virtual cells width', function (assert) {
              ...
              [{
                ...
                rightVirtualCellWidth: 28500
              }, {
                left: 900,
                leftVirtualCellWidth: 600,
                rightVirtualCellWidth: 28200
              }, {
                left: 29000,
                leftVirtualCellWidth: 28650,
                rightVirtualCellWidth: 150
              }, {
                left: 30000,
                leftVirtualCellWidth: 29100,
            ...
            test('Scroll event position should be checked correctly before update state11', function (assert) {
              ...
              [{
                ...
                assert.equal(spy.getCall(index).returnValue, option.expectedNeedUpdate, `State updated "${option.expectedNeedUpdate}" if scrollLeft: ${option.left}`);
              });
            });
          });
        });
