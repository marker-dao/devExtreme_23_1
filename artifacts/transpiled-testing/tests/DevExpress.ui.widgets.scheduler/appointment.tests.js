System.register(["jquery", "ui/scheduler/appointments/appointment", "core/utils/deferred", "animation/fx"], function (_export, _context) {
  "use strict";

  var $, Appointment, Deferred, fx, module, test, testStart, CELL_HEIGHT, CELL_WIDTH, APPOINTMENT_DRAG_SOURCE_CLASS, createInstance, moduleOptions;
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_uiSchedulerAppointmentsAppointment) {
      Appointment = _uiSchedulerAppointmentsAppointment.Appointment;
    ...
    execute: function () {
      ...
      CELL_HEIGHT = 20;
      CELL_WIDTH = 25;
      APPOINTMENT_DRAG_SOURCE_CLASS = 'dx-scheduler-appointment-drag-source';
      testStart(function () {
      ...
      module('Appointments', moduleOptions, () => {
        ...
        test('Appointment should process "isDragSource" property', function (assert) {
          const instance = createInstance();
          assert.ok(!instance.$element().hasClass(APPOINTMENT_DRAG_SOURCE_CLASS), 'Appointment is not a drag source by default');
          instance.option('isDragSource', true);
          assert.ok(instance.$element().hasClass(APPOINTMENT_DRAG_SOURCE_CLASS), 'Appointment is a drag source by');
        });
      });
    }
  };
