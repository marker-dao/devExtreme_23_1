System.register(["core/utils/size", "jquery", "animation/fx", "core/utils/type", "core/config", "../../helpers/scheduler/helpers.js", "core/utils/date"], function (_export, _context) {
  "use strict";

  var getOuterWidth, getOuterHeight, $, fx, isRenderer, config, createWrapper, initTestMarkup, dateToMilliseconds, module, testStart, test, moduleConfig;
  return {
    setters: [function (_coreUtilsSize) {
      ...
      dateToMilliseconds = _coreUtilsDate.dateToMilliseconds;
    }],
    execute: function () {
      ({
        module,
      ...
      module('CellTemplate tests', moduleConfig, () => {
        ...
        const checkIfGroupsAreUndefined = assert => ({
          groups,
          groupIndex
        }) => {
        ...
        module('Data Cell template', {}, function () {
          ...
          [true, false].forEach(renovateRender => {
            const description = renovateRender ? 'Renovated Render' : 'Old Render';
            module(description, {}, () => {
          ...
          [{
            ...
            test(`dataCellTemplate should have correct startDate and endDate options in ${view} view` + ` with ${groupOrientation} groupping`, function (assert) {
              const actualDates = [];
              createWrapper({
                views: [{
                  type: view,
          ...
          [{
            ...
            test(`dataCellTemplate should have correct startDate and endDate options in ${view} view` + ' with groupping by date', function (assert) {
              const actualDates = [];
              createWrapper({
                views: [{
                  type: view,
          ...
          [{
            ...
            test(`dataCellTemplate should provide correct options in ${view} view` + ' with intervalCount: 2', function (assert) {
              const actualDates = [];
              createWrapper({
                views: [{
                  type: view,
          ...
          const twoWeekAllDayCells = [new Date(2021, 7, 1), new Date(2021, 7, 2), new Date(2021, 7, 3), new Date(2021, 7, 4), new Date(2021, 7, 5), new Date(2021, 7, 6), new Date(2021, 7, 7), new Date(2021, 7, 8), new Date(2021, 7, 9), new Date(2021, 7, 10), new Date(2021, 7, 11), new Date(2021, 7, 12), new Date(2021, 7, 13), new Date(2021, 7, 14)];
          [{
            view: 'day',
            ...
            test(`allDay cells should have correct options in ${view} view` + 'with intervalCount: 2', function (assert) {
              const actualDates = [];
              createWrapper({
                views: [{
                  type: view,
                ...
                dataCellTemplate: data => {
                  if (data.allDay) {
                    assert.equal(data.startDate.getTime(), data.endDate.getTime(), 'startDate and endDate of allDay cell should be equal');
          ...
          [{
            ...
            test(`allDay cells should have correct options in ${view} view` + ` with ${groupOrientation} grouping`, function (assert) {
              const actualDates = [];
              createWrapper({
                views: [{
                  type: view,
          ...
          [{
            ...
            viewType: 'week',
            expectedTemplateOptions: [...groupedCells.slice(0, 7), ...groupedCells.slice(0, 7), ...groupedCells.slice(7, 14), ...groupedCells.slice(7, 14)]
          }, {
            viewType: 'workWeek',
            expectedTemplateOptions: [...groupedCells.slice(1, 6), ...groupedCells.slice(1, 6), ...groupedCells.slice(8, 13), ...groupedCells.slice(8, 13)].map(({
              index,
              ...restProps
            }) => ({
              ...restProps,
          ...
          [{
            ...
            viewType: 'week',
            expectedTemplateOptions: [...groupedCells.slice(0, 7), ...groupedCells.slice(7, 14), ...groupedCells.slice(0, 7), ...groupedCells.slice(7, 14)]
          }, {
            viewType: 'workWeek',
            expectedTemplateOptions: [...groupedCells.slice(1, 6), ...groupedCells.slice(8, 13), ...groupedCells.slice(1, 6), ...groupedCells.slice(8, 13)].map(({
              index,
              ...restProps
            }) => ({
              ...restProps,
          ...
          const groupedByDateWeek = [groupedCells[0], groupedCells[7], groupedCells[1], groupedCells[8], groupedCells[2], groupedCells[9], groupedCells[3], groupedCells[10], groupedCells[4], groupedCells[11], groupedCells[5], groupedCells[12], groupedCells[6], groupedCells[13]];
          [{
            viewType: 'day',
            expectedTemplateOptions: [groupedCells[0], groupedCells[7], groupedCells[0], groupedCells[7]]
          }, {
            ...
            viewType: 'workWeek',
            expectedTemplateOptions: [...groupedByDateWeek.slice(2, 12), ...groupedByDateWeek.slice(2, 12)].map(({
              index,
              ...restProps
            }) => ({
              ...restProps,
          ...
          [{
            ...
            viewType: 'week',
            expectedTemplateOptions: [...groupedCells.slice(0, 7), ...groupedCells.slice(7, 14)]
          }, {
            viewType: 'workWeek',
            expectedTemplateOptions: [...groupedCells.slice(1, 6), ...groupedCells.slice(8, 13)].map(({
              index,
              ...restProps
            }) => ({
              ...restProps,
          ...
          [true, false].forEach(renovateRender => {
            ...
            module(description, {
              ...
              test('dateCellTemplate should work correctly in workWeek view', function (assert) {
                ...
                this.createInstance({
                  ...
                  dateCellTemplate: function (cellData, index, container) {
                    $(container).append($('<div />').addClass('name').text(dayOfWeekNames[cellData.date.getDay()]), $('<div />').addClass('number').text(cellData.date.getDate()));
                  }
                });
              ...
              [{
                ...
                description: '\'"groups" and "groupIndex" shoud be correct in dateCellTemplate' + 'when vertical grouping is used',
                expectedAsserts: totalDateCells * 2,
                ...
                description: '\'"groups" and "groupIndex" shoud be correct in dateCellTemplate' + 'when grouping by date is used',
                expectedAsserts: totalDateCells * 2,
                views: viewsBase.map(view => ({
                  ...view,
                  groupOrientation: 'horizontal',
                ...
                const scheduler = createWrapper({
                  ...
                  dateCellTemplate: ({
                    ...
                    assert.deepEqual(groups, {
                      ownerId: currentGroupIndex + 1
                    }, 'Groups property is correct');
          ...
          [true, false].forEach(renovateRender => {
            ...
            module(description, {}, () => {
              [{
                ...
                description: '"groups" and "groupIndex" shoud be correct in timeCellTemplate ' + 'when vertical grouping is used in timleine views',
                expectedAsserts: 72,
                ...
                description: '"groups" and "groupIndex" shoud be correct in timeCellTemplate' + ' when grouping by date is used',
                expectedAsserts: totalTimeCells * 2,
                views: viewsBase.map(view => ({
                  ...view,
                  groupOrientation: 'horizontal',
                ...
                description: '"groups" and "groupIndex" shoud be correct in timeCellTemplate' + ' when horizontal grouping is used in simple views',
                expectedAsserts: 16,
              ...
              test('"groups" and "groupIndex" shoud be correct in timeCellTemplate ' + 'when vertical grouping is used in simple views', function (assert) {
                assert.expect(32);
                const views = viewsBase.map(({
                  type,
                  intervalCount
              ...
              test('"groups" and "groupIndex" shoud be correct in timeCellTemplate' + ' when horizontal grouping is used in timeline views', function (assert) {
