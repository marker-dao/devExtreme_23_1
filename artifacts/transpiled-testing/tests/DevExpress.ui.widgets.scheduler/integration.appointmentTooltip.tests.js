System.register(["jquery", "core/utils/date_serialization", "ui/tooltip", "ui/tooltip/ui.tooltip", "core/utils/resize_callbacks", "animation/fx", "localization/date", "localization/message", "data/data_source/data_source", "../../helpers/keyboardMock.js", "core/devices", "core/element_data", "../../helpers/scheduler/helpers.js", "../../helpers/scheduler/data.js", "generic_light.css!", "ui/scheduler/ui.scheduler"], function (_export, _context) {
  "use strict";

  var $, dateSerialization, Tooltip, tooltip, resizeCallbacks, fx, dateLocalization, messageLocalization, DataSource, keyboardMock, devices, dataUtils, createWrapper, initTestMarkup, getSimpleDataArray, dateFormat, timeFormat, testStart, module, test, moduleConfig;
  return {
    ...
    }, function (_helpersSchedulerDataJs) {
      getSimpleDataArray = _helpersSchedulerDataJs.getSimpleDataArray;
    ...
    execute: function () {
      ...
      module('Integration: Appointment tooltip', moduleConfig, () => {
        const createScheduler = options => createWrapper($.extend(options, {
          height: 600
        }));
      ...
      module('New common tooltip for compact and cell appointments', moduleConfig, () => {
        ...
        test('Title in tooltip should equals title of cell appointments in month view', function (assert) {
          ...
          const compactAppointmentSample = [['Install New Router in Dev Room'], ['New Brochures'], ['Upgrade Personal Computers'], ['Brochure Design Review'], ['Upgrade Server Hardware', 'Submit New Website Design']];
