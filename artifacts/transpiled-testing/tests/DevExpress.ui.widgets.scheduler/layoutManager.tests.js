...
(["testing/tests/DevExpress.ui.widgets.scheduler/layoutManager.tests.js"], ["core/utils/size","generic_light.css!","ui/scheduler/ui.scheduler","jquery","../../helpers/keyboardMock.js","../../helpers/pointerMock.js","animation/translator","ui/scheduler/appointments.layout_manager","ui/scheduler/appointments/rendering_strategies/strategy.base","ui/scheduler/appointments/rendering_strategies/strategy_vertical","ui/scheduler/appointments/rendering_strategies/strategy_horizontal","ui/scheduler/appointments/rendering_strategies/strategy_horizontal_month_line","color","core/element_data","data/custom_store","../../helpers/scheduler/helpers.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.scheduler/layoutManager.tests.js", ["core/utils/size", "generic_light.css!", "ui/scheduler/ui.scheduler", "jquery", "../../helpers/keyboardMock.js", "../../helpers/pointerMock.js", "animation/translator", "ui/scheduler/appointments.layout_manager", "ui/scheduler/appointments/rendering_strategies/strategy.base", "ui/scheduler/appointments/rendering_strategies/strategy_vertical", "ui/scheduler/appointments/rendering_strategies/strategy_horizontal", "ui/scheduler/appointments/rendering_strategies/strategy_horizontal_month_line", "color", "core/element_data", "data/custom_store", "../../helpers/scheduler/helpers.js"], function($__export) {
  "use strict";
  var getOuterHeight,
      getOuterWidth,
      $,
      ...
      checkAppointmentUpdatedCallbackArgs,
      moduleOptions;
  return {
    setters: [function($__m) {
      ...
      AppointmentLayoutManager = $__m.default;
    }, function($__m) {
      BaseAppointmentsStrategy = $__m.default;
    }, function($__m) {
      VerticalAppointmentStrategy = $__m.default;
    }, function($__m) {
      HorizontalAppointmentsStrategy = $__m.default;
    }, function($__m) {
      HorizontalMonthLineAppointmentsStrategy = $__m.default;
    }, function($__m) {
      Color = $__m.default;
    }, function($__m) {
    ...
    execute: function() {
      ...
      checkAppointmentUpdatedCallbackArgs = function(assert, actual, expected) {
      ...
      moduleOptions = {
        beforeEach: function() {
          ...
          this.createInstance = function(options) {
            $__3.instance = $('#scheduler').dxScheduler($.extend(options, {
              editing: true,
              height: options && options.height || 600
            })).dxScheduler('instance');
            $__3.scheduler = new SchedulerTestWrapper($__3.instance);
          };
        },
        afterEach: function() {}
      };
      ...
      QUnit.test('Exception should be thrown if appointment has no start date', function(assert) {
        ...
        assert.throws(function() {
          layoutManager.createAppointmentsMap([{text: 'Appointment 1'}]);
        }, function(e) {
      ...
      QUnit.test('Appointment should have a correct height when dates are defined as not Date objects', function(assert) {
        this.createInstance({
          ...
          dataSource: [{
            text: 'Appointment 1',
            startDate: 1423458000000,
            endDate: 1423461600000
          }]
        });
        var $appointment = $(this.instance.$element().find('.dx-scheduler-appointment'));
        assert.equal(getOuterHeight($appointment), 100, 'Appointment has a right height');
      ...
      QUnit.test('Appointment has right sortedIndex', function(assert) {
        this.createInstance({
          ...
          dataSource: [{
            ...
            text: 'Appointment 3',
            startDate: new Date(2015, 9, 18, 8),
            endDate: new Date(2015, 9, 18, 10)
          }, {
            text: 'Appointment 4',
            startDate: new Date(2015, 9, 19, 8),
            endDate: new Date(2015, 9, 19, 10)
          }]
        });
      ...
      QUnit.test('AllDay appointment should be displayed right when endDate > startDate and duration < 24', function(assert) {
        ...
        var $appointment = $(this.instance.$element().find('.dx-scheduler-appointment'));
        var $allDayCell = $(this.instance.$element().find('.dx-scheduler-all-day-table-cell'));
      ...
      QUnit.test('Two rival appointments should have correct positions', function(assert) {
        this.createInstance({
          ...
          dataSource: [{
            text: 'Appointment 1',
            startDate: new Date(2015, 1, 1, 8),
            endDate: new Date(2015, 1, 1, 10)
          }, {
            text: 'Appointment 1',
            startDate: new Date(2015, 1, 1, 8),
            endDate: new Date(2015, 1, 1, 10)
      ...
      QUnit.test('Four rival appointments should have correct positions', function(assert) {
        this.createInstance({
          ...
          dataSource: [{
            text: 'Appointment 1',
            startDate: new Date(2015, 1, 1, 8),
            endDate: new Date(2015, 1, 1, 12)
          }, {
            text: 'Appointment 2',
            startDate: new Date(2015, 1, 1, 9),
            endDate: new Date(2015, 1, 1, 12)
          }, {
            text: 'Appointment 3',
            startDate: new Date(2015, 1, 1, 11),
            endDate: new Date(2015, 1, 1, 12)
          }, {
            text: 'Appointment 4',
            startDate: new Date(2015, 1, 1, 10),
            endDate: new Date(2015, 1, 1, 12)
          }]
        });
      ...
      QUnit.test('Rival duplicated appointments should have correct positions', function(assert) {
        this.createInstance({
          ...
          dataSource: [{
            ...
            text: 'Appointment 2',
            startDate: new Date(2015, 1, 1, 8),
            endDate: new Date(2015, 1, 2, 9)
          }]
        });
        var $appointment = $(this.instance.$element().find('.dx-scheduler-appointment'));
        var $tableCell = $(this.instance.$element().find('.dx-scheduler-date-table-cell').eq(0));
        var firstAppointmentPosition = translator.locate($appointment.eq(0));
        var secondAppointmentPosition = translator.locate($appointment.eq(1));
      ...
      QUnit.test('Start date of appointment should be changed when resize is finished', function(assert) {
        var item = {
          ...
          endDate: new Date(2015, 1, 5, 0)
        };
        var updatedItem = $.extend({}, item, {startDate: new Date(2015, 1, 3, 0)});
        this.createInstance({
      ...
      QUnit.test('End date of appointment should be changed when resize is finished', function(assert) {
        ...
        var updatedItem = $.extend({}, item, {endDate: new Date(2015, 1, 6, 0)});
        this.createInstance({
          currentDate: new Date(2015, 1, 4),
          currentView: 'timelineMonth',
          height: 500,
      ...
      QUnit.test('Start date of appointment should be changed when resize is finished', function(assert) {
        var item = {
          ...
          endDate: new Date(2015, 1, 2, 0)
        };
        var updatedItem = $.extend({}, item, {startDate: new Date(2015, 1, 1, 0, 30)});
        this.createInstance({
      ...
      QUnit.test('Start date of the long-time reduced appointment should be changed correctly when resize is finished', function(assert) {
        var item = {
          text: 'Appointment 1',
          startDate: new Date(2015, 2, 15, 2),
          endDate: new Date(2015, 2, 23, 0)
        };
        var updatedItem = $.extend({}, item, {startDate: new Date(2015, 2, 15, 0)});
        this.createInstance({
          currentDate: new Date(2015, 2, 15),
          views: ['timelineWeek'],
          currentView: 'timelineWeek',
      ...
      QUnit.test('End date of appointment should be changed when resize is finished', function(assert) {
        ...
        var updatedItem = $.extend({}, item, {endDate: new Date(2015, 1, 5, 0, 30)});
        this.createInstance({
          currentDate: new Date(2015, 1, 4),
          views: ['timelineWeek'],
          currentView: 'timelineWeek',
      ...
      QUnit.test('Start date of appointment should be changed when resize is finished, RTL mode', function(assert) {
        var item = {
          text: 'Appointment 1',
          startDate: new Date(2015, 1, 4, 10),
          endDate: new Date(2015, 1, 5, 0)
        };
        var updatedItem = $.extend({}, item, {startDate: new Date(2015, 1, 4, 9, 30)});
        this.createInstance({
          currentDate: new Date(2015, 1, 4),
          views: ['timelineWeek'],
          currentView: 'timelineWeek',
      ...
      QUnit.test('End date of appointment should be changed considering endDayHour and startDayHour when resize is finished', function(assert) {
        var item = {
          text: 'Appointment 1',
          startDate: new Date(2015, 1, 9, 18),
          endDate: new Date(2015, 1, 9, 19)
        };
        var updatedItem = $.extend({}, item, {endDate: new Date(2015, 1, 10, 10)});
        this.createInstance({
          currentDate: new Date(2015, 1, 9),
          views: ['timelineWeek'],
          currentView: 'timelineWeek',
      ...
      QUnit.test('Start date of appointment should be changed considering endDayHour and startDayHour when resize is finished', function(assert) {
        ...
        var updatedItem = $.extend({}, item, {startDate: new Date(2015, 1, 8, 19)});
        this.createInstance({
          currentDate: new Date(2015, 1, 9),
          views: ['timelineWeek'],
          currentView: 'timelineWeek',
      ...
      QUnit.test('Start date of long multiday appointment should be changed considering endDayHour and startDayHour when resize is finished', function(assert) {
        ...
        var updatedItem = $.extend({}, item, {startDate: new Date(2015, 1, 7, 18)});
        this.createInstance({
          currentDate: new Date(2015, 1, 9),
          views: ['timelineWeek'],
          currentView: 'timelineWeek',
        ...
        var stub = sinon.stub(this.instance.getAppointmentsInstance(), 'notifyObserver').withArgs('updateAppointmentAfterResize');
        var pointer = pointerMock(this.instance.$element().find('.dx-resizable-handle-left')).start();
        var tableCellWidth = getOuterWidth(this.instance.$element().find('.dx-scheduler-date-table-cell').eq(0));
        var cellsCount = 15 * 2;
      ...
      QUnit.test('End date of long multiday appointment should be changed considering endDayHour and startDayHour when resize is finished', function(assert) {
        ...
        var updatedItem = $.extend({}, item, {endDate: new Date(2015, 1, 11, 10)});
        this.createInstance({
          currentDate: new Date(2015, 1, 9),
          views: ['timelineWeek'],
          currentView: 'timelineWeek',
      ...
      QUnit.test('Four rival appointments should have correct positions', function(assert) {
        ...
        assert.deepEqual(translator.locate($appointment.eq(0)), {
          top: 0,
          left: 0
        }, 'appointment is rendered in right place');
      ...
      QUnit.test('Four rival appointments should have correct sizes', function(assert) {
        ...
        var $appointment = $(this.instance.$element().find('.dx-scheduler-appointment'));
        var tableCellWidth = getOuterWidth(this.instance.$element().find('.dx-scheduler-date-table-cell').eq(0)) * 2;
      ...
      QUnit.test('Start date of appointment should be changed when resize is finished', function(assert) {
        ...
        var updatedItem = $.extend({}, item, {startDate: new Date(2015, 1, 9, 7)});
        this.createInstance({
          currentDate: new Date(2015, 1, 9),
          currentView: 'day',
          height: 530,
      ...
      QUnit.test('End date of appointment should be changed when resize is finished', function(assert) {
        ...
        var updatedItem = $.extend({}, item, {endDate: new Date(2015, 1, 9, 10)});
        this.createInstance({
          currentDate: new Date(2015, 1, 9),
          currentView: 'day',
          height: 530,
      ...
      QUnit.test('Two rival appointments should have correct positions, vertical strategy', function(assert) {
        ...
        var $appointment = $(this.instance.$element().find('.dx-scheduler-appointment'));
        var $tableCell = $(this.instance.$element().find('.dx-scheduler-date-table-cell').eq(0));
        var cellHeight = $tableCell.get(0).getBoundingClientRect().height;
        var cellWidth = $tableCell.get(0).getBoundingClientRect().width;
        var offset = APPOINTMENT_DEFAULT_LEFT_OFFSET;
        assert.equal($appointment.length, 2, 'All appointments are rendered');
        var firstAppointmentPosition = translator.locate($appointment.eq(0));
        var secondAppointmentPosition = translator.locate($appointment.eq(1));
      ...
      QUnit.test('Three rival appointments with two columns should have correct positions, vertical strategy', function(assert) {
        ...
        var firstAppointmentPosition = translator.locate($appointment.eq(0));
        var secondAppointmentPosition = translator.locate($appointment.eq(1));
        var thirdAppointmentPosition = translator.locate($appointment.eq(2));
      ...
      QUnit.test('Four rival appointments with three columns should have correct positions, vertical strategy', function(assert) {
        ...
        var cellHeight = this.scheduler.workSpace.getCellHeight();
        var cellWidth = this.scheduler.workSpace.getCellWidth();
        var unlimitedModeOffset = 5;
        var expectedAppWidth = (cellWidth - unlimitedModeOffset) / 3;
        assert.equal(this.scheduler.appointments.getAppointmentCount(), 4, 'All appointments are rendered');
        assert.deepEqual(this.scheduler.appointments.getAppointmentPosition(0), {
          top: 0,
          left: cellWidth
        }, 'appointment is rendered in right place');
        assert.roughEqual(this.scheduler.appointments.getAppointmentWidth(0), expectedAppWidth, 1, 'appointment has a right size');
        assert.deepEqual(this.scheduler.appointments.getAppointmentPosition(1), {
          top: 2 * cellHeight,
          left: cellWidth + 2 * expectedAppWidth
        }, 'appointment is rendered in right place');
        assert.roughEqual(this.scheduler.appointments.getAppointmentWidth(1), expectedAppWidth, 1, 'appointment has a right size');
        assert.deepEqual(this.scheduler.appointments.getAppointmentPosition(2), {
          top: 0,
          left: cellWidth + expectedAppWidth
        }, 'appointment is rendered in right place');
        assert.roughEqual(this.scheduler.appointments.getAppointmentWidth(2), expectedAppWidth, 1, 'appointment has a right size');
        assert.deepEqual(this.scheduler.appointments.getAppointmentPosition(3), {
          top: 4 * cellHeight,
          left: cellWidth + expectedAppWidth
        }, 'appointment is rendered in right place');
      ...
      QUnit.test('Rival duplicated appointments should have correct positions', function(assert) {
        this.createInstance({
          ...
          dataSource: [{
            ...
            text: 'Appointment 2',
            startDate: new Date(2015, 1, 10, 8),
            endDate: new Date(2015, 1, 10, 9)
          }, {
            text: 'Appointment 3',
            startDate: new Date(2015, 1, 10, 8),
            endDate: new Date(2015, 1, 10, 9)
      ...
      QUnit.test('All day appointments should have correct left position, vertical strategy, rtl mode', function(assert) {
        ...
        var appointmentPosition = translator.locate($appointment.eq(0));
      ...
      QUnit.testInActiveWindow('Apps should be focused in right order', function(assert) {
        this.createInstance({
          ...
          dataSource: [{
            text: 'Appointment 1',
            startDate: new Date(2015, 9, 11, 9),
            endDate: new Date(2015, 9, 11, 11)
          }, {
            text: 'Appointment 2',
            startDate: new Date(2015, 9, 12, 8),
            endDate: new Date(2015, 9, 12, 10)
          }, {
            text: 'Appointment 3',
            startDate: new Date(2015, 9, 13, 8),
            endDate: new Date(2015, 9, 13, 10)
          }, {
            text: 'Appointment 4',
            startDate: new Date(2015, 9, 14, 8),
            endDate: new Date(2015, 9, 14, 10)
          }]
        });
        var $appointments = $(this.instance.$element().find('.dx-scheduler-appointment'));
        var apptInstance = this.instance.getAppointmentsInstance();
      ...
      QUnit.testInActiveWindow('Apps should be focused in right order on month view with ddAppointments', function(assert) {
        this.createInstance({
          ...
          dataSource: [{
            ...
            text: 'Appointment 2',
            startDate: new Date(2015, 9, 11, 8),
            endDate: new Date(2015, 9, 11, 10)
          }, {
            text: 'Appointment 3',
            startDate: new Date(2015, 9, 11, 8),
            endDate: new Date(2015, 9, 11, 10)
      ...
      QUnit.test('Full-size appointment count depends on maxAppointmentsPerCell option', function(assert) {
        var items = [{
          text: 'Task 1',
          startDate: new Date(2015, 2, 4, 2, 0),
          endDate: new Date(2015, 2, 4, 3, 0)
        }, {
          text: 'Task 2',
          startDate: new Date(2015, 2, 4, 7, 0),
          endDate: new Date(2015, 2, 4, 12, 0)
        }, {
          text: 'Task 3',
          startDate: new Date(2015, 2, 4, 2, 0),
          endDate: new Date(2015, 2, 4, 5, 0)
        }, {
          text: 'Task 4',
          startDate: new Date(2015, 2, 4, 6, 0),
          endDate: new Date(2015, 2, 4, 8, 0)
        }];
        this.createInstance({
        ...
        var tableCellWidth = getOuterWidth(this.instance.$element().find('.dx-scheduler-date-table-cell').eq(0));
        for (var i = 0; i < 2; i++) {
          var appointmentWidth = getOuterWidth($appointment.eq(i));
      ...
      QUnit.test('Full-size appointment count depends on maxAppointmentsPerCell option, height is small "auto" mode', function(assert) {
        ...
        var dropDownMenuText = $dropDownMenu.find('span').first().text();
      ...
      QUnit.test('Full-size appointment count depends on maxAppointmentsPerCell option, Day view', function(assert) {
        ...
        var $appointment = $(this.instance.$element().find('.dx-scheduler-all-day-appointment'));
        var tableCellWidth = getOuterWidth(this.instance.$element().find('.dx-scheduler-all-day-table-cell').eq(0));
        var tableCellHeight = getOuterHeight(this.instance.$element().find('.dx-scheduler-all-day-table-cell').eq(0));
        for (var i = 0; i < 3; i++) {
          var appointmentWidth = getOuterWidth($appointment.eq(i));
          var appointmentHeight = getOuterHeight($appointment.eq(i));
          assert.roughEqual(appointmentWidth, tableCellWidth, 1.5, 'appointment is full-size');
      ...
      QUnit.test('Appointment should have an unchangeable height, Day view, \'auto\' mode', function(assert) {
        ...
        var $appointment = $(this.instance.$element().find('.dx-scheduler-all-day-appointment'));
        var tableCellHeight = getOuterHeight(this.instance.$element().find('.dx-scheduler-all-day-table-cell').eq(0));
        var appointmentHeight = (tableCellHeight - 24) / 2;
      ...
      QUnit.test('One full-size appointment should have a correct height, Week view, \'unlimited\' mode', function(assert) {
        ...
        var tableCellHeight = getOuterHeight(this.instance.$element().find('.dx-scheduler-all-day-table-cell').eq(0));
        assert.roughEqual(getOuterHeight($(this.instance.$element().find('.dx-scheduler-all-day-appointment')).eq(0)), tableCellHeight, 1.5, 'appointment height is correct');
      });
      ...
      QUnit.test('Full-size appointment count depends on maxAppointmentsPerCell option, \'numeric\' mode', function(assert) {
        var items = [{
          text: 'Task 1',
          startDate: new Date(2015, 2, 1, 2, 0),
          endDate: new Date(2015, 2, 1, 4, 0)
        }, {
          text: 'Task 2',
          startDate: new Date(2015, 2, 1, 0, 0),
          endDate: new Date(2015, 2, 1, 2, 0)
        }, {
          text: 'Task 3',
          startDate: new Date(2015, 2, 1, 2, 0),
          endDate: new Date(2015, 2, 1, 5, 0)
        }, {
          text: 'Task 4',
          startDate: new Date(2015, 2, 1, 1, 0),
          endDate: new Date(2015, 2, 1, 2, 0)
        }, {
          text: 'Task 5',
          startDate: new Date(2015, 2, 1, 1, 0),
          endDate: new Date(2015, 2, 1, 3, 0)
        }, {
          text: 'Task 6',
          startDate: new Date(2015, 2, 1, 1, 0),
          endDate: new Date(2015, 2, 1, 3, 0)
        ...
        var $appointment = $(this.instance.$element().find('.dx-scheduler-appointment'));
        var tableCellHeight = getOuterHeight(this.instance.$element().find('.dx-scheduler-date-table-cell').eq(0));
        for (var i = 0; i < 3; i++) {
          var appointmentHeight = getOuterHeight($appointment.eq(i));
      ...
      QUnit.test('Full-size appointment count depends on maxAppointmentsPerCell option, \'unlimited\' mode', function(assert) {
        ...
        var $appointment = $(this.instance.$element().find('.dx-scheduler-appointment'));
        var tableCellHeight = getOuterHeight(this.instance.$element().find('.dx-scheduler-date-table-cell').eq(0));
        var appointmentHeight = getOuterHeight($appointment.eq(0));
        assert.roughEqual(appointmentHeight, tableCellHeight, 1.5, 'appointment is full-size');
        this.instance.option('dataSource', items);
        $appointment = $(this.instance.$element().find('.dx-scheduler-appointment')), tableCellHeight = getOuterHeight(this.instance.$element().find('.dx-scheduler-date-table-cell').eq(0));
        for (var i = 0; i < 5; i++) {
      ...
      QUnit.test('Full-size appointment should have correct size, \'auto\' mode', function(assert) {
        ...
        var tableCellWidth = getOuterWidth(this.instance.$element().find('.dx-scheduler-date-table-cell').eq(0));
        var appointmentWidth = getOuterWidth($appointment);
        var offset = APPOINTMENT_DEFAULT_LEFT_OFFSET;
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/size","generic_light.css!","ui/scheduler/ui.scheduler","jquery","../../helpers/keyboardMock.js","../../helpers/pointerMock.js","animation/translator","ui/scheduler/appointments.layout_manager","ui/scheduler/appointments/rendering_strategies/strategy.base","ui/scheduler/appointments/rendering_strategies/strategy_vertical","ui/scheduler/appointments/rendering_strategies/strategy_horizontal","ui/scheduler/appointments/rendering_strategies/strategy_horizontal_month_line","color","core/element_data","data/custom_store","../../helpers/scheduler/helpers.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/size"), require("generic_light.css!"), require("ui/scheduler/ui.scheduler"), require("jquery"), require("../../helpers/keyboardMock.js"), require("../../helpers/pointerMock.js"), require("animation/translator"), require("ui/scheduler/appointments.layout_manager"), require("ui/scheduler/appointments/rendering_strategies/strategy.base"), require("ui/scheduler/appointments/rendering_strategies/strategy_vertical"), require("ui/scheduler/appointments/rendering_strategies/strategy_horizontal"), require("ui/scheduler/appointments/rendering_strategies/strategy_horizontal_month_line"), require("color"), require("core/element_data"), require("data/custom_store"), require("../../helpers/scheduler/helpers.js"));
  else
