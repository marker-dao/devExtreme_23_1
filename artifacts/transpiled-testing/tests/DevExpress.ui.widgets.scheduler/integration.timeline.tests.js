System.register(["jquery", "generic_light.css!", "animation/fx", "data/data_source/data_source", "core/devices", "ui/scheduler/ui.scheduler", "../../helpers/scheduler/helpers.js"], function (_export, _context) {
  "use strict";

  var $, fx, DataSource, devices, SchedulerTestWrapper, createWrapper, createInstance;
  return {
    ...
    `);
      ...
      QUnit.test('Scheduler should not update scroll position if appointment is visible, timeline month view ', function (assert) {
        ...
        const appointment = {
          startDate: new Date(2015, 2, 29, 6),
          endDate: new Date(2015, 2, 29, 8),
          text: 'caption'
        };
      ...
      QUnit.test('Scheduler timeline dateTable should have right height after changing size if crossScrollingEnabled = true (T644407)', function (assert) {
        ...
        const $firstRowCell = scheduler.workSpace.getCell(0);
        const cellHeight = $firstRowCell.height();
        ...
        QUnit.module('Integration: Work space: Multiple selection when dragging is not enabled', {
          ...
          [{
            ...
            QUnit.test(`Multiple selection should work in ${view} when dragging is not enabled`, function (assert) {
              ...
              assert.deepEqual(instance.option('selectedCellData'), [{
