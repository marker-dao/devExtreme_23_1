System.register(["core/utils/size", "jquery", "animation/translator", "animation/fx", "../../helpers/pointerMock.js", "color", "data/data_source/data_source", "data/custom_store", "core/utils/browser", "ui/scheduler/appointmentPopup/form", "../../helpers/scheduler/helpers.js", "ui/scheduler/ui.scheduler", "ui/switch"], function (_export, _context) {
  "use strict";

  var getOuterWidth, getOuterHeight, $, translator, fx, pointerMock, Color, DataSource, CustomStore, browser, APPOINTMENT_FORM_GROUP_NAMES, initTestMarkup, createWrapper, supportedScrollingModes, module, test, testStart, DATE_TABLE_CELL_CLASS, APPOINTMENT_CLASS, APPOINTMENT_DEFAULT_TOP_OFFSET, getAppointmentColor, createInstanceBase;
  return {
    ...
    }, function (_uiSchedulerAppointmentPopupForm) {
      APPOINTMENT_FORM_GROUP_NAMES = _uiSchedulerAppointmentPopupForm.APPOINTMENT_FORM_GROUP_NAMES;
    ...
    }, function (_uiSchedulerUiScheduler) {}, function (_uiSwitch) {}],
    execute: function () {
      ({
        module,
        test,
      ...
      APPOINTMENT_DEFAULT_TOP_OFFSET = 26;
          ...
          module(`Scrolling mode ${scrollingMode}`, () => {
            ...
            test('Two not rival appointments with fractional coordinates should have correct positions(ie)', function (assert) {
              ...
              const scheduler = createInstance({
                dataSource: [{
                  ...
                  text: 'Appointment 2',
                  startDate: new Date(2015, 1, 11, 8),
                  endDate: new Date(2015, 1, 11, 10)
                }, {
                  text: 'Appointment 3',
            ...
            test('Rival appointments should have correct positions on month view, rtl mode', function (assert) {
              const scheduler = createInstance({
                ...
                dataSource: [{
                  startDate: new Date(2015, 2, 4),
                  endDate: new Date(2015, 2, 7),
                  text: 'long'
                }, {
                  startDate: new Date(2015, 2, 5),
                  endDate: new Date(2015, 2, 5, 1),
                  text: 'short'
                }]
              }, this.clock);
            ...
            test('Appointment startDate should be preprocessed before position calculating', function (assert) {
              const scheduler = createInstance({
                dataSource: [{
                  'text': 'a',
                  'allDay': true,
                  'startDate': '2017-03-13T09:05:00Z',
                  'endDate': '2017-03-20T09:05:00Z'
                }],
            ...
            test('Appointments should be rendered correctly, Month view with intervalCount and startDate', function (assert) {
              const tasks = [{
                ...
                text: 'Five',
                startDate: new Date(2017, 7, 9, 8),
                endDate: new Date(2017, 7, 9, 8, 30)
              }];
