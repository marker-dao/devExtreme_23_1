...
(["testing/tests/DevExpress.ui.widgets.scheduler/perfomance.tests.js"], ["generic_light.css!","ui/scheduler/ui.scheduler","jquery","../../helpers/pointerMock.js","animation/fx","data/data_source/data_source","data/custom_store","../../helpers/scheduler/helpers.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.scheduler/perfomance.tests.js", ["generic_light.css!", "ui/scheduler/ui.scheduler", "jquery", "../../helpers/pointerMock.js", "animation/fx", "data/data_source/data_source", "data/custom_store", "../../helpers/scheduler/helpers.js"], function($__export) {
  "use strict";
  var $,
      pointerMock,
      fx,
    ...
    execute: function() {
      ...
      renderLayoutModuleOptions = {
        beforeEach: function() {
          ...
          this.createInstance = function(view, dataSource, options) {
      ...
      QUnit.module('Render layout', renderLayoutModuleOptions, function() {
        var createScheduler = function(view, dataSource, options) {
          var instance = $('#scheduler').dxScheduler($.extend(options, {
            views: ['week', 'month', 'agenda'],
            currentView: view,
            dataSource: dataSource,
            currentDate: new Date(2017, 4, 25),
        ...
        var markAppointments = function(scheduler) {
          return scheduler.appointments.getAppointments().data('mark', true);
        };
        var getUnmarkedAppointments = function(scheduler) {
        ...
        var createDataSource = function() {
          var list = arguments[0] !== (void 0) ? arguments[0] : defaultData;
        ...
        QUnit.test('Scheduler should throw onAppointmentRendered event only for appointments that need redraw', function(assert) {
          var dataSource = createDataSource();
          var fakeHandler = {onAppointmentRendered: function() {}};
          var renderedStub = sinon.stub(fakeHandler, 'onAppointmentRendered');
        ...
        QUnit.test('Scheduler should render appointments only for appointments that need redraw in Month view', function(assert) {
          var dataSource = createDataSource();
          var scheduler = createScheduler('month', dataSource);
          markAppointments(scheduler);
          dataSource.store().push([{
            type: 'update',
            key: 0,
        ...
        QUnit.test('Scheduler should render appointments only for appointments that need redraw. Use scheduler API', function(assert) {
          var scheduler = createScheduler('week', defaultData);
          markAppointments(scheduler);
        ...
        QUnit.test('Scheduler should re-render all appointments in Agenda view case', function(assert) {
          var dataSource = createDataSource();
          var scheduler = createScheduler('agenda', dataSource);
          markAppointments(scheduler);
          dataSource.store().push([{
            type: 'update',
            key: 8,
        ...
        QUnit.test('Scheduler should re-render appointments in Agenda view, if data source loading data', function(assert) {
          var items = [{
            ...
            id: 1,
            startDate: new Date(2017, 4, 27, 15),
            endDate: new Date(2017, 4, 27, 15, 30),
            text: 'b'
          }];
          var dataSource = {store: new CustomStore({
              key: 'id',
              load: function() {
                return items;
              },
              update: function(key, values) {
                return items[parseInt(key)] = values;
              }
            })};
          var scheduler = createScheduler('agenda', dataSource);
        ...
        QUnit.test('Scheduler should leave appointments consistently if no data has been changed (T751129)', function(assert) {
          ...
          var appointmentFirst = this.scheduler.appointments.getAppointment(0);
          appointmentFirst.css('backgroundColor', '#00ff00');
          var appointmentSecond = this.scheduler.appointments.getAppointment(1);
          var pointer = pointerMock(appointmentSecond).start();
          ...
          var appointments = this.instance.option('dataSource');
        ...
        QUnit.test('Scheduler must re-render appointments if resource color has been changed (T751129)', function(assert) {
          ...
          this.createInstance('week', data, {resources: [{
          ...
          var resources = this.instance.option('resources');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["generic_light.css!","ui/scheduler/ui.scheduler","jquery","../../helpers/pointerMock.js","animation/fx","data/data_source/data_source","data/custom_store","../../helpers/scheduler/helpers.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("generic_light.css!"), require("ui/scheduler/ui.scheduler"), require("jquery"), require("../../helpers/pointerMock.js"), require("animation/fx"), require("data/data_source/data_source"), require("data/custom_store"), require("../../helpers/scheduler/helpers.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=perfomance.tests.js.map