System.register(["../../helpers/scheduler/helpers.js", "../../helpers/pointerMock.js", "animation/fx", "ui/scheduler/utils.timeZone", "ui/scheduler/recurrence", "ui/scheduler/ui.scheduler", "generic_light.css!"], function (_export, _context) {
  "use strict";

  var initTestMarkup, createWrapper, isDesktopEnvironment, CLASSES, pointerMock, fx, timeZoneUtils, getRecurrenceProcessor, testStart, module, test, skip, pacificTimezoneOffset, summerDSTDate, winterDSTDate;
  return {
    setters: [function (_helpersSchedulerHelpersJs) {
    ...
    }, function (_uiSchedulerRecurrence) {
      getRecurrenceProcessor = _uiSchedulerRecurrence.getRecurrenceProcessor;
    ...
    execute: function () {
      ...
      pacificTimezoneOffset = 480; // TODO: Value in ms. Offset (UTC-08:00) Pacific Time (US & Canada)
      summerDSTDate = new Date(2020, 2, 8); // TODO Daylight saving time will happen on this day in 2 A.M.(UTC -7 Pacific time)
      winterDSTDate = new Date(2020, 10, 1); // TODO Daylight saving time will happen on this day in 2 A.M.(UTC -8 Pacific time)
      ...
      if (new Date(2020, 2, 7).getTimezoneOffset() === pacificTimezoneOffset) {
        ...
        module('Day light saving time in native JS Date', moduleConfig, () => {
          const testCase1AmTo2AmSummerTime = {
            ...
            result: ['1:00 AM - 2:00 AM', '1:00 AM - 3:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM'],
          ...
          const testCase1AmTo3AmSummerTime = {
            ...
            result: ['1:00 AM - 3:00 AM', '1:00 AM - 3:00 AM', '1:00 AM - 3:00 AM', '1:00 AM - 3:00 AM', '1:00 AM - 3:00 AM'],
            startDate: new Date(2020, 2, 7, 1),
          ...
          const testCase2AmTo3AmSummerTime = {
            ...
            result: ['2:00 AM - 3:00 AM', '3:00 AM - 4:00 AM', '2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM'],
          ...
          const testCase1AmTo2AmWinterTime = {
            ...
            result: ['1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM', '1:00 AM - 2:00 AM'],
          ...
          const testCase2AmTo3AmWinterTime = {
            ...
            result: ['2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM', '2:00 AM - 3:00 AM'],
            startDate: new Date(2020, 9, 25, 2),
            endDate: new Date(2020, 9, 25, 3),
            currentDate: winterDSTDate,
            recurrenceException: '20201102T100000Z'
          };
          [testCase1AmTo2AmSummerTime, testCase1AmTo3AmSummerTime, testCase2AmTo3AmSummerTime, testCase1AmTo2AmWinterTime, testCase1AmTo3AmWinterTime, testCase2AmTo3AmWinterTime].forEach(testCase => {
        ...
        module('Time panel should have correct dates value in case DST', moduleConfig, () => {
          const expectedAllTimes = ['12:00 AM', '12:30 AM', '1:00 AM', '1:30 AM', '2:00 AM', '2:30 AM', '3:00 AM', '3:30 AM', '4:00 AM', '4:30 AM', '5:00 AM', '5:30 AM', '6:00 AM', '6:30 AM', '7:00 AM', '7:30 AM', '8:00 AM', '8:30 AM', '9:00 AM', '9:30 AM', '10:00 AM', '10:30 AM', '11:00 AM', '11:30 AM', '12:00 PM', '12:30 PM', '1:00 PM', '1:30 PM', '2:00 PM', '2:30 PM', '3:00 PM', '3:30 PM', '4:00 PM', '4:30 PM', '5:00 PM', '5:30 PM', '6:00 PM', '6:30 PM', '7:00 PM', '7:30 PM', '8:00 PM', '8:30 PM', '9:00 PM', '9:30 PM', '10:00 PM', '10:30 PM', '11:00 PM', '11:30 PM'];
          const expectedShortTimes = ['12:00 AM', '', '1:00 AM', '', '2:00 AM', '', '3:00 AM', '', '4:00 AM', '', '5:00 AM', '', '6:00 AM', '', '7:00 AM', '', '8:00 AM', '', '9:00 AM', '', '10:00 AM', '', '11:00 AM', '', '12:00 PM', '', '1:00 PM', '', '2:00 PM', '', '3:00 PM', '', '4:00 PM', '', '5:00 PM', '', '6:00 PM', '', '7:00 PM', '', '8:00 PM', '', '9:00 PM', '', '10:00 PM', '', '11:00 PM', ''];
          ...
          const testCases = [{
            view: 'week',
            times: expectedShortTimes,
            dates: expectedDateResults
          }, {
            view: 'day',
            times: expectedShortTimes,
            dates: expectedDateResults
                ...
                test(`template args should be valid in '${testCase.view}' view when startViewDate is during DST change when renovateRender is ${renovateRender}`, function (assert) {
                  ...
                  createWrapper({
                    ...
                    dataCellTemplate: ({
                      ...
                      const correctedIndex = testCase.isDivideIndex ? Math.floor(index / 7) : index;
                      const isValidIndex = testCase.isDivideIndex ? index % 7 === 0 : true;
          ...
          if (isDesktopEnvironment()) {
            ...
            [{
              ...
              test(`Correct cell should be selected when ${currentView} view is used`, function (assert) {
                const scheduler = createWrapper(Object.assign({
                  currentView
                }, schedulerSettings));
