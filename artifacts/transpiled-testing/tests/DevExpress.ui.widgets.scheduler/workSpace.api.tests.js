System.register(["generic_light.css!", "jquery", "ui/scheduler/workspaces/ui.scheduler.work_space_month", "ui/scheduler/workspaces/ui.scheduler.work_space_week"], function (_export, _context) {
  "use strict";

  var $, test, module, testStart;
  return {
    setters: [function (_generic_lightCss) {}, function (_jquery) {
      $ = _jquery.default;
    }, function (_uiSchedulerWorkspacesUiSchedulerWork_space_month) {}, function (_uiSchedulerWorkspacesUiSchedulerWork_space_week) {}],
    execute: function () {
      ({
        test,
        module,
      ...
      module('API', () => {
        module('Get cell index by coordinates', {
          ...
          test('Week view', function (assert) {
            ...
            const index = this.instance.getCellIndexByCoordinates({
              left: 0,
              top: 55
            });
          ...
          test('All day row', function (assert) {
            ...
            let index = this.instance.getCellIndexByCoordinates({
              left: 298,
              top: 0
            });
            assert.equal(index, 3, 'Index is OK');
            index = this.instance.getCellIndexByCoordinates({
              left: 298,
              top: 45
            });
            assert.equal(index, 3, 'Index is OK');
