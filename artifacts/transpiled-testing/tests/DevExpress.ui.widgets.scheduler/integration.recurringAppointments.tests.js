System.register(["core/utils/size", "jquery", "events/dblclick", "color", "animation/fx", "../../helpers/pointerMock.js", "events/drag", "animation/translator", "data/data_source/data_source", "core/utils/date_serialization", "../../helpers/scheduler/helpers.js", "core/utils/date", "ui/scheduler/utils.timeZone", "generic_light.css!", "ui/scheduler/ui.scheduler"], function (_export, _context) {
  "use strict";

  var getOuterHeight, getOuterWidth, $, dblclickEvent, Color, fx, pointerMock, dragEvents, translator, DataSource, dateSerialization, createWrapper, isDesktopEnvironment, supportedScrollingModes, dateUtils, timeZoneUtils, module, test, toMs, getAppointmentColor;
  return {
    ...
    execute: function () {
      ...
      getAppointmentColor = element => new Color(element.css('backgroundColor')).toHex();
      supportedScrollingModes.forEach(scrollingMode => {
        module(`Integration: Recurring Appointments in the ${scrollingMode} scrolling mode`, {
          ...
          test('Tasks should be duplicated according to recurrence rule, if firstDayOfWeek was set', function (assert) {
            const tasks = [{
              text: 'One',
              startDate: new Date(2015, 2, 12),
              endDate: new Date(2015, 2, 12, 2),
          ...
          test('Recurring appt should be rendered correctly after changing of repeate count', function (assert) {
            const task = {
              ...
              endDate: new Date(2017, 7, 9, 0, 30),
