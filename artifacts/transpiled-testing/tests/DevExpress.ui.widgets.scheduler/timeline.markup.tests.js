System.register(["jquery", "ui/scheduler/workspaces/ui.scheduler.timeline", "ui/scheduler/workspaces/ui.scheduler.timeline_day", "ui/scheduler/workspaces/ui.scheduler.timeline_week", "ui/scheduler/workspaces/ui.scheduler.timeline_work_week", "ui/scheduler/workspaces/ui.scheduler.timeline_month", "core/element_data", "localization/date", "ui/scheduler/workspaces/ui.scheduler.work_space.grouped.strategy.vertical", "ui/scheduler/workspaces/ui.scheduler.work_space.grouped.strategy.horizontal", "ui/scheduler/ui.scheduler"], function (_export, _context) {
  "use strict";

  var $, SchedulerTimeline, SchedulerTimelineDay, SchedulerTimelineWeek, SchedulerTimelineWorkWeek, SchedulerTimelineMonth, dataUtils, dateLocalization, SchedulerWorkSpaceVerticalStrategy, SchedulerWorkSpaceHorizontalStrategy, CELL_CLASS, HEADER_PANEL_CELL_CLASS, HEADER_PANEL_WEEK_CELL_CLASS, FIRST_GROUP_CELL_CLASS, LAST_GROUP_CELL_CLASS, TIMELINE_DAY, TIMELINE_WEEK, TIMELINE_MONTH, toSelector, checkHeaderCells, moduleConfig, timelineDayModuleConfig, timelineWeekModuleConfig, formatWeekdayAndDay, timelineWorkWeekModuleConfig, timelineMonthModuleConfig;
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_uiSchedulerWorkspacesUiSchedulerTimeline) {
      SchedulerTimeline = _uiSchedulerWorkspacesUiSchedulerTimeline.default;
    }, function (_uiSchedulerWorkspacesUiSchedulerTimeline_day) {
      SchedulerTimelineDay = _uiSchedulerWorkspacesUiSchedulerTimeline_day.default;
    }, function (_uiSchedulerWorkspacesUiSchedulerTimeline_week) {
      SchedulerTimelineWeek = _uiSchedulerWorkspacesUiSchedulerTimeline_week.default;
    }, function (_uiSchedulerWorkspacesUiSchedulerTimeline_work_week) {
      SchedulerTimelineWorkWeek = _uiSchedulerWorkspacesUiSchedulerTimeline_work_week.default;
    }, function (_uiSchedulerWorkspacesUiSchedulerTimeline_month) {
      SchedulerTimelineMonth = _uiSchedulerWorkspacesUiSchedulerTimeline_month.default;
    ...
    }, function (_uiSchedulerUiScheduler) {}],
    execute: function () {
      QUnit.testStart(() => {
      ...
      TIMELINE_DAY = {
        ...
        name: 'SchedulerTimelineDay'
      };
      TIMELINE_WEEK = {
        class: 'dxSchedulerTimelineWeek',
        name: 'SchedulerTimelineWeek'
      };
      TIMELINE_MONTH = {
        class: 'dxSchedulerTimelineMonth',
        name: 'SchedulerTimelineMonth'
      };
      toSelector = cssClass => '.' + cssClass;
      checkHeaderCells = function ($element, assert, interval, groupCount, viewDuration) {
      ...
      formatWeekdayAndDay = function (date) {
