System.register(["animation/fx", "data/custom_store", "data/data_source/data_source", "ui/scheduler/timezones/utils.timezones_data", "../../helpers/scheduler/helpers.js"], function (_export, _context) {
  "use strict";

  var fx, CustomStore, DataSource, timeZoneDataUtils, createWrapper, initTestMarkup, createInstance;
  return {
    ...
    }, function (_uiSchedulerTimezonesUtilsTimezones_data) {
      timeZoneDataUtils = _uiSchedulerTimezonesUtilsTimezones_data.default;
    ...
    execute: function () {
      ...
      QUnit.module('Methods', {
        ...
        QUnit.test('Other appointments should not be rerendered after update item', function (assert) {
          ...
          this.clock.tick(10);
          const newTask = {
            startDate: new Date(2015, 1, 9, 2, 0),
        ...
        QUnit.test('Timezone offset calculation(T388304)', function (assert) {
          [{
            ...
            offset: 1,
            daylightOffset: 2,
            daylightDate: new Date(2016, 4, 10),
            ...
            offset: 12,
            daylightOffset: 13,
            daylightDate: new Date(2016, 10, 20),
        ...
        QUnit.test('_getUpdatedData for the empty data item (T906240)', function (assert) {
          ...
          const updatedData = scheduler.instance._getUpdatedData({
            text: 'test'
          });
