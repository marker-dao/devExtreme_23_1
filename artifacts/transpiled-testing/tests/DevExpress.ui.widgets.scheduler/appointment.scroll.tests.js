System.register(["jquery", "animation/fx", "data/data_source/data_source", "../../helpers/scheduler/helpers.js", "ui/scheduler/ui.scheduler", "ui/switch"], function (_export, _context) {
  ...
  var $, fx, DataSource, createWrapper, initTestMarkup, module, test, createInstanceBase;
  return {
          ...
          module(`Scrolling mode ${scrollingMode}`, () => {
            ...
            module('Timeline views', () => {
              ...
              test('Scheduler should update scroll position if appointment is not visible, timeline week view ', function (assert) {
                ...
                const appointment = {
                  startDate: new Date(2015, 1, 12, 7),
                  endDate: new Date(2015, 1, 12, 1, 8),
                  text: 'caption'
                };
                const workSpace = scheduler.instance.getWorkSpace();
                const scrollToSpy = sinon.spy(workSpace, 'scrollTo');
            ...
            test('Scheduler should update scroll position if appointment was added to invisible bottom area: minutes case', function (assert) {
              ...
              const appointment = {
                startDate: new Date(2015, 1, 9, 5, 45),
                endDate: new Date(2015, 1, 9, 6, 30),
                text: 'caption'
              };
              const workSpace = scheduler.instance.getWorkSpace();
              const scrollToSpy = sinon.spy(workSpace, 'scrollTo');
