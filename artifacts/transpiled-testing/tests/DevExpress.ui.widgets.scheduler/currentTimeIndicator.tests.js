System.register(["core/utils/size", "jquery", "core/utils/resize_callbacks", "generic_light.css!", "ui/scheduler/workspaces/ui.scheduler.work_space_day", "ui/scheduler/workspaces/ui.scheduler.work_space_week", "ui/scheduler/workspaces/ui.scheduler.timeline_day", "ui/scheduler/workspaces/ui.scheduler.timeline_week", "ui/scheduler/workspaces/ui.scheduler.timeline_work_week", "ui/scheduler/workspaces/ui.scheduler.timeline_month"], function (_export, _context) {
  "use strict";

  var getOuterHeight, getOuterWidth, $, resizeCallbacks, SCHEDULER_DATE_TIME_SHADER_CLASS, SCHEDULER_DATE_TIME_SHADER_ALL_DAY_CLASS, SCHEDULER_DATE_TIME_SHADER_TOP_CLASS, SCHEDULER_DATE_TIME_SHADER_BOTTOM_CLASS, SCHEDULER_DATE_TIME_INDICATOR_CLASS;
  return {
    ...
    }, function (_generic_lightCss) {}, function (_uiSchedulerWorkspacesUiSchedulerWork_space_day) {}, function (_uiSchedulerWorkspacesUiSchedulerWork_space_week) {}, function (_uiSchedulerWorkspacesUiSchedulerTimeline_day) {}, function (_uiSchedulerWorkspacesUiSchedulerTimeline_week) {}, function (_uiSchedulerWorkspacesUiSchedulerTimeline_work_week) {}, function (_uiSchedulerWorkspacesUiSchedulerTimeline_month) {}],
    execute: function () {
      SCHEDULER_DATE_TIME_SHADER_CLASS = 'dx-scheduler-date-time-shader';
      ...
      QUnit.module('DateTime indicator on grouped Week View', () => {
        ...
        QUnit.test('Shader should have correct position and size, Week view with groupByDate = true', function (assert) {
          ...
          const shaderConfigs = [{
            type: 'allDay',
            element: $allDayShader,
            height: getOuterHeight($allDayCell),
            width: 9 * cellWidth,
            left: 0
          }, {
            type: 'top',
            element: $topShader,
            height: 9.5 * cellHeight,
            width: 9 * cellWidth,
            left: 0
          }, {
            type: 'bottom',
            element: $bottomShader,
            height: 22.5 * cellHeight,
            width: 6 * cellWidth,
            left: 0
          }];
