System.register(["core/utils/size", "jquery", "core/utils/common", "animation/fx", "../../helpers/pointerMock.js", "ui/tooltip/ui.tooltip", "data/data_source/data_source", "core/utils/deferred", "../../helpers/scheduler/helpers.js", "ui/scheduler/ui.scheduler", "ui/switch"], function (_export, _context) {
  "use strict";

  var getOuterWidth, getOuterHeight, $, noop, fx, pointerMock, tooltip, DataSource, Deferred, initTestMarkup, createWrapper, module, test, testStart, DATE_TABLE_CELL_CLASS;
  return {
        ...
        ['standard', 'virtual'].forEach(scrollingMode => {
          module(`Scrolling mode ${scrollingMode}`, {
            ...
            test('updateAppointment method should be called with right args when task was resized, timelineMonth view', function (assert) {
              ...
              try {
                ...
                assert.deepEqual(spy.getCall(0).args[1], $.extend(true, oldItem, {
                  endDate: new Date(2015, 1, 3, 2, 0)
                }), 'New data is correct');
              } finally {
            ...
            test('Scheduler should add only one appointment at multiple "done" button clicks on appointment form', function (assert) {
              const a = {
                ...
                endDate: new Date(2017, 7, 9, 0, 15)
              };
              const scheduler = createWrapper({
                dataSource: [],
          ...
          module(`Scroll after Editing if ${scrollingMode} scrolling mode`, () => {
            ...
            [{
              ...
              test(`Scroll position should not be updated if appointment is visible in ${view}, ${groupOrientation} grouping`, function (assert) {
            ...
            [{
              ...
              test(`Scroll position should not be updated if appointment is visible in ${view}, grouping by date`, function (assert) {
                const scheduler = createScheduler({
                  views: [{
                    type: view,
                    groupOrientation: 'horizontal',
            ...
            [{
              ...
              test(`Scroll position should be updated if appointment is not visible in ${view}, grouping by date`, function (assert) {
                const scheduler = createScheduler({
                  views: [{
                    type: view,
                    groupOrientation: 'horizontal',
            ...
            test('Scroll position should not be updated if appointment is visible in all-day panel', function (assert) {
              const scheduler = createScheduler({
                views: [{
                  type: 'week',
                  groupOrientation: 'horizontal'
