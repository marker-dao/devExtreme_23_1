System.register(["jquery", "animation/fx", "data/data_source/data_source", "core/element_data", "../../helpers/scheduler/helpers.js", "ui/scheduler/ui.scheduler", "ui/switch"], function (_export, _context) {
  "use strict";

  var $, fx, DataSource, dataUtils, initTestMarkup, createWrapper, asyncAssert, supportedScrollingModes, module, test, testStart, APPOINTMENT_CLASS, createInstanceBase;
  return {
        ...
        supportedScrollingModes.forEach(scrollingMode => {
          ...
          module(`Scrolling mode ${scrollingMode}`, () => {
            ...
            test('Remote filter should apply after change view type', function (assert) {
              ...
              filter.push([['startDate', '>', '2017-05-25T21:00:00'], 'and', ['endDate', '<', '2017-05-26T21:00:00']]);
            ...
            test('Tasks should be filtered by date before render', function (assert) {
              const tasks = [{
                ...
                endDate: new Date(2015, 2, 16, 1)
              }, {
                text: 'Two',
                startDate: new Date(2015, 2, 17),
                endDate: new Date(2015, 2, 17, 1)
              }];
              const dataSource = new DataSource({
                store: tasks
              });
            ...
            test('Tasks should be filtered by start day hour before render', function (assert) {
              const tasks = [{
                ...
                text: 'Three',
                startDate: new Date(2015, 2, 17, 2),
                endDate: new Date(2015, 2, 17, 2, 30)
              }, {
                text: 'Five',
                startDate: new Date(2015, 2, 10, 6),
                endDate: new Date(2015, 2, 10, 6, 30)
              }];
              const dataSource = new DataSource({
                store: tasks
              });
            ...
            test('Tasks should be filtered by end day hour before render', function (assert) {
              const tasks = [{
                ...
                text: 'Three',
                startDate: new Date(2015, 2, 16, 12),
                endDate: new Date(2015, 2, 16, 12, 30)
              }, {
                text: 'Five',
                startDate: new Date(2015, 2, 10, 15),
                endDate: new Date(2015, 2, 10, 15, 30)
              }];
              const scheduler = createInstance({
                currentDate: new Date(2015, 2, 16),
                dataSource: tasks,
