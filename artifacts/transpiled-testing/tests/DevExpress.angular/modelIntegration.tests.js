...
(["testing/tests/DevExpress.angular/modelIntegration.tests.js"], ["jquery","core/utils/common","angular","core/component_registrator","ui/widget/ui.widget","ui/editor/editor","core/utils/inflector","ui/tag_box","integration/angular","../../helpers/ignoreAngularTimers.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.angular/modelIntegration.tests.js", ["jquery", "core/utils/common", "angular", "core/component_registrator", "ui/widget/ui.widget", "ui/editor/editor", "core/utils/inflector", "ui/tag_box", "integration/angular", "../../helpers/ignoreAngularTimers.js"], function($__export) {
  "use strict";
  var $,
      noop,
      angular,
    ...
    execute: function() {
      QUnit.module('ngmodel editor integration', {
        beforeEach: function() {
          ...
          var MultiEditor = Editor.inherit({_getDefaultOptions: function() {
              return $.extend(this.callBase(), {values: []});
            }});
          var TestEditor = function($__super) {
            function TestEditor() {
              $traceurRuntime.superConstructor(TestEditor).apply(this, arguments);
            }
            return ($traceurRuntime.createClass)(TestEditor, {}, {}, $__super);
          }(Editor);
      ...
      QUnit.test('ngmodel should pass current value to editor at initialization', function(assert) {
        var $markup = $('<div></div>').attr('dx-editor', '{ value: \'bad\' }').attr('ng-model', 'value').appendTo(this.$controller);
      ...
      QUnit.test('ng-model-controller should be pristine at initialization', function(assert) {
        var $markup = $('<div></div>').attr('dx-editor', '{ value: \'custom\' }').attr('ng-model', 'value').appendTo(this.$controller);
        this.app.controller('my-controller', ['$scope', function($scope) {
          $scope.value = 'test';
        }]);
        angular.bootstrap(this.$container, ['app']);
      ...
      QUnit.test('ngmodel should pass value to editor if it\'s changed at runtime', function(assert) {
        var $markup = $('<div></div>').attr('dx-editor', '{}').attr('ng-model', 'value').appendTo(this.$controller);
        this.app.controller('my-controller', ['$scope', function($scope) {
          $scope.value = 'test';
        }]);
        angular.bootstrap(this.$container, ['app']);
      ...
      QUnit.test('ngmodel should pass value to editor if it\'s changed', function(assert) {
        var $markup = $('<div></div>').attr('dx-test-editor', '{}').attr('ng-model', 'value').appendTo(this.$controller);
        this.app.controller('my-controller', ['$scope', function($scope) {
          $scope.value = 'test';
        }]);
        angular.bootstrap(this.$container, ['app']);
      ...
      $.each(['dxTagBox'], function(_, widgetName) {
        QUnit.test('ngmodel should be bound with values option for ' + widgetName, function(assert) {
          var $markup = $('<div></div>').attr(inflector.dasherize(widgetName), '{bindingOptions: {values: \'value\'}}').appendTo(this.$controller);
          this.app.controller('my-controller', ['$scope', function($scope) {
            $scope.value = [1];
          }]);
          angular.bootstrap(this.$container, ['app']);
      ...
      QUnit.test('ngmodel should not bind value option to widget', function(assert) {
        var $markup = $('<div></div>').attr('dx-widget', '{}').attr('ng-model', 'value').appendTo(this.$controller);
        this.app.controller('my-controller', ['$scope', function($scope) {
          $scope.value = 'test';
        }]);
        angular.bootstrap(this.$container, ['app']);
      ...
      QUnit.test('optionChanged should fired once when value is a plain object and use ngmodel binding', function(assert) {
        ...
        var $markup = $('<div></div>').attr('dx-editor', '{ onOptionChanged: optionChangedHandler }').attr('ng-model', 'value').appendTo(this.$controller);
        var spy = sinon.spy();
        this.app.controller('my-controller', ['$scope', function($scope) {
          $scope.value = {value: 1};
      ...
      QUnit.test('editor without ng model should not fail', function(assert) {
        ...
        $('<div></div>').attr('dx-editor', '{}').appendTo(this.$controller);
      ...
      QUnit.test('editor with ng model and bindingOptions should not fail (T540101)', function(assert) {
        assert.expect(0);
        var $markup = $('<div></div>').attr('dx-editor', 'editorOptions').attr('ng-model', 'value').appendTo(this.$controller);
        this.app.controller('my-controller', ['$scope', function($scope) {
          $scope.value;
          $scope.editorOptions = {bindingOptions: {value: 'value'}};
        }]);
        angular.bootstrap(this.$container, ['app']);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","angular","core/component_registrator","ui/widget/ui.widget","ui/editor/editor","core/utils/inflector","ui/tag_box","integration/angular","../../helpers/ignoreAngularTimers.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("angular"), require("core/component_registrator"), require("ui/widget/ui.widget"), require("ui/editor/editor"), require("core/utils/inflector"), require("ui/tag_box"), require("integration/angular"), require("../../helpers/ignoreAngularTimers.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=modelIntegration.tests.js.map