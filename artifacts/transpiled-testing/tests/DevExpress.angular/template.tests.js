...
(["testing/tests/DevExpress.angular/template.tests.js"], ["jquery","core/utils/common","angular","core/component_registrator","ui/widget/ui.widget","integration/angular"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.angular/template.tests.js', ['jquery', 'core/utils/common', 'angular', 'core/component_registrator', 'ui/widget/ui.widget', 'integration/angular'], true, function ($__require, exports, module) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","angular","core/component_registrator","ui/widget/ui.widget","integration/angular"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("angular"), require("core/component_registrator"), require("ui/widget/ui.widget"), require("integration/angular"));
  else
