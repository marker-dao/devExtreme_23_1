...
(["testing/tests/DevExpress.angular/eventRegistration.tests.js"], ["jquery","angular","events/core/event_registrator","events/drag","events/swipe","integration/angular"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.angular/eventRegistration.tests.js', ['jquery', 'angular', 'events/core/event_registrator', 'events/drag', 'events/swipe', 'integration/angular'], true, function ($__require, exports, module) {
    ...
    $.each(['dxpointerdown', 'dxpointermove', 'dxpointerup', 'dxpointercancel', swipeEvents.start, swipeEvents.swipe, swipeEvents.end, 'dxclick', 'dxhold', dragEvents.start, dragEvents.move, dragEvents.end, dragEvents.enter, dragEvents.leave, dragEvents.drop], function (_, eventName) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","angular","events/core/event_registrator","events/drag","events/swipe","integration/angular"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("angular"), require("events/core/event_registrator"), require("events/drag"), require("events/swipe"), require("integration/angular"));
  else
