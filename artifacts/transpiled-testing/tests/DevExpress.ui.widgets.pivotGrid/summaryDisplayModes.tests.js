...
(["testing/tests/DevExpress.ui.widgets.pivotGrid/summaryDisplayModes.tests.js"], ["jquery","__internal/grids/pivot_grid/summary_display_modes/module","__internal/grids/pivot_grid/module_widget_utils"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.pivotGrid/summaryDisplayModes.tests.js", ["jquery", "__internal/grids/pivot_grid/summary_display_modes/module", "__internal/grids/pivot_grid/module_widget_utils"], function($__export) {
  "use strict";
  var $,
      summaryDisplayModes,
  ...
  return {
    setters: [function($__m) {
      ...
      summaryDisplayModes = $__m.default;
      applyDisplaySummaryMode = $__m.applyDisplaySummaryMode;
      applyRunningTotal = $__m.applyRunningTotal;
      summaryDictionary = $__m.summaryDictionary;
    }, function($__m) {
    ...
    execute: function() {
      data = {
        ...
        values: [[['GT'], ['T1'], ['T2'], ['T3'], ['T4'], ['T5'], ['T6'], ['T7'], ['T8']], [['1T'], [1], [11], [12], [13], [2], [3], [31], [32]], [['2T'], [10], [110], [120], [130], [20], [30], [310], [320]], [['3T'], [100], [1100], [1200], [1300], [200], [300], [3100], [3200]], [['4T'], [1000], [11000], [12000], [13000], [2000], [3000], [31000], [32000]], [['5T'], [10000], [110000], [120000], [130000], [20000], [30000], [310000], [320000]]],
      ...
      QUnit.module('display Summary Type. CallBack arg', {
        beforeEach: function() {
          ...
          this.descriptions = {
            ...
            values: [{
              area: 'data',
              caption: 'summaryField1',
              summaryDisplayMode: 'summaryDisplayType',
              index: 4
            }]
          };
          this.grandTotalRow = {
        ...
        QUnit.test('Get cell value when there are several data fields get fieldValue by Fieldname', function(assert) {
          ...
          this.descriptions.values.push({
            ...
            area: 'data',
            caption: 'summaryField3',
            summaryDisplayMode: 'summaryDisplayType',
            index: 2
          }, {
            caption: 'summaryField5',
            summaryDisplayMode: 'summaryDisplayType',
            index: 3
          });
        ...
        QUnit.test('get child rows', function(assert) {
          ...
          var childRows2 = new this.Cell([this.grandTotalColumn], [this.data.rows[1], this.grandTotalRow], this.data, this.descriptions, 0).children('row');
        ...
        QUnit.test('get child columns', function(assert) {
          ...
          var childRows2 = new this.Cell([this.data.columns[0], this.grandTotalColumn], [this.data.rows[0], this.grandTotalRow], this.data, this.descriptions, 0).children('column');
          var childRows3 = new this.Cell([this.data.columns[0], this.grandTotalColumn], [this.data.rows[0], this.grandTotalRow], this.data, this.descriptions, 0).children();
      ...
      QUnit.module('summary display type calculation', {beforeEach: function() {
          this.data = $.extend(true, {}, data);
          this.descriptions = {
            columns: [{
              dataField: 'Field1',
        ...
        QUnit.test('Add percent format for percent display type', function(assert) {
          ...
          this.descriptions.values = [{summaryDisplayMode: 'percentOfColumnTotal'}, {
            summaryDisplayMode: 'percentOfRow',
            format: 'numeric'
          }];
          applyDisplaySummaryMode(this.descriptions, this.data);
        ...
        QUnit.test('Calculate cell value with empty data', function(assert) {
          ...
          assert.deepEqual(this.data.values, [[['calculatedValue']]]);
        });
        ...
        QUnit.test('RunningTotal with 2 fields', function(assert) {
          ...
          this.data.values = [[['GT', 'GT1'], ['T1', 'T11'], ['T2', 'T22'], ['T3', 'T33'], ['T4', 'T44'], ['T5', 'T55'], ['T6', 'T66'], ['T7', 'T77'], ['T8', 'T88']], [['1T', '1T1'], [1, 1], [11, 11], [12, 12], [13, 13], [2, 2], [3, 3], [31, 31], [32, 32]]];
          applyRunningTotal(this.descriptions, this.data);
          var values = this.data.values;
        ...
        QUnit.test('RunningTotal by row', function(assert) {
          ...
          applyRunningTotal(this.descriptions, this.data);
          var values = this.data.values;
          var firstColumn = $.map(values, function(row) {
            return row[0];
          });
          assert.deepEqual(values[0], [['GT'], ['T1'], ['T2'], ['T3'], ['T4'], ['T5'], ['T6'], ['T7'], ['T8']]);
      ...
      QUnit.module('summary display mode presets', {
        beforeEach: function() {
          ...
          this.getExpression = function(name, crossGrouping) {
            return summaryDisplayModes.getExpression({
              summaryDisplayMode: name,
              allowCrossGroupCalculation: crossGrouping
            });
          };
        },
        afterEach: function() {}
        ...
        QUnit.test('Absolute variation. Crossgrouping', function(assert) {
          ...
          var prevCell = this.stubCell();
          var calculateSummaryCallback = this.getExpression('absoluteVariation', true);
        ...
        QUnit.test('Absolute variation', function(assert) {
          var cell = this.stubCell();
          var prevCell = this.stubCell();
          var calculateSummaryCallback = this.getExpression('absoluteVariation', false);
          prevCell.value.returns(2);
        ...
        QUnit.test('Percent variation. CrossGrouping', function(assert) {
          var cell = this.stubCell();
          var prevCell = this.stubCell();
          var calculateSummaryCallback = this.getExpression('percentVariation', true);
          prevCell.value.returns(2);
          cell.prev.withArgs('column', true).returns(prevCell);
          var resultWithPrevCell = calculateSummaryCallback(cell);
          cell.prev.withArgs('column', true).returns(null);
        ...
        QUnit.test('Percent variation.', function(assert) {
          var cell = this.stubCell();
          var prevCell = this.stubCell();
          var calculateSummaryCallback = this.getExpression('percentVariation', false);
          prevCell.value.returns(2);
          cell.prev.withArgs('column', false).returns(prevCell);
          var resultWithPrevCell = calculateSummaryCallback(cell);
          cell.prev.withArgs('column', false).returns(null);
        ...
        QUnit.test('Percent of row grand total', function(assert) {
          var cell = this.stubCell();
          var totalCell = this.stubCell();
          var calculateSummaryCallback = this.getExpression('percentOfRowGrandTotal');
        ...
        QUnit.test('Percent of column grand total', function(assert) {
          var cell = this.stubCell();
          var totalCell = this.stubCell();
          var calculateSummaryCallback = this.getExpression('percentOfColumnGrandTotal');
          totalCell.value.returns(20);
        ...
        QUnit.test('Percent of grandTotal', function(assert) {
          var cell = this.stubCell();
          var totalCell = this.stubCell();
          var calculateSummaryCallback = this.getExpression('percentOfGrandTotal');
          totalCell.value.returns(20);
        ...
        QUnit.test('Percent of row', function(assert) {
          var cell = this.stubCell();
          var parentCell = this.stubCell();
          var calculateSummaryCallback = this.getExpression('percentOfRowTotal');
          ...
          var resultWhenNoParent = calculateSummaryCallback(cell);
        ...
        QUnit.test('Percent of column', function(assert) {
          var cell = this.stubCell();
          var parentCell = this.stubCell();
          var calculateSummaryCallback = this.getExpression('percentOfColumnTotal');
          parentCell.value.returns(20);
      ...
      dataWithTwoValues = $.extend(true, {}, data);
      QUnit.module('Check empty columns and rows', {beforeEach: function() {
          this.data = $.extend(true, {}, data);
          this.descriptions = {
            columns: [{
              dataField: 'Field1',
        ...
        QUnit.test('createMockSummaryCell with custom calculateSummaryValue', function(assert) {
          ...
          var summaryCell = summaryDisplayModes.createMockSummaryCell(descriptions, fields, {});
      ...
      QUnit.module('Check empty columns and rows with several dataFields', {beforeEach: function() {
        ...
        QUnit.test('Check if value is calculated', function(assert) {
          var field1 = this.descriptions.values[0];
          var field2 = this.descriptions.values[1];
          field1.calculateSummaryValue = function(e) {
            return e.value();
          };
          field1.index = 0;
          field2.index = 1;
          var calculateIsCalled = false;
          field2.calculateSummaryValue = function(e) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","__internal/grids/pivot_grid/summary_display_modes/module","__internal/grids/pivot_grid/module_widget_utils"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("__internal/grids/pivot_grid/summary_display_modes/module"), require("__internal/grids/pivot_grid/module_widget_utils"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=summaryDisplayModes.tests.js.map