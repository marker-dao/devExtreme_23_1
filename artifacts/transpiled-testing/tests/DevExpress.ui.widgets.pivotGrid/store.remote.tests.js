...
(["testing/tests/DevExpress.ui.widgets.pivotGrid/store.remote.tests.js"], ["jquery","__internal/grids/pivot_grid/remote_store/module","__internal/grids/pivot_grid/remote_store/module_utils","__internal/grids/pivot_grid/data_source/module_utils","__internal/grids/pivot_grid/module_widget_utils","data/array_store","data/data_source","../../content/orders.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.pivotGrid/store.remote.tests.js", ["jquery", "__internal/grids/pivot_grid/remote_store/module", "__internal/grids/pivot_grid/remote_store/module_utils", "__internal/grids/pivot_grid/data_source/module_utils", "__internal/grids/pivot_grid/module_widget_utils", "data/array_store", "data/data_source", "../../content/orders.js"], function($__export) {
  "use strict";
  var $,
      RemoteStore,
      forEachGroup,
      ...
      load: function(loadOptions) {
        ...
        if (loadOptions.group) {
          $.each(loadOptions.group, function(_, group) {
            ...
            var interval = group.groupInterval;
            var intervalField = selector + (typeof interval === 'string' ? interval.substr(0, 1).toUpperCase() + interval.substr(1) : '');
            group.selector = intervalField;
          });
        }
        var skip = loadOptions.skip;
        var take = loadOptions.take;
        arrayStore.load($.extend({}, loadOptions, {
          skip: null,
          take: null
        })).done(function(data) {
          var path = [];
          var totalSummary = {summary: null};
          var filterExpr = '';
  ...
  function getValue(data, rowItem, columnItem, measureIndex) {
    ...
    var rowIndex = rowItem ? rowItem.index : data.grandTotalRowIndex;
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module('Loading root data', moduleConfig, function() {
        QUnit.test('Fail on loading', function(assert) {
          var store = new RemoteStore({load: function() {
        ...
        QUnit.test('Loading data with empty dimensions', function(assert) {
          ...
          var loadSpy = sinon.spy(function() {
            return externalStore.load.apply(externalStore, arguments);
          });
          var store = new RemoteStore({load: loadSpy});
          store.load({
            columns: [],
            rows: [],
            values: []
        ...
        ['columns', 'rows'].forEach(function(headerName) {
          QUnit.test(("Parse string data if data type is set. Number type for " + headerName), function(assert) {
            var $__2;
            this.load(($__2 = {}, Object.defineProperty($__2, "columns", {
              value: [],
              configurable: true,
              enumerable: true,
              writable: true
            }), Object.defineProperty($__2, "rows", {
              value: [],
              configurable: true,
              enumerable: true,
              writable: true
            }), Object.defineProperty($__2, "values", {
              value: [],
              configurable: true,
              enumerable: true,
              writable: true
            }), Object.defineProperty($__2, headerName, {
              value: [{
                dataField: 'Freight',
                dataType: 'number'
              }],
          ...
          QUnit.test(("Do not parse string data if next field dataType is number for " + headerName + " (T853201)"), function(assert) {
            var $__2;
            this.store = new RemoteStore({load: function() {
            ...
            this.load(($__2 = {}, Object.defineProperty($__2, "columns", {
              ...
              var headerItems = data[headerName];
      ...
      QUnit.module('Summary calculation', moduleConfig, function() {
        ...
        QUnit.test('Empty string key', function(assert) {
          var dataSource = [{field1: ''}, {field1: '2'}];
          new RemoteStore({store: getCustomArrayStore(dataSource)}).load({
      ...
      QUnit.module('Lazy loading', moduleConfig, function() {
      ...
      QUnit.module('Discover', function() {
        ...
        QUnit.test('getFields. Generate levels for user dataType', function(assert) {
          var dataSource = [{OrderDate: '1996/07/05'}, {OrderDate: '1999/07/05'}];
      ...
      QUnit.module('Mock tests', function() {
      ...
      QUnit.module('Data filtering', moduleConfig, function() {
        QUnit.test('Columns with filter values', function(assert) {
          this.load({
            columns: [{
              dataField: 'ShipCountry',
              filterValues: ['Argentina', 'Germany']
            }],
            rows: [{dataField: 'ShipVia'}],
            values: [{summaryType: 'count'}]
          }).done(function(data) {
        ...
        QUnit.test('Rows with filter values when expanded is false', function(assert) {
          this.load({
            rows: [{dataField: 'ShipCountry'}, {
              dataField: 'ShipName',
              filterValues: ['Alfreds Futterkiste', 'Ana Trujillo Emparedados y helados']
            }],
            columns: [],
            values: [{summaryType: 'count'}]
          }).done(function(data) {
        ...
        QUnit.test('There are filter values in all dimensions', function(assert) {
          this.load({
            ...
            filters: [{
              dataField: 'ShipCity',
              filterValues: ['Boise', 'Seattle', 'Vancouver']
            }],
            values: [{summaryType: 'count'}]
          }).done(function(data) {
        ...
        QUnit.test('Prefilter as option', function(assert) {
          ...
          store.load({
            rows: [{
              dataField: 'OrderID',
              filterValues: [10250, 10251, 10249]
            }],
            columns: [],
            values: [{}]
          }).done(function(data) {
        ...
        QUnit.test('Filter date with incorrect groupInterval', function(assert) {
          var store = new RemoteStore({load: function(loadOptions) {
        ...
        QUnit.test('Include filter by Quarter', function(assert) {
          var store = new RemoteStore({load: function(loadOptions) {
              assert.deepEqual(loadOptions.filter, [[['OrderDate.Month', '>=', 1], 'and', ['OrderDate.Month', '<', 4]], 'or', [['OrderDate.Month', '>=', 4], 'and', ['OrderDate.Month', '<', 7]], 'or', [['OrderDate.Month', '>=', 7], 'and', ['OrderDate.Month', '<', 10]], 'or', [['OrderDate.Month', '>=', 10], 'and', ['OrderDate.Month', '<', 13]]]);
              return $.Deferred();
            }});
          store.load({
            columns: [{
        ...
        QUnit.test('Exclude filter by Quarter', function(assert) {
          var store = new RemoteStore({load: function(loadOptions) {
              assert.deepEqual(loadOptions.filter, [[['OrderDate.Month', '<', 1], 'or', ['OrderDate.Month', '>=', 4]], 'and', [['OrderDate.Month', '<', 4], 'or', ['OrderDate.Month', '>=', 7]], 'and', [['OrderDate.Month', '<', 7], 'or', ['OrderDate.Month', '>=', 10]], 'and', [['OrderDate.Month', '<', 10], 'or', ['OrderDate.Month', '>=', 13]]]);
              return $.Deferred();
            }});
          store.load({
            columns: [{
        ...
        QUnit.test('Filter by number without groupInterval', function(assert) {
          var store = new RemoteStore({load: function(loadOptions) {
              assert.deepEqual(loadOptions.filter, [['Freight', '=', 0], 'or', ['Freight', '=', 200]]);
              return $.Deferred();
            }});
          store.load({
            columns: [{
        ...
        QUnit.test('Filter by number with groupInterval', function(assert) {
          var store = new RemoteStore({load: function(loadOptions) {
              assert.deepEqual(loadOptions.filter, [[['Freight', '>=', 0], 'and', ['Freight', '<', 100]], 'or', [['Freight', '>=', 200], 'and', ['Freight', '<', 300]]]);
              return $.Deferred();
            }});
          store.load({
            columns: [{
        ...
        QUnit.test('Error should not be thrown during filtering if there are more filter values ​​than fields', function(assert) {
          ...
          var filterValues = [[1996, 1], [1996, 2], [1997, 4]];
          ...
          assert.deepEqual(filter, [[['OrderDate.Year', '=', 1996], 'and', ['OrderDate.Month', '=', 1]], 'or', [['OrderDate.Year', '=', 1996], 'and', ['OrderDate.Month', '=', 2]], 'or', [['OrderDate.Year', '=', 1997], 'and', ['OrderDate.Month', '=', 4]]], 'filter is correct');
        });
      });
      QUnit.module('Expanding items', moduleConfig, function() {
        QUnit.test('Expand column', function(assert) {
          this.load({
            ...
            assert.deepEqual(data.values[0], [['GT:count(ShipCountry,=,Spain)'], ['Barcelona:count(ShipCountry,=,Spain)'], ['Madrid:count(ShipCountry,=,Spain)'], ['Sevilla:count(ShipCountry,=,Spain)']], 'total values');
          });
        });
        ...
        ['rowExpandedPaths', 'columnExpandedPaths'].forEach(function(expandedPathOptionName) {
          ...
          QUnit.test((expandedPathOptionName + ". Two expanded date fields. Redundant filter value (T758282)"), function(assert) {
            ...
            var loadOptions = {
              rows: [{dataField: expandedPathOptionName === 'rowExpandedPaths' ? 'date1' : 'anotherField'}, {dataField: expandedPathOptionName === 'rowExpandedPaths' ? 'date2' : 'anotherField'}],
              columns: [{dataField: expandedPathOptionName === 'columnExpandedPaths' ? 'date1' : 'anotherField'}, {dataField: expandedPathOptionName === 'columnExpandedPaths' ? 'date2' : 'anotherField'}]
            };
        ...
        QUnit.test('Total should be correct when load initially expanded child on two level', function(assert) {
          this.load({
            rows: [{dataField: 'ShipCountry'}, {dataField: 'ShipRegion'}, {dataField: 'ShipCity'}],
        ...
        QUnit.test('Expand first level when other item is expanded without rows', function(assert) {
          this.load({
            columns: [{
              dataField: 'ShipCountry',
              expanded: true
            }, {dataField: 'ShipCity'}, {dataField: 'ShipVia'}],
            rows: [],
            values: [{summaryType: 'count'}],
        ...
        QUnit.test('Expand first level when other item is expanded without rows. Second level items are same in each parent item', function(assert) {
          this.load({
            columns: [{
              dataField: 'ShipCountry',
              expanded: true
            }, {dataField: 'ShipVia'}, {dataField: 'ShipCity'}],
            rows: [],
            values: [{summaryType: 'count'}],
      ...
      QUnit.module('DrillDown', {beforeEach: function() {
        ...
        QUnit.test('DrillDown with filters', function(assert) {
          this.getDrillDownData({
            columns: [{
              dataField: 'ShipCountry',
              filterValues: ['Argentina', 'Brazil', 'Canada', 'USA']
            }],
            rows: [{
              dataField: 'ShipVia',
              filterValues: [1, 3]
            ...
            filters: [{
              dataField: 'ShipCity',
              filterValues: ['Campinas', 'Tsawassen', 'Vancouver', 'Portland']
            }],
            values: [{summaryType: 'count'}]
          }, {
            columnPath: [],
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","__internal/grids/pivot_grid/remote_store/module","__internal/grids/pivot_grid/remote_store/module_utils","__internal/grids/pivot_grid/data_source/module_utils","__internal/grids/pivot_grid/module_widget_utils","data/array_store","data/data_source","../../content/orders.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("__internal/grids/pivot_grid/remote_store/module"), require("__internal/grids/pivot_grid/remote_store/module_utils"), require("__internal/grids/pivot_grid/data_source/module_utils"), require("__internal/grids/pivot_grid/module_widget_utils"), require("data/array_store"), require("data/data_source"), require("../../content/orders.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=store.remote.tests.js.map