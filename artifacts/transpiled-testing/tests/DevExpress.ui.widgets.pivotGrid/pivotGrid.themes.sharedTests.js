System.register(["jquery", "__internal/grids/pivot_grid/module_widget"], function (_export, _context) {
  "use strict";

  var $, PivotGrid, PIVOTGRID_EXPANDED_CLASS, PIVOTGRID_TOTAL_CLASS, PIVOTGRID_ROW_TOTAL_CLASS, PIVOTGRID_GRAND_TOTAL_CLASS, runThemesSharedTests;
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_internalGridsPivot_gridModule_widget) {
      PivotGrid = _internalGridsPivot_gridModule_widget.PivotGrid;
    }],
    execute: function () {
