...
(["testing/tests/DevExpress.ui.widgets.pivotGrid/dataController.tests.js"], ["jquery","core/class","__internal/grids/pivot_grid/data_controller/module","ui/grid_core/ui.grid_core.virtual_scrolling_core","ui/grid_core/ui.grid_core.state_storing_core","__internal/grids/pivot_grid/module_widget_utils","__internal/grids/pivot_grid/data_source/module","../../helpers/executeAsyncMock.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.pivotGrid/dataController.tests.js", ["jquery", "core/class", "__internal/grids/pivot_grid/data_controller/module", "ui/grid_core/ui.grid_core.virtual_scrolling_core", "ui/grid_core/ui.grid_core.state_storing_core", "__internal/grids/pivot_grid/module_widget_utils", "__internal/grids/pivot_grid/data_source/module", "../../helpers/executeAsyncMock.js"], function($__export) {
  "use strict";
  var $,
      Class,
      DataController,
  ...
  return {
    setters: [function($__m) {
      ...
      DataController = $__m.DataController;
    }, function($__m) {
      virtualScrolling = $__m.default;
    }, function($__m) {
      stateStoring = $__m.default;
    }, function($__m) {
    ...
    execute: function() {
      ...
      prepareCellsInfo = function(cellsInfo) {
        var result = [];
        for (var rowIndex = 0; rowIndex < cellsInfo.length; rowIndex++) {
          result.push([]);
          for (var columnIndex = 0; columnIndex < cellsInfo[rowIndex].length; columnIndex++) {
            var cellInfo = cellsInfo[rowIndex][columnIndex];
            var preparedCellInfo = {
      ...
      QUnit.module('dxPivotGrid DataController', moduleConfig, function() {
        ...
        QUnit.test('Empty dataSource', function(assert) {
          var dataController = new DataController({dataSource: {}});
          assert.deepEqual(dataController.getRowsInfo(), [[{
            text: undefined,
            type: 'GT',
            isLast: true
        ...
        QUnit.test('dataSource by options disposing', function(assert) {
          var dataController = new DataController({dataSource: {}});
          var onScrollChanged = sinon.stub();
        ...
        QUnit.test('dataSource by instance disposing', function(assert) {
          ...
          var dataController = new DataController({dataSource: dataSource});
          dataController.dispose();
          assert.ok(dataSource, 'dataSource created');
        ...
        QUnit.test('columnsInfo when cells descriptions count === 1 and sorting by summary', function(assert) {
          var dataController = new DataController({
            dataSource: {
              fields: [{
                sortBySummaryField: 'sum',
                sortBySummaryPath: ['A', 'P2'],
                area: 'row'
        ...
        QUnit.test('columnsInfo when cells descriptions count === 1 and sorting by summary when caption path', function(assert) {
          var dataController = new DataController({
            dataSource: {
              fields: [{
                sortBySummaryField: 'sum',
                sortBySummaryPath: ['Atext', 'P2text'],
                area: 'row'
              }, {area: 'column'}, {area: 'column'}, {
                dataField: 'sum',
                caption: 'Sum',
        ...
        QUnit.test('columns formatting', function(assert) {
          ...
          var dataController = new DataController({
            dataSource: {
              ...
              columns: [{
                value: 2009,
                children: [{value: new Date(2009, 5, 11)}, {value: new Date(2009, 7, 5)}]
              }, {value: 2010}]
            },
            texts: texts
          });
          assert.deepEqual(dataController.getColumnsInfo(), [[{
            ...
            text: 'June',
            type: 'D',
            path: [2009, new Date(2009, 5, 11)],
            isLast: true
          }, {
            text: 'August',
            type: 'D',
            path: [2009, new Date(2009, 7, 5)],
            isLast: true
          }]]);
          assert.strictEqual(customizeTextThisObjects.length, 2);
        ...
        QUnit.test('cellInfo when cells descriptions count === 1', function(assert) {
          var dataController = new DataController({dataSource: {
              ...
              values: [[1, 2, 3, 6, 12], [2, 3, 4, 9, 18], [3, 5, 7, 15, 30]]
            }});
        ...
        QUnit.test('Get Cell info for column depth = 3', function(assert) {
          var dataController = new DataController({dataSource: {
              fields: [{area: 'row'}, {area: 'column'}, {area: 'column'}, {area: 'column'}, {
                caption: 'Sum',
                format: 'decimal',
                area: 'data'
              }],
        ...
        QUnit.test('cellInfo when cells descriptions count > 1', function(assert) {
          var dataController = new DataController({dataSource: {
              ...
              values: [[[1, 2], [2, 3], [3, 4], [6, 7], [12, 13]], [[2, 3], [3, 4], [4, 5], [9, 10], [18, 19]], [[3, 4], [5, 6], [7, 8], [15, 16], [30, 31]]]
            }});
          assert.deepEqual(prepareCellsInfo(dataController.getCellsInfo()), [[{
            columnType: 'D',
            rowType: 'D',
          ...
          var dataController = new DataController({
            dataSource: {
              ...
              columns: [{
                ...
                children: [{
                  value: 'P1',
                  children: [{value: 'P11'}, {value: 'P12'}]
                }, {
                  value: 'P2',
                  children: [{value: 'P21'}, {value: 'P22'}]
                }]
              }, {value: 'C'}]
            },
            texts: texts
        ...
        QUnit.test('expand not collapsed column item', function(assert) {
          ...
          var expandValueChangingSpy = sinon.spy();
        ...
        QUnit.test('apply partial dataController with columns path', function(assert) {
          ...
          assert.deepEqual(cells, [['1', '2', '3', '', '', '6', '12'], ['2', '3', '4', '4', '5', '9', '18'], ['3', '5', '7', '8', '7', '15', '30']]);
        });
        QUnit.test('Apply partial dataController with empty data. Update columns', function(assert) {
          ...
          assert.deepEqual(cells, [['1', '2', '3', '6', '12'], ['2', '3', '4', '9', '18'], ['3', '5', '7', '15', '30']]);
        });
        QUnit.test('Apply partial dataController with empty data. Update rows', function(assert) {
          var dataController = new DataController({dataSource: {
              fields: [{area: 'row'}, {area: 'row'}, {area: 'column'}, {area: 'column'}, {
                caption: 'Sum',
                format: 'fixedPoint',
                area: 'data'
              }],
        ...
        QUnit.test('Apply partial dataController by rows after column collapsing', function(assert) {
          ...
          assert.deepEqual(cells, [['3', '6', '12'], ['3', '6', '12'], ['4', '9', '18'], ['7', '15', '30']]);
        });
        QUnit.test('Apply partial dataController with empty data. Update Rows', function(assert) {
          var dataController = new DataController({dataSource: {
              fields: [{area: 'row'}, {area: 'column'}, {area: 'column'}, {
        ...
        QUnit.test('apply partial dataController with columns path, removed row item', function(assert) {
          ...
          assert.deepEqual(cells, [['1', '2', '3', '', '', '6', '12'], ['2', '3', '4', '4', '5', '9', '18'], ['3', '5', '7', '4', '5', '15', '30']]);
        });
        QUnit.test('apply partial dataController with columns path length 2', function(assert) {
          ...
          assert.deepEqual(cells, [['1', '0', '1', '2', '3', '6', '12'], ['1', '1', '2', '3', '4', '9', '18'], ['2', '1', '3', '5', '7', '15', '30']]);
        });
        QUnit.test('apply partial dataController with rows path', function(assert) {
          var dataController = new DataController({dataSource: {
              fields: [{area: 'row'}, {area: 'row'}, {area: 'column'}, {
                caption: 'Sum',
                format: 'fixedPoint',
                area: 'data'
              }],
              ...
              values: [[1, 2, 3], [2, 3, 5], [3, 4, 7], [6, 9, 15], [12, 18, 30]]
            }});
          ...
          assert.deepEqual(cells, [['1', '2', '3'], ['2', '3', '5'], ['3', '4', '7'], ['4', '4', '8'], ['2', '5', '7'], ['6', '9', '15'], ['12', '18', '30']]);
        });
        QUnit.test('collapse row after apply partial dataController with rows path', function(assert) {
          ...
          assert.deepEqual(cells, [['1', '2', '3'], ['2', '3', '5'], ['3', '4', '7'], ['6', '9', '15'], ['12', '18', '30']]);
        });
        QUnit.test('lost cells after several collapse/expand/applyPartialDataSource', function(assert) {
          ...
          assert.deepEqual(cells, [['1', '1'], ['2', '2'], ['3', '3'], ['4', '4'], ['2', '2'], ['6', '6'], ['12', '12']]);
        });
        QUnit.test('apply partial dataController with rows path when no column descriptions', function(assert) {
          ...
          assert.deepEqual(cells, [['1'], ['2'], ['3'], ['4'], ['2'], ['6'], ['12']]);
        });
        ...
        QUnit.test('Hide empty columns in a single group', function(assert) {
          var dataController = new DataController({
            ...
            dataSource: {
              ...
              values: [[null, 2, 3, null, 12], [null, 3, 4, null, 18], [null, 5, 7, null, 30]]
            }
          });
          assert.deepEqual(prepareCellsInfo(dataController.getCellsInfo()), [[{
            'columnType': 'D',
        ...
        QUnit.test('Hide empty rows in a single group', function(assert) {
          var dataController = new DataController({
            hideEmptySummaryCells: true,
            dataSource: {
              fields: [{area: 'column'}, {area: 'row'}, {area: 'row'}, {
                caption: 'Sum',
                format: 'decimal',
                area: 'data'
              }],
              ...
              values: [[null, null, null], [2, 3, 5], [3, 4, 7], [null, null, null], [12, 18, 30]]
            }
          });
          assert.deepEqual(prepareCellsInfo(dataController.getCellsInfo()), [[{
            'columnType': 'D',
        ...
        QUnit.test('Hide empty columns in different groups', function(assert) {
          var dataController = new DataController({
            ...
            dataSource: {
              ...
              values: [[1, null, 3, null, 12], [2, null, 4, null, 18], [3, null, 7, null, 30]]
            }
          });
          assert.deepEqual(prepareCellsInfo(dataController.getCellsInfo()), [[{
            'columnType': 'D',
        ...
        QUnit.test('Hide all children items', function(assert) {
          var dataController = new DataController({
            ...
            dataSource: {
              ...
              values: [[1, 2, 3], [null, null, null], [null, null, null], [6, 9, 15], [12, 18, 30]]
            }
          });
          assert.deepEqual(prepareCellsInfo(dataController.getCellsInfo()), [[{
            'columnType': 'D',
        ...
        QUnit.test('Not hide row with not empty second cell', function(assert) {
          var dataController = new DataController({
            hideEmptySummaryCells: true,
            dataSource: {
              fields: [{area: 'row'}, {area: 'column'}, {area: 'data'}, {area: 'data'}],
              'rows': [{
                'value': 'Los Angeles',
                'index': 2,
                'text': 'Los Angeles',
              ...
              'values': [[[1740, 2], [1740, 1], [null, 1]], [[1740, 1], [1740, 1], [null]], [[null, 1], [null], [null, 1]]],
              grandTotalColumnIndex: 0,
              grandTotalRowIndex: 0
            }
          });
      ...
      QUnit.module('Showing total on the top', moduleConfig, function() {
      ...
      QUnit.module('Tree-Like row layout', moduleConfig, function() {
      ...
      QUnit.module('Virtual scrolling', {
        beforeEach: function() {
          this.data = [{
            'value': 'Accessories',
            'children': [{'value': 'Bike Racks'}, {'value': 'Bottles and Cages'}, {'value': 'Cleaners'}, {'value': 'Helmets'}, {'value': 'Hydration Packs'}, {'value': 'Locks'}, {'value': 'Pumps'}, {'value': 'Tires and Tubes'}]
          }, {
            'value': 'Bikes',
            'children': [{'value': 'Mountain Bikes'}, {'value': 'Road Bikes'}, {'value': 'Touring Bikes'}]
          }, {
            'value': 'Clothing',
            'children': [{'value': 'Bib-Shorts'}, {
              'text': 'Caps',
              'value': 'Caps'
            }, {'value': 'Gloves'}, {'value': 'Jerseys'}, {'value': 'Shorts'}, {'value': 'Socks'}, {'value': 'Tights'}, {'value': 'Vests'}]
          }, {
            'value': 'Components',
            'children': [{'value': 'Bottom Brackets'}, {'value': 'Brakes'}, {'value': 'Chains'}, {'value': 'Cranksets'}, {'value': 'Derailleurs'}, {'value': 'Forks'}, {'value': 'Handlebars'}, {'value': 'Headsets'}, {'value': 'Mountain Frames'}, {'value': 'Pedals'}, {'value': 'Road Frames'}, {'value': 'Saddles'}, {'value': 'Touring Frames'}, {'value': 'Wheels'}]
          }];
          ...
          this.component = {option: sinon.stub().withArgs('scrolling.mode').returns('virtual')};
          this.getOptions = function(options) {
            return $.extend({component: this.component}, options || {});
          };
        ...
        QUnit.test('Calculate virtual content params', function(assert) {
          var dataController = new DataController(this.getOptions({}));
          var rowsScrollController = this.VirtualScrollController.firstCall.returnValue;
          var columnsScrollController = this.VirtualScrollController.secondCall.returnValue;
          var scrollChanged = sinon.stub();
        ...
        QUnit.test('dataAdapter for columnsScrollController', function(assert) {
          var dataController = new DataController(this.getOptions({dataSource: {
              fields: [{area: 'row'}, {area: 'column'}, {area: 'column'}, {
                caption: 'Sum',
                format: 'decimal',
                area: 'data'
        ...
        QUnit.test('dataAdapter for columnsScrollController. Load when rowPageIndex greater then pagecount', function(assert) {
          ...
          var changed = sinon.stub();
          var dataAdapter = this.VirtualScrollController.secondCall.args[1];
          var scrollController = this.VirtualScrollController.secondCall.returnValue;
          dataController.changed.add(changed);
        ...
        QUnit.test('dataAdapter for rowsScrollController', function(assert) {
          ...
          var changed = sinon.stub();
          var dataAdapter = this.VirtualScrollController.firstCall.args[1];
          dataController.changed.add(changed);
        ...
        QUnit.test('dataAdapter for rowsScrollController. Load when rowPageIndex greater then pagecount', function(assert) {
          ...
          var changed = sinon.stub();
          var dataAdapter = this.VirtualScrollController.firstCall.args[1];
          var scrollController = this.VirtualScrollController.firstCall.returnValue;
          dataController.changed.add(changed);
          scrollController.pageIndex.returns(10);
          dataAdapter.load();
          assert.ok(this.VirtualScrollController.firstCall.returnValue.handleDataChanged.calledOnce);
        ...
        QUnit.test('Get data by pageIndex, pageSize, pageCount. Rows', function(assert) {
          ...
          assert.deepEqual(dataController.getRowsInfo(), [[{
            ...
            'isLast': true,
            'path': ['Accessories', 'Cleaners'],
            'text': 'Cleaners',
            'type': 'D'
          }], [{
            'isLast': true,
            'path': ['Accessories', 'Helmets'],
            'text': 'Helmets',
            'type': 'D'
          }], [{
            'isLast': true,
            'path': ['Accessories', 'Hydration Packs'],
          ...
          assert.deepEqual(dataController.getRowsInfo(), [[{
            ...
            'isLast': true,
            'path': ['Accessories', 'Pumps'],
            'text': 'Pumps',
            'type': 'D'
          }], [{
            'isLast': true,
            'path': ['Accessories', 'Tires and Tubes'],
        ...
        QUnit.test('T318502. Get rows info with three level expanded items', function(assert) {
          ...
          this.data[0].children[1].children = [{value: 'Red'}, {value: 'Black'}];
          var dataController = new DataController(this.getOptions({
            dataSource: {
              fields: [{area: 'row'}, {area: 'row'}, {area: 'row'}, {
                area: 'data',
                caption: 'Sum',
                format: 'fixedPoint'
              }],
          ...
          assert.deepEqual(dataController.getRowsInfo(), [[{
            ...
            'expanded': false,
            'isLast': true,
            'path': ['Accessories', 'Bike Racks'],
            'text': 'Bike Racks',
            'type': 'D'
          }], [{
            'expanded': true,
            'path': ['Accessories', 'Bottles and Cages'],
            'rowspan': 2,
            'text': 'Bottles and Cages',
            'type': 'D'
          }, {
            'isLast': true,
            'path': ['Accessories', 'Bottles and Cages', 'Red'],
            'text': 'Red',
            'type': 'D'
          }], [{
            'isLast': true,
            'path': ['Accessories', 'Bottles and Cages', 'Black'],
            'text': 'Black',
            'type': 'D'
          }], [{
            'colspan': 2,
        ...
        QUnit.test('Get data by pageIndex, pageSize, pageCount. Columns', function(assert) {
          ...
          assert.deepEqual(columnsInfo[1], [{
            ...
            'isLast': true,
            'path': ['Bikes', 'Road Bikes'],
            'text': 'Road Bikes',
            'type': 'D'
          }, {
            'isLast': true,
            'path': ['Bikes', 'Touring Bikes'],
            'text': 'Touring Bikes',
            'type': 'D'
          }, {
            'isLast': true,
            'path': ['Clothing', 'Bib-Shorts'],
            'text': 'Bib-Shorts',
            'type': 'D'
          }]);
        });
        ...
        QUnit.test('Get all data when paging. Columns', function(assert) {
          ...
          dataController._columnsScrollController.beginPageIndex.returns(4);
          dataController._columnsScrollController.endPageIndex.returns(5);
          var columnsInfo = dataController.getColumnsInfo(true);
          assert.strictEqual(columnsInfo.length, 2);
        ...
        QUnit.test('Can get changingTime. after load columnsScrollController', function(assert) {
          ...
          var columnsDataAdapter = this.VirtualScrollController.firstCall.args[1];
          var rowsDataAdapter = this.VirtualScrollController.secondCall.args[1];
          columnsScrollController.handleDataChanged.returns('handleChangedResult');
          var loadResult = columnsDataAdapter.load();
          var handleDataChangedArg = columnsScrollController.handleDataChanged.lastCall.args[0];
        ...
        QUnit.test('Can get changingTime. after load rowsScrollController', function(assert) {
          ...
          var handleDataChangedArg = rowsScrollController.handleDataChanged.lastCall.args[0];
          handleDataChangedArg();
        ...
        QUnit.test('T327502. DataController changed once on update', function(assert) {
          ...
          var changedCallback = sinon.stub();
      ...
      QUnit.module('StateStoring', {
        beforeEach: function() {
          ...
          this.component = {option: function() {}};
          this.stateStoringController.isEnabled.returns(true);
          this.stateStoringController.load.returns($.Deferred().resolve({fields: [{
              area: 'column',
              filterValues: ['ValueFromState']
            }]}));
        },
        afterEach: function() {
        ...
        QUnit.test('Load dataController when stateStoring is disabled', function(assert) {
          ...
          assert.deepEqual(dataController._dataSource.fields(), [{
            caption: '',
            '_initProperties': {'caption': undefined},
            index: 0
          }]);
        });
      ...
      QUnit.module('Remote paging', {
        beforeEach: function() {
          ...
          this.component = {option: function(name) {
          ...
          this.createDataSource = function(rowFieldCount, columnFieldCount) {
            ...
            return {
              ...
              pageSize: 4,
              fields: Array.apply(null, Array(rowFieldCount)).map(function() {
                return {area: 'row'};
              }).concat(Array.apply(null, Array(columnFieldCount)).map(function() {
                return {area: 'column'};
              })).concat([{area: 'data'}])
            };
          };
        ...
        QUnit.test('expand column', function(assert) {
          ...
          assert.deepEqual(dataController.getColumnsInfo(), [[{
            ...
            dataSourceIndex: 4,
            text: 'column 1',
            path: ['column 1', 'column 1'],
            type: 'D',
            isLast: true
          }, {
            dataSourceIndex: 5,
            text: 'column 2',
            path: ['column 1', 'column 2'],
            type: 'D',
            isLast: true
          }]]);
        });
        ...
        QUnit.test('expand several rows and columns', function(assert) {
          var dataController = this.setup({
            ...
            pageSize: 4,
            fields: [{area: 'row'}, {area: 'row'}, {area: 'row'}, {area: 'column'}, {area: 'column'}, {area: 'column'}, {area: 'data'}]
          });
          dataController.expandHeaderItem('column', ['column 1']);
          ...
          assert.deepEqual(this.loadArgs.map(function(options) {
            ...
            columnSkip: 0,
            columnTake: 4,
            oppositePath: ['column 1', 'column 2']
          }], 'load options');
          assert.deepEqual(dataController.getColumnsInfo(), [[{
            'colspan': 2,
            'dataSourceIndex': 1,
            ...
            'dataSourceIndex': 9,
            'isLast': true,
            'path': ['column 1', 'column 2', 'column 1'],
            'text': 'column 1',
            'type': 'D'
          }]], 'columns');
          assert.deepEqual(dataController.getRowsInfo(), [[{
        ...
        QUnit.test('scroll by columns after expand column', function(assert) {
          ...
          assert.deepEqual(dataController.getColumnsInfo(), [[{
            ...
            dataSourceIndex: 7,
            text: 'column 4',
            path: ['column 2', 'column 4'],
            type: 'D',
            isLast: true
          }, {
            dataSourceIndex: 8,
            text: 'column 5',
            path: ['column 2', 'column 5'],
            type: 'D',
            isLast: true
          }, {
            dataSourceIndex: 9,
            text: 'column 6',
            path: ['column 2', 'column 6'],
            type: 'D',
            isLast: true
          }, {
            dataSourceIndex: 10,
            text: 'column 7',
            path: ['column 2', 'column 7'],
            type: 'D',
            isLast: true
          }]], 'rows info');
          assert.strictEqual(changedSpy.callCount, 3, 'changed call count');
        ...
        QUnit.skip('load with CustomStore', function(assert) {
          ...
          var dataController = that.setup({
            ...
            load: function(loadOptions) {
              that.loadArgs.push(loadOptions);
              return $.Deferred().resolve([{key: 'row 1'}, {key: 'row 2'}], {groupCount: 10});
            }
          });
          assert.strictEqual(this.loadArgs.length, 1, 'one load');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/class","__internal/grids/pivot_grid/data_controller/module","ui/grid_core/ui.grid_core.virtual_scrolling_core","ui/grid_core/ui.grid_core.state_storing_core","__internal/grids/pivot_grid/module_widget_utils","__internal/grids/pivot_grid/data_source/module","../../helpers/executeAsyncMock.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/class"), require("__internal/grids/pivot_grid/data_controller/module"), require("ui/grid_core/ui.grid_core.virtual_scrolling_core"), require("ui/grid_core/ui.grid_core.state_storing_core"), require("__internal/grids/pivot_grid/module_widget_utils"), require("__internal/grids/pivot_grid/data_source/module"), require("../../helpers/executeAsyncMock.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=dataController.tests.js.map