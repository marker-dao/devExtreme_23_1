...
(["testing/tests/DevExpress.ui.widgets.pivotGrid/fieldChooser.tests.js"], ["core/utils/type","core/devices","core/element_data","core/renderer","events/visibility_change","generic_light.css!","jquery","__internal/grids/pivot_grid/data_source/module","__internal/grids/pivot_grid/field_chooser/module","__internal/grids/pivot_grid/module_widget","../../helpers/pointerMock.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.pivotGrid/fieldChooser.tests.js", ["core/utils/type", "core/devices", "core/element_data", "core/renderer", "events/visibility_change", "generic_light.css!", "jquery", "__internal/grids/pivot_grid/data_source/module", "__internal/grids/pivot_grid/field_chooser/module", "__internal/grids/pivot_grid/module_widget", "../../helpers/pointerMock.js"], function($__export) {
  "use strict";
  var isDefined,
      devices,
      dataUtils,
    ...
    ';
      ...
      QUnit.module('dxPivotGridFieldChooser', {
        ...
        QUnit.test('Hidden field in the data area', function(assert) {
          var dataSourceOptions = {dataFields: [{
              caption: 'Field 1',
              area: 'data',
              visible: false
            }, {
        ...
        QUnit.test('Render Fields Tree', function(assert) {
          ...
          var dataSourceOptions = {fields: fields};
          this.setup(dataSourceOptions);
          assert.ok(this.fieldChooser);
          assert.ok(this.dataSource);
        ...
        QUnit.test('Render Fields Tree with dimension and displayFolder', function(assert) {
          var fields = [{
            ...
            dataField: 'HierarchyField',
            caption: 'a hierarchy field',
            dimension: 'Dimension 2',
            groupName: 'hierarchy',
            isMeasure: false,
            levels: [{dataField: 'levelField'}]
          }];
          var dataSourceOptions = {fields: fields};
          this.setup(dataSourceOptions);
          assert.ok(this.fieldChooser);
        ...
        QUnit.test('Select Items in all fields area', function(assert) {
          var fields = [{
            ...
            dataField: 'field9',
            dimension: 'Dimension 1',
            displayFolder: 'Folder1_1'
          }, {
            dataField: 'field11',
            dimension: 'Dimension 1',
            displayFolder: 'Folder1_2'
          }, {
            dataField: 'field12',
            dimension: 'Dimension 1',
            displayFolder: 'Folder1_2',
          ...
          var treeViewItems = treeView.option('dataSource');
          treeView.selectItem(treeViewItems[4]);
          treeView.selectItem(treeViewItems[2]);
          treeView.selectItem(treeViewItems[0]);
        ...
        QUnit.test('T676235. Select Items in all fields area if applyChangesMode is onDemand', function(assert) {
          ...
          this.setup({fields: fields}, {applyChangesMode: 'onDemand'});
          sinon.spy(this.fieldChooser, '_changedHandler');
          var treeView = this.$container.find('.dx-treeview').dxTreeView('instance');
          treeView.selectItem(treeView.option('dataSource')[4]);
          treeView.selectItem(treeView.option('dataSource')[2]);
          treeView.selectItem(treeView.option('dataSource')[0]);
          treeView.selectItem(treeView.option('dataSource')[1]);
          assert.strictEqual(this.dataSource.load.callCount, 0);
        ...
        QUnit.test('Unselect Items in all fields area', function(assert) {
          ...
          var treeView = this.$container.find('.dx-treeview').dxTreeView('instance');
          var treeViewItems = treeView.option('dataSource');
          treeView.unselectItem(treeViewItems[4]);
          treeView.selectItem(treeViewItems[2]);
        ...
        QUnit.test('Change sort order', function(assert) {
          ...
          assert.deepEqual(this.dataSource.field.getCall(0).args, [1, {sortOrder: 'desc'}]);
          assert.deepEqual(this.dataSource.field.getCall(1).args, [0, {sortOrder: 'asc'}]);
        });
        QUnit.test('Header filter menu for not group field', function(assert) {
          var dataSourceOptions = {
            ...
            fieldValues: [[{value: 1}, {value: 2}, {value: 4}, {value: 5}], [{value: 6}, {value: 7}, {value: 8}, {value: 9}, {value: 10}]]
          };
          this.setup(dataSourceOptions);
          assert.ok(this.fieldChooser);
          assert.ok(this.dataSource);
          ...
          pointerMock($('.dx-header-filter-menu .dx-resizable-handle-right')).start().down().move(10, 10).up();
        });
        QUnit.test('Date in the filterValue', function(assert) {
          ...
          var dataSourceOptions = {
            ...
            fieldValues: [[{value: 1}, {value: 2}, {value: 4}, {value: 5}], [{value: 6}, {value: 7}, {value: new Date(filterValue)}, {value: 9}, {value: 10}]]
          };
          this.setup(dataSourceOptions);
          assert.ok(this.fieldChooser);
          assert.ok(this.dataSource);
        ...
        QUnit.test('Header filter menu when data with key', function(assert) {
          var dataSourceOptions = {
            columnFields: [{
              ...
              caption: 'Field 3',
              area: 'column',
              filterValues: ['&[2003]', 'CY 2001'],
              allowFiltering: true
            }],
            fieldValues: [[{value: 1}, {value: 2}, {value: 4}, {value: 5}], [{
              value: 2001,
              key: '&[2001]',
              caption: 'CY 2001'
            }, {
        ...
        QUnit.test('Change filter values for not group field', function(assert) {
          var dataSourceOptions = {
            ...
            fieldValues: [[{value: 1}, {value: 2}, {value: 4}, {value: 5}], [{value: 6}, {value: 7}, {value: 8}, {value: 9}, {
              value: 10,
              key: '&[10]'
            }]]
          };
        ...
        QUnit.test('Change filter values second time', function(assert) {
          this.fieldChooser = this.$container.dxPivotGridFieldChooser({dataSource: new PivotGridDataSource({
              fields: [{
                index: 0,
                dataField: 'field1',
                area: 'column',
        ...
        QUnit.test('Change filter values for group field when key in data', function(assert) {
          var dataSourceOptions = {
            columnFields: [{
              ...
              area: 'column',
              groupName: 'Date',
              filterValues: [['CY 2001'], ['&[2002]', '&[2002]&[2]'], undefined, [2002, 1]],
              levels: [{}, {}],
              allowFiltering: true
            }],
            fieldValues: [[{
        ...
        QUnit.test('Dragging Fields', function(assert) {
          ...
          assert.ok(this.fieldChooser);
          assert.ok(this.dataSource);
          var fields = this.$container.find('.dx-area-field');
          ...
          function assertDragging(field, area, cancelExpected) {
            ...
            var areaBorderColor = getBorderColor($targetGroup);
            var offset = field.offset();
            var targetOffset = $targetGroup.offset();
            var pointer = pointerMock(field).start({
              x: offset.left,
              y: offset.top
            }).down().move(10, 0).move(targetOffset.left - offset.left + 25, targetOffset.top - offset.top + 30);
        ...
        QUnit.test('Pass allowDragging to sortable', function(assert) {
          this.setup({}, {allowFieldDragging: false});
          var sortable = this.fieldChooser.$element().dxSortableOld('instance');
        ...
        QUnit.test('change group position', function(assert) {
          var dataSourceOptions = {columnFields: [{
              caption: 'Field 1',
              area: 'column',
              index: 0,
              areaIndex: 0
          ...
          var sortable = this.fieldChooser.$element().dxSortableOld('instance');
          var onChangedHandler = sortable.option('onChanged');
      ...
      QUnit.module('dxPivotGridFieldChooser context menu', {
        ...
        QUnit.test('create event args from field', function(assert) {
          ...
          var eventArgs = onContextMenuPreparingHandler.lastCall.args[0];
        ...
        QUnit.test('create custom context menu items', function(assert) {
          ...
          var contextMenu = this.$container.find('.context-menu').dxContextMenu('instance');
          var items = contextMenu.option('items');
        ...
        QUnit.test('onContextMenuPreparing handler can be changed at runtime', function(assert) {
          ...
          this.fieldChooser.option({onContextMenuPreparing: onContextMenuPreparingHandler});
          this.$container.find('[group=\'column\']').eq(0).trigger('dxcontextmenu');
          assert.strictEqual(onContextMenuPreparingHandler.callCount, 1);
        });
      });
      QUnit.module('Base Field chooser', {
        ...
        QUnit.test('Render group fields', function(assert) {
          ...
          var dataSourceOptions = {columnFields: fields};
          this.setup(dataSourceOptions);
        ...
        QUnit.test('Change sortOrder for group field', function(assert) {
          ...
          assert.deepEqual(this.dataSource.field.lastCall.args[1], {'sortOrder': 'desc'});
        });
        QUnit.test('change group position', function(assert) {
          var dataSourceOptions = {columnFields: [{
              caption: 'Field 1',
        ...
        QUnit.test('Show search box in headerFilter', function(assert) {
          ...
          var dataSourceOptions = {
            columnFields: fields,
            fieldValues: [[{value: 1}, {value: 2}, {value: 3}, {value: 4}]]
          };
          this.setup(dataSourceOptions, {headerFilter: {search: {
                enabled: true,
                timeout: 300
              }}});
          $.each(fields, function(_, field) {
        ...
        QUnit.test('HeaderFilter should be without search bar when column allowSearch is disabled', function(assert) {
          ...
          this.setup(dataSourceOptions, {headerFilter: {search: {enabled: true}}});
          $.each(fields, function(_, field) {
            that.$container.append(that.fieldChooser.renderField(field));
          });
          var fieldElements = that.$container.find('.dx-area-field');
        ...
        QUnit.test('Search in headerFilter', function(assert) {
          ...
          this.setup(dataSourceOptions, {headerFilter: {allowSearch: true}});
          $.each(fields, function(_, field) {
            that.$container.append(that.fieldChooser.renderField(field));
          });
          var fieldElements = that.$container.find('.dx-area-field');
        ...
        QUnit.test('headerFilter items if showRelevantValues is true', function(assert) {
          ...
          this.setup(dataSourceOptions, {headerFilter: {showRelevantValues: true}});
          $.each(fields, function(_, field) {
            that.$container.append(that.fieldChooser.renderField(field));
          });
          var fieldElements = that.$container.find('.dx-area-field');
          ...
          assert.deepEqual(this.dataSource.getFieldValues.getCall(0).args, [0, true, undefined], 'getFieldValues calling args');
        });
        QUnit.test('Custom texts.emptyValue in header filter', function(assert) {
          ...
          this.setup(dataSourceOptions, {headerFilter: {texts: {emptyValue: 'Test'}}});
          $.each(fields, function(_, field) {
            that.$container.append(that.fieldChooser.renderField(field));
          });
          var fieldElements = that.$container.find('.dx-area-field');
          fieldElements.first().find('.dx-header-filter').trigger('dxclick');
          this.clock.tick(500);
          var listItems = $('.dx-list').dxList('instance').option('items');
      ...
      QUnit.module('applyChangesMode: onDemand', {
        ...
        QUnit.test('Tree should not recursive expand parent nodes (T866559)', function(assert) {
          ...
          dataSource.load();
          this.clock.tick(500);
          var treeView = this.fieldChooser.$element().find('.dx-treeview').dxTreeView('instance');
          var treeViewItems = treeView.option('dataSource');
        ...
        QUnit.test('cancelChanges', function(assert) {
          ...
          var isCanceled = this.fieldChooser.cancelChanges();
          this.clock.tick(1000);
        ...
        QUnit.test('cancelChanges should not work during loading', function(assert) {
          ...
          this.fieldChooser.getDataSource().field(0, {area: 'row'});
          this.fieldChooser.getDataSource().load();
          var isCanceled = this.fieldChooser.cancelChanges();
        ...
        QUnit.test('Render actual dataSource state on initialization', function(assert) {
          var dataSource = new PivotGridDataSource({fields: [{
              index: 0,
              dataField: 'Field1',
              area: 'row',
              allowSorting: true,
      ...
      QUnit.module('FieldChooser encodeHtml', {
        beforeEach: function() {
          ...
          this.initPivotGrid = function(options) {
            $__3.pivotGrid = createPivotGrid($.extend(true, {
              dataSource: {
                fields: [{
                  dataField: 'field1',
                  area: 'column'
            ...
            $__3.clock.tick(10);
            return $__3.pivotGrid;
          };
          this.getListItemText = function() {
        ...
        QUnit.module('integrated', {beforeEach: function() {
            var $__3 = this;
            this.showFieldChooserPopup = function() {
              $__3.pivotGrid.getFieldChooserPopup().show();
              $__3.clock.tick(500);
            };
            this.showHeaderFilterPanel = function(index) {
              $($__3.pivotGrid.getFieldChooserPopup().content()).find(("." + HEADER_FILTER_CLASS)).eq(index).trigger('dxclick');
              $__3.clock.tick(500);
            };
          }}, function() {
          ...
          [true, false].forEach(function(pivotGridEncodeHtml) {
            ...
            [true, false].forEach(function(fieldChooserEncodeHtml) {
        ...
        QUnit.module('standalone', {beforeEach: function() {
            var $__3 = this;
            this.initStandaloneFieldChooser = function(pivotGridEncodeHtml, fieldChooserEncodeHtml) {
              var pivotGrid = $__3.initPivotGrid({encodeHtml: pivotGridEncodeHtml});
              var fieldChooserOptions = {
              ...
              $__3.$standaloneFieldChooser = $('#standaloneFieldChooser').dxPivotGridFieldChooser(fieldChooserOptions);
            };
            this.showHeaderFilterPanel = function(index) {
              $__3.$standaloneFieldChooser.find(("." + HEADER_FILTER_CLASS)).eq(index).trigger('dxclick');
              $__3.clock.tick(500);
            };
          }}, function() {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/type","core/devices","core/element_data","core/renderer","events/visibility_change","generic_light.css!","jquery","__internal/grids/pivot_grid/data_source/module","__internal/grids/pivot_grid/field_chooser/module","__internal/grids/pivot_grid/module_widget","../../helpers/pointerMock.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/type"), require("core/devices"), require("core/element_data"), require("core/renderer"), require("events/visibility_change"), require("generic_light.css!"), require("jquery"), require("__internal/grids/pivot_grid/data_source/module"), require("__internal/grids/pivot_grid/field_chooser/module"), require("__internal/grids/pivot_grid/module_widget"), require("../../helpers/pointerMock.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=fieldChooser.tests.js.map