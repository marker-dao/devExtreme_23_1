...
(["testing/tests/DevExpress.ui.widgets.pivotGrid/pivotGrid.tests.js"], ["animation/fx","events/core/events_engine","core/config","core/devices","core/element_data","core/utils/size","core/utils/type","core/utils/shadow_dom","events/visibility_change","generic_light.css!","jquery","localization/date","__internal/grids/pivot_grid/data_source/module","ui/pivot_grid/ui.pivot_grid","__internal/grids/pivot_grid/area_item/module","__internal/grids/pivot_grid/data_area/module","__internal/grids/pivot_grid/data_controller/module","__internal/grids/pivot_grid/headers_area/module","__internal/grids/pivot_grid/module_widget_utils","ui/scroll_view/ui.scrollable","../../helpers/pointerMock.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.pivotGrid/pivotGrid.tests.js", ["animation/fx", "events/core/events_engine", "core/config", "core/devices", "core/element_data", "core/utils/size", "core/utils/type", "core/utils/shadow_dom", "events/visibility_change", "generic_light.css!", "jquery", "localization/date", "__internal/grids/pivot_grid/data_source/module", "ui/pivot_grid/ui.pivot_grid", "__internal/grids/pivot_grid/area_item/module", "__internal/grids/pivot_grid/data_area/module", "__internal/grids/pivot_grid/data_controller/module", "__internal/grids/pivot_grid/headers_area/module", "__internal/grids/pivot_grid/module_widget_utils", "ui/scroll_view/ui.scrollable", "../../helpers/pointerMock.js"], function($__export) {
  "use strict";
  var fx,
      eventsEngine,
      config,
  ...
  function getStubComponent(options) {
    ...
    return {
      ...
      _eventsStrategy: {hasEvent: function() {
          return false;
        }}
    };
  }
  ...
  return {
    setters: [function($__m) {
      ...
      getRealElementWidth = $__m.getRealElementWidth;
    }, function($__m) {
      DataAreaModule = $__m.default;
    }, function($__m) {
      DataControllerModule = $__m.default;
    }, function($__m) {
      HeadersAreaModule = $__m.default;
    }, function($__m) {
      pivotGridUtils = $__m.default;
      getScrollbarWidth = $__m.getScrollbarWidth;
    }, function($__m) {
...
<div class="dx-pivotgrid">\
    <div id="pivotArea" class="dx-pivotgrid-area-data dx-pivotgrid-vertical-headers" />\
      ...
      QUnit.module('dxPivotGrid', {
        beforeEach: function() {
          ...
          this.dataSource = {
            ...
            values: [[[1, 0.1], [8, 0.8], [15, 0.15], [36, 0.36], [43, 0.43]], [[2, 0.2], [9, 0.9], [16, 0.16], [37, 0.37], [44, 0.44]], [[3, 0.3], [10, 0.1], [17, 0.17], [38, 0.38], [45, 0.45]]]
          };
        ...
        QUnit.test('No options', function(assert) {
          var pivotGrid = createPivotGrid(undefined);
          assert.ok(pivotGrid);
        });
        QUnit.test('No data', function(assert) {
          var contentReadyCallback = sinon.stub();
          var pivotGrid = createPivotGrid({onContentReady: contentReadyCallback});
          assert.ok(pivotGrid);
        ...
        QUnit.test('Empty store', function(assert) {
          ...
          var pivotGrid = createPivotGrid(testOptions);
          this.clock.tick(10);
          var $columnCell = pivotGrid.$element().find('.dx-area-column-cell');
          var $rowCell = pivotGrid.$element().find('.dx-area-row-cell');
        ...
        QUnit.test('No data when pivot grid rendered to invisible container', function(assert) {
          ...
          this.clock.tick(10);
          var $noDataElement = $(pivotGrid.$element().find('.dx-pivotgrid-nodata'));
          var dataAreaCell = $(("." + DATA_AREA_CELL_CLASS));
          var dataAreaCellOffset = dataAreaCell.offset();
          var noDataElementOffset = $noDataElement.offset();
          assert.ok($noDataElement.is(':visible'));
        ...
        QUnit.test('Loading DataSource', function(assert) {
          ...
          var dataAreaGroupElement = pivotGrid._dataArea.groupElement();
          var loadIndicatorElementOffset = loadIndicatorElement.offset();
          var dataAreaGroupElementOffset = dataAreaGroupElement.offset();
        ...
        QUnit.test('Loading DataSource longer 1000 ms', function(assert) {
          ...
          assert.deepEqual(loadingChangedArgs, [true, false, true, false]);
          assert.ok(onContentReadyCallback.calledOnce, 'contentReady should be called once');
          assert.ok(!pivotGrid._loadPanel.option('visible'), 'loadPanel should not be visible');
        ...
        QUnit.test('T248253. DataSource changed', function(assert) {
          var expandValueChangingArgs;
          var pivotGrid = createPivotGrid($.extend(this.testOptions, {onExpandValueChanging: function(args) {
              expandValueChangingArgs = $.extend({}, args);
            }}));
          pivotGrid.option({dataSource: this.dataSource});
          var $collapsedSpan = $('#pivotGrid').find('.dx-pivotgrid-collapsed');
          assert.strictEqual($collapsedSpan.length, 1);
          $($collapsedSpan).trigger('dxclick');
          this.clock.tick(10);
        ...
        QUnit.test('onCellClick event', function(assert) {
          ...
          var $fieldsArea = $('#pivotGrid').find('.dx-pivotgrid-fields-area');
          this.clock.tick(10);
        ...
        QUnit.test('show field chooser popup on field chooser button click', function(assert) {
          var pivotGrid = createPivotGrid({dataSource: {
              rows: [],
              columns: [],
              values: []
            }});
        ...
        QUnit.test('FieldPanel inherits visible option', function(assert) {
          ...
          var fieldPanelInstance = pivotGrid.$element().dxPivotGridFieldChooserBase('instance');
          this.clock.tick(10);
        ...
        QUnit.test('create field chooser with search', function(assert) {
          ...
          var fieldChooserPopup = pivotGrid.getFieldChooserPopup();
          this.clock.tick(10);
          fieldChooserPopup.show();
          this.clock.tick(500);
          var fieldChooser = fieldChooserPopup.$content().data('dxPivotGridFieldChooser');
          var treeViewInstance = fieldChooserPopup.$content().find('.dx-treeview').dxTreeView('instance');
        ...
        QUnit.test('clear selection and filtering in field chooser treeview on popup hidding', function(assert) {
          ...
          this.clock.tick(500);
          var fieldChooser = fieldChooserPopup.$content().data('dxPivotGridFieldChooser');
          var resetTreeView = sinon.spy(fieldChooser, 'resetTreeView');
        ...
        QUnit.test('Dragging between PivotGrid and FieldChooser', function(assert) {
          ...
          var $fieldChooser1 = $('<div>').insertAfter($pivotGrid).dxPivotGridFieldChooser({dataSource: dataSource});
          var $fieldChooser2 = $('<div>').insertAfter($pivotGrid).dxPivotGridFieldChooser({dataSource: new PivotGridDataSource({store: {
                type: 'array',
                data: []
              }})});
        ...
        QUnit.test('resize field chooser popup', function(assert) {
          ...
          pivotGrid.getFieldChooserPopup().show();
          this.clock.tick(500);
          var $fieldChooserPopup = $('.dx-fieldchooser-popup').dxPopup('instance').$wrapper();
          ...
          var $fieldChooser = $fieldChooserPopup.find('.dx-pivotgridfieldchooser');
          var fieldChooserHeight = getOuterHeight($fieldChooser, true);
          var fieldChooserWidth = getOuterWidth($fieldChooser, true);
          var $fieldChooserContainer = $fieldChooserPopup.find('.dx-pivotgridfieldchooser-container');
          var fieldChooserContainerHeight = getHeight($fieldChooserContainer);
        ...
        QUnit.test('rtlEnabled assign for all children widgets', function(assert) {
          var pivotGrid = createPivotGrid({rtlEnabled: true});
          this.clock.tick(10);
          pivotGrid.getFieldChooserPopup().show();
          this.clock.tick(500);
          ...
          $.each($widgets, function() {
            var $widget = $(this);
            var componentNames = dataUtils.data($widget[0], 'dxComponents');
        ...
        [true, false].forEach(function(useNativeScrolling) {
          [true, false].forEach(function(rtlEnabled) {
            QUnit.test(("aria data with scrollable in rtl mode, scrolling: { useNative: " + useNativeScrolling + "}, rtlEnabled: " + rtlEnabled), function(assert) {
              ...
              var $scrollable = pivotGrid.$element().find('.dx-pivotgrid-area-data');
              var $headersAreaScrollable = pivotGrid.$element().find('.dx-scrollable.dx-pivotgrid-horizontal-headers');
              var $rowsAreaScrollable = pivotGrid.$element().find('.dx-scrollable.dx-pivotgrid-vertical-headers');
        ...
        QUnit.test('subscribe to onCellPrepared event', function(assert) {
          var cellPreparedArgs = {length: 0};
          var pivotGrid = createPivotGrid({dataSource: this.dataSource});
        ...
        QUnit.test('onCellPrepared event should change in runtime', function(assert) {
          ...
          var pivotGrid = createPivotGrid({
            dataSource: {
              ...
              values: [[[1, 0.1], [8, 0.8], [15, 0.15], [36, 0.36], [43, 0.43]], [[2, 0.2], [9, 0.9], [16, 0.16], [37, 0.37], [44, 0.44]]]
            },
        ...
        QUnit.test('contextMenu on Total node when rowHeaderLayout is \'tree\'', function(assert) {
          this.dataSource.rows[0].children = [{
            value: 'P1',
            index: 0
          }, {
            value: 'P2',
          ...
          var contextMenuPreparing = sinon.stub();
        ...
        QUnit.test('Context menu when click on field chooser', function(assert) {
          ...
          var $fieldsArea = $('#pivotGrid').find('.dx-pivotgrid-fields-area');
          var $dataFields = $fieldsArea.eq(1);
          var $filterFields = $fieldsArea.eq(0);
        ...
        QUnit.test('Context menu when no data', function(assert) {
          var contextMenuArgs = [];
          createPivotGrid({onContextMenuPreparing: function(e) {
              contextMenuArgs.push(e);
            }});
          this.clock.tick(10);
          var $dataArea = $('#pivotGrid').find('.dx-pivotgrid-area-data');
        ...
        QUnit.test('Context menu when click target no pivot table', function(assert) {
          var pivotGrid = createPivotGrid({onContextMenuPreparing: sinon.stub});
          var $target = $('#pivotGrid').find('.dx-widget.dx-pivotgrid');
        ...
        QUnit.test('Sorting by Summary should not be allowd if paginate is true', function(assert) {
          ...
          this.clock.tick(500);
          $('#pivotGrid').find('.dx-pivotgrid-horizontal-headers td').last().trigger('dxcontextmenu');
          assert.deepEqual(contextMenuArgs[0].items.map(function(i) {
            return i.text;
          }), ['Show Field Chooser'], 'context menu items');
        });
        QUnit.test('load dataSource after PivotGrid dispose', function(assert) {
          var dataSource = new PivotGridDataSource({store: []});
          var pivotGrid = createPivotGrid({});
        ...
        QUnit.test('Render to invisible container', function(assert) {
          this.testOptions.scrolling = {useNative: true};
          var $pivotGridElement = $('#pivotGrid').wrap().hide().width(2000).height('200px');
          var pivotGrid = createPivotGrid(this.testOptions);
          $pivotGridElement.show();
          triggerShownEvent($pivotGridElement);
          ...
          var dataAreaContainerElement = $(pivotGrid._dataArea._getScrollable().container()).get(0);
        ...
        QUnit.test('expand All should not be allowed if paginate true', function(assert) {
          ...
          $('#pivotGrid').find('.dx-pivotgrid-horizontal-headers .dx-pivotgrid-collapsed').trigger('dxcontextmenu');
          assert.deepEqual(contextMenuArgs[0].items.map(function(item) {
            return item.text;
          }), ['Show Field Chooser'], 'context menu items');
        });
        ...
        QUnit.test('pivot grid render', function(assert) {
          ...
          var mainTable = testElement.find('table')[0];
        ...
        QUnit.test('disable word wrapping', function(assert) {
          createPivotGrid({wordWrapEnabled: false});
          var testElement = $('#pivotGrid');
          var mainTable = testElement.find('table')[0];
          assert.ok(!$(mainTable).hasClass('dx-word-wrap'));
        });
        QUnit.test('disable word wrapping at runtime', function(assert) {
          var pivotGrid = createPivotGrid({wordWrapEnabled: true});
          var testElement = $('#pivotGrid');
          var mainTable = testElement.find('table')[0];
        ...
        QUnit.test('disable rowHeaderLayout at runtime', function(assert) {
          var pivotGrid = createPivotGrid({rowHeaderLayout: 'tree'});
          var testElement = $('#pivotGrid');
          var mainTable = testElement.find('table')[0];
        ...
        QUnit.test('enable rowHeaderLayout at runtime', function(assert) {
          var pivotGrid = createPivotGrid({rowHeaderLayout: 'standard'});
          var testElement = $('#pivotGrid');
          var mainTable = testElement.find('table')[0];
        ...
        QUnit.test('no scroll after drawing data', function(assert) {
          ...
          var dataScrollable = pivotGrid._dataArea.groupElement().dxScrollable('instance');
          sinon.spy(dataScrollable, 'update');
          sinon.spy(dataScrollable, 'scrollTo');
          pivotGrid.option({dataSource: {
              fields: [{area: 'row'}, {area: 'column'}, {area: 'column'}, {
                caption: 'Sum1',
                area: 'data'
              }],
              rows: [{
              ...
              values: [[[null], [null], [15], [36], [43], [100]], [[962], [2625], [16], [37], [44], [200]], [[962], [2625], [1753], [11753], [11753]]]
            }});
          assert.ok(pivotGrid, 'pivotGrid container is rendered');
        ...
        QUnit.test('T317921: dxPivotGrid - Scrollbar overlaps the last column when the document height slightly exceeds the window height. Without columns scroll', function(assert) {
          ...
          var $parentElement = $('<div>').css({
            height: 400,
            overflow: 'auto'
          }).appendTo($('#pivotGrid').parent());
          $pivotGridElement.appendTo($parentElement);
          var pivotGrid = createPivotGrid(this.testOptions);
          var tableElement = $pivotGridElement.find('table').first();
          var dataAreaWidth = getWidth(pivotGrid.$element().find('.dx-pivotgrid-area-data'));
          var rowsAreaWidth = getWidth(pivotGrid.$element().find('.dx-pivotgrid-vertical-headers.dx-pivotgrid-area'));
          assert.strictEqual(getWidth(tableElement), getWidth($pivotGridElement)), assert.ok((dataAreaWidth + rowsAreaWidth) <= getWidth($pivotGridElement));
        });
        ...
        QUnit.test('page scrolling after tapping inside PivotGrid. T418829', function(assert) {
          ...
          pointerMock(pivotGrid._dataArea.groupElement()).start().down().move(-10, -1).move(-20, -1).up();
        ...
        QUnit.test('Pivot should have scroll after container height was changed', function(assert) {
          ...
          $pivotGrid.dxPivotGrid($.extend(this.testOptions, {height: '50%'}));
        ...
        QUnit.test('Resize. reset height', function(assert) {
          var pivotGrid = createPivotGrid($.extend(this.testOptions, {height: 200}));
          assert.ok(pivotGrid.hasScroll('row'), 'has vertical scroll');
        ...
        QUnit.test('Group height should take into account horizontal scrollbar height', function(assert) {
          ...
          this.testOptions.scrolling = {useNative: false};
          var pivotGrid = createPivotGrid(this.testOptions);
          var dataAreaHeight = getHeight(pivotGrid.$element().find('.dx-pivotgrid-area-data'));
          pivotGrid.option({scrolling: {useNative: true}});
        ...
        QUnit.test('Synchronize areas', function(assert) {
          ...
          var pivotGrid = createPivotGrid(this.testOptions);
          this.clock.tick(10);
          var dataAreaElement = testElement.find('.dx-pivotgrid-area-data table');
          var rows = dataAreaElement[0].rows;
          var colsElement = dataAreaElement.find('col');
        ...
        QUnit.test('Scrolling when virtual scrolling is enabled', function(assert) {
          ...
          assert.ok(pivotGrid);
          var scrollable = pivotGrid._dataArea.groupElement().dxScrollable('instance');
          var setViewportPosition = sinon.spy(pivotGrid._dataController, 'setViewportPosition');
          var updateWindowScrollPosition = sinon.spy(pivotGrid._dataController, 'updateWindowScrollPosition');
        ...
        QUnit.test('Initial horizontal scroll position when rtl is enabled', function(assert) {
          ...
          var dataAreaContainerElement = $(dataAreaScrollable.container()).get(0);
        ...
        QUnit.test('T243287. Scroll position after updateDimensions', function(assert) {
          ...
          var scrollAction = function(e) {
            ...
            var dataScrollPosition = scrollable.scrollLeft();
            pivotGrid.updateDimensions();
        ...
        QUnit.test('T245599. Scroll row area', function(assert) {
          ...
          var scrollable = pivotGrid._dataArea.groupElement().dxScrollable('instance');
          var rowScrollable = pivotGrid._rowsArea.groupElement().dxScrollable('instance');
          scrollable.on('scroll', assertFunction);
          rowScrollable.scrollTo(columnHeights[0] + 5);
          rowScrollable.option('useSimulatedScrollbar', true);
        ...
        QUnit.test('T245599. Scroll columnArea area', function(assert) {
          ...
          var scrollable = pivotGrid._dataArea.groupElement().dxScrollable('instance');
          var columnScrollable = pivotGrid._columnsArea.groupElement().dxScrollable('instance');
          scrollable.on('scroll', assertFunction);
          columnScrollable.scrollTo(columnWidth[0] + columnWidth[1] + 5);
          columnScrollable.option('useSimulatedScrollbar', true);
        ...
        ['standard', 'virtual'].forEach(function(scrollMode) {
          [true, false].forEach(function(useNative) {
            [40, 80].forEach(function(scrollDistance) {
              QUnit.test(("Container.visibility= false -> Container.visibility= true -> dataArea.trigger(scrollTop), useNative=" + useNative + ", scrollMode=" + scrollMode + ", scrollDistance = " + scrollDistance + " (T907207)"), function(assert) {
                ...
                var grid = $('#pivotGrid').dxPivotGrid({
                  width: 500,
                  height: 100,
                  scrolling: {
                    mode: scrollMode,
                ...
                var eventArgs = {scrollOffset: {
                    top: scrollDistance,
                    left: 0
                  }};
                grid._dataArea.element().find('.dx-scrollable').dxScrollable('instance')._eventsStrategy.fireEvent('scroll', [eventArgs]);
                var $rowsElement = grid._rowsArea.element();
                var containerTop = $rowsElement.find('.dx-scrollable-container').get(0).getBoundingClientRect().top;
                var contentTop = $rowsElement.find('.dx-scrollable-content').get(0).getBoundingClientRect().top;
        ...
        QUnit.test('dxPivotGrid with vertical scroll and minimum width without horizontal scroller (columns stretch to less)', function(assert) {
          var createPivotGridOptions = function(options) {
            ...
            var cellSet = [[[100000000, 0.1], [8, 0.8], [15, 0.15], [22, 0.22], [29, 0.29], [36, 0.36], [43, 0.43]], [[2, 0.2], [9, 0.9], [16, 0.16], [23, 0.23], [30, 0.3], [37, 0.37], [44, 0.44]], [[3, 0.3], [10, 0.1], [17, 0.17], [24, 0.24], [31, 0.31], [38, 0.38], [45, 0.45]], [[4, 0.4], [11, 0.11], [18, 0.18], [25, 0.25], [32, 0.32], [39, 0.39], [46, 0.46]], [[5, 0.5], [12, 0.12], [19, 0.19], [26, 0.26], [33, 0.33], [40, 0.4], [47, 0.47]], [[6, 0.6], [13, 0.13], [20, 0.2], [27, 0.27], [34, 0.34], [41, 0.41], [48, 0.48]], [[7, 0.7], [14, 0.14], [21, 0.21], [28, 0.28], [35, 0.35], [42, 0.42], [49, 0.49]]];
            var pivotGridOptions = $.extend(true, {dataSource: {
                fields: [{area: 'row'}, {area: 'row'}, {
                  format: 'decimal',
                  area: 'column'
                }, {
                  format: {
          ...
          var pivotGrid = createPivotGrid(createPivotGridOptions({
            width: 1005,
            height: 250
          }));
          this.clock.tick(10);
          ...
          var columnsAreaWidth = getWidth(pivotGrid.$element().find('.dx-pivotgrid-horizontal-headers.dx-pivotgrid-area'));
        ...
        QUnit.test('Stretch columns when scrolling has size and horizontal scrollbar may cause vertical scrollbar', function(assert) {
          var pivotGrid = createPivotGrid({
            ...
            dataSource: {
              ...
              values: [[[10, 0.1], [8, 0.8], [15, 0.15], [22, 0.22], [29, 0.29], [36, 0.36], [43, 0.43]], [[7, 0.7], [14, 0.14], [21, 0.21], [28, 0.28], [35, 0.35], [42, 0.42], [49, 0.49]]]
            }
          });
          this.clock.tick(10);
          assert.ok(pivotGrid);
        ...
        QUnit.test('B253995 - dxPivotGrid height is wrong when rows area has text wrapped to another line', function(assert) {
          ...
          var cellSet = [[100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100], [200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 100], [200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 100], [200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 100], [200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 100], [200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 100], [300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 100]];
          var pivotGridOptions = {
            ...
            dataSource: {
              ...
              rows: [{
                value: 'A 111111 222222',
                index: 0
              }, {
                value: 'B 1111111 11111',
                index: 1
              }, {
                value: 'C 111111 111111',
                index: 2
              }, {
                value: 'D 111111 111111',
                index: 3
              }, {
                value: 'E 11111 1111111',
                index: 4
              }, {
                value: 'F 1111111 11111',
                index: 5
              }],
              columns: columnItems,
              values: cellSet
        ...
        QUnit.test('DataController - scrollChanged event', function(assert) {
          ...
          var dataController = widget._dataController;
          var dataAreaScrollable = widget._dataArea.groupElement().dxScrollable('instance');
        ...
        QUnit.test('Column area should be visible after change scrolling.mode to virtual', function(assert) {
          ...
          widget.option({scrolling: {mode: 'virtual'}});
        ...
        QUnit.test('Header cell text should be rendered on the same line with expand icon', function(assert) {
          var pivotGrid = createPivotGrid({dataSource: {
              ...
              store: [{field1: 'BigBigBigBigBigWord'}]
            }}, assert);
          this.clock.tick(10);
          assert.ok(pivotGrid);
          var $headerCellElements = $('#pivotGrid').find('td.dx-pivotgrid-collapsed').eq(0).children();
          assert.strictEqual($headerCellElements.length, 2, 'two header cell elements');
          var expandIconRect = $headerCellElements[0].getBoundingClientRect();
          var textRect = $headerCellElements[1].getBoundingClientRect();
        ...
        QUnit.test('Sort icon should be correctly positioned when header text was wrapped to the next line', function(assert) {
          ...
          var $sortIcon = $header.find('.dx-icon-sorted');
          var sortIconRect = $sortIcon.get(0).getBoundingClientRect();
          var headerIconRect = $header.get(0).getBoundingClientRect();
        ...
        QUnit.test('Summary field text should not be NaN if the only field value is null', function(assert) {
          var customizeTextSpy = sinon.spy(function() {
            return 'custom text';
          });
          createPivotGrid({dataSource: {
              fields: [{
                dataField: 'field',
                area: 'data',
                summaryType: 'avg',
                customizeText: customizeTextSpy
              }],
              store: [{field: NaN}]
            }}, assert);
          this.clock.tick(10);
          assert.equal(customizeTextSpy.callCount, 1, 'customizeText call count');
          var args = customizeTextSpy.args[0][0];
          var isValueNaN = args.value === args.value;
          var grandTotalText = $('.dx-pivotgrid-area.dx-pivotgrid-area-data').find('.dx-grandtotal').text();
      ...
      QUnit.module('T984139, T1010175', {
        ...
        ['row', 'column'].forEach(function(area) {
          [false, true].forEach(function(useNative) {
            function getHeaderCellByText($area, text) {
              return $area.find('table:not(.dx-pivot-grid-fake-table) td').filter(function(_, el) {
                return el.innerText.trim() === text;
              }).get(0);
            }
            function getArea(pivotGrid, area) {
              var $element = pivotGrid.$element();
              return area === 'row' ? $element.find('.dx-pivotgrid-vertical-headers') : $element.find('.dx-pivotgrid-horizontal-headers');
            }
            function getVerticalOffset(pivotGrid, fromCellText, toCellText) {
              var $rowsHeaderArea = getArea(pivotGrid, 'row');
              var fromCellRect = getHeaderCellByText($rowsHeaderArea, fromCellText).getBoundingClientRect();
              var toCellRect = getHeaderCellByText($rowsHeaderArea, toCellText).getBoundingClientRect();
              return toCellRect.y - fromCellRect.y - 1;
            }
            function getHorizontalOffset(pivotGrid, fromCellText, toCellText) {
              var $columnsHeaderArea = getArea(pivotGrid, 'column');
              var fromCellRect = getHeaderCellByText($columnsHeaderArea, fromCellText).getBoundingClientRect();
              var toCellRect = getHeaderCellByText($columnsHeaderArea, toCellText).getBoundingClientRect();
            ...
            function checkLeftTopVisibleHeaderCellTexts(pivotGrid, expectedRowHeaderCellText, expectedColHeaderCellText, errorMessageDetails) {
              var $rowsHeaderArea = getArea(pivotGrid, 'row');
              var $columnsHeaderArea = getArea(pivotGrid, 'column');
              var rowsAreaRect = $rowsHeaderArea.get(0).getBoundingClientRect();
              var columnsAreaRect = $columnsHeaderArea.get(0).getBoundingClientRect();
              var expectedRowCellRect = getHeaderCellByText($rowsHeaderArea, expectedRowHeaderCellText).getBoundingClientRect();
              var expectedColumnCellRect = getHeaderCellByText($columnsHeaderArea, expectedColHeaderCellText).getBoundingClientRect();
            ...
            function filterPivotGrid(pivotGrid, filterValue, area) {
              var ds = pivotGrid.getDataSource();
              var fieldIndex = area === 'row' ? 1 : 0;
            ...
            QUnit.test(("Render -> scrollTo(). UseNative: " + useNative + ", expandDimension: " + area), function(assert) {
              ...
              this.clock.tick(100);
              var scrollable = pivotGrid._dataArea._getScrollable();
              scrollable.scrollTo({
              ...
              this.clock.tick(100);
              var expectedRowHeaderCellText = '60';
              var expectedColHeaderCellText = '60';
            ...
            QUnit.test(("Render -> scrollTo() -> expandHeader. UseNative: " + useNative + ", expandDimension: " + area), function(assert) {
              ...
              var getExpandedCells = function() {
                return pivotGrid.$element().find('.dx-pivotgrid-expanded');
              };
      ...
      QUnit.module('Field Panel', {beforeEach: function() {
          moduleConfig.beforeEach.apply(this, arguments);
        ...
        QUnit.test('pivot grid has correct size', function(assert) {
          var pivotGrid = createPivotGrid($.extend(true, this.testOptions, {
            height: 250,
            width: 1200,
            fieldPanel: {allowFieldDragging: false}
          }));
          var tableElement = pivotGrid.$element().find('table').first();
          ...
          var rowAreaColumnWidth = pivotGrid._rowsArea.getColumnsWidth();
          var baseFieldChooser = pivotGrid.$element().dxPivotGridFieldChooserBase('instance');
        ...
        QUnit.test('Column and Filter Headers', function(assert) {
          ...
          var filterFieldTextElements = tableElement.find('.dx-column-header').find('.dx-area-field-content');
        ...
        QUnit.test('Synchronize rowsFields and row headers', function(assert) {
          this.testOptions.dataSource.fields.push({
            area: 'row',
            caption: 'Row Field 3'
          });
          var pivotGrid = createPivotGrid(this.testOptions);
          ...
          var rowAreaColumnWidth = getColumnWidth(pivotGrid._rowsArea.tableElement());
        ...
        QUnit.test('PivotGrid should have correct height if filter fields take several lines', function(assert) {
          ...
          var container = pivotGrid.$element().find('.dx-pivotgrid-container').first();
        ...
        QUnit.test('PivotGrid should take into account horizontal scroll height if filter fields take several lines', function(assert) {
          ...
          var dataAreaHeight = getHeight(pivotGrid.$element().find('.dx-pivotgrid-area-data'));
          pivotGrid.option({scrolling: {useNative: true}});
          var newDataAreaHeight = getHeight(pivotGrid.$element().find('.dx-pivotgrid-area-data'));
          var newRowsAreaHeight = getHeight(pivotGrid.$element().find('.dx-pivotgrid-vertical-headers.dx-pivotgrid-area'));
        ...
        QUnit.test('Fields are draggable', function(assert) {
          var pivotGrid = createPivotGrid($.extend(true, this.testOptions, {fieldPanel: {allowFieldDragging: true}}));
          var field = pivotGrid.$element().find('.dx-area-field').first();
          pointerMock(field).start().down().move(-10, -1).move(-20, -1);
          assert.strictEqual($('.dx-drag').length, 1);
        });
        [true, false].forEach(function(showDataFields) {
          ['standard', 'virtual'].forEach(function(scrollingMode) {
            [true, false].forEach(function(useNative) {
              [true, false].forEach(function(fieldPanelVisible) {
                QUnit.test(("Data area has correct height. FieldPanel.visible=" + fieldPanelVisible + ", showDataFields=" + showDataFields + ", scrollingMode=" + scrollingMode + ",useNative=" + useNative + " (T933699)"), function(assert) {
                  ...
                  var $dataAreaCell = pivotGrid.$element().find(("." + DATA_AREA_CELL_CLASS)).first();
                  var expectedHeight = fieldPanelVisible ? 31 : 86;
      ...
      QUnit.module('Tests with real timer', {}, function() {
      ...
      QUnit.module('Tests with stubs', {
        beforeEach: function() {
          var that = this;
          var HorizontalHeadersArea = HeadersAreaModule.HorizontalHeadersArea;
          var VerticalHeadersArea = HeadersAreaModule.VerticalHeadersArea;
          var DataArea = DataAreaModule.DataArea;
          var DataController = DataControllerModule.DataController;
          ...
          sinon.stub(DataControllerModule, 'DataController').callsFake(function(options) {
            ...
            var dataSource = createMockDataSource(options.dataSource);
        ...
        QUnit.test('columns area row height calculation when description area is big', function(assert) {
          ...
          var tableElement = pivot.$element().find('table').first();
          var descriptionCell = tableElement.find('.dx-area-description-cell');
          setHeight(descriptionCell, 80);
          var delta = (getOuterHeight(descriptionCell[0], true) - 28) / 2;
        ...
        QUnit.test('DataController creation', function(assert) {
          ...
          var dataControllerOptions = DataControllerModule.DataController.lastCall.args[0];
        ...
        QUnit.test('Change DataController options', function(assert) {
          ...
          $.each(['texts', 'showColumnGrandTotals', 'showColumnTotals', 'showRowGrandTotals', 'showRowTotals', 'showTotalsPrior', 'hideEmptySummaryCells', 'rowHeaderLayout'], function(index, optionName) {
            widget.option(optionName, index);
          });
          assert.ok(DataControllerModule.DataController.calledWithNew);
          assert.ok(DataControllerModule.DataController.calledOnce);
          var dataController = DataControllerModule.DataController.lastCall.returnValue;
          var dataControllerOptions = dataController.updateViewOptions.lastCall.args[0];
      ...
      QUnit.module('headersArea', {
        ...
        QUnit.test('getColumnWidths', function(assert) {
          ...
          var testElement = $('#pivotArea');
          headersArea.render(testElement, [[{text: '1'}, {
            text: '12',
            rowspan: 2
          }, {
            text: '123',
        ...
        QUnit.test('Apply borders right style for last cells', function(assert) {
          ...
          var rows = testElement.find('table')[0].rows;
        ...
        QUnit.test('EncodeHtml is enabled', function(assert) {
          var headersArea = createHeadersArea(null, false, {encodeHtml: true});
          var testElement = $('#pivotArea');
          headersArea.render(testElement, [[{
            text: '<b>A</b>',
            colspan: 2,
        ...
        QUnit.test('Render when virtual scrolling is enabled', function(assert) {
          var area = createHeadersArea(undefined, undefined, {'scrolling.mode': 'virtual'});
          var testElement = $('#pivotArea');
        ...
        QUnit.test('get scroll path with virtual scrolling. Horizontal', function(assert) {
          var area = createHeadersArea(undefined, false, {'scrolling.mode': 'virtual'});
          var testElement = $('#pivotGrid').addClass('dx-pivotgrid').addClass('dx-virtual-mode');
          area.render(testElement, [[{
            text: '<b>A</b>',
            colspan: 2,
            expanded: true,
        ...
        QUnit.test('get scroll path with virtual scrolling. Vertical', function(assert) {
          var area = createHeadersArea(undefined, true, {'scrolling.mode': 'virtual'});
          var testElement = $('#pivotGrid').addClass('dx-pivotgrid').addClass('dx-virtual-mode');
          area.render(testElement, [[{
            text: 'A',
            rowspan: 2,
      ...
      QUnit.module('Vertical headers', {
        beforeEach: function() {
          this.data = [[{
            ...
            text: 'P11.1111111111111111',
            type: 'D'
          }], [{
            text: 'P11.222222222222222222222',
            type: 'D'
          }], [{
            text: 'P11 Total',
            colspan: 2,
        ...
        QUnit.skip('headers and data columns has same width', function(assert) {
          ...
          grid.repaint();
          var columnsWidth = grid._columnsArea.getColumnsWidth();
          var dataWidth = grid._dataArea.getColumnsWidth();
          assert.deepEqual(columnsWidth, dataWidth);
        });
        function needRunZoomTest() {
          var isNoJquery = !config().useJQuery;
          var isNewJQuery = parseInt($.fn.jquery) >= 3;
          ...
          ['standard', 'virtual'].forEach(function(scrollingMode) {
            [true, false].forEach(function(useNative) {
              QUnit.test(("No extra scrollbar on zoom, useNative=" + useNative + ", scrollingMode=" + scrollingMode + " (T914454)"), function(assert) {
                ...
                grid.$element().css('zoom', 1.35);
                grid.repaint();
                var containerWidth = grid._dataArea.element().find('.dx-scrollable-container').get(0).getBoundingClientRect().width;
                var contentWidth = grid._dataArea.element().find('.dx-scrollable-content').last().get(0).getBoundingClientRect().width;
        ...
        [true, false].forEach(function(remoteOperations) {
          QUnit.test('dataSource.remoteOperations=${remoteOperations}, store.load = returns empty array as arguments list', function(assert) {
            var grid = $('#pivotGrid').dxPivotGrid({dataSource: {
                remoteOperations: remoteOperations,
                fields: [{area: 'row'}, {area: 'column'}, {area: 'data'}],
                load: function() {
                  var d = $.Deferred();
                  d.resolve([]);
                  return d.promise();
            ...
            var grid = $('#pivotGrid').dxPivotGrid({
              ...
              dataSource: {
                ...
                load: function() {
                  ...
                  d.resolve([{
                    row: 'row',
                    date: new Date('2021-05-24T03:24:00'),
                    amount: 1
                  }]);
                  return d.promise();
                }
            ...
            var grid = $('#pivotGrid').dxPivotGrid({
              ...
              dataSource: {
                ...
                load: function(options) {
                  var d = $.Deferred();
                  var date = new Date('2021-05-24T03:24:00');
          ...
          QUnit.test('PivotGrid. [col x row x data]. remoteOperations = true. displayText is specified. Resolve data as arguments list. JQuery promise', function(assert) {
            ...
            var grid = $('#pivotGrid').dxPivotGrid({
              onContentReady: function() {
                checkFieldsTypes(grid, assert);
                checkPivotGridCellsText(grid, {
                  row: 'displayText in row',
                  column: 'displayText in column'
                }, assert);
                done();
              },
              dataSource: {
                ...
                load: function(options) {
                  ...
                  if (options.group === undefined) {
                    ...
                    d.resolve([{
                      key: date.getFullYear(),
                      summary: [1],
                      displayText: 'displayText in column'
                    }]);
                  } else if (options.group && options.group[0].selector === 'row') {
                    d.resolve([{
                      key: 'row',
                      summary: [1],
                      displayText: 'displayText in row',
                      items: [{
                        key: date.getFullYear(),
                        summary: [1]
                      }]
        ...
        ['instantly', 'onDemand'].forEach(function(applyChangesMode) {
          ['row', 'column'].forEach(function(changedArea) {
            function createPivotGridAndExpandHeaderItem(fieldsChooserFieldsUpdater) {
              ...
              clock.tick(10);
              grid.getFieldChooserPopup().show().done(function() {
                var fieldChooser = grid.getFieldChooserPopup().$content().dxPivotGridFieldChooser('instance');
            ...
            QUnit.test(("After expanding the " + changedArea + ", expandedPath must be assigned (T928525)"), function(assert) {
              createPivotGridAndExpandHeaderItem(function(fieldChooser) {
                var state = fieldChooser.getDataSource().state();
                if (changedArea === 'row') {
            ...
            QUnit.test(("Remove first item from the " + changedArea + " area must clear the expandedPath (T928525)"), function(assert) {
              createPivotGridAndExpandHeaderItem(function(fieldChooser) {
                ...
                var newState = fieldChooser.getDataSource().state();
          ...
          QUnit.test(("applyChangesMode=" + applyChangesMode + ". fieldChooser.option(state, newState). fieldChooser.applyChanges()"), function(assert) {
            createGridAndTestFieldChooser(function(grid, fieldChooser, clock) {
              var fields = grid.getDataSource().state().fields;
              fieldChooser.option('state', {
                rowExpandedPaths: [['row1']],
                columnExpandedPaths: [['column1']],
                fields: fields
              });
              clock.tick(10);
              var dataSourceState = grid.getDataSource().state();
              ...
              var optionState = fieldChooser.option('state');
          ...
          QUnit.test(("applyChangesMode=" + applyChangesMode + ". onOptionChanged must be fired if dataSource changed"), function(assert) {
            createGridAndTestFieldChooser(function(grid, fieldChooser, clock) {
              ...
              fieldChooser.option('onOptionChanged', function(e) {
                if (e.name === 'state') {
          ...
          QUnit.test(("applyChangesMode=" + applyChangesMode + ". pivotGrid.dataSource.state(newState) multiple times"), function(assert) {
            createGridAndTestFieldChooser(function(grid, fieldChooser, clock) {
              var dataSourceEventsCount = 0;
              fieldChooser.getDataSource().on('changed', function() {
                dataSourceEventsCount++;
              });
              var state = fieldChooser.getDataSource().state();
        ...
        ['allowExpandAll', 'allowSortingBySummary', 'allowFiltering'].forEach(function(option) {
          ...
          [false, true].forEach(function(isEnabledInGrid) {
            ['simpleObject', 'pivotGridDataSource'].forEach(function(dataSourceType) {
              QUnit.test(("grid." + option + "=" + isEnabledInGrid + " -> grid." + option + "=" + !isEnabledInGrid + ". Changing option of pivotGrid affects the field option (T950953). dataSourceType: " + dataSourceType), function(assert) {
                var getFields = function(grid) {
                  return grid.getDataSource().fields();
                };
                var dataSource = getSourceData();
                var gridOptions = {};
                gridOptions[option] = isEnabledInGrid;
                gridOptions.dataSource = dataSourceType === 'simpleObject' ? dataSource : new PivotGridDataSource(dataSource);
                var grid = $('#pivotGrid').dxPivotGrid(gridOptions).dxPivotGrid('instance');
                this.clock.tick(10);
                getFields(grid).forEach(function(field) {
                  return assert.strictEqual(field[option], isEnabledInGrid, 'option is initialized correctly');
                });
                grid.option(option, !isEnabledInGrid);
                this.clock.tick(10);
                getFields(grid).forEach(function(field) {
                  return assert.strictEqual(field[option], !isEnabledInGrid, 'option is changed');
                });
              });
              [false, true].forEach(function(isEnabledInField) {
                QUnit.test(("grid." + option + "=" + isEnabledInGrid + ", grid.allFields." + option + "=" + isEnabledInField + " -> grid." + option + "=" + !isEnabledInGrid + ". Changing option of pivotGrid doesn't affects the field option if it has value (T950953). dataSourceType: " + dataSourceType), function(assert) {
                  ...
                  var gridOptions = {};
                  gridOptions[option] = isEnabledInGrid;
                  dataSource.fields.forEach(function(f) {
                    return f[option] = isEnabledInField;
                  });
                  gridOptions.dataSource = dataSourceType === 'simpleObject' ? dataSource : new PivotGridDataSource(dataSource);
                  var grid = $('#pivotGrid').dxPivotGrid(gridOptions).dxPivotGrid('instance');
                  this.clock.tick(10);
                  getFields(grid).forEach(function(field) {
                    return assert.strictEqual(field[option], isEnabledInField, 'option is initialized correctly');
                  });
                  grid.option(option, !isEnabledInGrid);
                  this.clock.tick(10);
                  getFields(grid).forEach(function(field) {
                    return assert.strictEqual(field[option], isEnabledInField, 'option is not changed');
                  });
                });
              });
            });
      ...
      QUnit.module('Data area', function() {
        ...
        QUnit.test('EncodeHtml is enabled', function(assert) {
          var dataArea = createDataArea({encodeHtml: true});
          var testElement = $('#pivotArea');
          var data = [[{
            columnType: 'D',
            rowType: 'D',
        ...
        QUnit.test('setVirtualContentParams.', function(assert) {
          var area = createDataArea({'scrolling.mode': 'virtual'});
          var testElement = $('#pivotGrid').addClass('dx-pivotgrid').addClass('dx-virtual-mode');
          area.render(testElement, []);
          area.setVirtualContentParams({
            left: 10,
        ...
        QUnit.module('T1003928', {
          ...
          function getDataAreaVisibleText(pivotGrid) {
            return pivotGrid._dataArea.element().children(':visible').text().trim();
          }
          QUnit.test('field.visible:false]', function(assert) {
            var dataAreaCellPreparedCallCount = 0;
            var pivot = $('#pivotGrid').dxPivotGrid({
              onCellPrepared: function(e) {
                if (e.area === 'data') {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["animation/fx","events/core/events_engine","core/config","core/devices","core/element_data","core/utils/size","core/utils/type","core/utils/shadow_dom","events/visibility_change","generic_light.css!","jquery","localization/date","__internal/grids/pivot_grid/data_source/module","ui/pivot_grid/ui.pivot_grid","__internal/grids/pivot_grid/area_item/module","__internal/grids/pivot_grid/data_area/module","__internal/grids/pivot_grid/data_controller/module","__internal/grids/pivot_grid/headers_area/module","__internal/grids/pivot_grid/module_widget_utils","ui/scroll_view/ui.scrollable","../../helpers/pointerMock.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("animation/fx"), require("events/core/events_engine"), require("core/config"), require("core/devices"), require("core/element_data"), require("core/utils/size"), require("core/utils/type"), require("core/utils/shadow_dom"), require("events/visibility_change"), require("generic_light.css!"), require("jquery"), require("localization/date"), require("__internal/grids/pivot_grid/data_source/module"), require("ui/pivot_grid/ui.pivot_grid"), require("__internal/grids/pivot_grid/area_item/module"), require("__internal/grids/pivot_grid/data_area/module"), require("__internal/grids/pivot_grid/data_controller/module"), require("__internal/grids/pivot_grid/headers_area/module"), require("__internal/grids/pivot_grid/module_widget_utils"), require("ui/scroll_view/ui.scrollable"), require("../../helpers/pointerMock.js"));
  else
