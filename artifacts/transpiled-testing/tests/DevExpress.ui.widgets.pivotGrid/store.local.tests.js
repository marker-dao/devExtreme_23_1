...
(["testing/tests/DevExpress.ui.widgets.pivotGrid/store.local.tests.js"], ["../../content/orders.js","data/odata/store","jquery","core/utils/common","ui/pivot_grid/local_store","ui/pivot_grid/data_source.utils","ui/pivot_grid/ui.pivot_grid.utils","core/config","format_helper","../../helpers/ajaxMock.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.pivotGrid/store.local.tests.js", ["../../content/orders.js", "data/odata/store", "jquery", "core/utils/common", "ui/pivot_grid/local_store", "ui/pivot_grid/data_source.utils", "ui/pivot_grid/ui.pivot_grid.utils", "core/config", "format_helper", "../../helpers/ajaxMock.js"], function($__export) {
  "use strict";
  var $,
      noop,
      LocalStore,
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module('Local Store Initialization', function() {
        ...
        QUnit.test('OData Store', function(assert) {
          ...
          this.store = new LocalStore({store: {
              type: 'odata',
              url: '/mock-odata'
            }});
          this.store.load({
        ...
        QUnit.test('Fail on load', function(assert) {
          assert.expect(1);
          var store = new LocalStore({load: function() {
      ...
      QUnit.module('Array Local Store', moduleConfig, function() {
        ...
        QUnit.test('Numeric intervals. With format and without custom customizeText callback', function(assert) {
          ...
          this.load({
            ...
            assert.deepEqual(formatHelper.format.lastCall.args, [100, {
              type: 'currency',
              precision: 2
            }]);
            assert.strictEqual(field.customizeText({
        ...
        QUnit.test('Expand undefined value', function(assert) {
          this.load({
            path: [undefined],
            rows: [{dataField: 'missedField'}, {dataField: 'ShipCountry'}],
            columns: [],
            values: [{summaryType: 'count'}],
            headerName: 'rows'
          }).done(function(data) {
        ...
        QUnit.test('Filter in rows and columns', function(assert) {
          this.load({
            rows: [{
              ...
              dataField: 'ShipCity',
              filterValues: ['Boise', 'Lander', 'Montreal'],
              filterType: 'exclude'
            }],
            columns: [{
              dataField: 'OrderDate',
            ...
            assert.deepEqual(data.columns, [{
              index: 1,
              value: 1997
            }]), assert.deepEqual(data.values, [[[10], [10]], [[7], [7]], [[3], [3]]]);
          });
        });
        ...
        QUnit.test('Filter group field. Include Type', function(assert) {
          this.load({
            ...
            assert.deepEqual(data.columns, [{
              ...
              index: 2,
              value: 1997
            }]), assert.deepEqual(data.values, [[[42], [27], [15]], [[33], [23], [10]], [[9], [4], [5]]]);
          });
        });
        QUnit.test('Filter group field. Exclude Type', function(assert) {
          this.load({
            ...
            filters: [{
              dataField: 'OrderDate',
              groupName: 'OrderDate',
              filterValues: [[1996], [1997, 1], [1997, 3, 8], [1998, undefined, 2]],
              filterType: 'exclude',
              levels: [{
                dataField: 'OrderDate',
                groupInterval: 'year',
            ...
            assert.deepEqual(data.values, [[[105], [57], [48]], [[18], [9], [9]], [[87], [48], [39]]]);
          });
        });
        QUnit.test('Filter dates without group interval', function(assert) {
          ...
          new LocalStore(dataSource).load({
            ...
            columns: [{
              dataField: 'OrderDate',
              dataType: 'date',
              filterValues: [new Date(window.orders[0].OrderDate), null],
              filterType: 'include'
            }],
            values: [{summaryType: 'count'}]
          }).done(function(data) {
        ...
        QUnit.test('complex dataField', function(assert) {
          ...
          new LocalStore(dataSource).load({
            columns: [{dataField: 'Customer.name'}],
            values: [{
              dataField: 'Freight',
              summaryType: 'sum',
              dataType: 'number'
        ...
        QUnit.test('Date dataField with ISO8601 format without forceIsoDateParsing', function(assert) {
          ...
          try {
            var dataSource = [{'Date': '2015-08-05T13:30:15'}];
            new LocalStore(dataSource).load({
              columns: [{
                dataField: 'Date',
                dataType: 'date'
        ...
        QUnit.test('reload data', function(assert) {
          ...
          localStore.load({values: [{dataField: 'OrderID'}]}).done(function(data) {
        ...
        QUnit.test('filter data', function(assert) {
          ...
          var localStore = new LocalStore(dataSource);
          localStore.load({values: [{dataField: 'OrderID'}]});
      ...
      QUnit.module('DrillDown', {beforeEach: function() {
        ...
        QUnit.test('DrillDown by path with maxRowCount', function(assert) {
          ...
          assert.strictEqual(store.getDrillDownItems(loadOptions, {
            columnPath: [],
            rowPath: [],
            maxRowCount: 0
          }).length, 830, 'GrandTotal with maxRowCount is 0');
          assert.strictEqual(store.getDrillDownItems(loadOptions, {
            columnPath: [],
            rowPath: [],
            maxRowCount: 100
          }).length, 100, 'GrandTotal');
          assert.strictEqual(store.getDrillDownItems(loadOptions, {
            columnPath: ['Argentina'],
            rowPath: [1],
            maxRowCount: 100
          }).length, 5, 'ShipVia 1 - Argentina');
        });
        QUnit.test('DrillDown by path with customColumns', function(assert) {
          ...
          this.load(loadOptions);
          var drillDownItems = store.getDrillDownItems(loadOptions, {
            columnPath: [],
            rowPath: [],
            customColumns: ['CustomerID', 'ShipAddress']
          });
        ...
        QUnit.test('DrillDown by path when groups', function(assert) {
          ...
          this.load(loadOptions);
          var drillItems = store.getDrillDownItems(loadOptions, {
            columnPath: [1997, 2, 6],
            rowPath: ['Brazil'],
            customColumns: ['OrderID']
          });
          assert.strictEqual(drillItems.length, 2);
          assert.deepEqual(drillItems, [{OrderID: 10563}, {OrderID: 10581}]);
        });
      });
      QUnit.module('Custom Store local filtering', function() {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../content/orders.js","data/odata/store","jquery","core/utils/common","ui/pivot_grid/local_store","ui/pivot_grid/data_source.utils","ui/pivot_grid/ui.pivot_grid.utils","core/config","format_helper","../../helpers/ajaxMock.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../content/orders.js"), require("data/odata/store"), require("jquery"), require("core/utils/common"), require("ui/pivot_grid/local_store"), require("ui/pivot_grid/data_source.utils"), require("ui/pivot_grid/ui.pivot_grid.utils"), require("core/config"), require("format_helper"), require("../../helpers/ajaxMock.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=store.local.tests.js.map