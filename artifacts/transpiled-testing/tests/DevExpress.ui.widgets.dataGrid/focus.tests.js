...
(["testing/tests/DevExpress.ui.widgets.dataGrid/focus.tests.js"], ["generic_light.css!","ui/data_grid","data/odata/store","jquery","data/array_store","events/pointer","events/click","../../helpers/dataGridMocks.js","../../helpers/wrappers/dataGridWrappers.js","../../helpers/grid/keyboardNavigationHelper.js","core/utils/common"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.dataGrid/focus.tests.js", ["generic_light.css!", "ui/data_grid", "data/odata/store", "jquery", "data/array_store", "events/pointer", "events/click", "../../helpers/dataGridMocks.js", "../../helpers/wrappers/dataGridWrappers.js", "../../helpers/grid/keyboardNavigationHelper.js", "core/utils/common"], function($__export) {
  "use strict";
  var $,
      ArrayStore,
      pointerEvents,
  ...
  return {
    ...
    execute: function() {
      ...
      getModuleConfig = function(keyboardNavigationEnabled) {
        return {
          setupModule: function() {
            ...
            this.options = $.extend(true, {
              ...
              keyboardNavigation: {enabled: keyboardNavigationEnabled},
              tabIndex: 0,
            ...
            setupDataGridModules(this, ['data', 'columns', 'columnHeaders', 'rows', 'editorFactory', 'grouping', 'gridView', 'editing', 'editingRowBased', 'editingFormBased', 'editingCellBased', 'focus', 'selection', 'keyboardNavigation', 'validating', 'masterDetail', 'virtualScrolling', 'adaptivity', 'columnFixing', 'pager'], {initViews: true});
          },
          beforeEach: function() {
      ...
      scrollTo = function(that, location) {
      ...
      QUnit.module('Focused row', getModuleConfig(true), function() {
        ...
        QUnit.testInActiveWindow('Arrow Up key should decrease focusedRowIndex', function(assert) {
          ...
          keyboardController._upDownKeysHandler({
            key: 'ArrowUp',
            keyName: 'upArrow'
          });
        ...
        ['batch', 'cell', 'row', 'form'].forEach(function(mode) {
        ...
        QUnit.test('Row should be focused after click if editing.mode: cell', function(assert) {
          ...
          if (isMobile) {
            ...
            $cell.trigger(pointerEvents.down).trigger(clickEvent.name);
          }
          this.clock.tick(10);
          assert.equal(this.option('focusedRowIndex'), 1, 'FocusedRowIndex');
        ...
        QUnit.testInActiveWindow('ArrowUp / ArrowDown should not change focus type', function(assert) {
          this.options = {focusedRowEnabled: true};
          this.data = [{
            name: 'Alex',
            phone: '555555',
            room: 1
        ...
        QUnit.testInActiveWindow('DataGrid should restore focused row when data without focused row was filtered', function(assert) {
          ...
          this.clock.tick(10);
          var rowsView = this.gridView.getView('rowsView');
          var visibleRows = this.dataController.getVisibleRows();
          assert.equal(this.option('focusedRowIndex'), 1, 'focusedRowIndex');
        ...
        QUnit.test('Focus types test', function(assert) {
          this.options = {editing: {allowEditing: false}};
          this.setupModule();
          this.gridView.render($('#container'));
          this.clock.tick(10);
        ...
        QUnit.testInActiveWindow('Not highlight cell by isHighlighted arg in the onFocusedCellChanging event by LeftArrow key', function(assert) {
          var focusedColumnChangingCount = 0;
          this.data = [{
            name: 'Alex',
            phone: '111111',
            room: 6
          ...
          assert.equal(this.option('focusedColumnIndex'), 1, 'FocusedColumnIndex');
          keyboardController._leftRightKeysHandler({
            key: 'ArrowLeft',
            keyName: 'leftArrow'
          });
          this.clock.tick(10);
        ...
        QUnit.testInActiveWindow('Fire onFocusedCellChanging by Tab key', function(assert) {
          var focusedCellChangingCounter = 0;
          this.data = [{
            name: 'Alex',
            phone: '111111',
            room: 6
          ...
          this.options = {
            ...
            onFocusedCellChanging: function(e) {
              if (++focusedCellChangingCounter > 2) {
                var columnIndex = focusedCellChangingCounter - 1;
                assert.equal(e.cancel, false, 'Not canceled');
        ...
        QUnit.testInActiveWindow('Highlight cell on focus() if focusedRowIndex, focusedColumnIndex are not set', function(assert) {
          var focusedCellChangingCount = 0;
          this.options = {onFocusedCellChanging: function(e) {
              ++focusedCellChangingCount;
            }};
          this.setupModule();
          this.gridView.render($('#container'));
        ...
        QUnit.testInActiveWindow('Fire onFocusedRowChanging by UpArrow key when virtual scrolling is enabled', function(assert) {
          ...
          rowsView.height(400);
          rowsView.resize();
          var scrollable = rowsView.getScrollable();
        ...
        QUnit.testInActiveWindow('Fire onFocusedRowChanging by Tab key', function(assert) {
          var focusedRowChangingCounter = 0;
          this.data = [{
            name: 'Alex',
            phone: '111111',
            room: 6
        ...
        QUnit.testInActiveWindow('Focused row events should not fire if dataGrid is in loading phase', function(assert) {
          ...
          this.data = {load: function(options) {
              var d = $.Deferred();
              setTimeout(function() {
                d.resolve({
                  data: items.slice(options.skip, options.skip + options.take),
        ...
        QUnit.testInActiveWindow('onFocusedChanged args should be correct after data change', function(assert) {
          ...
          var onFocusedRowChangedArgs = onFocusedRowChangedSpy.secondCall.args[0];
        ...
        QUnit.test('onFocusedCellChanged event should contains correct row object if scrolling mode is virtual', function(assert) {
          ...
          that.options = {
            ...
            onFocusedCellChanged: function(e) {
              ...
              var globalRowIndex = that.pageIndex() * that.pageSize();
          ...
          var rowsView = that.gridView.getView('rowsView');
          rowsView.height(100);
          rowsView.resize();
          var scrollable = rowsView.getScrollable();
          that.clock.tick(10);
          ...
          that.clock.tick(10);
          var visibleRow = that.getVisibleRows()[0];
        ...
        QUnit.testInActiveWindow('isHighlighted in the onFocusedCellChanged event', function(assert) {
          var focusedColumnChangingCount = 0;
          var focusedColumnChangedCount = 0;
          this.options = {
            onFocusedCellChanging: function(e) {
              ++focusedColumnChangingCount;
              e.isHighlighted = true;
        ...
        QUnit.testInActiveWindow('The page with focused row should load without errors after sorting the boolean column', function(assert) {
          ...
          assert.deepEqual(loadSpy.getCall(2).args[0].filter, [['isRoom', '<>', true], 'or', [['isRoom', '=', true], 'and', [[['name', '<', 'Alex'], 'or', ['name', '=', null]], 'or', [['name', '=', 'Alex'], 'and', ['name', '<', 'Alex']]]]]);
        });
        QUnit.test('Focused row should be visible if set focusedRowKey', function(assert) {
          ...
          this.gridView.render($('#container'));
          var rowsView = this.gridView.getView('rowsView');
          rowsView.scrollToElementVertically = function($row) {
            ++counter;
        ...
        QUnit.testInActiveWindow('Keyboard navigation controller should find next cell if column index is wrong when jump from the group row', function(assert) {
          ...
          this.options = {
            ...
            focusedRowIndex: 0,
            focusedColumnIndex: 1,
            columns: [{type: 'selection'}, 'name', 'phone', {
              dataField: 'room',
              groupIndex: 0,
              autoExpandGroup: true
            }]
          ...
          keyboardController._focusedView = rowsView;
          assert.equal(this.option('focusedRowIndex'), 0, 'FocusedRowIndex is 0');
          var $cell = keyboardController._getNextCell('downArrow');
        ...
        QUnit.testInActiveWindow('DataGrid should focus the row bellow by arrowDown key if grid focused and if selection multiple', function(assert) {
          ...
          this.options = {
            ...
            focusedRowEnabled: true,
            focusedRowIndex: 0,
            columns: [{type: 'selection'}, 'name', 'phone', 'room']
          };
          this.setupModule();
          this.gridView.render($('#container'));
          this.clock.tick(10);
        ...
        QUnit.test('autoNavigateToFocusedRow == false and paging if scrolling mode is virtual', function(assert) {
          ...
          this.data = [{id: 1}, {id: 2}, {id: 3}, {id: 4}, {id: 5}, {id: 6}, {id: 7}, {id: 8}];
          this.setupModule();
          this.gridView.render($('#container'));
          this.clock.tick(10);
        ...
        QUnit.test('Focused row events should handle only once after click disabled editing cell if editing.mode: cell', function(assert) {
          var focusedRowChangingCounter = 0;
          var focusedRowChangedCounter = 0;
          this.options = {
            focusedRowEnabled: true,
            keyExpr: 'name',
            editing: {
            ...
            onFocusedRowChanging: function(e) {
              return ++focusedRowChangingCounter;
            },
            onFocusedRowChanged: function(e) {
              return ++focusedRowChangedCounter;
            }
          };
          this.data = [{
            name: 'Alex',
        ...
        QUnit.testInActiveWindow('Virtual Scrolling - DataGrid should not focus inserted row', function(assert) {
          ...
          this.addRow();
          this.clock.tick(10);
          var newRowIndex = rowsView.getTopVisibleItemIndex();
          var newRow = this.getVisibleRows()[newRowIndex];
      ...
      [true, false].forEach(function(keyboardNavigationEnabled) {
        QUnit.module(("FocusedRow with real dataController and columnsController, keyboardNavigation.enabled = " + keyboardNavigationEnabled), getModuleConfig(keyboardNavigationEnabled), function() {
          [true, false].forEach(function(repaintChangesOnly) {
            [undefined, 0, 1].forEach(function(focusedRowKey) {
              QUnit.test(("Paging: set focusedRowKey on the next page: repaintChangesOnly=" + repaintChangesOnly + ", focusedRowKey=" + focusedRowKey), function(assert) {
                ...
                if (focusedRowKey) {
                  var dataRow = rowsViewWrapper.getDataRow(focusedRowKey);
            ...
            [undefined, 0, 1].forEach(function(focusedRowIndex) {
              QUnit.test(("Paging: set focusedRowKey on the next page: repaintChangesOnly=" + repaintChangesOnly + ", focusedRowIndex=" + focusedRowIndex), function(assert) {
                ...
                if (focusedRowIndex) {
                  var dataRow = rowsViewWrapper.getDataRow(focusedRowIndex);
                  assert.ok(dataRow.isFocusedRow(), 'Row is focused');
                }
                this.option('focusedRowKey', 3);
                this.clock.tick(10);
          ...
          QUnit.testInActiveWindow('onSelectionChanged event should fire if focusedRowEnabled (T729611)', function(assert) {
            ...
            this.options = {
              ...
              onSelectionChanged: function() {
                return ++selectionChangedFiresCount;
              }
            };
            this.setupModule();
            this.gridView.render($('#container'));
          ...
          QUnit.testInActiveWindow('DataGrid should not show error E1042 if keyExpr is missing and focusedRowEnabled is false', function(assert) {
            var dataErrors = [];
            this.options = {focusedRowEnabled: false};
            this.data = [{
              team: 'internal',
              name: 'Alex',
              age: 30
          ...
          QUnit.testInActiveWindow('Focused row different key support', function(assert) {
            ...
            this.setupModule();
            this.option('focusedRowKey', {
              key0: '1',
              key1: '2'
            });
            assert.ok(this.getController('focus').isRowFocused({
              key0: '1',
              key1: '2'
            }), 'Composite key equal');
            assert.notOk(this.getController('focus').isRowFocused({
              key0: '4',
              key1: '2'
            }), 'Composite key not equal');
          ...
          QUnit.testInActiveWindow('Should not render overlay on focused row with tabindex if useKeyboard set false', function(assert) {
            ...
            this.gridView.render($('#container'));
            this.clock.tick(10);
            $(this.getRowElement(1)).attr('tabindex', 0).focus();
          ...
          QUnit.testInActiveWindow('DataGrid should reset focused row if focusedRowKey is set to undefined', function(assert) {
            var focusedRowChangedCallsCount = 0;
            this.options = {
              keyExpr: 'name',
              focusedRowEnabled: true,
              focusedRowIndex: 1,
          ...
          QUnit.testInActiveWindow('DataGrid should raise exception if focusedRowEnabled and dataSource has no operationTypes', function(assert) {
            ...
            this.gridView.render($('#container'));
            this.clock.tick(10);
            this.getController('data')._dataSource.operationTypes = function() {
              return undefined;
            };
            try {
              this.option('focusedRowKey', 'Dan');
          ...
          QUnit.testInActiveWindow('DataGrid - click by cell should not generate exception if rowTemplate is used (T800604)', function(assert) {
            ...
            keyboardController._focusedView = rowsView;
            try {
              var virtualRowWrapper = dataGridWrapper.rowsView.getVirtualRow();
              var $virtualCell0 = virtualRowWrapper.getCell(0).getElement();
              var $virtualCell1 = virtualRowWrapper.getCell(1).getElement();
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["generic_light.css!","ui/data_grid","data/odata/store","jquery","data/array_store","events/pointer","events/click","../../helpers/dataGridMocks.js","../../helpers/wrappers/dataGridWrappers.js","../../helpers/grid/keyboardNavigationHelper.js","core/utils/common"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("generic_light.css!"), require("ui/data_grid"), require("data/odata/store"), require("jquery"), require("data/array_store"), require("events/pointer"), require("events/click"), require("../../helpers/dataGridMocks.js"), require("../../helpers/wrappers/dataGridWrappers.js"), require("../../helpers/grid/keyboardNavigationHelper.js"), require("core/utils/common"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=focus.tests.js.map