...
(["testing/tests/DevExpress.ui.widgets.dataGrid/columnsController.tests.js"], ["jquery","data/data_source/data_source","data/array_store","localization/date","core/utils/type","ui/data_grid/ui.data_grid.core","ui/data_grid/ui.data_grid.data_source_adapter","../../helpers/executeAsyncMock.js","../../helpers/dataGridMocks.js","core/config","ui/widget/ui.errors","core/errors","../../helpers/ajaxMock.js","ui/data_grid","localization/globalize/currency","localization/globalize/number","localization/core"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.dataGrid/columnsController.tests.js", ["jquery", "data/data_source/data_source", "data/array_store", "localization/date", "core/utils/type", "ui/data_grid/ui.data_grid.core", "ui/data_grid/ui.data_grid.data_source_adapter", "../../helpers/executeAsyncMock.js", "../../helpers/dataGridMocks.js", "core/config", "ui/widget/ui.errors", "core/errors", "../../helpers/ajaxMock.js", "ui/data_grid", "localization/globalize/currency", "localization/globalize/number", "localization/core"], function($__export) {
  "use strict";
  var $,
      DataSource,
      ArrayStore,
  ...
  return {
    ...
    execute: function() {
      createMockDataSource = function(items, loadOptions) {
      ...
      processColumnsForCompare = function(columns, parameterNames, ignoreParameterNames) {
        ...
        $.each(processedColumns, function() {
          ...
          for (propertyName in this) {
            if (ignoreParameterNames && $.inArray(propertyName, ignoreParameterNames) >= 0) {
              ...
              if (['filterOperations', 'showInColumnChooser', 'userDataType', 'defaultFilterOperation', 'defaultFilterOperations', 'visibleIndex', 'serializationFormat', 'resizedCallbacks', 'headerId'].indexOf(propertyName) !== -1) {
                delete this[propertyName];
              }
            }
          }
      ...
      setupModule = function(moduleNames) {
        locale('en');
        executeAsyncMock.setup();
        dataGridMocks.setupDataGridModules(this, ['columns', 'data', 'selection', 'editing', 'editingRowBased', 'filterRow', 'masterDetail'].concat(moduleNames || []), {controllers: {data: new dataGridMocks.MockDataController({items: []})}});
      ...
      QUnit.module('initialization from options', {
        ...
        QUnit.test('Initialize from options with field names', function(assert) {
          this.applyOptions({columns: ['TestField1', 'TestField2', 'TestField3']});
        ...
        QUnit.test('Initialize from options with field names and visible indexes with useLegacyVisibleIndex', function(assert) {
          ...
          try {
            ...
            var visibleColumns = this.columnsController.getVisibleColumns();
            var visibleIndices = visibleColumns.map(function(column) {
        ...
        QUnit.test('Initialize from options if visible index is specified for a single column', function(assert) {
          this.applyOptions({columns: [{
              dataField: 'TestField1',
              visibleIndex: 2
            }, {dataField: 'TestField2'}, {dataField: 'TestField3'}, {dataField: 'TestField4'}]});
          var visibleColumns = this.columnsController.getVisibleColumns();
          assert.strictEqual(visibleColumns.length, 4);
          assert.strictEqual(visibleColumns[0].dataField, 'TestField2');
        ...
        QUnit.test('Lookup column with boolean values should not have showEditorAlways (T1063568)', function(assert) {
          var dataSource = createDataSource(this, [{boolField: true}]);
          dataSource.load();
          this.columnsController.applyDataSource(dataSource);
          this.applyOptions({columns: [{
              dataField: 'boolField',
              lookup: {dataSource: [false, true]}
            }]});
          this.editingController.init();
          assert.ok(this.columnsController.isInitialized());
          var visibleColumns = this.columnsController.getVisibleColumns();
        ...
        QUnit.test('Initialize from options with objects', function(assert) {
          this.applyOptions({columns: [{
              dataField: 'TestField1',
              caption: 'Custom Title 1'
            }, {
              dataField: 'TestField2',
              caption: 'Custom Title 2',
              visible: false,
              allowSorting: false,
        ...
        QUnit.test('Initialization group indexes', function(assert) {
          this.applyOptions({columns: [{
              ...
              dataField: 'TestField5',
              groupIndex: 1
            }, {
              dataField: 'TestField6',
              grouped: true
            }, {
              dataField: 'TestField7',
              groupIndex: 1
            }]});
          assert.ok(this.columnsController.isInitialized());
        ...
        QUnit.test('Initialize from options without caption', function(assert) {
          this.applyOptions({columns: [{dataField: 'TestField1'}, {dataField: 'TestField2'}]});
          assert.ok(this.columnsController.isInitialized());
          var columns = this.getColumns();
        ...
        QUnit.test('Initialize from options without dataField', function(assert) {
          this.applyOptions({columns: [{dataField: 'TestField1'}, {visible: true}]});
          assert.ok(this.columnsController.isInitialized());
        ...
        QUnit.test('generate caption from dataField', function(assert) {
          this.applyOptions({columns: ['name', 'phoneNumber', 'ID', 'cardID', 'field1', 'field_2', 'order_ID', 'Address.City']});
        ...
        QUnit.test('calculateCellValue for column with dataField', function(assert) {
          this.applyOptions({columns: [{dataField: 'Name'}, {dataField: 'Address.City'}]});
          assert.ok(this.columnsController.isInitialized());
        ...
        QUnit.test('Save default calculateCellValue when column with custom calculateCellValue', function(assert) {
          this.applyOptions({columns: [{dataField: 'Name'}, {
              dataField: 'Address.City',
              calculateCellValue: function(data) {
                return 'test-' + this.defaultCalculateCellValue(data);
              }
            }]});
          assert.ok(this.columnsController.isInitialized());
          var columns = this.columnsController.getColumns();
        ...
        QUnit.test('getFixedColumns', function(assert) {
          ...
          assert.deepEqual(fixedColumns[1], {
            command: 'transparent',
            colspan: 3
          }, 'transparent column');
        ...
        QUnit.test('column with calculateCellValue', function(assert) {
          var calculateCellValue = function() {
            return 1;
          };
          this.applyOptions({columns: [{calculateCellValue: calculateCellValue}]});
          assert.ok(this.columnsController.isInitialized());
        ...
        QUnit.test('calculateFilterExpression for unbound column', function(assert) {
          var calculateCellValue = function(data) {
        ...
        QUnit.test('calculateFilterExpression for column with lookup and calculateDisplayValue', function(assert) {
          this.applyOptions({columns: [{
              ...
              dataType: 'string',
              lookup: {},
              calculateDisplayValue: 'TestDisplayField'
            }]});
          var column = this.columnsController.getColumns()[0];
          assert.ok(column);
          assert.ok(column.calculateFilterExpression);
        ...
        QUnit.test('calculateFilterExpression for column with date dataField', function(assert) {
          ...
          var dateStart = new Date(2012, 4, 11);
          var dateEnd = new Date(2012, 4, 12);
          var column = this.columnsController.getColumns()[0];
          assert.ok(column);
          assert.ok(column.calculateFilterExpression);
        ...
        QUnit.test('calculateFilterExpression for column with dataType is date when filterOperation is \'between\'', function(assert) {
          ...
          assert.deepEqual(column.calculateFilterExpression([dateStart, dateEnd], 'between'), [['TestField', '>=', dateStart], 'and', ['TestField', '<', new Date(2016, 7, 6)]], 'calculate filter expression for end date without time');
          dateStart = new Date(2016, 7, 1, 13, 30, 0);
          dateEnd = new Date(2016, 7, 5, 15, 40, 15);
          assert.deepEqual(column.calculateFilterExpression([dateStart, dateEnd], 'between'), [['TestField', '>=', dateStart], 'and', ['TestField', '<=', dateEnd]], 'calculate filter expression for end date with time');
        });
        QUnit.test('calculateFilterExpression for column with dataType is dateTime when filterOperation is \'between\'', function(assert) {
          ...
          var column = this.columnsController.getColumns()[0];
          var dateStart = new Date(2016, 7, 1, 0, 0, 0);
          var dateEnd = new Date(2017, 7, 1, 0, 0, 0);
          assert.deepEqual(column.calculateFilterExpression([dateStart, dateEnd], 'between'), [['TestField', '>=', dateStart], 'and', ['TestField', '<', dateEnd]], 'calculate filter expression for end date with time');
        });
        QUnit.test('calculateFilterExpression for column with dataType is \'datetime\'', function(assert) {
          ...
          var date = new Date(2012, 4, 11, 8, 30);
          var dateStart = new Date(2012, 4, 11, 8, 30);
          var dateEnd = new Date(2012, 4, 11, 8, 31);
          var column = this.columnsController.getColumns()[0];
          assert.ok(column);
          assert.ok(column.calculateFilterExpression);
          assert.deepEqual(column.calculateFilterExpression(null), ['TestField', '=', null]);
        ...
        QUnit.test('Initialize from options with fields that are specified as undefined and null', function(assert) {
          this.applyOptions({columns: ['TestField1', undefined, null, 'TestField2', 'TestField3']});
          var columns = this.columnsController.getColumns();
        ...
        QUnit.module('Auto-generated names', function() {
          QUnit.test('No duplicated dataFields', function(assert) {
            var columns = ['TestField1', 'TestField2', 'TestField3'];
            this.applyOptions({columns: columns});
            var visibleColumns = this.columnsController.getVisibleColumns();
            assert.strictEqual(visibleColumns.length, 3);
          ...
          QUnit.test('Add column', function(assert) {
            var columns = ['TestField1', 'TestField2'];
            this.applyOptions({columns: columns});
            var visibleColumns = this.columnsController.getVisibleColumns();
          ...
          QUnit.test('Duplicated dataFields', function(assert) {
            ...
            var columns = ['TestField', 'TestField'];
            this.applyOptions({columns: columns});
          ...
          QUnit.test('Multiple duplicated dataFields', function(assert) {
            sinon.spy(errors, 'log');
            var columns = ['TestField', 'TestField', 'TestField2', 'TestField2'];
            this.applyOptions({columns: columns});
            assert.equal(errors.log.callCount, 1, 'one error');
            assert.equal(errors.log.lastCall.args[0], 'E1059', 'error code');
          ...
          QUnit.test('Duplicated names and editable column without dataField and name', function(assert) {
            ...
            var errorLogCalls = errors.log.getCalls();
      ...
      QUnit.module('initialization from dataSource', {
        ...
        QUnit.test('Initialize Lookup column with paging', function(assert) {
          ...
          var dataSource = createDataSource(this, array);
          dataSource.load();
          var lookupLoadingCount = 0;
          this.applyOptions({columns: ['name', {
        ...
        QUnit.test('Initialize Lookup column by columnOption', function(assert) {
          ...
          dataSource.load();
          var lookupLoadingCount = 0;
          this.applyOptions({columns: ['name', 'category_id']});
          var columnsController = this.columnsController;
          var columnChangedCallCount = 0;
          columnsController.columnsChanged.add(function() {
            columnChangedCallCount++;
        ...
        QUnit.test('defaultFilterOperationLookup of lookup column should not be undefined if dataSource is empty and calculateDisplayValue is set', function(assert) {
          ...
          var lookupColumn = this.columnsController.getVisibleColumns()[0];
        ...
        QUnit.test('Converting dates for array store', function(assert) {
          ...
          var dataSource = createDataSource(this, {store: array});
          dataSource.load();
          this.applyOptions({columns: ['name', {
              dataField: 'birthDate',
              dataType: 'date'
        ...
        QUnit.test('Converting dates for custom store when virtual scrolling', function(assert) {
          ...
          var dataSource = createDataSource(this, {load: function(options) {
              return array;
            }});
          dataSource.load();
          this.applyOptions({
        ...
        QUnit.test('Not update dates for array store after inserting', function(assert) {
          ...
          var dataSource = createDataSource(this, {store: arrayStore});
          dataSource.load();
          this.applyOptions({columns: ['name', {
              dataField: 'birthDate',
              dataType: 'date'
        ...
        QUnit.test('Initialize grouping from dataSource when remoteOperations disabled and autoExpandAll enabled', function(assert) {
          ...
          dataSource.load();
          this.applyOptions({grouping: {autoExpandAll: true}});
          this.columnsController.applyDataSource(dataSource);
          assert.ok(this.columnsController.__groupingUpdated);
          assert.ok(!this.columnsController.__sortingUpdated);
          assert.deepEqual(this.getColumns(['dataField', 'groupIndex', 'sortOrder', 'sortIndex']), [{dataField: 'name'}, {
            dataField: 'age',
            groupIndex: 0,
            sortOrder: 'asc'
          }]);
        ...
        QUnit.test('Initialize grouping from dataSource. Not update sorting/grouping', function(assert) {
          ...
          dataSource.load();
          this.applyOptions({
            commonColumnSettings: {autoExpandGroup: false},
            columns: [{
              dataField: 'name',
              sortOrder: 'desc'
            }, {
        ...
        QUnit.test('Initialize grouping from dataSource and sorting from columns', function(assert) {
          ...
          this.applyOptions({columns: ['team', 'name', {
              dataField: 'age',
              sortOrder: 'asc'
            }]});
          dataSource.load();
        ...
        QUnit.test('Second Initialize from array store after reset', function(assert) {
          var dataSource1 = createDataSource(this, [{
            name: 'Alex',
            age: 15
          }, {
            name: 'Dan',
          ...
          dataSource1.load();
          var dataSource2 = createDataSource(this, [{
            id: 0,
            value: 'value1'
          }, {
            id: 1,
        ...
        QUnit.test('Second Initialize from array when regenerateColumnsByVisibleItems enabled', function(assert) {
          ...
          dataSource2.load();
          this.applyOptions({regenerateColumnsByVisibleItems: true});
          this.columnsController.applyDataSource(dataSource1);
          this.columnsController.applyDataSource(dataSource2);
          assert.deepEqual(this.getColumns(), [{
            index: 0,
        ...
        QUnit.test('Second Initialize from array when regenerateColumnsByVisibleItems disabled', function(assert) {
          ...
          dataSource2.load();
          this.applyOptions({regenerateColumnsByVisibleItems: false});
          this.columnsController.applyDataSource(dataSource1);
          this.columnsController.applyDataSource(dataSource2);
          assert.deepEqual(this.getColumns(), [{
            index: 0,
        ...
        QUnit.test('Initialize from remote rest store', function(assert) {
          ...
          var dataSource = createDataSource(this, {load: function() {
              var d = $.Deferred();
              setTimeout(function() {
          ...
          dataSource.load().done(function() {
            $__3.columnsController.applyDataSource(dataSource);
            assert.deepEqual($__3.getColumns(), [{
              index: 0,
              dataField: 'a',
              caption: 'A',
              name: 'a',
        ...
        QUnit.test('Initialize from custom store', function(assert) {
          ...
          this.applyOptions({columns: ['Column1', {
              dataField: 'Column2',
              dataType: 'date'
            }]});
          var dataSource = createDataSource(this, {
      ...
      QUnit.module('Update columns on initialization', {
        beforeEach: setupModule,
        afterEach: teardownModule
      }, function() {
        ...
        QUnit.test('update date dataType for columns', function(assert) {
          this.columnsController.applyDataSource(createMockDataSource([{
            dateObject: new Date(2012, 1, 1),
            dateString: '5/25/2012',
            notDate: '1999-xxx'
          }]));
          assert.strictEqual(this.columnsController.getColumns().length, 3);
        ...
        QUnit.test('update alignment for columns when getVisibleColumns called before dataSource applying', function(assert) {
          var columnsController = this.columnsController;
          this.applyOptions({columns: ['number', 'string', 'date', 'boolean']});
        ...
        QUnit.test('Change column option via option method (for band columns)', function(assert) {
          this.applyOptions({columns: [{dataField: 'field1'}, {
              caption: 'Band column 1',
              columns: [{dataField: 'field2'}, {
                caption: 'Band column 2',
                columns: [{dataField: 'field3'}, {dataField: 'field4'}]
              }, {dataField: 'field5'}]
            }]});
          this.columnsController.applyDataSource(createMockDataSource([{
            field1: 'test1',
          ...
          this.columnsController.optionChanged({
            name: 'columns',
            fullName: 'columns[1].columns[1].columns[0].visible',
            value: false
          });
          var visibleColumns = this.columnsController.getVisibleColumns();
        ...
        QUnit.test('Change column visibility via option method when band column placed before it', function(assert) {
          this.applyOptions({columns: [{dataField: 'field1'}, {
              caption: 'Band',
              columns: [{dataField: 'field2'}, {dataField: 'field3'}]
            }, {dataField: 'field4'}, {dataField: 'field5'}]});
          this.columnsController.applyDataSource(createMockDataSource([{
            field1: 'test1',
            field2: 'test2',
            field3: 'test3',
        ...
        QUnit.test('Change column option via option method when option value as object (for band columns)', function(assert) {
          ...
          this.columnsController.optionChanged({
            name: 'columns',
            fullName: 'columns[1].columns[1].columns[0]',
            value: {visible: false}
          });
          var visibleColumns = this.columnsController.getVisibleColumns();
          assert.strictEqual(visibleColumns.length, 4, 'columns state is not reset');
      ...
      QUnit.module('Allow Move Columns', {
        beforeEach: setupModule,
        afterEach: teardownModule
      }, function() {
        QUnit.test('allow move allowReordering column', function(assert) {
          this.applyOptions({
            commonColumnSettings: {allowReordering: true},
        ...
        QUnit.test('not allow move not allowReordering column', function(assert) {
          this.applyOptions({
            commonColumnSettings: {allowReordering: false},
            columns: ['field1', 'field2', 'field3']
          });
          assert.ok(!this.columnsController.allowMoveColumn(0, 2));
        });
        ...
        QUnit.test('allow move column from column chooser to headers when not allowGrouping, allowReordering', function(assert) {
          this.applyOptions({columns: ['field1', {
              dataField: 'field2',
              visible: false,
              allowGrouping: false,
              allowReordering: false,
        ...
        QUnit.test('allow move for band columns', function(assert) {
          ...
          assert.ok(this.columnsController.allowMoveColumn({
            columnIndex: 0,
            rowIndex: 1
          }, {
            columnIndex: 2,
      ...
      QUnit.module('Move Columns', {
        ...
        QUnit.test('swap two band columns', function(assert) {
          ...
          this.columnsController.moveColumn({
            columnIndex: 0,
            rowIndex: 0
          }, {
            columnIndex: 2,
        ...
        QUnit.test('move column from column chooser to group', function(assert) {
          ...
          var visibleGroupColumns = this.columnsController.getGroupColumns();
        ...
        QUnit.test('move the group command column to begin', function(assert) {
          this.applyOptions({
            selection: {mode: 'multiple'},
            columns: [{type: 'selection'}, {type: 'groupExpand'}, {
              dataField: 'field1',
              groupIndex: 0
            }, {
              dataField: 'field2',
      ...
      QUnit.module('Column Option', {
        ...
        QUnit.test('update column dataField', function(assert) {
          ...
          assert.strictEqual(this.columnsController.getColumns()[1].calculateCellValue({
            field2a: 1,
            field2b: 2
          }), 2, 'calculateCellValue for field with changed dataField');
          assert.strictEqual(columnsChangedArgs.length, 1);
        ...
        QUnit.test('change column dataType', function(assert) {
          ...
          var dataSource = createDataSource(this, items);
          dataSource.load();
          this.columnsController.applyDataSource(dataSource);
          this.columnsController.columnsChanged.add(function(e) {
            columnsChangedArgs.push(e);
        ...
        QUnit.test('get column options by name', function(assert) {
          ...
          var column1 = this.columnsController.columnOption('field1');
          var column2 = this.columnsController.columnOption('field2');
        ...
        QUnit.test('get column options by dataField if some column has such caption (T896131)', function(assert) {
          ...
          var column1 = this.columnsController.columnOption('CompanyNo');
          var column2 = this.columnsController.columnOption('Company');
          assert.equal(column1.index, 0);
          assert.equal(column2.index, 1);
        });
      ...
      QUnit.module('Sorting/Grouping', {
        ...
        QUnit.test('getSortDataSourceParameters. Column with calculateCellValue', function(assert) {
          ...
          assert.deepEqual(sortParameters[1], {
            selector: 'field1',
            desc: false
          });
        });
        ...
        QUnit.test('getSortDataSourceParameters. Column with calculateSortValue', function(assert) {
          var context;
          var calculateSortValue = function() {
            context = this;
            return 'test';
          };
          this.applyOptions({columns: [{
        ...
        QUnit.test('getSortDataSourceParameters. Column with calculateDisplayValue for lookup', function(assert) {
          ...
          assert.equal(sortParameters[0].selector({
            field1: 0,
            field1Text: 'text1'
          }), 'text1');
          assert.ok(sortParameters[0].desc);
        ...
        QUnit.test('getSortDataSourceParameters. Column with calculateDisplayValue as string for lookup', function(assert) {
          this.applyOptions({columns: [{
              dataField: 'field1',
              calculateDisplayValue: 'field1Text',
              sortOrder: 'desc',
              sortIndex: 0,
              lookup: {
                valueExpr: 'id',
        ...
        QUnit.test('getGroupDataSourceParameters. Several group columns when calculateGroupValue defined', function(assert) {
          var context;
          var calculateGroupValue = function() {
            context = this;
            return 1;
          };
          this.applyOptions({columns: [{
          ...
          assert.deepEqual(groupParameters[1], {
            selector: 'field1',
            desc: false,
            isExpanded: false
          });
        ...
        QUnit.test('getGroupDataSourceParameters. Several group columns when sortingMethod is defined', function(assert) {
          var context;
          var calculateGroupValue = function(x, y) {
            context = this;
            return x - y;
          };
          this.applyOptions({columns: [{
              ...
              groupIndex: 0,
              autoExpandGroup: true,
              sortingMethod: calculateGroupValue
            }]});
          var groupParameters = this.columnsController.getGroupDataSourceParameters();
        ...
        QUnit.test('getGroupDataSourceParameters when calculateDisplayValue defined', function(assert) {
          var context;
          var calculateDisplayValue = function() {
            context = this;
            return 1;
          };
          this.applyOptions({columns: [{
        ...
        QUnit.test('getGroupDataSourceParameters when calculateDisplayValue as string defined', function(assert) {
          this.applyOptions({columns: [{
              ...
              groupIndex: 0,
              autoExpandGroup: true,
              calculateDisplayValue: 'field2Text'
            }]});
          var groupParameters = this.columnsController.getGroupDataSourceParameters();
        ...
        QUnit.test('The headerCellTemplate of the group column should not be applied for expand column', function(assert) {
          ...
          var expandColumns = this.columnsController.getExpandColumns();
        ...
        QUnit.test('Fixed position of expand columns should be identical to RTL', function(assert) {
          ...
          [true, false].forEach(function(rtlEnabled) {
            ['left', 'right'].forEach(function(initialFixedPosition) {
              $__3.applyOptions({
                columns: [{
                  dataField: 'field',
                  groupIndex: 0,
                  fixed: true,
                  fixedPosition: initialFixedPosition
                }],
                rtlEnabled: rtlEnabled
              });
              var expandColumns = $__3.columnsController.getExpandColumns();
              var properFixedPosition = rtlEnabled ? 'right' : 'left';
              assert.strictEqual(expandColumns.length, 1, 'count expand column');
      ...
      QUnit.module('ParseValue', {
        ...
        QUnit.test('parseValue for column with number dataField', function(assert) {
          ...
          formats.forEach(function(format) {
            $__3.columnOption(0, 'format', format);
            assert.ok(column);
        ...
        QUnit.test('parseValue should not rise warning if column with number dataField and format with object (T1079297)', function(assert) {
          ...
          var column = this.columnsController.getColumns()[0];
          var errorHandler = sinon.spy(coreErrors, 'log');
          var value = column.parseValue('123');
      ...
      QUnit.module('Edit Column', {
        ...
        QUnit.test('Dynamically added column must be kept after change editing.mode option', function(assert) {
          ...
          that.columnsController.applyDataSource(createMockDataSource([{TestField: 'test'}]));
          that.columnsController.addColumn({
            dataField: 'AddedColumn',
            caption: 'My Column'
          });
          ...
          assert.deepEqual(columns[1].added, {
            dataField: 'AddedColumn',
            caption: 'My Column',
            name: 'AddedColumn'
          }, 'dynamically column added flag');
        });
        QUnit.test('Delete column', function(assert) {
          ...
          that.columnsController.applyDataSource(createMockDataSource([{
            TestField1: 'test1',
            TestField2: 'test2'
          }]));
        ...
        QUnit.test('commonColumnSettings for added column', function(assert) {
          ...
          that.applyOptions({
            ...
            commonColumnSettings: {editable: true}
          });
          that.columnsController.applyDataSource(createMockDataSource([{TestField: 'test'}]));
          that.columnsController.addColumn('TestColumn');
          var columns = that.columnsController.getVisibleColumns();
      ...
      QUnit.module('State storing', {
        ...
        QUnit.test('Get user state', function(assert) {
          ...
          that.applyOptions({columns: [{
              ...
              sortOrder: 'asc',
              sortIndex: 0,
              filterValue: 'TestFilter1',
              selectedFilterOperation: '=',
              filterValues: ['TestFilter1'],
              filterType: 'include',
              fixed: true,
              fixedPosition: 'right'
            }, {
              ...
              sortOrder: 'asc',
              sortIndex: 1,
              filterValue: 'TestFilter2',
              selectedFilterOperation: 'startswith'
            }]});
          var columns = that.columnsController.getUserState();
          assert.equal(columns.length, 2);
        ...
        QUnit.test('Apply user state', function(assert) {
          ...
          assert.deepEqual(columns[1], {
            ...
            'filterValue': 'Test2',
            'selectedFilterOperation': '=',
            defaultSelectedFilterOperation: 'startswith',
            index: 1,
            caption: 'Test Field 2',
            dataType: 'string',
            alignment: 'left',
        ...
        QUnit.test('Apply user state for dynamically added column', function(assert) {
          ...
          assert.deepEqual(columns[1], {
            ...
            dataType: 'string',
            alignment: 'left',
            defaultSelectedFilterOperation: null,
            showEditorAlways: false,
            added: {
              dataField: 'TestField2',
              dataType: 'string',
        ...
        QUnit.test('Apply user state for dynamically added band column', function(assert) {
          ...
          that.columnsController.setUserState([{
            ...
            added: {
              caption: 'TestField2',
              columns: ['TestField21', 'TestField22']
            }
          }, {
        ...
        QUnit.test('Apply user state dataField', function(assert) {
          ...
          assert.equal(columns[0].calculateCellValue({
            TestField1A: 1,
            TestField1B: 2
          }), 2, 'calculateCellValue for TestField1b');
        });
        ...
        QUnit.test('Apply user state columns are generated by dataSource and dataSource is empty', function(assert) {
          ...
          assert.deepEqual(this.getColumns(['dataField', 'visibleIndex']), [{
            dataField: 'name',
            visibleIndex: 1
          }, {
            dataField: 'age',
      ...
      QUnit.module('Band columns', {
        ...
        QUnit.test('getVisibleColumns with rowIndex and grouped columns with showWhenGrouped', function(assert) {
          ...
          assert.ok(this.columnsController.isInitialized());
          var firstRowColumns = this.columnsController.getVisibleColumns(0);
          var secondRowColumns = this.columnsController.getVisibleColumns(1);
          var thirdRowColumns = this.columnsController.getVisibleColumns(2);
        ...
        QUnit.test('getFixedColumns with rowIndex', function(assert) {
          ...
          assert.ok(this.columnsController.isInitialized());
          var fixedColumns = this.columnsController.getFixedColumns(0);
          ...
          assert.strictEqual(fixedColumns[1].command, 'transparent', 'transparent column');
          fixedColumns = this.columnsController.getFixedColumns(1);
          assert.equal(fixedColumns.length, 3, 'count fixed column');
          assert.strictEqual(fixedColumns[0].caption, 'Column 2', 'caption of the first fixed column');
          assert.strictEqual(fixedColumns[1].caption, 'Column 3', 'caption of the second fixed column');
          assert.strictEqual(fixedColumns[2].command, 'transparent', 'transparent column');
        ...
        QUnit.test('getVisibleIndex when there is band columns', function(assert) {
          ...
          assert.ok(this.columnsController.isInitialized());
          var column = this.columnsController.columnOption('TestField5');
        ...
        QUnit.test('Initialization with band columns when set customizeColumns', function(assert) {
          ...
          var assertColumns = function(columns) {
            assert.equal(columns.length, 4);
        ...
        QUnit.test('Changing column option is ownerBand via customizeColumns', function(assert) {
          ...
          assert.ok(this.columnsController.isInitialized());
          assert.ok(callCustomizeColumns, 'call customizeColumns');
          var columns = this.columnsController.getVisibleColumns(0);
        ...
        QUnit.test('Delete several band columns via API inside beginUpdate/endUpdate (T1049616)', function(assert) {
          this.applyOptions({columns: [{dataField: 'Area'}, {
              caption: 'Population',
              columns: [{dataField: 'Population_Total'}]
            }, {
              caption: 'Nominal GDP',
              columns: [{dataField: 'GDP_Total'}]
            }]});
          this.beginUpdate();
      ...
      QUnit.module('onOptionChanged', {
        ...
        QUnit.test('Event should be fired when grouping', function(assert) {
          ...
          var groupIndexCall = this._notifyOptionChanged.getCalls().filter(function(params) {
        ...
        QUnit.test('Should be correct value in onOptionChanged callback after moving some column to the last position', function(assert) {
          this.applyOptions({columns: [{dataField: 'field1'}, {dataField: 'field2'}, {dataField: 'field3'}]});
      ...
      QUnit.module('Customization of the command columns', {
        ...
        QUnit.test('visibleColumnIndex should find index considering command column', function(assert) {
          this.applyOptions({columns: [{type: 'buttons'}, 'field1']});
          assert.equal(this.getVisibleColumnIndex('field1'), 1, 'index');
        });
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","data/data_source/data_source","data/array_store","localization/date","core/utils/type","ui/data_grid/ui.data_grid.core","ui/data_grid/ui.data_grid.data_source_adapter","../../helpers/executeAsyncMock.js","../../helpers/dataGridMocks.js","core/config","ui/widget/ui.errors","core/errors","../../helpers/ajaxMock.js","ui/data_grid","localization/globalize/currency","localization/globalize/number","localization/core"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("data/data_source/data_source"), require("data/array_store"), require("localization/date"), require("core/utils/type"), require("ui/data_grid/ui.data_grid.core"), require("ui/data_grid/ui.data_grid.data_source_adapter"), require("../../helpers/executeAsyncMock.js"), require("../../helpers/dataGridMocks.js"), require("core/config"), require("ui/widget/ui.errors"), require("core/errors"), require("../../helpers/ajaxMock.js"), require("ui/data_grid"), require("localization/globalize/currency"), require("localization/globalize/number"), require("localization/core"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=columnsController.tests.js.map