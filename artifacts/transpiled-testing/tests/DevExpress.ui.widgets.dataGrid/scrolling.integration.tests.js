...
(["testing/tests/DevExpress.ui.widgets.dataGrid/scrolling.integration.tests.js"], ["jquery","core/utils/common","core/devices","core/utils/browser","core/utils/shadow_dom","events/pointer","../../helpers/wrappers/dataGridWrappers.js","../../helpers/dataGridHelper.js","core/utils/size","../../helpers/stylesHelper.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.dataGrid/scrolling.integration.tests.js", ["jquery", "core/utils/common", "core/devices", "core/utils/browser", "core/utils/shadow_dom", "events/pointer", "../../helpers/wrappers/dataGridWrappers.js", "../../helpers/dataGridHelper.js", "core/utils/size", "../../helpers/stylesHelper.js"], function($__export) {
  "use strict";
  var $,
      commonUtils,
      devices,
      ...
      getEmulatorStyles,
      dataGridWrapper;
  function checkScrollWorks(dataGrid) {
    var scrollBy = arguments[1] !== (void 0) ? arguments[1] : 10;
    var isHorizontal = arguments[2] !== (void 0) ? arguments[2] : false;
    var scrollable = dataGrid.getScrollable();
    if (scrollable && scrollable.element()) {
      if (isHorizontal) {
        var initScrollPosition = scrollable.scrollLeft();
        scrollable.scrollBy({left: scrollBy});
        return initScrollPosition + scrollBy === scrollable.scrollLeft();
      } else {
        var initScrollPosition$__2 = scrollable.scrollTop();
        scrollable.scrollBy({top: scrollBy});
        return initScrollPosition$__2 + scrollBy === scrollable.scrollTop();
      }
    }
    return false;
  }
  function checkHeaderRowScrollPadding(dataGrid) {
    var headerPadding = parseFloat($(dataGrid.getView('columnHeadersView').element()).css('paddingRight'));
    var scrollbarWidth = dataGrid.getView('rowsView').getScrollbarWidth();
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module('Scrolling', baseModuleConfig, function() {
        [true, false].forEach(function(nativeScrolling) {
          QUnit.test(("Correct start scroll position when RTL with nativeScrolling: " + nativeScrolling), function(assert) {
            ...
            this.clock.tick(100);
            var scrollLeft = $('.dx-scrollable').scrollLeft();
            var $headerScrollContainer = $(dataGrid.$element().find('.dx-datagrid-headers .dx-datagrid-scroll-container'));
        ...
        QUnit.test('Scroll position after grouping when RTL', function(assert) {
          ...
          var getRightScrollOffset = function(scrollable) {
          ...
          var scrollRight = getRightScrollOffset(scrollable);
          setTimeout(function() {
            dataGrid.columnOption('field1', 'groupIndex', 0);
            setTimeout(function() {
              var scrollRightAfterGrouping = getRightScrollOffset(scrollable);
        ...
        QUnit.test('native scrollBars layout should be correct after width change if fixed columns exist and columnAutoWidth is true', function(assert) {
          ...
          var dataGrid = $('#dataGrid').dxDataGrid({
            ...
            width: 1000,
            scrolling: {useNative: true},
            columns: [{dataField: 'CompanyName'}, {dataField: 'Phone'}, {dataField: 'Address'}, {
              dataField: 'Fax',
              fixed: true,
              fixedPosition: 'right',
              width: 50
        ...
        QUnit.test('Horizontal scroll position of headers view is changed_T251448', function(assert) {
          ...
          var dataGrid = $dataGrid.dxDataGrid('instance');
          this.clock.tick(10);
          var $headersView = $dataGrid.find('.dx-datagrid-headers' + ' .dx-datagrid-scroll-container').first();
          $headersView.scrollLeft(400);
          $($headersView).trigger('scroll');
          var $footerView = $dataGrid.find('.dx-datagrid-total-footer .dx-datagrid-scroll-container').first();
        ...
        QUnit.test('Keep horizontal scroller position after refresh with native scrolling', function(assert) {
          ...
          this.clock.tick(10);
          this.clock.restore();
          var scrollableInstance = dataGrid.getView('rowsView').getScrollable();
        ...
        QUnit.test('Horizontal scroll should not exist if fixed column with custom buttons exists', function(assert) {
          var dataGrid = createDataGrid({
            ...
            columns: ['field1', 'field2', {
              type: 'buttons',
              fixed: true,
              buttons: [{icon: 'repeat'}, {icon: 'repeat'}, {icon: 'repeat'}, {icon: 'repeat'}, {icon: 'repeat'}, {icon: 'repeat'}]
            }]
          });
          var scrollable = dataGrid.getScrollable();
        ...
        QUnit.test('Scrollable should have the correct padding when the grid inside the ScrollView', function(assert) {
          $('#container').dxScrollView({showScrollbar: 'always'});
          var dataGrid = createDataGrid({
            dataSource: [{field1: 1}],
            columnAutoWidth: true,
          ...
          this.clock.tick(30);
          var $scrollableContent = $(dataGrid.getScrollable().content());
        ...
        QUnit.test('Content height differs from the scrollable container height by the height of horizontal scroll (T865137)', function(assert) {
          ...
          this.clock.tick(10);
          var scrollable = dataGrid.getScrollable();
          var content = dataGrid.$element().find('.dx-datagrid-rowsview .dx-datagrid-content')[0];
          var scrollbarWidth = dataGrid.getView('rowsView').getScrollbarWidth(true);
        ...
        QUnit.test('scroll position after refresh with native scrolling', function(assert) {
          var $dataGrid = $('#dataGrid').dxDataGrid({
            ...
            dataSource: [{
              ...
              field2: 'test test test',
              field3: 'test test test',
              field4: 'test test test'
            }]
          });
          var dataGrid = $dataGrid.dxDataGrid('instance');
          this.clock.tick(10);
        ...
        QUnit.test('Scrollbar should not be shown if column hiding is enabled and all columns are visible', function(assert) {
          ...
          var dataGrid = createDataGrid({
            ...
            columns: [{cellTemplate: function($container) {
                $($container).css('width', '129.6px');
              }}, {cellTemplate: function($container) {
                $($container).css('width', '96.8px');
              }}, {cellTemplate: function($container) {
                $($container).css('width', '104px');
              }}, {cellTemplate: function($container) {
                $($container).css('width', '111.2px');
              }}]
          });
          var scrollable = dataGrid.getScrollable();
        ...
        QUnit.test('New mode. No data text should not be shown when rowRenderingMode is virtual and max height (T1054920)', function(assert) {
          ...
          this.clock.tick(10);
          var $noDataElement = $(dataGrid.element()).find('.dx-datagrid-nodata');
        ...
        QUnit.testInActiveWindow('Virtual scrolling should work with validation and fixed columns', function(assert) {
          ...
          dataGrid.addRow();
          this.clock.tick(10);
          var table = $('.dx-datagrid-rowsview .dx-datagrid-content:not(.dx-datagrid-content-fixed) tbody');
          var tableFixed = $('.dx-datagrid-rowsview .dx-datagrid-content.dx-datagrid-content-fixed tbody');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","core/devices","core/utils/browser","core/utils/shadow_dom","events/pointer","../../helpers/wrappers/dataGridWrappers.js","../../helpers/dataGridHelper.js","core/utils/size","../../helpers/stylesHelper.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("core/devices"), require("core/utils/browser"), require("core/utils/shadow_dom"), require("events/pointer"), require("../../helpers/wrappers/dataGridWrappers.js"), require("../../helpers/dataGridHelper.js"), require("core/utils/size"), require("../../helpers/stylesHelper.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=scrolling.integration.tests.js.map