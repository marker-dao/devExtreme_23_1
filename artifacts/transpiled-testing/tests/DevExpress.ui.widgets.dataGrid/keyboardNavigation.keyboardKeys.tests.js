System.register(["generic_light.css!", "jquery", "ui/data_grid", "ui/grid_core/ui.grid_core.utils", "core/devices", "../../helpers/keyboardMock.js", "core/utils/common", "core/utils/type", "core/utils/shadow_dom", "events/pointer", "../../helpers/dataGridMocks.js", "../../helpers/grid/keyboardNavigationHelper.js", "ui/text_area.js"], function (_export, _context) {
  "use strict";

  var $, gridCoreUtils, devices, keyboardMock, commonUtils, typeUtils, addShadowDomStyles, pointerEvents, setupDataGridModules, MockDataController, CLICK_EVENT, setupModules, fireKeyDown, triggerKeyDown, focusCell, callViewsRenderCompleted, dataGridWrapper, device;
  ...
  return {
    setters: [function (_generic_lightCss) {}, function (_jquery) {
      $ = _jquery.default;
    }, function (_uiData_grid) {}, function (_uiGrid_coreUiGrid_coreUtils) {
    ...
    }, function (_helpersGridKeyboardNavigationHelperJs) {
      CLICK_EVENT = _helpersGridKeyboardNavigationHelperJs.CLICK_EVENT;
      setupModules = _helpersGridKeyboardNavigationHelperJs.setupModules;
      fireKeyDown = _helpersGridKeyboardNavigationHelperJs.fireKeyDown;
      triggerKeyDown = _helpersGridKeyboardNavigationHelperJs.triggerKeyDown;
      focusCell = _helpersGridKeyboardNavigationHelperJs.focusCell;
      callViewsRenderCompleted = _helpersGridKeyboardNavigationHelperJs.callViewsRenderCompleted;
      dataGridWrapper = _helpersGridKeyboardNavigationHelperJs.dataGridWrapper;
    }, function (_uiText_areaJs) {}],
    execute: function () {
      device = devices.real();
      ...
      QUnit.module('Keyboard keys', {
        ...
        QUnit.testInActiveWindow('Update focus when row is editing with form_T306378', function (assert) {
          ...
          setupDataGridModules(this, ['data', 'columns', 'rows', 'editorFactory', 'gridView', 'columnHeaders', 'editing', 'editingRowBased', 'editingFormBased', 'keyboardNavigation', 'masterDetail'], {
            initViews: true
          });
        ...
        QUnit.testInActiveWindow('Page up should scroll page up when paging disabled and vertial scroll exists', function (assert) {
          ...
          this.rowsView.resize();
          this.focusFirstCell();
          this.rowsView.getScrollable().scrollTo({
            left: 0,
            top: 200
          });
          const isPreventDefaultCalled = this.triggerKeyDown('pageUp').preventDefault;
        ...
        QUnit.test('onKeyDown event customization (T824764)', function (assert) {
          ...
          assert.deepEqual(cellPosition, {
            rowIndex: 1,
            columnIndex: 1
          }, 'Cell was navigate by default key handler');
        });
        ...
        QUnit.testInActiveWindow('closeEditCell and reset focus on \'tab\' if the current cell is the last editable cell and contains editor', function (assert) {
          ...
          setupDataGridModules(this, ['data', 'columns', 'rows', 'editorFactory', 'gridView', 'columnHeaders', 'editing', 'editingCellBased', 'keyboardNavigation'], {
            initViews: true
          });
        ...
        ['row', 'cell', 'batch'].forEach(editMode => {
          ['dblClick', 'click'].forEach(startEditAction => {
            QUnit.testInActiveWindow(`Focus overlay should not overlap the whole row after addRow and tab (edit mode is ${editMode} and startEditAction = ${startEditAction})`, function (assert) {
              ...
              setupDataGridModules(this, ['data', 'columns', 'rows', 'editorFactory', 'gridView', 'columnHeaders', 'editing', 'editingRowBased', 'editingFormBased', 'editingCellBased', 'keyboardNavigation', 'focus'], {
                initViews: true
              });
        ...
        QUnit.testInActiveWindow('Focus link elements on tab key', function (assert) {
          ...
          this.columns = [{
            ...
            cellTemplate: function (container, options) {
              $('<a href="#" />').addClass('link1').text('link1').appendTo(container);
              $('<a href="#" />').addClass('link2').text('link2').appendTo(container);
            }
          }, {
            caption: 'Column 3',
            visible: true,
        ...
        [{
          ...
          QUnit.testInActiveWindow(`Select all should not work on ${keyName} + AltGr + A when allowSelectAll is true`, function (assert) {
            ...
            this.gridView.render($('#container'));
            this.focusFirstCell();
            const isPreventDefaultCalled = this.triggerKeyDown('A', {
              ...keyConfig,
              alt: true
            }).preventDefault;
        ...
        QUnit.testInActiveWindow('Down arrow key should work correctly after page down key press', function (assert) {
          ...
          this.dataControllerOptions = {
            ...
            pageSize: 2,
            items: [{
              values: ['test11', 'test21', 'test31', 'test41'],
              rowType: 'data',
              key: 0
            }, {
              values: ['test12', 'test22', 'test32', 'test42'],
              rowType: 'data',
              key: 1
            }, {
              values: ['test13', 'test23', 'test33', 'test43'],
              rowType: 'data',
              key: 2
            }, {
              values: ['test14', 'test24', 'test34', 'test44'],
              rowType: 'data',
              key: 3
            }, {
              values: ['test15', 'test25', 'test35', 'test45'],
              rowType: 'data',
              key: 4
            }, {
              values: ['test16', 'test26', 'test36', 'test46'],
              rowType: 'data',
              key: 5
            }, {
              values: ['test17', 'test27', 'test37', 'test47'],
              rowType: 'data',
              key: 6
            }, {
              values: ['test18', 'test28', 'test38', 'test48'],
              rowType: 'data',
              key: 7
            }, {
              values: ['test19', 'test29', 'test39', 'test49'],
              rowType: 'data',
              key: 8
            }]
          };
