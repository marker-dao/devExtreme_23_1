...
(["testing/tests/DevExpress.ui.widgets.dataGrid/virtualScrolling.tests.js"], ["generic_light.css!","ui/scroll_view/ui.scrollable","jquery","../../helpers/memoryLeaksHelper.js","ui/grid_core/ui.grid_core.virtual_scrolling_core","ui/grid_core/ui.grid_core.utils","core/utils/browser","core/devices","core/renderer","core/utils/size"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.dataGrid/virtualScrolling.tests.js", ["generic_light.css!", "ui/scroll_view/ui.scrollable", "jquery", "../../helpers/memoryLeaksHelper.js", "ui/grid_core/ui.grid_core.virtual_scrolling_core", "ui/grid_core/ui.grid_core.utils", "core/utils/browser", "core/devices", "core/renderer", "core/utils/size"], function($__export) {
  "use strict";
  var $,
      memoryLeaksHelper,
  ...
  return {
    setters: [function($__m) {}, function($__m) {}, function($__m) {
      ...
      memoryLeaksHelper = $__m.default;
    }, function($__m) {
      VirtualScrollController = $__m.VirtualScrollController;
    }, function($__m) {
    ...
    execute: function() {
      mockComponent = {option: sinon.stub()};
      mockDataSource = {
        pageSize: sinon.stub(),
      ...
      CONTENT_HEIGHT_LIMIT = gridCoreUtils.getContentHeightLimit(browser);
      moduleConfig = {
        beforeEach: function() {
      ...
      QUnit.module('VirtualScrollingController. Virtual scrolling mode', moduleConfig, function() {
        ...
        QUnit.test('setContentItemSizes. When items', function(assert) {
          ...
          this.scrollController.load();
          var contentSize = 200;
          var contentSizes = getContentSizes(20, 10);
      ...
      QUnit.module('Virtual scrolling', {
        beforeEach: function() {
          ...
          var contentSizes = getContentSizes(20, 20);
          this.scrollController.setContentItemSizes(contentSizes);
        ...
        QUnit.test('getVirtualContentSize after far scroll if itemSizes are not equal to virtual item size', function(assert) {
          var realItemSize = 10;
          var realItemSizes = Array.apply(null, Array(20)).map(function() {
            return realItemSize;
          });
      ...
      QUnit.module('Subscribe to external scrollable events', {
        ...
        QUnit.test('Native scroll event', function(assert) {
          var done = assert.async();
          var scrollController = this.scrollController;
          var $fixtureElement = this.$fixtureElement;
          $('<div>').height(300).appendTo(this.$fixtureElement);
        ...
        QUnit.test('dxScrollable scroll event', function(assert) {
          ...
          var scrollable = this.$fixtureElement.height(10000).dxScrollable({}).dxScrollable('instance');
          this.scrollController.subscribeToWindowScrollEvents($element);
        ...
        QUnit.test('Content height limit for different browsers', function(assert) {
          ...
          gridCoreUtils._setPixelRatioFn(function() {
            return 1;
          });
          ...
          assert.equal(gridCoreUtils.getContentHeightLimit({}), 7500000, 'content height limit depends on devicePixelRatio for other browsers');
        });
      });
      QUnit.module('VirtualScrollingController. New mode', {
        ...
        QUnit.test('virtualItemsCount does not call data source pageIndex method', function(assert) {
          var pageIndex = sinon.stub(mockDataSource, 'pageIndex');
        ...
        QUnit.test('setViewportItemIndex does not call data source and virtual scrolling controller methods', function(assert) {
          var pageCount = sinon.stub(mockDataSource, 'pageCount');
          var load = sinon.stub(this.scrollController, 'load');
        ...
        QUnit.test('Viewport params at the top', function(assert) {
          ...
          var viewportParams = this.scrollController.getViewportParams();
          var virtualItemsCount = this.scrollController.virtualItemsCount();
          assert.deepEqual(virtualItemsCount, {
            begin: 0,
            end: DEFAULT_TOTAL_ITEMS_COUNT - 26
          }, 'virtual items');
          assert.deepEqual(viewportParams, {
            skip: 0,
            take: 26
          }, 'viewport params');
        });
        QUnit.test('Viewport params at the middle', function(assert) {
          var viewportSize = 25;
          this.scrollController.viewportSize(viewportSize);
          var viewportItemIndex = DEFAULT_TOTAL_ITEMS_COUNT / 2;
          this.scrollController.setViewportItemIndex(viewportItemIndex);
          var viewportParams = this.scrollController.getViewportParams();
          var virtualItemsCount = this.scrollController.virtualItemsCount();
          assert.deepEqual(virtualItemsCount, {
            begin: Math.floor(viewportItemIndex),
            end: 9974
          }, 'virtual items');
          assert.deepEqual(viewportParams, {
            skip: Math.floor(viewportItemIndex),
            take: viewportSize + 1
          }, 'viewport params');
        });
        QUnit.test('Viewport params at the bottom', function(assert) {
          var viewportSize = 25;
          this.scrollController.viewportSize(viewportSize);
          var viewportItemIndex = DEFAULT_TOTAL_ITEMS_COUNT - viewportSize;
          this.scrollController.setViewportItemIndex(viewportItemIndex);
          var viewportParams = this.scrollController.getViewportParams();
          var virtualItemsCount = this.scrollController.virtualItemsCount();
          assert.deepEqual(virtualItemsCount, {
            begin: DEFAULT_TOTAL_ITEMS_COUNT - viewportSize,
            end: 0
          }, 'virtual items');
          assert.deepEqual(viewportParams, {
            skip: DEFAULT_TOTAL_ITEMS_COUNT - viewportSize,
            take: viewportSize
          }, 'viewport params');
        });
        QUnit.test('viewportSize should be correct when there is a lot of data', function(assert) {
          ...
          this.scrollController.setContentItemSizes($traceurRuntime.spread(new Array(15)).map(function() {
            return 50;
          }));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["generic_light.css!","ui/scroll_view/ui.scrollable","jquery","../../helpers/memoryLeaksHelper.js","ui/grid_core/ui.grid_core.virtual_scrolling_core","ui/grid_core/ui.grid_core.utils","core/utils/browser","core/devices","core/renderer","core/utils/size"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("generic_light.css!"), require("ui/scroll_view/ui.scrollable"), require("jquery"), require("../../helpers/memoryLeaksHelper.js"), require("ui/grid_core/ui.grid_core.virtual_scrolling_core"), require("ui/grid_core/ui.grid_core.utils"), require("core/utils/browser"), require("core/devices"), require("core/renderer"), require("core/utils/size"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=virtualScrolling.tests.js.map