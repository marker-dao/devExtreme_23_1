System.register(["ui/grid_core/ui.grid_core.modules"], function (_export, _context) {
  "use strict";

  var modules;
  return {
    setters: [function (_uiGrid_coreUiGrid_coreModules) {
      modules = _uiGrid_coreUiGrid_coreModules.default;
    }],
    execute: function () {
        ...
        */
        ...
        QUnit.module('Controller basic functions', {
          ...
          QUnit.test('inheritance controller should not override public method', function (assert) {
            ...
            assert.deepEqual(RootController.calls[0], {
              instance: rootControllerInstance,
              param: 'val3'
        ...
        QUnit.module('Controller Extender', {
          ...
          QUnit.test('Extend extender method', function (assert) {
            ...
            const applyExtendedExtender = Base => class ExtendedExtender extends Base {
              extenderMethod() {
                RootController.calls.push({
                  instance: this,
                  name: 'extenderMethod',
          ...
          QUnit.test('override several extender', function (assert) {
            ...
            */
            const applyExtender1 = Base => class Extender1 extends Base {
              extenderMethod1() {
                RootController.calls.push({
          ...
          QUnit.test('chain with different type of extending (es6Class -> Class.inherit -> es6Class)', function (assert) {
            ...
            const applyES6Class = Base => class ES6Class extends Base {
              method(param) {
                RootController.calls.push({
                  instance: this,
                  param,
        ...
        QUnit.module('View Extender', {}, () => {
          QUnit.test('Check view use same approach as controller', function (assert) {
            ...
            // assert
            assert.deepEqual(RootView.calls[0], {
              instance: viewInstance,
              name: 'extenderMethod',
              type: 'ExtendedExtender'
            }, 'check type es6Class');
            assert.deepEqual(RootView.calls[1], {
              instance: viewInstance,
              name: 'extenderMethod',
              type: 'RootView'
