...
(["testing/tests/DevExpress.ui.widgets/box.markup.tests.js"], ["jquery","ui/box","core/component_registrator","generic_light.css!","ui/scroll_view/ui.scrollable"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/box.markup.tests.js", ["jquery", "ui/box", "core/component_registrator", "generic_light.css!", "ui/scroll_view/ui.scrollable"], function($__export) {
  "use strict";
  var $,
      Box,
      registerComponent,
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module('layouting', function() {
        QUnit.test('render box in dxBox', function(assert) {
          var $box = $('#box').dxBox({items: [{box: {direction: 'row'}}]});
      ...
      QUnit.module('rendering box item', function() {
        QUnit.test('callstack should not grow when nesting is growing', function(assert) {
          var originalBox = Box;
          var deep = 0;
          var TestBox = function($__super) {
            function TestBox() {
              $traceurRuntime.superConstructor(TestBox).apply(this, arguments);
            }
            return ($traceurRuntime.createClass)(TestBox, {
              _render: function() {
                deep++;
                $traceurRuntime.superGet(this, TestBox.prototype, "_render").apply(this, arguments);
              },
              _renderItem: function() {
                var currentDeep = deep;
                $traceurRuntime.superGet(this, TestBox.prototype, "_renderItem").apply(this, arguments);
          ...
          try {
            $('#box').dxBox({items: [{box: {items: [{box: {items: ['1']}}]}}]});
          } finally {
        ...
        QUnit.test('onItemStateChanged action should fire after item visibility changed', function(assert) {
          ...
          var itemStateChangedHandler = sinon.spy();
          var $box = $('#box').dxBox({
            items: items,
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/box","core/component_registrator","generic_light.css!","ui/scroll_view/ui.scrollable"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/box"), require("core/component_registrator"), require("generic_light.css!"), require("ui/scroll_view/ui.scrollable"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=box.markup.tests.js.map