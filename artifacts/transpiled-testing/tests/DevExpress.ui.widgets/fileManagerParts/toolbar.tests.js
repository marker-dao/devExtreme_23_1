System.register(["jquery", "ui/file_manager", "animation/fx", "../../../helpers/fileManagerHelpers.js", "core/utils/size"], function (_export, _context) {
  "use strict";

  var $, fx, Consts, FileManagerWrapper, createTestFileSystem, implementationsMap, test, moduleConfig, createFileManager;
  return {
    ...
    execute: function () {
      ...
      createFileManager = useThumbnailViewMode => {
      ...
      QUnit.module('Toolbar', moduleConfig, () => {
        ...
        test('default items manual visibility management', function (assert) {
          ...
          const fileManagerInstance = $('#fileManager').dxFileManager('instance');
          fileManagerInstance.option('toolbar', {
            items: ['showNavPane', 'create', 'upload', 'separator', {
              name: 'move',
              visible: true,
              disabled: true
            }, 'refresh', {
        ...
        test('itemView dropDownButton must show correct state', function (assert) {
          ...
          this.clock.tick(400);
          this.wrapper.getDialogTextInput().val('New filename.txt').trigger('change');
        ...
        test('toolbar separators must support default items in menu', function (assert) {
          ...
          fileManager.option({
            toolbar: {
              fileSelectionItems: ['download', 'move', 'copy', 'rename', 'separator', 'delete', 'refresh', 'clearSelection', {
                widget: 'dxButton',
                options: {
        ...
        test('toolbar separators must support custom items in menu', function (assert) {
          ...
          fileManager.option({
            toolbar: {
              fileSelectionItems: ['download', 'move', 'copy', 'rename', 'separator', 'refresh', 'clearSelection', {
                widget: 'dxButton',
                options: {
        ...
        test('toolbar items can be specified by option full name', function (assert) {
          ...
          this.clock.tick(400);
          const fileManager = this.wrapper.getInstance();
          fileManager.option('toolbar.items', ['create', {
            widget: 'dxButton',
            options: {
              text: 'item 1'
            },
          ...
          this.clock.tick(400);
          fileManager.option('toolbar.fileSelectionItems', ['move', {
            widget: 'dxButton',
            options: {
              text: 'item 2'
            },
