System.register(["jquery", "animation/fx", "ui/file_uploader", "core/utils/resize_callbacks", "../../../helpers/fileManagerHelpers.js", "../../../helpers/fileManager/notification.progress_panel.mock.js", "../../../helpers/fileManager/logger.js", "../../../helpers/grid/keyboardNavigationHelper.js", "../../../helpers/fileManager/file_provider.slow.js", "file_management/custom_provider", "core/utils/size"], function (_export, _context) {
  "use strict";

  var $, fx, FileUploader, resizeCallbacks, createTestFileSystem, createUploaderFiles, FileManagerProgressPanelWrapper, FileManagerWrapper, FileManagerProgressPanelMock, FileManagerLogger, CLICK_EVENT, SlowFileProvider, CustomFileSystemProvider, implementationsMap, test, FileUploaderInternals, moduleConfig, integrationModuleConfig, createProgressPanel, createDetailItems, createDetailItem;
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_animationFx) {
      fx = _animationFx.default;
    }, function (_uiFile_uploader) {
    ...
    execute: function () {
      ...
      createProgressPanel = context => {
        ...
        context.progressPanel = new FileManagerProgressPanelMock($progressPanel, {
          onOperationClosed: ({
            info
          }) => logger.addEntry('onOperationClosed', {
            id: info.testOperationId
          }),
          onOperationCanceled: ({
            info
          }) => logger.addEntry('onOperationCanceled', {
            id: info.testOperationId
          }),
          onOperationItemCanceled: ({
            item,
            itemIndex
          }) => logger.addEntry('onOperationItemCanceled', {
            item: {
