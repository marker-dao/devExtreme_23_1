System.register(["file_management/utils", "file_management/file_system_item"], function (_export, _context) {
  "use strict";

  var getPathParts, getEscapedFileName, FileSystemItem, test;
  return {
    setters: [function (_file_managementUtils) {
      getPathParts = _file_managementUtils.getPathParts;
      getEscapedFileName = _file_managementUtils.getEscapedFileName;
