System.register(["jquery", "animation/fx", "ui/file_uploader", "file_management/object_provider", "../../../helpers/fileManagerHelpers.js", "core/utils/extend", "core/utils/deferred"], function (_export, _context) {
  "use strict";

  var $, fx, FileUploader, ObjectFileSystemProvider, createTestFileSystem, createEditingEvents, createUploaderFiles, stubFileReader, FileManagerWrapper, FileManagerProgressPanelWrapper, extend, Deferred, test, moduleConfig;
  return {
    ...
    execute: function () {
      ...
      moduleConfig = {
        ...
        createFileSystemProvider: function () {
          ...
          this.provider = new ObjectFileSystemProvider({
            data: fileSystem
          });
