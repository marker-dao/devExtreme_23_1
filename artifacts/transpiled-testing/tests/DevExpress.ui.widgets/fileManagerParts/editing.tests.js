System.register(["jquery", "ui/file_manager", "ui/file_uploader", "animation/fx", "events/pointer", "file_management/object_provider", "file_management/custom_provider", "file_management/error.js", "file_management/error_codes", "../../../helpers/fileManagerHelpers.js", "../../../helpers/fileManager/file_provider.no_duplicates.js", "../../../helpers/fileManager/file_provider.slow.js", "../../../helpers/grid/keyboardNavigationHelper.js", "core/utils/size"], function (_export, _context) {
  "use strict";

  var $, FileUploader, fx, pointerEvents, ObjectFileSystemProvider, CustomFileSystemProvider, FileSystemError, ErrorCode, Consts, FileManagerWrapper, FileManagerProgressPanelWrapper, createTestFileSystem, createUploaderFiles, stubFileReader, getDropFileEvent, NoDuplicatesFileProvider, SlowFileProvider, CLICK_EVENT, implementationsMap, test, FileUploaderInternals, ALLOWED_FILE_EXTENSIONS, moduleConfig;
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_uiFile_manager) {}, function (_uiFile_uploader) {
      FileUploader = _uiFile_uploader.default;
    ...
    }, function (_file_managementErrorJs) {
      ...
      Consts = _helpersFileManagerHelpersJs.Consts;
      ...
      getDropFileEvent = _helpersFileManagerHelpersJs.getDropFileEvent;
    }, function (_helpersFileManagerFile_providerNo_duplicatesJs) {
      NoDuplicatesFileProvider = _helpersFileManagerFile_providerNo_duplicatesJs.default;
    ...
    execute: function () {
      ...
      FileUploaderInternals = FileUploader.__internals;
      ALLOWED_FILE_EXTENSIONS = ['.txt', '.jpg', '.png', '.xml'];
      moduleConfig = {
        beforeEach: function () {
      ...
      QUnit.module('Editing operations', moduleConfig, () => {
        ...
        test('rename file failed for not allowed extension', function (assert) {
          ...
          this.wrapper.getToolbarButton('Rename').trigger('dxclick');
          this.clock.tick(400);
          this.wrapper.getDialogTextInput().val('Testpage 11.aspx').trigger('change');
          this.wrapper.getDialogButton('Save').trigger('dxclick');
          this.clock.tick(400);
        ...
        test('the entire widget must not be repainted when the permissions option changed (T1051605)', function (assert) {
          ...
          fileManager.option('permissions', {
            copy: true
          });
          assert.ok(initMarkupSpy.notCalled, '_initMarkup not called yet');
        });
        ...
        test('current directory must not be changed when all items not moved - provider (T1080473)', function (assert) {
          ...
          this.fileManager.option({
            fileSystemProvider: new CustomFileSystemProvider({
              getItems: function () {
                return objectProvider.getItems(...arguments);
              },
              moveItem: function () {
                throw new FileSystemError(0, null);
              }
            }),
            selectionMode: 'multiple',
            selectedItemKeys: [fileName1, fileName2]
