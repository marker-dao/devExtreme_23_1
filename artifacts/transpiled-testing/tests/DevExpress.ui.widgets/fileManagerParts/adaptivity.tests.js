System.register(["jquery", "core/utils/resize_callbacks", "ui/file_manager", "animation/fx", "../../../helpers/fileManagerHelpers.js", "core/utils/size"], function (_export, _context) {
  "use strict";

  var $, resizeCallbacks, fx, FileManagerWrapper, createTestFileSystem, Consts, implementationsMap, getOuterWidth, test, moduleConfig;
  return {
    ...
    execute: function () {
      ...
      moduleConfig = {
        beforeEach: function () {
          ...
          this.$element = $('#fileManager').css('width', 350).dxFileManager({
