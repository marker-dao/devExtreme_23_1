System.register(["jquery", "animation/fx", "core/utils/deferred", "file_management/object_provider", "file_management/error_codes", "ui/file_manager/file_items_controller", "../../../helpers/fileManagerHelpers.js", "../../../helpers/fileManager/file_provider.test.js", "../../../helpers/fileManager/notification.progress_panel.mock.js", "../../../helpers/fileManager/notification.mock.js", "../../../helpers/fileManager/file_uploader.mock.js", "../../../helpers/fileManager/editing.mock.js", "../../../helpers/fileManager/logger.js", "../../../helpers/fileManager/notification_manager.mock.js"], function (_export, _context) {
  "use strict";

  var $, fx, Deferred, ObjectFileSystemProvider, ErrorCode, FileItemsController, createTestFileSystem, createUploaderFiles, stubFileReader, createEditingEvents, TestFileSystemProvider, FileManagerProgressPanelMock, FileManagerNotificationControlMock, FileManagerFileUploaderMock, FileManagerEditingControlMock, FileManagerLogger, FileManagerNotificationManagerMock, test, moduleConfig, createController, createNotificationControl, createEditing, prepareEnvironment, raiseErrorForItem, startDeleteItems, startDownloadItems, createTestData;
  return {
    ...
    }, function (_file_managementError_codes) {
      ErrorCode = _file_managementError_codes.default;
    }, function (_uiFile_managerFile_items_controller) {
      FileItemsController = _uiFile_managerFile_items_controller.FileItemsController;
    }, function (_helpersFileManagerHelpersJs) {
      createTestFileSystem = _helpersFileManagerHelpersJs.createTestFileSystem;
      createUploaderFiles = _helpersFileManagerHelpersJs.createUploaderFiles;
      stubFileReader = _helpersFileManagerHelpersJs.stubFileReader;
      createEditingEvents = _helpersFileManagerHelpersJs.createEditingEvents;
    }, function (_helpersFileManagerFile_providerTestJs) {
      TestFileSystemProvider = _helpersFileManagerFile_providerTestJs.default;
    }, function (_helpersFileManagerNotificationProgress_panelMockJs) {
      FileManagerProgressPanelMock = _helpersFileManagerNotificationProgress_panelMockJs.default;
    }, function (_helpersFileManagerNotificationMockJs) {
      FileManagerNotificationControlMock = _helpersFileManagerNotificationMockJs.default;
    }, function (_helpersFileManagerFile_uploaderMockJs) {
      FileManagerFileUploaderMock = _helpersFileManagerFile_uploaderMockJs.default;
    }, function (_helpersFileManagerEditingMockJs) {
      FileManagerEditingControlMock = _helpersFileManagerEditingMockJs.default;
    }, function (_helpersFileManagerLoggerJs) {
      FileManagerLogger = _helpersFileManagerLoggerJs.default;
    }, function (_helpersFileManagerNotification_managerMockJs) {
      FileManagerNotificationManagerMock = _helpersFileManagerNotification_managerMockJs.default;
    }],
    execute: function () {
      ({
        test
      ...
      createController = (context, providerOptions) => {
        const data = createTestFileSystem();
        const arrayProvider = new ObjectFileSystemProvider({
          data
        });
      ...
      createNotificationControl = (context, options) => {
        options = options || {};
        ...
        const defaultConfig = {
          ...
          onActionProgress: ({
            message,
            status
          }) => logger.addEntry('notification-onActionProgress', {
            message,
            status
          }),
          logger
      ...
      prepareEnvironment = (context, options) => {
        options = options || {};
      ...
      raiseErrorForItem = (fileItem, fileIndex) => {
      ...
      startDeleteItems = (context, deleteItemCount, endIndex) => {
        ...
        controller.getDirectoryContents(selectedDir).then(items => {
        ...
        }).then(() => controller.getDirectoryContents(selectedDir)).then(items => deferred.resolve(items, itemCount));
        return deferred.promise();
      };
      startDownloadItems = (context, downloadItemCount, endIndex) => {
        if (endIndex === undefined) {
          endIndex = 4;
        }
        const deferred = new Deferred();
      ...
      createTestData = () => {
        return {
          'multiple request - delete multiple items': [{
            operationId: 1,
            commonText: 'Deleting 3 items from Files',
            allowProgressAutoUpdate: true,
            type: 'progress-addOperation'
          }, {
            message: 'Deleting 3 items from Files',
            status: 'progress',
            type: 'notification-onActionProgress'
          }, {
            operationId: 1,
            details: [{
              commonText: 'Folder 3',
            ...
            commonText: 'Deleted 3 items from Files',
            type: 'notification-_showPopup'
          }, {
            operationId: 1,
            commonText: 'Deleted 3 items from Files',
            isError: false,
            type: 'progress-completeOperation'
          }, {
            message: '',
            status: 'success',
            type: 'notification-onActionProgress'
          }, {
            updatedOnlyFiles: false,
            type: 'editing-onSuccess'
          }],
          'multiple request - delete multiple items with error': [{
            ...
            type: 'progress-addOperationDetailsError'
          }, {
            errorText: 'Unspecified error.',
            type: 'progress-_renderError'
          }, {
            ...
            errorText: 'Unspecified error.',
            type: 'notification_manager-renderError'
          }, {
            errorMode: true,
            commonText: 'Item was not deleted',
            detailsText: 'File 2.jpgUnspecified error.',
            type: 'notification-_showPopup'
          }, {
            operationId: 1,
            commonText: 'Item was not deleted',
          ...
          'multiple request - delete multiple items with error for each item': [{
            operationId: 1,
            commonText: 'Deleting 2 items from Files',
            allowProgressAutoUpdate: true,
            type: 'progress-addOperation'
          }, {
            message: 'Deleting 2 items from Files',
            status: 'progress',
            type: 'notification-onActionProgress'
          }, {
            operationId: 1,
            ...
            errorMode: true,
            commonText: 'Item was not deleted',
            detailsText: 'File 1.txtUnspecified error.',
            type: 'notification-_showPopup'
          }, {
            operationId: 1,
            index: 1,
            ...
            message: '2 items were not deleted',
            status: 'error',
            type: 'notification-onActionProgress'
          }, {
            item: {
            ...
            errorMode: true,
            commonText: '2 items were not deleted',
            detailsText: 'File 2.jpgUnspecified error.',
            type: 'notification-_showPopup'
          }, {
            operationId: 1,
          ...
          'multiple request - delete single item': [{
            operationId: 1,
            commonText: 'Deleting an item from Files',
            allowProgressAutoUpdate: true,
            type: 'progress-addOperation'
          }, {
            message: 'Deleting an item from Files',
            status: 'progress',
            type: 'notification-onActionProgress'
          }, {
            operationId: 1,
            ...
            commonText: 'Deleted an item from Files',
            type: 'notification-_showPopup'
          }, {
            operationId: 1,
            commonText: 'Deleted an item from Files',
          ...
          'multiple request - delete single item with error': [{
            ...
            operationId: 1,
            errorText: 'Unspecified error.',
            type: 'progress-completeSingleOperationWithError'
          }, {
            errorText: 'Unspecified error.',
            type: 'progress-_renderError'
          }, {
          ...
          'upload multiple files': [{
            operationId: 1,
            commonText: 'Uploading 2 items to Files',
            allowCancel: true,
            allowProgressAutoUpdate: false,
            type: 'progress-addOperation'
          }, {
            message: 'Uploading 2 items to Files',
            status: 'progress',
            type: 'notification-onActionProgress'
          }, {
            operationId: 1,
            ...
            commonText: 'Uploaded 2 items to Files',
            type: 'notification-_showPopup'
          }, {
            operationId: 1,
            commonText: 'Uploaded 2 items to Files',
          ...
          'upload multiple files with error': [{
            ...
            errorMode: true,
            commonText: 'Item was not uploaded',
            detailsText: 'Upload file 1.txtUnspecified error.',
            type: 'notification-_showPopup'
          }, {
            operationId: 1,
            itemIndex: 0,
          ...
          'upload multiple files with error for each item': [{
            ...
            errorMode: true,
            commonText: 'Item was not uploaded',
            detailsText: 'Upload file 0.txtUnspecified error.',
            type: 'notification-_showPopup'
          }, {
            operationId: 1,
            index: 1,
            ...
            message: '2 items were not uploaded',
            status: 'error',
            type: 'notification-onActionProgress'
          }, {
            item: {
            ...
            errorMode: true,
            commonText: '2 items were not uploaded',
            detailsText: 'Upload file 1.txtUnspecified error.',
            type: 'notification-_showPopup'
          }, {
            operationId: 1,
          ...
          'upload multiple files and cancel one of them': [{
            ...
            commonText: 'Uploaded 1 items to Files',
            type: 'notification-_showPopup'
          }, {
            operationId: 1,
            commonText: 'Uploaded 1 items to Files',
          ...
          'multiple request - download single item with error': [{
            ...
            message: 'Item was not downloaded',
            status: 'error',
            type: 'notification-onActionProgress'
          }, {
            errorText: 'Unspecified error.',
            ...
            commonText: 'Item was not downloaded',
            detailsText: 'File 2.jpgUnspecified error.',
            errorMode: true,
            type: 'notification-_showPopup'
          }, {
          ...
          'multiple request - download multiple items with error for each item': [{
            ...
            message: '2 items were not downloaded',
            status: 'error',
            type: 'notification-onActionProgress'
          }, {
            item: {
            ...
            errorMode: true,
            commonText: '2 items were not downloaded',
            detailsText: 'File 2.jpgUnspecified error.',
            type: 'notification-_showPopup'
          }, {
            operationId: 1,
      ...
      QUnit.module('Editing progress tests', moduleConfig, () => {
        test('multiple request - delete multiple items', function (assert) {
          ...
          startDeleteItems(this, 3).then((items, itemCount) => {
        ...
        test('multiple request - delete single item', function (assert) {
          ...
          startDeleteItems(this, 1).then((items, itemCount) => {
        ...
        test('multiple request - download single item with error', function (assert) {
          ...
          startDownloadItems(this, 1).then(() => {
            assert.deepEqual(this.logger.getEntries(), expectedEvents, 'progress events raised');
            done();
          });
          this.clock.tick(10000);
        ...
        test('multiple request - download multiple items with error for each item', function (assert) {
          ...
          startDownloadItems(this, 2).then(() => {
            assert.deepEqual(this.logger.getEntries(), expectedEvents, 'progress events raised');
            done();
          });
          this.clock.tick(10000);
