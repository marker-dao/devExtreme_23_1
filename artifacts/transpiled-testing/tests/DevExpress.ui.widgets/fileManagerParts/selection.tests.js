System.register(["jquery", "ui/file_manager", "animation/fx", "../../../helpers/fileManagerHelpers.js", "../../../helpers/fileManager/events.js"], function (_export, _context) {
  "use strict";

  var $, fx, FileManagerWrapper, createTestFileSystem, isDesktopDevice, triggerCellClick, test, moduleConfig, createFileManager;
  return {
    ...
    execute: function () {
      ...
      createFileManager = (context, options) => {
        ...
        context.fileManager = $('#fileManager').dxFileManager(finalOptions).dxFileManager('instance');
