System.register(["jquery", "ui/file_manager", "file_management/file_system_item", "file_management/remote_provider", "../../../helpers/ajaxMock.js", "../../../helpers/fileManagerHelpers.js", "core/utils/deferred", "core/utils/type", "core/utils/extend"], function (_export, _context) {
  "use strict";

  var $, FileSystemItem, RemoteFileSystemProvider, ajaxMock, createSampleFileItems, generateString, createFileObject, when, isString, isFunction, extend, test, filesPathInfo, itemData, fileSystemItems, moduleConfig, createProvider;
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_uiFile_manager) {}, function (_file_managementFile_system_item) {
      FileSystemItem = _file_managementFile_system_item.default;
    }, function (_file_managementRemote_provider) {
      RemoteFileSystemProvider = _file_managementRemote_provider.default;
    }, function (_helpersAjaxMockJs) {
      ajaxMock = _helpersAjaxMockJs.default;
    }, function (_helpersFileManagerHelpersJs) {
      createSampleFileItems = _helpersFileManagerHelpersJs.createSampleFileItems;
      generateString = _helpersFileManagerHelpersJs.generateString;
      createFileObject = _helpersFileManagerHelpersJs.createFileObject;
    }, function (_coreUtilsDeferred) {
      when = _coreUtilsDeferred.when;
    }, function (_coreUtilsType) {
      isString = _coreUtilsType.isString;
      isFunction = _coreUtilsType.isFunction;
    ...
    execute: function () {
      ...
      createProvider = (context, options) => {
      ...
      QUnit.module('Remote Provider', moduleConfig, () => {
        test('get directory file items', function (assert) {
          ...
          this.provider.getItems(filesDir).done(folders => {
        ...
        test('create directory', function (assert) {
          ...
          this.provider.createDirectory(parentFolder, 'Test 1').done(result => {
        ...
        test('rename item test', function (assert) {
          ...
          this.provider.renameItem(item, 'Test 1').done(result => {
        ...
        test('delete item test', function (assert) {
          ...
          when.apply(null, deferreds).done(result => {
        ...
        test('upload file chunk', function (assert) {
          ...
          ajaxMock.setup({
            ...
            callback: request => {
              ...
              documentsPathInfo.push({
                key: 'Root/Files/Documents',
                name: 'Documents'
              });
          ...
          const chunkBlob = new window.Blob([generateString(20)], {
          ...
          this.provider.uploadFileChunk(fileData, uploadInfo, directory).done(() => done());
        });
        test('get items content test', function (assert) {
          ...
          this.provider.getItemsContent([item]).done(result => {
