System.register(["jquery", "ui/file_manager", "animation/fx", "core/utils/window", "../../../helpers/fileManagerHelpers.js", "generic_light.css!"], function (_export, _context) {
  "use strict";

  var $, fx, windowUtils, FileManagerWrapper, createTestFileSystem, Consts, isDesktopDevice, test, getDefaultConfig, prepareFileManager, moduleConfig;
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_uiFile_manager) {}, function (_animationFx) {
      fx = _animationFx.default;
    }, function (_coreUtilsWindow) {
      windowUtils = _coreUtilsWindow.default;
    ...
    execute: function () {
      ...
      prepareFileManager = (context, isPure, options) => {
