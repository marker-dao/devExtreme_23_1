...
(["testing/tests/DevExpress.ui.widgets/contextMenu.markup.tests.js"], ["jquery","ui/context_menu","generic_light.css!"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/contextMenu.markup.tests.js", ["jquery", "ui/context_menu", "generic_light.css!"], function($__export) {
  "use strict";
  var $,
      ContextMenu,
      DX_HAS_CONTEXT_MENU_CLASS,
      moduleConfig;
  return {
    ...
    execute: function() {
      ...
      QUnit.module('ContextMenu markup', moduleConfig, function() {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/context_menu","generic_light.css!"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/context_menu"), require("generic_light.css!"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=contextMenu.markup.tests.js.map