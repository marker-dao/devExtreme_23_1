...
(["testing/tests/DevExpress.ui.widgets/tabPanel.width.tests.js"], ["core/utils/size","generic_light.css!","events/visibility_change","jquery","ui/tab_panel"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/tabPanel.width.tests.js", ["core/utils/size", "generic_light.css!", "events/visibility_change", "jquery", "ui/tab_panel"], function($__export) {
  "use strict";
  var getOuterWidth,
      triggerResizeEvent,
      triggerShownEvent,
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module('Tabs width', function() {
        var TabPanelWidthTestHelper = function() {
          function TabPanelWidthTestHelper(assert, setWidthApproach) {
            this.$container = $('<div id=\'container\'>');
            this.$tabPanel = $('<div>');
            this.assert = assert;
            this.setWidthApproach = setWidthApproach;
          }
          return ($traceurRuntime.createClass)(TabPanelWidthTestHelper, {
            _initializeTabPanel: function(width) {
              this.$tabPanel.appendTo(this.$container);
              this.tabPanel = this.$tabPanel.dxTabPanel({
                items: [{title: 'title'}, {title: 'long long title example'}],
                showNavButtons: true,
            ...
            createTabPanel: function(options) {
              this._initializeTabPanel(options.width);
              this.checkTabPanel(options);
            },
            checkTabPanel: function(options) {
              var tabs = this.tabPanel._tabs;
        ...
        ['resizeBrowser', 'container', 'option'].forEach(function(setWidthApproach) {
          var config = (", change " + setWidthApproach + ".width");
          QUnit.test(("Tabpanel with fixed tabs, resize to show navigation button tabs" + config), function(assert) {
            var helper = new TabPanelWidthTestHelper(assert, setWidthApproach);
            helper.createTabPanel({
              width: 400,
              expectNavButtons: 0
            });
            helper.setWidth(100);
            helper.checkTabPanel({
              width: 100,
              expectNavButtons: 2
            });
          });
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/size","generic_light.css!","events/visibility_change","jquery","ui/tab_panel"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/size"), require("generic_light.css!"), require("events/visibility_change"), require("jquery"), require("ui/tab_panel"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=tabPanel.width.tests.js.map