...
(["testing/tests/DevExpress.ui.widgets/treeViewParts/expresions.js"], ["jquery"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/treeViewParts/expresions.js", ["jquery"], function($__export) {
  "use strict";
  var $;
  return {
    ...
    execute: function() {
      ...
      QUnit.test('Render items with custom model', function(assert) {
        ...
        var $rootNodeFirstItem = $rootNode.find('.' + internals.NODE_CLASS).eq(0);
        var $rootNodeSecondItem = $rootNode.find(' > .' + internals.NODE_CLASS).eq(1);
