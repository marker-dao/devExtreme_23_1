...
(["testing/tests/DevExpress.ui.widgets/treeViewParts/selectAllMode.js"], ["jquery"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/treeViewParts/selectAllMode.js", ["jquery"], function($__export) {
  "use strict";
  var $;
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.test('\'selectAll\' item should be selected if all item became selected', function(assert) {
        ...
        checkBox = this.treeView._$selectAllItem.dxCheckBox('instance'), assert.strictEqual(checkBox.option('value'), true, 'selected');
      });
...
//# sourceMappingURL=selectAllMode.js.map