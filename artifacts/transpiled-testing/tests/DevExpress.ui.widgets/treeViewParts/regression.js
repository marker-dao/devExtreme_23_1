...
(["testing/tests/DevExpress.ui.widgets/treeViewParts/regression.js"], ["jquery"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.ui.widgets/treeViewParts/regression.js', ['jquery'], true, function ($__require, exports, module) {
    ...
    QUnit.test('Widget should work right if item is class instance', function (assert) {
        ...
        const treeView = $('#treeView').dxTreeView({
            items: [new User('Alex'), new User('Jack'), new User('John')],
            displayExpr: 'name'
        }).dxTreeView('instance');
    ...
    QUnit.test('T217916: dxTreeView does not render a node if ID is less than ParentID', function (assert) {
        const treeView = $('#treeView').dxTreeView({
            items: [{ id: 1, text: 'Cats', parentId: 0, expanded: true }, { id: 4, text: 'Sub Bob', parentId: 2, expanded: true }, { id: 2, text: 'Bob', parentId: 3, expanded: true }, { id: 3, text: 'Dogs', parentId: 0, expanded: true }],
            dataStructure: 'plain'
