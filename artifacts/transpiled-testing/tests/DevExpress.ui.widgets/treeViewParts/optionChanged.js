...
(["testing/tests/DevExpress.ui.widgets/treeViewParts/optionChanged.js"], ["jquery"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/treeViewParts/optionChanged.js", ["jquery"], function($__export) {
  "use strict";
  var $;
  return {
    ...
    execute: function() {
      ...
      QUnit.test('selectAll mode', function(assert) {
        ...
        assert.equal($traceurRuntime.typeof(treeView._$selectAllItem), 'undefined');
      ...
      QUnit.test('scrollDirection', function(assert) {
        var treeView = initTree({items: $.extend(true, [], DATA[5])}).dxTreeView('instance');
...
//# sourceMappingURL=optionChanged.js.map