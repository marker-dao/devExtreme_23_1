...
(["testing/tests/DevExpress.ui.widgets/accordion.tests.js"], ["animation/fx","generic_light.css!","core/config","core/utils/size","core/utils/common","core/utils/extend","core/utils/type","data/custom_store","data/data_source/data_source","events/hold","events/visibility_change","jquery","ui/accordion","ui/themes","../../helpers/executeAsyncMock.js","../../helpers/keyboardMock.js","../../helpers/pointerMock.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/accordion.tests.js", ["animation/fx", "generic_light.css!", "core/config", "core/utils/size", "core/utils/common", "core/utils/extend", "core/utils/type", "data/custom_store", "data/data_source/data_source", "events/hold", "events/visibility_change", "jquery", "ui/accordion", "ui/themes", "../../helpers/executeAsyncMock.js", "../../helpers/keyboardMock.js", "../../helpers/pointerMock.js"], function($__export) {
  "use strict";
  var fx,
      config,
      getHeight,
  ...
  return {
    ...
    execute: function() {
      ...
      HIDDEN_CLASS = 'dx-state-invisible';
      ...
      QUnit.module('widget rendering', moduleSetup, function() {
        QUnit.test('Widget should be rendered without exception inside deferUpdate', function(assert) {
          var $accordion;
          deferUpdate(function() {
            $accordion = $('<div>').appendTo('#qunit-fixture').dxAccordion({items: ['Test1', 'Test2']});
          });
          var $accordionItemTitles = $accordion.find(("." + ACCORDION_ITEM_TITLE_CLASS + "-caption"));
          var $accordionItemBodies = $accordion.find(("." + ACCORDION_ITEM_BODY_CLASS));
        ...
        QUnit.test('height should be correctly updated on dxshown event', function(assert) {
          ...
          try {
            var $container = $('<div>');
            var $element = $('<div>').appendTo($container).dxAccordion({items: this.items});
            $element.dxAccordion('instance');
            fx.animate = function() {
              assert.ok(false, 'animation executed');
            };
        ...
        QUnit.test('Item body should be rendered on item opening when the \'deferRendering\' option is true', function(assert) {
          ...
          var instance = $element.dxAccordion('instance');
      ...
      QUnit.module('nested accordion', moduleSetup, function() {
        ...
        QUnit.test('nested widget with onItemTitleClick', function(assert) {
          var that = this;
          var nested;
          var handleFire = sinon.stub();
          var parent = this.$element.dxAccordion({
            items: this.items,
            onItemTitleClick: handleFire,
            itemTemplate: function(itemData, itemIndex, itemElement) {
              nested = $('<div>').dxAccordion({items: that.items}).dxAccordion('instance');
      ...
      QUnit.module('widget options', moduleSetup, function() {
        ...
        QUnit.test('dataSource option with using DataSource', function(assert) {
          ...
          this.$element.dxAccordion({dataSource: new DataSource({load: function(loadOptions) {
                var d = new $.Deferred();
                setTimeout(function() {
        ...
        QUnit.test('animationDuration option', function(assert) {
          ...
          try {
            ...
            var $title = $item.find('.' + ACCORDION_ITEM_TITLE_CLASS);
        ...
        QUnit.test('height option in \'auto\' mode', function(assert) {
          ...
          var instance = $element.dxAccordion({
            items: [{
              title: '',
        ...
        QUnit.test('height option in static mode', function(assert) {
          ...
          var closedItemsHeight = $element.find('.' + ACCORDION_ITEM_CLASS).eq(1).outerHeight() * (items.length - 1);
        ...
        QUnit.test('height option in static mode when widget is multiple', function(assert) {
          ...
          var closedItemHeight = $element.find('.' + ACCORDION_ITEM_CLASS).eq(1).outerHeight();
          ...
          var closedItemsCount = items.length - openedItemsCount;
      ...
      QUnit.module('widget options changed', moduleSetup, function() {
        QUnit.test('items options is changed', function(assert) {
          var instance = this.$element.dxAccordion({items: this.items}).dxAccordion('instance');
        ...
        QUnit.test('itemTitleTemplate option changed (function)', function(assert) {
          ...
          instance.option('itemTitleTemplate', function(itemData, itemIndex, itemElement) {
            return $('<div>').addClass('item-title-render-changed').text('Changed: ' + itemData.title);
          });
        ...
        QUnit.test('item title templates should be applied', function(assert) {
          ...
          var $items = this.$element.find(("." + ACCORDION_ITEM_TITLE_CLASS));
        ...
        QUnit.test('itemTemplate option changed (function)', function(assert) {
          ...
          instance.option('itemTemplate', function(itemData, itemIndex, itemElement) {
            ...
            return $('<div>').addClass('item-content-render-changed').text('Changed: ' + itemData.text);
          });
      ...
      QUnit.module('widget behavior', moduleSetup, function() {
        ...
        QUnit.test('collapseItem public method', function(assert) {
          ...
          var itemsVisible = this.$element.find('.' + ACCORDION_ITEM_OPENED_CLASS).length;
      ...
      QUnit.module('update method', function() {
      ...
      QUnit.module('Live Update', {beforeEach: function() {
          ...
          this.createAccordion = function(dataSourceOptions, repaintChangesOnly) {
            var dataSource = new DataSource($.extend({
              ...
              store: new CustomStore({
                ...
                remove: function(key) {
                  var removedItem = $__3.data.filter(function(item) {
                    return item.id === key;
                  })[0];
                  if (removedItem) {
                    $__3.data.splice($__3.data.indexOf(removedItem), 1);
                  }
                },
                key: 'id'
              })
        ...
        QUnit.test('remove item', function(assert) {
          ...
          var store = accordion.getDataSource().store();
          var pushData = [{
            type: 'remove',
            key: 1
          }];
        ...
        QUnit.test('repaintChangesOnly, remove item', function(assert) {
          var accordion = this.createAccordion({}, true);
          var dataSource = accordion.getDataSource();
      ...
      QUnit.module('optionChanged', moduleSetup, function() {
        var AccordionTestHelper = function() {
          function AccordionTestHelper($element, options) {
            this.element = $element.get(0);
            this.options = options;
            this.instance = new Accordion(this.element, options);
          }
          return ($traceurRuntime.createClass)(AccordionTestHelper, {
            _getItemElements: function() {
              return this.element.querySelectorAll(("." + ACCORDION_ITEM_CLASS));
            },
            _getItemContentElement: function(itemElement) {
              return itemElement.querySelector(("." + ACCORDION_ITEM_BODY_CLASS));
            },
            _hasSelectedClass: function(item) {
              return item.classList.contains(SELECTED_ITEM_CLASS);
            },
            _hasOpenedClass: function(item) {
              return item.classList.contains(ACCORDION_ITEM_OPENED_CLASS);
            },
            _hasClosedClass: function(item) {
              return item.classList.contains(ACCORDION_ITEM_CLOSED_CLASS);
            },
            checkItems: function(assert, items, selectedIndexes) {
              var $__3 = this;
              var itemElements = this._getItemElements();
              selectedIndexes.forEach(function(index) {
                assert.notStrictEqual($__3.instance.option('selectedItems').indexOf(items[index]), -1, ("item " + index + " is selected"));
                assert.strictEqual($__3._hasSelectedClass(itemElements[index]), true, ("item " + index + " has selected class"));
                assert.strictEqual($__3._hasOpenedClass(itemElements[index]), true, ("item " + index + " has opened class"));
                assert.strictEqual($__3._hasClosedClass(itemElements[index]), false, ("item " + index + " hasn't closed class"));
                assert.strictEqual(window.getComputedStyle($__3._getItemContentElement(itemElements[index])).visibility, 'visible', ("contentElement[" + index + "] is visible"));
              });
              for (var index = 0,
                  length = itemElements.length; index < length; index++) {
        ...
        var configs = [];
        [true, false].forEach(function(collapsible) {
          [true, false].forEach(function(multiple) {
        ...
        configs.forEach(function(config) {
          var $__4 = config,
              collapsible = $__4.collapsible,
              multiple = $__4.multiple;
          QUnit.test(config.message + '[item_0.selected, item_1] -> .option(items[0].title, "new_value") -> .expandItem(1)', function(assert) {
            ...
            var helper = new AccordionTestHelper(this.$element, extend(config, {
              selectedIndex: 0,
              items: items
            }));
          ...
          QUnit.test(config.message + 'item1.display: false -> accordion.option(items[1].visible, true) -> accordion.option(items[1].visible, false) (T869114)', function(assert) {
            var $element = this.$element.dxAccordion(extend(config, {items: [{
                id: 0,
                title: 'item0',
                text: 'Any text'
              }, {
            ...
            var instance = $element.dxAccordion('instance');
            var item1GetterFunc = function() {
              return $element.find(("." + ACCORDION_ITEM_CLASS)).eq(1);
            };
            var item1 = item1GetterFunc();
          ...
          function checkItems_T992552($accordion, assert) {
            var $items = $accordion.find(("." + ACCORDION_ITEM_CLASS));
            ...
            var $bodyItems = $accordion.find(("." + ACCORDION_ITEM_BODY_CLASS));
          ...
          QUnit.test(config.message + 'accordion.selectedItem=item1 (T992552)', function(assert) {
            ...
            var $element = this.$element.dxAccordion(extend(config, {
              items: items,
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["animation/fx","generic_light.css!","core/config","core/utils/size","core/utils/common","core/utils/extend","core/utils/type","data/custom_store","data/data_source/data_source","events/hold","events/visibility_change","jquery","ui/accordion","ui/themes","../../helpers/executeAsyncMock.js","../../helpers/keyboardMock.js","../../helpers/pointerMock.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("animation/fx"), require("generic_light.css!"), require("core/config"), require("core/utils/size"), require("core/utils/common"), require("core/utils/extend"), require("core/utils/type"), require("data/custom_store"), require("data/data_source/data_source"), require("events/hold"), require("events/visibility_change"), require("jquery"), require("ui/accordion"), require("ui/themes"), require("../../helpers/executeAsyncMock.js"), require("../../helpers/keyboardMock.js"), require("../../helpers/pointerMock.js"));
  else
