...
(["testing/tests/DevExpress.ui.widgets/ganttParts/toolbar.tests.js"], ["jquery","ui/gantt","../../../helpers/ganttHelpers.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/ganttParts/toolbar.tests.js", ["jquery", "ui/gantt", "../../../helpers/ganttHelpers.js"], function($__export) {
  "use strict";
  var $,
      Consts,
      data,
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module('Toolbar', moduleConfig, function() {
        test('common', function(assert) {
          var items = ['undo', 'redo', 'separator', 'zoomIn', 'zoomOut', 'fullScreen', 'taskDetails', 'resourceManager', 'separator', {
            widget: 'dxButton',
            options: {
              text: 'Custom item',
              stylingMode: 'text'
