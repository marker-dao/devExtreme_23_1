...
(["testing/tests/DevExpress.ui.widgets/filterBuilderParts/utilsTests.js"], ["ui/filter_builder/utils","ui/filter_builder/between","data/custom_store","localization/message","../../../helpers/filterBuilderTestData.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/filterBuilderParts/utilsTests.js", ["ui/filter_builder/utils", "ui/filter_builder/between", "data/custom_store", "localization/message", "../../../helpers/filterBuilderTestData.js"], function($__export) {
  "use strict";
  var utils,
      between,
      CustomStore,
  ...
  return {
    ...
    execute: function() {
      condition1 = ['CompanyName', '=', 'Super Mart of the West'];
      ...
      QUnit.module('Errors', function() {
        ...
        QUnit.test('E4019', function(assert) {
          assert.throws(function() {
            utils.getGroupValue([['CompanyName', '=', 'Value1'], 'and', ['Zipcode', '=', 'Value2'], 'or', ['CompanyName', '=', 'Value2']], fields);
          }, function(e) {
      ...
      QUnit.module('Utils', function() {
        ...
        QUnit.test('getGroupMenuItem', function(assert) {
          var group = ['!', [condition1, 'and', condition2, 'and', condition3]];
          assert.deepEqual(utils.getGroupMenuItem(group, groupOperations), {
            text: 'Not And',
            value: '!and'
          });
        });
        ...
        QUnit.test('change operation from default to custom with value', function(assert) {
          var updatedCondition = utils.updateConditionByOperation(['value', '=', '123'], 'range', [{name: 'range'}]);
        ...
        QUnit.test('change operation from custom with value to default', function(assert) {
          var updatedCondition = utils.updateConditionByOperation(['value', 'range', [1, 2]], '=', [{name: 'range'}]);
          assert.deepEqual(updatedCondition, ['value', '=', '']);
        });
        ...
        QUnit.test('getNormalizedFields', function(assert) {
          ...
          var defaultTrueText = messageLocalization.format('dxDataGrid-trueText');
          var defaultFalseText = messageLocalization.format('dxDataGrid-falseText');
          var normalizedFields = utils.getNormalizedFields([field, {}]);
      ...
      QUnit.module('Add item', function() {
        ...
        QUnit.test('to inner group', function(assert) {
          var innerGroup = ['and'];
          var group = [condition1, 'and', innerGroup, 'and'];
      ...
      QUnit.module('Remove item', function() {
        ...
        QUnit.test('from middle', function(assert) {
          var group = [condition1, 'and', condition2, 'and', condition3, 'and', condition4, 'and', condition5, 'and'];
          group = utils.removeItem(group, condition3);
          assert.deepEqual(group, [condition1, 'and', condition2, 'and', condition4, 'and', condition5, 'and']);
        });
      ...
      QUnit.module('Convert to inner structure', function() {
        ...
        QUnit.test('from short condition', function(assert) {
          ...
          var model = utils.convertToInnerStructure(shortCondition, []);
        ...
        QUnit.test('from group with several conditions', function(assert) {
          ...
          var model = utils.convertToInnerStructure(filter, []);
        ...
        QUnit.test('from short group with several short conditions', function(assert) {
          ...
          var model = utils.convertToInnerStructure(filter, []);
          assert.deepEqual(model, [['CompanyName', '=', 'DevExpress'], 'and', ['CompanyName', '=', 'DevExpress'], 'and', ['!', [['CompanyName', '=', 'DevExpress'], 'and']], 'and']);
        });
        QUnit.test('check lowercase group', function(assert) {
          ...
          var model = utils.convertToInnerStructure(filter, []);
          assert.deepEqual(model, [condition1, 'or', condition2, 'or', [condition1, 'and', ['!', [condition1, 'or', condition2, 'or']], 'and'], 'or']);
        });
        QUnit.test('from negative group with inner negative group', function(assert) {
          var model = utils.convertToInnerStructure(['!', ['!', condition1]], []);
          assert.deepEqual(model, ['!', [['!', [['CompanyName', '=', 'Super Mart of the West'], 'and']], 'and']]);
        });
        QUnit.test('with custom operation', function(assert) {
          var filter = ['State', 'lastWeek'];
          var model = utils.convertToInnerStructure(filter, [{name: 'lastWeek'}]);
          assert.deepEqual(model, [['State', 'lastWeek'], 'and']);
        });
        QUnit.test('with custom group operations', function(assert) {
          var model = utils.convertToInnerStructure(null, [], 'or');
      ...
      QUnit.module('Filter normalization', function() {
        ...
        QUnit.test('get normalized filter from group which contains some not valid conditions', function(assert) {
          ...
          var group = [notValidCondition, 'and', [notValidCondition, 'and', condition2, 'and'], 'and', ['!', [condition3, 'and', notValidCondition, 'and']], 'and'];
          group = utils.getNormalizedFilter(group);
      ...
      QUnit.module('getAvailableOperations', {beforeEach: function() {
        ...
        QUnit.test('for field with lookup', function(assert) {
          var operations = utils.getAvailableOperations({
            dataField: 'Product',
            lookup: {dataSource: ['DataGrid', 'PivotGrid', 'TreeList']}
          }, filterOperationsDescriptions, []);
        ...
        QUnit.test('ignore custom operation if dataType is not set', function(assert) {
          var operations = utils.getAvailableOperations({dataField: 'test'}, {equals: '='}, [{
            name: 'lastDays',
            caption: 'last days',
            icon: 'add'
          }]);
        ...
        QUnit.test('a custom operation with enabled notForLookup option should not be listed for a lookup column', function(assert) {
          ...
          var operations = utils.getAvailableOperations(field1, filterOperationsDescriptions, customOperations);
          var operationValues = operations.map(function(operation) {
          ...
          operationValues = operations.map(function(operation) {
            return operation.value;
          });
      ...
      QUnit.module('Custom filter expressions', {beforeEach: function() {
          this.fields = utils.getNormalizedFields([{
            ...
            calculateFilterExpression: function(filterValue, selectedFilterOperation) {
              ...
              return [[this.dataField, '<>', filterValue], 'or', [this.dataField, '=', 10]];
            }
          }, {dataField: 'field2'}]);
        }}, function() {
        ...
        QUnit.test('calculateFilterExpression for negative group with one condition', function(assert) {
          var value = ['!', ['field', '=', 1]];
          var normalizedFields = utils.getNormalizedFields([{dataField: 'field'}]);
        ...
        QUnit.test('calculateFilterExpression for fieldValue = array', function(assert) {
          ...
          assert.deepEqual(utils.getFilterExpression(value, this.fields, customOperations), [['field1', '>', 2], 'and', ['field1', '<', 3]]);
        });
        ...
        QUnit.test('calculateFilterExpression for group', function(assert) {
          ...
          assert.deepEqual(utils.getFilterExpression(value, this.fields, []), [[['field1', '<>', 1], 'or', ['field1', '=', 10]], 'and', [[['field1', '<>', 20], 'or', ['field1', '=', 10]], 'or', ['field2', '=', '30']]]);
        });
        ...
        QUnit.test('calculateFilterExpression for short form of group', function(assert) {
          var value = [['field1', 1], [['field1', '=', 20], ['field2', '30']]];
          assert.deepEqual(utils.getFilterExpression(value, this.fields, []), [[['field1', '<>', 1], 'or', ['field1', '=', 10]], 'and', [[['field1', '<>', 20], 'or', ['field1', '=', 10]], 'and', ['field2', '=', '30']]]);
        });
        QUnit.test('calculateFilterExpression for group with between', function(assert) {
          var value = [['field2', '20'], 'or', ['field2', '30'], 'or', ['field1', 'between', [null, null]]];
          assert.deepEqual(utils.getFilterExpression(value, this.fields, [between.getConfig()]), [['field2', '=', '20'], 'or', ['field2', '=', '30']]);
          value = [['field2', '20'], ['field2', '30'], ['field1', 'between', [null, null]]];
          assert.deepEqual(utils.getFilterExpression(value, this.fields, [between.getConfig()]), [['field2', '=', '20'], 'and', ['field2', '=', '30']]);
        });
      ...
      QUnit.module('Formatting', function() {
        ...
        QUnit.test('field.customizeText', function(assert) {
          var field = {customizeText: function(conditionInfo) {
        ...
        QUnit.test('customOperation.customizeText', function(assert) {
          ...
          var value = 'MyValue';
          var customOperation = {customizeText: function(conditionInfo) {
        ...
        QUnit.test('customOperation.customizeText for array', function(assert) {
          ...
          var customOperation = {customizeText: function(fieldInfo) {
              return '(Blanks)';
            }};
          var text = utils.getCurrentValueText(field, '', customOperation);
          assert.equal(text, '');
          text = utils.getCurrentValueText(field, [null], customOperation).done(function(text) {
        ...
        QUnit.test('default format for date', function(assert) {
          ...
          var value = new Date(2017, 8, 5, 12, 30, 0);
          assert.equal(utils.getCurrentValueText(field, value), '9/5/2017');
        });
      ...
      QUnit.module('Lookup Value', function() {
        QUnit.test('array of strings & value=empty', function(assert) {
          var field = {lookup: {dataSource: ['DataGrid', 'PivotGrid', 'TreeList']}};
          var value = '';
        ...
        QUnit.test('lookup with ODataStore shouldn\'t send getValueText query when value is empty', function(assert) {
          var fakeStore = {load: function() {
              assert.ok(false, 'load shoudn\'t execute');
            }};
          var field = {lookup: {dataSource: {store: fakeStore}}};
          var value = '';
          utils.getCurrentLookupValueText(field, value, function(r) {
            assert.equal(r, '');
          });
        ...
        QUnit.test('with custom store', function(assert) {
          var categories = ['Video Players', 'Televisions'];
          var field = {lookup: {dataSource: new CustomStore({
                load: function() {
                  return categories;
                },
                byKey: function(key) {
          ...
          var value = 'Televisions';
          utils.getCurrentLookupValueText(field, value, function(r) {
            return assert.equal(r, 'Televisions');
          });
        });
      ...
      QUnit.module('Between operation', function() {
        ...
        QUnit.test('between.calculateFilterExpression', function(assert) {
          var customOperations = [];
          var fields = utils.getNormalizedFields([{
            dataField: 'field',
            dataType: 'number'
          }]);
          ...
          assert.deepEqual(filterExpression, null);
          filterExpression = utils.getFilterExpression([['field', 'between', [123, null]], 'and', ['field', '>', 100]], fields, customOperations);
          assert.deepEqual(filterExpression, ['field', '>', 100]);
        });
        QUnit.test('between.customizeText', function(assert) {
          var customOperations = [];
          var field = {dataType: 'number'};
          var betweenOperation = utils.getMergedOperations(customOperations)[0];
          var text = utils.getCurrentValueText(field, null, betweenOperation);
          assert.equal(text, '', 'empty text is correct');
          text = utils.getCurrentValueText(field, [null, null], betweenOperation).done(function(result) {
            assert.equal(result, '', 'empty text is correct');
          });
          text = utils.getCurrentValueText(field, [0, null], betweenOperation).done(function(result) {
            assert.deepEqual(result, ['0', '?'], 'text without endValue');
          });
          text = utils.getCurrentValueText(field, [null, 1], betweenOperation).done(function(result) {
            assert.deepEqual(result, ['?', '1'], 'text without startValue');
          });
          text = utils.getCurrentValueText(field, [0, 1], betweenOperation).done(function(result) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["ui/filter_builder/utils","ui/filter_builder/between","data/custom_store","localization/message","../../../helpers/filterBuilderTestData.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("ui/filter_builder/utils"), require("ui/filter_builder/between"), require("data/custom_store"), require("localization/message"), require("../../../helpers/filterBuilderTestData.js"));
  else
