System.register(["jquery", "core/utils/type", "core/config", "core/devices", "ui/list", "../../helpers/ariaAccessibilityTestHelper.js", "generic_light.css!"], function (_export, _context) {
  ...
  var $, isRenderer, config, devices, List, ariaAccessibilityTestHelper, LIST_CLASS, LIST_ITEM_CLASS, LIST_GROUP_CLASS, LIST_GROUP_HEADER_CLASS, LIST_GROUP_BODY_CLASS, LIST_ITEM_BEFORE_BAG_CLASS, SCROLLVIEW_CONTENT_CLASS, toSelector, helper, STATIC_DELETE_BUTTON_CONTAINER_CLASS, STATIC_DELETE_BUTTON_CLASS, TOGGLE_DELETE_SWITCH_CLASS, TOGGLE_DELETE_SWITCH_ICON_CLASS, SELECT_CHECKBOX_CONTAINER_CLASS, SELECT_CHECKBOX_CLASS, SELECT_RADIO_BUTTON_CONTAINER_CLASS, SELECT_RADIO_BUTTON_CLASS, REORDER_HANDLE_CONTAINER_CLASS, REORDER_HANDLE_CLASS;
  return {
