...
(["testing/tests/DevExpress.ui.widgets/diagramParts/options.tests.js"], ["jquery","ui/diagram","devexpress-diagram","../../../helpers/diagramHelpers.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/diagramParts/options.tests.js", ["jquery", "ui/diagram", "devexpress-diagram", "../../../helpers/diagramHelpers.js"], function($__export) {
  "use strict";
  var $,
      test,
      DiagramCommand,
  ...
  return {
    setters: [function($__m) {
      ...
      DataLayoutType = $__m.DataLayoutType;
    }, function($__m) {
      Consts = $__m.Consts;
    }],
    execute: function() {
      ...
      moduleConfig = {beforeEach: function() {
          ...
          this.$element = $('#diagram').dxDiagram({onOptionChanged: this.onOptionChanged});
      ...
      QUnit.module('Options', {
        ...
        test('should change zoomLevel object property', function(assert) {
          ...
          this.instance.option('zoomLevel', {
            value: 1.5,
            items: [1, 1.5]
          });
          assert.equal(this.instance._diagramInstance.settings.zoomLevel, 1.5);
        ...
        test('should sync pageSize property', function(assert) {
          ...
          assert.equal(this.onOptionChanged.getCalls().length, 2);
          this.instance._diagramInstance.commandManager.getCommand(DiagramCommand.PageSize).execute({
            width: 4,
            height: 6
          });
          assert.equal(this.instance.option('pageSize.width'), 4);
          assert.equal(this.instance.option('pageSize.height'), 6);
          assert.equal(this.onOptionChanged.getCalls().length, 3);
        });
        ...
        test('should change pageColor property', function(assert) {
          assert.equal(this.instance._diagramInstance.model.pageColor, -1);
          this.instance.option('pageColor', 'red');
          assert.equal(this.instance._diagramInstance.model.pageColor, -65536);
        ...
        test('should change data expression options', function(assert) {
          ...
          assert.equal(this.instance._diagramInstance.documentDataSource.nodeDataImporter.getChildren, undefined);
          assert.equal(this.instance._diagramInstance.documentDataSource.nodeDataImporter.setChildren, undefined);
          this.instance.option('nodes.containerChildrenExpr', 'children');
        ...
        test('should change customShapes option', function(assert) {
          var descriptions = this.instance._diagramInstance.shapeDescriptionManager.descriptions;
          ...
          this.instance.option('customShapes', [{
            ...
            template: function(container, item) {},
            toolboxTemplate: function(container, item) {},
            templateLeft: 0,
            templateTop: 0,
            templateWidth: 1,
            templateHeight: 1,
          ...
          var description = descriptions[keys[keys.length - 1]];
      ...
      QUnit.module('Options (initially set)', {
        ...
        test('should has non-default options', function(assert) {
          ...
          assert.equal(instance._diagramInstance.model.pageColor, -65536);
        ...
        test('should not change model options if readOnly=true', function(assert) {
          ...
          assert.equal(instance._diagramInstance.model.pageColor, -1);
