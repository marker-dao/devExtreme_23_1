...
(["testing/tests/DevExpress.ui.widgets/diagramParts/historyToolbar.tests.js"], ["jquery","ui/diagram","../../../helpers/diagramHelpers.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/diagramParts/historyToolbar.tests.js", ["jquery", "ui/diagram", "../../../helpers/diagramHelpers.js"], function($__export) {
  "use strict";
  var $,
      test,
      Consts,
      getHistoryToolbarInstance,
      moduleConfig;
  return {
    setters: [function($__m) {
      ...
      Consts = $__m.Consts;
      getHistoryToolbarInstance = $__m.getHistoryToolbarInstance;
    }],
    execute: function() {
      var $__2;
      ...
      QUnit.module('History Toolbar', {
        ...
        test('should fill toolbar with default items', function(assert) {
          var toolbar = getHistoryToolbarInstance(this.$element);
...
//# sourceMappingURL=historyToolbar.tests.js.map