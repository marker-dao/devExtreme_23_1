...
(["testing/tests/DevExpress.ui.widgets/diagramParts/contextToolbox.tests.js"], ["jquery","ui/diagram","../../../helpers/diagramHelpers.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/diagramParts/contextToolbox.tests.js", ["jquery", "ui/diagram", "../../../helpers/diagramHelpers.js"], function($__export) {
  "use strict";
  var $,
      test,
      Consts,
    ...
    execute: function() {
      ...
      QUnit.module('Context Toolbox', {
        ...
        test('should not render if contextToolbox.enabled is false', function(assert) {
          var $contextToolbox = this.$element.find(Consts.CONTEXT_TOOLBOX_SELECTOR);
        ...
        test('should set contextToolbox width', function(assert) {
          var $contextToolbox = $('#qunit-fixture').find(Consts.CONTEXT_TOOLBOX_CONTENT_SELECTOR);
          assert.equal($contextToolbox.length, 0);
          this.instance._contextToolbox._show(0, 0, 0, 'general', function() {});
...
//# sourceMappingURL=contextToolbox.tests.js.map