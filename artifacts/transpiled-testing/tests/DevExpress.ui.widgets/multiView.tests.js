...
(["testing/tests/DevExpress.ui.widgets/multiView.tests.js"], ["animation/fx","animation/translator","generic_light.css!","core/config","core/devices","core/utils/type","events/gesture/swipeable","events/visibility_change","jquery","ui/multi_view","ui/multi_view/ui.multi_view.animation","../../helpers/keyboardMock.js","../../helpers/pointerMock.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/multiView.tests.js", ["animation/fx", "animation/translator", "generic_light.css!", "core/config", "core/devices", "core/utils/type", "events/gesture/swipeable", "events/visibility_change", "jquery", "ui/multi_view", "ui/multi_view/ui.multi_view.animation", "../../helpers/keyboardMock.js", "../../helpers/pointerMock.js"], function($__export) {
  "use strict";
  var fx,
      translator,
      config,
  ...
  return {
    ...
    execute: function() {
      ...
      mockFxAnimate = function(animations, type, output, startAction) {
      ...
      animationCapturing = {
        start: function(animationStartAction) {
      ...
      QUnit.module('nested multiview', function() {
        ...
        QUnit.test('pointerdown should not affect to parent multiview (T306118)', function(assert) {
          ...
          var outerMultiView = $multiView.dxMultiView('instance');
          var $outerItemElements = $multiView.dxMultiView('itemElements');
          var $outerFirstItem = $outerItemElements.eq(0);
          var $innerMultiView = $outerFirstItem.find('.' + MULTIVIEW_CLASS);
          var $innerSecondItem = $innerMultiView.dxMultiView('itemElements').get(1);
      ...
      QUnit.module('interaction via swipe', {
        ...
        QUnit.test('item container should not be moved by swipe if items count less then 2', function(assert) {
          var $multiView = $('#multiView').dxMultiView({items: [1]});
        ...
        QUnit.test('widget shouldn\'t handle dxswipe events if swipeEnabled is false', function(assert) {
          ...
          var multiView = $('#multiView').dxMultiView('instance');
          var pointer = pointerMock($multiView);
        ...
        QUnit.test('item container should be moved by swipe', function(assert) {
          var $multiView = $('#multiView').dxMultiView({items: [1, 2, 3]});
          var $itemContainer = $multiView.find(toSelector(MULTIVIEW_ITEM_CONTAINER_CLASS));
          var pointer = pointerMock($multiView);
      ...
      QUnit.module('loop', {
        ...
        QUnit.test('second item should have correct position if swipe present at first one', function(assert) {
          ...
          var $item1 = $multiView.find(toSelector(MULTIVIEW_ITEM_CLASS)).eq(1);
          var pointer = pointerMock($multiView);
      ...
      QUnit.module('defer rendering', {
        beforeEach: function() {
          ...
          this.items = [{text: 'Greg'}, {text: '31'}, {text: 'Charlotte'}, {text: 'programmer'}];
        ...
        QUnit.test('onItemRendered should be fired after item was rendered', function(assert) {
          ...
          var instance = $element.dxMultiView('instance');
      ...
      QUnit.module('keyboard navigation', {
        ...
        QUnit.test('selected item should have focus after swipe', function(assert) {
          ...
          var multiView = $multiView.dxMultiView('instance');
          var $item1 = $(multiView.itemElements()).eq(1);
      ...
      QUnit.module('aria accessibility', {
        ...
        QUnit.test('selected item should have unique id', function(assert) {
          ...
          var id = instance.getFocusedItemId().toString();
          var $item0 = $multiView.find('.dx-multiview-item:eq(0)');
          var $item1 = $multiView.find('.dx-multiview-item:eq(1)');
          $multiView.focusin();
      ...
      QUnit.module('swipeable disabled state', function() {
        QUnit.test('{items: [], swipeEnabled: false}', function(assert) {
          ...
          var multiView = $multiView.dxMultiView('instance');
          var swipeable = Swipeable.getInstance($multiView);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["animation/fx","animation/translator","generic_light.css!","core/config","core/devices","core/utils/type","events/gesture/swipeable","events/visibility_change","jquery","ui/multi_view","ui/multi_view/ui.multi_view.animation","../../helpers/keyboardMock.js","../../helpers/pointerMock.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("animation/fx"), require("animation/translator"), require("generic_light.css!"), require("core/config"), require("core/devices"), require("core/utils/type"), require("events/gesture/swipeable"), require("events/visibility_change"), require("jquery"), require("ui/multi_view"), require("ui/multi_view/ui.multi_view.animation"), require("../../helpers/keyboardMock.js"), require("../../helpers/pointerMock.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=multiView.tests.js.map