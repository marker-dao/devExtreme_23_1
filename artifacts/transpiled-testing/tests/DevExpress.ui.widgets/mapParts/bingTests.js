...
(["testing/tests/DevExpress.ui.widgets/mapParts/bingTests.js"], ["jquery","./utils.js","ui/map/provider.dynamic.bing","../../../helpers/ajaxMock.js","ui/widget/ui.errors","ui/map"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/mapParts/bingTests.js", ["jquery", "./utils.js", "ui/map/provider.dynamic.bing", "../../../helpers/ajaxMock.js", "ui/widget/ui.errors", "ui/map"], function($__export) {
  "use strict";
  var $,
      testing,
      BingProvider,
  ...
  return {
    ...
    execute: function() {
      ...
      prepareTestingBingProvider = function(abortDirectionsUpdate) {
      ...
      QUnit.test('add route should extend bounds', function(assert) {
        ...
        var $map = $('#map').dxMap({
          ...
          routes: [ROUTES[0]],
          onReady: function() {
            points.push(new Microsoft.Maps.Location(ROUTES[0].locations[0][0], ROUTES[0].locations[0][1]), new Microsoft.Maps.Location(ROUTES[0].locations[2][0], ROUTES[0].locations[2][1]), new Microsoft.Maps.Location(ROUTES[1].locations[0].lat, ROUTES[1].locations[0].lng), new Microsoft.Maps.Location(ROUTES[1].locations[2][0], ROUTES[1].locations[2][1]));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","./utils.js","ui/map/provider.dynamic.bing","../../../helpers/ajaxMock.js","ui/widget/ui.errors","ui/map"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("./utils.js"), require("ui/map/provider.dynamic.bing"), require("../../../helpers/ajaxMock.js"), require("ui/widget/ui.errors"), require("ui/map"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=bingTests.js.map