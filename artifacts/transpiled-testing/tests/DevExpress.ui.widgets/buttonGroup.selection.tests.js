...
(["testing/tests/DevExpress.ui.widgets/buttonGroup.selection.tests.js"], ["jquery","ui/button","ui/button_group","events/core/events_engine","generic_light.css!"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/buttonGroup.selection.tests.js", ["jquery", "ui/button", "ui/button_group", "events/core/events_engine", "generic_light.css!"], function($__export) {
  "use strict";
  var $,
      eventsEngine,
      BUTTON_GROUP_CLASS,
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module(("Selection for items: " + JSON.stringify(items) + ", "), function() {
        var ButtonGroupSelectionTestHelper = function() {
          function ButtonGroupSelectionTestHelper(onInitialOption, selectionMode) {
            this.selectionChangedHandler = sinon.spy();
            this.onInitialOption = onInitialOption;
            this.selectionMode = selectionMode;
          }
          return ($traceurRuntime.createClass)(ButtonGroupSelectionTestHelper, {
            createButtonGroup: function(options) {
              ...
              if (this.onInitialOption) {
                ...
                if (options.keyExpr)
                  this.buttonGroup.option('keyExpr', options.keyExpr);
                if (options.selectedItemKeys)
                  this.buttonGroup.option('selectedItemKeys', options.selectedItemKeys);
                if (options.selectedItems)
                  this.buttonGroup.option('selectedItems', options.selectedItems);
              }
            },
            resetSelectedChangedSpy: function() {
              this.selectionChangedHandler.reset();
            },
            _getButtonGroupItem: function(index) {
              return this.buttonGroup.$element().find(("." + BUTTON_GROUP_ITEM_CLASS)).eq(index);
            },
            triggerButtonClick: function(itemIndex) {
              eventsEngine.trigger(this._getButtonGroupItem(itemIndex), 'dxclick');
            },
            checkAsserts: function(options) {
              if (options.selectedItems) {
            ...
            checkSelectedItems: function(selectedIndexes) {
              var $buttons = this.buttonGroup.$element().find(("." + BUTTON_GROUP_ITEM_CLASS));
        ...
        ['single', 'multiple'].forEach(function(selectionMode) {
          var config = (" ,selectionMode=" + selectionMode);
          [true, false].forEach(function(onInitialOption) {
            ['selectedItems', 'selectedItemKeys'].forEach(function(selectedOption) {
              config = (", onInitial=" + onInitialOption + ", selectionMode=" + selectionMode);
              [null, undefined, []].forEach(function(selectedOptionValue) {
                QUnit.test((selectedOption + ": " + selectedOptionValue) + config, function() {
                  var helper = new ButtonGroupSelectionTestHelper(onInitialOption, selectionMode);
              ...
              QUnit.test((selectedOption + ": ['btn1']") + config, function() {
                ...
                helper.checkAsserts({
                  selectionChanged: onInitialOption ? null : {
                    addedItems: [items[0]],
                    removedItems: []
                  },
                  selectedItems: [items[0]],
      ...
      QUnit.module('selectionMode', function() {
        ...
        QUnit.test('selectionMode=multiple -> clickByItem1, clickByItem2, clickByItem3 -> getSelectedKeys', function(assert) {
          ...
          var clickByButton = function(button) {
            return $(buttonGroup.$element().find('[aria-label="' + button + '"]')).trigger('dxclick');
          };
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/button","ui/button_group","events/core/events_engine","generic_light.css!"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/button"), require("ui/button_group"), require("events/core/events_engine"), require("generic_light.css!"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=buttonGroup.selection.tests.js.map