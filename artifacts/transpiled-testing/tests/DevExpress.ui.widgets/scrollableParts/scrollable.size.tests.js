...
(["testing/tests/DevExpress.ui.widgets/scrollableParts/scrollable.size.tests.js"], ["jquery","../../../helpers/scrollableTestsHelper.js","ui/scroll_view/ui.scrollable","ui/box","ui/responsive_box","generic_light.css!"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/scrollableParts/scrollable.size.tests.js", ["jquery", "../../../helpers/scrollableTestsHelper.js", "ui/scroll_view/ui.scrollable", "ui/box", "ui/responsive_box", "generic_light.css!"], function($__export) {
  "use strict";
  var $,
  ...
  function appendScrollableTo(appendTo, id, nestedElementWidth, nestedElementHeight, useNativeScrolling, width, height) {
    var $scrollable = $(("<div id=\"" + id + "\"></div>")).css('background-color', 'orange').append($('<div>').css({
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module('Size of one scrollable standalone/inside Box/inside ResponsiveBox', {
        ...
        [false, true].forEach(function(useNativeScrolling) {
          [PLACEMENT_STANDALONE, PLACEMENT_INSIDE_BOX, PLACEMENT_INSIDE_RESPONSIVE_BOX].forEach(function(placement) {
            var testContext = ("[useNativeScroller: " + useNativeScrolling + ", placement: " + placement + "]");
            function appendOneScrollable($appendTo, $__3) {
              var $__4 = $__3,
                  id = $__4.id,
                  width = $__4.width,
                  height = $__4.height,
                  nestedElementWidth = $__4.nestedElementWidth,
                  nestedElementHeight = $__4.nestedElementHeight;
      ...
      QUnit.module('Size of two scrollables inside Box/Responsive', {
        ...
        [false, true].forEach(function(useNativeScrolling) {
          [PLACEMENT_INSIDE_BOX, PLACEMENT_INSIDE_RESPONSIVE_BOX].forEach(function(placement) {
            ...
            var testContext = ("[useNativeScrolling: " + useNativeScrolling + ", placement: " + placement + "]");
            ...
            QUnit.test('no content overflow - 2 scrollable in row, ' + testContext, function(assert) {
              ...
              [0, 1].forEach(function(index) {
                return checkScrollableSizes(assert, $__2.$container, {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../../helpers/scrollableTestsHelper.js","ui/scroll_view/ui.scrollable","ui/box","ui/responsive_box","generic_light.css!"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../../helpers/scrollableTestsHelper.js"), require("ui/scroll_view/ui.scrollable"), require("ui/box"), require("ui/responsive_box"), require("generic_light.css!"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=scrollable.size.tests.js.map