...
(["testing/tests/DevExpress.ui.widgets/scrollableParts/scrollable.mouseWheel.tests.js"], ["jquery","animation/frame","core/devices","../../../helpers/pointerMock.js","generic_light.css!","./scrollable.constants.js","core/utils/window"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/scrollableParts/scrollable.mouseWheel.tests.js", ["jquery", "animation/frame", "core/devices", "../../../helpers/pointerMock.js", "generic_light.css!", "./scrollable.constants.js", "core/utils/window"], function($__export) {
  "use strict";
  var $,
      animationFrame,
      devices,
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.test('mousewheel for vertical direction', function(assert) {
        ...
        pointerMock($container).start().wheel(-distance);
      ...
      QUnit.test('preventDefault should be called on immediate mousewheel at the end of content', function(assert) {
        ...
        var scrollable = $scrollable.dxScrollable('instance');
        var $container = $scrollable.find('.' + SCROLLABLE_CONTAINER_CLASS);
        var pointer = pointerMock($container).start().wheel(-50);
        pointer.wheel(-50);
      ...
      QUnit.test('mousewheel scrolls correctly when mouse is located over scrollbar', function(assert) {
        ...
        pointerMock($scrollbar).start().wheel(-distance);
        assert.equal(scrollable.scrollOffset().top, distance, 'scrolled vertically');
      });
      QUnit.test('mousewheel for horizontal direction', function(assert) {
        ...
        var scrollable = $scrollable.dxScrollable('instance');
        var $container = $scrollable.find('.' + SCROLLABLE_CONTAINER_CLASS);
        pointerMock($container).start().wheel(-distance, {shiftKey: true});
      ...
      QUnit.test('mousewheel triggers scroll event on container', function(assert) {
        ...
        pointerMock($container).start().down().move(-9, -10);
      ...
      if (devices.current().deviceType === 'desktop') {
        ['vertical', 'horizontal'].forEach(function(direction) {
          var ValidateMouseWheelEventTestHelper = function() {
            function ValidateMouseWheelEventTestHelper(direction, useNative) {
            ...
            return ($traceurRuntime.createClass)(ValidateMouseWheelEventTestHelper, {
              ...
              triggerWheelEvent: function(delta) {
                var pointer = pointerMock(this.getScrollableContainer());
                pointer.start();
              ...
              checkScrollOffset: function(delta, zoom) {
                var expectedOffset = {
                  top: 25,
                  left: 25
                };
          ...
          QUnit.test(("validate() mousewheel (top, left), direction:" + direction), function(assert) {
            var helper = new ValidateMouseWheelEventTestHelper(direction, true);
          ...
          [-10, 10].forEach(function(wheelDelta) {
            [1, 0.75, 1.5].forEach(function(browserZoom) {
              QUnit.test(("WheelDelta -> browser.zoom: " + browserZoom + ", direction: " + direction + ", wheelDelta: " + wheelDelta), function() {
                var helper = new ValidateMouseWheelEventTestHelper(direction, false);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","animation/frame","core/devices","../../../helpers/pointerMock.js","generic_light.css!","./scrollable.constants.js","core/utils/window"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("animation/frame"), require("core/devices"), require("../../../helpers/pointerMock.js"), require("generic_light.css!"), require("./scrollable.constants.js"), require("core/utils/window"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=scrollable.mouseWheel.tests.js.map