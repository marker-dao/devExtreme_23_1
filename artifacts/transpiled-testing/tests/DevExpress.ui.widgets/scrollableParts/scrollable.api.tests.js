...
(["testing/tests/DevExpress.ui.widgets/scrollableParts/scrollable.api.tests.js"], ["jquery","renovation/ui/scroll_view/utils/get_translate_values","renovation/ui/scroll_view/utils/get_element_style","renovation/ui/scroll_view/utils/get_scrollbar_size","core/utils/resize_callbacks","core/config","../../../helpers/pointerMock.js","core/utils/type","core/utils/browser","ui/scroll_view/ui.scrollable","generic_light.css!","./scrollable.constants.js","renovation/ui/scroll_view/common/consts.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/scrollableParts/scrollable.api.tests.js", ["jquery", "renovation/ui/scroll_view/utils/get_translate_values", "renovation/ui/scroll_view/utils/get_element_style", "renovation/ui/scroll_view/utils/get_scrollbar_size", "core/utils/resize_callbacks", "core/config", "../../../helpers/pointerMock.js", "core/utils/type", "core/utils/browser", "ui/scroll_view/ui.scrollable", "generic_light.css!", "./scrollable.constants.js", "renovation/ui/scroll_view/common/consts.js"], function($__export) {
  "use strict";
  var $,
      getTranslateValues,
      getElementOverflowY,
  ...
  return {
    setters: [function($__m) {
      ...
      getElementOverflowY = $__m.getElementOverflowY;
      getElementOverflowX = $__m.getElementOverflowX;
    }, function($__m) {
      getScrollbarSize = $__m.getScrollbarSize;
    }, function($__m) {
      ...
      DIRECTION_HORIZONTAL = $__m.DIRECTION_HORIZONTAL;
      DIRECTION_VERTICAL = $__m.DIRECTION_VERTICAL;
      DIRECTION_BOTH = $__m.DIRECTION_BOTH;
    ...
    execute: function() {
      ...
      [true, false].forEach(function(useNative) {
        QUnit.test('Check that widget is renovated or not', function(assert) {
          var scrollable = $('#scrollable').dxScrollable({useNative: useNative}).dxScrollable('instance');
      ...
      QUnit.test('update', function(assert) {
        ...
        var $scrollableChild = $scrollable.find('div');
      ...
      [true, false].forEach(function(useNative) {
        QUnit.test(("content(), useNative: " + useNative), function(assert) {
          var $scrollable = $('#scrollable').dxScrollable({useNative: useNative});
        ...
        QUnit.test(("container(), useNative: " + useNative), function(assert) {
          var $scrollable = $('#scrollable').dxScrollable({useNative: useNative});
          var container = $scrollable.dxScrollable('instance').container();
      ...
      QUnit.test('scrollOffset', function(assert) {
        ...
        var $content = $scrollable.find(("." + SCROLLABLE_CONTENT_CLASS));
        pointerMock($content).start().down().move(0, -10);
        assert.deepEqual($scrollable.dxScrollable('scrollOffset'), {
          top: 10,
          left: 0
      ...
      QUnit.test('scrollLeft', function(assert) {
        ...
        var $content = $scrollable.find(("." + SCROLLABLE_CONTENT_CLASS));
        pointerMock($content).start().down().move(-10, 0);
      ...
      QUnit.test('event arguments', function(assert) {
        var $scrollable = $('#scrollable').dxScrollable({
          ...
          onScroll: function(e) {
            ...
            assert.deepEqual(e.scrollOffset, {
              top: 10,
              left: isRenovatedScrollable ? 0 : undefined
            }, 'scrollOffset passed');
      ...
      QUnit.test('simulated strategy should subscribe to the poiner events after disabled option changed', function(assert) {
        var $scrollable = $('#scrollable');
        var scrollableInstance = $('#scrollable').dxScrollable({
          useNative: false,
          showScrollbar: 'onHover',
          disabled: true
        }).dxScrollable('instance');
        scrollableInstance.option('disabled', false);
        var $scroll = $scrollable.find(("." + SCROLLABLE_SCROLLBAR_CLASS + " .dx-scrollable-scroll"));
        var $container = $scrollable.find('.' + SCROLLABLE_CONTAINER_CLASS);
      ...
      QUnit.test('switching useNative to false turns off native scrolling', function(assert) {
        var scrollable = $('#scrollable').dxScrollable({useNative: true}).dxScrollable('instance');
        var containerEl = $(scrollable.container()).get(0);
      ...
      QUnit.test('event handlers should be reattached after changing to simulated strategy ', function(assert) {
        if (QUnit.urlParams['nojquery']) {
          ...
          var scrollable = $scrollable.dxScrollable('instance');
          var wrapperEl = $scrollable.find(("." + SCROLLABLE_WRAPPER_CLASS)).get(0);
          var eventListeners = Object.values($._data(wrapperEl).events || {});
      ...
      QUnit.test('scrollToElement', function(assert) {
        ...
        $scrollable.dxScrollable({direction: DIRECTION_VERTICAL});
        var scrollable = $scrollable.dxScrollable('instance');
      ...
      QUnit.test('getScrollElementPosition', function(assert) {
        ...
        $scrollable.dxScrollable({direction: DIRECTION_VERTICAL});
        var scrollable = $scrollable.dxScrollable('instance');
        var position = scrollable.getScrollElementPosition($item, DIRECTION_VERTICAL);
      ...
      QUnit.test('scrollToElement with offset', function(assert) {
        ...
        var scrollable = $scrollable.dxScrollable({direction: DIRECTION_VERTICAL}).dxScrollable('instance');
      ...
      QUnit.test('scrollToElement scrolls in both directions', function(assert) {
        ...
        var scrollable = $scrollable.dxScrollable({direction: 'both'}).dxScrollable('instance');
        scrollable.scrollToElement($item);
      ...
      [true, false].forEach(function(useNative) {
        [DIRECTION_HORIZONTAL, DIRECTION_VERTICAL, DIRECTION_BOTH].forEach(function(direction) {
          var scrollToValue = 40;
          ...
          QUnit.test(("scrollTo(" + JSON.stringify(scrollToValue) + "), update scrollOffset value after resize, useNative: " + useNative + ", dir: " + direction), function(assert) {
            ...
            var $scrollable = $('#scrollable').width(containerSize).height(containerSize);
            ...
            var expectedTopOffsetValue = direction !== DIRECTION_HORIZONTAL ? 40 : 0;
            var expectedLeftOffsetValue = direction !== DIRECTION_VERTICAL ? 40 : 0;
      ...
      ScrollableTestHelper = function() {
        function ScrollableTestHelper(options) {
          var $__3 = options,
              useNative = $__3.useNative,
              direction = $__3.direction,
              useSimulatedScrollbar = $__3.useSimulatedScrollbar,
              rtlEnabled = $__3.rtlEnabled;
        ...
        return ($traceurRuntime.createClass)(ScrollableTestHelper, {
          ...
          getMaxScrollOffset: function() {
            ...
            var maxVerticalOffset = containerElement.scrollHeight - containerElement.clientHeight;
            var maxHorizontalOffset = containerElement.scrollWidth - containerElement.clientWidth;
            return {
              vertical: maxVerticalOffset,
              horizontal: maxHorizontalOffset
            };
          },
          getScrollbarSize: function(direction) {
            return getScrollbarSize(this.$container.get(0), direction);
          },
          checkScrollEvent: function(options) {
            var scrollArguments = this.onScrollHandler.lastCall.args[0];
          ...
          checkScrollTranslateValues: function($__3) {
            var $__4 = $__3,
                vertical = $__4.vertical,
                horizontal = $__4.horizontal;
            var $__2 = this;
            if (!this._useNative || (this._useNative && this._useSimulatedScrollbar)) {
              var checkTranslateValues = function($__5) {
                var $__6 = $__5,
                    vertical = $__6.vertical,
                    horizontal = $__6.horizontal;
                if ($__2._direction === DIRECTION_VERTICAL || $__2._direction === 'both') {
                  var $scroll = $__2.$scrollable.find(("." + SCROLLBAR_VERTICAL_CLASS + " ." + SCROLLABLE_SCROLL_CLASS));
                  var $__7 = getTranslateValues($scroll.get(0)),
                      left = $__7.left,
                      top = $__7.top;
                  QUnit.assert.strictEqual(left, 0, 'translate left');
                  QUnit.assert.roughEqual(top, vertical, 1.001, 'translate top');
                }
                if ($__2._direction === DIRECTION_HORIZONTAL || $__2._direction === 'both') {
                  var $scroll$__9 = $__2.$scrollable.find(("." + SCROLLBAR_HORIZONTAL_CLASS + " ." + SCROLLABLE_SCROLL_CLASS));
                  var $__8 = getTranslateValues($scroll$__9.get(0)),
                      left$__10 = $__8.left,
                      top$__11 = $__8.top;
                  QUnit.assert.roughEqual(left$__10, horizontal, 1.001, 'translate left');
                  QUnit.assert.strictEqual(top$__11, 0, 'translate top');
                }
              };
              ...
              checkTranslateValues({
                vertical: vertical,
                horizontal: horizontal
              });
            }
          },
          checkScrollOffset: function($__3, message) {
            var $__5;
            var $__4 = $__3,
                left = $__4.left,
                top = $__4.top,
                maxScrollOffset = $__4.maxScrollOffset,
                epsilon = ($__5 = $__4.epsilon) === void 0 ? 0.001 : $__5;
            var scrollOffset = getScrollOffset(this.$scrollable);
            QUnit.assert.roughEqual(this.getMaxScrollOffset().horizontal, maxScrollOffset, epsilon, 'horizontal maxScrollOffset');
            var expectedScrollOffsetLeft = left;
      ...
      [true, false].forEach(function(useNative) {
        [true, false].forEach(function(useSimulatedScrollbar) {
          QUnit.module(("ScrollToElement, native: " + useNative + ", useSimulateScrollbar: " + useSimulatedScrollbar), moduleConfig, function() {
            ...
            [DIRECTION_VERTICAL, DIRECTION_HORIZONTAL, 'both'].forEach(function(direction) {
              QUnit.test(("Scroll from top to bottom, direction: " + direction + ", rtlEnabled: false"), function() {
                setInitialState();
                var helper = new ScrollableTestHelper({
                  direction: direction,
                  useNative: useNative,
                  useSimulatedScrollbar: useSimulatedScrollbar,
                  rtlEnabled: false
                });
                var $element = $('#element').css({top: elementOffset.top});
                helper.scrollable.scrollToElement($element);
                helper.scrollable.update();
                var expectedTopOffset = direction !== DIRECTION_HORIZONTAL ? helper.$container.get(0).offsetHeight + elementHeight + helper.getScrollbarSize(DIRECTION_HORIZONTAL) : 0;
                helper.checkScrollOffset({
                  left: 0,
                  top: expectedTopOffset,
                  maxScrollOffset: helper.getMaxScrollOffset().horizontal
                });
              ...
              QUnit.test(("Scroll from left to right, direction: " + direction + ", rtlEnabled: false"), function() {
                ...
                var $element = $('#element').css({left: elementOffset.left});
                helper.scrollable.scrollToElement($element);
                helper.scrollable.update();
                var expectedLeftOffset = direction !== DIRECTION_VERTICAL ? helper.$container.get(0).offsetWidth + elementWidth + helper.getScrollbarSize(DIRECTION_VERTICAL) : 0;
                helper.checkScrollOffset({
              ...
              QUnit.test(("Scroll from bottom to top, direction: " + direction + ", rtlEnabled: false"), function() {
                ...
                helper.scrollable.scrollToElement($element);
                helper.scrollable.update();
                var expectedTopOffset = direction !== DIRECTION_HORIZONTAL ? elementOffset.top : 0;
                helper.checkScrollOffset({
                  left: 0,
                  top: expectedTopOffset,
                  maxScrollOffset: helper.getMaxScrollOffset().horizontal
              ...
              QUnit.test(("Scroll from right to left, direction: " + direction + ", rtlEnabled: false"), function() {
                ...
                helper.scrollable.scrollToElement($element);
                helper.scrollable.update();
                var expectedLeftOffset = direction !== DIRECTION_VERTICAL ? elementOffset.left : 0;
                helper.checkScrollOffset({
                  left: expectedLeftOffset,
                  top: 0,
                  maxScrollOffset: helper.getMaxScrollOffset().horizontal
              ...
              QUnit.test(("Scroll from right-bottom to left-top, direction: " + direction + ", rtlEnabled: false"), function() {
                ...
                helper.scrollable.scrollTo({
                  top: helper.getMaxScrollOffset().vertical,
                  left: helper.getMaxScrollOffset().horizontal
                });
                helper.scrollable.update();
                helper.scrollable.scrollToElement($element);
                helper.scrollable.update();
            ...
            QUnit.test(("Scroll from left to right, bottom border on scrollbar, useNative: " + useNative + ", useSimulatedScrollbar: " + useSimulatedScrollbar + ", direction: both, rtlEnabled: false"), function() {
              ...
              helper.scrollable.scrollToElement($element);
              helper.scrollable.update();
              var expectedLeftOffset = helper.$container.get(0).offsetWidth + elementWidth + helper.getScrollbarSize(DIRECTION_VERTICAL);
              var expectedTopOffset = helper.$container.get(0).offsetHeight + elementHeight + helper.getScrollbarSize(DIRECTION_HORIZONTAL);
              helper.checkScrollOffset({
                left: expectedLeftOffset,
                top: expectedTopOffset,
                maxScrollOffset: helper.getMaxScrollOffset().horizontal
          ...
          QUnit.module(("ScrollPosition after update(), native: " + useNative), moduleConfig, function() {
            ...
            QUnit.test(("direction: horizontal, useNative: " + useNative + ", useSimulatedScrollbar: " + useSimulatedScrollbar + ", rtl: true -> change content size"), function() {
              ...
              helper.$scrollable.find('.content1').css('width', '200px');
              helper.checkScrollOffset({
                left: useNative ? 150 : 50,
                top: 0,
                maxScrollOffset: 150
              });
              helper.checkScrollTranslateValues({
                vertical: 0,
                horizontal: !useNative ? 25 : 35
              });
              helper.scrollable.update();
              helper.checkScrollOffset({
                left: useNative || isRenovatedScrollable ? 150 : 50,
                top: 0,
                maxScrollOffset: 150
              });
              helper.checkScrollTranslateValues({
                vertical: 0,
                horizontal: !useNative && !isRenovatedScrollable ? 12 : 35
              });
            });
          });
          QUnit.module(("ScrollPosition after resize, rtl: true, useNative: " + useNative), {beforeEach: function() {
              var markup = "\n                    <style nonce=\"qunit-test\">\n                        #scrollable {\n                            height: 50px;\n                            width: 50px;\n                        }\n                        #scrollable .content1 {\n                            height: 100px;\n                            width: 100px;\n                        }\n                    </style>\n                    <div id=\"scrollable\">\n                        <div class=\"content1\"></div>\n                        <div class=\"content2\"></div>\n                    </div>";
              $('#qunit-fixture').html(markup);
            }}, function() {
            [0, 10, 20].forEach(function(scrollRight) {
              QUnit.test(("Direction: horizontal, useSimulatedScrollbar: " + useSimulatedScrollbar + ", initialScrollPosition(Right - " + scrollRight + "), css.zoomIn -> css.zoomOut"), function() {
                ...
                var maxOffset = helper.getMaxScrollOffset();
                helper.scrollable.scrollTo({left: maxOffset.horizontal - scrollRight});
                helper.scrollable.update();
                [1, 1.1, 1].forEach(function(zoomLevel) {
                  helper.scrollable._getWindowDevicePixelRatio = function() {
                    return zoomLevel;
                  };
        ...
        QUnit.module(("Scroll arguments, native: " + useNative), moduleConfig, function() {
          QUnit.test('Direction: vertical, rtl: false, scrollPosition: { top: 0 } -> { top: 1 } -> { top: center } -> { top: max-1 } -> { top: max }', function() {
            ...
            helper.checkScrollEvent({
              reachedTop: true,
              reachedBottom: false,
              reachedLeft: undefined,
              reachedRight: undefined
            });
          ...
          QUnit.test('Direction: both, rtl: false, scrollPosition: { top: 0, left: 0 } -> { top:1, left: 1 } -> { top: center, left: center } -> { top: max-1, left: max-1 } -> { top: max, left: max }', function() {
            ...
            helper.onScrollHandler.reset();
            helper.scrollable.scrollTo({
              top: maxOffset.vertical - 1,
              left: maxOffset.horizontal - 1
            });
            helper.$container.trigger('scroll');
            helper.checkScrollEvent({
              reachedTop: false,
            ...
            helper.onScrollHandler.reset();
            helper.scrollable.scrollTo({
              top: maxOffset.vertical,
              left: maxOffset.horizontal
            });
            helper.$container.trigger('scroll');
            helper.checkScrollEvent({
              reachedTop: false,
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","renovation/ui/scroll_view/utils/get_translate_values","renovation/ui/scroll_view/utils/get_element_style","renovation/ui/scroll_view/utils/get_scrollbar_size","core/utils/resize_callbacks","core/config","../../../helpers/pointerMock.js","core/utils/type","core/utils/browser","ui/scroll_view/ui.scrollable","generic_light.css!","./scrollable.constants.js","renovation/ui/scroll_view/common/consts.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("renovation/ui/scroll_view/utils/get_translate_values"), require("renovation/ui/scroll_view/utils/get_element_style"), require("renovation/ui/scroll_view/utils/get_scrollbar_size"), require("core/utils/resize_callbacks"), require("core/config"), require("../../../helpers/pointerMock.js"), require("core/utils/type"), require("core/utils/browser"), require("ui/scroll_view/ui.scrollable"), require("generic_light.css!"), require("./scrollable.constants.js"), require("renovation/ui/scroll_view/common/consts.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=scrollable.api.tests.js.map