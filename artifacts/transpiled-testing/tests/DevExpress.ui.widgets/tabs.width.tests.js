...
(["testing/tests/DevExpress.ui.widgets/tabs.width.tests.js"], ["generic_light.css!","events/visibility_change","jquery","ui/tabs","core/utils/shadow_dom"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/tabs.width.tests.js", ["generic_light.css!", "events/visibility_change", "jquery", "ui/tabs", "core/utils/shadow_dom"], function($__export) {
  "use strict";
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module('Width', function() {
        var TabsWidthTestHelper = function() {
          function TabsWidthTestHelper(assert, scrollingEnabled, setWidthApproach) {
          ...
          return ($traceurRuntime.createClass)(TabsWidthTestHelper, {
            _initializeTabs: function(width) {
              this.$tabs.appendTo(this.$container);
              this.tabs = this.$tabs.dxTabs({
                items: [{text: 'text 1'}, {text: 'long text example'}],
            ...
            createStretchedTabs: function() {
              this._initializeTabs(200);
              this.checkStretchedTabs();
            },
            checkStretchedTabs: function() {
            ...
            createNavigationButtonsTabs: function() {
              this._initializeTabs(100);
              this.checkNavigationButtonsTabs();
            },
            checkNavigationButtonsTabs: function() {
        ...
        [true, false, undefined].forEach(function(scrollingEnabled) {
          ['resizeBrowser', 'container', 'option'].forEach(function(setWidthApproach) {
            var config = (", scrollingEnabled=" + scrollingEnabled + ", change " + setWidthApproach + ".width");
            QUnit.test('Show fixed tabs, resize to show stretched tabs' + config, function(assert) {
              var helper = new TabsWidthTestHelper(assert, scrollingEnabled, setWidthApproach);
        ...
        QUnit.test('Does not render navbuttons: dx-tabs{ max-width: 413px; } .dx-tab{ width: 100px; }', function(assert) {
          ...
          $tabs.appendTo($container).dxTabs({
            items: [{text: 'Timeline Day'}, {text: 'Timeline Week'}, {text: 'Timeline Work Week'}, {text: 'Timeline Month'}],
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["generic_light.css!","events/visibility_change","jquery","ui/tabs","core/utils/shadow_dom"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("generic_light.css!"), require("events/visibility_change"), require("jquery"), require("ui/tabs"), require("core/utils/shadow_dom"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=tabs.width.tests.js.map