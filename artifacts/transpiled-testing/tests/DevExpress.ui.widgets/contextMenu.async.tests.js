...
(["testing/tests/DevExpress.ui.widgets/contextMenu.async.tests.js"], ["jquery","ui/context_menu","ui/button","generic_light.css!"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets/contextMenu.async.tests.js", ["jquery", "ui/context_menu", "ui/button", "generic_light.css!"], function($__export) {
  "use strict";
  var $,
      ContextMenu;
  return {
    ...
    execute: function() {
      ...
      QUnit.module('Context menu', function() {
        QUnit.test('Context menu should shown in the same position after repaint()', function(assert) {
          var done = assert.async();
          var menuTargetSelector = '#menuTarget';
          var instance = new ContextMenu($('#simpleMenu'), {
            items: [{text: 'item 1'}],
          ...
          instance.option('onShown', function(e) {
            var position = e.component._overlay.option('position');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/context_menu","ui/button","generic_light.css!"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/context_menu"), require("ui/button"), require("generic_light.css!"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=contextMenu.async.tests.js.map