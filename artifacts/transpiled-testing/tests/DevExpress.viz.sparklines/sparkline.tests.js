...
(["testing/tests/DevExpress.viz.sparklines/sparkline.tests.js"], ["jquery","../../helpers/vizMocks.js","viz/core/tooltip","viz/core/base_widget","viz/core/renderers/renderer","viz/components/data_validator","viz/translators/translator2d","viz/series/base_series","data/data_source/data_source","viz/sparkline"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.sparklines/sparkline.tests.js', ['jquery', '../../helpers/vizMocks.js', 'viz/core/tooltip', 'viz/core/base_widget', 'viz/core/renderers/renderer', 'viz/components/data_validator', 'viz/translators/translator2d', 'viz/series/base_series', 'data/data_source/data_source', 'viz/sparkline'], true, function ($__require, exports, module) {
    ...
    QUnit.begin(function () {
        ...
        QUnit.test('Get bar width when there are two points', function (assert) {
            this.series.getPoints.returns([{ argument: 1, value: 2, correctCoordinates: sinon.spy() }, { argument: 2, value: 3, correctCoordinates: sinon.spy() }]);
        ...
        QUnit.module('Customize points', $.extend({
        ...
        QUnit.test('B239983. Datasource is array with string', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ border: { color: 'red' }, visible: true }, { border: { color: 'green' }, visible: true }, { border: { color: '#666666' }, visible: true }]);
        });
        ...
        QUnit.test('B239983. Datasource is array with object and string', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ border: { color: '#666666' }, visible: true }, { border: { color: 'green' }, visible: true }, { border: { color: 'red' }, visible: true }]);
        });
        ...
        QUnit.test('Get extremum points indexes when datasource is not ordered - B239987', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ border: { color: 'green' }, visible: true }, { border: { color: 'green' }, visible: true }, { border: { color: 'red' }, visible: true }]);
        });
        ...
        QUnit.test('Get extremum points indexes when mode is first last', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ border: { color: '#666666' }, visible: true }, {}, {}, {}, { border: { color: '#666666' }, visible: true }]);
        });
        ...
        QUnit.test('Get extremum points indexes when mode is min max', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ border: { color: '#e8c267' }, visible: true }, {}, {}, { border: { color: '#e55253' }, visible: true }, {}]);
        });
        ...
        QUnit.test('Get extremum points indexes when mode is extremum', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ border: { color: '#e8c267' }, visible: true }, {}, {}, { border: { color: '#e55253' }, visible: true }, { border: { color: '#666666' }, visible: true }]);
        });
        ...
        QUnit.test('Extremum points when mode is firstLast. Custom options. Line, spline, stepline, area, splinearea, steparea', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ border: { color: 'blue' }, visible: true }, {}, {}, { border: { color: 'blue' }, visible: true }]);
        });
        ...
        QUnit.test('Extremum points when mode is firstLast. Default options. Bar, winloss', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ color: '#666666' }, { color: '#a9a9a9' }, { color: '#d7d7d7' }, { color: '#666666' }]);
        });
        ...
        QUnit.test('Extremum points when mode is firstLast. Custom options. Bar, winloss', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ color: 'yellow' }, { color: '#a9a9a9' }, { color: '#d7d7d7' }, { color: 'yellow' }]);
        });
        ...
        QUnit.test('Extremum points when mode is minMax. Bar, winloss', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ color: '#e8c267' }, { color: '#e55253' }, { color: '#a9a9a9' }, { color: '#a9a9a9' }]);
        });
        ...
        QUnit.test('Extremum points when mode is extremum. Line, spline, stepline, area, splinearea, steparea. FirstLast and minMax points are different', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ border: { color: '#666666' }, visible: true }, {}, { border: { color: '#e8c267' }, visible: true }, {}, { border: { color: '#e55253' }, visible: true }, { border: { color: '#666666' }, visible: true }]);
        });
        ...
        QUnit.test('Extremum points when mode is extremum. Line, spline, stepline, area, splinearea, steparea. Three points, min or max point is first or last', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ border: { color: '#666666' }, visible: true }, {}, { border: { color: '#e8c267' }, visible: true }, {}, {}, { border: { color: '#e55253' }, visible: true }]);
        });
        ...
        QUnit.test('Extremum points when mode is extremum. Line, spline, stepline, area, splinearea, steparea. Two min and max points', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ border: { color: '#666666' }, visible: true }, {}, { border: { color: 'red' }, visible: true }, { border: { color: 'red' }, visible: true }, { border: { color: 'green' }, visible: true }, { border: { color: 'green' }, visible: true }, { border: { color: '#666666' }, visible: true }]);
        });
        ...
        QUnit.test('Extremum points when mode is extremum. Bar, winloss. FirstLast and minMax points are different', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ color: 'yellow' }, { color: '#a9a9a9' }, { color: '#e8c267' }, { color: '#a9a9a9' }, { color: '#e55253' }, { color: 'yellow' }]);
        });
        ...
        QUnit.test('Extremum points when mode is extremum. Bar, winloss. Three points, min or max point is first or last', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ color: 'yellow' }, { color: '#a9a9a9' }, { color: '#e8c267' }, { color: '#a9a9a9' }, { color: '#a9a9a9' }, { color: '#e55253' }]);
        });
        ...
        QUnit.test('Extremum points when mode is extremum. Bar, winloss. Two points, minMax points are firstLast', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ color: '#e8c267' }, { color: '#a9a9a9' }, { color: '#a9a9a9' }, { color: '#a9a9a9' }, { color: '#a9a9a9' }, { color: '#e55253' }]);
        });
        ...
        QUnit.test('Extremum points when mode is extremum. Bar. Two min and max points', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ color: 'yellow' }, { color: '#a9a9a9' }, { color: '#e8c267' }, { color: '#e8c267' }, { color: '#e55253' }, { color: '#e55253' }, { color: 'yellow' }]);
        });
        ...
        QUnit.test('Extremum points when mode is none. Bar, winloss', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ color: '#a9a9a9' }, { color: '#a9a9a9' }, { color: '#d7d7d7' }, { color: '#a9a9a9' }]);
        });
        ...
        QUnit.test('Bar points. Default', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ color: '#666666' }, { color: '#a9a9a9' }, { color: '#a9a9a9' }, { color: '#666666' }]);
        });
        ...
        QUnit.test('Bar points. Custom', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ color: 'pink' }, { color: 'yellow' }, { color: 'yellow' }, { color: 'pink' }]);
        });
        ...
        QUnit.test('Winloss points. Custom', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ color: 'pink' }, { color: 'blue' }, { color: 'yellow' }, { color: 'pink' }]);
        });
        ...
        QUnit.test('Several min/max in dataSource', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ visible: true, border: { color: '#666666' } }, { visible: true, border: { color: 'red' } }, { visible: true, border: { color: 'red' } }, { visible: true, border: { color: 'green' } }, { visible: true, border: { color: 'green' } }]);
        });
        ...
        QUnit.test('DataSource contains only equal values', function (assert) {
            ...
            this.checkCustomizePoint(assert, [{ visible: true, border: { color: '#666666' } }, {}, { visible: true, border: { color: '#666666' } }]);
        });
        ...
        QUnit.test('isReady with not loaded dataSource', function (assert) {
            ...
            sinon.stub(data, 'isLoaded').callsFake(function () {
                return false;
            });

            const sparkline = this.createSparkline({ dataSource: data });

            this.renderer.stub('onEndAnimation', function (callback) {
                callback();
            });
            sparkline.render();
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/vizMocks.js","viz/core/tooltip","viz/core/base_widget","viz/core/renderers/renderer","viz/components/data_validator","viz/translators/translator2d","viz/series/base_series","data/data_source/data_source","viz/sparkline"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/vizMocks.js"), require("viz/core/tooltip"), require("viz/core/base_widget"), require("viz/core/renderers/renderer"), require("viz/components/data_validator"), require("viz/translators/translator2d"), require("viz/series/base_series"), require("data/data_source/data_source"), require("viz/sparkline"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=sparkline.tests.js.map