...
(["testing/tests/DevExpress.utils/utils.common.js"], ["core/utils/common"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.utils/utils.common.js", ["core/utils/common"], function($__export) {
  "use strict";
  var pairToObject,
      test,
      module;
    ...
    execute: function() {
      ...
      module('pairToObject', {}, function() {
        ...
        test('result should prevented rounded', function(assert) {
          var result = pairToObject(100.2, true);
