...
(["testing/tests/DevExpress.ui.widgets.editors/validationMessage.tests.js"], ["ui/validation_message","jquery","core/utils/size"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.editors/validationMessage.tests.js", ["ui/validation_message", "jquery", "core/utils/size"], function($__export) {
  "use strict";
  ...
  return {
    ...
    execute: function() {
      ...
      moduleSetup = {
        beforeEach: function() {
          ...
          this.init = function(options) {
            $__4._validationMessage = new ValidationMessage($__4._$validationMessage, options);
          };
          this.reinit = function(options) {
            $__4._validationMessage.dispose();
            $__4.init(options);
          };
      ...
      QUnit.module('options', moduleSetup, function() {
        QUnit.test('should not render if message is empty (T1033883)', function(assert) {
          this.reinit({validationErrors: [{message: ''}]});
        ...
        QUnit.test('should hide if message becomes empty', function(assert) {
          this._validationMessage.option({validationErrors: [{message: ''}]});
          assert.notOk(this._validationMessage.$wrapper().hasClass(INVALID_MESSAGE_CLASS), 'validationMessage is not visible');
        });
        ...
        QUnit.test('maxWidth option should be updated after target option change', function(assert) {
          ...
          var defaultGetOuterWidth = implementationsMap.getOuterWidth;
          implementationsMap.getOuterWidth = function(element, value) {
            if (element === $target) {
              return 120;
            }
            return defaultGetOuterWidth.apply((void 0), $traceurRuntime.spread(arguments));
          };
          try {
        ...
        QUnit.test('position should be recalculated after target option runtime change', function(assert) {
          ...
          try {
            ...
            var messagePositionLeft = this._validationMessage.$content().get(0).getBoundingClientRect().left;
      ...
      QUnit.module('message inner html', moduleSetup, function() {
        ...
        QUnit.test('message html should be rendered correctly when there is one validation error after runtime change', function(assert) {
          var validationErrors = [{message: 'required'}];
        ...
        QUnit.test('message html should be rendered correctly when there are several validation error on init', function(assert) {
          var validationErrors = [{message: 'required'}, {message: 'should be boolean'}];
      ...
      QUnit.module('position', moduleSetup, function() {
        [{
          position: 'top',
          rtlEnabled: false,
          my: 'left bottom',
          ...
          var $__6 = $__5,
              positionSide = $__6.position,
              rtlEnabled = $__6.rtlEnabled,
              at = $__6.at,
              my = $__6.my;
        ...
        QUnit.test('should add position class on positionSide change', function(assert) {
          var positionClass = 'dx-invalid-message-left';
      ...
      QUnit.module('content id', moduleSetup, function() {
        ...
        QUnit.test('validation message should update content id after container option change if contentId is not specified', function(assert) {
          var contentId = 'guid';
          var $container = $('<div>').attr('aria-describedby', contentId).appendTo('#qunit-fixture');
          try {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["ui/validation_message","jquery","core/utils/size"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("ui/validation_message"), require("jquery"), require("core/utils/size"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=validationMessage.tests.js.map