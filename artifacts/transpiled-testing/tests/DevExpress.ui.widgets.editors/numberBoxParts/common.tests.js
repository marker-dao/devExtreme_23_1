...
(["testing/tests/DevExpress.ui.widgets.editors/numberBoxParts/common.tests.js"], ["jquery","ui/number_box/number_box.spin","core/config","core/devices","events/core/events_engine","../../../helpers/keyboardMock.js","../../../helpers/pointerMock.js","events/utils/index","ui/number_box","ui/validator"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.editors/numberBoxParts/common.tests.js", ["jquery", "ui/number_box/number_box.spin", "core/config", "core/devices", "events/core/events_engine", "../../../helpers/keyboardMock.js", "../../../helpers/pointerMock.js", "events/utils/index", "ui/number_box", "ui/validator"], function($__export) {
  "use strict";
  var $,
      SpinButton,
      config,
      ...
      ACTIVE_STATE_CLASS,
      CLEAR_BUTTON_CLASS,
      INVALID_MESSAGE_POPUP_CONTENT_SELECTOR;
  return {
    setters: [function($__m) {
      $ = $__m.default;
    }, function($__m) {
      SpinButton = $__m.default;
    }, function($__m) {
      config = $__m.default;
    }, function($__m) {
      devices = $__m.default;
    ...
    execute: function() {
      ...
      INVALID_MESSAGE_POPUP_CONTENT_SELECTOR = '.dx-invalid-message .dx-overlay-content';
      QUnit.module('basics', {}, function() {
        ...
        QUnit.test('typing value by keyboard update \'value\' option', function(assert) {
          ...
          keyboard.caret(3).type('200').change();
        ...
        QUnit.test('validate \'minus\' char typing', function(assert) {
          ...
          assert.strictEqual(instance.option('value'), 1, 'value is correct');
          instance.option('value', null);
          $input.focus().val('-11').trigger('change');
        ...
        QUnit.test('regression test. Change value used option', function(assert) {
          assert.expect(1);
          var element = $('#numberbox').dxNumberBox({value: 100});
          var instance = element.dxNumberBox('instance');
          var $input = element.find('.' + INPUT_CLASS);
        ...
        QUnit.test('widget\'s width does not increase after buttons hover in FF (T806555)', function(assert) {
          ...
          var $spinButton = $element.find(("." + SPIN_UP_CLASS));
        ...
        QUnit.testInActiveWindow('input is focused when spin buttons are clicked if useLargeSpinButtons = false', function(assert) {
          ...
          var $input = $element.find(("." + INPUT_CLASS));
          var $spinButton = $element.find('.dx-numberbox-spin-up');
        ...
        QUnit.test('spin button should have feedback after click on it', function(assert) {
          ...
          try {
            var $element = $('#numberbox').dxNumberBox({showSpinButtons: true});
            var $spinButton = $element.find('.dx-numberbox-spin-up');
        ...
        QUnit.test('hoverStateEnabled option', function(assert) {
          var $element = $('#numberbox').dxNumberBox({hoverStateEnabled: true});
        ...
        QUnit.test('hoverStateEnabled option for spinButton', function(assert) {
          ...
          var $spinButton = $element.find('.dx-numberbox-spin-button');
        ...
        QUnit.testInActiveWindow('input value is greeter or less after mousewheel action', function(assert) {
          var $numberBox = $('#numberbox').dxNumberBox({value: 100.6});
          var numberBox = $numberBox.dxNumberBox('instance');
          var $numberBoxInput = $numberBox.find(("." + INPUT_CLASS));
          var mouse = pointerMock($numberBoxInput);
        ...
        QUnit.test('mousewheel action should not work in disabled state', function(assert) {
          ...
          var numberBox = $numberBox.dxNumberBox('instance');
          var $numberBoxInput = $(("." + INPUT_CLASS), $numberBox);
          var mouse = pointerMock($numberBoxInput).start();
        ...
        QUnit.test('mousewheel action should not work if widget is not focused', function(assert) {
          var $numberBox = $('#numberbox').dxNumberBox({value: 100});
          var numberBox = $numberBox.dxNumberBox('instance');
          var input = $(("." + INPUT_CLASS), $numberBox).get(0);
        ...
        ['ctrlKey', 'metaKey'].forEach(function(commandKey) {
          QUnit.test(("mousewheel action should not work for zooming (" + commandKey + " pressed)"), function(assert) {
            ...
            var mouse = pointerMock($numberBoxInput).start();
            $numberBoxInput.get(0).focus();
            mouse.wheel(10, ($__3 = {}, Object.defineProperty($__3, commandKey, {
              value: true,
              configurable: true,
              enumerable: true,
              writable: true
        ...
        QUnit.test('correct order of buttons when spin buttons option is set after rendering', function(assert) {
          var $element = $('#numberbox').dxNumberBox({showClearButton: true});
          var instance = $element.dxNumberBox('instance');
        ...
        QUnit.test('clearButton should clear the text even if the value was not changed', function(assert) {
          ...
          kb.type('123');
          var $clearButton = $element.find(("." + CLEAR_BUTTON_CLASS));
        ...
        QUnit.test('clearButton should clear the text and reset incorrect value (T818673)', function(assert) {
          ...
          var kb = keyboardMock($input);
          kb.type('11');
          sinon.stub(instance, '_inputIsInvalid').callsFake(function() {
            return true;
          });
          try {
            var $clearButton = $element.find(("." + CLEAR_BUTTON_CLASS));
        ...
        QUnit.test('T220209 - the \'displayValueFormatter\' option when value is changed using keyboard', function(assert) {
          ...
          keyboardMock($input).press('end').type('0');
        ...
        QUnit.test('T220209 - the \'displayValueFormatter\' option when value is changed using spin buttons', function(assert) {
          ...
          var $spinUpButton = $numberBox.find('.dx-numberbox-spin-up');
        ...
        QUnit.test('T351846 - the value should not be changed after the \'change\' input event is fired if value is null', function(assert) {
          ...
          var $input = $numberBox.find('.' + INPUT_CLASS);
          keyboardMock($input).focus().change();
        ...
        QUnit.test('T351846 - the value should be reset to null if input is cleared', function(assert) {
          var $numberBox = $('#numberbox').dxNumberBox({value: 0});
          var $input = $numberBox.find('.' + INPUT_CLASS);
          keyboardMock($input).focus().press('end').press('backspace').change();
          assert.equal($numberBox.dxNumberBox('option', 'value'), null, 'value is correct');
        });
        QUnit.test('the value should be reset to null if reset method called', function(assert) {
          var numberBox = $('#numberbox').dxNumberBox({value: 0}).dxNumberBox('instance');
          numberBox.reset();
        ...
        QUnit.test('The value option should not be changed if it is invalid', function(assert) {
          ...
          var $numberBox = $('#numberbox').dxNumberBox({value: value});
          var numberBox = $numberBox.dxNumberBox('instance');
          var $input = $numberBox.find('.' + INPUT_CLASS);
        ...
        QUnit.test('The value option should not be reset if it is invalid', function(assert) {
          var value = 'any invalid value';
          var $numberBox = $('#numberbox').dxNumberBox({value: 5});
          var numberBox = $numberBox.dxNumberBox('instance');
          var $input = $numberBox.find('.' + INPUT_CLASS);
        ...
        QUnit.test('The widget should be valid if the value option is undefined', function(assert) {
          var $numberBox = $('#numberbox').dxNumberBox({value: undefined});
          var numberBox = $numberBox.dxNumberBox('instance');
          var $input = $numberBox.find('.' + INPUT_CLASS);
      ...
      QUnit.module('submit element', {}, function() {
        ...
        QUnit.test('the hidden input should get correct value on init', function(assert) {
          ...
          var $element = $('#numberbox').dxNumberBox({value: expectedValue});
          var $hiddenInput = $element.find('input[type=\'hidden\']');
        ...
        QUnit.test('the hidden input gets correct value after widget value is changed', function(assert) {
          ...
          var $element = $('#numberbox').dxNumberBox({value: 24.6});
          var instance = $element.dxNumberBox('instance');
          var $hiddenInput = $element.find('input[type=\'hidden\']');
        ...
        QUnit.test('the hidden input should use the decimal separator specified in DevExpress.config', function(assert) {
          ...
          try {
            ...
            var $element = $('#numberbox').dxNumberBox({value: 12.25});
            var $hiddenInput = $element.find('input[type=\'hidden\']');
      ...
      QUnit.module('the \'name\' option', {}, function() {
        QUnit.test('hidden input should get the \'name\' attribute', function(assert) {
          ...
          $('#numberbox').dxNumberBox({name: expectedName});
        ...
        QUnit.test('editor input should not get the \'name\' attribute', function(assert) {
          var $element = $('#numberbox').dxNumberBox({name: 'name'});
      ...
      QUnit.module('input value updating', {}, function() {
        ...
        QUnit.test('value should not be redrawn if it is incomplete and valueChangeEvent is set to keyup', function(assert) {
          ...
          $input.val('1');
          keyboard.caret(1).type('.').triggerEvent('keyup');
          keyboard.type('5').triggerEvent('keyup');
          assert.equal($input.val(), '1.5');
          instance.blur();
          $input.val('');
          keyboard.type('-').triggerEvent('keyup');
          keyboard.type('5').triggerEvent('keyup');
          assert.equal($input.val(), '-5');
          instance.blur();
        });
        QUnit.test('T378082 - value should be null if the incorrect value is entered', function(assert) {
          ...
          var $input = $element.find('.' + INPUT_CLASS);
          keyboardMock($input).type('..').change();
      ...
      QUnit.module('options changed callbacks', {beforeEach: function() {
        ...
        QUnit.test('min/max: value changes to limited value', function(assert) {
          ...
          $input.focus().val('99').trigger('change');
          assert.equal($input.val(), 100);
          $input.focus().val('201').trigger('change');
          assert.equal($input.val(), 200);
        ...
        QUnit.test('min/max: value changes when min wasn\'t set', function(assert) {
          ...
          $input.focus().val('101').trigger('change');
          assert.equal($input.val(), 100);
        });
        ...
        QUnit.test('min/max: value changes if value is negative', function(assert) {
          ...
          $input.focus().val('-100').trigger('change');
          assert.equal($input.val(), -30);
          $input.focus().val('-5').trigger('change');
        ...
        QUnit.test('spin edit handling', function(assert) {
          ...
          var $spinDown = this.element.find('.' + SPIN_DOWN_CLASS);
        ...
        QUnit.test('interactions with spin buttons do not change value if the readOnly option was set to true', function(assert) {
          ...
          var $input = this.element.find('.' + INPUT_CLASS);
          var $spinUp = this.element.find('.' + SPIN_UP_CLASS);
          var mouse = pointerMock($spinUp).start();
          mouse.click();
          assert.equal($input.val(), '100');
        });
        ...
        QUnit.test('spin edit very long click handling', function(assert) {
          ...
          try {
            ...
            this.instance.option('value', 100);
            var $spinUp = this.element.find('.' + SPIN_UP_CLASS);
            var pointer = pointerMock($spinUp).start();
            pointer.down();
      ...
      QUnit.module('regressions', {beforeEach: function() {
        ...
        QUnit.test('B230398', function(assert) {
          ...
          keyboard.type('10').change();
          assert.equal(instance.option('value'), 10);
          keyboard.press('backspace').press('backspace').change();
        ...
        QUnit.test('B235175 - add additional test cases for various numbers', function(assert) {
          ...
          $input.focus().val('1e2').trigger('change');
          ...
          $input.focus().val('2e+3').trigger('change');
          ...
          $input.focus().val('1e-2').trigger('change');
        ...
        QUnit.test('tabindex attribute should be rendered after initialization', function(assert) {
          var instance = $('#widget').dxNumberBox({
            tabIndex: 3,
            value: 1,
            min: 1
          }).dxNumberBox('instance');
          var $input = instance.$element().find(("." + INPUT_CLASS));
          assert.strictEqual($input.attr('tabIndex'), '3', 'tabIndex is correct after initializing');
        });
        ['min', 'max', 'step'].forEach(function(optionName) {
      ...
      QUnit.module('keyboard navigation', {}, function() {
        ...
        QUnit.test('keypress with meta key should not be prevented', function(assert) {
          var $numberBox = $('#numberbox').dxNumberBox({focusStateEnabled: true});
          var $input = $numberBox.find('.' + INPUT_CLASS);
          var keyboard = keyboardMock($input);
          ...
          keyboard.triggerEvent('keypress', {
            key: '0',
            metaKey: true
          });
        ...
        QUnit.test('control keys should not be prevented', function(assert) {
          var controlKeys = ['Tab', 'Del', 'Delete', 'Backspace', 'ArrowLeft', 'ArrowRight', 'Home', 'End'];
          var isKeyPressPrevented = false;
          var $numberBox = $('#numberbox').dxNumberBox({focusStateEnabled: true});
          var $input = $numberBox.find('.' + INPUT_CLASS);
          var keyboard = keyboardMock($input);
      ...
      QUnit.module('number validation', {}, function() {
        QUnit.test('decimal is not removed on valueChangeEvent', function(assert) {
          var $numberBox = $('#numberbox').dxNumberBox({valueChangeEvent: 'keyup'});
          var $input = $numberBox.find('.' + INPUT_CLASS);
        ...
        QUnit.test('T277051 - the \'e\' letter entered in the center of text should not be ignored', function(assert) {
          var $numberBox = $('#numberbox').dxNumberBox({value: 95});
          var numberBox = $numberBox.dxNumberBox('instance');
          var $input = $numberBox.find(("." + INPUT_CLASS));
          var keyboard = keyboardMock($input);
          keyboard.caret(1).type('e0');
          $input.change();
        ...
        QUnit.test('T303827: Delete last number in scientific notation with valueChangeEvent:\'keyup\'', function(assert) {
          ...
          keyboard.type(initialValue);
          numberBox.blur();
          numberBox.focus();
          keyboard.caret(30).press('backspace');
          $input.trigger('keyup');
          var expectedInputValue = isTextMode ? '8.888888888888888e+3' : '888888888888888888888888888880';
          assert.equal($input.val(), expectedInputValue, 'last digit was deleted');
          var expectedOptionValue = isTextMode ? '8.888888888888888e+3' : '8.888888888888888e+29';
        ...
        QUnit.test('Value shouldn\'t be reset after point remove', function(assert) {
          ...
          keyboard.caret(7).press('backspace').press('backspace');
        ...
        QUnit.test('the validation message should be shown if value is invalid', function(assert) {
          var $numberBox = $('#numberbox').dxNumberBox({value: 'abc'});
          var instance = $numberBox.dxNumberBox('instance');
        ...
        QUnit.test('the validation message should be shown if value is invalid after \'enter\' key was pressed', function(assert) {
          var $numberBox = $('#numberbox').dxNumberBox({valueChangeEvent: 'input'}).dxValidator({validationRules: [{
              type: 'range',
              min: 3,
              max: 10,
      ...
      QUnit.module('aria accessibility', {}, function() {
        ...
        QUnit.test('aria-valuenow is defined for numberBox with null value (T801129)', function(assert) {
          var $element = $('#numberbox').dxNumberBox({value: null});
          var $input = $element.find(("." + INPUT_CLASS));
        ...
        QUnit.test('the dxNumberBox should have value[min/max] when max or min only is specified', function(assert) {
          ...
          var numberBox = $element.dxNumberBox('instance');
          var $input = $element.find(("." + INPUT_CLASS)).get(0);
      ...
      QUnit.module('valueChanged should receive correct event parameter', {beforeEach: function() {
          var $__2 = this;
          ...
          this.init = function(options) {
            $__2.$element = $('#numberbox').dxNumberBox(options);
            $__2.instance = $__2.$element.dxNumberBox('instance');
            $__2.$input = $__2.$element.find(("." + INPUT_CLASS));
            $__2.keyboard = keyboardMock($__2.$input);
            $__2.mouse = pointerMock($__2.$input);
            $__2.$spinUp = $__2.$element.find(("." + SPIN_UP_CLASS));
            $__2.$spinDown = $__2.$element.find(("." + SPIN_DOWN_CLASS));
          };
        ...
        QUnit.test('on change when value is not valid', function(assert) {
          ...
          this.keyboard.press('end').press('backspace').keyUp('backspace');
        ...
        QUnit.test('on click on clear button', function(assert) {
          ...
          var $clearButton = this.$element.find(("." + CLEAR_BUTTON_CLASS));
          $clearButton.trigger('dxclick');
        ...
        [['up', 10], ['down', -10]].forEach(function($__4) {
          var $__6,
              $__7;
          var $__5 = $__4,
              direction = ($__6 = $__5[Symbol.iterator](), ($__7 = $__6.next()).done ? void 0 : $__7.value),
              delta = ($__7 = $__6.next()).done ? void 0 : $__7.value;
        ...
        ['arrowdown', 'arrowup'].forEach(function(arrow) {
        ...
        QUnit.test('on enter key press', function(assert) {
          this.keyboard.type('2').press('enter').change();
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/number_box/number_box.spin","core/config","core/devices","events/core/events_engine","../../../helpers/keyboardMock.js","../../../helpers/pointerMock.js","events/utils","ui/number_box","ui/validator"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/number_box/number_box.spin"), require("core/config"), require("core/devices"), require("events/core/events_engine"), require("../../../helpers/keyboardMock.js"), require("../../../helpers/pointerMock.js"), require("events/utils"), require("ui/number_box"), require("ui/validator"));
  else
