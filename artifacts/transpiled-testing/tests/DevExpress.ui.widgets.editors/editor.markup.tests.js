...
(["testing/tests/DevExpress.ui.widgets.editors/editor.markup.tests.js"], ["jquery","ui/editor/editor","core/class"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.editors/editor.markup.tests.js", ["jquery", "ui/editor/editor", "core/class"], function($__export) {
  "use strict";
  var $,
      Editor,
      Class,
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module('Editor markup', {
        ...
        [0, undefined, null].forEach(function(readOnly) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/editor/editor","core/class"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/editor/editor"), require("core/class"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=editor.markup.tests.js.map