System.register(["jquery", "core/utils/inflector", "animation/translator", "core/utils/date", "core/utils/date_serialization", "core/utils/common", "events/swipe", "animation/fx", "ui/calendar/ui.calendar.views", "ui/calendar", "../../helpers/pointerMock.js", "../../helpers/keyboardMock.js", "core/config", "core/element_data", "core/devices.js", "localization/date", "events/utils/index", "localization", "generic_light.css!"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      CALENDAR_RANGE_DATE_CLASS = 'dx-calendar-range-date';
      ...
      QUnit.module('Options', {
        ...
        QUnit.module('SelectionMode', {
          ...
          QUnit.module('Range', {
            ...
            [[null, null], [new Date(2021, 9, 17), null], [null, new Date(2021, 10, 25)], [new Date(2021, 9, 17), new Date(2021, 10, 25)]].forEach(values => {
