...
(["testing/tests/DevExpress.ui.widgets.editors/trackBar.markup.tests.js"], ["jquery","ui/track_bar"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.editors/trackBar.markup.tests.js", ["jquery", "ui/track_bar"], function($__export) {
  "use strict";
  var $,
      TRACKBAR_CLASS,
      TRACKBAR_CONTAINER_CLASS,
      TRACKBAR_RANGE_CLASS,
      TRACKBAR_WRAPPER_CLASS;
  ...
  return {
    ...
    execute: function() {
      QUnit.testStart(function() {
        var markup = '<div id="trackbar"></div>';
        $('#qunit-fixture').html(markup);
      });
      TRACKBAR_CLASS = 'dx-trackbar';
      ...
      QUnit.module('TrackBar markup', {beforeEach: function() {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/track_bar"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/track_bar"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=trackBar.markup.tests.js.map