System.register(["jquery", "ui/text_box", "core/devices", "../../helpers/executeAsyncMock.js", "core/utils/size", "core/utils/shadow_dom", "ui/text_box/ui.text_editor.label.js", "generic_light.css!"], function (_export, _context) {
  "use strict";

  var $, TextBox, devices, executeAsyncMock, getWidth, getOuterWidth, addShadowDomStyles, TextEditorLabel, TEXTBOX_CLASS, INPUT_CLASS, PLACEHOLDER_CLASS, SEARCHBOX_CLASS, SEARCH_ICON_CLASS, CLEAR_BUTTON_AREA_CLASS, BUTTONS_CONTAINER_CLASS, TEXTEDITOR_INPUT_CONTAINER_CLASS;
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_uiText_box) {
      TextBox = _uiText_box.default;
    ...
    execute: function () {
      QUnit.testStart(() => {
        const markup = '<div id="qunit-fixture">\
            <div id="textbox"></div>\
