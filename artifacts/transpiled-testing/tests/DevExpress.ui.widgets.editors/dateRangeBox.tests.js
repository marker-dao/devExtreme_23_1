System.register(["jquery", "core/config", "ui/date_range_box", "ui/date_box", "core/utils/type", "core/utils/type.js", "animation/fx", "events/hover", "../../helpers/keyboardMock.js", "ui/popup/ui.popup", "generic_light.css!"], function (_export, _context) {
  "use strict";

  var $, config, DateRangeBox, DateBox, isRenderer, isObject, fx, hoverEvents, keyboardMock, Popup, WIDGET_CLASS, BUTTON_CLASS, DROP_DOWN_EDITOR_BUTTON_CLASS, DROP_DOWN_EDITOR_BUTTONS_CONTAINER_CLASS, TEXTEDITOR_INPUT_CLASS, POPUP_CONTENT_CLASS, CLEAR_BUTTON, STATE_FOCUSED_CLASS, STATE_HOVER_CLASS, getStartDateBoxInstance, getEndDateBoxInstance, getButtonsContainers, getButtons, getClearButton, moduleConfig;
  return {
