...
(["testing/tests/DevExpress.ui.widgets.editors/radioButton.markup.tests.js"], ["jquery","ui/radio_group/radio_button"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.editors/radioButton.markup.tests.js", ["jquery", "ui/radio_group/radio_button"], function($__export) {
  "use strict";
  var RADIO_BUTTON_CLASS,
      RADIO_BUTTON_ICON_CLASS,
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module('button rendering', function() {
        ...
        QUnit.test('icon should be rendered', function(assert) {
          var $radioButton = $('#radioButton').dxRadioButton();
          var $icon = $radioButton.children(toSelector(RADIO_BUTTON_ICON_CLASS));
      ...
      QUnit.module('value changing', function() {
        QUnit.test('widget should be selected if value is set to true', function(assert) {
          var $radioButton = $('#radioButton').dxRadioButton({value: true});
      ...
      QUnit.module('aria accessibility', function() {
        ...
        QUnit.test('aria properties if value is set to false', function(assert) {
          var $element = $('#radioButton').dxRadioButton({value: false});
          $element.dxRadioButton('instance');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/radio_group/radio_button"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/radio_group/radio_button"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=radioButton.markup.tests.js.map