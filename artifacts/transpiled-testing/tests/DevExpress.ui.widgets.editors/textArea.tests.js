...
(["testing/tests/DevExpress.ui.widgets.editors/textArea.tests.js"], ["jquery","../../helpers/pointerMock.js","../../helpers/nativePointerMock.js","../../helpers/keyboardMock.js","core/devices","core/utils/resize_callbacks","core/utils/size.js","generic_light.css!","ui/text_area","ui/scroll_view/ui.scrollable"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.editors/textArea.tests.js", ["jquery", "../../helpers/pointerMock.js", "../../helpers/nativePointerMock.js", "../../helpers/keyboardMock.js", "core/devices", "core/utils/resize_callbacks", "core/utils/size.js", "generic_light.css!", "ui/text_area", "ui/scroll_view/ui.scrollable"], function($__export) {
  "use strict";
  var $,
      pointerMock,
      nativePointerMock,
  ...
  return {
    setters: [function($__m) {
      ...
      parseHeight = $__m.parseHeight;
    }, function($__m) {}, function($__m) {}, function($__m) {}],
    execute: function() {
      QUnit.testStart(function() {
        var markup = '<div id="textarea"></div>\
        <div id="widget"></div>\
        ...
        $('#content').css('width', '300px').css('height', '300px');
      ...
      AUTO_RESIZE_CLASS = 'dx-texteditor-input-auto-resize';
      TEXTEDITOR_INPUT_CLASS = 'dx-texteditor-input';
      QUnit.module('rendering', function() {
        QUnit.test('onContentReady fired after the widget is fully ready', function(assert) {
          assert.expect(1);
          $('#textarea').dxTextArea({onContentReady: function(e) {
        ...
        QUnit.test('scrolling with dxpointer events', function(assert) {
          ...
          var $input = $element.dxTextArea('instance')._input();
      ...
      QUnit.module('options changing', function() {
        QUnit.test('value', function(assert) {
          assert.expect(2);
          var $element = $('#textarea').dxTextArea({});
          var $input = $element.find(("." + INPUT_CLASS));
          var instance = $element.dxTextArea('instance');
        ...
        QUnit.test('Changing the \'value\' option must invoke the \'onValueChanged\' action', function(assert) {
          $('#textarea').dxTextArea({onValueChanged: function() {
              assert.ok(true);
      ...
      QUnit.module('widget sizing render', function() {
        ...
        [true, false].forEach(function(autoResizeEnabled) {
          [100, '100px', '50%', '20vh', '10em'].forEach(function(minHeight) {
            QUnit.test(("input should have correct size when autoResizeEnabled is " + autoResizeEnabled + " and minHeight equals " + minHeight), function(assert) {
              ...
              var borderHeight = parseInt($element.css('borderTopWidth'));
              var parsedMinHeight = typeof minHeight === 'number' ? minHeight : parseHeight(minHeight, $element.get(0).parentNode, $element.get(0));
              assert.strictEqual(inputHeight + 2 * borderHeight, parsedMinHeight, 'height is ok');
            });
          });
        });
      });
      QUnit.module('the \'autoResizeEnabled\' option', function() {
        QUnit.test('widget is resized on init', function(assert) {
          var $element = $('#textarea').dxTextArea({autoResizeEnabled: true});
          var $input = $element.find(("." + TEXTEDITOR_INPUT_CLASS));
          var inputHeight = $input.outerHeight();
          $input.height(0);
        ...
        QUnit.test('widget with auto resize should have a scrollbar if content is higher than the max height', function(assert) {
          ...
          var instance = $element.dxTextArea({
            autoResizeEnabled: true,
            value: '1\n2\n3\n4\n5\n6\n7\n8\n9',
            maxHeight: boundaryHeight
          }).dxTextArea('instance');
        ...
        QUnit.test('widget should adopt its size on shown (T403238)', function(assert) {
          var $element = $('#textarea').hide().dxTextArea({
            width: 70,
            autoResizeEnabled: true,
            minHeight: 20
          });
        ...
        QUnit.test('widget can not scroll container to the top on change content height (T755402)', function(assert) {
          ...
          var $element = $('#withContainer').dxTextArea({
            autoResizeEnabled: true,
      ...
      QUnit.module('TextArea in simulated scrollable', function() {
        if (devices.current().deviceType === 'desktop') {
          ['vertical', 'horizontal'].forEach(function(direction) {
            var TextAreaInScrollableTestHelper = function() {
              function TextAreaInScrollableTestHelper(direction) {
              ...
              return ($traceurRuntime.createClass)(TextAreaInScrollableTestHelper, {
            ...
            QUnit.test(("mousewheel: textArea (scrollPosition - MIN) - wheel -> up -> down - scrollable direction: " + direction), function(assert) {
              var helper = new TextAreaInScrollableTestHelper(direction);
              helper.scrollable.scrollTo(100);
              var pointer = nativePointerMock(helper.$textAreaInput);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/pointerMock.js","../../helpers/nativePointerMock.js","../../helpers/keyboardMock.js","core/devices","core/utils/resize_callbacks","core/utils/size.js","generic_light.css!","ui/text_area","ui/scroll_view/ui.scrollable"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/pointerMock.js"), require("../../helpers/nativePointerMock.js"), require("../../helpers/keyboardMock.js"), require("core/devices"), require("core/utils/resize_callbacks"), require("core/utils/size.js"), require("generic_light.css!"), require("ui/text_area"), require("ui/scroll_view/ui.scrollable"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=textArea.tests.js.map