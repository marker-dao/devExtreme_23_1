...
(["testing/tests/DevExpress.ui.widgets.editors/sliderHandle.tests.js"], ["jquery","ui/slider/ui.slider_handle","ui/slider/ui.slider_tooltip"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.editors/sliderHandle.tests.js", ["jquery", "ui/slider/ui.slider_handle", "ui/slider/ui.slider_tooltip"], function($__export) {
  "use strict";
  var $,
      SliderHandle,
      SliderTooltip,
    ...
    execute: function() {
      ...
      QUnit.module('public methods', {beforeEach: function() {
        ...
        QUnit.test('updateTooltipPosition should call sliderTooltip updatePosition', function(assert) {
          var tooltipUpdatePositionSpy = sinon.spy(this.tooltip, 'updatePosition');
          this.sliderHandle.updateTooltipPosition();
          assert.ok(tooltipUpdatePositionSpy.called);
        });
      });
      QUnit.module('tooltip integration', function() {
        QUnit.test('sliderHandle should create SliderTooltip with correct parameters', function(assert) {
          ...
          var sliderHandle = new SliderHandle($('#sliderHandle'), initConfig);
          var $sliderTooltip = getSliderTooltip(sliderHandle);
          var sliderTooltip = SliderTooltip.getInstance($sliderTooltip);
          var sliderTooltipOptions = sliderTooltip.option();
        ...
        QUnit.module('on option change', {beforeEach: function() {
            this.sliderHandle = new SliderHandle($('#sliderHandle'), {tooltip: {enabled: true}});
            var $sliderTooltip = getSliderTooltip(this.sliderHandle);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/slider/ui.slider_handle","ui/slider/ui.slider_tooltip"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/slider/ui.slider_handle"), require("ui/slider/ui.slider_tooltip"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=sliderHandle.tests.js.map