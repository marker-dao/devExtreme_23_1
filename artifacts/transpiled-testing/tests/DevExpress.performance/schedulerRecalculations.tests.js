...
(["testing/tests/DevExpress.performance/schedulerRecalculations.tests.js"], ["../../helpers/qunitPerformanceExtension.js","generic_light.css!","jquery","core/utils/resize_callbacks","ui/scheduler","ui/drop_down_button"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.performance/schedulerRecalculations.tests.js', ['../../helpers/qunitPerformanceExtension.js', 'generic_light.css!', 'jquery', 'core/utils/resize_callbacks', 'ui/scheduler', 'ui/drop_down_button'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    /* eslint-disable no-console */

    $__require('../../helpers/qunitPerformanceExtension.js');

    $__require('generic_light.css!');

    const $ = $__require('jquery');
    const resizeCallbacks = $__require('core/utils/resize_callbacks');
    const data = [{ startDate: new Date(2016, 2, 9, 1), endDate: new Date(2016, 2, 9, 2), text: 'Meeting' }, { startDate: new Date(2016, 2, 9, 3), endDate: new Date(2016, 2, 9, 4), text: 'Go to a shop' }, { startDate: new Date(2016, 2, 9, 4, 30), endDate: new Date(2016, 2, 9, 5), text: 'The TV show' }, { startDate: new Date(2016, 2, 9, 5), endDate: new Date(2016, 2, 9, 5, 30), text: 'Read a book' }, { startDate: new Date(2016, 2, 9, 9), endDate: new Date(2016, 2, 9, 10), text: 'Play a guitar' }];

    $__require('ui/scheduler');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../helpers/qunitPerformanceExtension.js","generic_light.css!","jquery","core/utils/resize_callbacks","ui/scheduler","ui/drop_down_button"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../helpers/qunitPerformanceExtension.js"), require("generic_light.css!"), require("jquery"), require("core/utils/resize_callbacks"), require("ui/scheduler"), require("ui/drop_down_button"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=schedulerRecalculations.tests.js.map