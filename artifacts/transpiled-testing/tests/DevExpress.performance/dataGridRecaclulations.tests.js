...
(["testing/tests/DevExpress.performance/dataGridRecaclulations.tests.js"], ["jquery","../../helpers/qunitPerformanceExtension.js","../../content/orders.js","generic_light.css!","ui/data_grid","ui/pager","ui/scroll_view/ui.scrollable"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.performance/dataGridRecaclulations.tests.js', ['jquery', '../../helpers/qunitPerformanceExtension.js', '../../content/orders.js', 'generic_light.css!', 'ui/data_grid', 'ui/pager', 'ui/scroll_view/ui.scrollable'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');

    $__require('../../helpers/qunitPerformanceExtension.js');
    $__require('../../content/orders.js');

    $__require('generic_light.css!');
    const DataGrid = $__require('ui/data_grid');
    const Pager = $__require('ui/pager');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/qunitPerformanceExtension.js","../../content/orders.js","generic_light.css!","ui/data_grid","ui/pager","ui/scroll_view/ui.scrollable"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/qunitPerformanceExtension.js"), require("../../content/orders.js"), require("generic_light.css!"), require("ui/data_grid"), require("ui/pager"), require("ui/scroll_view/ui.scrollable"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=dataGridRecaclulations.tests.js.map