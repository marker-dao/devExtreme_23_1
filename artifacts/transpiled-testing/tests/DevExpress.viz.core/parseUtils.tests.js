...
(["testing/tests/DevExpress.viz.core/parseUtils.tests.js"], ["core/utils/common","core/config","viz/components/parse_utils"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.core/parseUtils.tests.js', ['core/utils/common', 'core/config', 'viz/components/parse_utils'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const noop = $__require('core/utils/common').noop;
    const config = $__require('core/config');
    const parseUtils = $__require('viz/components/parse_utils');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/common","core/config","viz/components/parse_utils"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/common"), require("core/config"), require("viz/components/parse_utils"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=parseUtils.tests.js.map