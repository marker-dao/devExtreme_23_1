...
(["testing/tests/DevExpress.viz.core/axesTicksGeneration.tests.js"], ["jquery","../../helpers/vizMocks.js","viz/core/utils","viz/axes/base_axis","viz/translators/translator2d","viz/translators/range"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.viz.core/axesTicksGeneration.tests.js", ["jquery", "../../helpers/vizMocks.js", "viz/core/utils", "viz/axes/base_axis", "viz/translators/translator2d", "viz/translators/range"], function($__export) {
  "use strict";
  var $,
      vizMocks,
      vizUtilsModule,
    ...
    execute: function() {
      ...
      QUnit.test('No matter what type - return ticks in pixels', function(assert) {
        var test = function(options) {
          ...
          this.axis.createTicks($.extend(canvas(300), {
            left: 21,
            right: 21
          }));
      ...
      QUnit.test('Calculate tickInterval if ratio of (categories count) to (count by spacingFactor) more than 4', function(assert) {
        ...
        this.axis.setBusinessRange({categories: getArray(82, 1).map(function(_, i) {
            return i;
          })});
        this.axis.createTicks(canvas(1000));
      ...
      QUnit.test('interval correction issue', function(assert) {
        ...
        this.axis.createTicks(canvas(1000));
        assert.deepEqual(this.axis._majorTicks.map(value).map(function(tick) {
      ...
      QUnit.test('Do not hang browser if small numbers', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: 22.099999999999998,
          max: 22.100000000000005
        });
        this.axis.createTicks(canvas(1000));
      ...
      QUnit.test('Milliseconds tickInterval (5ms)', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2012, 3, 1, 12, 3, 5, 123),
          max: new Date(2012, 3, 1, 12, 3, 5, 149)
        });
        this.axis.createTicks(canvas(300));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2012, 3, 1, 12, 3, 5, 125), new Date(2012, 3, 1, 12, 3, 5, 130), new Date(2012, 3, 1, 12, 3, 5, 135), new Date(2012, 3, 1, 12, 3, 5, 140), new Date(2012, 3, 1, 12, 3, 5, 145)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Seconds tickInterval (5s)', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2012, 3, 1, 12, 3, 3),
          max: new Date(2012, 3, 1, 12, 3, 26)
        });
        this.axis.createTicks(canvas(300));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2012, 3, 1, 12, 3, 5), new Date(2012, 3, 1, 12, 3, 10), new Date(2012, 3, 1, 12, 3, 15), new Date(2012, 3, 1, 12, 3, 20), new Date(2012, 3, 1, 12, 3, 25)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Minutes tickInterval (3)', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2012, 3, 1, 12, 1),
          max: new Date(2012, 3, 1, 12, 16)
        });
        this.axis.createTicks(canvas(300));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2012, 3, 1, 12, 3), new Date(2012, 3, 1, 12, 6), new Date(2012, 3, 1, 12, 9), new Date(2012, 3, 1, 12, 12), new Date(2012, 3, 1, 12, 15)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Hours tickInterval (4)', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2012, 5, 1, 3),
          max: new Date(2012, 5, 1, 21)
        });
        this.axis.createTicks(canvas(250));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2012, 5, 1, 4), new Date(2012, 5, 1, 8), new Date(2012, 5, 1, 12), new Date(2012, 5, 1, 16), new Date(2012, 5, 1, 20)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Days tickInterval (2)', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2012, 3, 2, 13),
          max: new Date(2012, 3, 11, 5)
        });
        this.axis.createTicks(canvas(250));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2012, 3, 4), new Date(2012, 3, 6), new Date(2012, 3, 8), new Date(2012, 3, 10)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Weeks tickInterval (2)', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2012, 2, 30),
          max: new Date(2012, 4, 30)
        });
        this.axis.createTicks(canvas(250));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2012, 3, 8), new Date(2012, 3, 22), new Date(2012, 4, 6), new Date(2012, 4, 20)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Months tickInterval (3)', function(assert) {
        ...
        this.axis.setBusinessRange({
          ...
          max: new Date(2013, 0, 15)
        });
        this.axis.createTicks(canvas(250));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2012, 0, 1), new Date(2012, 3, 1), new Date(2012, 6, 1), new Date(2012, 9, 1), new Date(2013, 0, 1)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Years tickInterval (2)', function(assert) {
        ...
        this.axis.createTicks(canvas(250));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2006, 0, 1), new Date(2008, 0, 1), new Date(2010, 0, 1), new Date(2012, 0, 1)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Years tickInterval can not be 2.5 (5)', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(1994, 11, 20),
          max: new Date(2015, 5, 1)
        });
        this.axis.createTicks(canvas(500));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(1995, 0, 1), new Date(2000, 0, 1), new Date(2005, 0, 1), new Date(2010, 0, 1), new Date(2015, 0, 1)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Years tickInterval (25)', function(assert) {
        ...
        this.axis.setBusinessRange({
          ...
          max: new Date(2001, 0, 1)
        });
        this.axis.createTicks(canvas(250));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(1900, 0, 1), new Date(1925, 0, 1), new Date(1950, 0, 1), new Date(1975, 0, 1), new Date(2000, 0, 1)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Days tickInterval converts into weeks (7)', function(assert) {
        ...
        this.axis.createTicks(canvas(300));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2011, 1, 6), new Date(2011, 1, 13), new Date(2011, 1, 20), new Date(2011, 1, 27)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Quarters tickInterval (2)', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2010, 5, 15),
          max: new Date(2012, 3, 1)
        });
        this.axis.createTicks(canvas(300));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2010, 6, 1), new Date(2011, 0, 1), new Date(2011, 6, 1), new Date(2012, 0, 1)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('endOnTick === false - calculate ticks inside data bounds', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2017, 1, 3, 13, 28, 33),
          max: new Date(2017, 1, 12, 5, 3)
        });
        this.axis.createTicks(canvas(300));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2017, 1, 5), new Date(2017, 1, 7), new Date(2017, 1, 9), new Date(2017, 1, 11)].map(function(d) {
          return d.valueOf();
        }));
        assert.deepEqual(this.axis._tickInterval, {'days': 2});
      });
      QUnit.test('endOnTick === true - calculate ticks outside or on data bounds', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2017, 1, 3, 13, 28, 33),
          max: new Date(2017, 1, 11, 5, 3)
        });
        this.axis.createTicks(canvas(300));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2017, 1, 3), new Date(2017, 1, 5), new Date(2017, 1, 7), new Date(2017, 1, 9), new Date(2017, 1, 11), new Date(2017, 1, 13)].map(function(d) {
          return d.valueOf();
        }));
        assert.deepEqual(this.axis._tickInterval, {'days': 2});
      });
      QUnit.test('endOnTick === true - calculate ticks outside or on data bounds. Take into account local timezone offset', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2017, 1, 3),
          max: new Date(2017, 1, 13)
        });
        this.axis.createTicks(canvas(300));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2017, 1, 3), new Date(2017, 1, 5), new Date(2017, 1, 7), new Date(2017, 1, 9), new Date(2017, 1, 11), new Date(2017, 1, 13)].map(function(d) {
          return d.valueOf();
      ...
      QUnit.test('Force user tick interval if it is too small for given screenDelta and spacing factor', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2017, 1, 4, 13, 28, 33),
          max: new Date(2017, 1, 8, 5, 3)
        });
        this.axis.createTicks(canvas(150));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2017, 1, 5), new Date(2017, 1, 6), new Date(2017, 1, 7), new Date(2017, 1, 8)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Quarters custom interval', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2011, 0, 10),
          max: new Date(2011, 10, 1)
        });
        this.axis.createTicks(canvas(300));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2011, 3, 1), new Date(2011, 6, 1), new Date(2011, 9, 1)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Custom tickInterval with several keys - use bigger key as multiplier', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2012, 3, 1, 11, 3, 3),
          max: new Date(2012, 3, 1, 21)
        });
        this.axis.createTicks(canvas(250));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2012, 3, 1, 12, 0, 30), new Date(2012, 3, 1, 14, 1, 0), new Date(2012, 3, 1, 16, 1, 30), new Date(2012, 3, 1, 18, 2, 0), new Date(2012, 3, 1, 20, 2, 30)].map(function(d) {
          return d.valueOf();
        }));
        assert.deepEqual(this.axis._tickInterval, {
          hours: 2,
          seconds: 30
        });
      });
      QUnit.test('endOnTick true, custom tickInterval with several keys - use bigger key as multiplier', function(assert) {
        ...
        this.axis.createTicks(canvas(250));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2012, 3, 1, 10, 0, 0), new Date(2012, 3, 1, 12, 0, 30), new Date(2012, 3, 1, 14, 1, 0), new Date(2012, 3, 1, 16, 1, 30), new Date(2012, 3, 1, 18, 2, 0), new Date(2012, 3, 1, 20, 2, 30), new Date(2012, 3, 1, 22, 3, 0)].map(function(d) {
          return d.valueOf();
        }));
        assert.deepEqual(this.axis._tickInterval, {
          hours: 2,
      ...
      QUnit.test('customTicks', function(assert) {
        ...
        this.axis.createTicks(canvas(250));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2011, 3, 10), new Date(2011, 4, 10), new Date(2011, 5, 10), new Date(2011, 6, 10)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Custom tickInterval is very small - ignore tickInterval and raise W2003 warning', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2012, 3, 2, 2),
          max: new Date(2012, 3, 12, 12)
        });
      ...
      QUnit.test('Tick interval can be set as string value', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2017, 1, 3, 13, 28, 33),
          max: new Date(2017, 1, 7, 5, 3)
        });
        this.axis.createTicks(canvas(300));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2017, 1, 4), new Date(2017, 1, 5), new Date(2017, 1, 6), new Date(2017, 1, 7)].map(function(d) {
          return d.valueOf();
        }));
        assert.deepEqual(this.axis._tickInterval, {'days': 1});
      });
      QUnit.test('The Daylight Saving day on the Central European time zone', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date('2017-10-28T23:59:00+01:00'),
          max: new Date('2017-10-29T05:01:00+00:00')
        });
        this.axis.createTicks(canvas(400));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date('2017-10-29T00:00:00+01:00'), new Date('2017-10-29T01:00:00+01:00'), new Date('2017-10-29T01:00:00+00:00'), new Date('2017-10-29T02:00:00+00:00'), new Date('2017-10-29T03:00:00+00:00'), new Date('2017-10-29T04:00:00+00:00'), new Date('2017-10-29T05:00:00+00:00')].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Get ticks with right type after empty range', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(0),
          max: new Date(23 * 1000)
        });
        this.axis.createTicks(canvas(300), {
          left: 21,
          right: 21
        });
        assert.deepEqual(this.axis._majorTicks.map(function(v) {
          return v.value.getTime();
      ...
      QUnit.test('tickInterval month - minorTickInterval can not be in weeks', function(assert) {
        ...
        this.axis.setBusinessRange({
          ...
          max: new Date(2012, 5, 1)
        });
        this.axis.createTicks(canvas(120));
        assert.deepEqual(this.axis._minorTicks.map(value), [new Date(2012, 3, 15), new Date(2012, 3, 29), new Date(2012, 4, 15), new Date(2012, 4, 29)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Custom minorTicks', function(assert) {
        ...
        this.axis.createTicks(canvas(120));
        assert.deepEqual(this.axis._minorTicks.map(value), [new Date(2012, 3, 10), new Date(2012, 3, 20), new Date(2012, 3, 30), new Date(2012, 4, 9)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Minor ticks when there is only one major tick on min (big tickInterval)', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2012, 3, 10),
          max: new Date(2012, 3, 30)
        });
        this.axis.createTicks(canvas(75));
        assert.deepEqual(this.axis._minorTicks.map(value), [new Date(2012, 3, 15), new Date(2012, 3, 29)].map(function(d) {
          return d.valueOf();
        }));
      ...
      QUnit.test('Minor ticks when there is only one major tick in the middle (big tickInterval)', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2012, 2, 20),
          max: new Date(2012, 3, 9)
        });
        this.axis.createTicks(canvas(75));
        assert.deepEqual(this.axis._minorTicks.map(value), [new Date(2012, 2, 22), new Date(2012, 2, 29), new Date(2012, 3, 8)].map(function(d) {
          return d.valueOf();
        }));
        assert.deepEqual(this.axis._minorTickInterval, {days: 7});
      });
      QUnit.test('Minor ticks with given minorTickCount', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2015, 11, 24),
          max: new Date(2017, 0, 7)
        });
        this.axis.createTicks(canvas(1388));
        assert.deepEqual(this.axis._minorTickInterval, {
          days: 7,
          hours: 12
        });
      ...
      QUnit.test('Do not generate minor ticks more than minorTickCount', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2016, 11, 24),
          max: new Date(2017, 1, 7)
        });
        this.axis.createTicks(canvas(400));
      ...
      QUnit.test('Do not generate minor ticks nor calculate minorTickInterval when data range is zero (min == max)', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2012, 10, 1, 12),
          max: new Date(2012, 10, 1, 12)
        });
        this.axis.createTicks(canvas(1000));
        assert.deepEqual(this.axis._minorTicks.map(value), []);
        assert.deepEqual(this.axis._minorTickInterval, undefined);
      ...
      QUnit.test('BusinessDelta is 0', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2018, 4, 5),
          max: new Date(2018, 4, 5)
        });
        this.axis.createTicks(canvas(1000));
      ...
      QUnit.test('Remove ticks that in the break. DateTime', function(assert) {
        ...
        this.updateOptions({
          ...
          breakStyle: {width: 0},
          breaks: [{
            startValue: new Date(2017, 10, 5),
            endValue: new Date(2017, 10, 5, 7)
          }]
        });
        this.axis.setBusinessRange({
          min: new Date(2017, 10, 4, 22),
          max: new Date(2017, 10, 5, 8)
        });
        this.axis.createTicks(canvas(1000));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2017, 10, 4, 22), new Date(2017, 10, 5), new Date(2017, 10, 5, 6), new Date(2017, 10, 5, 8)].map(function(d) {
          return d.valueOf();
        }), 'major ticks');
        assert.deepEqual(this.axis._minorTicks.map(value), [new Date(2017, 10, 4, 23), new Date(2017, 10, 5, 5), new Date(2017, 10, 5, 7)].map(function(d) {
          return d.valueOf();
        }), 'minor ticks');
      });
      QUnit.test('Tune scale break values. Numeric', function(assert) {
        ...
        this.axis.createTicks(canvas(1000));
        assert.deepEqual(this.axis._majorTicks.map(value), [0, 10, 100, 110, 300, 310, 320, 330, 340, 490, 500, 510], 'major ticks');
        assert.deepEqual(this.translator.updateBusinessRange.lastCall.args[0].breaks, [{
          from: 15,
          to: 95,
          cumulativeWidth: 0
      ...
      QUnit.test('Tune scale break values. Datetime', function(assert) {
        ...
        this.updateOptions({
          ...
          breakStyle: {width: 0},
          breaks: [{
            startValue: new Date(2017, 4, 3),
            endValue: new Date(2017, 8, 5)
          }]
        });
        this.axis.setBusinessRange({
          min: new Date(2017, 0, 1),
          max: new Date(2017, 9, 1)
        });
        this.axis.createTicks(canvas(1000));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2017, 0, 1).getTime(), new Date(2017, 1, 1).getTime(), new Date(2017, 2, 1).getTime(), new Date(2017, 3, 1).getTime(), new Date(2017, 4, 1).getTime(), new Date(2017, 8, 1).getTime(), new Date(2017, 9, 1).getTime()], 'major ticks');
        assert.deepEqual(this.translator.updateBusinessRange.lastCall.args[0].breaks, [{
      ...
      QUnit.test('Do not tune day off scale break', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2017, 8, 13),
          max: new Date(2017, 8, 20)
        });
        this.axis.createTicks(canvas(1000));
      ...
      QUnit.test('Move datetime ticks to work day', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2017, 8, 15),
          max: new Date(2017, 8, 19)
        });
        this.axis.createTicks(canvas(1000));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2017, 8, 15).getTime(), new Date(2017, 8, 15, 14, 0).getTime(), new Date(2017, 8, 18, 4, 0).getTime(), new Date(2017, 8, 18, 18, 0).getTime()]);
      });
      QUnit.test('Correct first tick to work day', function(assert) {
        ...
        this.axis.createTicks(canvas(500));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(1994, 2, 7).getTime(), new Date(1994, 2, 14).getTime(), new Date(1994, 2, 21).getTime(), new Date(1994, 2, 28).getTime()]);
      });
      ...
      QUnit.test('Move datetime ticks to work day. Tick interval data - move tick to start of work week', function(assert) {
        ...
        this.axis.createTicks(canvas(1000));
        assert.deepEqual(this.axis._majorTicks.map(value), [new Date(2017, 8, 15).getTime(), new Date(2017, 8, 18).getTime(), new Date(2017, 8, 19).getTime()]);
      });
      QUnit.test('Do not move datetime ticks to work day if work day has tick', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2017, 8, 16),
          max: new Date(2017, 8, 22)
        });
        this.axis.createTicks(canvas(1000));
      ...
      QUnit.test('Update breaks in translator after tick calculation', function(assert) {
        ...
        this.axis.setBusinessRange(new Range({
          min: 50,
          max: 1000
        }));
        this.axis.createTicks(canvas(200));
      ...
      QUnit.test('getAggregationInfo with tickInterval', function(assert) {
        ...
        this.axis.createTicks(canvas(1000));
        var aggregationInfo = this.axis.getAggregationInfo(undefined, {});
      ...
      QUnit.test('getAggregationInfo. Do not get tickInterval less than data interval', function(assert) {
        ...
        this.axis.createTicks(canvas(170));
        var aggregationInfo = this.axis.getAggregationInfo(undefined, {interval: 5});
      ...
      QUnit.test('getAggregationInfo. Adjust data interval by multipliers', function(assert) {
        ...
        this.axis.createTicks(canvas(170));
        var aggregationInfo = this.axis.getAggregationInfo(undefined, {interval: 4.96});
        assert.strictEqual(aggregationInfo.interval, 5);
      });
      ...
      QUnit.test('Do not get tickInterval less than data interval', function(assert) {
        ...
        this.axis.setBusinessRange({
          min: new Date(2012, 3, 1),
          max: new Date(2012, 3, 2)
        });
        this.axis.createTicks(canvas(170));
        var aggregationInfo = this.axis.getAggregationInfo(undefined, {interval: 23 * 1000 * 60 * 60});
      ...
      QUnit.test('Do not get tickInterval less than data interval. Logarithmic', function(assert) {
        ...
        this.axis.createTicks(canvas(170));
        var aggregationInfo = this.axis.getAggregationInfo(undefined, {interval: 3});
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/vizMocks.js","viz/core/utils","viz/axes/base_axis","viz/translators/translator2d","viz/translators/range"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/vizMocks.js"), require("viz/core/utils"), require("viz/axes/base_axis"), require("viz/translators/translator2d"), require("viz/translators/range"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=axesTicksGeneration.tests.js.map