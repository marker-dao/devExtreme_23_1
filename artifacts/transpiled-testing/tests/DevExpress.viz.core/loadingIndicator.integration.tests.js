...
(["testing/tests/DevExpress.viz.core/loadingIndicator.integration.tests.js"], ["viz/tree_map/tree_map","jquery","../../helpers/vizMocks.js","viz/core/loading_indicator","data/data_source/data_source"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.core/loadingIndicator.integration.tests.js', ['viz/tree_map/tree_map', 'jquery', '../../helpers/vizMocks.js', 'viz/core/loading_indicator', 'data/data_source/data_source'], true, function ($__require, exports, module) {
    ...
    QUnit.module('Loading indicator', {
        beforeEach: function () {
            ...
            loadingIndicatorModule.DEBUG_set_LoadingIndicator(sinon.spy(function () {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["viz/tree_map/tree_map","jquery","../../helpers/vizMocks.js","viz/core/loading_indicator","data/data_source/data_source"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("viz/tree_map/tree_map"), require("jquery"), require("../../helpers/vizMocks.js"), require("viz/core/loading_indicator"), require("data/data_source/data_source"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=loadingIndicator.integration.tests.js.map