...
(["testing/tests/DevExpress.viz.core/axisFormatting.tests.js"], ["jquery","viz/translators/translator2d","viz/translators/range","viz/axes/tick_generator","viz/axes/base_axis","../../helpers/vizMocks.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.viz.core/axisFormatting.tests.js", ["jquery", "viz/translators/translator2d", "viz/translators/range", "viz/axes/tick_generator", "viz/axes/base_axis", "../../helpers/vizMocks.js"], function($__export) {
  "use strict";
  var $,
      translator2DModule,
      Range,
    ...
    execute: function() {
      ...
      environment = {
        ...
        testFormat: function(assert, options, ticks, tickInterval, texts, constantLineValue) {
          ...
          var actualTexts = getArray(texts.length).map(function(_, i) {
        ...
        testTickLabelFormat: function(assert, ticks, tickInterval, texts) {
          this.testFormat(assert, {label: {visible: true}}, ticks, tickInterval, texts);
        },
        testConstantLineLabelFormat: function(assert, ticks, tickInterval, text, constantLineValue, isDatetime) {
          this.testFormat(assert, {argumentType: isDatetime ? 'datetime' : 'numeric'}, ticks, tickInterval, [text], constantLineValue);
        },
        afterEach: function() {
      ...
      QUnit.test('formatting logarithmic ticks', function(assert) {
        this.testFormat(assert, {
          ...
          argumentType: 'numeric',
          label: {visible: true}
        }, [0.00000999999999, 0.0000999999999, 0.000999999999, 0.00999999999, 0.0999999999, 0, 1, 10, 100, 1000, 10000, 1e18], 1, ['1E-5', '0.0001', '0.001', '0.01', '0.1', '0', '1', '10', '100', '1K', '10K', '1E+18']);
      });
      QUnit.test('No formats for logarithmic ticks with logarithmBase !== 10', function(assert) {
        this.testFormat(assert, {
          ...
          argumentType: 'numeric',
          label: {visible: true}
        }, [512, 1024, 2048, 4096], 1, ['512', '1024', '2048', '4096']);
      });
      ...
      QUnit.test('format is calculated by ticks and tickInterval in years', function(assert) {
        this.testFormat(assert, {
          ...
          label: {visible: true}
        }, [new Date(1940, 0, 1), new Date(1950, 0, 1), new Date(1960, 0, 1), new Date(1970, 0, 1), new Date(1980, 0, 1), new Date(1990, 0, 1), new Date(2000, 0, 1), new Date(2010, 0, 1)], {years: 10}, ['1940', '1950', '1960', '1970', '1980', '1990', '2000', '2010']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in quartes (even)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(1949, 3, 1), new Date(1949, 9, 1), new Date(1950, 3, 1), new Date(1950, 9, 1), new Date(1951, 3, 1), new Date(1951, 9, 1), new Date(1952, 3, 1), new Date(1952, 9, 1)], {quarters: 2}, ['April 1949', 'October', 'April 1950', 'October', 'April 1951', 'October', 'April 1952', 'October']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in quartes (odd)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(1950, 6, 1), new Date(1951, 3, 1), new Date(1952, 0, 1), new Date(1952, 9, 1), new Date(1953, 6, 1), new Date(1954, 3, 1)], {quarters: 3}, ['July 1950', 'April 1951', 'January 1952', 'October', 'July 1953', 'April 1954']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in years and months', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2000, 3, 1), new Date(2002, 5, 1), new Date(2004, 7, 1), new Date(2006, 9, 1), new Date(2008, 11, 1), new Date(2010, 1, 1), new Date(2012, 3, 1)], {
          years: 2,
          months: 2
      ...
      QUnit.test('format is calculated by ticks and tickInterval in years, months and days', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2000, 3, 1), new Date(2001, 5, 4), new Date(2002, 7, 7), new Date(2003, 9, 10), new Date(2004, 11, 13), new Date(2005, 1, 16), new Date(2006, 3, 19)], {
          years: 1,
          months: 2,
          days: 3
      ...
      QUnit.test('format is calculated by ticks and tickInterval in months', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2010, 3, 1), new Date(2010, 4, 1), new Date(2010, 5, 1), new Date(2010, 6, 1), new Date(2010, 7, 1), new Date(2010, 8, 1), new Date(2010, 9, 1)], {months: 1}, ['April 2010', 'May', 'June', 'July', 'August', 'September', 'October']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in months (years changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(1950, 3, 1), new Date(1950, 8, 1), new Date(1951, 1, 1), new Date(1951, 6, 1), new Date(1951, 11, 1), new Date(1952, 4, 1), new Date(1952, 9, 1), new Date(1953, 2, 1), new Date(1953, 7, 1)], {months: 5}, ['April 1950', 'September', 'February 1951', 'July', 'December', 'May 1952', 'October', 'March 1953', 'August']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in months (years change every tick)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2010, 4, 1), new Date(2010, 11, 1), new Date(2011, 6, 1), new Date(2012, 2, 1), new Date(2012, 9, 1), new Date(2013, 4, 1), new Date(2013, 11, 1)], {months: 7}, ['May 2010', 'December', 'July 2011', 'March 2012', 'October', 'May 2013', 'December']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in months (second tick for years changing)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2010, 9, 1), new Date(2011, 1, 1), new Date(2011, 5, 1), new Date(2011, 9, 1), new Date(2012, 1, 1), new Date(2012, 5, 1), new Date(2012, 9, 1)], {months: 4}, ['October 2010', 'February 2011', 'June', 'October', 'February 2012', 'June', 'October']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in months and days (years, months and days changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(1950, 0, 16), new Date(1950, 4, 31), new Date(1950, 9, 16), new Date(1951, 2, 3), new Date(1951, 6, 18), new Date(1951, 11, 3), new Date(1952, 3, 18), new Date(1952, 8, 2), new Date(1953, 0, 17), new Date(1953, 5, 1)], {
          months: 4,
          days: 15
      ...
      QUnit.test('format is calculated by ticks and tickInterval in weeks', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(1950, 1, 5), new Date(1950, 1, 19), new Date(1950, 2, 5), new Date(1950, 2, 19), new Date(1950, 3, 2), new Date(1950, 3, 16), new Date(1950, 3, 30), new Date(1950, 4, 14)], {weeks: 2}, ['Feb 5', '19', 'Mar 5', '19', 'Apr 2', '16', '30', 'May 14']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in days', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(1950, 2, 2), new Date(1950, 2, 5), new Date(1950, 2, 8), new Date(1950, 2, 11), new Date(1950, 2, 14), new Date(1950, 2, 17), new Date(1950, 2, 20)], {days: 3}, ['Mar 2', '5', '8', '11', '14', '17', '20']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in days (month changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(1950, 2, 12), new Date(1950, 2, 22), new Date(1950, 3, 1), new Date(1950, 3, 11), new Date(1950, 3, 21), new Date(1950, 4, 1), new Date(1950, 4, 11), new Date(1950, 4, 21)], {days: 10}, ['Mar 12', '22', 'Apr 1', '11', '21', 'May 1', '11', '21']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in days (year, month changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 10, 29), new Date(2015, 11, 6), new Date(2015, 11, 14), new Date(2015, 11, 22), new Date(2015, 11, 30), new Date(2016, 0, 7), new Date(2016, 0, 15), new Date(2016, 0, 23), new Date(2016, 0, 31), new Date(2016, 1, 8)], {days: 8}, ['Nov 29', 'Dec 6', '14', '22', '30', 'January 2016', '15', '23', '31', 'Feb 8']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in days (year, month changed) 2', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2008, 11, 14), new Date(2008, 11, 21), new Date(2008, 11, 28), new Date(2009, 0, 4), new Date(2009, 0, 11), new Date(2009, 0, 18), new Date(2009, 0, 25), new Date(2009, 1, 1), new Date(2009, 1, 8)], {days: 7}, ['Dec 14', '21', '28', 'January 2009', '11', '18', '25', 'Feb 1', '8']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in hours', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 11, 14, 2), new Date(2015, 11, 14, 4), new Date(2015, 11, 14, 6), new Date(2015, 11, 14, 8), new Date(2015, 11, 14, 10), new Date(2015, 11, 14, 12), new Date(2015, 11, 14, 14), new Date(2015, 11, 14, 16)], {hours: 2}, ['14 2:00 AM', '4:00 AM', '6:00 AM', '8:00 AM', '10:00 AM', '12:00 PM', '2:00 PM', '4:00 PM']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in hours (days changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 11, 14, 10), new Date(2015, 11, 14, 16), new Date(2015, 11, 14, 22), new Date(2015, 11, 15, 4), new Date(2015, 11, 15, 10), new Date(2015, 11, 15, 16), new Date(2015, 11, 15, 22), new Date(2015, 11, 16, 4)], {hours: 6}, ['14 10:00 AM', '4:00 PM', '10:00 PM', '15 4:00 AM', '10:00 AM', '4:00 PM', '10:00 PM', '16 4:00 AM']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in hours (days changed) 2', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 11, 14, 6), new Date(2015, 11, 14, 12), new Date(2015, 11, 14, 18), new Date(2015, 11, 15, 0), new Date(2015, 11, 15, 6), new Date(2015, 11, 15, 12), new Date(2015, 11, 15, 18), new Date(2015, 11, 16, 0)], {hours: 6}, ['14 6:00 AM', '12:00 PM', '6:00 PM', '15 12:00 AM', '6:00 AM', '12:00 PM', '6:00 PM', '16 12:00 AM']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in days and hours', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 11, 14, 10), new Date(2015, 11, 15, 16), new Date(2015, 11, 16, 22), new Date(2015, 11, 17, 4), new Date(2015, 11, 18, 10), new Date(2015, 11, 19, 16), new Date(2015, 11, 20, 22), new Date(2015, 11, 21, 4)], {
          days: 1,
          hours: 6
      ...
      QUnit.test('format is calculated by ticks and tickInterval in days and hours (year, month changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 11, 28, 10), new Date(2015, 11, 29, 16), new Date(2015, 11, 30, 22), new Date(2015, 11, 31, 4), new Date(2016, 0, 1, 10), new Date(2016, 0, 2, 16), new Date(2016, 0, 3, 22)], {
          days: 1,
          hours: 6
      ...
      QUnit.test('format is calculated by ticks and tickInterval in years, days and hours', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2010, 0, 1, 10), new Date(2011, 0, 3, 16), new Date(2012, 0, 5, 22), new Date(2013, 0, 7, 4), new Date(2014, 0, 9, 10), new Date(2015, 0, 11, 16), new Date(2016, 0, 13, 22)], {
          years: 1,
          days: 2,
          hours: 6
      ...
      QUnit.test('format is calculated by ticks and tickInterval in years, months and hours', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2010, 0, 1, 10), new Date(2011, 2, 1, 16), new Date(2012, 4, 1, 22), new Date(2013, 6, 1, 4), new Date(2014, 8, 1, 10), new Date(2015, 10, 1, 16)], {
          years: 1,
          months: 2,
          hours: 6
      ...
      QUnit.test('format is calculated by ticks and tickInterval in hours and minutes (day changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 11, 14, 18, 10), new Date(2015, 11, 14, 20, 25), new Date(2015, 11, 14, 22, 40), new Date(2015, 11, 15, 0, 55), new Date(2015, 11, 15, 3, 10), new Date(2015, 11, 15, 5, 25)], {
          hours: 2,
          minutes: 15
      ...
      QUnit.test('format is calculated by ticks and tickInterval in hours and minutes (month changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 4, 31, 18, 10), new Date(2015, 4, 31, 20, 25), new Date(2015, 4, 31, 22, 40), new Date(2015, 5, 1, 0, 55), new Date(2015, 5, 1, 3, 10), new Date(2015, 5, 1, 5, 25)], {
          hours: 2,
          minutes: 15
      ...
      QUnit.test('format is calculated by ticks and tickInterval in days, hours and minutes (years changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 11, 26, 18, 10), new Date(2015, 11, 28, 20, 25), new Date(2015, 11, 30, 22, 40), new Date(2016, 0, 1, 0, 55), new Date(2016, 0, 3, 3, 10), new Date(2016, 0, 5, 5, 25)], {
          days: 2,
          hours: 2,
          minutes: 15
      ...
      QUnit.test('format is calculated by ticks and tickInterval in minutes and seconds', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 11, 26, 18, 10, 10), new Date(2015, 11, 26, 18, 25, 30), new Date(2015, 11, 26, 18, 40, 50), new Date(2015, 11, 26, 18, 56, 10)], {
          minutes: 15,
          seconds: 20
      ...
      QUnit.test('format is calculated by ticks and tickInterval in minutes and seconds (day changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 11, 27, 23, 25, 30), new Date(2015, 11, 27, 23, 40, 50), new Date(2015, 11, 27, 23, 56, 10), new Date(2015, 11, 28, 0, 11, 30), new Date(2015, 11, 28, 0, 26, 50)], {
          minutes: 15,
          seconds: 20
      ...
      QUnit.test('format is calculated by ticks and tickInterval in minutes and seconds (day changed after first tick)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 4, 27, 23, 56, 10), new Date(2015, 4, 28, 0, 11, 30), new Date(2015, 4, 28, 0, 26, 50), new Date(2015, 4, 28, 0, 42, 10)], {
          minutes: 15,
          seconds: 20
      ...
      QUnit.test('format is calculated by ticks and tickInterval in minutes and seconds (month, day changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 4, 31, 23, 25, 30), new Date(2015, 4, 31, 23, 40, 50), new Date(2015, 4, 31, 23, 56, 10), new Date(2015, 5, 1, 0, 11, 30), new Date(2015, 5, 1, 0, 26, 50)], {
          minutes: 15,
          seconds: 20
      ...
      QUnit.test('format is calculated by ticks and tickInterval in seconds (minutes changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 4, 31, 23, 25, 30), new Date(2015, 4, 31, 23, 25, 50), new Date(2015, 4, 31, 23, 26, 10), new Date(2015, 4, 31, 23, 26, 30), new Date(2015, 4, 31, 23, 26, 50), new Date(2015, 4, 31, 23, 27, 10), new Date(2015, 4, 31, 23, 27, 30), new Date(2015, 4, 31, 23, 27, 50), new Date(2015, 4, 31, 23, 28, 10)], {seconds: 20}, ['11:25:30 PM', '11:25:50 PM', '11:26:10 PM', '11:26:30 PM', '11:26:50 PM', '11:27:10 PM', '11:27:30 PM', '11:27:50 PM', '11:28:10 PM']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in milliseconds', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 4, 30, 23, 12, 59, 200), new Date(2015, 4, 30, 23, 12, 59, 250), new Date(2015, 4, 30, 23, 12, 59, 300), new Date(2015, 4, 30, 23, 12, 59, 350), new Date(2015, 4, 30, 23, 12, 59, 400), new Date(2015, 4, 30, 23, 12, 59, 450)], {milliseconds: 50}, ['11:12 PM 59.2s', '59.25s', '59.3s', '59.35s', '59.4s', '59.45s']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in milliseconds (second changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 4, 30, 23, 12, 57, 700), new Date(2015, 4, 30, 23, 12, 57, 800), new Date(2015, 4, 30, 23, 12, 57, 900), new Date(2015, 4, 30, 23, 12, 58, 0), new Date(2015, 4, 30, 23, 12, 58, 100), new Date(2015, 4, 30, 23, 12, 58, 200)], {milliseconds: 100}, ['11:12 PM 57.7s', '57.8s', '57.9s', '58s', '58.1s', '58.2s']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in milliseconds (minute changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 4, 30, 23, 12, 59, 700), new Date(2015, 4, 30, 23, 12, 59, 800), new Date(2015, 4, 30, 23, 12, 59, 900), new Date(2015, 4, 30, 23, 13, 0, 0), new Date(2015, 4, 30, 23, 13, 0, 100), new Date(2015, 4, 30, 23, 13, 0, 200)], {milliseconds: 100}, ['11:12 PM 59.7s', '59.8s', '59.9s', '11:13:00 PM', '0.1s', '0.2s']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in milliseconds (day, hour, minute, seconds changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 4, 30, 23, 59, 58, 600), new Date(2015, 4, 30, 23, 59, 58, 900), new Date(2015, 4, 30, 23, 59, 59, 200), new Date(2015, 4, 30, 23, 59, 59, 500), new Date(2015, 4, 30, 23, 59, 59, 800), new Date(2015, 4, 31, 0, 0, 0, 100), new Date(2015, 4, 31, 0, 0, 0, 400), new Date(2015, 4, 31, 0, 0, 0, 700), new Date(2015, 4, 31, 0, 0, 1, 0)], {milliseconds: 300}, ['11:59 PM 58.6s', '58.9s', '59.2s', '59.5s', '59.8s', '31 12:00:00 AM', '0.4s', '0.7s', '1s']);
      });
      QUnit.test('format is calculated by ticks and tickInterval in milliseconds (month ant etc. changed)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2015, 4, 31, 23, 59, 59, 200), new Date(2015, 4, 31, 23, 59, 59, 400), new Date(2015, 4, 31, 23, 59, 59, 600), new Date(2015, 4, 31, 23, 59, 59, 800), new Date(2015, 5, 1, 0, 0, 0, 0), new Date(2015, 5, 1, 0, 0, 0, 200)], {milliseconds: 200}, ['11:59 PM 59.2s', '59.4s', '59.6s', '59.8s', 'Jun 1 12:00:00 AM', '0.2s']);
      });
      ...
      QUnit.test('Datetime - single format by ticks', function(assert) {
        this.testFormat(assert, {
          ...
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2009, 11, 1), new Date(2010, 0, 1), new Date(2010, 1, 1)], 1, ['December 2009', 'January 2010', 'February 2010']);
      });
      QUnit.test('Numeric - no format', function(assert) {
        this.testFormat(assert, {
          ...
          argumentType: 'numeric',
          label: {visible: true}
        }, [10010, 11001, 20000], 1, ['10010', '11001', '20000']);
      });
      ...
      QUnit.test('DateTime - format is calculated by tick (minutes)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2010, 0, 1, 15, 10)], undefined, ['1/1/2010 3:10 PM']);
      });
      QUnit.test('DateTime - format is calculated by tick (milliseconds)', function(assert) {
        this.testFormat(assert, {
          argumentType: 'datetime',
          label: {visible: true}
        }, [new Date(2010, 0, 1, 15, 0, 2, 100)], undefined, ['1/1/2010 3:00:02 PM 100']);
      });
      ...
      QUnit.test('setPercentLabelFormat for user format', function(assert) {
        this.createAxis({label: {format: 'fixedPoint'}});
        this.axis.setPercentLabelFormat();
      ...
      QUnit.test('format datetime - difference is measured in milliseconds', function(assert) {
        this.testConstantLineLabelFormat(assert, [new Date(2010, 4, 21), new Date(2010, 4, 28), new Date(2010, 5, 4), new Date(2010, 5, 11), new Date(2010, 5, 18)], {days: 7}, '15.2s', new Date(2010, 4, 28, 0, 0, 15, 200), true);
      });
      QUnit.test('format datetime - difference is measured in longtime', function(assert) {
        this.testConstantLineLabelFormat(assert, [new Date(2010, 4, 21), new Date(2010, 4, 28), new Date(2010, 5, 4), new Date(2010, 5, 11), new Date(2010, 5, 18)], {days: 7}, '28 12:00:15 AM', new Date(2010, 4, 28, 0, 0, 15), true);
      });
      QUnit.test('format datetime - difference is measured in shorttime', function(assert) {
        this.testConstantLineLabelFormat(assert, [new Date(2010, 4, 21), new Date(2010, 4, 28), new Date(2010, 5, 4), new Date(2010, 5, 11), new Date(2010, 5, 18)], {days: 7}, '8:50 AM', new Date(2010, 4, 28, 8, 50), true);
      });
      QUnit.test('format datetime - difference is measured in days and shorttime', function(assert) {
        this.testConstantLineLabelFormat(assert, [new Date(2010, 4, 21), new Date(2010, 4, 28), new Date(2010, 5, 4), new Date(2010, 5, 11), new Date(2010, 5, 18)], {days: 7}, '29 8:50 AM', new Date(2010, 4, 29, 8, 50), true);
      });
      QUnit.test('format datetime - difference is measured in days', function(assert) {
        this.testConstantLineLabelFormat(assert, [new Date(2010, 4, 21), new Date(2010, 4, 28), new Date(2010, 5, 4), new Date(2010, 5, 11), new Date(2010, 5, 18)], {days: 7}, '29', new Date(2010, 4, 29), true);
      });
      QUnit.test('format datetime - difference is measured in month and days', function(assert) {
        this.testConstantLineLabelFormat(assert, [new Date(2010, 4, 18), new Date(2010, 4, 25), new Date(2010, 5, 1), new Date(2010, 5, 11), new Date(2010, 5, 18)], {days: 7}, 'May 31', new Date(2010, 4, 31), true);
      });
      QUnit.test('format datetime - difference is measured in month and years', function(assert) {
        this.testConstantLineLabelFormat(assert, [new Date(2010, 6, 1), new Date(2010, 9, 1), new Date(2011, 0, 1), new Date(2011, 3, 1), new Date(2011, 6, 1)], {months: 3}, 'December 2010', new Date(2010, 11, 12), true);
      });
      QUnit.module('getFormattedValue', environment);
      QUnit.test('No value - return null', function(assert) {
        this.createAxis({label: {visible: false}});
        this.axis.setBusinessRange({});
        this.generatedTickInterval = 100;
        this.axis.draw(this.canvas);
      ...
      QUnit.test('Pass options with format, axis label has format - use passed format', function(assert) {
        ...
        this.generatedTickInterval = 100;
        this.axis.draw(this.canvas);
        var result = this.axis.getFormattedValue(1002, {format: {
            type: 'fixedPoint',
            precision: 2
          }});
      ...
      QUnit.test('No custom format - use auto formatting', function(assert) {
        ...
        var date1 = new Date(2011, 5, 30, 0, 0, 0);
        var date2 = new Date(2011, 6, 1, 0, 0, 0);
        var date3 = new Date(2011, 6, 2, 0, 0, 0);
        var date4 = new Date(2011, 6, 2, 23, 59, 59);
        this.createAxis({
          isHorizontal: true,
          argumentType: 'datetime',
          marker: {
      ...
      QUnit.test('Tick labels do not show date transition', function(assert) {
        ...
        var date1 = new Date(2011, 5, 30, 12, 0, 0);
        var date2 = new Date(2011, 6, 1, 0, 0, 0);
        var date3 = new Date(2011, 6, 1, 12, 0, 0);
        this.createAxis({
          isHorizontal: true,
          argumentType: 'datetime',
          label: {visible: true},
      ...
      QUnit.test('interval is equal difference unit. IntervalEnd has next high unit', function(assert) {
        ...
        assert.strictEqual(this.axis.formatRange(new Date(2018, 2, 1), new Date(2018, 2, 2, 1), {
          days: 1,
          hours: 1
        }), 'March 2018, 1 12:00 AM - 2 1:00 AM', 'Day interval and hour');
      });
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","viz/translators/translator2d","viz/translators/range","viz/axes/tick_generator","viz/axes/base_axis","../../helpers/vizMocks.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("viz/translators/translator2d"), require("viz/translators/range"), require("viz/axes/tick_generator"), require("viz/axes/base_axis"), require("../../helpers/vizMocks.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=axisFormatting.tests.js.map