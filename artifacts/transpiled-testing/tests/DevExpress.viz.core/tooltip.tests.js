...
(["testing/tests/DevExpress.viz.core/tooltip.tests.js"], ["jquery","../../helpers/vizMocks.js","viz/core/tooltip","viz/core/utils","viz/core/renderers/renderer","core/dom_adapter","core/utils/size","../../helpers/sizeMocks.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.viz.core/tooltip.tests.js", ["jquery", "../../helpers/vizMocks.js", "viz/core/tooltip", "viz/core/utils", "viz/core/renderers/renderer", "core/dom_adapter", "core/utils/size", "../../helpers/sizeMocks.js"], function($__export) {
  "use strict";
  var $,
      vizMocks,
      tooltipModule,
  ...
  function getCloudPoints() {
    var cloud = this.renderer.path.lastCall.returnValue;
    var path = cloud._stored_settings.d.replace(/a 0 0 0 0 1 0 0/g, '');
    var regExp = /(?:(-?\d+),(-?\d+))/g;
    var m;
    var coords = [];
    do {
  ...
  return {
    setters: [function($__m) {
      ...
      initializeSizeMocks = $__m.initializeSizeMocks;
      destroySizeMocks = $__m.destroySizeMocks;
    }],
    execute: function() {
      Tooltip = tooltipModule.Tooltip;
      QUnit.testStart(function() {
        $('<div>').attr('class', 'some-correct-class-name').appendTo($('#qunit-fixture'));
      });
      CANVAS = {
        left: 0,
        top: 0,
      ...
      QUnit.module('Main functionality', {
        beforeEach: function() {
          ...
          this.patchFontOptions = sinon.spy(function() {
            return this._oldPatchFontOptions.apply(null, arguments);
          }.bind(this));
      ...
      QUnit.test('Create tooltip', function(assert) {
        ...
        assert.deepEqual(tooltip._renderer.ctorArgs, [{
          pathModified: 'pathModified-option',
          container: tooltip._wrapper[0]
        }], 'renderer with rendererOptions');
        assert.ok(tooltip._wrapper, 'wrapper');
        var wrapper = tooltip._wrapper.get(0);
      ...
      QUnit.test('Set options. All options', function(assert) {
        var et = {event: 'trigger'};
        var tooltip = new Tooltip({eventTrigger: et});
        var result = tooltip.setOptions(this.options);
        ...
        assert.equal(tooltip._textFontStyles, this.patchFontOptions.firstCall.returnValue);
        assert.notEqual(tooltip._textFontStyles.color, this.options.font.color);
        assert.equal(tooltip._textFontStyles.color, tooltip._textFontStyles.fill);
        assert.notOk(tooltip._textFontStyles.color.opacity);
      ...
      QUnit.test('Append tooltip to container on shown', function(assert) {
        $('#qunit-fixture').append('<div class=\'tooltip-container\'></div>').append('<div class=\'tooltip-container\'></div>');
        var et = {
          eventTrigger: function() {},
          cssClass: 'test-tooltip'
        };
        var tooltip = new Tooltip(et);
      ...
      QUnit.test('Tooltip should be appended in the closest element to root', function(assert) {
        $('#qunit-fixture').append('<div class=\'tooltip-container far\'></div>').append('<div class=\'tooltip-container\'><div id=\'root\'></div></div>');
        var et = {
          eventTrigger: function() {},
          cssClass: 'test-tooltip',
          widgetRoot: $('#root').get(0)
        };
        var tooltip = new Tooltip(et);
        this.options.container = '.tooltip-container';
        tooltip.setOptions(this.options);
      ...
      QUnit.test('Container has offset', function(assert) {
        var $container = $('<div class="tooltipContainer"></div>');
        $container.css({
          position: 'absolute',
          left: '20px',
          top: '20px',
        ...
        var tooltip = new Tooltip({eventTrigger: function() {}});
        this.options.container = '.tooltipContainer';
        tooltip.update(this.options);
        tooltip.show({description: 'some-text'}, {
          x: 100,
          y: 200
        });
      ...
      QUnit.test('Body has vertical scroll', function(assert) {
        var container = $('<div>').css('height', '4000px').appendTo(domAdapter.getDocument().body);
        try {
          var tooltip = new Tooltip({eventTrigger: function() {}});
          tooltip.update(this.options);
          tooltip.show({description: 'some-text'}, {
      ...
      QUnit.test('Body has horizontal scroll', function(assert) {
        ...
        var documentScrollLeft = documentElement.scrollLeft;
      ...
      QUnit.test('Set options. Two times', function(assert) {
        ...
        var tooltip = new Tooltip({eventTrigger: et});
        tooltip.setOptions(this.options);
        var result = tooltip.setOptions(options2);
        assert.equal(tooltip, result);
      ...
      QUnit.test('Update', function(assert) {
        ...
        var result = tooltip.update(this.options);
        assert.equal(tooltip, result);
      ...
      QUnit.test('formatValue. Default format', function(assert) {
        ...
        tooltip.setOptions($.extend(this.options, {format: ''}));
      ...
      QUnit.test('formatValue. Null argumentFormat', function(assert) {
        var tooltip = new Tooltip({eventTrigger: {}});
        tooltip.setOptions($.extend(this.options, {argumentFormat: null}));
        assert.equal(tooltip.formatValue(12, 'argument'), 12);
      });
      QUnit.test('formatValue. Null valueFormat', function(assert) {
        var tooltip = new Tooltip({eventTrigger: {}});
        tooltip.setOptions($.extend(this.options, {format: null}));
      ...
      QUnit.module('Manipulation', {
        beforeEach: function() {
          ...
          this.tooltip = tooltip = new Tooltip({
            ...
            widget: {_getTemplate: function(callback) {
                return {render: function(arg) {
          ...
          if (tooltip._textGroup && tooltip._textGroup.stub('getBBox')) {
            tooltip._textGroup.getBBox = sinon.spy(function() {
              return {
                x: -10,
                y: -5,
                width: 20,
      ...
      QUnit.test('Show preparations. W/o customize, empty text', function(assert) {
        ...
        assert.deepEqual(this.tooltip._state, {a: 'b'}, 'state');
      ...
      QUnit.test('Show preparations. W/o customize, w/ text', function(assert) {
        ...
        var cloudSettings = this.renderer.path.lastCall.returnValue._stored_settings;
      ...
      QUnit.test('Show preparations. W/o customize, w/ text from \'description\' filed', function(assert) {
        ...
        this.tooltip._wrapper.appendTo = sinon.spy();
        this.tooltip._state = {a: 'b'};
        var formatObject = {description: 'some-text'};
        var result = this.tooltip.show(formatObject, {
          x: 100,
          y: 200,
          offset: 300
      ...
      QUnit.test('Show preparations. W/ customize empty text, empty text', function(assert) {
        this.options.customizeTooltip = sinon.spy(function() {
          return {
            ...
            borderColor: 'cColor2',
            fontColor: 'cColor3',
            someAnotherProperty: 'some-value'
          };
        });
        this.tooltip.update(this.options);
        this.tooltip.move = sinon.spy(function() {
      ...
      QUnit.test('Show preparations. Certain container', function(assert) {
        this.options.customizeTooltip = null;
        this.options.container = '.some-correct-class-name';
        this.tooltip._getCanvas = function() {
          return CANVAS;
        };
        this.tooltip.update(this.options);
        this.tooltip.move = sinon.spy(function() {
      ...
      QUnit.test('Show. W/o params', function(assert) {
        ...
        try {
          ...
          implementationsMap.for(this.tooltip._textGroupHtml).getWidth = sinon.spy(function() {
            return 85;
          });
          implementationsMap.for(this.tooltip._textGroupHtml).getHeight = sinon.spy(function() {
            return 43;
          });
          ...
          assert.deepEqual(this.tooltip._text.attr.firstCall.args, [{
            text: 'some-text',
            'class': 'tooltip_class',
            'pointer-events': 'none'
          }]);
      ...
      QUnit.test('Show. W/o params. Html', function(assert) {
        ...
        this.options.customizeTooltip = function() {
      ...
      QUnit.test('Do not show tooltip if html is not set in contentTemplate', function(assert) {
        ...
        this.options.contentTemplate = function(_, container, onRendered) {
          onRendered();
        };
        this.tooltip.update(this.options);
        this.resetTooltipMocks();
        ...
        var formatObject = {valueText: 'some-text'};
        var callback = sinon.stub();
        this.tooltip.show(formatObject, {
          x: 100,
          y: 200,
          offset: 300
        }, eventData, undefined, callback);
      ...
      QUnit.test('Tooltip shown twice with template. Async template emulation', function(assert) {
        ...
        var renderTemplate = function(container, onRendered, content) {
        ...
        this.options.contentTemplate.getCalls().forEach(function(c, index) {
      ...
      QUnit.test('check cursor on tooltip, interactive', function(assert) {
        ...
        tooltip.update(this.options);
        tooltip.plaque.getBBox = sinon.stub().returns({
          x: 4,
          y: 5,
          width: 20,
          height: 10
      ...
      QUnit.test('Show preparations. Use external customizeText', function(assert) {
        this.options.customizeTooltip = sinon.spy(function() {
          return {text: 'some-customized-text'};
        });
        this.tooltip.update(this.options);
        this.tooltip.move = sinon.spy(function() {
          return this;
        ...
        var result = this.tooltip.show(formatObject, {
          ...
          return {text: 'custom text from external customizeText'};
        });
        assert.strictEqual(result, true);
      ...
      QUnit.test('\'tooltipHidden\' is triggered on show if tooltip is already shown', function(assert) {
        ...
        var eventData2 = {tag: 'data-2'};
        this.tooltip.update(this.options);
        this.tooltip.show({valueText: 'text-1'}, {
          x: 10,
          y: 20
        }, eventData1);
        this.tooltip.show({valueText: 'text-2'}, {
          x: 10,
          y: 20
        }, eventData2);
      ...
      QUnit.test('Hide.', function(assert) {
        ...
        this.options.customizeTooltip = null;
        this.tooltip.update(this.options).show({valueText: 'some-text'}, {
          x: 10,
          y: 20
        }, eventObject);
      ...
      QUnit.test('forceEvents. rise tooltipShown event, but tooltip not shown', function(assert) {
        ...
        this.tooltip._wrapper.appendTo = sinon.spy();
        this.tooltip._state = {a: 'b'};
        var result = this.tooltip.show({valueText: 'some-text'}, {
          x: 100,
          y: 200,
          offset: 50
        }, {});
        assert.strictEqual(result, true);
        assert.deepEqual(this.eventTrigger.lastCall.args, ['tooltipShown', {
          x: 100,
          y: 150
        }], 'event is triggered');
        assert.deepEqual(this.tooltip._state, {a: 'b'}, 'state');
      ...
      QUnit.module('Movements', {
        beforeEach: function() {
          ...
          that.tooltip = tooltip = new Tooltip({
            eventTrigger: that.eventTrigger,
            cssClass: 'test-title-class'
          });
        ...
        afterEach: function() {
          this.getComputedStyle && this.getComputedStyle.restore();
          $('body').css({margin: this._initialBodyMargin});
      ...
      QUnit.test('Center-top side of page', function(assert) {
        ...
        assert.deepEqual(this.tooltip._renderer.resize.firstCall.args, [60 + 10 + 20, 40 + 9 + 21 + this.options.arrowLength]);
        assert.equal(wrapper.css('left'), '360px');
        assert.equal(wrapper.css('top'), '101px');
      ...
      QUnit.test('Center-top side of page, Html', function(assert) {
        ...
        try {
          this.tooltip._textGroupHtml.css = sinon.spy();
          implementationsMap.for(this.tooltip._textHtml).getWidth = sinon.spy(function() {
            return 59.2;
          });
          this.tooltip.show({valueText: 'some-text'}, {
            x: 400,
          ...
          assert.deepEqual(this.tooltip._textGroupHtml.css.getCall(1).args, [{
            left: 370,
            top: 135
          }]);
      ...
      QUnit.test('Orientation is not changed', function(assert) {
        ...
        assert.equal(this.tooltip._renderer.resize.callCount, 1, 'renderer resize');
        assert.equal(wrapper.css('left'), '460px');
        assert.equal(wrapper.css('top'), '331px');
      });
      ...
      QUnit.test('Orientation is changed. Html', function(assert) {
        ...
        this.tooltip._textGroupHtml.css = sinon.spy();
        this.tooltip.move(800, 300, 30);
        assert.deepEqual(this.tooltip._textGroupHtml.css.getCall(0).args, [{
          left: 702,
          top: 205
        }]);
        assert.equal(this.tooltip._renderer.resize.callCount, 1, 'renderer resize');
      ...
      QUnit.test('Show after move w/o orientation changing', function(assert) {
        ...
        this.resetTooltipMocks();
        this.tooltip.show({valueText: 'some-long-text'}, {
          x: 500,
          y: 400,
          offset: 30
        });
        ...
        assert.equal(wrapper.css('left'), '460px');
        assert.equal(wrapper.css('top'), '311px');
      });
      ...
      QUnit.test('Out of bounds vertically. Left side of page', function(assert) {
        ...
        assert.equal(this.tooltip._wrapper.css('left'), '10px');
        assert.equal(this.tooltip._wrapper.css('top'), '11px');
      });
      QUnit.test('Out of bounds vertically. Center of page', function(assert) {
        ...
        assert.equal(this.tooltip._renderer.resize.callCount, 1, 'renderer resize');
        assert.deepEqual(this.tooltip._renderer.resize.firstCall.args, [60 + 10 + 20, 1030]);
        assert.equal(this.tooltip._wrapper.css('left'), '360px');
        assert.equal(this.tooltip._wrapper.css('top'), '11px');
      });
      QUnit.test('Out of bounds vertically. Right side of page', function(assert) {
        ...
        assert.equal(this.tooltip._renderer.resize.callCount, 1, 'renderer resize');
        assert.deepEqual(this.tooltip._renderer.resize.firstCall.args, [60 + 10 + 20, 1030]);
        assert.equal(this.tooltip._wrapper.css('left'), '710px');
        assert.equal(this.tooltip._wrapper.css('top'), '11px');
      });
      QUnit.test('Out of bounds horizontally. Top side of page', function(assert) {
        ...
        assert.equal(this.tooltip._wrapper.css('left'), '-105px');
        assert.equal(this.tooltip._wrapper.css('top'), '101px');
      });
      QUnit.test('Out of bounds horizontally. Center of page', function(assert) {
        ...
        assert.deepEqual(this.tooltip._renderer.resize.firstCall.args, [1030, 40 + 9 + 21 + this.options.arrowLength]);
        assert.equal(this.tooltip._wrapper.css('left'), '-105px');
        assert.equal(this.tooltip._wrapper.css('top'), '211px');
      });
    }
  };
});
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/vizMocks.js","viz/core/tooltip","viz/core/utils","viz/core/renderers/renderer","core/dom_adapter","core/utils/size","../../helpers/sizeMocks.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/vizMocks.js"), require("viz/core/tooltip"), require("viz/core/utils"), require("viz/core/renderers/renderer"), require("core/dom_adapter"), require("core/utils/size"), require("../../helpers/sizeMocks.js"));
  else
