...
(["testing/tests/DevExpress.viz.core/baseWidget.tests.js"], ["viz/core/errors_warnings","jquery","core/version","core/utils/resize_callbacks","core/component_registrator","core/utils/console","core/resize_observer","core/utils/type","viz/core/base_widget","viz/core/base_widget.utils","viz/core/base_theme_manager","viz/core/renderers/renderer","../../helpers/vizMocks.js","core/utils/size","viz/core/export"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.core/baseWidget.tests.js', ['viz/core/errors_warnings', 'jquery', 'core/version', 'core/utils/resize_callbacks', 'core/component_registrator', 'core/utils/console', 'core/resize_observer', 'core/utils/type', 'viz/core/base_widget', 'viz/core/base_widget.utils', 'viz/core/base_theme_manager', 'viz/core/renderers/renderer', '../../helpers/vizMocks.js', 'core/utils/size', 'viz/core/export'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    /* global currentTest */

    const errorsModule = $__require('viz/core/errors_warnings');
    ...
    const { version } = $__require('core/version');
    ...
    const resizeObserverSingleton = $__require('core/resize_observer');
    ...
    const DEBUG_createEventTrigger = $__require('viz/core/base_widget.utils').DEBUG_createEventTrigger;
    const DEBUG_createResizeHandler = $__require('viz/core/base_widget.utils').DEBUG_createResizeHandler;
    ...
    $__require('viz/core/base_widget');

    // TODO: Move export tests to a separate file
    $__require('viz/core/export');
    ...
    QUnit.test('Theme manager callback', function (assert) {
        this.onGetAnimationOptions = function () {
    ...
    QUnit.module('Order of methods calls', $.extend({}, environment, {
        beforeEach: function () {
            ...
            test.spies = ['onInitCore', 'onGetDefaultSize', 'onApplySize', 'onClean', 'onRender', 'onDisposeCore'];
        ...
        checkResized: function (assert) {
            this.checkOrder(assert, [this.onGetDefaultSize.lastCall, this.renderer.resize.lastCall, this.onApplySize.lastCall]);
    ...
    QUnit.test('Create and destroy', function (assert) {
        ...
        this.checkOrder(assert, [this.onGetDefaultSize.lastCall, rendererModule.Renderer.lastCall, this.renderer.resize.lastCall, this.onInitCore.lastCall, onInitialized.lastCall, this.onRender.lastCall, this.onApplySize.lastCall, this.onClean.lastCall, this.onDisposeCore.lastCall, this.renderer.dispose.lastCall]);
    });
    ...
    QUnit.test('Create and destroy / hidden', function (assert) {
        ...
        this.checkOrder(assert, [this.onGetDefaultSize.lastCall, rendererModule.Renderer.lastCall, this.renderer.resize.lastCall, this.onInitCore.lastCall, this.onRender.lastCall, this.onApplySize.lastCall, this.onClean.lastCall, this.onDisposeCore.lastCall, this.renderer.dispose.lastCall]);
    });
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["viz/core/errors_warnings","jquery","core/version","core/utils/resize_callbacks","core/component_registrator","core/utils/console","core/resize_observer","core/utils/type","viz/core/base_widget","viz/core/base_widget.utils","viz/core/base_theme_manager","viz/core/renderers/renderer","../../helpers/vizMocks.js","core/utils/size","viz/core/export"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("viz/core/errors_warnings"), require("jquery"), require("core/version"), require("core/utils/resize_callbacks"), require("core/component_registrator"), require("core/utils/console"), require("core/resize_observer"), require("core/utils/type"), require("viz/core/base_widget"), require("viz/core/base_widget.utils"), require("viz/core/base_theme_manager"), require("viz/core/renderers/renderer"), require("../../helpers/vizMocks.js"), require("core/utils/size"), require("viz/core/export"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=baseWidget.tests.js.map