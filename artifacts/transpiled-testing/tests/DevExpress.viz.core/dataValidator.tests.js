...
(["testing/tests/DevExpress.viz.core/dataValidator.tests.js"], ["jquery","../../helpers/vizMocks.js","core/utils/common","viz/series/base_series","viz/components/data_validator","../../helpers/chartMocks.js"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.core/dataValidator.tests.js', ['jquery', '../../helpers/vizMocks.js', 'core/utils/common', 'viz/series/base_series', 'viz/components/data_validator', '../../helpers/chartMocks.js'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const vizMocks = $__require('../../helpers/vizMocks.js');
    const commonUtils = $__require('core/utils/common');
    ...
    QUnit.test('Numbers', function (assert) {
        checkTypes(assert, [{ arg: 11, val: 1 }, { arg: 22, val: 2 }, { arg: 33, val: 3 }], createGroupsData(), 'continuous', 'numeric', 'continuous', 'numeric');
    });
    ...
    QUnit.test('DateTime', function (assert) {
        ...
        checkTypes(assert, [{ arg: date1000, val: date4000 }, { arg: date2000, val: date5000 }, { arg: date3000, val: date6000 }], createGroupsData(), 'continuous', 'datetime', 'continuous', 'datetime');
    });

    QUnit.test('String', function (assert) {
        checkTypes(assert, [{ arg: '1000', val: '1' }, { arg: '2000', val: '2' }, { arg: '3000', val: '3' }], createGroupsData(), 'discrete', 'string', 'discrete', 'string');
    });

    QUnit.test('String & Numeric', function (assert) {
        checkTypes(assert, [{ arg: 1000, val: '1' }, { arg: 2000, val: '2' }, { arg: 3000, val: '3' }], createGroupsData(), 'continuous', 'numeric', 'discrete', 'string');
    });

    QUnit.test('Numbers. Categories.', function (assert) {
        checkTypes(assert, [{ arg: 11, val: 1 }, { arg: 22, val: 2 }, { arg: 33, val: 3 }, { arg: 44, val: 4 }, { arg: 55, val: 5 }], createGroupsData({
    ...
    QUnit.test('DateTime. Categories.', function (assert) {
        ...
        checkTypes(assert, [{ arg: date1000, val: date10001 }, { arg: date2000, val: date20001 }, { arg: date3000, val: date30001 }, { arg: date4000, val: date40001 }, { arg: date5000, val: date50001 }], createGroupsData({
    ...
    QUnit.test('String. Categories.', function (assert) {
        checkTypes(assert, [{ arg: '1000', val: '1' }, { arg: '2000', val: '2' }, { arg: '3000', val: '3' }, { arg: '4000', val: '4' }, { arg: '5000', val: '5' }], createGroupsData({
    ...
    QUnit.test('Custom field name. Numbers.', function (assert) {
        checkTypes(assert, [{ arg1: 11, val1: 1 }, { arg1: 22, val1: 2 }, { arg1: 33, val1: 3 }], createGroupsData({
            argumentField: 'arg1',
            valueFields: ['val1']
    ...
    QUnit.test('Custom field name. DateTime.', function (assert) {
        ...
        checkTypes(assert, [{ arg1: date1000, val1: date10001 }, { arg1: date2000, val1: date20001 }, { arg1: date3000, val1: date30001 }], createGroupsData({
            argumentField: 'arg1',
            valueFields: ['val1']
    ...
    QUnit.test('Custom field name. String.', function (assert) {
        checkTypes(assert, [{ arg1: '1000', val1: '1' }, { arg1: '2000', val1: '2' }, { arg1: '3000', val1: '3' }], createGroupsData({
            argumentField: 'arg1',
            valueFields: ['val1']
        }), 'discrete', 'string', 'discrete', 'string');
    });
    ...
    QUnit.test('Custom field name. Numbers. Categories.', function (assert) {
        checkTypes(assert, [{ arg1: 11, val1: 1 }, { arg1: 22, val1: 2 }, { arg1: 33, val1: 3 }, { arg1: 44, val1: 4 }, { arg1: 55, val1: 5 }], createGroupsData({
            argumentField: 'arg1',
            argumentCategories: [11, 22, 33, 44, 55],
            valueFields: ['val1'],
            valueCategories: [1, 2, 3, 4, 5]
    ...
    QUnit.test('Custom field name. DateTime. Categories.', function (assert) {
        ...
        checkTypes(assert, [{ arg1: date1000, val1: date10001 }, { arg1: date2000, val1: date20001 }, { arg1: date3000, val1: date30001 }, { arg1: date4000, val1: date40001 }, { arg1: date5000, val1: date50001 }], createGroupsData({
            argumentField: 'arg1',
            argumentCategories: [new Date(1000), new Date(2000), new Date(3000), new Date(4000), new Date(5000)],
            valueFields: ['val1'],
            valueCategories: [new Date(10001), new Date(20001), new Date(30001), new Date(40001), new Date(50001)]
    ...
    QUnit.test('Custom field name. String. Categories.', function (assert) {
        checkTypes(assert, [{ arg1: '1000', val1: '1' }, { arg1: '2000', val1: '2' }, { arg1: '3000', val1: '3' }, { arg1: '4000', val1: '4' }, { arg1: '5000', val1: '5' }], createGroupsData({
            argumentField: 'arg1',
            argumentCategories: ['1000', '2000', '3000', '4000', '5000'],
            valueFields: ['val1'],
            valueCategories: ['1', '2', '3', '4', '5']
    ...
    QUnit.test('First null value', function (assert) {
        checkTypes(assert, [{ arg: null, val: null }, { arg: null, val: 2 }, { arg: 33, val: 3 }], createGroupsData(), 'continuous', 'numeric', 'continuous', 'numeric');
    });
    ...
    QUnit.test('Revalidate. From numbers to Datetime and Strings', function (assert) {
        ...
        checkTypes(assert, [{ arg: date1000, val: '1000' }, { arg: date2000, val: '2000' }, { arg: date3000, val: '3000' }], group, 'continuous', 'datetime', 'discrete', 'string', 2);
    });
    ...
    QUnit.test('DateTime (auto). Discrete axis', function (assert) {
        ...
        checkTypes(assert, [{ arg: date1000, val: date10001 }, { arg: date2000, val: date20001 }, { arg: date3000, val: date30001 }], createGroupsData({
            argumentAxisType: 'discrete',
            valueAxisType: 'discrete'
        }), 'discrete', 'datetime', 'discrete', 'datetime');
    });
    ...
    QUnit.test('Validate incorrect type', function (assert) {
        checkTypes(assert, [{ arg: 1, val: 5 }, { arg: 2, val: 6 }], createGroupsData({
            argumentType: 'abc',
            valueType: 'def',
            argumentField: 'arg',
            valueFields: ['val']
    ...
    QUnit.test('Argument & Value. Numeric', function (assert) {
        checkTypes(assert, [{ arg1: 1, arg2: 4, val1: 11, val2: 44 }, { arg1: 2, arg2: 5, val1: 22, val2: 55 }, { arg1: 3, arg2: 6, val1: 33, val2: 66 }], createGroupsData({
            argumentField: 'arg1',
    ...
    QUnit.test('Argument & Value. String', function (assert) {
        checkTypes(assert, [{ arg1: '1', arg2: 4, val1: 11, val2: 44 }, { arg1: 2, arg2: 5, val1: 22, val2: '55' }, { arg1: 3, arg2: 6, val1: 33, val2: 66 }], createGroupsData({
            argumentField: 'arg1',
            valueFields: ['val1', 'val2']
        }), 'discrete', 'string', 'discrete', 'string', null, { checkTypeForAllData: true });
    });
    ...
    QUnit.test('Argument & Value. Date', function (assert) {
        ...
        checkTypes(assert, [{ arg1: 4000, arg2: 4000, val1: date2, val2: 5000 }, { arg1: 6000, arg2: 7000, val1: 8000, val2: 9000 }, { arg1: date1, arg2: date2, val1: 11000, val2: 12000 }], createGroupsData({
            argumentField: 'arg1',
            valueFields: ['val1', 'val2']
        }), 'continuous', 'datetime', 'continuous', 'datetime', null, { checkTypeForAllData: true });
    });
    ...
    QUnit.test('Argument - Numeric. Value - Date', function (assert) {
        ...
        checkTypes(assert, [{ arg1: 1, arg2: 11, val1: date1000, val2: date4000 }, { arg1: 2, arg2: 22, val1: date2000, val2: 123 }, { arg1: 3, arg2: 33, val1: date3000, val2: 203 }], createGroupsData({
            argumentField: 'arg1',
            valueFields: ['val1', 'val2']
    ...
    QUnit.test('Argument - Numeric. Value - String', function (assert) {
        ...
        checkTypes(assert, [{ arg1: 1, arg2: 4, val1: '11', val2: date1000 }, { arg1: 2, arg2: 5, val1: '22', val2: 55 }, { arg1: 3, arg2: 6, val1: '33', val2: '66' }], createGroupsData({
            argumentField: 'arg1',
            valueFields: ['val1', 'val2']
    ...
    QUnit.test('Numeric from numbers. logarithmic axis', function (assert) {
        ...
        const parsedData = testValidateData([{ arg: 1, val: 0 }, { arg: 2, val: 22 }, { arg: 0, val: 33 }, { arg: -4, val: -44 }, { arg: 5, val: 0 }], createGroupsData({
            argumentType: 'numeric',
            valueType: 'numeric',
    ...
    QUnit.test('DataSource with null values. logarithmic axis', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: null }, { arg: 2, val: 22 }, { arg: null, val: 33 }, { arg: 4, val: 44 }, { arg: 5, val: 55 }], createGroupsData({
            argumentType: 'numeric',
            valueType: 'numeric',
            valueAxisType: 'logarithmic',
            argumentAxisType: 'logarithmic'
    ...
    QUnit.test('Numeric from dates', function (assert) {
        ...
        const parsedData = testValidateData([{ arg: date1, val: date11 }, { arg: date2, val: date22 }, { arg: date3, val: date33 }, { arg: date4, val: date44 }, { arg: date5, val: date55 }], createGroupsData({
            argumentType: 'numeric',
            valueType: 'numeric'
        }));
    ...
    QUnit.test('Datetime from strings', function (assert) {
        ...
        const parsedData = testValidateData([{ arg: date1.toString(), val: date11.toString() }, { arg: date2.toString(), val: date22.toString() }, { arg: date3.toString(), val: date33.toString() }, { arg: date4.toString(), val: date44.toString() }, { arg: date5.toString(), val: date55.toString() }], createGroupsData({
            argumentType: 'datetime',
            valueType: 'datetime'
        }));
    ...
    QUnit.test('Datetime from numbers', function (assert) {
        ...
        const parsedData = testValidateData([{ arg: 1000, val: 10000 }, { arg: 2000, val: 20000 }, { arg: 3000, val: 30000 }, { arg: 4000, val: 40000 }, { arg: 5000, val: 50000 }], createGroupsData({
            argumentType: 'datetime',
            valueType: 'datetime'
        }));
    ...
    QUnit.test('Size field values always parsed to Numeric', function (assert) {
        const parsedData = testValidateData([{ arg: '1', val: '11', size: '111' }, { arg: '2', val: '22', size: '222' }, { arg: '3', val: '33', size: '333' }], createGroupsData({
            argumentType: 'string',
            valueType: 'datetime',
            sizeField: 'size'
        }));
    ...
    QUnit.test('Parsed data should have all fields from source data', function (assert) {
        const parsedData = testValidateData([{ arg: 1, val: 11, extra: '1' }, { arg: 2, val: 22, extra: '2' }], createGroupsData({
            argumentType: 'numeric',
            valueType: 'numeric'
        }));
    ...
    QUnit.test('Two axes, first string discrete, second numeric discrete', function (assert) {
        ...
        const parsedData = testValidateData([{ arg: 'A', val: '1', val1: 10 }], groupsData1);
    ...
    QUnit.test('Can not parse Datetime arguments', function (assert) {
        ...
        const parsedData = testValidateData([{ arg: new Date(1000).toString(), val: 1 }, { arg: 2000, val: 2 }, { arg: '3000', val: 3 }, { arg: new Date(4) + 'ff', val: 4 }, { arg: 'Thu Jan 01 1970 00:00:05 GMT+0000', val: 5 }, { arg: '400sdf', val: 5 }], groups);
    ...
    QUnit.test('Order of the series should be correct', function (assert) {
        ...
        const parsedData = testValidateData([{ arg: 'cat1', val: 3 }, { arg: 'cat2', val: 4 }, { arg: 'cat3', val: 5 }, { arg: 'cat4', val: 5 }, { arg: 'cat5', val: 4 }, { arg: 'cat6', val: 5 }, { arg: 'cat7', val: 5 }, { arg: 'cat8', val: 5 }, { arg: 'cat9', val: 5 }, { arg1: 'cat6', val: 1 }, { arg1: 'cat7', val: 2 }], groups);
    ...
    QUnit.test('Can not parse Numeric values', function (assert) {
        ...
        const parsedData = testValidateData([{ val: '1', arg: 1 }, { val: 'df', arg: 2 }, { val: '3', arg: 3 }, { val: new Date().toString(), arg: 4 }, { val: '5', arg: 5 }], groupsData);
    ...
    QUnit.test('Can not parse Datetime values', function (assert) {
        ...
        const parsedData = testValidateData([{ val: new Date(1000).toString(), arg: 1 }, { val: 2000, arg: 2 }, { val: '3000', arg: 3 }, { val: new Date(4) + 'ff', arg: 4 }, { val: 'Thu Jan 01 1970 00:00:05 GMT+0000', arg: 5 }, { val: '400sdf', arg: 5 }], groupsData);
    ...
    QUnit.test('Can not parse sizes', function (assert) {
        ...
        const parsedData = testValidateData([{ size: '1', val: 1, arg: 1 }, { size: 'df', val: 1, arg: 2 }, { size: '3', val: 1, arg: 3 }, { size: new Date().toString(), val: 1, arg: 4 }, { size: '5', val: 1, arg: 5 }], groupsData);
    ...
    QUnit.test('Numeric, series with same field, sortingMethod true - sort data by argument', function (assert) {
        const data = [{ arg: 2, val: 11, val1: 333 }, { arg: 1, val: 55, val1: 444 }, { arg: 5, val: 33, val1: 111 }, { arg: 4, val: 22, val1: 222 }, { arg: 3, val: 44, val1: 555 }];
    ...
    QUnit.test('Numeric, series with different fields, sortingMethod true - sort data by argument', function (assert) {
        const data = [{ arg: 2, val: 11, arg1: 4, val1: 333 }, { arg: 1, val: 55, arg1: 3, val1: 444 }, { arg: 5, val: 33, arg1: 1, val1: 111 }, { arg: 4, val: 22, arg1: 5, val1: 222 }, { arg: 3, val: 44, arg1: 2, val1: 555 }, { arg: 6, val: 66 }];
        const group1 = createGroupsData({
            argumentAxisType: 'continuous',
            argumentType: 'numeric',
            valueType: 'numeric'
    ...
    QUnit.test('T532528. Different argumentFields, each dataSource item is only for one series, first arguemnt is 0', function (assert) {
        const data = [{ arg: 1, val: 11 }, { arg: 0, val: 55 }, { arg: 4, val: 33 }, { arg: 3, val: 22 }, { arg: 2, val: 44 }, { arg: 5, val: 66 }, { arg1: 3, val1: 333 }, { arg1: 2, val1: 444 }, { arg1: 0, val1: 111 }, { arg1: 4, val1: 222 }, { arg1: 1, val1: 555 }, { arg1: 5, val1: 666 }];
        const group1 = createGroupsData({
            argumentAxisType: 'continuous',
            argumentType: 'numeric',
            valueType: 'numeric'
    ...
    QUnit.test('Numeric, series with different fields (skipped items), sortingMethod true - sort data by argument', function (assert) {
        const data = [{ arg: 2, val: 11, arg1: 4, val1: 333 }, { arg: undefined, val: undefined, arg1: 3, val1: 444 }, { arg: 5, val: 33, arg1: 1, val1: 111 }, { arg: 4, val: 22, arg1: 5, val1: 222 }, { arg: 3, val: 44, arg1: 2, val1: 555 }, { arg: 6, val: 66 }];
        const group1 = createGroupsData({
            argumentAxisType: 'discrete',
            argumentType: 'numeric',
            valueType: 'numeric'
    ...
    QUnit.test('String, series with same field, sortingMethod callback - sort data by callback', function (assert) {
        const data = [{ arg: 'b', val: 11, val1: 333 }, { arg: 'a', val: 55, val1: 444 }, { arg: 'e', val: 33, val1: 111 }, { arg: 'd', val: 22, val1: 222 }, { arg: 'c', val: 44, val1: 555 }];
        const group1 = createGroupsData({
            argumentAxisType: 'discrete',
            argumentType: 'string',
            valueType: 'numeric'
    ...
    QUnit.test('Collect only unique categories', function (assert) {
        const data = [{ arg: 2, val: 11 }, { arg: 1, val: 22 }, { arg: 2, val: 66 }, { arg: 5, val: 44 }, { arg: 4, val: 33 }, { arg: 1, val: 77 }, { arg: 3, val: 55 }];
        const groups = createGroupsData({
            argumentAxisType: 'discrete',
            argumentType: 'numeric',
            valueType: 'numeric'
    ...
    QUnit.test('merge. series has more than one the same arguments', function (assert) {
        const parsedData = testValidateData([{ arg: 'oranges', val: 22 }, { arg: 'apples', val: 11 }, { arg: 'oranges', val: 45 }, { arg: 'kiwi', val: 18 }, { arg: 'bananas', val: 29 }, { arg: 'kiwi', val: 2 }], createGroupsData({
            argumentAxisType: 'discrete',
            valueType: 'numeric',
            type: 'pie'
    ...
    QUnit.test('merge. series has more than one the same arguments, more than one valueFields', function (assert) {
        const parsedData = testValidateData([{ arg: 'oranges', val1: 11, val2: 111 }, { arg: 'apples', val1: 22, val2: 222 }, { arg: 'oranges', val1: 33, val2: 333 }, { arg: 'kiwi', val1: 44, val2: 444 }, { arg: 'bananas', val1: 55, val2: 555 }, { arg: 'kiwi', val1: 66, val2: 666 }], createGroupsData({
            argumentAxisType: 'discrete',
            valueType: 'numeric',
            valueFields: ['val1', 'val2'],
            type: 'pie'
    ...
    QUnit.test('merge. series has two groups', function (assert) {
        ...
        const parsedData = testValidateData([{ arg1: 'oranges', arg2: 'potatoes', val1: 11, val2: 111 }, { arg1: 'apples', arg2: 'cucumbers', val1: 22, val2: 222 }, { arg1: 'oranges', arg2: 'tomatoes', val1: 33, val2: 333 }, { arg1: 'kiwi', arg2: 'potatoes', val1: 44, val2: 444 }, { arg1: 'bananas', arg2: 'tomatoes', val1: 55, val2: 555 }, { arg1: 'kiwi', arg2: 'garlic', val1: 66, val2: 666 }], groupsData, null, { sortingMethod: false });
    ...
    QUnit.test('merge. argument type is not discrete', function (assert) {
        const parsedData = testValidateData([{ arg: 22, val: 22 }, { arg: 11, val: 11 }, { arg: 33, val: 45 }, { arg: 44, val: 18 }, { arg: 55, val: 29 }, { arg: 66, val: 2 }], createGroupsData({
    ...
    QUnit.test('mode - smallValueThreshold. groupName is default', function (assert) {
        const parsedData = testValidateData([{ arg: 'apples', val1: 22 }, { arg: 'oranges', val1: 33 }, { arg: 'tomatoes', val1: 11 }, { arg: 'kiwi', val1: 44 }, { arg: 'bananas', val1: 55 }], createGroupsData({
            valueType: 'numeric',
            valueFields: ['val1'],
            type: 'pie',
    ...
    QUnit.test('mode - smallValueThreshold. threshold is zero', function (assert) {
        const parsedData = testValidateData([{ arg: 'apples', val1: 0 }, { arg: 'oranges', val1: 33 }, { arg: 'tomatoes', val1: 0 }, { arg: 'kiwi', val1: 44 }, { arg: 'bananas', val1: 55 }], createGroupsData({
            valueType: 'numeric',
            valueFields: ['val1'],
            type: 'pie'
        }), null, { sortingMethod: false });
    ...
    QUnit.test('mode - smallValueThreshold. threshold is more than max data', function (assert) {
        const parsedData = testValidateData([{ arg: 'apples', val1: 10 }, { arg: 'oranges', val1: 33 }, { arg: 'tomatoes', val1: 10 }, { arg: 'kiwi', val1: 44 }, { arg: 'bananas', val1: 55 }], createGroupsData({
            valueType: 'numeric',
            valueFields: ['val1'],
            type: 'pie',
    ...
    QUnit.test('mode - smallValueThreshold. some series has the same name', function (assert) {
        const parsedData = testValidateData([{ arg: 'apples', val1: 11 }, { arg: 'oranges', val1: 33 }, { arg: 'apples', val1: 22 }, { arg: 'kiwi', val1: 44 }, { arg: 'bananas', val1: 55 }], createGroupsData({
            argumentAxisType: 'discrete',
            valueType: 'numeric',
            valueFields: ['val1'],
            type: 'pie',
    ...
    QUnit.test('mode - topN, some objects has same name', function (assert) {
        ...
        const groupsData = { groups: groupData1.groups.concat(groupData2.groups) };
        const parsedData = testValidateData([{ arg: 'apples', val1: 22, val2: 77 }, { arg: 'oranges', val1: 33, val2: 11 }, { arg: 'apples', val1: 11, val2: 5 }, { arg: 'oranges', val1: 7, val2: 5 }, { arg: 'kiwi', val1: 44, val2: 65 }, { arg: 'bananas', val1: 55, val2: 45 }], groupsData, null, { sortingMethod: false });
    ...
    QUnit.test('Incompatible argument and axis types', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: 1 }, { arg: 2, val: 2 }, { arg: 3, val: 3 }, { arg: 4, val: 4 }, { arg: 5, val: 5 }], createGroupsData({ argumentType: 'string', argumentAxisType: 'continuous' }), incidentOccurred);
    ...
    QUnit.test('Incompatible value and axis types', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: 1 }, { arg: 2, val: 2 }, { arg: 3, val: 3 }, { arg: 4, val: 4 }, { arg: 5, val: 5 }], createGroupsData({ valueType: 'string', valueAxisType: 'continuous' }), incidentOccurred);
    ...
    QUnit.test('Incompatible types, semidiscrete axis', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: 1 }, { arg: 2, val: 2 }, { arg: 3, val: 3 }, { arg: 4, val: 4 }, { arg: 5, val: 5 }], createGroupsData({ valueType: 'string', valueAxisType: 'semidiscrete' }), incidentOccurred);
    ...
    QUnit.test('Input data with argument of wrong type', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: [1, 2], val: 1 }, { arg: 2, val: 2 }, { arg: 3, val: 3 }, { arg: [3, 4], val: 4 }, { arg: 5, val: 5 }], createGroupsData(), incidentOccurred, { checkTypeForAllData: true });
    ...
    QUnit.test('Input data with value of wrong type', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: { d: 2 } }, { arg: 2, val: 2 }, { arg: 3, val: 3 }, { arg: 4, val: 4 }, { arg: 5, val: 5 }], createGroupsData(), incidentOccurred, { checkTypeForAllData: true });
    ...
    QUnit.test('Input data with size of wrong type', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: 1, size: { d: 2 } }, { arg: 2, val: 2, size: 2 }, { arg: 3, val: 3, size: 2 }, { arg: 4, val: 4, size: 2 }, { arg: 5, val: 5, size: 2 }], createGroupsData({ sizeField: 'size' }), incidentOccurred, { checkTypeForAllData: true });
    ...
    QUnit.test('Missing numeric argument.should not call incidentOccurred', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: 1 }, { arg: 2, val: 2 }, { arg: null, val: 3 }, { arg: 4, val: 4 }, { arg: 5, val: 5 }], createGroupsData(), incidentOccurred);
    ...
    QUnit.test('Missing datetime argument', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: new Date(1000), val: 1 }, { arg: new Date(2000), val: 2 }, { arg: null, val: 3 }, { arg: new Date(4000), val: 4 }, { arg: new Date(5000), val: 5 }], createGroupsData(), incidentOccurred);
    ...
    QUnit.test('Can not parse numeric argument.', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: 1 }, { arg: 2, val: 2 }, { arg: 'sf', val: 3 }, { arg: 4, val: 4 }, { arg: 5, val: 5 }], createGroupsData({ argumentType: 'numeric' }), incidentOccurred);
    ...
    QUnit.test('Can not parse datetime argument', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: new Date(1000), val: 1 }, { arg: new Date(2000), val: 2 }, { arg: 'df', val: 3 }, { arg: new Date(4000), val: 4 }, { arg: new Date(5000), val: 5 }], createGroupsData({ argumentType: 'datetime' }), incidentOccurred);
    ...
    QUnit.test('Missing numeric value.should not call incidentOccurred', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: 1 }, { arg: 2, val: 2 }, { arg: 3, val: null }, { arg: 4, val: 4 }, { arg: 5, val: 5 }], createGroupsData(), incidentOccurred);
    ...
    QUnit.test('Missing datetime value.should not call incidentOccurred', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: new Date(1000), val: 1 }, { arg: new Date(2000), val: 2 }, { arg: new Date(3000), val: null }, { arg: new Date(4000), val: 4 }, { arg: new Date(5000), val: 5 }], createGroupsData(), incidentOccurred);
    ...
    QUnit.test('Can not parse numeric value', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: 1 }, { arg: 2, val: 2 }, { arg: 3, val: 'ups' }, { arg: 4, val: 4 }, { arg: 5, val: 5 }], createGroupsData({ valueType: 'numeric' }), incidentOccurred);
    ...
    QUnit.test('Can not parse datetime value', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: new Date(1000) }, { arg: 2, val: new Date(2000) }, { arg: 3, val: 'df' }, { arg: 4, val: new Date(4000) }, { arg: 5, val: new Date(5000) }], createGroupsData({ valueType: 'datetime' }), incidentOccurred);
    ...
    QUnit.test('Missing size. should not call incidentOccurred', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: 1, size: 1 }, { arg: 2, val: 2, size: 1 }, { arg: 3, val: 3, size: null }, { arg: 4, val: 4, size: 1 }, { arg: 5, val: 5, size: 1 }], createGroupsData({ sizeField: 'size' }), incidentOccurred);
    ...
    QUnit.test('Can not parse size', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: 1, size: 1 }, { arg: 2, val: 2, size: 1 }, { arg: 3, val: 1, size: 'ups' }, { arg: 4, val: 4, size: 1 }, { arg: 5, val: 5, size: 1 }], createGroupsData({ sizeField: 'size' }), incidentOccurred);
    ...
    QUnit.test('No any value in val field.should not call incidentOccurred', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: new Date(1000) }, { arg: 2, val: new Date(2000) }, { arg: 3 }, { arg: 4, val: new Date(4000) }, { arg: 5, val: new Date(5000) }], createGroupsData({ valueType: 'datetime' }), incidentOccurred);
    ...
    QUnit.test('No any value in arg field.should not call incidentOccurred', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: new Date(1000) }, { arg: 2, val: new Date(2000) }, { val: new Date(3000) }, { arg: 4, val: new Date(4000) }, { arg: 5, val: new Date(5000) }], createGroupsData({ valueType: 'datetime' }), incidentOccurred);
    ...
    QUnit.test('No any value in size field.should not call incidentOccurred', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: 1, size: 1 }, { arg: 2, val: 2, size: 2 }, { arg: 3, val: 3 }, { arg: 4, val: 4, size: 4 }, { arg: 5, val: 5, size: 5 }], createGroupsData({ sizeField: 'size' }), incidentOccurred);
    ...
    QUnit.test('Element is null.should not call incidentOccurred', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: new Date(1000) }, { arg: 2, val: new Date(2000) }, null, { arg: 4, val: new Date(4000) }, { arg: 5, val: new Date(5000) }], createGroupsData({ valueType: 'datetime' }), incidentOccurred);
    ...
    QUnit.test('Element is undefined.should not call incidentOccurred', function (assert) {
        const incidentOccurred = sinon.spy();
        const parsedData = testValidateData([{ arg: 1, val: new Date(1000) }, { arg: 2, val: new Date(2000) }, { arg: 4, val: new Date(4000) }, undefined, { arg: 5, val: new Date(5000) }], createGroupsData({ valueType: 'datetime', argumentType: 'numeric' }), incidentOccurred);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/vizMocks.js","core/utils/common","viz/series/base_series","viz/components/data_validator","../../helpers/chartMocks.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/vizMocks.js"), require("core/utils/common"), require("viz/series/base_series"), require("viz/components/data_validator"), require("../../helpers/chartMocks.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=dataValidator.tests.js.map