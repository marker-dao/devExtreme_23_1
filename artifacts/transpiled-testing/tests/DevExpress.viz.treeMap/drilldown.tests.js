...
(["testing/tests/DevExpress.viz.treeMap/drilldown.tests.js"], ["./commonParts/common.js","jquery","viz/tree_map/drilldown"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.treeMap/drilldown.tests.js', ['./commonParts/common.js', 'jquery', 'viz/tree_map/drilldown'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const common = $__require('./commonParts/common.js');
    const $ = $__require('jquery');

    $__require('viz/tree_map/drilldown');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./commonParts/common.js","jquery","viz/tree_map/drilldown"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./commonParts/common.js"), require("jquery"), require("viz/tree_map/drilldown"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=drilldown.tests.js.map