...
(["testing/tests/DevExpress.viz.treeMap/states.tests.js"], ["./commonParts/common.js","jquery","viz/tree_map/hover","viz/tree_map/selection"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.treeMap/states.tests.js', ['./commonParts/common.js', 'jquery', 'viz/tree_map/hover', 'viz/tree_map/selection'], true, function ($__require, exports, module) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./commonParts/common.js","jquery","viz/tree_map/hover","viz/tree_map/selection"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./commonParts/common.js"), require("jquery"), require("viz/tree_map/hover"), require("viz/tree_map/selection"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=states.tests.js.map