...
(["testing/tests/DevExpress.viz.treeMap/treeMap.base.tests.js"], ["jquery","./commonParts/common.js","viz/themes","data/data_source/data_source"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.treeMap/treeMap.base.tests.js', ['jquery', './commonParts/common.js', 'viz/themes', 'data/data_source/data_source'], true, function ($__require, exports, module) {
    ...
    QUnit.module('rtl support', $.extend({}, environment, {
        create: function (options) {
            $.extend(options, {
                rtlEnabled: true
            });
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","./commonParts/common.js","viz/themes","data/data_source/data_source"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("./commonParts/common.js"), require("viz/themes"), require("data/data_source/data_source"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=treeMap.base.tests.js.map