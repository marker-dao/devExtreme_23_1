...
(["testing/tests/DevExpress.ui.widgets.htmlEditor/htmlEditorParts/scrolling.tests.js"], ["jquery","animation/fx","../../../helpers/nativePointerMock.js","ui/html_editor","ui/popup","ui/scroll_view"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.htmlEditor/htmlEditorParts/scrolling.tests.js", ["jquery", "animation/fx", "../../../helpers/nativePointerMock.js", "ui/html_editor", "ui/popup", "ui/scroll_view"], function($__export) {
  "use strict";
  var $,
      fx,
      nativePointerMock,
  ...
  return {
    ...
    execute: function() {
      ...
      QUnit.module('Scrolling', {
        ...
        var SCROLLABLE_CONTAINER_SELECTOR = '.dx-scrollable-container';
        var TestHelper = function() {
          function TestHelper() {
            this.editorOptions = {height: 150};
            this.presetValue = true;
          }
          return ($traceurRuntime.createClass)(TestHelper, {
            ...
            initPopupWithScrollViewTest: function() {
              this._prepareEnvironment();
              ...
              this.popup = this.$container.parent().dxPopup({visible: true}).dxPopup('instance');
            },
            initScrollViewTest: function() {
              this._prepareEnvironment();
              this.scrollView = this.$container.dxScrollView({
                height: 100,
                useNative: false,
            ...
            setScrollableContainer: function($container) {
              this._$scrollableContainer = $container;
            },
            setPosition: function($element, scrollPosition) {
        ...
        test('editor + scrollView: editor scrollTop - start', function(assert) {
          ...
          var $scrollableContainer = $(SCROLLABLE_CONTAINER_SELECTOR);
          helper.setScrollableContainer($scrollableContainer);
          helper.scrollView.scrollTo({top: 50});
          var pointer = nativePointerMock(helper.$editorContent.children().first());
        ...
        test('editor + scrollView: editor scrollTop - end', function(assert) {
          ...
          var pointer = nativePointerMock(helper.$editorContent);
          pointer.start().wheel(-20);
        ...
        test('editor + popup: editor scrollTop - start', function(assert) {
          ...
          var $scrollableContainer = $(helper.popup.content());
          helper.setScrollableContainer($scrollableContainer);
        ...
        test('editor + popup: wheel event should be passed for element with contenteditable=false', function(assert) {
          var helper = new TestHelper();
          var labelClass = 'test-label';
          helper.presetValue = false;
          helper.editorOptions.onInitialized = function($__4) {
            var instance = $__4.component;
            var Parchment = instance.get('parchment');
            var Label = function($__super) {
              function Label() {
                $traceurRuntime.superConstructor(Label).apply(this, arguments);
              }
              return ($traceurRuntime.createClass)(Label, {deleteAt: function() {}}, {
                create: function(value) {
                  var node = $traceurRuntime.superGet(this, Label, "create").call(this, value);
          ...
          helper.editorOptions.onContentReady = function($__4) {
            var instance = $__4.component;
            var quill = instance.getQuillInstance();
            var Delta = instance.get('delta');
            var newDelta = new Delta().insert({label: 'Footer (Readonly)'}).insert(MULTILINE_VALUE);
          ...
          helper.setPosition($scrollableContainer, 50);
          helper.setPosition(helper.$editorContent, helper.maxScrollValue / 2);
          var pointer = nativePointerMock(helper.$editorContent.find(("." + labelClass)));
          pointer.start().wheel(-20);
          helper.checkAsserts(assert, 50);
          pointer.start().wheel(20);
          helper.checkAsserts(assert, 50);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","animation/fx","../../../helpers/nativePointerMock.js","ui/html_editor","ui/popup","ui/scroll_view"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("animation/fx"), require("../../../helpers/nativePointerMock.js"), require("ui/html_editor"), require("ui/popup"), require("ui/scroll_view"));
  else
