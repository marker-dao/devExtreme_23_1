...
(["testing/tests/DevExpress.ui.widgets.htmlEditor/htmlEditorParts/dropImageModule.tests.js"], ["jquery","ui/html_editor/modules/dropImage","../../../helpers/fileHelper.js","core/utils/browser"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.htmlEditor/htmlEditorParts/dropImageModule.tests.js", ["jquery", "ui/html_editor/modules/dropImage", "../../../helpers/fileHelper.js", "core/utils/browser"], function($__export) {
  "use strict";
  var $,
      DropImage,
      createBlobFile,
  ...
  return {
    ...
    execute: function() {
      ...
      DropImageMock = function($__super) {
        function DropImageMock() {
          $traceurRuntime.superConstructor(DropImageMock).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(DropImageMock, {_getImage: function(files, callback) {
            callback(IMAGE);
          }}, {}, $__super);
      }(DropImage);
      moduleConfig = {beforeEach: function() {
          ...
          this.options = {editorInstance: {
              NAME: 'dxHtmlEditor',
              _saveValueChangeEvent: function() {}
            }};
        }};
      (($__5 = QUnit, test = $__5.test, $__5));
      QUnit.module('DropImage module', moduleConfig, function() {
        test('insert image on drop', function(assert) {
          new DropImageMock(this.quillMock, this.options);
          var event = $.Event($.Event('drop', {dataTransfer: {files: [this.file]}}));
        ...
        test('check file type', function(assert) {
          var dropImage = new DropImage(this.quillMock, this.options);
          var textFile = createBlobFile('test', 80, 'text/html');
          var unsupportedImage = createBlobFile('test', 80, 'image/psd');
        ...
        test('insert image on paste', function(assert) {
          ...
          new DropImageMock(this.quillMock, this.options);
          var event = $.Event($.Event('paste', {clipboardData: {
              items: [this.file],
              getData: function(type) {
                return type === 'text/html' ? false : true;
              }
            }}));
          this.$element.trigger(event);
          clock.tick(10);
        ...
        test('Do not encode pasted image with URL', function(assert) {
          ...
          var event = $.Event($.Event('paste', {clipboardData: {
              ...
              getData: function(type) {
                return type === 'text/html' ? true : false;
              }
            }}));
          this.$element.trigger(event);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/html_editor/modules/dropImage","../../../helpers/fileHelper.js","core/utils/browser"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/html_editor/modules/dropImage"), require("../../../helpers/fileHelper.js"), require("core/utils/browser"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=dropImageModule.tests.js.map