...
(["testing/tests/DevExpress.ui.widgets.htmlEditor/htmlEditorParts/tableResizingModule.tests.js"], ["jquery","ui/html_editor/modules/tableResizing","core/utils/resize_callbacks"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.htmlEditor/htmlEditorParts/tableResizingModule.tests.js", ["jquery", "ui/html_editor/modules/tableResizing", "core/utils/resize_callbacks"], function($__export) {
  "use strict";
  var $,
      TableResizing,
      resizeCallbacks,
  ...
  return {
    ...
    execute: function() {
      ...
      moduleConfig = {
        ...
        ').attr({
          ...
          this.attachSpies = function(instance) {
            ...
            $__4.createFrameSpy = sinon.spy(instance, '_createResizeFrames');
            $__4.updateFrameSpy = sinon.spy(instance, '_updateFramePosition');
            $__4.detachSeparatorEventsSpy = sinon.spy(instance, '_detachSeparatorEvents');
          };
        },
        afterEach: function() {
          this.clock.restore();
      ...
      module('Table resizing module', moduleConfig, function() {
        test('create module instance with default options', function(assert) {
          var resizingInstance = new TableResizing(this.quillMock, this.options);
          this.clock.tick(10);
        ...
        test('module should work correct if it has been enabled or disabled some times at runtime', function(assert) {
          ...
          try {
            ...
            this.clock.tick(10);
            resizingInstance.option('enabled', true);
            assert.strictEqual($traceurRuntime.typeof(resizingInstance._resizeHandler), 'function', 'resizingInstance._resizeHandler is still a function');
          } catch (e) {
            assert.ok(false);
          }
        });
        test('Window resize callback should be added', function(assert) {
          ...
          this.clock.tick(10);
          resizeCallbacks.fire();
          assert.strictEqual($traceurRuntime.typeof(resizingInstance._resizeHandlerWithContext), 'object', '_resizeHandler is an object');
        });
        ...
        test('minColumnWidth and minRowHeight as an object can be applied', function(assert) {
          ...
          this.clock.tick(10);
          this.attachSpies(resizingInstance);
          resizingInstance.option('tableResizing', {
            minColumnWidth: 55,
            minRowHeight: 45
          });
          assert.strictEqual(resizingInstance._minColumnWidth, 55, 'minColumnWidth is applied');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/html_editor/modules/tableResizing","core/utils/resize_callbacks"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/html_editor/modules/tableResizing"), require("core/utils/resize_callbacks"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=tableResizingModule.tests.js.map