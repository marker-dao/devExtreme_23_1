...
(["testing/tests/DevExpress.ui.widgets.htmlEditor/htmlEditorParts/api.tests.js"], ["jquery","ui/html_editor","./utils.js","core/utils/type"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.htmlEditor/htmlEditorParts/api.tests.js", ["jquery", "ui/html_editor", "./utils.js", "core/utils/type"], function($__export) {
  "use strict";
  var $,
      prepareEmbedValue,
      prepareTableValue,
    ...
    execute: function() {
      ...
      moduleConfig = {
        beforeEach: function() {
          ...
          this.options = {value: '<p>Test 1</p><p>Test 2</p><p>Test 3</p>'};
          this.createEditor = function() {
            $__3.instance = $('#htmlEditor').dxHtmlEditor($__3.options).dxHtmlEditor('instance');
          };
        },
        afterEach: function() {
          this.clock.restore();
      ...
      moduleConfigWithTable = {
        beforeEach: function() {
          var $__3 = this;
          this.clock = sinon.useFakeTimers();
          this.options = {value: '<table><tr><td>1</td><td>2</td></tr><tr><td>3</td><td>4</td></tr></table>'};
          this.createEditor = function() {
            $__3.instance = $('#htmlEditor').dxHtmlEditor($__3.options).dxHtmlEditor('instance');
          };
          this.applyTableMethod = function(methodName) {
            var $__8;
            for (var restArgs = [],
                $__4 = 1; $__4 < arguments.length; $__4++)
              restArgs[$__4 - 1] = arguments[$__4];
            return $__3.instance && ($__8 = $__3.instance.getModule('table'))[methodName].apply($__8, $traceurRuntime.spread(restArgs));
          };
          this.getValue = function() {
            return prepareTableValue($__3.instance.option('value'));
          };
        },
        afterEach: function() {
          this.clock.restore();
      ...
      testModule('API', moduleConfig, function() {
        test('get registered module', function(assert) {
          this.createEditor();
          var Bold = this.instance.get('formats/bold');
        ...
        test('get registered module on init', function(assert) {
          assert.expect(2);
          this.options.onInitialized = function($__6) {
            var component = $__6.component;
            var Bold = component.get('formats/bold');
            assert.ok(Bold, 'module is defined');
            assert.strictEqual(Bold.blotName, 'bold', 'we get correct blot');
          };
          this.createEditor();
        ...
        test('get quill instance', function(assert) {
          this.createEditor();
          var quillInstance = this.instance.getQuillInstance();
        ...
        test('getMentionKeyInTemplateStorage', function(assert) {
          this.createEditor();
          var firstEditorKey = this.instance.getMentionKeyInTemplateStorage();
          var $secondEditor = $('<div>').appendTo('#qunit-fixture');
          var secondEditorKey = $secondEditor.dxHtmlEditor(this.options).dxHtmlEditor('getMentionKeyInTemplateStorage');
          assert.strictEqual(secondEditorKey - firstEditorKey, 1);
        });
        test('get module instance', function(assert) {
          this.createEditor();
          var Clipboard = this.instance.get('modules/clipboard');
          var clipboardInstance = this.instance.getModule('clipboard');
        ...
        test('quill getSelection gets correct arguments', function(assert) {
          this.createEditor();
          var getSelectionSpy = sinon.spy(this.instance.getQuillInstance(), 'getSelection');
        ...
        test('formatText', function(assert) {
          this.createEditor();
          var expected = '<h1>T<strong>est 1</strong></h1><p><strong>Tes</strong>t 2</p><p>Test 3</p>';
          this.instance.formatText(1, 9, {
            bold: true,
            header: 1
          });
          assert.strictEqual(this.instance.option('value'), expected, 'block format applies for the first line only');
        });
        ...
        test('getBounds', function(assert) {
          ...
          var getBoundsSpy = sinon.spy(this.instance.getQuillInstance(), 'getBounds');
          var bounds = this.instance.getBounds(2, 7);
        ...
        test('getFormat', function(assert) {
          ...
          var format = this.instance.getFormat(1, 2);
        ...
        test('getFormat for current selection', function(assert) {
          ...
          var format = this.instance.getFormat();
          assert.deepEqual(format, {bold: true}, 'correct format');
        });
        test('getText', function(assert) {
          this.createEditor();
          this.instance.option('value', '<p><b>Test Test</b></p>');
          var text = this.instance.getText(2, 5);
        ...
        test('getLength', function(assert) {
          this.createEditor();
          var length = this.instance.getLength();
          var LINE_WIDTH = 7;
        ...
        test('insertEmbed', function(assert) {
          this.createEditor();
          var expected = '<p>T<span class="dx-variable" data-var-start-esc-char="#" data-var-end-esc-char="#"' + ' data-var-value="template"><span contenteditable="false">#template#</span></span>est 1</p><p>Test 2</p><p>Test 3</p>';
          this.instance.insertEmbed(1, 'variable', {
            value: 'template',
            escapeChar: '#'
          });
        ...
        test('undo button should have disabled state after call "clearHistory"', function(assert) {
          ...
          this.instance.insertText(0, 'a');
          this.clock.tick(1000);
          var $undoButton = $('#htmlEditor').find(("." + BUTTON_CLASS));
          this.instance.clearHistory();
        ...
        test('redo button should have disabled state after call "undo"->"clearHistory"', function(assert) {
          ...
          this.instance.insertText(0, 'a');
          this.clock.tick(1000);
          var $redoButton = $('#htmlEditor').find(("." + BUTTON_CLASS));
          this.instance.undo();
          this.instance.clearHistory();
        ...
        test('registerModule', function(assert) {
          var Test = function() {
            function Test(quillInstance, options) {
              this._editorInstance = options.editorInstance;
            }
            return ($traceurRuntime.createClass)(Test, {getEditor: function() {
                return this._editorInstance;
              }}, {});
          }();
          this.createEditor();
          var repaintSpy = sinon.spy(this.instance, 'repaint');
          this.instance.register({'modules/test': Test});
          var testModule = this.instance.getQuillInstance().getModule('test');
        ...
        test('registerModule on init', function(assert) {
          ...
          this.createEditor();
          var testModule = this.instance.getQuillInstance().getModule('testInit');
          assert.ok(testModule);
        ...
        test('\'focus\' method should call the quill\'s focus', function(assert) {
          this.createEditor();
          var focusSpy = sinon.spy(this.instance.getQuillInstance(), 'focus');
          this.instance.focus();
        ...
        test('\'blur\' method should call the quill\'s blur', function(assert) {
          this.createEditor();
          var blurSpy = sinon.spy(this.instance.getQuillInstance(), 'blur');
          this.instance.blur();
        ...
        test('\'blur\' method should not remove focus from additional htmlEditor element', function(assert) {
          this.createEditor();
          var internalElement = $('<input type="button">');
        ...
        test('change value via \'option\' method should correctly update content', function(assert) {
          ...
          var updateContentSpy = sinon.spy(this.instance, '_updateHtmlContent');
        ...
        test('customize module', function(assert) {
          this.options.customizeModules = function($__6) {
            var toolbar = $__6.toolbar;
            toolbar.items.push('italic');
          };
          this.options.toolbar = {items: ['bold']};
          this.createEditor();
          var $toolbarItems = $(("." + TOOLBAR_FORMAT_WIDGET_CLASS));
        ...
        test('onContentReady should trigger after processing transcluded content', function(assert) {
          var initialMarkup = '<custom-tag></custom-tag><h1>Hi!</h1><p>Test         </p>';
          var expectedValue = '<h1>Hi!</h1><p>Test</p>';
          $('#htmlEditor').html(initialMarkup);
          this.options = {onContentReady: function($__6) {
              var component = $__6.component;
      ...
      testModule('Private API', moduleConfig, function() {
        test('cleanCallback should trigger on refresh', function(assert) {
          var cleanCallback = sinon.stub();
          this.createEditor();
        ...
        test('contentInitialized callback should trigger after content was initialized by Quill but before ContentReady event', function(assert) {
          var contentInitializedCallback = function() {
        ...
        test('contentInitialized callback should been removed on widget repaint', function(assert) {
          var contentInitializedCallback = sinon.stub();
          this.options.onInitialized = function($__6) {
            var component = $__6.component;
            component.addContentInitializedCallback(contentInitializedCallback);
          };
      ...
      testModule('Table API', moduleConfigWithTable, function() {
        test('insertTable', function(assert) {
          var expectedValue = '<table><tbody><tr><td><p><br></p></td><td><p><br></p></td></tr></tbody></table><p><br></p>';
          this.options.value = '';
          this.createEditor();
          this.instance.focus();
        ...
        test('insertRowBelow', function(assert) {
          var expectedValue = '<table><tbody><tr><td><p>1</p></td><td><p>2</p></td></tr><tr><td><p><br></p></td><td><p><br></p></td></tr><tr><td><p>3</p></td><td><p>4</p></td></tr></tbody></table>';
          this.createEditor();
        ...
        test('insertRowAbove', function(assert) {
          var expectedValue = '<table><tbody><tr><td><p><br></p></td><td><p><br></p></td></tr><tr><td><p>1</p></td><td><p>2</p></td></tr><tr><td><p>3</p></td><td><p>4</p></td></tr></tbody></table>';
          this.createEditor();
          this.instance.setSelection(1, 0);
        ...
        test('insertColumnLeft', function(assert) {
          var expectedValue = '<table><tbody><tr><td><p><br></p></td><td><p>1</p></td><td><p>2</p></td></tr><tr><td><p><br></p></td><td><p>3</p></td><td><p>4</p></td></tr></tbody></table>';
          this.createEditor();
          this.instance.setSelection(1, 0);
        ...
        test('insertColumnRight', function(assert) {
          var expectedValue = '<table><tbody><tr><td><p>1</p></td><td><p><br></p></td><td><p>2</p></td></tr><tr><td><p>3</p></td><td><p><br></p></td><td><p>4</p></td></tr></tbody></table>';
          this.createEditor();
          this.instance.setSelection(1, 0);
        ...
        test('deleteColumn', function(assert) {
          var expectedValue = '<table><tbody><tr><td><p>2</p></td></tr><tr><td><p>4</p></td></tr></tbody></table>';
          this.createEditor();
          this.instance.setSelection(1, 0);
        ...
        test('deleteRow', function(assert) {
          var expectedValue = '<table><tbody><tr><td><p>3</p></td><td><p>4</p></td></tr></tbody></table>';
          this.createEditor();
          this.instance.setSelection(1, 0);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/html_editor","./utils.js","core/utils/type"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/html_editor"), require("./utils.js"), require("core/utils/type"));
  else
