...
(["testing/tests/DevExpress.ui.widgets.htmlEditor/htmlEditorParts/tableContextMenuModule.tests.js"], ["jquery","ui/html_editor/modules/tableContextMenu"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.htmlEditor/htmlEditorParts/tableContextMenuModule.tests.js", ["jquery", "ui/html_editor/modules/tableContextMenu"], function($__export) {
  "use strict";
  var $,
      TableUI,
      moduleConfig,
  ...
  return {
    ...
    execute: function() {
      ...
      module('Table Context Menu module', moduleConfig, function() {
        test('create module instance with default options', function(assert) {
          var tableUIInstance = new TableUI(this.quillMock, this.options);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/html_editor/modules/tableContextMenu"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/html_editor/modules/tableContextMenu"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=tableContextMenuModule.tests.js.map