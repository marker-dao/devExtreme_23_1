...
(["testing/tests/DevExpress.ui.widgets.htmlEditor/htmlEditorParts/converters.tests.js"], ["jquery","ui/html_editor/converters/delta","ui/html_editor/converters/markdown","ui/html_editor/quill_importer"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.htmlEditor/htmlEditorParts/converters.tests.js", ["jquery", "ui/html_editor/converters/delta", "ui/html_editor/converters/markdown", "ui/html_editor/quill_importer"], function($__export) {
  "use strict";
  var $,
      DeltaConverter,
      MarkdownConverter,
  ...
  return {
    setters: [function($__m) {
      ...
      DeltaConverter = $__m.default;
    }, function($__m) {
      MarkdownConverter = $__m.default;
    }, function($__m) {
      getQuill = $__m.getQuill;
    }],
    execute: function() {
      var $__3;
      (($__3 = QUnit, test = $__3.test, testModule = $__3.module, $__3));
      testModule('Delta converter', {beforeEach: function() {
          var Quill = getQuill();
        ...
        test('it should respect more the one level indent between list items', function(assert) {
          ...
          var expected = '<ul><li>item1-1<ul><li><ul><li>item3-1</li></ul></li></ul></li><li>item1-2</li></ul>';
          this.quillInstance.setContents(deltaOps);
        ...
        test('it should respect list item attributes', function(assert) {
          ...
          var expected = '<ul><li class="ql-align-center">item1<ul><li class="ql-align-center">item2</li></ul></li></ul>';
          this.quillInstance.setContents(deltaOps);
      ...
      testModule('Markdown converter', function() {
        ...
        test('it convert a HTML with empty lines to the Markdown', function(assert) {
          var markdownConverter = new MarkdownConverter();
          var html = '<p>Te</p><p><br></p><p><br></p><p>st</p>';
          var expectedValue = 'Te\n\n<br><br>\n\nst';
      ...
      testModule('Custom list', {
        before: function() {
          ...
          var LatinList = function($__super) {
            function LatinList() {
              $traceurRuntime.superConstructor(LatinList).apply(this, arguments);
            }
            return ($traceurRuntime.createClass)(LatinList, {}, {create: function(value) {
                var node = $traceurRuntime.superGet(this, LatinList, "create").call(this, value);
        ...
        [{
          ...
          test(("it should respect " + type + " list attributes"), function(assert) {
            ...
            var expected = ("<" + tag + "><li type=\"a\">item1</li><li type=\"a\">item2</li></" + tag + ">");
            this.quillInstance.setContents(deltaOps);
          ...
          test(("indent " + type + " list attributes are correct"), function(assert) {
            ...
            var expected = ("<" + tag + "><li type=\"a\">item1<" + tag + "><li type=\"a\">item2</li></" + tag + "></li></" + tag + ">");
            this.quillInstance.setContents(deltaOps);
            assert.strictEqual(this.deltaConverter.toHtml(), expected, ("attributes of the " + type + " list are correct"));
          });
        });
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/html_editor/converters/delta","ui/html_editor/converters/markdown","ui/html_editor/quill_importer"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/html_editor/converters/delta"), require("ui/html_editor/converters/markdown"), require("ui/html_editor/quill_importer"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=converters.tests.js.map