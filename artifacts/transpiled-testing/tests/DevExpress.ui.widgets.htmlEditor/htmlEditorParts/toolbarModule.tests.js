System.register(["jquery", "generic_light.css!", "ui/select_box", "ui/color_box/color_view", "ui/html_editor/modules/toolbar", "ui/html_editor/ui/formDialog", "core/utils/common", "../../../helpers/keyboardMock.js", "animation/fx", "ui/widget/ui.errors", "localization", "core/utils/resize_callbacks.js"], function (_export, _context) {
  "use strict";

  var $, Toolbar, FormDialog, noop, keyboardMock, fx, errors, localization, resizeCallbacks, TOOLBAR_CLASS, TOOLBAR_WRAPPER_CLASS, TOOLBAR_FORMAT_WIDGET_CLASS, ACTIVE_FORMAT_CLASS, FORM_CLASS, DIALOG_CLASS, DIALOG_TARGET_ITEM_CLASS, SEPARATOR_CLASS, MENU_SEPARATOR_CLASS, BUTTON_CLASS, SELECTBOX_CLASS, COLORVIEW_CLASS, DROPDOWNMENU_BUTTON_CLASS, BUTTON_WITH_TEXT_CLASS, ICON_CLASS, HOME_ICON_CLASS, DISABLED_STATE_CLASS, CHECKBOX_CHECKED_CLASS, CHECKBOX_TEXT_CLASS, FIELD_ITEM_CLASS, FIELD_ITEM_LABEL_CLASS, COLOR_VIEW_HEX_FIELD_CLASS, TEXTEDITOR_INPUT_CLASS, DROPDOWNEDITOR_ICON_CLASS, LIST_ITEM_CLASS, POPUP_TITLE_CLASS, BOLD_FORMAT_CLASS, SIZE_FORMAT_CLASS, HEADER_FORMAT_CLASS, ITALIC_FORMAT_CLASS, ALIGNCENTER_FORMAT_CLASS, CODEBLOCK_FORMAT_CLASS, COLOR_FORMAT_CLASS, BACKGROUND_FORMAT_CLASS, ORDEREDLIST_FORMAT_CLASS, BULLETLIST_FORMAT_CLASS, CLEAR_FORMAT_CLASS, IMAGE_FORMAT_CLASS, INSERT_TABLE_FORMAT_CLASS, TOOLBAR_MULTILINE_CLASS, TABLE_OPERATIONS, simpleModuleConfig, dialogModuleConfig, test, testModule;
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_generic_lightCss) {}, function (_uiSelect_box) {}, function (_uiColor_boxColor_view) {}, function (_uiHtml_editorModulesToolbar) {
      Toolbar = _uiHtml_editorModulesToolbar.default;
    }, function (_uiHtml_editorUiFormDialog) {
      FormDialog = _uiHtml_editorUiFormDialog.default;
    ...
    }, function (_coreUtilsResize_callbacksJs) {
      resizeCallbacks = _coreUtilsResize_callbacksJs.default;
    }],
    execute: function () {
      ...
      DIALOG_TARGET_ITEM_CLASS = 'dx-formdialog-field-target';
      SEPARATOR_CLASS = 'dx-htmleditor-toolbar-separator';
      MENU_SEPARATOR_CLASS = 'dx-htmleditor-toolbar-menu-separator';
      BUTTON_CLASS = 'dx-button';
      SELECTBOX_CLASS = 'dx-selectbox';
      COLORVIEW_CLASS = 'dx-colorview';
      DROPDOWNMENU_BUTTON_CLASS = 'dx-dropdownmenu-button';
      BUTTON_WITH_TEXT_CLASS = 'dx-button-has-text';
      ICON_CLASS = 'dx-icon';
      HOME_ICON_CLASS = 'dx-icon-home';
      DISABLED_STATE_CLASS = 'dx-state-disabled';
      CHECKBOX_CHECKED_CLASS = 'dx-checkbox-checked';
      CHECKBOX_TEXT_CLASS = 'dx-checkbox-text';
      FIELD_ITEM_CLASS = 'dx-field-item';
      FIELD_ITEM_LABEL_CLASS = 'dx-field-item-label-text';
      COLOR_VIEW_HEX_FIELD_CLASS = 'dx-colorview-label-hex';
      TEXTEDITOR_INPUT_CLASS = 'dx-texteditor-input';
      DROPDOWNEDITOR_ICON_CLASS = 'dx-dropdowneditor-icon';
      LIST_ITEM_CLASS = 'dx-list-item';
      POPUP_TITLE_CLASS = 'dx-popup-title';
      BOLD_FORMAT_CLASS = 'dx-bold-format';
      SIZE_FORMAT_CLASS = 'dx-size-format';
      HEADER_FORMAT_CLASS = 'dx-header-format';
      ITALIC_FORMAT_CLASS = 'dx-italic-format';
      ALIGNCENTER_FORMAT_CLASS = 'dx-aligncenter-format';
      CODEBLOCK_FORMAT_CLASS = 'dx-codeblock-format';
      COLOR_FORMAT_CLASS = 'dx-color-format';
      BACKGROUND_FORMAT_CLASS = 'dx-background-format';
      ORDEREDLIST_FORMAT_CLASS = 'dx-orderedlist-format';
      BULLETLIST_FORMAT_CLASS = 'dx-bulletlist-format';
      CLEAR_FORMAT_CLASS = 'dx-clear-format';
      IMAGE_FORMAT_CLASS = 'dx-image-format';
      INSERT_TABLE_FORMAT_CLASS = 'dx-inserttable-format';
      TOOLBAR_MULTILINE_CLASS = 'dx-toolbar-multiline';
      TABLE_OPERATIONS = ['insertTable', 'insertRowAbove', 'insertRowBelow', 'insertColumnLeft', 'insertColumnRight', 'deleteColumn', 'deleteRow', 'deleteTable'];
      simpleModuleConfig = {
        beforeEach: function () {
          fx.off = true;
      ...
      dialogModuleConfig = {
        beforeEach: function () {
          ...
          this.formDialog = new FormDialog(this.options.editorInstance, {
      ...
      testModule('Toolbar module', simpleModuleConfig, () => {
        ...
        test('Enum format handling', function (assert) {
          ...
          this.options.items = [{
            name: 'size',
            acceptedValues: ['10px', '2em']
          }];
          new Toolbar(this.quillMock, this.options);
          this.$element.find(`.${TOOLBAR_FORMAT_WIDGET_CLASS} .${DROPDOWNEDITOR_ICON_CLASS}`).trigger('dxclick');
          $(`.${LIST_ITEM_CLASS}`).first().trigger('dxclick');
          assert.deepEqual(this.log, [{
            format: 'size',
            value: '10px'
          }]);
        ...
        test('Enum with custom options format handling', function (assert) {
          ...
          this.options.items = [{
            name: 'script',
            acceptedValues: [false, 'super', 'sub'],
            options: {
              placeholder: 'Test'
            }
          }];
        ...
        test('toolbar should prevent default mousedown event', function (assert) {
          ...
          this.$element.find(`.${TOOLBAR_FORMAT_WIDGET_CLASS}`).trigger('mousedown');
        });
      ...
      testModule('Active formats', simpleModuleConfig, () => {
        ...
        test('SelectBox should display currently applied value', function (assert) {
          ...
          const toolbar = new Toolbar(this.quillMock, this.options);
          toolbar.updateFormatWidgets();
          const value = this.$element.find(`.${TOOLBAR_FORMAT_WIDGET_CLASS} .${TEXTEDITOR_INPUT_CLASS}`).val();
      ...
      testModule('Toolbar dialogs', dialogModuleConfig, () => {
        ...
        test('change color', function (assert) {
          ...
          const $hexValueInput = $colorView.find(`.${COLOR_VIEW_HEX_FIELD_CLASS} .${TEXTEDITOR_INPUT_CLASS}`);
          $hexValueInput.val('');
          keyboardMock($hexValueInput).type('fafafa').change();
          $(`.${DIALOG_CLASS} .${BUTTON_WITH_TEXT_CLASS}`).first().trigger('dxclick');
          assert.deepEqual(this.log, [{
            format: 'color',
            value: '#fafafa'
          }], 'format method with the right arguments');
        });
        ...
        test('change an image formatting', function (assert) {
          ...
          this.$element.find(`.${TOOLBAR_FORMAT_WIDGET_CLASS}`).trigger('dxclick');
          const $fieldInputs = $(`.${FIELD_ITEM_CLASS} .${TEXTEDITOR_INPUT_CLASS}`);
          keyboardMock($fieldInputs.eq(0)).type('http://test.com/test.jpg').change();
          keyboardMock($fieldInputs.eq(1)).type('100').change();
          keyboardMock($fieldInputs.eq(2)).type('100').change();
          keyboardMock($fieldInputs.eq(3)).type('Alternate').change().press('enter');
        ...
        test('caret position after update an image with selection', function (assert) {
          ...
          this.quillMock.getFormat = () => {
            return {
              extendedImage: 'oldImage'
            };
          };
          new Toolbar(this.quillMock, this.options);
          this.$element.find(`.${TOOLBAR_FORMAT_WIDGET_CLASS}`).trigger('dxclick');
          const $src = $(`.${FIELD_ITEM_CLASS} .${TEXTEDITOR_INPUT_CLASS}`).first();
          keyboardMock($src).type('http://test.com/test.jpg').change().press('enter');
          assert.deepEqual(this.log[1], {
            setSelection: [5, 0]
        ...
        test('image must be correctly updated if it is the first element', function (assert) {
          ...
          keyboardMock($src).type('100').change().press('enter');
          const {
            index: pasteIndex,
            type: name
          } = this.log[0];
        ...
        test('change an link formatting', function (assert) {
          ...
          this.$element.find(`.${TOOLBAR_FORMAT_WIDGET_CLASS}`).trigger('dxclick');
          const $fieldInputs = $(`.${FIELD_ITEM_CLASS} .${TEXTEDITOR_INPUT_CLASS}`);
          keyboardMock($fieldInputs.eq(0)).type('http://test.com').change();
          keyboardMock($fieldInputs.eq(1)).type('Test').change().press('enter');
          assert.deepEqual(this.log, [{
            format: 'link',
            value: {
              href: 'http://test.com',
      ...
      testModule('Toolbar with multiline mode', simpleModuleConfig, function () {
        ...
        test('check separator item height', function (assert) {
          ...
          new Toolbar(this.quillMock, this.options);
          $(`.${TOOLBAR_CLASS} .${DROPDOWNMENU_BUTTON_CLASS}`).trigger('dxclick').trigger('dxclick');
      ...
      testModule('tables', simpleModuleConfig, function () {
        test('render table manipulation buttons', function (assert) {
          ...
          $formatWidgets.each((index, element) => {
            ...
            assert.strictEqual($(element).hasClass(DISABLED_STATE_CLASS), expectedDisabledState, `${operationName} item should ${expectedDisabledState ? '' : 'not'} be disabled in case the table is not focused`);
          });
        });
