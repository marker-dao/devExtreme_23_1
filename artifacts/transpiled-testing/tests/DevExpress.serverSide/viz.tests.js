...
(["testing/tests/DevExpress.serverSide/viz.tests.js"], ["viz/core/base_widget"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.serverSide/viz.tests.js', ['viz/core/base_widget'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const BaseVizWidget = $__require('viz/core/base_widget');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["viz/core/base_widget"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("viz/core/base_widget"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=viz.tests.js.map