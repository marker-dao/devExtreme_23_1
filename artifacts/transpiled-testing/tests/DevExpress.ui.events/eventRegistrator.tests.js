...
(["testing/tests/DevExpress.ui.events/eventRegistrator.tests.js"], ["jquery","events/core/event_registrator","events/core/events_engine","events/core/event_registrator_callbacks","core/class","../../helpers/eventHelper.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.events/eventRegistrator.tests.js", ["jquery", "events/core/event_registrator", "events/core/events_engine", "events/core/event_registrator_callbacks", "core/class", "../../helpers/eventHelper.js"], function($__export) {
  "use strict";
  var $,
      registerEvent,
      eventsEngine,
  ...
  return {
    setters: [function($__m) {
      ...
      registerEventCallbacks = $__m.default;
    }, function($__m) {
      Class = $__m.default;
    }, function($__m) {
      eventHelper = $__m.default;
    }],
    execute: function() {
        ...
        beforeEach: function() {
          var impl = Class.inherit({
            ctor: function() {
              var impl = this;
              impl.LOG = {};
              $.each(['setup', 'teardown', 'add', 'remove', 'trigger', '_default', 'handle'], function(_, methodName) {
      ...
      QUnit.test('\'setup\' method', function(assert) {
        ...
        var LOG = this.testEventImplementer.LOG.setup;
      ...
      QUnit.test('\'teardown\' method', function(assert) {
        ...
        var LOG = this.testEventImplementer.LOG.teardown;
        assert.strictEqual(LOG.context, this.testEventImplementer, 'context');
      ...
      QUnit.test('\'add\' method', function(assert) {
        ...
        var LOG = this.testEventImplementer.LOG.add;
        assert.strictEqual(LOG.context, this.testEventImplementer, 'context');
      ...
      QUnit.test('\'_default\' method', function(assert) {
        ...
        eventsEngine.on(this.element, 'dxtestevent.test1.test2', data, handler);
        eventsEngine.trigger(this.element, event, data);
        var LOG = this.testEventImplementer.LOG._default;
        assert.strictEqual(LOG.context, this.testEventImplementer, 'context');
        assert.equal(LOG.arguments.length, 3, 'arguments count');
        assert.strictEqual(LOG.arguments[1], event, 'event');
        assert.strictEqual(LOG.arguments[2], data, 'data');
      ...
      QUnit.test('\'handle\' method', function(assert) {
        ...
        eventsEngine.on(this.element, 'dxtestevent.test1.test2', data, handler);
        eventsEngine.trigger(this.element, event, data);
        var LOG = this.testEventImplementer.LOG.handle;
        assert.strictEqual(LOG.context, this.testEventImplementer, 'context');
        assert.equal(LOG.arguments.length, 3, 'arguments count');
        assert.strictEqual(LOG.arguments[0], this.element[0], 'element');
        assert.strictEqual(LOG.arguments[1], event, 'event');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","events/core/event_registrator","events/core/events_engine","events/core/event_registrator_callbacks","core/class","../../helpers/eventHelper.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("events/core/event_registrator"), require("events/core/events_engine"), require("events/core/event_registrator_callbacks"), require("core/class"), require("../../helpers/eventHelper.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=eventRegistrator.tests.js.map