...
(["testing/tests/DevExpress.ui.events/remove.tests.js"], ["jquery","events/core/events_engine","events/remove"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.events/remove.tests.js", ["jquery", "events/core/events_engine", "events/remove"], function($__export) {
  "use strict";
  var $,
      eventsEngine,
      removeEvent;
  return {
    ...
    execute: function() {
      ...
      QUnit.test('dxremove event should be fired on element removing', function(assert) {
        assert.expect(2);
        $('#element').data('testData', true).on(removeEvent, function(e) {
      ...
      QUnit.test('dxremove event should be fired for nested removing element', function(assert) {
        $('#inner').data('testData', true).on(removeEvent, function(e) {
          assert.ok(e, 'dxremove fired');
          assert.ok($(e.target).data('testData'), 'element has data');
        });
        $('#element').remove();
      ...
      QUnit.test('dxremove event should not triggers for element without any subscriptions', function(assert) {
        var counter = 0;
        var originalTriggerHandler = eventsEngine.triggerHandler;
        try {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","events/core/events_engine","events/remove"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("events/core/events_engine"), require("events/remove"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=remove.tests.js.map