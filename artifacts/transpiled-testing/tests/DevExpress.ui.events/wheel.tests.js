...
(["testing/tests/DevExpress.ui.events/wheel.tests.js"], ["jquery","events/core/wheel","../../helpers/nativePointerMock.js"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.ui.events/wheel.tests.js', ['jquery', 'events/core/wheel', '../../helpers/nativePointerMock.js'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const wheelEvent = $__require('events/core/wheel');
    const nativePointerMock = $__require('../../helpers/nativePointerMock.js');

    QUnit.testStart(function () {
        const markup = '<div id="test"></div>';
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","events/core/wheel","../../helpers/nativePointerMock.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("events/core/wheel"), require("../../helpers/nativePointerMock.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=wheel.tests.js.map