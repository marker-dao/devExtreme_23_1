...
(["testing/tests/DevExpress.ui.events/contextmenu.tests.js"], ["jquery","core/utils/common","core/devices","core/utils/support","events/hold","events/contextmenu"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.ui.events/contextmenu.tests.js', ['jquery', 'core/utils/common', 'core/devices', 'core/utils/support', 'events/hold', 'events/contextmenu'], true, function ($__require, exports, module) {
    ...
    const contextMenuEvent = $__require('events/contextmenu');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","core/devices","core/utils/support","events/hold","events/contextmenu"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("core/devices"), require("core/utils/support"), require("events/hold"), require("events/contextmenu"));
  else
