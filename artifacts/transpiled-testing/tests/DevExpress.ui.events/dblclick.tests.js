...
(["testing/tests/DevExpress.ui.events/dblclick.tests.js"], ["jquery","events/dblclick","../../helpers/pointerMock.js"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.ui.events/dblclick.tests.js', ['jquery', 'events/dblclick', '../../helpers/pointerMock.js'], true, function ($__require, exports, module) {
    ...
    QUnit.test('dxdblclick should not be fired for the mixed (real and triggered) clicks (T941819)', function (assert) {
        ...
        .start({ clock: 2222 }).click()
        // NOTE: real click (the timeStamp is smaller than the previous one)
        .start({ clock: 1111 }).click();
    });
});
})
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","events/dblclick","../../helpers/pointerMock.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("events/dblclick"), require("../../helpers/pointerMock.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=dblclick.tests.js.map