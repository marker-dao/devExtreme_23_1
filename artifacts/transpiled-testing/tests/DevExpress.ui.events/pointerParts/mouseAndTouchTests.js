...
(["testing/tests/DevExpress.ui.events/pointerParts/mouseAndTouchTests.js"], ["jquery","events/pointer/mouse_and_touch","events/core/event_registrator","../../../helpers/nativePointerMock.js","../../../helpers/eventHelper.js"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.ui.events/pointerParts/mouseAndTouchTests.js', ['jquery', 'events/pointer/mouse_and_touch', 'events/core/event_registrator', '../../../helpers/nativePointerMock.js', '../../../helpers/eventHelper.js'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const MouseAndTouchStrategy = $__require('events/pointer/mouse_and_touch');
    const registerEvent = $__require('events/core/event_registrator');
    const nativePointerMock = $__require('../../../helpers/nativePointerMock.js');
    ...
    QUnit.test('pointer event should not trigger twice on real devices', function (assert) {
        ...
        nativePointerMock($element).start().down();

        assert.equal(handlerTriggerCount, 2);

        nativePointerMock($container).start().down();
    ...
    QUnit.test('dxpointerup triggers twice on real devices', function (assert) {
        ...
        const pointer = nativePointerMock(this.$element).start().touchStart().touchEnd();

        this.clock.tick(300);

        pointer.mouseDown().mouseUp();
    ...
    const simulateMouseEvent = function ($element, type, options) {
        ...
        const args = [];
        $.each(['type', 'canBubble', 'cancelable', 'view', 'detail', 'screenX', 'screenY', 'clientX', 'clientY', 'ctrlKey', 'altKey', 'shiftKey', 'metaKey', 'button', 'relatedTarget'], function (i, name) {
            if (name in options) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","events/pointer/mouse_and_touch","events/core/event_registrator","../../../helpers/nativePointerMock.js","../../../helpers/eventHelper.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("events/pointer/mouse_and_touch"), require("events/core/event_registrator"), require("../../../helpers/nativePointerMock.js"), require("../../../helpers/eventHelper.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=mouseAndTouchTests.js.map