...
(["testing/tests/DevExpress.ui.events/pointerParts/touchTests.js"], ["jquery","events/pointer/touch","events/core/event_registrator","../../../helpers/nativePointerMock.js","core/utils/common","../../../helpers/eventHelper.js","events/core/events_engine"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.ui.events/pointerParts/touchTests.js', ['jquery', 'events/pointer/touch', 'events/core/event_registrator', '../../../helpers/nativePointerMock.js', 'core/utils/common', '../../../helpers/eventHelper.js', 'events/core/events_engine'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const TouchStrategy = $__require('events/pointer/touch');
    ...
    QUnit.test('pointer event should not trigger twice on real devices', function (assert) {
        ...
        nativePointerMock($element).start().touchStart().mouseDown();
        ...
        nativePointerMock($container).start().touchStart().mouseDown();
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","events/pointer/touch","events/core/event_registrator","../../../helpers/nativePointerMock.js","core/utils/common","../../../helpers/eventHelper.js","events/core/events_engine"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("events/pointer/touch"), require("events/core/event_registrator"), require("../../../helpers/nativePointerMock.js"), require("core/utils/common"), require("../../../helpers/eventHelper.js"), require("events/core/events_engine"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=touchTests.js.map