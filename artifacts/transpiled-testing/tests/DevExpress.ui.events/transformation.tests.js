...
(["testing/tests/DevExpress.ui.events/transformation.tests.js"], ["jquery","events/transform"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.ui.events/transformation.tests.js', ['jquery', 'events/transform'], true, function ($__require, exports, module) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","events/transform"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("events/transform"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=transformation.tests.js.map