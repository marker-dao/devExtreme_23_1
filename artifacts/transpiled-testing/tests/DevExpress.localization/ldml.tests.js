...
(["testing/tests/DevExpress.localization/ldml.tests.js"], ["../../helpers/noIntl.js","localization/ldml/number","localization/ldml/date.parser","localization/ldml/date.formatter","localization/ldml/date.format","localization/default_date_names","localization/number","localization/date","core/utils/extend","core/utils/console","localization/currency"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.localization/ldml.tests.js', ['../../helpers/noIntl.js', 'localization/ldml/number', 'localization/ldml/date.parser', 'localization/ldml/date.formatter', 'localization/ldml/date.format', 'localization/default_date_names', 'localization/number', 'localization/date', 'core/utils/extend', 'core/utils/console', 'localization/currency'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    $__require('../../helpers/noIntl.js');
    const getNumberFormatter = $__require('localization/ldml/number').getFormatter;
    const getNumberFormat = $__require('localization/ldml/number').getFormat;
    const getDateParser = $__require('localization/ldml/date.parser').getParser;
    const getRegExpInfo = $__require('localization/ldml/date.parser').getRegExpInfo;
    const getDateFormatter = $__require('localization/ldml/date.formatter').getFormatter;
    const getDateFormat = $__require('localization/ldml/date.format').getFormat;
    const defaultDateNames = $__require('localization/default_date_names');
    const numberLocalization = $__require('localization/number');
    const dateLocalization = $__require('localization/date');
    const extend = $__require('core/utils/extend').extend;
    const console = $__require('core/utils/console').logger;
    ...
    QUnit.module('number formatter', () => {
        ...
        QUnit.test('getRegExpInfo should return correct pattern set when stub is in the end', function (assert) {
            ...
            assert.deepEqual(regExpInfo.patterns, ['EEE', '\', \'', 'MMMM', '\', \'', 'dd', '\', \'', 'HH', ':', 'mm', ':', 'ss', '\' (stub)\'']);
        });
        ...
        QUnit.test('getRegExpInfo should return correct pattern set when there is "ww" inside of it', function (assert) {
            ...
            assert.deepEqual(regExpInfo.patterns, ['ww', '\', \'', 'MMMM', '\', \'', 'dd', '\', \'', 'HH', ':', 'mm', ':', 'ss', '\' (stub)\'']);
        });
        ...
        QUnit.test('getRegExpInfo should return correct pattern for the single time separator', function (assert) {
            ...
            assert.deepEqual(regExpInfo.patterns, ['HH', ':', 'mm']);
        });
        ...
        QUnit.test('getRegExpInfo should return correct regexp for the single time separator (for special locals)', function (assert) {
            ...
            assert.deepEqual(regExpInfo.patterns, ['HH', '\' h \'', 'mm']);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../helpers/noIntl.js","localization/ldml/number","localization/ldml/date.parser","localization/ldml/date.formatter","localization/ldml/date.format","localization/default_date_names","localization/number","localization/date","core/utils/extend","core/utils/console","localization/currency"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../helpers/noIntl.js"), require("localization/ldml/number"), require("localization/ldml/date.parser"), require("localization/ldml/date.formatter"), require("localization/ldml/date.format"), require("localization/default_date_names"), require("localization/number"), require("localization/date"), require("core/utils/extend"), require("core/utils/console"), require("localization/currency"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ldml.tests.js.map