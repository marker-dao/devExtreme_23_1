System.register(["localization/date", "localization/number", "localization/core"], function (_export, _context) {
  "use strict";

  var dateLocalization, numberLocalization, locale, NARROW_NO_BREAK_SPACE;
  return {
    setters: [function (_localizationDate) {
      dateLocalization = _localizationDate.default;
    }, function (_localizationNumber) {
      numberLocalization = _localizationNumber.default;
    }, function (_localizationCore) {
      locale = _localizationCore.locale;
    }],
    execute: function () {
      locale('en');
      ...
      QUnit.module('Localization date', () => {
        QUnit.test('object syntax, fractionalSecondDigits is set in format (T1079944)', function (assert) {
          ...
          assert.equal(dateLocalization.format(date, {
            ...options,
