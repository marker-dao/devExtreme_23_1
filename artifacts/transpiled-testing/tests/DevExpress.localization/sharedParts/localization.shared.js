...
(["testing/tests/DevExpress.localization/sharedParts/localization.shared.js"], ["jquery","localization/date","localization/number","localization/message","core/errors","localization","core/config","core/utils/console","../../../helpers/dateHelper.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.localization/sharedParts/localization.shared.js", ["jquery", "localization/date", "localization/number", "localization/message", "core/errors", "localization", "core/config", "core/utils/console", "../../../helpers/dateHelper.js"], function($__export) {
  "use strict";
  var $,
      dateLocalization,
      numberLocalization,
  ...
  return {
    setters: [function($__m) {
      ...
      generateDate = $__m.generateDate;
    }],
    execute: function() {
      $__export('default', function() {
        QUnit.module('Localization modules', function() {
          ...
          checkModules('localization.date', dateLocalization, ['getMonthNames', 'getDayNames', 'getTimeSeparator', 'format', 'parse', 'formatUsesMonthName', 'formatUsesDayName', 'getFormatParts', 'firstDayOfWeekIndex']);
          checkModules('localization.number', numberLocalization, ['format', 'parse', 'getCurrencySymbol']);
          checkModules('localization.message', messageLocalization, ['setup', 'localizeString', 'getMessagesByLocales', 'getFormatter', 'format', 'load']);
          checkModules('localization', localization, ['loadMessages', 'locale']);
        });
        QUnit.module('Localization date (en)', function() {
          ...
          QUnit.test('getMonthNames', function(assert) {
            assert.deepEqual(dateLocalization.getMonthNames(), ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'], 'Array of month names');
          });
          QUnit.test('getDayNames', function(assert) {
            assert.deepEqual(dateLocalization.getDayNames(), ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'], 'Array of day names');
          });
          ...
          QUnit.test('format', function(assert) {
            ...
            $.each(assertData, function(format, data) {
              ...
              $.each(data, function(_, data) {
                ...
                assert.equal($traceurRuntime.typeof((localizedDate)), 'string');
          ...
          QUnit.test('parse with custom format', function(assert) {
            ...
            assert.deepEqual(localization.parseDate('2 March 2015', {formatter: function(value) {
          ...
          QUnit.test('parse', function(assert) {
            ...
            try {
              $.each(assertData, function(format, data) {
                data = $.makeArray(data);
                $.each(data, function(_, data) {
                  var expected = data.expectedConfig && generateDate(data.expectedConfig) || data.expected;
        ...
        QUnit.module('Localization message (en)', {beforeEach: function() {
          ...
          QUnit.test('format', function(assert) {
            ...
            try {
              localization.loadMessages({'en': {fallBackTestKey: 'fallBackTestMessage'}});
              localization.locale('ru');
          ...
          QUnit.test('format using parent locales', function(assert) {
            try {
              localization.loadMessages({
                ...
                'pt-PT': {ptPtTestKey: 'ptPtTestValue'}
              });
          ...
          QUnit.test('format with placeholders', function(assert) {
            ...
            assert.equal(localization.formatMessage('hello', 'Ivan', 'Ivanov'), 'Hello, Ivan Ivanov');
            try {
              localization.loadMessages({'en': {fallBackTestKey: 'fallBackTestMessage {0}'}});
              localization.locale('ru');
          ...
          QUnit.test('getDictionary', function(assert) {
            localization.loadMessages({'en': {freshAddedKey: 'testValue'}});
        ...
        QUnit.module('Localization number', function() {
          ...
          QUnit.test('parse by predefined formats', function(assert) {
            ...
            assert.strictEqual(localization.parseNumber('1.2M %', {type: 'percent largeNumber'}), 12000);
          });
          ...
          QUnit.test('format: base', function(assert) {
            ...
            assert.equal(localization.formatNumber(1, {
              type: 'decimal',
              precision: 2
            }), '01');
            assert.equal(localization.formatNumber(1, {
            ...
            var small18DecimalDigits = -0.004768895486559899;
          ...
          QUnit.test('format: precision', function(assert) {
            assert.equal(localization.formatNumber(2, {
              type: 'decimal',
              precision: 2
            }), '02');
            assert.equal(localization.formatNumber(12, {
              type: 'decimal',
              precision: 2
            }), '12');
            assert.equal(localization.formatNumber(2, {
            ...
            assert.equal(localization.formatNumber(123, {
              type: 'decimal',
              precision: 3
            }), '123');
          });
          ...
          QUnit.test('Fixed point numeric formats', function(assert) {
            assert.equal(localization.formatNumber(23.04059872, {
              type: 'fIxedPoint',
              precision: 4
            }), '23.0406');
          ...
          QUnit.test('format fixedPoint with precision', function(assert) {
            ...
            assert.equal(localization.formatNumber(1.1, {
              type: 'fixedPoint',
              precision: 2
            }), '1.10');
            ...
            assert.equal(localization.formatNumber(1.2, {
              type: 'fixedPoint',
              precision: null
            }), '1.2');
            assert.equal(localization.formatNumber(1.22, {
              type: 'fixedPoint',
              precision: null
            }), '1.22');
            assert.equal(localization.formatNumber(1.222, {
              type: 'fixedPoint',
              precision: null
            }), '1.222');
            assert.equal(localization.formatNumber(1.2222, {
              type: 'fixedPoint',
              precision: null
            }), '1.2222');
            assert.equal(localization.formatNumber(1.2225, {
              type: 'fixedPoint',
              precision: null
            }), '1.2225');
            assert.equal(localization.formatNumber(1.22222228, {
              type: 'fixedPoint',
              precision: null
            }), '1.22222228');
            assert.equal(localization.formatNumber(4.645, {
              type: 'fixedPoint',
              precision: 2
            }), '4.65');
            assert.equal(localization.formatNumber(4.645, {
            ...
            assert.equal(localization.formatNumber(4.64, {
              type: 'fixedPoint',
              precision: 2
            }), '4.64');
            assert.equal(localization.formatNumber(-4.645, {
            ...
            assert.equal(localization.formatNumber(35.855, {
              type: 'fixedPoint',
              precision: 2
            }), '35.86');
            assert.equal(localization.formatNumber(35.855, {
            ...
            assert.equal(localization.formatNumber(1.296249, {
              type: 'fixedPoint',
              precision: 4
            }), '1.2962', 'T848392');
            assert.equal(localization.formatNumber(-1.296249, {
          ...
          QUnit.test('Percent numeric formats', function(assert) {
            ...
            assert.equal(localization.formatNumber(0.45, {
              type: 'peRcent',
              precision: 2
            }), '45.00%');
          });
          QUnit.test('Decimal numeric formats', function(assert) {
            ...
            assert.equal(localization.formatNumber(437, {
              type: 'deCimal',
              precision: 5
            }), '00437');
            assert.equal(localization.formatNumber(-437, {
          ...
          QUnit.test('format as function', function(assert) {
            assert.equal(localization.formatNumber(437, function(value) {
              return '!' + value;
            }), '!437');
            assert.equal(localization.formatNumber(437, {formatter: function(value) {
                return '!' + value;
              }}), '!437');
          });
          QUnit.test('custom group and decimal separators', function(assert) {
            ...
            try {
              ...
              assert.equal(localization.formatNumber(1234567.89, {
                type: 'fixedPoint',
                precision: 2
              }), '1.234.567,89');
            } finally {
        ...
        QUnit.module('Localization currency', function() {
          QUnit.test('format: base', function(assert) {
            ...
            var negativeCurrency = localization.formatNumber(-1, {
              type: 'currency',
              precision: 2
            });
          ...
          QUnit.test('format: several words', function(assert) {
            assert.equal(localization.formatNumber(0, {
        ...
        QUnit.module('Localization custom functions', function() {
          ...
          QUnit.test('getTimeSeparator should depend on current locale', function(assert) {
            try {
              ...
              var formattedText = localization.formatDate(new Date(2021, 1, 1, 12, 34), 'shorttime');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","localization/date","localization/number","localization/message","core/errors","localization","core/config","core/utils/console","../../../helpers/dateHelper.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("localization/date"), require("localization/number"), require("localization/message"), require("core/errors"), require("localization"), require("core/config"), require("core/utils/console"), require("../../../helpers/dateHelper.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=localization.shared.js.map