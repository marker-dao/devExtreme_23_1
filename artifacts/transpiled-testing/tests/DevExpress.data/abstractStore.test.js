...
(["testing/tests/DevExpress.data/abstractStore.test.js"], ["data/abstract_store"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.data/abstractStore.test.js", ["data/abstract_store"], function($__export) {
  "use strict";
  var Store;
  return {
    ...
    execute: function() {
      QUnit.module('Abstract Store', function() {
        var MyStore = function() {
          function MyStore() {}
          return ($traceurRuntime.createClass)(MyStore, {}, {});
        }();
        QUnit.test('registerClass', function(assert) {
          Store.registerClass(MyStore, 'my-store');
          var customStore = Store.create('my-store');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["data/abstract_store"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("data/abstract_store"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=abstractStore.test.js.map