...
(["testing/tests/DevExpress.data/storeLocal.tests.js"], ["data/local_store"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.data/storeLocal.tests.js', ['data/local_store'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const LocalStore = $__require('data/local_store');
    ...
    QUnit.test('_clearCache must read data from backend', function (assert) {
        ...
        const storeData = [{ id: 1, name: '1' }, { id: 2, name: '2' }];
    ...
    QUnit.test('store methods must get actual data', function (assert) {
        ...
        const storeData = [{ id: 0, name: '1' }, { id: 1, name: '2' }, { id: 2, name: '3' }];
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["data/local_store"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("data/local_store"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=storeLocal.tests.js.map