System.register(["core/guid", "data/utils", "data/odata/utils", "data/array_utils"], function (_export, _context) {
  "use strict";

  var Guid, processRequestResultLock, keysEqual, isGroupCriterion, throttleChanges, b64, EdmLiteral, createObjectWithChanges;
  return {
    setters: [function (_coreGuid) {
      Guid = _coreGuid.default;
    }, function (_dataUtils) {
      processRequestResultLock = _dataUtils.processRequestResultLock;
      keysEqual = _dataUtils.keysEqual;
      isGroupCriterion = _dataUtils.isGroupCriterion;
      throttleChanges = _dataUtils.throttleChanges;
      b64 = _dataUtils.base64_encode;
    }, function (_dataOdataUtils) {
      EdmLiteral = _dataOdataUtils.EdmLiteral;
    }, function (_dataArray_utils) {
      createObjectWithChanges = _dataArray_utils.createObjectWithChanges;
    }],
    execute: function () {
