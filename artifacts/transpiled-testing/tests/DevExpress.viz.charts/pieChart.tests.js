...
(["testing/tests/DevExpress.viz.charts/pieChart.tests.js"], ["jquery","core/utils/common","../../helpers/vizMocks.js","../../helpers/executeAsyncMock.js","./chartParts/commons.js","viz/series/base_series","viz/chart_components/base_chart","viz/series/points/label","viz/components/data_validator","viz/translators/translator1d","data/custom_store","viz/components/chart_theme_manager","viz/chart_components/layout_manager","viz/chart_components/tracker","viz/pie_chart","../../helpers/chartMocks.js","core/template_manager","common/charts","events/core/events_engine","core/devices"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.viz.charts/pieChart.tests.js", ["jquery", "core/utils/common", "../../helpers/vizMocks.js", "../../helpers/executeAsyncMock.js", "./chartParts/commons.js", "viz/series/base_series", "viz/chart_components/base_chart", "viz/series/points/label", "viz/components/data_validator", "viz/translators/translator1d", "data/custom_store", "viz/components/chart_theme_manager", "viz/chart_components/layout_manager", "viz/chart_components/tracker", "viz/pie_chart", "../../helpers/chartMocks.js", "core/template_manager", "common/charts", "events/core/events_engine", "core/devices"], function($__export) {
  "use strict";
  var $,
      noop,
      vizMocks,
  ...
  function setupMocks() {
    ...
    this.stubSeries = new MockSeries({points: this.stubPoints});
  }
  function createPoint(options) {
    ...
    point.fullState = 0;
    point.getLegendStyles = sinon.stub().returns({
      normal: {},
      selection: {},
      hover: {}
    });
    ...
    execute: function() {
      ...
      environment = {
        beforeEach: function() {
          ...
          TemplateManagerModule.TemplateManager.createDefaultOptions = function() {
            return {};
          };
          ...
          that.themeManager.getOptions.withArgs('tooltip').returns({
            enabled: true,
            font: {}
          });
          ...
          that.createPieChart = function(options) {
            ...
            var pieChart = createPieChart.call(this, options);
            return pieChart;
          };
          ...
          that.layoutManager.applyPieChartSeriesLayout.returns({
            radiusInner: 0,
            radiusOuter: 300,
            centerX: 100,
            centerY: 200
      ...
      overlappingEnvironment = $.extend({}, environment, {
        ...
        createFakeSeriesWithLabels: function(bBoxes, position) {
          ...
          series.getOptions = function() {
            return {label: {position: position || 'outside'}};
          };
      ...
      (function mainTest() {
        ...
        QUnit.test('Theme manager with no settings', function(assert) {
          ...
          assert.deepEqual(this.createThemeManager.lastCall.args, [{
            options: chart.option(),
            themeSection: 'pie',
            fontFields: ['legend.font', 'legend.title.font', 'legend.title.subtitle.font', 'commonSeriesSettings.label.font', 'export.font', 'title.font', 'title.subtitle.font', 'tooltip.font', 'loadingIndicator.font', 'commonAnnotationSettings.font']
          }]);
        });
        ...
        QUnit.test('Creation layoutManager with options', function(assert) {
          this.themeManager.getOptions.withArgs('adaptiveLayout').returns({
            width: 'someWidth',
            height: 'someHeight'
          });
          ...
          this.createPieChart({});
          assert.deepEqual(layoutManagerModule.LayoutManager.firstCall.returnValue.setOptions.lastCall.args, [{
            width: 'someWidth',
            height: 'someHeight',
            piePercentage: 0.75,
            minPiePercentage: 0.5
          }]);
        });
        ...
        QUnit.test('Get inner raduis API', function(assert) {
          seriesMockData.series.push(new MockSeries({range: {val: {
                min: 0,
                max: 10
              }}}));
          this.layoutManager.applyPieChartSeriesLayout.returns({
            radiusInner: 80,
            radiusOuter: 300,
            centerX: 100,
            centerY: 200
          ...
          var radius = chart.getInnerRadius();
        ...
        QUnit.test('Hole template. No option - no group created', function(assert) {
          ...
          var templateGroup = chart._renderer.root.children.filter(function(c) {
            var attrCall = c.stub('attr').getCall(0);
        ...
        QUnit.test('Async tempaltes rendering. OnRendered was not called', function(assert) {
          ...
          var templateGroup = chart._renderer.root.children[chart._renderer.root.children.length - 1];
        ...
        QUnit.test('Async tempaltes rendering. OnRendered called, group moved', function(assert) {
          ...
          var templateGroup = chart._renderer.g.returnValues[15];
        ...
        QUnit.test('Hole template. First rendering', function(assert) {
          ...
          var centerTemplateSpy = sinon.spy();
          var chart = this.createPieChart({
            dataSource: this.dataSource,
            series: [{}],
        ...
        QUnit.module('Creation series for tracker', {
          beforeEach: function() {
            ...
            var stubSeries2 = new MockSeries({points: this.points2});
        ...
        QUnit.test('T400246. After dataSource update tracker gets same series', function(assert) {
          ...
          chart.option({dataSource: $.extend(true, [], this.dataSource)});
        ...
        QUnit.test('visibility changed', function(assert) {
          ...
          var populateBusinessRange = sinon.spy(chart, '_populateBusinessRange');
          var renderMethod = sinon.spy(chart, '_doRender');
          assert.ok(series);
        ...
        QUnit.test('Theme was applied to single series', function(assert) {
          ...
          this.themeManager.getOptions.withArgs('series').returns({seriesTheme: true});
          this.themeManager.getOptions.withArgs('pieSegment').resetBehavior();
          this.themeManager.getOptions.withArgs('pieSegment').returns({point: {pointThemeApplied: true}});
          var chart = this.createPieChart({
            dataSource: this.dataSource,
            series: {},
            type: 'pie'
        ...
        QUnit.test('Pie dxChart with single series request default type, customizeLabel and customizePoint is specify', function(assert) {
          ...
          var points = chart.series[0].getPoints();
        ...
        QUnit.module('Axes and Series', {
          beforeEach: function() {
            ...
            var stubSeries1 = new MockSeries({range: {val: {
                  min: 0,
                  max: 10
                }}});
            var stubSeries2 = new MockSeries({range: {val: {
                  min: 0,
                  max: 110
                }}});
        ...
        QUnit.test('Pass axis pretender to series, axis pretender can return translator', function(assert) {
          ...
          var seriesOptions2 = seriesMockData.args[1][0];
        ...
        QUnit.test('Set correct business ranges', function(assert) {
          ...
          var translator2 = seriesMockData.args[1][0].valueAxis.getTranslator();
        ...
        QUnit.module('Multi level pie chart', {
          beforeEach: function() {
            environment.beforeEach.apply(this, arguments);
            this.mockSeries1 = new MockSeries({range: {val: {
                  min: 0,
                  max: 10
                }}}), this.mockSeries2 = new MockSeries({range: {val: {
                  min: 0,
                  max: 10
                }}});
            var translatorClass = new vizMocks.stubClass(translator1DModule.Translator1D);
        ...
        QUnit.test('business range', function(assert) {
          ...
          chart.series[0].setOptions({range: {val: {
                min: 1,
                max: 5
              }}});
          chart.option({dataSource: []});
          var businessRange1 = seriesMockData.args[0][0].valueAxis.getTranslator().stub('setDomain').lastCall.args;
          var businessRange2 = seriesMockData.args[1][0].valueAxis.getTranslator().stub('setDomain').lastCall.args;
        ...
        QUnit.test('handle render complete without series', function(assert) {
          ...
          this.createPieChart({onDone: function() {
        ...
        QUnit.test('Hide marker for pie series after hiding segment', function(assert) {
          ...
          var getLegendData = function(passedData) {
            return {
              id: passedData.id,
        ...
        QUnit.test('Create Horizontal Legend with single named series', function(assert) {
          ...
          var legend = commons.getLegendStub();
          var updateArgs = legend.update.lastCall.args;
          ...
          updateArgs[0].forEach(function(args, i) {
            ...
            assert.deepEqual(args.states, {
              hover: {},
              selection: {},
              normal: {}
            }, 'Legend states for ' + i.toString());
        ...
        QUnit.test('Create legend with two series, different arguments', function(assert) {
          ...
          seriesMockData.series.push(new MockSeries({points: points2}));
          ...
          for (i = 0; i < updateArgs[0].length; i++) {
            ...
            assert.deepEqual(updateArgs[0][i].states, {
              hover: {},
              selection: {},
              normal: {}
            }, 'Legend stated for ' + i.toString());
        ...
        QUnit.test('Create legend with two series, the same arguments in each series', function(assert) {
          ...
          var stubSeries = new MockSeries({points: stubPoints});
          seriesMockData.series.push(stubSeries);
        ...
        QUnit.test('Create legend with two series, some of the points are invisible', function(assert) {
          ...
          var stubSeries1 = new MockSeries({points: stubPoints1});
          var stubSeries2 = new MockSeries({points: stubPoints2});
          seriesMockData.series.push(stubSeries1);
          seriesMockData.series.push(stubSeries2);
          this.createPieChart({
            dataSource: this.dataSource,
          ...
          var updateArgs = commons.getLegendStub().stub('update').lastCall.args;
          assert.deepEqual(updateArgs[0][0].states, {
            hover: {},
            selection: {},
            normal: {}
          }, 'Legend states');
          assert.deepEqual(updateArgs[0][1].states, {
            hover: {},
            selection: {},
            normal: {}
          }, 'Legend states');
          assert.deepEqual(updateArgs[0][2].states, {
            hover: {opacity: 0.3},
            selection: {opacity: 0.3},
            normal: {opacity: 0.3}
          }, 'Legend states');
        ...
        QUnit.test('index of points', function(assert) {
          ...
          var seriesPoints = series[0].getPoints();
        ...
        QUnit.test('argument indecies in the legend data of points with the same arguments', function(assert) {
          ...
          var legendData = commons.getLegendStub().stub('update').lastCall.args[0];
        ...
        QUnit.test('Legend callback', function(assert) {
          ...
          var stubSeries = new MockSeries({points: points});
          var stubSeries2 = new MockSeries({points: points2});
          ...
          var legendCallback = seriesMockData.series[0].legendCallback;
          legendCallback();
      ...
      (function dynamicTests() {
        ...
        QUnit.test('Force full redraw', function(assert) {
          ...
          $.each(chart.series, function(_, series) {
            series.dispose = function() {
              chart.seriesDisposed = true;
            };
          });
          chart.render({force: true});
        ...
        QUnit.test('update diameter', function(assert) {
          var stubSeries = new MockSeries({range: {
              arg: {
                min: 15,
                max: 80
              },
        ...
        QUnit.test('dxChart with single series request default type', function(assert) {
          var chart = this.createPieChart({series: {}});
          var updatedData = [1, 2, 3, 4, 5];
          chart.series[0].setOptions({
            argumentField: 'arg',
            range: {val: {
                min: 1,
                max: 5
        ...
        QUnit.test('Datasource with delayed loading from Store', function(assert) {
          ...
          var store = new CustomStore({load: function() {
        ...
        QUnit.test('Group series for pieChart', function(assert) {
          var chart = this.createPieChart({series: {argumentType: 'argumentType'}});
          var expected = chart.series;
      ...
      (function API() {
        ...
        QUnit.test('dxChart - get all series', function(assert) {
          var chart = this.createPieChart({series: {name: 'Pie series'}});
      ...
      (function minorFunctionality() {
        QUnit.module('resolveLabelOverlapping. hide', $.extend({}, overlappingEnvironment, {createPieChartWithLabels: function(BBox) {
        ...
        QUnit.test('hide label', function(assert) {
          ...
          var points = pie.getAllSeries()[0].getVisiblePoints();
        ...
        QUnit.module('resolveLabelOverlapping. shift', $.extend({}, overlappingEnvironment, {createPieChartWithLabels: function(BBox, position, segmentsDirection) {
        ...
        QUnit.module('resolveLabelOverlapping. shift. multipie', $.extend({}, overlappingEnvironment, {createPieChartWithLabels: function(BBox1, BBox2, position) {
        ...
        QUnit.test('two series - all labels are resolved together (in two directions)', function(assert) {
          ...
          var points1 = pie.getAllSeries()[0].getVisiblePoints();
          var points2 = pie.getAllSeries()[1].getVisiblePoints();
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","../../helpers/vizMocks.js","../../helpers/executeAsyncMock.js","./chartParts/commons.js","viz/series/base_series","viz/chart_components/base_chart","viz/series/points/label","viz/components/data_validator","viz/translators/translator1d","data/custom_store","viz/components/chart_theme_manager","viz/chart_components/layout_manager","viz/chart_components/tracker","viz/pie_chart","../../helpers/chartMocks.js","core/template_manager","common/charts","events/core/events_engine","core/devices"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("../../helpers/vizMocks.js"), require("../../helpers/executeAsyncMock.js"), require("./chartParts/commons.js"), require("viz/series/base_series"), require("viz/chart_components/base_chart"), require("viz/series/points/label"), require("viz/components/data_validator"), require("viz/translators/translator1d"), require("data/custom_store"), require("viz/components/chart_theme_manager"), require("viz/chart_components/layout_manager"), require("viz/chart_components/tracker"), require("viz/pie_chart"), require("../../helpers/chartMocks.js"), require("core/template_manager"), require("common/charts"), require("events/core/events_engine"), require("core/devices"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=pieChart.tests.js.map