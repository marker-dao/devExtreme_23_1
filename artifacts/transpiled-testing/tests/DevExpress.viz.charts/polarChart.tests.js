...
(["testing/tests/DevExpress.viz.charts/polarChart.tests.js"], ["../../helpers/trackerMock.js","jquery","../../helpers/vizMocks.js","viz/chart_components/tracker","viz/components/chart_theme_manager","viz/components/legend","viz/series/base_series","viz/core/series_family","viz/axes/base_axis","viz/polar_chart","viz/core/renderers/renderer","viz/components/data_validator","viz/translators/range","viz/core/tooltip","viz/chart_components/layout_manager","viz/core/export"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.charts/polarChart.tests.js', ['../../helpers/trackerMock.js', 'jquery', '../../helpers/vizMocks.js', 'viz/chart_components/tracker', 'viz/components/chart_theme_manager', 'viz/components/legend', 'viz/series/base_series', 'viz/core/series_family', 'viz/axes/base_axis', 'viz/polar_chart', 'viz/core/renderers/renderer', 'viz/components/data_validator', 'viz/translators/range', 'viz/core/tooltip', 'viz/chart_components/layout_manager', 'viz/core/export'], true, function ($__require, exports, module) {
    ...
    const dxPolarChart = $__require('viz/polar_chart');
    ...
    function createSeries() {
        ...
        series.getPoints.returns([{ argument: 0, value: 1, getOptions: function () {
                return { visible: true };
            }, getMinValue: function () {} }, { argument: 1, value: 2, getOptions: function () {
                return { visible: true };
            }, getMinValue: function () {} }, { argument: 2, value: 3, getOptions: function () {
                return { visible: true };
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../helpers/trackerMock.js","jquery","../../helpers/vizMocks.js","viz/chart_components/tracker","viz/components/chart_theme_manager","viz/components/legend","viz/series/base_series","viz/core/series_family","viz/axes/base_axis","viz/polar_chart","viz/core/renderers/renderer","viz/components/data_validator","viz/translators/range","viz/core/tooltip","viz/chart_components/layout_manager","viz/core/export"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../helpers/trackerMock.js"), require("jquery"), require("../../helpers/vizMocks.js"), require("viz/chart_components/tracker"), require("viz/components/chart_theme_manager"), require("viz/components/legend"), require("viz/series/base_series"), require("viz/core/series_family"), require("viz/axes/base_axis"), require("viz/polar_chart"), require("viz/core/renderers/renderer"), require("viz/components/data_validator"), require("viz/translators/range"), require("viz/core/tooltip"), require("viz/chart_components/layout_manager"), require("viz/core/export"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=polarChart.tests.js.map