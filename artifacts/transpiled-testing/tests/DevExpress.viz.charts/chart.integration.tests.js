System.register(["jquery", "../../helpers/vizMocks.js", "../../helpers/executeAsyncMock.js", "viz/core/renderers/renderer", "viz/components/legend", "viz/core/title", "viz/chart", "viz/pie_chart", "viz/polar_chart", "viz/chart_components/base_chart", "viz/core/series_family", "../../helpers/chartMocks.js", "../../helpers/pointerMock.js"], function (_export, _context) {
  "use strict";

  var $, vizMocks, executeAsyncMock, rendererModule, legendModule, titleModule, dxChart, dxPieChart, dxPolarChart, baseChartModule, seriesFamilyModule, setupSeriesFamily, pointerMock, seriesFamilyNativeConstructor, chartContainerCounter, containerName, moduleSetup, VALIDATE_CHART_GROUPS, VALIDATE_PIECHART_GROUPS, VALIDATE_POLARCHART_GROUPS;
  ...
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_helpersVizMocksJs) {
      vizMocks = _helpersVizMocksJs.default;
    }, function (_helpersExecuteAsyncMockJs) {
      executeAsyncMock = _helpersExecuteAsyncMockJs.default;
    }, function (_vizCoreRenderersRenderer) {
      rendererModule = _vizCoreRenderersRenderer.default;
    }, function (_vizComponentsLegend) {
      legendModule = _vizComponentsLegend.default;
    }, function (_vizCoreTitle) {
      titleModule = _vizCoreTitle.default;
    }, function (_vizChart) {
      dxChart = _vizChart.default;
    }, function (_vizPie_chart) {
      dxPieChart = _vizPie_chart.default;
    }, function (_vizPolar_chart) {
      dxPolarChart = _vizPolar_chart.default;
    }, function (_vizChart_componentsBase_chart) {
      baseChartModule = _vizChart_componentsBase_chart.default;
    }, function (_vizCoreSeries_family) {
      seriesFamilyModule = _vizCoreSeries_family.default;
    }, function (_helpersChartMocksJs) {
      setupSeriesFamily = _helpersChartMocksJs.setupSeriesFamily;
    }, function (_helpersPointerMockJs) {
      pointerMock = _helpersPointerMockJs.default;
    }],
    execute: function () {
      seriesFamilyNativeConstructor = {
        ...seriesFamilyModule
      }.SeriesFamily;
      setupSeriesFamily();
      ...
      QUnit.test('MultiAxis with title and inverted axis', function (assert) {
        ...
        const chart = this.createChart({
          ...
          valueAxis: [{
            ...
            position: 'left',
            title: {
              text: 'title very long <br/> test <br/> test',
              margin: 0
            },
            grid: {
              visible: true
      ...
      QUnit.test('Set visualRange via arguments', function (assert) {
        ...
        assert.deepEqual(chart._argumentAxes[0].getViewport(), {
          startValue: 2.5,
          endValue: undefined
        });
      });
      QUnit.test('Set visualRange via array', function (assert) {
        ...
        assert.deepEqual(chart.getArgumentAxis().getViewport(), {
          startValue: 2,
          endValue: 8
        });
        ...
        assert.deepEqual(visualRangeChanged.firstCall.args[0].value, {
          startValue: 2,
          endValue: 8
        });
      });
      QUnit.test('Set visualRange for indexed valueAxis (check onOptionChanged fired)', function (assert) {
        ...
        assert.deepEqual(visualRangeChanged.lastCall.args[0].value, {
          startValue: 3,
          endValue: 6
        });
        assert.deepEqual(chart.option('valueAxis[0].visualRange'), {
          startValue: 3,
          endValue: 6
        });
      });
      ...
      QUnit.test('Set visualRange for multi axis/pane (exists option collection for each value axis)', function (assert) {
        ...
        assert.deepEqual(chart.option('valueAxis[1].visualRange'), {
          startValue: 3,
          endValue: 25
        });
      });
      ...
      QUnit.test('Cancel visualRange setting for logarithm axis', function (assert) {
        ...
        assert.deepEqual(zoomEnd.firstCall.args[0].range, {
          startValue: 10,
          endValue: 1000
        });
      ...
      QUnit.test('Using the single section of axis options for some panes (check customVisualRange merging)', function (assert) {
        ...
        assert.deepEqual(chart.getArgumentAxis().visualRange(), {
          startValue: 4,
          endValue: 6
        }, 'argument visual range');
        assert.deepEqual(chart._valueAxes[0].visualRange(), {
          startValue: 6,
          endValue: 7
        });
        assert.deepEqual(chart._valueAxes[1].visualRange(), {
          startValue: 18,
          endValue: 25
        });
        assert.deepEqual(visualRangeChanged.callCount, 3);
        assert.deepEqual(visualRangeChanged.getCall(1).args[0].value, {
          startValue: 4,
          endValue: 6
        });
        assert.deepEqual(visualRangeChanged.getCall(2).args[0].value, {
          startValue: 18,
          endValue: 25
        });
      });
      ...
      QUnit.test('Set the visualRange option by the different ways', function (assert) {
        ...
        assert.deepEqual(visualRangeChanged.getCall(3).args[0].value, {
          visualRange: [2, 7]
        });
        ...
        assert.deepEqual(chart.option('valueAxis._customVisualRange'), {
          startValue: 3
        });
        visualRangeChanged.reset();
        chart.option('valueAxis', {
      ...
      QUnit.test('Reload dataSource - visualRange option should be changed', function (assert) {
        ...
        // assert
        // argumentAxis
        assert.deepEqual(visualRangeChanged.getCall(0).args[0].previousValue, {
          startValue: 1,
          endValue: 5
        });
        assert.deepEqual(visualRangeChanged.getCall(0).args[0].value, {
          startValue: 1,
          endValue: 11
        });
        assert.deepEqual(chart.option('argumentAxis.visualRange'), {
        ...
        // valueAxis
        assert.deepEqual(visualRangeChanged.getCall(1).args[0].previousValue, {
          startValue: 4,
          endValue: 7
        });
        assert.deepEqual(visualRangeChanged.getCall(1).args[0].value, {
      ...
      QUnit.test('Set null visualRange', function (assert) {
        ...
        assert.deepEqual(chart._valueAxes[0].visualRange(), {
          startValue: 3,
          endValue: 8
        }, 'visualRange is full (value axis)');
      });
      ...
      QUnit.test('Reset axis viewport', function (assert) {
        ...
        assert.equal(zoomEnd.callCount, 1);
        assert.deepEqual(zoomStart.firstCall.args[0].range, {
          startValue: 2,
          endValue: 5
        });
        assert.deepEqual(zoomEnd.firstCall.args[0].range, {
      ...
      QUnit.test('Reset chart viewport', function (assert) {
        ...
        assert.deepEqual(zoomStart.thirdCall.args[0].range, {
          startValue: -20,
          endValue: 40
        });
        ...
        assert.deepEqual(chart.getArgumentAxis().visualRange(), {
          startValue: new Date(2000, 6, 1),
          endValue: new Date(2015, 3, 1)
        });
        assert.deepEqual(chart.getValueAxis().visualRange(), {
          startValue: 1,
          endValue: 706
        });
        assert.deepEqual(chart.getValueAxis('ax1').visualRange(), {
          startValue: 0,
          endValue: 263
        });
      });
      ...
      QUnit.test('dxChart reinitialization - dataSource - correct axes min max', function (assert) {
        ...
        argAxis.setBusinessRange = sinon.spy(function () {
          return argFunction.apply(argAxis, arguments);
        });
        valAxis.setBusinessRange = sinon.spy(function () {
          return valFunction.apply(valAxis, arguments);
        });
      ...
      QUnit.test('Chart with large scale break', function (assert) {
        ...
        createChartInstance({
          ...
          dataSource: [{
            x: '2016-03-27T21:00:00.000Z',
            y1: 1600
          }, {
            x: '2016-07-30T21:00:00.000Z',
            y1: 430
          }],
          legend: {
            visible: false
      ...
      VALIDATE_CHART_GROUPS = ['dxc-background', 'dxc-title', 'dxc-strips-group', 'dxc-grids-group', 'dxc-border', 'dxc-axes-group', 'dxc-strips-labels-group', 'dxc-constant-lines-group', 'dxc-series-group', 'dxc-elements-axes-group', 'dxc-constant-lines-group', 'dxc-scale-breaks', 'dxc-labels-group', 'dxc-crosshair-cursor', 'dxc-legend', 'dxc-annotations', 'dx-export-menu'];
      VALIDATE_PIECHART_GROUPS = ['dxc-background', 'dxc-series-group', 'dxc-labels-group', 'dxc-legend', 'dxc-hole-template', 'dxc-annotations'];
      VALIDATE_POLARCHART_GROUPS = ['dxc-background', 'dxc-strips-group', 'dxc-grids-group', 'dxc-axes-group', 'dxc-elements-axes-group', 'dxc-strips-labels-group', 'dxc-constant-lines-group', 'dxc-series-group', 'dxc-constant-lines-group', 'dxc-scale-breaks', 'dxc-labels-group', 'dxc-crosshair-cursor', 'dxc-legend', 'dxc-annotations'];
      ...
      QUnit.test('Legend inside position. Zooming', function (assert) {
        ...
        root = $(chart._renderer.root.element), groupTag = root[0].tagName.toLowerCase() === 'div' ? 'div' : 'g', groups = root.find('>' + groupTag);
        checkOrder(assert, groups, VALIDATE_CHART_GROUPS);
      });
      ...
      QUnit.test('Set/reset the visualRange by API methods', function (assert) {
        ...
        assert.deepEqual(chart.option().valueAxis._customVisualRange, $.extend({
          action: undefined
        }, visualRange));
        visualRangeChanged.reset();
        visualRange = {
      ...
      QUnit.test('Resolve overlapping: labels and axes', function (assert) {
        ...
        argAxis._detectElementsOverlapping = sinon.spy(function () {
          return argFunction.apply(argAxis, arguments);
        });
        valAxis2._detectElementsOverlapping = sinon.spy(function () {
          return valFunction.apply(valAxis2, arguments);
        });
      ...
      QUnit.test('Set bar width (via interval) for each pane (T1000672)', function (assert) {
        ...
        const chart = this.createChart({
          ...
          defaultPane: 'bottomPane',
          dataSource: [{
            timestamp: '2021-05-15T13:00:00-0500',
            name_one: 100,
            name_two: 20
          }, {
            timestamp: '2021-05-15T14:00:00-0500',
            name_one: 80,
            name_two: 40
          }, {
            timestamp: '2021-05-15T17:00:00-0500',
            name_one: 100,
            name_two: 20
          }, {
            timestamp: '2021-05-15T21:00:00-0500',
            name_one: 100,
            name_two: 20
          }, {
            timestamp: '2021-05-15T22:00:00-0500',
            name_one: 80,
            name_two: 40
          }, {
            timestamp: '2021-05-15T23:00:00-0500',
            name_one: 60,
            name_two: 20
          }, {
            timestamp: '2021-05-15T12:05:00-0500',
            'f-name_one': 60
          }, {
            timestamp: '2021-05-15T12:10:00-0500',
            'f-name_one': 60
          }, {
            timestamp: '2021-05-15T12:15:00-0500',
            'f-name_one': 60
          }, {
            timestamp: '2021-05-15T12:20:00-0500',
            'f-name_one': 60
          }, {
            timestamp: '2021-05-15T12:25:00-0500',
            'f-name_one': 60
          }, {
            timestamp: '2021-05-15T13:30:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T13:35:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T13:40:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T13:45:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T15:00:00-0500',
            'f-name_one': 40
          }, {
            timestamp: '2021-05-15T15:05:00-0500',
            'f-name_one': 40
          }, {
            timestamp: '2021-05-15T15:10:00-0500',
            'f-name_one': 40
          }, {
            timestamp: '2021-05-15T15:15:00-0500',
            'f-name_one': 40
          }, {
            timestamp: '2021-05-15T16:10:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T16:15:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T16:20:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T16:25:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T16:30:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T16:35:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T17:55:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T18:00:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T19:10:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T19:15:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T19:20:00-0500',
            'f-name_one': 0
          }, {
            timestamp: '2021-05-15T20:10:00-0500',
            'f-name_one': 20
          }, {
            timestamp: '2021-05-15T20:15:00-0500',
            'f-name_one': 20
          }, {
            timestamp: '2021-05-15T20:20:00-0500',
            'f-name_one': 20
          }, {
            timestamp: '2021-05-15T20:25:00-0500',
            'f-name_one': 20
          }, {
            timestamp: '2021-05-15T20:30:00-0500',
            'f-name_one': 20
          }],
          panes: [{
            name: 'topPane'
