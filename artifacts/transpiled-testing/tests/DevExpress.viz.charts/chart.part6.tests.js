...
(["testing/tests/DevExpress.viz.charts/chart.part6.tests.js"], ["jquery","../../helpers/executeAsyncMock.js","./chartParts/commons.js","viz/chart_components/multi_axes_synchronizer","../../helpers/chartMocks.js"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.charts/chart.part6.tests.js', ['jquery', '../../helpers/executeAsyncMock.js', './chartParts/commons.js', 'viz/chart_components/multi_axes_synchronizer', '../../helpers/chartMocks.js'], true, function ($__require, exports, module) {
    ...
    QUnit.test('change dataSource only - reinitialized series data', function (assert) {
        ...
        const chart = this.createChart({
            series: [{ name: 'First series', type: 'line' }],
    ...
    QUnit.test('change series order only', function (assert) {
        ...
        chartMocks.seriesMockData.series.push(stubSeries1, stubSeries2, stubSeries3);
        const chart = this.createChart({
            series: [{ name: 'First series', type: 'line' }, { name: 'Second series', type: 'line' }]
        });
        $.each(chart.series, function (_, series) {
            series.dispose = function () {
                chart.seriesDisposed = true;
        ...
        // Act
        chart.option({
            series: [{ name: 'Second series', type: 'line' }, { name: 'First series', type: 'line' }]
        });
        // Assert
        assert.ok(!chart.seriesDisposed, 'Series should be disposed');
        assert.ok(chart.seriesFamiliesDisposed, 'SeriesFamilies should be disposed');
    ...
    QUnit.test('change series - pass less series than chart has', function (assert) {
        ...
        // Act
        chart.option({
            series: [{ name: 'Second series', type: 'line' }]
        });
        // Assert
        assert.ok(chart.seriesDisposed, 'Series should be disposed');
        assert.ok(chart.seriesFamiliesDisposed, 'SeriesFamilies should be disposed');
    ...
    QUnit.test('SeriesTemplate.', function (assert) {
        ...
        const chart = this.createChart({
            ...
            seriesTemplate: { nameField: 'series', type: 'line', customizeSeries: function (sName) {
                    return { type: 'line-' + sName };
                } }
        });
        ...
        this.validateData.reset();
        chart.seriesFamilies[0].adjustSeriesValues.reset();
        this.themeManager.getOptions.withArgs('seriesTemplate').returns({ nameField: 'series', customizeSeries: function (sName) {
                return { type: 'spline-' + sName };
            } });
        // Act
        chart.option({
            seriesTemplate: { nameField: 'series', customizeSeries: function (sName) {
                    return { type: 'spline-' + sName };
                } }
        });
        // Assert
    ...
    QUnit.test('Common axis settings more strips', function (assert) {
        ...
        const newOptions = {
            strips: [{ startValue: 10, endValue: 20, color: 'red' }, { startValue: 30, endValue: 40, color: 'red' }, { startValue: 50, endValue: 60, color: 'red' }]
        };
        // Act
        chart.option({
            commonAxisSettings: newOptions
    ...
    QUnit.test('Multiple Value axis more strips', function (assert) {
        ...
        const newOptions = [{
            strips: [{ startValue: 10, endValue: 20, color: 'green' }, { startValue: 30, endValue: 40, color: 'green' }, { startValue: 50, endValue: 60, color: 'green' }]
        }, {
            strips: [{ startValue: 70, endValue: 80, color: 'red' }, { startValue: 90, endValue: 100, color: 'red' }, { startValue: 110, endValue: 120, color: 'red' }]
        }];
        // Act
        chart.option({
            valueAxis: newOptions
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/executeAsyncMock.js","./chartParts/commons.js","viz/chart_components/multi_axes_synchronizer","../../helpers/chartMocks.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/executeAsyncMock.js"), require("./chartParts/commons.js"), require("viz/chart_components/multi_axes_synchronizer"), require("../../helpers/chartMocks.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=chart.part6.tests.js.map