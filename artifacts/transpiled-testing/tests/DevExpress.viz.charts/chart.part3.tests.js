...
(["testing/tests/DevExpress.viz.charts/chart.part3.tests.js"], ["jquery","./chartParts/commons.js","viz/core/renderers/renderer","viz/components/legend","viz/chart_components/crosshair","viz/chart_components/tracker","viz/utils","../../helpers/chartMocks.js"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.charts/chart.part3.tests.js', ['jquery', './chartParts/commons.js', 'viz/core/renderers/renderer', 'viz/components/legend', 'viz/chart_components/crosshair', 'viz/chart_components/tracker', 'viz/utils', '../../helpers/chartMocks.js'], true, function ($__require, exports, module) {
    ...
    QUnit.test('Panes - Percent format for pane with full stacked series', function (assert) {
        ...
        const chart = this.createChart({
            ...
            series: [{ type: 'line' }, { type: 'fullstackedbar' }],
            panes: [{
                name: 'topPane'
            }, {
                name: 'bottomPane'
    ...
    QUnit.test('No stack name', function (assert) {
        // arrange
        const s1Points = [new MockPoint({ argument: '1', val: 1 }), new MockPoint({ argument: '2', val: 2 }), new MockPoint({ argument: '3', val: 3 })];
        const s2Points = [new MockPoint({ argument: '1', val: 3 }), new MockPoint({ argument: '2', val: 5 }), new MockPoint({ argument: '3', val: 7 })];
    ...
    QUnit.test('Different stacks', function (assert) {
        // arrange
        const s1Points = [new MockPoint({ argument: '1', val: 1 }), new MockPoint({ argument: '2', val: 2 }), new MockPoint({ argument: '3', val: 3 })];
        const s2Points = [new MockPoint({ argument: '1', val: 4 }), new MockPoint({ argument: '2', val: 5 }), new MockPoint({ argument: '3', val: 6 })];
        const s3Points = [new MockPoint({ argument: '1', val: 7 }), new MockPoint({ argument: '2', val: 8 }), new MockPoint({ argument: '3', val: 9 })];
        const s4Points = [new MockPoint({ argument: '1', val: 10 }), new MockPoint({ argument: '2', val: 11 }), new MockPoint({ argument: '3', val: 12 })];
    ...
    QUnit.test('create crosshair, border of panes is visible', function (assert) {
        ...
        assert.ok(chart._crosshair);
        assert.ok(chart._crosshair.render.called);
        assert.deepEqual(crosshairModule.Crosshair.lastCall.args, [chart._renderer, chart.option('crosshair'), {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","./chartParts/commons.js","viz/core/renderers/renderer","viz/components/legend","viz/chart_components/crosshair","viz/chart_components/tracker","viz/utils","../../helpers/chartMocks.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("./chartParts/commons.js"), require("viz/core/renderers/renderer"), require("viz/components/legend"), require("viz/chart_components/crosshair"), require("viz/chart_components/tracker"), require("viz/utils"), require("../../helpers/chartMocks.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=chart.part3.tests.js.map