...
(["testing/tests/DevExpress.viz.charts/themeManager.tests.js"], ["jquery","viz/components/chart_theme_manager","viz/palette","viz/themes"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.charts/themeManager.tests.js', ['jquery', 'viz/components/chart_theme_manager', 'viz/palette', 'viz/themes'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const themeManagerModule = $__require('viz/components/chart_theme_manager');
    ...
    (function chart() {
        ...
        QUnit.test('applyPieSeriesTheme, donut theme equal doughnut theme', function (assert) {
            ...
            doughnutTheme.mainSeriesColor = null, donutTheme.mainSeriesColor = null;
        ...
        QUnit.test('Disposing', function (assert) {
            ...
            themeManager.palette.dispose = function () {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","viz/components/chart_theme_manager","viz/palette","viz/themes"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("viz/components/chart_theme_manager"), require("viz/palette"), require("viz/themes"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=themeManager.tests.js.map