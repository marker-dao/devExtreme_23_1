...
(["testing/tests/DevExpress.viz.charts/chart.part1.tests.js"], ["jquery","core/utils/common","../../helpers/vizMocks.js","./chartParts/commons.js","data/data_source/data_source","viz/chart_components/base_chart","viz/core/renderers/renderer","viz/chart_components/layout_manager","viz/chart_components/tracker","viz/chart","core/utils/resize_callbacks","viz/core/utils","../../helpers/chartMocks.js"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.charts/chart.part1.tests.js', ['jquery', 'core/utils/common', '../../helpers/vizMocks.js', './chartParts/commons.js', 'data/data_source/data_source', 'viz/chart_components/base_chart', 'viz/core/renderers/renderer', 'viz/chart_components/layout_manager', 'viz/chart_components/tracker', 'viz/chart', 'core/utils/resize_callbacks', 'viz/core/utils', '../../helpers/chartMocks.js'], true, function ($__require, exports, module) {
    ...
    const BaseChart = $__require('viz/chart_components/base_chart').BaseChart;
    ...
    QUnit.test('Theme manager with no settings', function (assert) {
        ...
        assert.deepEqual(this.createThemeManager.lastCall.args, [{ themeSection: 'chart', options: chart.option(), fontFields: ['legend.font', 'legend.title.font', 'legend.title.subtitle.font', 'commonSeriesSettings.label.font', 'export.font', 'title.font', 'title.subtitle.font', 'tooltip.font', 'loadingIndicator.font', 'commonAxisSettings.label.font', 'commonAxisSettings.title.font', 'crosshair.label.font', 'commonAnnotationSettings.font'] }]);
    });
    ...
    QUnit.test('sorting data for series with many argument fields', function (assert) {
        ...
        commons.createChartInstance({
            dataSource: [{ arg1: 'a1', val1: 1, arg2: 'b1', val2: 1 }, { arg1: 'a2', val1: 2, arg2: 'b2', val2: 2 }, { arg1: 'a3', val1: 3, arg2: 'a3', val2: 3 }],
            series: [stubSeries1, stubSeries2]
        }, this.$container);

        assert.deepEqual(chartMocks.seriesMockData.series[0].reinitializedData, [{ arg1: 'a1', val1: 1, arg2: 'b1', val2: 1 }, { arg1: 'a2', val1: 2, arg2: 'b2', val2: 2 }, { arg1: 'a3', val1: 3, arg2: 'a3', val2: 3 }]);

        assert.deepEqual(chartMocks.seriesMockData.series[1].reinitializedData, [{ arg1: 'a3', val1: 3, arg2: 'a3', val2: 3 }, { arg1: 'a1', val1: 1, arg2: 'b1', val2: 1 }, { arg1: 'a2', val1: 2, arg2: 'b2', val2: 2 }]);
    });
});
})
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","../../helpers/vizMocks.js","./chartParts/commons.js","data/data_source/data_source","viz/chart_components/base_chart","viz/core/renderers/renderer","viz/chart_components/layout_manager","viz/chart_components/tracker","viz/chart","core/utils/resize_callbacks","viz/core/utils","../../helpers/chartMocks.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("../../helpers/vizMocks.js"), require("./chartParts/commons.js"), require("data/data_source/data_source"), require("viz/chart_components/base_chart"), require("viz/core/renderers/renderer"), require("viz/chart_components/layout_manager"), require("viz/chart_components/tracker"), require("viz/chart"), require("core/utils/resize_callbacks"), require("viz/core/utils"), require("../../helpers/chartMocks.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=chart.part1.tests.js.map