...
(["testing/tests/DevExpress.viz.charts/chartSync.tests.js"], ["../../helpers/trackerMock.js","jquery","../../helpers/vizMocks.js","viz/chart_components/tracker","core/dom_adapter","core/utils/common","../../helpers/executeAsyncMock.js","viz/core/utils","viz/core/title","viz/core/export","viz/core/tooltip","viz/core/renderers/renderer","core/utils/deferred","viz/components/legend","viz/chart_components/layout_manager","viz/components/data_validator","data/custom_store","viz/components/chart_theme_manager","viz/chart_components/scroll_bar","viz/chart","../../helpers/chartMocks.js"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.charts/chartSync.tests.js', ['../../helpers/trackerMock.js', 'jquery', '../../helpers/vizMocks.js', 'viz/chart_components/tracker', 'core/dom_adapter', 'core/utils/common', '../../helpers/executeAsyncMock.js', 'viz/core/utils', 'viz/core/title', 'viz/core/export', 'viz/core/tooltip', 'viz/core/renderers/renderer', 'core/utils/deferred', 'viz/components/legend', 'viz/chart_components/layout_manager', 'viz/components/data_validator', 'data/custom_store', 'viz/components/chart_theme_manager', 'viz/chart_components/scroll_bar', 'viz/chart', '../../helpers/chartMocks.js'], true, function ($__require, exports, module) {
    ...
    const domAdapter = $__require('core/dom_adapter');
    ...
    const { Deferred } = $__require('core/utils/deferred');
    ...
    const scrollBarModule = $__require('viz/chart_components/scroll_bar');
    const ScrollBar = scrollBarModule.ScrollBar;
    const dxChart = $__require('viz/chart');
    ...
    const environment = {
        beforeEach: function () {
            ...
            sinon.stub(layoutManagerModule, 'LayoutManager').callsFake(function () {
                ...
                layoutManager.stub('needMoreSpaceForPanesCanvas').returns({ width: 10, height: 10 });
                layoutManager.stub('placeDrawnElements');
    ...
    (function dynamicTests() {
        ...
        QUnit.test('Redraw if hidden container is already shown', function (assert) {
            ...
            $.each(chart.seriesFamilies, function (_, family) {
                family.dispose = function () {
                    chart.seriesFamiliesDisposed = true;
                };
            });
            $.each(chart._argumentAxes, function (_, axis) {
                axis.dispose = function () {
                    chart.horizontalAxesDisposed = true;
                };
            });
            $.each(chart._valueAxes, function (_, axis) {
                axis.dispose = function () {
                    chart.verticalAxesDisposed = true;
                };
            });
            this.$container.show();
            // act
        ...
        QUnit.test('Redraw chart after render templates', function (assert) {
            ...
            $.each(chart._argumentAxes, function (_, axis) {
                ...
                axis.getTemplatesGroups = function () {
        ...
        QUnit.test('One series is animated while second one is not', function (assert) {
            ...
            const chart = this.createChart({
                ...
                series: [{ type: 'line' }, { valueField: 'val2', type: 'line' }]
            });
            // assert
        ...
        QUnit.test('Dispose', function (assert) {
                ...
                $.each(chart[propName], function (_, item) {
                    if (item && fields) {
                        $.each(fields, function (_, field) {
                            item[field] && (item[field].dispose = function () {
                                chart[propName + 'Disposed']++;
                            });
                        });
                    } else {
                        item && (item.dispose = function () {
                            chart[propName + 'Disposed']++;
                        });
                    }
                });
            ...
            const mockObjectDispose = function (propName) {
                chart[propName] && (chart[propName].dispose = function () {
                    chart[propName + 'Disposed'] = true;
                });
            };
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../helpers/trackerMock.js","jquery","../../helpers/vizMocks.js","viz/chart_components/tracker","core/dom_adapter","core/utils/common","../../helpers/executeAsyncMock.js","viz/core/utils","viz/core/title","viz/core/export","viz/core/tooltip","viz/core/renderers/renderer","core/utils/deferred","viz/components/legend","viz/chart_components/layout_manager","viz/components/data_validator","data/custom_store","viz/components/chart_theme_manager","viz/chart_components/scroll_bar","viz/chart","../../helpers/chartMocks.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../helpers/trackerMock.js"), require("jquery"), require("../../helpers/vizMocks.js"), require("viz/chart_components/tracker"), require("core/dom_adapter"), require("core/utils/common"), require("../../helpers/executeAsyncMock.js"), require("viz/core/utils"), require("viz/core/title"), require("viz/core/export"), require("viz/core/tooltip"), require("viz/core/renderers/renderer"), require("core/utils/deferred"), require("viz/components/legend"), require("viz/chart_components/layout_manager"), require("viz/components/data_validator"), require("data/custom_store"), require("viz/components/chart_theme_manager"), require("viz/chart_components/scroll_bar"), require("viz/chart"), require("../../helpers/chartMocks.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=chartSync.tests.js.map