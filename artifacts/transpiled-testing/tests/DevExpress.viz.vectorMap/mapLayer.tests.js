...
(["testing/tests/DevExpress.viz.vectorMap/mapLayer.tests.js"], ["jquery","core/utils/common","viz/vector_map/map_layer","viz/vector_map/tracker","viz/vector_map/data_exchanger","viz/vector_map/projection.main","data/data_source/data_source","viz/core/base_theme_manager","../../helpers/vizMocks.js"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.vectorMap/mapLayer.tests.js', ['jquery', 'core/utils/common', 'viz/vector_map/map_layer', 'viz/vector_map/tracker', 'viz/vector_map/data_exchanger', 'viz/vector_map/projection.main', 'data/data_source/data_source', 'viz/core/base_theme_manager', '../../helpers/vizMocks.js'], true, function ($__require, exports, module) {
    ...
    const baseThemeManagerModule = $__require('viz/core/base_theme_manager');
    ...
    QUnit.test('Create with customization', function (assert) {
        ...
        const proxies = $.map(StubMapLayerElement.items, function (item) {
            return item.proxy;
        });
    ...
    QUnit.test('getProxies', function (assert) {
        assert.deepEqual(this.layer.getProxies(), $.map(this.items, function (item) {
            return item.proxy;
        }));
    });
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","viz/vector_map/map_layer","viz/vector_map/tracker","viz/vector_map/data_exchanger","viz/vector_map/projection.main","data/data_source/data_source","viz/core/base_theme_manager","../../helpers/vizMocks.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("viz/vector_map/map_layer"), require("viz/vector_map/tracker"), require("viz/vector_map/data_exchanger"), require("viz/vector_map/projection.main"), require("data/data_source/data_source"), require("viz/core/base_theme_manager"), require("../../helpers/vizMocks.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=mapLayer.tests.js.map