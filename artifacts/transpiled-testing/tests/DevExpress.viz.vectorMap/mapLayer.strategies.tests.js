...
(["testing/tests/DevExpress.viz.vectorMap/mapLayer.strategies.tests.js"], ["jquery","core/utils/common","../../helpers/vizMocks.js","viz/vector_map/map_layer"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.viz.vectorMap/mapLayer.strategies.tests.js', ['jquery', 'core/utils/common', '../../helpers/vizMocks.js', 'viz/vector_map/map_layer'], true, function ($__require, exports, module) {
    ...
    QUnit.test('Select project strategy by type (polygon/multipolygon)', function (assert) {
        ...
        assert.deepEqual(areaStrategyPolygon.project(projection, [[[1, 2], [3, 4, 5], [6]]]), [['1,2-proj', '3,4,5-proj', '6-proj']], 'area polygon');
        assert.deepEqual(areaStrategyPolygon.project(projection, [[[[1, 2], [3]], [[4, 5, 6]]]]), [['1,2-proj', '3-proj'], ['4,5,6-proj']], 'area multipolygon');
    });
    ...
    QUnit.test('Project', function (assert) {
        ...
        assert.deepEqual(lineStrategyLineString.project(projection, ['p1', 'p2', 'p3']), [['p1-proj', 'p2-proj', 'p3-proj']], 'line linestring');
        assert.deepEqual(lineStrategyMultiLineString.project(projection, [['p1', 'p2'], ['p3', 'p4', 'p5'], ['p6']]), [['p1-proj', 'p2-proj'], ['p3-proj', 'p4-proj', 'p5-proj'], ['p6-proj']], 'line multilinestring');
        assert.deepEqual(pointDotStrategy.project(projection, ['p']), 'p-proj', 'point');
    });

    QUnit.test('Project area label', function (assert) {
        const data = areaStrategyPolygon.projectLabel([[[10, 20], [10, 40], [30, 40], [40, 20]], [[30, 50], [30, 60], [40, 70], [50, 20]]]);
    ...
    QUnit.test('Project line label', function (assert) {
        const data = lineStrategyLineString.projectLabel([[[10, 20], [10, 40], [30, 40], [40, 20], [50, 20]], [[30, 50], [30, 60], [40, 70]]]);
    ...
    QUnit.test('Transform area', function (assert) {
        ...
        areaStrategyPolygon.transform(figure, projection, [['p1', 'p2'], ['p3']]);

        assert.deepEqual(figure.root.attr.lastCall.args, [{
            points: [['p1-tr1', 'p1-tr2', 'p2-tr1', 'p2-tr2'], ['p3-tr1', 'p3-tr2']]
        }]);
    });
    ...
    QUnit.test('Transform line', function (assert) {
        ...
        lineStrategyLineString.transform(figure, projection, [['p1', 'p2'], ['p3']]);
    ...
    QUnit.test('Get styles', function (assert) {
        assert.deepEqual(areaStrategyPolygon.getStyles({
            ...
            root: [{ 'class': 'dxm-area', stroke: 'c1', 'stroke-width': 1, fill: 'c2', opacity: 'o1' }, { 'class': 'dxm-area dxm-area-hovered', stroke: 'c3', 'stroke-width': 2, fill: 'c4', opacity: 'o2' }, { 'class': 'dxm-area dxm-area-selected', stroke: 'c5', 'stroke-width': 3, fill: 'c6', opacity: 'o3' }]
        });
    });
    ...
    QUnit.test('Get styles, zero values', function (assert) {
        assert.deepEqual(areaStrategyPolygon.getStyles({
            ...
            root: [{ 'class': 'dxm-area', stroke: 'c1', 'stroke-width': 0, fill: 'c2', opacity: 0 }, { 'class': 'dxm-area dxm-area-hovered', stroke: 'c3', 'stroke-width': 0, fill: 'c4', opacity: 0 }, { 'class': 'dxm-area dxm-area-selected', stroke: 'c5', 'stroke-width': 0, fill: 'c6', opacity: 0 }]
        });
    });
    ...
    QUnit.test('Get styles', function (assert) {
        assert.deepEqual(lineStrategyLineString.getStyles({
            ...
            root: [{ 'class': 'dxm-line', stroke: 'c1', 'stroke-width': 1, opacity: 'o1' }, { 'class': 'dxm-line dxm-line-hovered', stroke: 'c2', 'stroke-width': 2, opacity: 'o2' }, { 'class': 'dxm-line dxm-line-selected', stroke: 'c3', 'stroke-width': 3, opacity: 'o3' }]
        });
    });
    ...
    QUnit.test('Get styles, zero values', function (assert) {
        assert.deepEqual(lineStrategyLineString.getStyles({
            ...
            root: [{ 'class': 'dxm-line', stroke: 'c1', 'stroke-width': 0, opacity: 0 }, { 'class': 'dxm-line dxm-line-hovered', stroke: 'c2', 'stroke-width': 0, opacity: 0 }, { 'class': 'dxm-line dxm-line-selected', stroke: 'c3', 'stroke-width': 0, opacity: 0 }]
        });
    });
    ...
    QUnit.test('Get styles', function (assert) {
        assert.deepEqual(pointDotStrategy.getStyles({
            ...
            back: [{ fill: 'c7', opacity: 0.4, r: 4, stroke: 'none', 'stroke-width': 0 }, { fill: 'c7', opacity: 0.4, r: 5.5, stroke: 'none', 'stroke-width': 0 }, { fill: 'c7', opacity: 0.4, r: 6.5, stroke: 'none', 'stroke-width': 0 }],
            dot: [{ fill: 'c2', r: 4, stroke: 'c1', 'stroke-width': 1, opacity: 'o1' }, { fill: 'c4', r: 4, stroke: 'c3', 'stroke-width': 2, opacity: 'o2' }, { fill: 'c6', r: 5, stroke: 'c5', 'stroke-width': 3, opacity: 'o3' }]
        });
    });
    ...
    QUnit.test('Get styles, zero values', function (assert) {
        assert.deepEqual(pointDotStrategy.getStyles({
            ...
            root: [{ 'class': 'dxm-marker' }, { 'class': 'dxm-marker dxm-marker-hovered' }, { 'class': 'dxm-marker dxm-marker-selected' }],
            back: [{ fill: 'c7', opacity: 0, r: 4, stroke: 'none', 'stroke-width': 0 }, { fill: 'c7', opacity: 0, r: 5.5, stroke: 'none', 'stroke-width': 0 }, { fill: 'c7', opacity: 0, r: 6.5, stroke: 'none', 'stroke-width': 0 }],
            dot: [{ fill: 'c2', r: 4, stroke: 'c1', 'stroke-width': 0, opacity: 0 }, { fill: 'c4', r: 4, stroke: 'c3', 'stroke-width': 0, opacity: 0 }, { fill: 'c6', r: 5, stroke: 'c5', 'stroke-width': 0, opacity: 0 }]
        });
    });
    ...
    QUnit.test('Get styles', function (assert) {
        assert.deepEqual(pointBubbleStrategy.getStyles({
            ...
            root: [{ 'class': 'dxm-marker' }, { 'class': 'dxm-marker dxm-marker-hovered' }, { 'class': 'dxm-marker dxm-marker-selected' }],
            bubble: [{ fill: 'c2', stroke: 'c1', 'stroke-width': 1, opacity: 0.1 }, { fill: 'c4', stroke: 'c3', 'stroke-width': 2, opacity: 0.2 }, { fill: 'c6', stroke: 'c5', 'stroke-width': 3, opacity: 0.3 }]
        });
    });
    ...
    QUnit.test('Get styles, zero values', function (assert) {
        assert.deepEqual(pointBubbleStrategy.getStyles({
            ...
            root: [{ 'class': 'dxm-marker' }, { 'class': 'dxm-marker dxm-marker-hovered' }, { 'class': 'dxm-marker dxm-marker-selected' }],
            bubble: [{ fill: 'c2', stroke: 'c1', 'stroke-width': 0, opacity: 0 }, { fill: 'c4', stroke: 'c3', 'stroke-width': 0, opacity: 0 }, { fill: 'c6', stroke: 'c5', 'stroke-width': 0, opacity: 0 }]
        });
    });
    ...
    QUnit.test('Refresh', function (assert) {
        ...
        pointPieStrategy.refresh(this.context, figure, 'test-data', { attribute: stub }, { _colors: ['c1', 'c2', 'c3'], size: 8 });
    ...
    QUnit.test('Get styles', function (assert) {
        assert.deepEqual(pointPieStrategy.getStyles({
            ...
            root: [{ 'class': 'dxm-marker' }, { 'class': 'dxm-marker dxm-marker-hovered' }, { 'class': 'dxm-marker dxm-marker-selected' }],
            pie: [{ opacity: 0.1 }, { opacity: 0.2 }, { opacity: 0.3 }],
            border: [{ stroke: 'c1', 'stroke-width': 1 }, { stroke: 'c2', 'stroke-width': 2 }, { stroke: 'c3', 'stroke-width': 3 }]
        });
    });
    ...
    QUnit.test('Get styles, zero values', function (assert) {
        assert.deepEqual(pointPieStrategy.getStyles({
            ...
            root: [{ 'class': 'dxm-marker' }, { 'class': 'dxm-marker dxm-marker-hovered' }, { 'class': 'dxm-marker dxm-marker-selected' }],
            pie: [{ opacity: 0 }, { opacity: 0 }, { opacity: 0 }],
            border: [{ stroke: 'c1', 'stroke-width': 0 }, { stroke: 'c2', 'stroke-width': 0 }, { stroke: 'c3', 'stroke-width': 0 }]
        });
    });
    ...
    QUnit.test('Arrange', function (assert) {
        ...
        pointPieStrategy.arrange(this.context, [{ proxy: { attribute: sinon.stub().returns([1, 2]) } }, { proxy: { attribute: sinon.stub().returns([1, 2, 3]) } }, { proxy: { attribute: sinon.stub().returns([1]) } }]);
    ...
    QUnit.test('Get styles', function (assert) {
        assert.deepEqual(pointImageStrategy.getStyles({
            ...
            root: [{ 'class': 'dxm-marker' }, { 'class': 'dxm-marker dxm-marker-hovered' }, { 'class': 'dxm-marker dxm-marker-selected' }],
            image: [{ x: -5, y: -5, width: 10, height: 10, opacity: 'o1' }, { x: -6, y: -6, width: 12, height: 12, opacity: 'o2' }, { x: -9, y: -9, width: 18, height: 18, opacity: 'o3' }]
        });
    });
    ...
    QUnit.test('Get styles, zero values', function (assert) {
        assert.deepEqual(pointImageStrategy.getStyles({
            ...
            root: [{ 'class': 'dxm-marker' }, { 'class': 'dxm-marker dxm-marker-hovered' }, { 'class': 'dxm-marker dxm-marker-selected' }],
            image: [{ x: -5, y: -5, width: 10, height: 10, opacity: 0 }, { x: -6, y: -6, width: 12, height: 12, opacity: 0 }, { x: -9, y: -9, width: 18, height: 18, opacity: 0 }]
        });
    });
...
//# sourceMappingURL=mapLayer.strategies.tests.js.map