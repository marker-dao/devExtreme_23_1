...
(["testing/helpers/grid/keyboardNavigationHelper.js"], ["jquery","core/devices","events/utils/index","../dataGridMocks.js","events/click","events/pointer","events/short","../wrappers/dataGridWrappers.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/grid/keyboardNavigationHelper.js", ["jquery", "core/devices", "events/utils/index", "../dataGridMocks.js", "events/click", "events/pointer", "events/short", "../wrappers/dataGridWrappers.js"], function($__export) {
  "use strict";
  var $,
      devices,
      addNamespace,
  ...
  function setupModules(that, modulesOptions, gridModules) {
    ...
    gridModules = (gridModules || []).concat(['data', 'columns', 'editorFactory', 'gridView', 'columnHeaders', 'rows', 'grouping', 'headerPanel', 'search', 'editing', 'editingRowBased', 'editingFormBased', 'editingCellBased', 'keyboardNavigation', 'summary', 'masterDetail', 'virtualScrolling']);
  ...
  function triggerKeyDown(key, ctrl, shift, target, result) {
    ...
    var alt = false;
    var meta = false;
    if ((typeof ctrl === 'undefined' ? 'undefined' : $traceurRuntime.typeof(ctrl)) === 'object') {
      alt = ctrl.alt;
      shift = ctrl.shift;
      meta = ctrl.meta;
      ctrl = ctrl.ctrl;
    }
    var keyboardListenerId = this.keyboardNavigationController._keyDownListener;
  ...
  function focusCell(columnIndex, rowIndex) {
    var $cell = $(this.rowsView.getCellElement(rowIndex, columnIndex));
  ...
  function callViewsRenderCompleted(views) {
    $.each(views, function(_, view) {
      return view.renderCompleted.fire();
    });
  }
  $__export("setupModules", setupModules);
  $__export("testInDesktop", testInDesktop);
  $__export("triggerKeyDown", triggerKeyDown);
  $__export("fireKeyDown", fireKeyDown);
  $__export("focusCell", focusCell);
  $__export("getTextSelection", getTextSelection);
  $__export("callViewsRenderCompleted", callViewsRenderCompleted);
  return {
    ...
    execute: function() {
      ...
      $__export("dataGridWrapper", dataGridWrapper);
      device = devices.real();
      $__export("device", device);
      isMobile = device.deviceType !== 'desktop';
      $__export("isMobile", isMobile);
      pointerEventName = !isMobile ? pointerEvents.down : clickEvent.name;
      CLICK_EVENT = addNamespace(pointerEventName, 'dxDataGridKeyboardNavigation');
      $__export("CLICK_EVENT", CLICK_EVENT);
      KEYS = {
        'tab': 'Tab',
        'enter': 'Enter',
        'escape': 'Escape',
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/devices","events/utils","../dataGridMocks.js","events/click","events/pointer","events/short","../wrappers/dataGridWrappers.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/devices"), require("events/utils"), require("../dataGridMocks.js"), require("events/click"), require("events/pointer"), require("events/short"), require("../wrappers/dataGridWrappers.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=keyboardNavigationHelper.js.map