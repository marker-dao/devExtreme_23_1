...
(["testing/helpers/gridBaseMocks.js"], [], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/helpers/gridBaseMocks.js', [], true, function ($__require, exports, module) {
        ...
        exports.MockDataController = function (options) {
            ...
            return {
                ...
                getContentOffset: function (type) {
                    return options.virtualItemsCount ? options.virtualItemsCount[type || 'begin'] * 20 : 0;
                },
                    ...
                    const nextSorting = function (column) {
                        switch (column.sortOrder) {
                            case 'asc':
                                return 'desc';
                            case 'desc':
                                return column.groupIndex !== undefined ? 'asc' : null;
                        }
                        return 'asc';
                    };
...
//# sourceMappingURL=gridBaseMocks.js.map