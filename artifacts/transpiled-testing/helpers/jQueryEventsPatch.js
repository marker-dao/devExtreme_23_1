...
(["testing/helpers/jQueryEventsPatch.js"], ["events/core/events_engine"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/jQueryEventsPatch.js", ["events/core/events_engine"], function($__export) {
  "use strict";
  var eventsEngine,
      originalJQueryEvent,
      originalJQueryMethods;
  return {
        ...
        ['on', 'one', 'off', 'trigger', 'triggerHandler'].forEach(function(methodName) {
          ...
          if (methodName === 'on') {
            jQuery.fn.on = function(events, selector, data) {
              if ((typeof events === 'undefined' ? 'undefined' : $traceurRuntime.typeof(events)) === 'object') {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["events/core/events_engine"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("events/core/events_engine"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=jQueryEventsPatch.js.map