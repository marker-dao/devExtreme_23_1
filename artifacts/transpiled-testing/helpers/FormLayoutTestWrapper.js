...
(["testing/helpers/FormLayoutTestWrapper.js"], ["jquery"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/FormLayoutTestWrapper.js", ["jquery"], function($__export) {
  "use strict";
  var $,
  ...
  return {
    ...
    execute: function() {
      FormLayoutTestWrapper = function() {
        function FormLayoutTestWrapper(colCount, options, items) {
          var wrapperOptions = $.extend({}, options, {
            width: 1000,
            screenByWidth: function() {
              return 'md';
            },
            colCountByScreen: {md: colCount},
            items: items
          });
          var $form = $('#form').dxForm(wrapperOptions);
          $form.find('*').css('font-family', 'Helvetica');
          this.epsilon = 3.5;
          this.$form = $form;
        }
        return ($traceurRuntime.createClass)(FormLayoutTestWrapper, {
          checkFormSize: function(expectedWidth, expectedHeight) {
            var elementRect = this.$form.get(0).getBoundingClientRect();
          ...
          checkElementPosition: function($element, expectedTop, expectedLeft, expectedWidth, expectedHeight) {
            var elementRect = $element.get(0).getBoundingClientRect();
            var containerRect = this.$form.get(0).getBoundingClientRect();
      ...
      $__export('default', FormLayoutTestWrapper);
    }
  };
});
...
//# sourceMappingURL=FormLayoutTestWrapper.js.map