...
(["testing/helpers/calendarFixtures.js"], ["jquery","core/utils/common","core/class","ui/calendar/ui.calendar.views"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/helpers/calendarFixtures.js', ['jquery', 'core/utils/common', 'core/class', 'ui/calendar/ui.calendar.views'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const noop = $__require('core/utils/common').noop;
    const Class = $__require('core/class');
    const Views = $__require('ui/calendar/ui.calendar.views');
        ...
        testing: {
            CalendarFixture: DevExpress.ui.testing.BaseCalendarFixture.inherit({
                ctor: function (options) {
                    ...
                    this.calendar = $('#calendar').dxCalendar($.extend({ monthViewType: DevExpress.ui.testing.MockMonthView }, options)).dxCalendar('instance');
                    this.navigatorLinks = {
            ...
            DateBoxFixture: DevExpress.ui.testing.BaseCalendarFixture.inherit({
                ctor: function (element, options) {
                    ...
                    this.dateBox = this.rootElement.dxDateBox($.extend(true, {
                        pickerType: 'calendar',
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","core/class","ui/calendar/ui.calendar.views"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("core/class"), require("ui/calendar/ui.calendar.views"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=calendarFixtures.js.map