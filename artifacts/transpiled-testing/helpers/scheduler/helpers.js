...
(["testing/helpers/scheduler/helpers.js"], ["jquery","animation/translator","core/devices","../../helpers/pointerMock.js","core/element_data","color","generic_light.css!","ui/scheduler/ui.scheduler","ui/drop_down_button"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/scheduler/helpers.js", ["jquery", "animation/translator", "core/devices", "../../helpers/pointerMock.js", "core/element_data", "color", "generic_light.css!", "ui/scheduler/ui.scheduler", "ui/drop_down_button"], function($__export) {
  "use strict";
  var $,
      locate,
      devices,
  ...
  return {
    ...
    execute: function() {
      TOOLBAR_TOP_LOCATION = 'top';
      $__export("TOOLBAR_TOP_LOCATION", TOOLBAR_TOP_LOCATION);
      TOOLBAR_BOTTOM_LOCATION = 'bottom';
      $__export("TOOLBAR_BOTTOM_LOCATION", TOOLBAR_BOTTOM_LOCATION);
      SCHEDULER_ID = 'scheduler';
      TEST_ROOT_ELEMENT_ID = 'qunit-fixture';
      CLASSES = {
        root: '.dx-scheduler',
        button: '.dx-button',
      ...
      $__export("CLASSES", CLASSES);
      supportedScrollingModes = ['standard', 'virtual'];
      $__export("supportedScrollingModes", supportedScrollingModes);
      supportedViews = ['day', 'week', 'workWeek', 'month', 'timelineDay', 'timelineWeek', 'timelineWorkWeek', 'timelineMonth'];
      $__export("supportedViews", supportedViews);
      initTestMarkup = function() {
        return $(("#" + TEST_ROOT_ELEMENT_ID)).html(("<div id=\"" + SCHEDULER_ID + "\"><div data-options=\"dxTemplate: { name: 'template' }\">Task Template</div></div>"));
      };
      $__export("initTestMarkup", initTestMarkup);
      createWrapper = function(option) {
        return new SchedulerTestWrapper($(("#" + SCHEDULER_ID)).dxScheduler(option).dxScheduler('instance'));
      };
      $__export("createWrapper", createWrapper);
      isDesktopEnvironment = function() {
        return devices.real().deviceType === 'desktop';
      };
      $__export("isDesktopEnvironment", isDesktopEnvironment);
      isMACEnvironment = function() {
        return devices.real().mac;
      };
      checkResultByDeviceType = function(assert, callback) {
      ...
      $__export("checkResultByDeviceType", checkResultByDeviceType);
      asyncWrapper = function(assert, callback) {
        var done = assert.async();
        var promise = Promise.resolve();
        return callback(promise).catch(function(e) {
          return assert.ok(false, e.stack);
        }).then(done);
      };
      $__export("asyncWrapper", asyncWrapper);
      execAsync = function(assert, promise, beforeAssertCallback, assertCallback, timeout) {
        var timerId;
        return promise.then(function() {
          return new Promise(function(resolve, reject) {
            var execCallback = function(func) {
              try {
                func();
              } catch (e) {
      ...
      $__export("execAsync", execAsync);
      asyncScrollTest = function(assert, promise, assertCallback, scrollable, offset) {
        var scrollTimeout = arguments[5] !== (void 0) ? arguments[5] : 100;
        var wrapper = function() {
          return execAsync(assert, promise, function() {
            return scrollable.scrollTo(offset);
          }, assertCallback, scrollTimeout).catch(function() {
            return wrapper();
          });
        };
        return wrapper();
      };
      $__export("asyncScrollTest", asyncScrollTest);
      asyncAssert = function(assert, assertCallback, timeout) {
        return asyncWrapper(assert, function(promise) {
          execAsync(assert, promise, null, assertCallback, timeout);
          return promise;
        });
      };
      $__export("asyncAssert", asyncAssert);
      ElementWrapper = function() {
        function ElementWrapper(selector, parent) {
          var index = arguments[2] !== (void 0) ? arguments[2] : 0;
          this.selector = selector;
          this.parent = parent;
          this.index = index;
        }
        return ($traceurRuntime.createClass)(ElementWrapper, {
          getElement: function() {
            if (this.parent) {
      ...
      ClickElementWrapper = function($__super) {
        function ClickElementWrapper() {
          $traceurRuntime.superConstructor(ClickElementWrapper).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(ClickElementWrapper, {
          click: function() {
      ...
      AppointmentTitle = function($__super) {
        function AppointmentTitle(parent) {
          $traceurRuntime.superConstructor(AppointmentTitle).call(this, CLASSES.appointmentTitle, parent, 0);
        }
        return ($traceurRuntime.createClass)(AppointmentTitle, {get text() {
            return this.getElement().text();
          }}, {}, $__super);
      }(ElementWrapper);
      AppointmentMarker = function($__super) {
        function AppointmentMarker(parent) {
          $traceurRuntime.superConstructor(AppointmentMarker).call(this, CLASSES.appointmentMarker, parent, 0);
        }
        return ($traceurRuntime.createClass)(AppointmentMarker, {get color() {
            return new Color(this.getElement().css('backgroundColor')).toHex();
          }}, {}, $__super);
      }(ElementWrapper);
      Appointment = function($__super) {
        function Appointment(parent, index) {
          $traceurRuntime.superConstructor(Appointment).call(this, CLASSES.appointment, parent, index);
        }
        return ($traceurRuntime.createClass)(Appointment, {
          get rectangle() {
            var elementRect = this.getElement().get(0).getBoundingClientRect();
            return {
              x: elementRect.left,
              y: elementRect.top
            };
          ...
          get data() {
            var currentAppointment = this.getElement().get(0);
            return dataUtils.data(currentAppointment, 'dxItemData');
          },
          get drag() {
            var $__12 = this;
            return {toCell: function(cellNumber) {
                var cell = $(CLASSES.dateTableCell).eq(cellNumber).get(0);
                var cellRect = cell.getBoundingClientRect();
                var elementRect = $__12.getElement().get(0).getBoundingClientRect();
                var appointmentPos = {
                ...
                var pointer = pointerMock($__12.getElement()).start();
                pointer.down(appointmentPos.x, appointmentPos.y).move(cellPos.x - appointmentPos.x, cellPos.y - appointmentPos.y);
                pointer.up();
              }};
          },
          click: function() {
      ...
      NavigatorCaption = function($__super) {
        function NavigatorCaption(parent) {
          $traceurRuntime.superConstructor(NavigatorCaption).call(this, CLASSES.navigatorCaption, parent);
        }
        return ($traceurRuntime.createClass)(NavigatorCaption, {getText: function() {
            return this.getElement().text();
          }}, {}, $__super);
      }(ClickElementWrapper);
      CalendarCell = function($__super) {
        function CalendarCell() {
          $traceurRuntime.superConstructor(CalendarCell).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(CalendarCell, {get value() {
            return parseInt(this.getElement().find('span').eq(0).text());
          }}, {}, $__super);
      }(ClickElementWrapper);
      Calendar = function($__super) {
        function Calendar() {
          $traceurRuntime.superConstructor(Calendar).call(this, CLASSES.calendar);
        }
        return ($traceurRuntime.createClass)(Calendar, {
          get today() {
      ...
      NavigatorPopover = function($__super) {
        function NavigatorPopover() {
          $traceurRuntime.superConstructor(NavigatorPopover).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(NavigatorPopover, {
          get isVisible() {
      ...
      NavigatorWrapper = function($__super) {
        function NavigatorWrapper() {
          $traceurRuntime.superConstructor(NavigatorWrapper).call(this, CLASSES.navigator);
        }
        return ($traceurRuntime.createClass)(NavigatorWrapper, {
          get caption() {
      ...
      ViewSwitcherWrapper = function($__super) {
        function ViewSwitcherWrapper() {
          $traceurRuntime.superConstructor(ViewSwitcherWrapper).call(this, CLASSES.viewSwitcher);
        }
        return ($traceurRuntime.createClass)(ViewSwitcherWrapper, {
          get dropDownButton() {
            var dropDown = new ClickElementWrapper(CLASSES.viewSwitcherDropDownButton);
          ...
          getButton: function(name) {
            ...
            var buttons = parent.find('.dx-button');
            var result;
      ...
      HeaderWrapper = function($__super) {
        function HeaderWrapper() {
          $traceurRuntime.superConstructor(HeaderWrapper).call(this, CLASSES.header);
        }
        return ($traceurRuntime.createClass)(HeaderWrapper, {
          get navigator() {
      ...
      SchedulerTestWrapper = function($__super) {
        function SchedulerTestWrapper(instance) {
          var $__12,
              $__13,
              $__14,
              $__15,
              ...
              $__96,
              $__97;
          $traceurRuntime.superConstructor(SchedulerTestWrapper).call(this, ("#" + SCHEDULER_ID));
          this.instance = instance;
          this.timePanel = {
            getElement: function() {
              return $('.dx-scheduler-time-panel');
            },
            getTimeValues: ($__12 = this, function() {
              var cellClassName = $__12.instance.option('currentView').indexOf('timeline') > -1 ? '.dx-scheduler-header-panel-cell' : '.dx-scheduler-time-panel-cell > div';
              return $(cellClassName).not('.dx-scheduler-header-panel-week-cell').map(function(i, el) {
                return $(el).text();
              });
            })
          }, this.tooltip = {
            getOverlayContentElement: ($__13 = this, function() {
              return $__13.isAdaptivity() ? $__13.tooltip.getContentElement().find('.dx-overlay-content') : $('.dx-scheduler-appointment-tooltip-wrapper .dx-overlay-content');
            }),
            getContentElement: ($__14 = this, function() {
              return $__14.isAdaptivity() ? $('.dx-scheduler-overlay-panel') : $('.dx-scheduler-appointment-tooltip-wrapper.dx-overlay-wrapper .dx-list');
            }),
            hasScrollbar: ($__15 = this, function() {
              return $__15.tooltip.getContentElement().find('.dx-scrollable-scrollbar').is(':visible');
            }),
            getItemElements: ($__16 = this, function() {
              return $__16.tooltip.getContentElement().find('.dx-list-item');
            }),
            getItemElement: ($__17 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $($__17.tooltip.getItemElements().get(index));
            }),
            checkItemElementHtml: ($__18 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              var template = arguments[1];
              return $__18.tooltip.getItemElement(index).html().indexOf(template) !== -1;
            }),
            getTitleElement: ($__19 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__19.tooltip.getItemElement(index).find('.dx-tooltip-appointment-item-content-subject');
            }),
            getDateElement: ($__20 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__20.tooltip.getItemElement(index).find('.dx-tooltip-appointment-item-content-date');
            }),
            getDeleteButton: ($__21 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__21.tooltip.getItemElement(index).find('.dx-tooltip-appointment-item-delete-button');
            }),
            getMarkers: ($__22 = this, function() {
              return $__22.tooltip.getItemElements().find('.dx-tooltip-appointment-item-marker-body');
            }),
            getMarker: ($__23 = this, function() {
              return $__23.tooltip.getMarkers().first();
            }),
            getDateText: ($__24 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__24.tooltip.getDateElement(index).text();
            }),
            getTitleText: ($__25 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__25.tooltip.getTitleElement(index).text();
            }),
            getItemCount: ($__26 = this, function() {
              return $__26.tooltip.getItemElements().length;
            }),
            clickOnDeleteButton: ($__27 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__27.tooltip.getDeleteButton(index).trigger('dxclick');
            }),
            clickOnItem: ($__28 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__28.tooltip.getItemElement(index).trigger('dxclick');
            }),
            hasDeleteButton: ($__29 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__29.tooltip.getDeleteButton(index).length !== 0;
            }),
            isVisible: ($__30 = this, function() {
              if ($__30.isAdaptivity()) {
                var content = $__30.tooltip.getContentElement();
                return content.length === 0 ? false : !content.hasClass('dx-state-invisible');
              }
              return $__30.tooltip.getContentElement().length > 0;
            })
          };
          this.appointments = {
            ...
            getAppointmentCount: ($__31 = this, function() {
              return $__31.appointments.getAppointments().length;
            }),
            getAppointment: ($__32 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__32.appointments.getAppointments().eq(index);
            }),
            getTitleText: ($__33 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__33.appointments.getAppointment(index).find('.dx-scheduler-appointment-title').text();
            }),
            getDateText: ($__34 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              var result = '';
              var appointment = $__34.appointments.getAppointment(index);
              appointment.find('.dx-scheduler-appointment-content-date').each(function(index, element) {
                result += element.innerHTML;
              });
              return result;
            }),
            getAppointmentWidth: ($__35 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__35.appointments.getAppointment(index).get(0).getBoundingClientRect().width;
            }),
            getAppointmentHeight: ($__36 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__36.appointments.getAppointment(index).get(0).getBoundingClientRect().height;
            }),
            getAppointmentPosition: ($__37 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return locate($($__37.appointments.getAppointment(index)));
            }),
            getDragSource: ($__38 = this, function() {
              return $__38.appointments.getAppointments().filter(CLASSES.appointmentDragSource);
            }),
            getFakeAppointment: function() {
              return $('.dx-scheduler-fixed-appointments .dx-scheduler-appointment');
            },
            getFakeAppointmentWrapper: ($__39 = this, function() {
              return $__39.appointments.getFakeAppointment().parent();
            }),
            find: ($__40 = this, function(text) {
              return $__40.appointments.getAppointments().filter(function(index, element) {
                return $(element).find('.dx-scheduler-appointment-title').text() === text;
              });
            }),
            click: ($__41 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              var isAsync = arguments[1] !== (void 0) ? arguments[1] : false;
              var click = function() {
                return $__41.appointments.getAppointment(index).trigger('dxclick');
              };
              if (isAsync) {
                click();
              } else {
            ...
            dblclick: ($__42 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              $__42.appointments.getAppointment(index).trigger('dxdblclick');
            }),
            compact: {
              getButtons: function() {
                return $('.dx-scheduler-appointment-collector');
              },
              getButtonCount: ($__43 = this, function() {
                return $__43.appointments.compact.getButtons().length;
              }),
              getLastButtonIndex: ($__44 = this, function() {
                return $__44.appointments.compact.getButtonCount() - 1;
              }),
              getButton: ($__45 = this, function() {
                var index = arguments[0] !== (void 0) ? arguments[0] : 0;
                return $($__45.appointments.compact.getButtons().get(index));
              }),
              getButtonText: ($__46 = this, function() {
                var index = arguments[0] !== (void 0) ? arguments[0] : 0;
                return $__46.appointments.compact.getButton(index).find('span').text();
              }),
              getButtonWidth: ($__47 = this, function() {
                var index = arguments[0] !== (void 0) ? arguments[0] : 0;
                return $__47.appointments.compact.getButton(index).get(0).getBoundingClientRect().width;
              }),
              getButtonHeight: ($__48 = this, function() {
                var index = arguments[0] !== (void 0) ? arguments[0] : 0;
                return $__48.appointments.compact.getButton(index).get(0).getBoundingClientRect().height;
              }),
              click: ($__49 = this, function() {
                var index = arguments[0] !== (void 0) ? arguments[0] : 0;
                return $__49.appointments.compact.getButton(index).trigger('dxclick');
              }),
              getAppointment: function() {
                var index = arguments[0] !== (void 0) ? arguments[0] : 0;
                return $('.dx-list-item').eq(index);
              }
            }
          };
          this.appointmentPopup = {
            form: {
              getSubjectTextBox: ($__50 = this, function() {
                var subjectElement = $__50.appointmentPopup.getPopup().find('.dx-textbox').eq(0);
                return subjectElement.dxTextBox('instance');
              }),
              setSubject: ($__51 = this, function(text) {
                var textBox = $__51.appointmentPopup.form.getSubjectTextBox();
                textBox.option('value', text);
              }),
              getSubject: ($__52 = this, function() {
                var textBox = $__52.appointmentPopup.form.getSubjectTextBox();
                return textBox.option('value');
              }),
              isRecurrenceEditorVisible: function() {
                return $('.dx-recurrence-editor-container').is(':visible');
              }
            },
            dialog: {
              clickEditSeries: function() {
                return $(CLASSES.dialog).find('.dx-dialog-button').eq(0).trigger('dxclick');
              },
              clickEditAppointment: function() {
                return $(CLASSES.dialog).find('.dx-dialog-button').eq(1).trigger('dxclick');
              },
              hide: function() {
                return $(CLASSES.dialog).find('.dx-closebutton.dx-button').trigger('dxclick');
              }
            },
            getPopup: function() {
              return $('.dx-overlay-wrapper.dx-scheduler-appointment-popup');
            },
            getRecurrenceDialog: function() {
              return $(("" + CLASSES.dialog + CLASSES.popup));
            },
            getPopupTitleElement: ($__53 = this, function() {
              return $__53.appointmentPopup.getPopup().find('.dx-popup-title');
            }),
            hasVerticalScroll: ($__54 = this, function() {
              var scrollableContainer = $__54.appointmentPopup.getPopup().find('.dx-scrollable-container').get(0);
              return scrollableContainer.scrollHeight > scrollableContainer.clientHeight;
            }),
            getPopupInstance: function() {
              return $('.dx-scheduler-appointment-popup.dx-widget').dxPopup('instance');
            },
            isVisible: ($__55 = this, function() {
              return $__55.appointmentPopup.getPopup().length !== 0;
            }),
            setPopupHeight: ($__56 = this, function(height) {
              return $__56.appointmentPopup.getPopupInstance().option('height', height);
            }),
            getToolbarElementByLocation: ($__57 = this, function(location) {
              var toolbarName = location === TOOLBAR_TOP_LOCATION ? 'title' : TOOLBAR_BOTTOM_LOCATION;
              return $__57.appointmentPopup.getPopup().find((".dx-toolbar.dx-widget.dx-popup-" + toolbarName));
            }),
            hasToolbarButtonsInSection: ($__58 = this, function(toolBarLocation, sectionName, buttonNames) {
              var $toolbar = $__58.appointmentPopup.getToolbarElementByLocation(toolBarLocation);
              var $buttons = $toolbar.find((".dx-toolbar-" + sectionName + " .dx-button"));
              return buttonNames.every(function(name, index) {
                return $buttons.eq(index).hasClass(("dx-popup-" + name));
              });
            }),
            getDoneButton: ($__59 = this, function() {
              return $__59.appointmentPopup.getPopup().find('.dx-button.dx-popup-done');
            }),
            clickDoneButton: ($__60 = this, function() {
              return $__60.appointmentPopup.getDoneButton().trigger('dxclick');
            }),
            getCancelButton: ($__61 = this, function() {
              return $__61.appointmentPopup.getPopup().find('.dx-popup-cancel');
            }),
            clickCancelButton: ($__62 = this, function() {
              return $__62.appointmentPopup.getCancelButton().trigger('dxclick');
            }),
            saveAppointmentData: ($__63 = this, function() {
              return $__63.instance._appointmentPopup.saveEditDataAsync.call($__63.instance._appointmentPopup);
            }),
            hasLoadPanel: ($__64 = this, function() {
              return $__64.appointmentPopup.getPopup().find('.dx-loadpanel').length !== 0;
            }),
            getInstance: ($__65 = this, function() {
              return $__65.instance._appointmentPopup;
            })
          };
          this.appointmentForm = {
            getFormInstance: ($__66 = this, function() {
              return $__66.appointmentPopup.getPopup().find('.dx-form').dxForm('instance');
            }),
            getEditor: ($__67 = this, function(name) {
              return $__67.appointmentForm.getFormInstance().getEditor(name);
            }),
            setSubject: ($__68 = this, function(value) {
              var fieldName = arguments[1] !== (void 0) ? arguments[1] : 'text';
              return $__68.appointmentForm.getEditor(fieldName).option('value', value);
            }),
            setStartDate: ($__69 = this, function(value) {
              return $__69.appointmentForm.getEditor('startDate').option('value', value);
            }),
            setEndDate: ($__70 = this, function(value) {
              return $__70.appointmentForm.getEditor('endDate').option('value', value);
            }),
            hasFormSingleColumn: function() {
              return $('.dx-responsivebox').first().hasClass('dx-responsivebox-screen-xs');
            },
            getRecurrentAppointmentFormDialogButtons: function() {
              return $('.dx-dialog-buttons .dx-button');
            },
            clickFormDialogButton: ($__71 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__71.appointmentForm.getRecurrentAppointmentFormDialogButtons().eq(index).trigger('dxclick');
            }),
            getPendingEditorsCount: ($__72 = this, function() {
              return $($__72.appointmentForm.getFormInstance().element()).find('.dx-validation-pending').length;
            }),
            getInvalidEditorsCount: ($__73 = this, function() {
              return $($__73.appointmentForm.getFormInstance().element()).find('.dx-invalid').length;
            })
          };
          this.workSpace = {
            getWorkSpace: function() {
              return $('.dx-scheduler-work-space');
            },
            getMonthCurrentDay: function() {
              return parseInt($('.dx-scheduler-date-table-current-date > div').text());
            },
            getWeekCurrentDay: function() {
              var value = $('.dx-scheduler-header-panel-current-time-cell').text();
              return parseInt(value.replace(/^\D+/g, ''));
            },
            getDateTableScrollable: function() {
              return $('.dx-scheduler-date-table-scrollable');
            },
            getHeaderScrollable: function() {
              return $('.dx-scheduler-header-scrollable');
            },
            getSideBarScrollable: function() {
              return $('.dx-scheduler-sidebar-scrollable');
            },
            getDateTable: function() {
              return $('.dx-scheduler-date-table');
            },
            getDateTableHeight: ($__74 = this, function() {
              return $__74.workSpace.getDateTable().height();
            }),
            getRowCount: function() {
              return $('.dx-scheduler-date-table-row').length;
            },
            getRows: function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $('.dx-scheduler-date-table-row').eq(index);
            },
            getCells: function() {
              return $(CLASSES.dateTableCell);
            },
            getSelectedCells: ($__75 = this, function() {
              return $__75.workSpace.getCells().filter(CLASSES.selectedCell);
            }),
            getFocusedCell: ($__76 = this, function() {
              return $__76.workSpace.getCells().filter(CLASSES.focusedCell);
            }),
            getCell: ($__77 = this, function(rowIndex, cellIndex) {
              if (cellIndex !== undefined) {
                return $('.dx-scheduler-date-table-row').eq(rowIndex).find(CLASSES.dateTableCell).eq(cellIndex);
              }
              return $__77.workSpace.getCells().eq(rowIndex);
            }),
            getCellPosition: ($__78 = this, function(rowIndex, cellIndex) {
              return $__78.workSpace.getCell(rowIndex, cellIndex).position();
            }),
            getCellWorkspaceRect: ($__79 = this, function(rowIndex, cellIndex) {
              var cell = $__79.workSpace.getCell(rowIndex, cellIndex);
              ...
              if ($__79.instance.currentView === 'month') {
                var monthNum = cell.find('div').eq(0);
            ...
            getAllDayCells: function() {
              return $('.dx-scheduler-all-day-table-cell');
            },
            getAllDayCell: ($__80 = this, function(index) {
              return $__80.workSpace.getAllDayCells().eq(index);
            }),
            getTimePanelCells: function() {
              return $(CLASSES.timePanelCell);
            },
            getVirtualCells: function() {
              return $(CLASSES.virtualCell);
            },
            getOrdinaryHeaderPanelCells: function() {
              return $((CLASSES.headerPanelCell + ":not(" + CLASSES.weekHeaderPanelCell + ")"));
            },
            getWeekDayHeaderPanelCells: function() {
              return $(("" + CLASSES.weekHeaderPanelCell));
            },
            getTimePanelCurrentTimeCells: function() {
              return $(CLASSES.currentTimeCell);
            },
            getHeaderPanelCurrentTimeCells: function() {
              return $(CLASSES.headerPanelCurrentTimeCell);
            },
            getCellWidth: ($__81 = this, function() {
              return $__81.workSpace.getCells().eq(0).outerWidth();
            }),
            getCellHeight: ($__82 = this, function() {
              return $__82.workSpace.getCells().eq(0).outerHeight();
            }),
            getAllDayCellWidth: ($__83 = this, function() {
              return $__83.workSpace.getAllDayCells().eq(0).outerWidth();
            }),
            getAllDayCellHeight: ($__84 = this, function() {
              return $__84.workSpace.getAllDayCells().eq(0).outerHeight();
            }),
            getCurrentTimeIndicator: function() {
              return $('.dx-scheduler-date-time-indicator');
            },
            getCurrentTimeIndicatorCount: ($__85 = this, function() {
              return $__85.workSpace.getCurrentTimeIndicator().length;
            }),
            getAllDayPanel: function() {
              return $('.dx-scheduler-all-day-panel');
            },
            getAllDayTitle: function() {
              return $(CLASSES.allDayTitle);
            },
            getDataTableScrollableContainer: ($__86 = this, function() {
              return $__86.workSpace.getDateTableScrollable().find('.dx-scrollable-container');
            }),
            getScrollPosition: ($__87 = this, function() {
              var element = $__87.workSpace.getDataTableScrollableContainer();
              return {
            ...
            getScrollable: function() {
              return $('.dx-scheduler-date-table-scrollable').dxScrollable('instance');
            },
            groups: {
              getGroupsContainer: function() {
                return $('.dx-scheduler-group-flex-container');
              },
              getGroup: function() {
                var index = arguments[0] !== (void 0) ? arguments[0] : 0;
                return $('.dx-scheduler-group-row').eq(index);
              },
              getGroupHeaders: ($__88 = this, function(index) {
                return $__88.workSpace.groups.getGroup(index).find('.dx-scheduler-group-header');
              }),
              getGroupHeader: ($__89 = this, function(index) {
                var groupRow = arguments[1] !== (void 0) ? arguments[1] : 0;
                return $__89.workSpace.groups.getGroupHeaders(groupRow).eq(index);
              }),
              getVerticalGroupPanel: function() {
                return $(CLASSES.verticalGroupPanel);
              }
            },
            clickCell: ($__90 = this, function(rowIndex, cellIndex) {
              return $__90.workSpace.getCell(rowIndex, cellIndex).trigger('dxclick');
            }),
            selectCells: ($__91 = this, function(firstCellIndex, lastCellIndex) {
              var firstCell = $__91.workSpace.getCell(firstCellIndex);
              var secondCell = $__91.workSpace.getCell(lastCellIndex);
              var $__98 = firstCell.offset(),
                  firstCellLeft = $__98.x,
                  firstCellTop = $__98.y;
              var $__99 = secondCell.offset(),
                  secondCellLeft = $__99.x,
                  secondCellTop = $__99.y;
              pointerMock(firstCell).start().down(firstCellLeft, firstCellTop);
              pointerMock(secondCell).move(secondCellLeft - firstCellLeft, secondCellTop - firstCellTop).up();
            }),
            getShader: function() {
              return $(CLASSES.shader);
            }
          };
          this.viewSwitcher = {getLabel: function() {
              return $('.dx-scheduler-view-switcher-label');
            }}, this.grouping = {
            getGroupHeaders: function() {
              return $('.dx-scheduler-group-header');
            },
            getGroupHeader: ($__92 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__92.grouping.getGroupHeaders().eq(index);
            }),
            getGroupHeaderHeight: ($__93 = this, function() {
              return $__93.grouping.getGroupHeader(0).outerHeight();
            }),
            getGroupHeaderContents: function() {
              return $('.dx-scheduler-group-header-content');
            },
            getGroupHeaderContentCount: ($__94 = this, function() {
              return $__94.grouping.getGroupHeaderContents().length;
            }),
            getGroupHeaderContent: ($__95 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__95.grouping.getGroupHeaderContents().eq(index);
            }),
            getGroupHeaderContentHeight: ($__96 = this, function() {
              var index = arguments[0] !== (void 0) ? arguments[0] : 0;
              return $__96.grouping.getGroupHeaderContent(index).outerHeight();
            }),
            getGroupTable: function() {
              return $('.dx-scheduler-group-table');
            },
            getGroupTableHeight: ($__97 = this, function() {
              return $__97.grouping.getGroupTable().height();
            })
          };
        }
        return ($traceurRuntime.createClass)(SchedulerTestWrapper, {
          get header() {
            return new HeaderWrapper();
          },
          get appointmentList() {
            var result = [];
            var length = this.getElement().find(CLASSES.appointment).length;
            for (var i = 0; i < length; i++) {
      ...
      $__export("SchedulerTestWrapper", SchedulerTestWrapper);
    }
  };
});
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","animation/translator","core/devices","../../helpers/pointerMock.js","core/element_data","color","generic_light.css!","ui/scheduler/ui.scheduler","ui/drop_down_button"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("animation/translator"), require("core/devices"), require("../../helpers/pointerMock.js"), require("core/element_data"), require("color"), require("generic_light.css!"), require("ui/scheduler/ui.scheduler"), require("ui/drop_down_button"));
  else
