...
(["testing/helpers/wrappers/dataGridWrappers.js"], ["./wrapperBase.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/wrappers/dataGridWrappers.js", ["./wrapperBase.js"], function($__export) {
  "use strict";
  var WrapperBase,
      ElementWrapper,
      FOCUS_OVERLAY_POSTFIX_CLASS,
      COMMAND_ADAPTIVE_CLASS,
      COMMAND_ADAPTIVE_HIDDEN_CLASS,
      FILTER_BUILDER_CLASS,
      FILTER_BUILDER_GROUP_CLASS,
      FILTER_BUILDER_ITEM_VALUE_TEXT_CLASS,
      FILTER_BUILDER_TEXT_PART_CLASS,
      ...
      FIXED_CONTENT_CLASS,
      HEADER_COLUMN_INDICATORS_CLASS,
      GRID_TABLE_CLASS,
      FREE_SPACE_ROW_CLASS,
      VIRTUAL_ROW_CLASS,
      COMMAND_EDIT_CLASS,
      COMMAND_BUTTON_CLASS,
  ...
  return {
    setters: [function($__m) {
      WrapperBase = $__m.WrapperBase;
      ElementWrapper = $__m.ElementWrapper;
    }],
    execute: function() {
      FOCUS_OVERLAY_POSTFIX_CLASS = 'focus-overlay';
      COMMAND_ADAPTIVE_CLASS = 'dx-command-adaptive';
      ...
      FILTER_BUILDER_TEXT_PART_CLASS = 'dx-filterbuilder-text-part';
      HEADER_FILTER_MENU_CLASS = 'dx-header-filter-menu';
      LIST_ITEM_CLASS = 'dx-list-item';
      BUTTON_CLASS = 'dx-button';
      FOCUSED_ROW_CLASS = 'dx-row-focused';
      SELECTED_ROW_CLASS = 'dx-selection';
      DATA_GRID_PREFIX = 'dx-datagrid';
      ROW_CLASS = 'dx-row';
      DATA_ROW_CLASS = 'dx-data-row';
      TREELIST_PREFIX = 'dx-treelist';
      TEXTEDITOR_CLASS = 'dx-texteditor';
      TEXTEDITOR_INPUT_CLASS = 'dx-texteditor-input';
      FIXED_CONTENT_CLASS = 'dx-datagrid-content-fixed';
      HEADER_COLUMN_INDICATORS_CLASS = 'dx-column-indicators';
      GRID_TABLE_CLASS = 'dx-datagrid-table';
      FREE_SPACE_ROW_CLASS = 'dx-freespace-row';
      VIRTUAL_ROW_CLASS = 'dx-virtual-row';
      COMMAND_EDIT_CLASS = 'dx-command-edit';
      COMMAND_BUTTON_CLASS = 'dx-link';
      SELECT_CHECKBOX_CLASS = 'dx-select-checkbox';
      FOCUSED_CLASS = 'dx-focused';
      EDITOR_CELL_CLASS = 'dx-editor-cell';
      HIDDEN_CLASS = 'dx-hidden';
      INSERTED_ROW_CLASS = 'dx-row-inserted';
      GridWrapper = function($__super) {
        function GridWrapper(containerSelector, widgetPrefix) {
          $traceurRuntime.superConstructor(GridWrapper).call(this, containerSelector);
        ...
        return ($traceurRuntime.createClass)(GridWrapper, {
          getElement: function() {
            return this.getContainer();
          },
          isEditorCell: function($cell) {
            return $cell.hasClass('dx-editor-cell');
          }
        }, {}, $__super);
      }(WrapperBase);
      $__export('default', function($__super) {
        function DataGridWrapper(containerSelector) {
          $traceurRuntime.superConstructor(DataGridWrapper).call(this, containerSelector, DATA_GRID_PREFIX);
        }
        return ($traceurRuntime.createClass)(DataGridWrapper, {}, {}, $__super);
      }(GridWrapper));
      TreeListWrapper = function($__super) {
        function TreeListWrapper(containerSelector) {
          $traceurRuntime.superConstructor(TreeListWrapper).call(this, containerSelector, TREELIST_PREFIX);
        }
        return ($traceurRuntime.createClass)(TreeListWrapper, {}, {}, $__super);
      }(GridWrapper);
      $__export("TreeListWrapper", TreeListWrapper);
      GridElement = function($__super) {
        function GridElement(containerSelector) {
          var widgetPrefix = arguments[1] !== (void 0) ? arguments[1] : 'dx-datagrid';
          $traceurRuntime.superConstructor(GridElement).call(this, containerSelector);
          this.widgetPrefix = widgetPrefix;
        }
        return ($traceurRuntime.createClass)(GridElement, {}, {}, $__super);
      }(WrapperBase);
      GridTableElement = function($__super) {
        function GridTableElement() {
          $traceurRuntime.superConstructor(GridTableElement).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(GridTableElement, {getTable: function() {
            return this.getElement().find(("." + GRID_TABLE_CLASS));
          }}, {}, $__super);
      }(GridElement);
      ColumnWrapper = function($__super) {
        function ColumnWrapper() {
          $traceurRuntime.superConstructor(ColumnWrapper).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(ColumnWrapper, {getCommandButtons: function() {
            return this.getContainer().find('td[class*=\'dx-command\'] .dx-link');
          }}, {}, $__super);
      }(GridElement);
      $__export("ColumnWrapper", ColumnWrapper);
      Editor = function($__super) {
        function Editor(containerWrapper) {
          $traceurRuntime.superConstructor(Editor).call(this, containerWrapper, ("." + TEXTEDITOR_CLASS));
        }
        return ($traceurRuntime.createClass)(Editor, {getInputElement: function() {
            return this.getElement().find(("." + TEXTEDITOR_INPUT_CLASS));
          }}, {}, $__super);
      }(ElementWrapper);
      $__export("Editor", Editor);
      Cell = function($__super) {
        function Cell(row, index) {
          $traceurRuntime.superConstructor(Cell).call(this, row.getElement());
          this.index = index;
        }
        return ($traceurRuntime.createClass)(Cell, {
          getElement: function() {
          ...
          hasFocusedClass: function() {
            return this.getElement().hasClass(FOCUSED_CLASS);
          },
          isEditorCell: function() {
            return this.getElement().hasClass(EDITOR_CELL_CLASS);
          }
        }, {}, $__super);
      }(WrapperBase);
      $__export("Cell", Cell);
      Row = function($__super) {
        function Row(rowsView) {
          var index = arguments[1] !== (void 0) ? arguments[1] : -1;
          $traceurRuntime.superConstructor(Row).call(this, rowsView.getElement());
          this.index = index;
          this.elementClass = ROW_CLASS;
        }
        return ($traceurRuntime.createClass)(Row, {
          getElement: function() {
            var rows = this.getContainer().find((":not(." + FIXED_CONTENT_CLASS + ") ." + this.elementClass));
      ...
      $__export("Row", Row);
      CommandAdaptive = function($__super) {
        function CommandAdaptive(containerWrapper) {
          $traceurRuntime.superConstructor(CommandAdaptive).call(this, containerWrapper, ("." + COMMAND_ADAPTIVE_CLASS));
        }
        return ($traceurRuntime.createClass)(CommandAdaptive, {isVisible: function() {
            return !this.getElement().hasClass(COMMAND_ADAPTIVE_HIDDEN_CLASS);
          }}, {}, $__super);
      }(ElementWrapper);
      $__export("CommandAdaptive", CommandAdaptive);
      CommandCell = function($__super) {
        function CommandCell(containerWrapper, columnIndex) {
          $traceurRuntime.superConstructor(CommandCell).call(this, containerWrapper, ("." + COMMAND_EDIT_CLASS + ":nth-child(" + (columnIndex + 1) + ")"));
        }
        return ($traceurRuntime.createClass)(CommandCell, {getButton: function(index) {
            return new ElementWrapper(this, ("." + COMMAND_BUTTON_CLASS + ":nth-child(" + index + ")"));
          }}, {}, $__super);
      }(ElementWrapper);
      $__export("CommandCell", CommandCell);
      DataRow = function($__super) {
        function DataRow(container, index) {
          $traceurRuntime.superConstructor(DataRow).call(this, container, index);
          this.elementClass = DATA_ROW_CLASS;
        }
        return ($traceurRuntime.createClass)(DataRow, {
          getSelectCheckBox: function() {
            var columnIndex = arguments[0] !== (void 0) ? arguments[0] : -1;
            var selector = ("." + SELECT_CHECKBOX_CLASS);
            if (columnIndex >= 0) {
          ...
          isFocusedRow: function() {
            return this.getElement().hasClass(FOCUSED_ROW_CLASS);
          },
          isNewRow: function() {
            return this.getElement().hasClass(INSERTED_ROW_CLASS);
          },
          getCommandAdaptive: function() {
            return new CommandAdaptive(this);
          },
          getCommandCell: function(columnIndex) {
            return new CommandCell(this, columnIndex);
          }
        }, {}, $__super);
      }(Row);
      $__export("DataRow", DataRow);
      FixedDataRow = function($__super) {
        function FixedDataRow() {
          $traceurRuntime.superConstructor(FixedDataRow).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(FixedDataRow, {getElement: function() {
            return this.getContainer().find(("." + FIXED_CONTENT_CLASS + " ." + this.elementClass)).eq(this.index);
          }}, {}, $__super);
      }(DataRow);
      $__export("FixedDataRow", FixedDataRow);
      FreeSpaceRow = function($__super) {
        function FreeSpaceRow(container) {
          $traceurRuntime.superConstructor(FreeSpaceRow).call(this, container, -1);
          this.elementClass = FREE_SPACE_ROW_CLASS;
        }
        return ($traceurRuntime.createClass)(FreeSpaceRow, {}, {}, $__super);
      }(Row);
      $__export("FreeSpaceRow", FreeSpaceRow);
      VirtualRow = function($__super) {
        function VirtualRow(container) {
          $traceurRuntime.superConstructor(VirtualRow).call(this, container, -1);
          this.elementClass = VIRTUAL_ROW_CLASS;
        }
        return ($traceurRuntime.createClass)(VirtualRow, {}, {}, $__super);
      }(Row);
      $__export("VirtualRow", VirtualRow);
      FocusOverlay = function($__super) {
        function FocusOverlay(containerWrapper) {
          var focusOverlaySelector = ("." + containerWrapper.widgetPrefix + "-" + FOCUS_OVERLAY_POSTFIX_CLASS);
          $traceurRuntime.superConstructor(FocusOverlay).call(this, containerWrapper, focusOverlaySelector);
        }
        return ($traceurRuntime.createClass)(FocusOverlay, {isVisible: function() {
            var $focusOverlay = this.getElement();
            return $focusOverlay.length > 0 && !$focusOverlay.hasClass(HIDDEN_CLASS);
          }}, {}, $__super);
      }(ElementWrapper);
      $__export("FocusOverlay", FocusOverlay);
      RowsViewWrapper = function($__super) {
        function RowsViewWrapper(container, widgetPrefix) {
          $traceurRuntime.superConstructor(RowsViewWrapper).call(this, container);
          this.widgetPrefix = widgetPrefix;
        }
        return ($traceurRuntime.createClass)(RowsViewWrapper, {
          getElement: function() {
          ...
          getFreeSpaceRow: function() {
            return new FreeSpaceRow(this);
          },
          getFixedDataRow: function(rowIndex) {
            return new FixedDataRow(this, rowIndex);
          },
          getFocusOverlay: function() {
          ...
          isRowVisible: function(rowIndex, precision) {
            var $row = this.getRow(rowIndex).getElement();
            return this._isInnerElementVisible($row, precision);
          },
          isElementIntersectViewport: function($element) {
            var rowsViewRect = this.getElement()[0].getBoundingClientRect();
            var elementRect = $element[0].getBoundingClientRect();
            var result = (elementRect.top > rowsViewRect.top && elementRect.top < rowsViewRect.bottom) || (elementRect.bottom > rowsViewRect.top && elementRect.bottom < rowsViewRect.bottom) || (elementRect.top <= rowsViewRect.top && elementRect.bottom >= rowsViewRect.bottom);
            return result;
          },
          _isInnerElementVisible: function($element) {
            var precision = arguments[1] !== (void 0) ? arguments[1] : 0;
            var rowsViewRect = this.getContainer()[0].getBoundingClientRect();
            var elementRect = $element[0].getBoundingClientRect();
            var diffTop = Math.floor(elementRect.top - rowsViewRect.top) + precision;
            var diffBottom = Math.floor(rowsViewRect.bottom - elementRect.bottom) + precision;
            return diffTop >= 0 && diffBottom >= 0;
          }
        }, {}, $__super);
      }(GridTableElement);
      $__export("RowsViewWrapper", RowsViewWrapper);
      PagerWrapper = function($__super) {
        function PagerWrapper(containerSelector, widgetPrefix) {
          $traceurRuntime.superConstructor(PagerWrapper).call(this, containerSelector, widgetPrefix);
          this.PAGE_SIZES_SELECTOR = ("." + this.widgetPrefix + "-pager .dx-page-sizes");
          this.PAGES_SELECTOR = ("." + this.widgetPrefix + "-pager .dx-pages");
        }
        return ($traceurRuntime.createClass)(PagerWrapper, {
          getElement: function() {
            return this.getContainer().find(("." + this.widgetPrefix + "-pager"));
          },
          getPagerPageSizeElements: function() {
            return this.getContainer().find((this.PAGE_SIZES_SELECTOR + " > .dx-page-size"));
          },
          getPagerPageSizeElement: function(index) {
            return this.getPagerPageSizeElements().eq(index);
          },
          getPagerPageChooserElement: function() {
            return this.getContainer().find(("" + this.PAGES_SELECTOR));
          },
          getPagerPagesElements: function() {
            return this.getPagerPageChooserElement().find('.dx-page');
          },
          getPagerPageElement: function(index) {
            return this.getPagerPagesElements().eq(index);
          },
          getPagerButtonsElements: function() {
            return this.getPagerPageChooserElement().find('.dx-navigate-button');
          },
          getNextButtonsElement: function() {
            return this.getPagerPageChooserElement().find('.dx-next-button');
          },
          getPrevButtonsElement: function() {
            return this.getPagerPageChooserElement().find('.dx-prev-button');
          },
          isFocusedState: function() {
            return this.getElement().hasClass('dx-state-focused');
          }
        }, {}, $__super);
      }(GridElement);
      $__export("PagerWrapper", PagerWrapper);
      FilterPanelWrapper = function($__super) {
        function FilterPanelWrapper() {
          $traceurRuntime.superConstructor(FilterPanelWrapper).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(FilterPanelWrapper, {
          getElement: function() {
      ...
      $__export("FilterPanelWrapper", FilterPanelWrapper);
      FilterRowWrapper = function($__super) {
        function FilterRowWrapper() {
          $traceurRuntime.superConstructor(FilterRowWrapper).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(FilterRowWrapper, {
          getElement: function() {
            return this.getContainer().find(("." + this.widgetPrefix + "-filter-row")).eq(0);
          },
          getTextEditor: function(index) {
            return this.getElement().find('.dx-texteditor').eq(index);
          },
          getTextEditorInput: function(index) {
            return this.getElement().find(("." + TEXTEDITOR_INPUT_CLASS)).eq(index);
          },
          getEditorCell: function(index) {
            return this.getElement().find('.dx-editor-cell').eq(index);
          },
          getMenuElement: function(index) {
            return this.getEditorCell(index).find('.dx-menu');
          }
        }, {}, $__super);
      }(GridElement);
      $__export("FilterRowWrapper", FilterRowWrapper);
      HeaderPanelWrapper = function($__super) {
        function HeaderPanelWrapper() {
          $traceurRuntime.superConstructor(HeaderPanelWrapper).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(HeaderPanelWrapper, {
          getElement: function() {
            return this.getContainer().find(("." + this.widgetPrefix + "-header-panel"));
          },
          getGroupPanelElement: function() {
            return this.getElement().find(("." + this.widgetPrefix + "-group-panel"));
          },
          getGroupPanelItem: function(index) {
            return this.getGroupPanelElement().find('.dx-group-panel-item').eq(index);
          },
          getGroupPanelItems: function() {
            return this.getGroupPanelElement().find('.dx-group-panel-item');
          }
        }, {}, $__super);
      }(GridElement);
      $__export("HeaderPanelWrapper", HeaderPanelWrapper);
      HeadersWrapper = function($__super) {
        function HeadersWrapper() {
          $traceurRuntime.superConstructor(HeadersWrapper).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(HeadersWrapper, {
          getElement: function() {
            return this.getContainer().find(("." + this.widgetPrefix + "-headers"));
          },
          getHeaderItem: function(rowIndex, columnIndex) {
            return this.getElement().find('.dx-header-row').eq(rowIndex).find('td').eq(columnIndex);
          },
          getHeaderItemTextContent: function(rowIndex, columnIndex) {
            return this.getHeaderItem(rowIndex, columnIndex).find(("." + this.widgetPrefix + "-text-content")).eq(0).text();
          },
          getHeaderFilterItem: function(rowIndex, columnIndex) {
            return this.getHeaderItem(rowIndex, columnIndex).find('.dx-header-filter');
          },
          getColumnsIndicators: function() {
            return this.getElement().find(("." + HEADER_COLUMN_INDICATORS_CLASS));
          },
          isColumnHidden: function(index) {
            var $colsHeadersView = this.getContainer().find('.dx-datagrid-headers col');
            var $colsRowsView = this.getContainer().find('.dx-datagrid-headers col');
            var headersColWidth = $colsHeadersView.get(index).style.width;
            var rowsViewWidth = $colsRowsView.get(index).style.width;
            return (headersColWidth === '0.0001px' || headersColWidth === '0px') && (rowsViewWidth === '0.0001px' || rowsViewWidth === '0px');
          }
        }, {}, $__super);
      }(GridTableElement);
      $__export("HeadersWrapper", HeadersWrapper);
      FilterBuilderWrapper = function($__super) {
        function FilterBuilderWrapper(containerSelector) {
          $traceurRuntime.superConstructor(FilterBuilderWrapper).call(this, containerSelector);
          this.headerFilterMenu = new HeaderFilterMenu(containerSelector);
        }
        return ($traceurRuntime.createClass)(FilterBuilderWrapper, {
          getElement: function() {
            return this.getContainer().find(("." + FILTER_BUILDER_CLASS + ".dx-widget"));
          },
          getItemValueTextElement: function() {
          ...
          getItemValueTextParts: function() {
            var index = arguments[0] !== (void 0) ? arguments[0] : 0;
            return this.getItemValueTextElement(index).find(("." + FILTER_BUILDER_TEXT_PART_CLASS));
          }
        }, {}, $__super);
      }(GridElement);
      $__export("FilterBuilderWrapper", FilterBuilderWrapper);
      HeaderFilterMenu = function($__super) {
        function HeaderFilterMenu() {
          $traceurRuntime.superConstructor(HeaderFilterMenu).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(HeaderFilterMenu, {
          getElement: function() {
            return this.getContainer().find(("." + HEADER_FILTER_MENU_CLASS));
          },
          getDropDownListItem: function(index) {
      ...
      $__export("HeaderFilterMenu", HeaderFilterMenu);
    }
  };
});
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["./wrapperBase.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("./wrapperBase.js"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=dataGridWrappers.js.map