...
(["testing/helpers/wrappers/searchBoxWrappers.js"], ["./wrapperBase.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/wrappers/searchBoxWrappers.js", ["./wrapperBase.js"], function($__export) {
  "use strict";
  var WrapperBase,
  ...
  return {
    ...
    execute: function() {
      ...
      SearchBoxWrapper = function($__super) {
        function SearchBoxWrapper(containerSelector, widgetName) {
          $traceurRuntime.superConstructor(SearchBoxWrapper).call(this, containerSelector);
          this.widgetName = widgetName.toLowerCase();
        }
        return ($traceurRuntime.createClass)(SearchBoxWrapper, {
          getElement: function() {
      ...
      $__export("SearchBoxWrapper", SearchBoxWrapper);
      TreeViewSearchBoxWrapper = function($__super) {
        function TreeViewSearchBoxWrapper(containerSelector) {
          $traceurRuntime.superConstructor(TreeViewSearchBoxWrapper).call(this, containerSelector, 'treeview');
        }
        return ($traceurRuntime.createClass)(TreeViewSearchBoxWrapper, {}, {}, $__super);
      }(SearchBoxWrapper);
      $__export("TreeViewSearchBoxWrapper", TreeViewSearchBoxWrapper);
      ListSearchBoxWrapper = function($__super) {
        function ListSearchBoxWrapper(containerSelector) {
          $traceurRuntime.superConstructor(ListSearchBoxWrapper).call(this, containerSelector, 'list');
        }
        return ($traceurRuntime.createClass)(ListSearchBoxWrapper, {}, {}, $__super);
      }(SearchBoxWrapper);
      $__export("ListSearchBoxWrapper", ListSearchBoxWrapper);
    }
  };
});
...
//# sourceMappingURL=searchBoxWrappers.js.map