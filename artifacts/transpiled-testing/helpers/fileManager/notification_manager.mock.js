...
(["testing/helpers/fileManager/notification_manager.mock.js"], ["ui/file_manager/ui.file_manager.notification_manager"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/fileManager/notification_manager.mock.js", ["ui/file_manager/ui.file_manager.notification_manager"], function($__export) {
  "use strict";
  var NotificationManager;
  return {
    setters: [function($__m) {
      NotificationManager = $__m.NotificationManager;
    }],
    execute: function() {
      $__export('default', function($__super) {
        function FileManagerNotificationManagerMock(options) {
          $traceurRuntime.superConstructor(FileManagerNotificationManagerMock).call(this, options);
        ...
        return ($traceurRuntime.createClass)(FileManagerNotificationManagerMock, {
          createErrorDetailsProgressBox: function($container, item, errorText) {
            var itemInfo = {
            ...
            $traceurRuntime.superGet(this, FileManagerNotificationManagerMock.prototype, "createErrorDetailsProgressBox").call(this, $container, item, errorText);
          },
          renderError: function($container, errorText) {
            this._logEvent('renderError', {errorText: errorText});
            $traceurRuntime.superGet(this, FileManagerNotificationManagerMock.prototype, "renderError").call(this, $container, errorText);
          },
          ...
          _getProgressPanelComponent: function() {
            return this._progressPanelComponent || $traceurRuntime.superGet(this, FileManagerNotificationManagerMock.prototype, "_getProgressPanelComponent").call(this);
          }
        }, {}, $__super);
      }(NotificationManager));
    }
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["ui/file_manager/ui.file_manager.notification_manager"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("ui/file_manager/ui.file_manager.notification_manager"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=notification_manager.mock.js.map