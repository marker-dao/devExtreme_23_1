...
(["testing/helpers/fileManager/notification.progress_panel.mock.js"], ["core/utils/extend","ui/file_manager/ui.file_manager.notification.progress_panel"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/fileManager/notification.progress_panel.mock.js", ["core/utils/extend", "ui/file_manager/ui.file_manager.notification.progress_panel"], function($__export) {
  "use strict";
  var extend,
      FileManagerProgressPanel;
  return {
    setters: [function($__m) {
      extend = $__m.extend;
    }, function($__m) {
      FileManagerProgressPanel = $__m.default;
    }],
    execute: function() {
      $__export('default', function($__super) {
        function FileManagerProgressPanelMock() {
          $traceurRuntime.superConstructor(FileManagerProgressPanelMock).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(FileManagerProgressPanelMock, {
          _initMarkup: function() {
            $traceurRuntime.superGet(this, FileManagerProgressPanelMock.prototype, "_initMarkup").call(this);
            this._lastId = 0;
            this._infoStore = [];
          },
          _logEvent: function(type, args) {
          ...
          addOperation: function(commonText, showCloseButtonAlways, allowProgressAutoUpdate) {
            var operationId = ++this._lastId;
            this._logEvent('addOperation', {
              operationId: operationId,
              commonText: commonText,
              allowCancel: showCloseButtonAlways,
              allowProgressAutoUpdate: allowProgressAutoUpdate
            });
            var info = $traceurRuntime.superGet(this, FileManagerProgressPanelMock.prototype, "addOperation").call(this, commonText, showCloseButtonAlways, allowProgressAutoUpdate);
            info.testOperationId = operationId;
            this._infoStore.push(info);
            return info;
          },
          addOperationDetails: function(info, details, showCloseButton) {
            var detailsItems = details.map(function(item) {
              return {
            ...
            $traceurRuntime.superGet(this, FileManagerProgressPanelMock.prototype, "addOperationDetails").call(this, info, details, showCloseButton);
          },
          completeOperationItem: function(info, itemIndex, commonProgress) {
            this._logEvent('completeOperationItem', {
              operationId: info.testOperationId,
              itemIndex: itemIndex,
              commonProgress: commonProgress
            });
            $traceurRuntime.superGet(this, FileManagerProgressPanelMock.prototype, "completeOperationItem").call(this, info, itemIndex, commonProgress);
          },
          updateOperationItemProgress: function(info, itemIndex, itemProgress, commonProgress) {
            ...
            $traceurRuntime.superGet(this, FileManagerProgressPanelMock.prototype, "updateOperationItemProgress").call(this, info, itemIndex, itemProgress, commonProgress);
          },
          completeOperation: function(info, commonText, isError, statusText) {
            ...
            $traceurRuntime.superGet(this, FileManagerProgressPanelMock.prototype, "completeOperation").call(this, info, commonText, isError, statusText);
          },
          completeSingleOperationWithError: function(info, errorText) {
            this._logEvent('completeSingleOperationWithError', {
              operationId: info.testOperationId,
              errorText: errorText
            });
            $traceurRuntime.superGet(this, FileManagerProgressPanelMock.prototype, "completeSingleOperationWithError").call(this, info, errorText);
          },
          addOperationDetailsError: function(info, index, errorText) {
            this._logEvent('addOperationDetailsError', {
              operationId: info.testOperationId,
              index: index,
              errorText: errorText
            });
            $traceurRuntime.superGet(this, FileManagerProgressPanelMock.prototype, "addOperationDetailsError").call(this, info, index, errorText);
          },
          _renderError: function($container, $target, errorText) {
            this._logEvent('_renderError', {errorText: errorText});
            $traceurRuntime.superGet(this, FileManagerProgressPanelMock.prototype, "_renderError").call(this, $container, $target, errorText);
          },
          getStoredInfos: function() {
            return this._infoStore;
          },
          _getDefaultOptions: function() {
            return extend($traceurRuntime.superGet(this, FileManagerProgressPanelMock.prototype, "_getDefaultOptions").call(this), {logger: null});
          },
          _optionChanged: function(args) {
            ...
            switch (name) {
              case 'logger':
                break;
              default:
                $traceurRuntime.superGet(this, FileManagerProgressPanelMock.prototype, "_optionChanged").call(this, args);
            }
          }
        }, {}, $__super);
      }(FileManagerProgressPanel));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/extend","ui/file_manager/ui.file_manager.notification.progress_panel"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/extend"), require("ui/file_manager/ui.file_manager.notification.progress_panel"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=notification.progress_panel.mock.js.map