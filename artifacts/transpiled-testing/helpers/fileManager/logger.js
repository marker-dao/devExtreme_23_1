...
(["testing/helpers/fileManager/logger.js"], ["core/utils/extend","core/utils/type"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/fileManager/logger.js", ["core/utils/extend", "core/utils/type"], function($__export) {
  "use strict";
  var extend,
      isNumeric;
  return {
    ...
    execute: function() {
      $__export('default', function() {
        function FileManagerLogger() {
          this._logEntries = [];
        }
        return ($traceurRuntime.createClass)(FileManagerLogger, {
          addEntry: function(type, info) {
            var preparedInfo = this._getPreparedObject(info);
            var entry = extend(preparedInfo, {type: type});
          ...
          _getPreparedObject: function(srcObject) {
            var result = {};
            for (var key in srcObject) {
              if (!Object.prototype.hasOwnProperty.call(srcObject, key)) {
                continue;
              }
              var value = srcObject[key];
              if (value === undefined) {
                continue;
              }
              if (isNumeric(value)) {
