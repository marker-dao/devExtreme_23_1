...
(["testing/helpers/fileManager/editing.mock.js"], ["core/utils/extend","ui/file_manager/ui.file_manager.editing"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/fileManager/editing.mock.js", ["core/utils/extend", "ui/file_manager/ui.file_manager.editing"], function($__export) {
  "use strict";
  var extend,
      FileManagerEditingControl;
  return {
    setters: [function($__m) {
      extend = $__m.extend;
    }, function($__m) {
      FileManagerEditingControl = $__m.default;
    }],
    execute: function() {
      $__export('default', function($__super) {
        function FileManagerEditingControlMock() {
          $traceurRuntime.superConstructor(FileManagerEditingControlMock).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(FileManagerEditingControlMock, {
          _showDialog: function(dialog, dialogArgument) {
            var dialogMock = this._createDialogMock(dialog);
            return $traceurRuntime.superGet(this, FileManagerEditingControlMock.prototype, "_showDialog").call(this, dialogMock, dialogArgument);
          },
          _createDialogMock: function(sourceDialog) {
            var $__4 = this;
            return {show: function(dialogArgument) {
                setTimeout(function() {
                  var dialogResultGetter = $__4.option('getDialogResult');
                  var dialogResult = dialogResultGetter ? dialogResultGetter(sourceDialog, dialogArgument) : {};
                  $__4._onDialogClosed({dialogResult: dialogResult});
                });
              }};
          },
          _getFileUploaderComponent: function() {
            var component = this.option('fileUploaderComponent');
            return component ? component : $traceurRuntime.superGet(this, FileManagerEditingControlMock.prototype, "_getFileUploaderComponent").call(this);
          },
          _getDefaultOptions: function() {
            return extend($traceurRuntime.superGet(this, FileManagerEditingControlMock.prototype, "_getDefaultOptions").call(this), {
          ...
          _optionChanged: function(args) {
            ...
            switch (name) {
              ...
              case 'logger':
                break;
              default:
                $traceurRuntime.superGet(this, FileManagerEditingControlMock.prototype, "_optionChanged").call(this, args);
            }
          }
        }, {}, $__super);
      }(FileManagerEditingControl));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/extend","ui/file_manager/ui.file_manager.editing"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/extend"), require("ui/file_manager/ui.file_manager.editing"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=editing.mock.js.map