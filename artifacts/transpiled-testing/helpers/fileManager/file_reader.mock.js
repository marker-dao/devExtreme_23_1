...
(["testing/helpers/fileManager/file_reader.mock.js"], ["core/utils/window"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/fileManager/file_reader.mock.js", ["core/utils/window"], function($__export) {
  "use strict";
  var getWindow,
      READ_DELAY;
  return {
    ...
    execute: function() {
      ...
      $__export('default', function() {
        ...
        return ($traceurRuntime.createClass)(FileReaderMock, {readAsDataURL: function(blob) {
            var $__2 = this;
            var window = getWindow();
            this._content = blob._dxContent;
            var base64String = window.btoa(this._content);
...
//# sourceMappingURL=file_reader.mock.js.map