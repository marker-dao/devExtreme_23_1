...
(["testing/helpers/fileManager/notification.mock.js"], ["jquery","core/utils/extend","core/utils/type","ui/file_manager/ui.file_manager.notification"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/fileManager/notification.mock.js", ["jquery", "core/utils/extend", "core/utils/type", "ui/file_manager/ui.file_manager.notification"], function($__export) {
  "use strict";
  var $,
      extend,
      isString,
  ...
  return {
    setters: [function($__m) {
      ...
      FileManagerNotificationControl = $__m.default;
    }],
    execute: function() {
      $__export('default', function($__super) {
        function FileManagerNotificationControlMock() {
          $traceurRuntime.superConstructor(FileManagerNotificationControlMock).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(FileManagerNotificationControlMock, {
          _showPopup: function(content, errorMode) {
            var info = {errorMode: errorMode};
            if (isString(content)) {
              info.commonText = content;
            } else {
              var contentInfo = this._getLogInfo($(content));
              info = extend(info, contentInfo);
            }
            this._logEvent('_showPopup', info);
          },
          _getLogInfo: function($content) {
            var commonText = $content.find('.dx-filemanager-notification-common').text();
            var detailsText = $content.find('.dx-filemanager-notification-details').text();
            return {
              commonText: commonText,
              detailsText: detailsText
            };
          },
          _logEvent: function(type, info) {
          ...
          _setNotificationManager: function() {
            var options = {
              progressPanelComponent: this.option('progressPanelComponent'),
              logger: this.option('logger')
            };
            $traceurRuntime.superGet(this, FileManagerNotificationControlMock.prototype, "_setNotificationManager").call(this, options);
          },
          _getProgressManagerComponent: function() {
            var component = this.option('progressManagerComponent');
            return component ? component : $traceurRuntime.superGet(this, FileManagerNotificationControlMock.prototype, "_getProgressPanelComponent").call(this);
          },
          _getDefaultOptions: function() {
            return extend($traceurRuntime.superGet(this, FileManagerNotificationControlMock.prototype, "_getDefaultOptions").call(this), {
          ...
          _isProgressDrawerOpened: function() {
          ...
          _optionChanged: function(args) {
            ...
            switch (name) {
              ...
              case 'progressPanelOpened':
                break;
              default:
                $traceurRuntime.superGet(this, FileManagerNotificationControlMock.prototype, "_optionChanged").call(this, args);
            }
          }
        }, {}, $__super);
      }(FileManagerNotificationControl));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/extend","core/utils/type","ui/file_manager/ui.file_manager.notification"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/extend"), require("core/utils/type"), require("ui/file_manager/ui.file_manager.notification"));
  else
