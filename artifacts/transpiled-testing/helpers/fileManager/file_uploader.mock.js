...
(["testing/helpers/fileManager/file_uploader.mock.js"], ["core/utils/extend","ui/file_manager/ui.file_manager.file_uploader"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/fileManager/file_uploader.mock.js", ["core/utils/extend", "ui/file_manager/ui.file_manager.file_uploader"], function($__export) {
  "use strict";
  var extend,
  ...
  return {
    setters: [function($__m) {
      ...
      FileManagerFileUploader = $__m.default;
    }],
    execute: function() {
      $__export('default', function($__super) {
        function FileManagerTestFileUploader() {
          $traceurRuntime.superConstructor(FileManagerTestFileUploader).apply(this, arguments);
        }
        return ($traceurRuntime.createClass)(FileManagerTestFileUploader, {
          tryUpload: function() {
            var $__3 = this;
            var filesSelector = this.option('filesSelector');
            if (filesSelector) {
              setTimeout(function() {
                var files = filesSelector();
                var info = $__3._uploaderInfos[0];
          ...
          _getDefaultOptions: function() {
            return extend($traceurRuntime.superGet(this, FileManagerTestFileUploader.prototype, "_getDefaultOptions").call(this), {filesSelector: null});
          },
          _optionChanged: function(args) {
            ...
            switch (name) {
              case 'filesSelector':
                break;
              default:
                $traceurRuntime.superGet(this, FileManagerTestFileUploader.prototype, "_optionChanged").call(this, args);
            }
          }
        }, {}, $__super);
      }(FileManagerFileUploader));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["core/utils/extend","ui/file_manager/ui.file_manager.file_uploader"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("core/utils/extend"), require("ui/file_manager/ui.file_manager.file_uploader"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=file_uploader.mock.js.map