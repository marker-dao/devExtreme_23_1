...
(["testing/helpers/fileManagerHelpers.js"], ["jquery","core/devices","core/utils/type.js","core/utils/date_serialization","file_management/file_system_item","./fileManager/file_reader.mock.js"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/helpers/fileManagerHelpers.js", ["jquery", "core/devices", "core/utils/type.js", "core/utils/date_serialization", "file_management/file_system_item", "./fileManager/file_reader.mock.js"], function($__export) {
  "use strict";
  var $,
      devices,
      isDefined,
      ...
      showMoreButtonText,
      FileManagerWrapper,
      FileManagerProgressPanelWrapper,
      FileManagerProgressPanelInfoWrapper,
      FileManagerProgressPanelProgressBoxWrapper,
      FileManagerBreadcrumbsWrapper,
      stringify,
      createTestFileSystem,
      createHugeFileSystem,
      createUploaderFiles,
      createSampleFileItems,
  ...
  return {
    setters: [function($__m) {
      ...
      deserializeDate = $__m.deserializeDate;
    }, function($__m) {
      FileSystemItem = $__m.default;
    }, function($__m) {
      FileReaderMock = $__m.default;
    }],
    execute: function() {
      Consts = {
      ...
      showMoreButtonText = '\u22EE';
      FileManagerWrapper = function() {
        function FileManagerWrapper($element) {
          this._$element = $element;
        }
        return ($traceurRuntime.createClass)(FileManagerWrapper, {
          getInstance: function() {
            return this._$element.dxFileManager('instance');
          },
          getDirsPanel: function() {
            return this._$element.find(("." + Consts.DIRS_PANEL_CLASS));
          },
          getDirsTree: function() {
          ...
          getItemsViewPanel: function() {
            return this._$element.find(("." + Consts.ITEMS_PANEL_CLASS));
          },
          getFolderNodes: function(inDialog) {
            if (inDialog) {
          ...
          getFolderNode: function(index, inDialog) {
            return this.getFolderNodes(inDialog).eq(index);
          },
          getFolderNodeText: function(index, inDialog) {
            var text = this.getFolderNode(index, inDialog).text() || '';
            return text.replace(showMoreButtonText, '');
          },
          getFolderToggles: function(inDialog) {
            if (inDialog) {
          ...
          getFolderToggle: function(index, inDialog) {
            return this.getFolderToggles(inDialog).eq(index);
          },
          isFolderNodeToggleOpened: function(text, inDialog) {
            var result = null;
            var targetNode = this.getFolderNodes(inDialog).filter(function() {
              return $(this).text() === text;
            }).eq(0).parent();
            if (targetNode.length) {
              var itemToggle = targetNode.children(("." + Consts.FOLDERS_TREE_VIEW_ITEM_TOGGLE_CLASS));
          ...
          getTreeViewScrollableContainer: function() {
          ...
          getFolderActionButton: function(index) {
            var $folderNode = this.getFolderNode(index);
            return this._findActionButton($folderNode);
          },
          getBreadcrumbsWrapper: function() {
          ...
          getBreadcrumbsItemByText: function(text) {
            return this.getBreadcrumbsWrapper().getItemByText(text);
          },
          getBreadcrumbsParentDirectoryItem: function() {
            return this.getBreadcrumbsWrapper().getParentDirectoryItem();
          },
          getToolbar: function() {
            return this._$element.find(("." + Consts.TOOLBAR_CLASS));
          },
          getGeneralToolbar: function() {
            return this.getToolbar().children().first();
          },
          getFileSelectionToolbar: function() {
            return this.getToolbar().children().first().next();
          },
          getAllItemsOfToolbar: function(isFileSelection) {
            var toolbarElement = isFileSelection ? this.getFileSelectionToolbar() : this.getGeneralToolbar();
            return toolbarElement.find(("." + Consts.TOOLBAR_ITEM_CLASS));
          },
          getToolbarElements: function() {
            return this._$element.find(("." + Consts.TOOLBAR_CLASS + " ." + Consts.BUTTON_TEXT_CLASS + ", ." + Consts.TOOLBAR_CLASS + " ." + Consts.NATIVE_TOOLBAR_CLASS + " ." + Consts.DROP_DOWN_BUTTON_CLASS)).filter(':visible');
          },
          getToolbarElementsInSection: function(sectionName) {
            var visibleToolbarSection = this.getToolbar().find(("." + Consts.NATIVE_TOOLBAR_CLASS + ":visible ." + Consts.NATIVE_TOOLBAR_CLASS + "-" + sectionName));
          ...
          getGeneralToolbarElements: function() {
          ...
          getFileSelectionToolbarElements: function() {
          ...
          getToolbarButton: function(text) {
            return this._$element.find(("." + Consts.TOOLBAR_CLASS + " ." + Consts.BUTTON_CLASS + ":contains('" + text + "')"));
          },
          getToolbarRefreshButton: function(isFileSelectionToolbar) {
            return this._$element.find(("." + Consts.TOOLBAR_CLASS + " ." + Consts.BUTTON_CLASS + "[title='Refresh']")).eq(isFileSelectionToolbar ? 1 : 0);
          },
          getToolbarRefreshButtonState: function(isFileSelectionToolbar) {
            var refreshIcon = this.getToolbarRefreshButton(isFileSelectionToolbar).find(("." + Consts.TOOLBAR_REFRESH_ITEM_ICON_CLASS));
            return {
          ...
          moveSplitter: function(delta, pointerType) {
            var $splitter = this.getSplitter();
            var $drawerContent = this.getNavPaneDrawerPanelContent();
            if (!pointerType) {
              pointerType = 'mouse';
            }
            $splitter.trigger($.Event('dxpointerdown', {pointerType: pointerType}));
            var contentRect = $drawerContent[0].getBoundingClientRect();
            $splitter.trigger($.Event('dxpointermove', {
              pointerType: pointerType,
              pageX: contentRect.right - parseFloat($splitter.css('margin-left')) + delta
            }));
            $splitter.trigger($.Event('dxpointerup', {pointerType: pointerType}));
          },
          isSplitterActive: function() {
          ...
          getSplitterPosition: function() {
            var $splitterWrapper = this._$element.find(("." + Consts.SPLITTER_WRAPPER_CLASS));
            return $splitterWrapper.get(0).offsetLeft + parseFloat(this.getSplitter().css('margin-left'));
          },
          getNotificationPopup: function() {
          ...
          setUploadInputFile: function(files) {
            var $input = this.getUploadInput();
            $input.val(files[0].name);
            $input.prop('files', files);
            $input.trigger('change');
          },
          getUploaderDropZonePlaceholder: function() {
            return this._$element.find(("." + Consts.FILE_UPLOADER_DROPZONE_PLACEHOLER_CLASS));
          },
          triggerDragEvent: function($element, eventType, elementOffset) {
            var offsetValue = eventType === 'dragenter' ? 1 : -1;
            $element = $($element);
      ...
      $__export("FileManagerWrapper", FileManagerWrapper);
      FileManagerProgressPanelWrapper = function() {
        function FileManagerProgressPanelWrapper($element) {
          this._$element = $element;
        }
        return ($traceurRuntime.createClass)(FileManagerProgressPanelWrapper, {
          getInfosContainer: function() {
            return this._$element.find('.dx-filemanager-progress-panel-infos-container');
          },
          getInfos: function() {
            return this.getInfosContainer().find('.dx-filemanager-progress-panel-info').map(function(_, info) {
              return new FileManagerProgressPanelInfoWrapper($(info));
            }).get();
          },
          getSeparators: function() {
            return this.getInfosContainer().find('.dx-filemanager-progress-panel-separator');
          },
          findProgressBoxes: function($container) {
            return $container.children('.dx-filemanager-progress-box').map(function(_, element) {
              return new FileManagerProgressPanelProgressBoxWrapper($(element));
            }).get();
          },
          findError: function($container) {
      ...
      $__export("FileManagerProgressPanelWrapper", FileManagerProgressPanelWrapper);
      FileManagerProgressPanelInfoWrapper = function() {
        function FileManagerProgressPanelInfoWrapper($element) {
          this._$element = $element;
        }
        return ($traceurRuntime.createClass)(FileManagerProgressPanelInfoWrapper, {
          get common() {
            var $common = this._$element.find('.dx-filemanager-progress-panel-common');
            return new FileManagerProgressPanelProgressBoxWrapper($common);
          },
          get details() {
            return this._$element.find('.dx-filemanager-progress-panel-details > .dx-filemanager-progress-box').map(function(_, detailsInfo) {
              return new FileManagerProgressPanelProgressBoxWrapper($(detailsInfo));
            }).get();
          }
        }, {});
      }();
      $__export("FileManagerProgressPanelInfoWrapper", FileManagerProgressPanelInfoWrapper);
      FileManagerProgressPanelProgressBoxWrapper = function() {
        function FileManagerProgressPanelProgressBoxWrapper($element) {
          this._$element = $element;
        }
        return ($traceurRuntime.createClass)(FileManagerProgressPanelProgressBoxWrapper, {
          get $element() {
      ...
      $__export("FileManagerProgressPanelProgressBoxWrapper", FileManagerProgressPanelProgressBoxWrapper);
      FileManagerBreadcrumbsWrapper = function() {
        function FileManagerBreadcrumbsWrapper($element) {
          this._$element = $element;
        }
        return ($traceurRuntime.createClass)(FileManagerBreadcrumbsWrapper, {
          getItems: function() {
          ...
          getParentDirectoryItem: function() {
            return this._$element.find(("." + Consts.BREADCRUMBS_PARENT_DIRECOTRY_ITEM_CLASS));
          }
        }, {});
      }();
      $__export("FileManagerBreadcrumbsWrapper", FileManagerBreadcrumbsWrapper);
      ...
      $__export("createTestFileSystem", createTestFileSystem);
      createHugeFileSystem = function() {
        var $__6;
        var result = [];
        var getFiles = function(amount) {
          return $traceurRuntime.spread(new Array(amount).keys()).map(function(i) {
            return ({
              name: ("File " + i + ".txt"),
              isDirectory: false
            });
        ...
        ($__6 = result).push.apply($__6, $traceurRuntime.spread(getFiles(10)));
        result.push({
          name: 'Folder 1',
          isDirectory: true,
      ...
      $__export("createHugeFileSystem", createHugeFileSystem);
      createUploaderFiles = function(count, size) {
        var result = [];
        for (var i = 0; i < count; i++) {
          var fileSize = (size !== null && size !== undefined) ? size : (300000 + i * 200000);
          var fileName = ("Upload file " + i + ".txt");
          var content = generateString(fileSize, i.toString());
          var file = createFileObject(fileName, content);
          result.push(file);
        }
        return result;
      };
      $__export("createUploaderFiles", createUploaderFiles);
      createSampleFileItems = function() {
        var filesPathInfo = [{
          key: 'Root',
          name: 'Root'
        }, {
        ...
        var itemData = [{
          id: 'Root\\Files\\Documents',
          name: 'Documents',
          dateModified: '2019-02-14T07:44:15.4265625Z',
          isDirectory: true,
          size: 0,
          pathInfo: filesPathInfo
        }, {
          id: 'Root\\Files\\Images',
          name: 'Images',
          dateModified: '2019-02-14T07:44:15.4885105Z',
          isDirectory: true,
          size: 0,
          pathInfo: filesPathInfo
        }, {
          id: 'Root\\Files\\Music',
          name: 'Music',
          dateModified: '2019-02-14T07:44:15.4964648Z',
          isDirectory: true,
          size: 0,
          pathInfo: filesPathInfo
        }, {
          id: 'Root\\Files\\Description.rtf',
          name: 'Description.rtf',
          dateModified: '2017-02-09T09:38:46.3772529Z',
          isDirectory: false,
          size: 1,
          pathInfo: filesPathInfo
        }, {
          id: 'Root\\Files\\Article.txt',
          name: 'Article.txt',
          dateModified: '2017-02-09T09:38:46.3772529Z',
          isDirectory: false,
          size: 1,
        ...
        var fileSystemItems = [createFileSystemItem(filesPathInfo, itemData[0]), createFileSystemItem(filesPathInfo, itemData[1]), createFileSystemItem(filesPathInfo, itemData[2]), createFileSystemItem(filesPathInfo, itemData[3]), createFileSystemItem(filesPathInfo, itemData[4])];
        return {
      ...
      $__export("createSampleFileItems", createSampleFileItems);
      createFileSystemItem = function(parentPath, dataObj) {
        var item = new FileSystemItem(parentPath, dataObj.name, dataObj.isDirectory);
      ...
      createFileObject = function(fileName, content) {
        var result = new window.Blob([content], {type: 'application/octet-stream'});
        result.name = fileName;
        result.lastModified = (new Date()).getTime();
        result._dxContent = content;
        return result;
      };
      $__export("createFileObject", createFileObject);
      generateString = function(size, content) {
        if (!size) {
          return '';
        }
        var result = content;
        ...
        if (result.length < size) {
          var count = Math.ceil(size / result.length);
      ...
      $__export("generateString", generateString);
      createUploadInfo = function(file, chunkIndex, customData, chunkSize) {
        chunkIndex = chunkIndex || 0;
        customData = customData || {};
        chunkSize = chunkSize || 200000;
        var bytesUploaded = chunkIndex * chunkSize;
        var chunkCount = getFileChunkCount(file, chunkSize);
        var chunkBlob = file.slice(bytesUploaded, Math.min(file.size, bytesUploaded + chunkSize));
        return {
      ...
      $__export("createUploadInfo", createUploadInfo);
      getFileChunkCount = function(file, chunkSize) {
        return file.size === 0 ? 1 : Math.ceil(file.size / chunkSize);
      };
      $__export("getFileChunkCount", getFileChunkCount);
      stubFileReader = function(object) {
        if (!(object['_createFileReader'].restore && object['_createFileReader'].restore.sinon)) {
          sinon.stub(object, '_createFileReader').callsFake(function() {
            return new FileReaderMock();
          });
        }
      };
      $__export("stubFileReader", stubFileReader);
      isDesktopDevice = function() {
        return devices.real().deviceType === 'desktop';
      };
      $__export("isDesktopDevice", isDesktopDevice);
      getDropFileEvent = function(file) {
        return $.Event($.Event('drop', {dataTransfer: {files: [file]}}));
      };
      $__export("getDropFileEvent", getDropFileEvent);
      createEditingEvents = function() {
        return {
      ...
      $__export("createEditingEvents", createEditingEvents);
    }
  };
});
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/devices","core/utils/type.js","core/utils/date_serialization","file_management/file_system_item","./fileManager/file_reader.mock.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/devices"), require("core/utils/type.js"), require("core/utils/date_serialization"), require("file_management/file_system_item"), require("./fileManager/file_reader.mock.js"));
  else
