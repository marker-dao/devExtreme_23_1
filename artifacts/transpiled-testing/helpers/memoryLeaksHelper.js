...
(["testing/helpers/memoryLeaksHelper.js"], ["jquery"], true, function($__System) {
...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    define("testing/helpers/memoryLeaksHelper.js", ["require", "exports", "module", "jquery"], function(require, exports, module) {
      root.memoryLeaksHelper = module.exports = factory(require('jquery'));
    });
  } else {
    jQuery.extend(window, factory(jQuery));
  }
}(window, function($) {
  const exports = {};
  ...
  exports.compareDomElements = function(originalDomElements, newDomElements, ignorePatterns) {
    ...
    $.each(newDomElements, function() {
      diffElement(this, +1);
    });
    $.each(originalDomElements, function() {
      diffElement(this, -1);
    });
...
//# sourceMappingURL=memoryLeaksHelper.js.map