...
var BaseChart = _m_base_widget.default.inherit({
  ...
  _createHtmlStructure() {
    ...
    var appendLabelsAxesGroup = function appendLabelsAxesGroup() {
      _this2._labelsAxesGroup.linkOn(root, 'elements');
    };
  ...
  _disposeCore() {
    ...
    var disposeObject = function disposeObject(propName) {
      ...
      if (_this3[propName]) {
        _this3[propName].dispose();
        _this3[propName] = null;
      }
    };
  ...
  _renderElements(drawOptions) {
    ...
    this._layoutAxes(function (needSpace) {
      ...
      var canvas = _this4._renderAxes(axisDrawOptions, preparedOptions);
      _this4._shrinkAxes(needSpace, canvas);
    });
  ...
  _getPointsToAnimation(series) {
    ...
    return series.map(function (s) {
      var valViewPortFilter = _this5._getValFilter(s);
  ...
  _renderSeriesElements(drawOptions, isLegendInside) {
    ...
    series.forEach(function (singleSeries, index) {
      _this6._applyExtraSettings(singleSeries, drawOptions);
      var animationEnabled = drawOptions.animate && pointsToAnimation[index] <= drawOptions.animationPointsLimit && _this6._renderer.animationEnabled();
      singleSeries.draw(animationEnabled, drawOptions.hideLayoutLabels, _this6._getLegendCallBack(singleSeries));
    });
  ...
  _handleSeriesDataUpdated() {
    ...
    this.series.forEach(function (s) {
      return _this7._processSingleSeries(s);
    }, this);
  },
  ...
  _populateSeriesOptions(data) {
    ...
    var seriesVisibilityChanged = function seriesVisibilityChanged(target) {
      _this8._specialProcessSeries();
      _this8._populateBusinessRange(target && target.getValueAxis(), true);
      _this8._renderer.stopAllAnimations(true);
      _this8._updateLegend();
      _this8._requestChange(['FULL_RENDER']);
    };
  ...
  _populateSeries(data) {
    ...
    seriesThemes.forEach(function (theme) {
      ...
      var curSeries = (_a = _this9.series) === null || _a === void 0 ? void 0 : _a.find(findSeries);
    ...
    var eventPipe = function eventPipe(data) {
      _this9.series.forEach(function (currentSeries) {
    ...
    seriesBasis.forEach(function (basis) {
      ...
      var argumentAxis = (_b = (_a = _this9._argumentAxes) === null || _a === void 0 ? void 0 : _a.filter(function (a) {
        return a.pane === seriesTheme.pane;
      })[0]) !== null && _b !== void 0 ? _b : _this9.getArgumentAxis();
      var renderSettings = {
        commonSeriesModes: _this9._getSelectionModes(),
        argumentAxis,
        valueAxis: _this9._getValueAxis(seriesTheme.pane, seriesTheme.axis)
      };
      if (basis.series) {
        ...
        particularSeries = new _base_series.Series((0, _extend.extend)({
          renderer: _this9._renderer,
          seriesGroup: _this9._seriesGroup,
          labelsGroup: _this9._labelsGroup,
          eventTrigger: _this9._eventTrigger,
          eventPipe,
          incidentOccurred
      ...
      if (!particularSeries.isUpdated) {
        ...
        particularSeries.index = _this9.series.length;
        _this9.series.push(particularSeries);
      }
    });
    return this.series;
  },
