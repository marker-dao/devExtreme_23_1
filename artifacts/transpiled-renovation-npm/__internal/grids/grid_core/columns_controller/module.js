...
var ColumnsController = /*#__PURE__*/function (_modules$Controller) {
  ...
  _proto.init = function init(isApplyingUserState) {
    ...
    if (that._isColumnsFromOptions) {
      (0, _module_utils2.assignColumns)(that, columns ? (0, _module_utils2.createColumnsFromOptions)(that, columns) : []);
      (0, _module_utils2.applyUserState)(that);
    } else {
      (0, _module_utils2.assignColumns)(that, that._columnsUserState ? (0, _module_utils2.createColumnsFromOptions)(that, that._columnsUserState) : that._columns);
    }
    (0, _module_utils2.addExpandColumn)(that);
    if (that._dataSourceApplied) {
      that.applyDataSource(that._dataSource, true, isApplyingUserState);
    } else {
      (0, _module_utils2.updateIndexes)(that);
    }
    that._checkColumns();
  };
  ...
  _proto.getColumnByPath = function getColumnByPath(path, columns) {
    ...
    if (columnIndexes.length) {
      if (columns) {
        ...
        column = (0, _module_utils2.getColumnByIndexes)(that, columnIndexes);
      }
    }
    return column;
  };
  ...
  _proto.applyDataSource = function applyDataSource(dataSource, forceApplying, isApplyingUserState) {
    ...
    if (!that._dataSourceApplied || that._dataSourceColumnsCount === 0 || forceApplying || that.option('regenerateColumnsByVisibleItems')) {
      if (isDataSourceLoaded) {
        if (!that._isColumnsFromOptions) {
          var columnsFromDataSource = (0, _module_utils2.createColumnsFromDataSource)(that, dataSource);
          if (columnsFromDataSource.length) {
            (0, _module_utils2.assignColumns)(that, columnsFromDataSource);
      ...
      (0, _module_utils2.updateColumnChanges)(that, 'columns');
  ...
  _proto.resetColumnsCache = function resetColumnsCache() {
    ...
    (0, _module_utils2.resetBandColumnsCache)(that);
  };
    ...
    if (isColumnFixing) {
      for (var i = 0; i <= rowCount; i++) {
        ...
        for (var j = 0; j < visibleColumns.length; j++) {
          ...
          } else if (prevColumn && prevColumn.fixed && (0, _module_utils2.getFixedPosition)(that, prevColumn) !== (0, _module_utils2.getFixedPosition)(that, column)) {
            if (!(0, _type.isDefined)(transparentColumnIndex)) {
              transparentColumnIndex = j;
            }
          } else {
  ...
  _proto._compileVisibleColumnsCore = function _compileVisibleColumnsCore() {
    ...
    (0, _iterator.each)(columns, function () {
      ...
      var indexedColumns;
      var parentBandColumns = (0, _module_utils2.getParentBandColumns)(column.index, bandColumnsCache.columnParentByIndex);
      ...
      if (visible && (!(0, _type.isDefined)(column.groupIndex) || column.showWhenGrouped)) {
        ...
        if (visibleIndex < 0) {
          ...
          if (column.fixed) {
            ...
            if (rtlEnabled && (!column.command || (0, _module_utils2.isCustomCommandColumn)(that, column))) {
  ...
  _proto.allowMoveColumn = function allowMoveColumn(fromVisibleIndex, toVisibleIndex, sourceLocation, targetLocation) {
    var that = this;
    var columnIndex = (0, _module_utils2.getColumnIndexByVisibleIndex)(that, fromVisibleIndex, sourceLocation);
  ...
  _proto.moveColumn = function moveColumn(fromVisibleIndex, toVisibleIndex, sourceLocation, targetLocation) {
    ...
    var options = {};
    var prevGroupIndex;
    var fromIndex = (0, _module_utils2.getColumnIndexByVisibleIndex)(that, fromVisibleIndex, sourceLocation);
    var toIndex = (0, _module_utils2.getColumnIndexByVisibleIndex)(that, toVisibleIndex, targetLocation);
    ...
    if (fromIndex >= 0) {
      ...
      if ((0, _type.isDefined)(column.groupIndex) && sourceLocation === _const.GROUP_LOCATION) {
        ...
        if (targetLocation !== _const.GROUP_LOCATION) {
          ...
          (0, _module_utils2.updateColumnGroupIndexes)(that);
        }
      }
      if (targetLocation === _const.GROUP_LOCATION) {
        options.groupIndex = (0, _module_utils2.moveColumnToGroup)(that, column, targetGroupIndex);
        column.groupIndex = prevGroupIndex;
      } else if (toVisibleIndex >= 0) {
        var targetColumn = that._columns[toIndex];
        if (!targetColumn || column.ownerBand !== targetColumn.ownerBand) {
          options.visibleIndex = _const.MAX_SAFE_INTEGER;
        } else if ((0, _module_utils2.isColumnFixed)(that, column) ^ (0, _module_utils2.isColumnFixed)(that, targetColumn)) {
          options.visibleIndex = _const.MAX_SAFE_INTEGER;
        } else {
  ...
  _proto.updateColumnDataTypes = function updateColumnDataTypes(dataSource) {
    ...
    (0, _iterator.each)(that._columns, function (index, column) {
      ...
      var valueDataType;
      var lookup = column.lookup;
      if (_module_utils.default.isDateType(column.dataType) && column.serializationFormat === undefined) {
        column.serializationFormat = dateSerializationFormat;
      }
      if (lookup && _module_utils.default.isDateType(lookup.dataType) && column.serializationFormat === undefined) {
  ...
  _proto._customizeColumns = function _customizeColumns(columns) {
    ...
    if (customizeColumns) {
      ...
      (0, _module_utils2.assignColumns)(that, (0, _module_utils2.createColumnsFromOptions)(that, columns));
    }
  };
  ...
  _proto.clearSorting = function clearSorting() {
    ...
    for (var i = 0; i < columnCount; i++) {
      ...
      delete (0, _module_utils2.findColumn)(that._columns, i).sortOrder;
    }
    that.endUpdate();
  };
  ...
  _proto.addColumn = function addColumn(options) {
    var that = this;
    var column = (0, _module_utils2.createColumn)(that, options);
    var index = that._columns.length;
    that._columns.push(column);
    if (column.isBand) {
      that._columns = (0, _module_utils2.createColumnsFromOptions)(that, that._columns);
      column = that._columns[index];
    }
    column.added = options;
    (0, _module_utils2.updateIndexes)(that, column);
  ...
  _proto.deleteColumn = function deleteColumn(id) {
    ...
    if (column && column.index >= 0) {
      (0, _module_utils2.convertOwnerBandToColumnReference)(that._columns);
  ...
  _proto.setUserState = function setUserState(state) {
    ...
    (0, _module_utils2.updateColumnChanges)(that, 'filtering');
    that.init(true);
    if (dataSource) {
          ...
          parseValue: function parseValue(text) {
            ...
            if (column.dataType === 'number') {
              if ((0, _type.isString)(text) && column.format) {
                result = (0, _module_utils2.strictParseNumber)(text.trim(), column.format);
            ...
            } else if (_module_utils.default.isDateType(column.dataType)) {
              // @ts-expect-error
