...
let Appointment = /*#__PURE__*/function (_InfernoComponent) {
  ...
  _proto.updateStylesEffect = function updateStylesEffect() {
    ...
    const groupIndex = (_viewModel$info$group = viewModel.info.groupIndex) !== null && _viewModel$info$group !== void 0 ? _viewModel$info$group : 0;
    const {
      appointment
    } = viewModel;
