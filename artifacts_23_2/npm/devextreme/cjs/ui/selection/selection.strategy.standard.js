...
let StandardStrategy = /*#__PURE__*/function (_SelectionStrategy) {
  ...
  _proto._isItemSelectionInProgress = function _isItemSelectionInProgress(key, checkPending) {
    ...
    if (shouldCheckPending) {
      ...
      const addedItems = (_this$_lastRequestDat3 = this._lastRequestData.addedItems) !== null && _this$_lastRequestDat3 !== void 0 ? _this$_lastRequestDat3 : [];
