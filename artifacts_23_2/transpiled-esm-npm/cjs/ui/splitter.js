...
const SPLITTER_WRAPPER_CLASS = "".concat(SPLITTER_CLASS, "-wrapper");
const SPLITTER_INACTIVE_CLASS = "".concat(SPLITTER_CLASS, "-inactive");
const SPLITTER_BORDER_CLASS = "".concat(SPLITTER_CLASS, "-border");
const SPLITTER_INITIAL_STATE_CLASS = "".concat(SPLITTER_CLASS, "-initial");
const STATE_DISABLED_CLASS = 'dx-state-disabled';
const SPLITTER_MODULE_NAMESPACE = 'dxSplitterResizing';
let SplitterControl = /*#__PURE__*/function (_Widget) {
