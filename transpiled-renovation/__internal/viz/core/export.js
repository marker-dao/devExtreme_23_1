...
function validateFormat(format, incidentOccurred, validFormats) {
  ...
  if (validFormats.unsupported.indexOf(format) !== -1) {
    incidentOccurred === null || incidentOccurred === void 0 || incidentOccurred('W2108', [format]);
  }
}
...
function setPrint(imageSrc, options) {
  return function () {
    ...
    const removeFrame = () => {
      var _options$__test, _options$__test2, _window;
      /// #DEBUG
      (_options$__test = options.__test) === null || _options$__test === void 0 || _options$__test.checkAssertions();
      /// #ENDDEBUG
      this.parentElement.removeChild(this);
      /// #DEBUG
      (_options$__test2 = options.__test) === null || _options$__test2 === void 0 || _options$__test2.deferred.resolve(origImageSrc, (_window = window) === null || _window === void 0 || (_window = _window.document) === null || _window === void 0 || (_window = _window.body) === null || _window === void 0 ? void 0 : _window.style);
      /// #ENDDEBUG
    };
...
function createMenuItem(renderer, options, settings) {
  ...
  if (type === 'printing') {
    ...
    // @ts-expect-error
    .attr(attr.separator).append(menuItem);
  }
  return {
    g: menuItem,
    rect,
...
const plugin = exports.plugin = {
  ...
  members: {
    ...
    exportTo(fileName, format) {
      ...
      menu === null || menu === void 0 || menu.hide();
      ...
      menu === null || menu === void 0 || menu.show();
      return promise;
    },
    print() {
      const menu = this._exportMenu;
