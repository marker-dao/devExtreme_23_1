...
const msMapsLoaded = () => {
  ...
  return Boolean((_window$Microsoft = window.Microsoft) === null || _window$Microsoft === void 0 ? void 0 : _window$Microsoft.Maps);
};
...
class BingProvider extends _provider.default {
  ...
  updateBounds() {
    ...
    return Promise.all([this._resolveLocation(boundsOption === null || boundsOption === void 0 ? void 0 : boundsOption.northEast), this._resolveLocation(boundsOption === null || boundsOption === void 0 ? void 0 : boundsOption.southWest)]).then(result => {
...
/// #DEBUG
// @ts-expect-error ts-error
BingProvider.remapConstant = function remapConstant(newValue) {
